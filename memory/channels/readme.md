...
- Example: `memory/2026/04/qualified-lead-acme-corp.json`
...
- Mirrors the canonical memory node schema in `docs/prd/01_core_identity.md`.

## Reference
- See `docs/prd/01_core_identity.md` for schema and slug rules.
- See `docs/prd/29_project_structure.md` for project directory conventions.
