-- Test Environment Setup for Integration Testing v3.0.71 (Fixed)
-- Creates test database and loads base schema + v3.0.70 migration + v3.0.71 test infrastructure

-- Drop existing test database if it exists
DROP DATABASE IF EXISTS test_lupopedia_v3_0_71;

-- Create test database
CREATE DATABASE test_lupopedia_v3_0_71;
USE test_lupopedia_v3_0_71;

-- Load base schema (v3.0.70)
-- Note: Use backticks for path in MySQL
SOURCE `c:/ServBay/www/servbay/lupopedia/database/install/lupopedia_mysql.sql`;

-- Apply v3.0.70 Agent Awareness Layer migration
SOURCE `c:/ServBay/www/servbay/lupopedia/database/migrations/agent_awareness_layer_3_0_70.sql`;

-- Apply v3.0.71 integration testing infrastructure
SOURCE `c:/ServBay/www/servbay/lupopedia/database/migrations/3.0.71.sql`;
...
(2001, 1, 1001, 1001, 'test_integration_channel', 'Integration Test Channel', 'Test channel for validating AAL interactions', '{"purpose": "integration_testing", "doctrine": {"version": "3.0.71", "test_mode": true}, "emotional_geometry": {"baseline_mood": "neutral", "test_scenario": "integration"}}', 'FFFFFF', 1, 20260117000000, 20260117000000, 0, NULL),
(2002, 1, 1001, 1001, 'test_fleet_channel', 'Fleet Coordination Test Channel', 'Test channel for multi-agent fleet operations', '{"purpose": "fleet_testing", "doctrine": {"version": "3.0.71", "test_mode": true}, "emotional_geometry": {"baseline_mood": "neutral", "test_scenario": "fleet"}}', '00FFFF', 1, 20260117000000, 20260117000000, 0, NULL);
...
(1, 1001, 2001, 'participant', '{"awareness_snapshot": {"who": "Test Agent 1", "what": "AI Agent for integration testing", "where": "Integration Test Channel", "when": "2026-01-17", "why": "Part of v3.0.71 integration testing framework", "how": "Following test blueprint procedures", "purpose": "Validate AAL implementation"}}', 20260117000000, 20260117000000, 0, NULL),
