...
lupopedia.headers:
  ...
  summary: "Root README for Lupopedia 4.1.9: PRD system semantic operating system, constitutional multi-agent framework, 22-field headers, install and stewardship links."
  edges_toon: null
...
**Lupopedia 4.1.8**  
**Version family:** 4.1.8 stabilization line (rooted in 4.0.x constitutional model).  
...
### v4.1.8 (current)
- PRD header interpretation update: LUPOPEDIA HEADERS contract is header_format_version 4.1.8 (19 canonical fields); see PRD 16_C
- Version and header update: Global header atoms (`memory/channels/atoms/lupopedia_global_constants.atom.toon`) list the canonical field order; `when_updated` refreshed on migration
- Documentation: Header examples and field names use `path_from_lupopedia_root` and `thread_key` (DB-ID header fields removed)
...
- Identity layers (auth user, actor, department, agent): [PRD 05](docs/prd/05_auth_user_actor_agent_transformation.md), [PRD 15](docs/prd/15_actors.md), [PRD 25](docs/prd/25_departments_system.md)
...
Full details and diagrams: [PRD 05](docs/prd/05_auth_user_actor_agent_transformation.md), [PRD 15](docs/prd/15_actors.md), [PRD 25](docs/prd/25_departments_system.md).
...
- **Lupopedia 4.1.8** is the constitutional layer being built on top.
