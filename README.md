...
**Primary mission:** Complete an end-to-end upgrade test cycle from **Crafty Syntax Live Help 3.7.5** to **Lupopedia 4.0.46**, including installer correctness, database seeding, and web UI feature parity.  
...
- **Installer Version Fix**: Correct version display from previous versions to 4.0.46 in install.php.
...
Lupopedia 4.0.46 is the **official upgrade and evolution** of **Crafty Syntax Live Help 3.7.5**. Everything Crafty Syntax ever did is **preserved exactly**:  
...
### What Lupopedia 4.0.46 Includes
...
Lupopedia 4.0.x (4.0.0 → 4.0.46 and all future 4.0.x patches) are **iterative development attempts at stabilizing the Crafty Syntax upgrade path**:  
- **Crafty Syntax 3.7.5 → Lupopedia 4.0.46 (Current Focus)**  
- **4.0.46 is the upgrade validation release** - focused exclusively on testing and validating the Crafty Syntax 3.7.5 → Lupopedia upgrade path.  
...
- **The ONLY supported upgrade path before 4.1.0** is: **Crafty Syntax 3.7.5 → Lupopedia 4.0.46**.  
...
### 🔁 Upgrade Path: Crafty Syntax 3.7.5 → Lupopedia 4.0.46
...
- `X-Lupo-Version`: System version at the time of the last modification (e.g., 4.0.46).  
