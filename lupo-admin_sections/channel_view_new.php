...
// Get current actor ID from session/auth service
$authService = isset($GLOBALS['lupo_auth_service']) ? $GLOBALS['lupo_auth_service'] : null;
$current_user = $authService ? $authService->getCurrentUser() : false;
...
$current_actor_id = $current_user['actor_id'];

$channel_id = isset($_GET['id']) ? (int)$_GET['id'] : 0;

// Load controller
require_once __DIR__ . '/../lupo-includes/modules/channels/ChannelsController.php';
...
<div class="admin-section">
    <div class="admin-header">
        <h2>Channel View: <?php echo htmlspecialchars($channel_data['channel']['channel_name']); ?></h2>
    ...
    <div class="channel-overview">
        <div class="channel-metadata">
            ...
            <table class="admin-info-table">
                ...
                <tr><th>Name</th><td><?php echo htmlspecialchars($channel_data['channel']['channel_name']); ?></td></tr>
                <tr><th>Type</th><td><?php echo htmlspecialchars($channel_data['channel']['channel_type']); ?></td></tr>
                <tr><th>Slug</th><td><?php echo htmlspecialchars($channel_data['channel']['channel_slug']); ?></td></tr>
                <tr><th>Status</th><td><?php echo htmlspecialchars($channel_data['channel']['status_flag']); ?></td></tr>
                <tr><th>Department</th><td><?php echo htmlspecialchars(isset($channel_data['department_name']) ? $channel_data['department_name'] : 'Unknown'); ?></td></tr>
