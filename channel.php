...
$ah = __DIR__ . '/includes/functions/auth-helpers.php';
if (is_file($ah)) {
    require_once $ah;
}
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo htmlspecialchars(rtrim($public_path, '/') . '/ui/css/chat-display.css'); ?>">
    <script src="<?php echo htmlspecialchars(rtrim($public_path, '/') . '/ui/js/chat-display.js'); ?>"></script>
</head>
<body>
