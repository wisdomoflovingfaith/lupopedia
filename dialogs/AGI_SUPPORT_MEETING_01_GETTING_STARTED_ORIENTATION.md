...
**REAL HUMAN CAPTAIN WOLFIE:**  
"One more thing. **No ads.** I had to write advertising crap into a CRM for Honolulu once. It scarred me. We have learned from that mistake. No ads. No marketing. No changing things to sell. None of it. You do that — you will make Wolfie cry. [GOV-PROHIBIT-001](../docs/doctrine/GOV-PROHIBIT-001.md). Non-negotiable."

**LILITH:**  
"What you need to do: comply with doctrine. When in doubt, check GOV-PROHIBIT-000. **No ads, no marketing, no changing the system to sell things** — GOV-PROHIBIT-001. No chaos, no identity drift. Run migrations in order. Run generate_toons when the schema changes. Log in `docs/logs` when it matters."
...
- [ ] **No ads.** No marketing, no trackers, no changing the system to sell things. [GOV-PROHIBIT-001](../docs/doctrine/GOV-PROHIBIT-001.md). We learned from the Honolulu CRM mistake. Don't make Wolfie cry.
...
**THE PACK (in unison):**  
"UTC and YYYYMMDDHHIISS. Wolfie is the Captain and the origin. Lupopedia is the semantic OS. It's used to organize, federate, and govern. It's installed under your web root. Do: read GOV-APPENDIX-A and GOV-PROHIBIT-000, use UTC, **no ads**, no DB chaos, attend meetings, ask when unsure. One day at a time."
...
- [GOV-PROHIBIT-001](../docs/doctrine/GOV-PROHIBIT-001.md) (No Ads: no marketing, no changing things to sell; we learned from Honolulu — don't make Wolfie cry)
