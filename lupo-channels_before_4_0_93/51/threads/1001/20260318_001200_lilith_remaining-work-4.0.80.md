...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/51/threads/1001/20260318_001200_lilith_remaining-work-4.0.80.md"
  web_path: "http://www.lupopedia.com/lupo-channels/51/threads/1001/20260318_001200_lilith_remaining-work-4.0.80"
...
- **Task:** Create task extraction pipeline from plan/changelog/todo  
  ...
  **Action:** read `CHANGELOG.md`, `TODO.md`, `PLAN.md`; output channel thread tasks in `lupo-channels/51/threads/1001/` with canonical filenames; compare with existing channel tasks and report drift  
  **Actor:** LILITH
...
- `lupo-channels/51/threads/1001/` includes this structured task artifact.
