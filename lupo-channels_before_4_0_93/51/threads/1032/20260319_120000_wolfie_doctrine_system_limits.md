...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/51/threads/1032/20260319_120000_wolfie_doctrine_system_limits.md"
  web_path: "http://www.lupopedia.com/lupo-channels/51/threads/1032/20260319_120000_wolfie_doctrine_system_limits.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-docs/doctrine/SYSTEM_LIMITS_DOCTRINE.md", type: "creates", weight: 1.0, reason: "Creates canonical system limits doctrine" }
    - { to: "lupo-database/lupopedia/tables/", type: "limits", weight: 1.0, reason: "Limits database table count to 199" }
    - { to: "lupo-channels/", type: "limits", weight: 1.0, reason: "Limits thread count per channel to 999" }
    - { to: "lupo-database/lupopedia/actors/actor_id/registry.json", type: "limits", weight: 1.0, reason: "Limits actor registration count to 999" }
    - { to: "lupo-scripts/", type: "limits", weight: 1.0, reason: "Limits repository file count to 10,000" }
  semantic_tags: ["wolfie_doctrine", "system_limits", "governance"]

lupopedia.see:
  mappings:
    - ["SYSTEM_LIMITS_DOCTRINE.md", "http://www.lupopedia.com/lupo-docs/doctrine/SYSTEM_LIMITS_DOCTRINE.md"]
    - ["System Limits Doctrine", "http://www.lupopedia.com/lupo-channels/51/threads/1032/20260319_120000_wolfie_doctrine_system_limits.md"]
