...
lupopedia.headers:
  ...
  file_path_from_root: lupo-channels/62/threads/6201/20260324_230000_cursor_organization_pass_closure.md
...
Channel 62 tracked the lupo-* folder organization pass and root-level cleanup for 4.0.87.
...
| New File | Purpose |
|----------|---------|
| `lupo-includes/classes/EdgeQueryService.php` | Edge graph read-only query interface |
| `lupo-tests/unit/test_header_validators.py` | Tier 2/3 validator unit tests |
