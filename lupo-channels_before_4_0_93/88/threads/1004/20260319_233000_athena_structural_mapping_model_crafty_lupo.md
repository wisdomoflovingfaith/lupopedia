...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/88/threads/1004/20260319_233000_athena_structural_mapping_model_crafty_lupo.md"
  web_path: "http://www.lupopedia.com/lupo-channels/88/threads/1004/20260319_233000_athena_structural_mapping_model_crafty_lupo"
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "lupo-channels/88/threads/1004/20260319_230000_wolfie_question_crafty_lupo_table_mapping.md", type: "derived_from", weight: 1.0, reason: "WOLFIE Thread 1004 question artifact" }
    - { to: "lupo-database/lupopedia/mysql/import/old_crafty_syntax_3_7_5_start.sql", type: "requires_reading", weight: 1.0, reason: "Source Crafty Syntax 3.7.5 schema" }
    - { to: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "requires_reading", weight: 1.0, reason: "Target Lupopedia 4.x schema" }
    - { to: "lupo-database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql", type: "requires_reading", weight: 1.0, reason: "Canonical import SQL mapping" }
    - { to: "lupo-docs/database/lupopedia/tables/MIGRATION_MAPPING_REFERENCE.md", type: "requires_reading", weight: 1.0, reason: "Migration mapping reference index" }
    - { to: "lupo-docs/channels/schema/migrations/analysis/CRAFTY_SYNTAX_TO_LUPOPEDIA_STRUCTURED_MAPPING.md", type: "requires_reading", weight: 1.0, reason: "Structured mapping analysis" }
    - { to: "lupo-docs/channels/schema/migrations/analysis/CRAFTY_SYNTAX_TO_LUPOPEDIA_ANALYSIS.md", type: "requires_reading", weight: 0.9, reason: "Crafty to Lupopedia analysis" }
    - { to: "lupo-docs/doctrine/MIGRATION_DOCTRINE.md", type: "requires_reading", weight: 0.9, reason: "Migration doctrine" }
    - { to: "lupo-docs/doctrine/CRAFTY_SYNTAX_INTEGRATION_PLAN.md", type: "requires_reading", weight: 0.8, reason: "Integration plan" }
    - { to: "lupo-docs/doctrine/migrations/livehelp_migrations_readme.md", type: "requires_reading", weight: 0.85, reason: "Relocation readme" }
    # Per-table migration docs (sample of most critical)
    - { to: "lupo-docs/database/lupopedia/tables/migrations/livehelp_users_migration.md", type: "references", weight: 0.9, reason: "User identity migration" }
    - { to: "lupo-docs/database/lupopedia/tables/migrations/livehelp_transcripts.md", type: "references", weight: 0.9, reason: "Critical transcript → dialog mapping" }
    - { to: "lupo-docs/database/lupopedia/tables/migrations/livehelp_departments_migration.md", type: "references", weight: 0.8, reason: "Department mapping" }
    - { to: "lupo-docs/database/lupopedia/tables/migrations/livehelp_config_migration.md", type: "references", weight: 0.8, reason: "Config → JSON transformation" }
    - { to: "lupo-docs/database/lupopedia/tables/migrations/livehelp_sessions_migration.md", type: "references", weight: 0.8, reason: "Session handling" }
    - { to: "lupo-docs/database/lupopedia/tables/migrations/livehelp_messages_migration.md", type: "references", weight: 0.8, reason: "Message handling (dropped)" }
    - { to: "lupo-docs/database/lupopedia/tables/migrations/livehelp_qa_migration.md", type: "references", weight: 0.8, reason: "QA → truth system mapping" }
    - { to: "lupo-docs/database/lupopedia/tables/migrations/livehelp_identity_migration.md", type: "references", weight: 0.7, reason: "Identity analytics (dropped)" }
    - { to: "lupo-docs/database/lupopedia/tables/migrations/livehelp_keywords_migration.md", type: "references", weight: 0.7, reason: "Keywords analytics (dropped)" }
...
# file: ATHENA Structural Mapping Model — session: L-LUPO-ROOT-ATHENA — delegation: wolfie:root — web_path: http://www.lupopedia.com/lupo-channels/88/threads/1004/20260319_233000_athena_structural_mapping_model_crafty_lupo
...
|-------|---------|--------|
| Old paths in import SQL | `docs/doctrine/migrations/` vs `lupo-docs/database/lupopedia/tables/migrations/` | Confusion |
...
```yaml
# lupo-docs/database/lupopedia/CRAFTY_TO_LUPOPEDIA_MAPPING.yaml
version: "4.0.80"
generated: "20260319"
