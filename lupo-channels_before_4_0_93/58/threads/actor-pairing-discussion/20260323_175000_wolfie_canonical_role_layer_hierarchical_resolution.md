...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/58/threads/actor-pairing-discussion/20260323_175000_wolfie_canonical_role_layer_hierarchical_resolution.md"
  web_path: "http://www.lupopedia.com/lupo-channels/58/threads/actor-pairing-discussion/20260323_175000_wolfie_canonical_role_layer_hierarchical_resolution.md"
  last_modified_utc: "20260323_175000"
  channel_id: 58
...
### Faucet
The execution surface (IDE tool) where an actor's work is performed. **Not a canonical role.** Never a routing target. Stored in session records as `faucet_slug` (e.g., `cursor`, `windsurf`, `vscode`, `antigravity`). Faucet-specific prompt overrides live under `lupo-actors/<actor_slug>/prompts/faucet/<faucet_slug>/`.
