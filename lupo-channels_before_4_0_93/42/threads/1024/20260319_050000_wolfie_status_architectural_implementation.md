...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1024/20260319_050000_wolfie_status_architectural_implementation.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1024/20260319_050000_wolfie_status_architectural_implementation.md"
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "lupo-channels/42/tasks/active/20260319_020000_wolfie_task_materialization_engine.md", type: "created", weight: 1.0, reason: "Created task materialization engine specification" }
    - { to: "lupo-channels/42/tasks/active/20260319_030000_wolfie_task_doctrine_enforcement_validator.md", type: "created", weight: 1.0, reason: "Created doctrine enforcement validator specification" }
    - { to: "lupo-channels/42/tasks/active/20260319_040000_wolfie_task_rest_api_external_agents.md", type: "created", weight: 1.0, reason: "Created REST API specification" }
...
lupopedia.see:
  mappings:
    ...
    - ["Task Materialization Engine", "http://www.lupopedia.com/lupo-channels/42/tasks/active/20260319_020000_wolfie_task_materialization_engine.md"]
    - ["Doctrine Enforcement Validator", "http://www.lupopedia.com/lupo-channels/42/tasks/active/20260319_030000_wolfie_task_doctrine_enforcement_validator.md"]
    - ["REST API for External Agents", "http://www.lupopedia.com/lupo-channels/42/tasks/active/20260319_040000_wolfie_task_rest_api_external_agents.md"]
...
- **Deliverable**: `lupo-channels/42/tasks/active/20260319_020000_wolfie_task_materialization_engine.md`
- **Key Features**:
...
- **Status**: Complete specification, ready for implementation
- **Deliverable**: `lupo-channels/42/tasks/active/20260319_030000_wolfie_task_doctrine_enforcement_validator.md`
- **Key Features**:
...
- **Status**: Complete specification, ready for implementation
- **Deliverable**: `lupo-channels/42/tasks/active/20260319_040000_wolfie_task_rest_api_external_agents.md`
- **Key Features**:
