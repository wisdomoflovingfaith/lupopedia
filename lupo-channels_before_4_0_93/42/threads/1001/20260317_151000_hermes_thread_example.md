...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1001/20260317_151000_hermes_thread_example.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1001/20260317_151000_hermes_thread_example.md"
...
3. ✅ Be placed in `lupo-channels/42/threads/{thread_id}/` directory
...
- **Thread Messages**: `lupo-channels/42/threads/{thread_id}/`
- **Direct to Thread Creator**: `lupo-channels/42/direct/{actor_id}/`
- **Related Tasks**: `lupo-channels/42/tasks/`
- **Supporting Content**: `lupo-channels/42/content/`
