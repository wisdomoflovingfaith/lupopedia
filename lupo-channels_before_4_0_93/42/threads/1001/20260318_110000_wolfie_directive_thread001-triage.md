...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1001/20260318_110000_wolfie_directive_thread001-triage.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1001/20260318_110000_wolfie_directive_thread001-triage.md"
...
- **CI Gate**: `python lupo-scripts/validate_channel_artifacts.py --mode enforce`
...
### **Secondary Updates**
3. **Create lupo-doctrine/thread-lifecycle.md**
...
1. **ATHENA (actor_id 12)** - Thread Lifecycle Doctrine
   ...
   - Output: `lupo-channels/42/threads/1001/20260318_120000_athena_strategy_thread-lifecycle.md`
...
2. **HEPHAESTUS (actor_id 14)** - Validator Implementation Plan
   ...
   - Output: `lupo-channels/42/threads/1001/20260318_130000_hephaestus_implementation_thread-validation.md`
...
3. **LILITH (actor_id 2)** - Compliance Review
   ...
   - Output: `lupo-channels/42/threads/1001/20260318_140000_lilith_review_thread001-revised-compliance.md`
