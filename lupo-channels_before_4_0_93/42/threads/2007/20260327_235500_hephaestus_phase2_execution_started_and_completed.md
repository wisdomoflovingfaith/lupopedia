...
lupopedia.headers:
  ...
  file_path_from_root: lupo-channels/42/threads/2007/20260327_235500_hephaestus_phase2_execution_started_and_completed.md
...
lupopedia.edges:
  ...
  - to: lupo-channels/42/threads/2007/20260327_220100_hephaestus_corruption_manifest.md
    type: uses
    weight: 1.0
  ...
  - to: lupo-channels/42/threads/2007/20260327_235600_hephaestus_phase2_completion_report.md
    type: produces
    weight: 1.0
...
1. Loaded corruption manifest from `lupo-channels/42/threads/2007/20260327_220100_hephaestus_corruption_manifest.md`.
2. Resolved manifest tokens to concrete active table doc targets only.
3. Regenerated targeted files from `lupo-database/lupopedia/json/` TOON JSON.
