...
lupopedia.headers:
  ...
  file_path_from_root: lupo-channels/42/threads/2007/20260327_220000_thoth_semantic_truth_validation_regeneration_source.md
...
lupopedia.edges:
  ...
  - to: lupo-scripts/regenerate_toons_docs.py
    type: tool_reference
    weight: 0.9
...
**File:** [lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql](lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql)
...
**Location:** [lupo-database/lupopedia/toon/](lupo-database/lupopedia/toon/)
...
- Output to `lupo-database/lupopedia/toon/` directory
...
**Evidence** ([lupo-docs/database/lupopedia/tables/active/lupo_actors.md](lupo-docs/database/lupopedia/tables/active/lupo_actors.md) header):
...
**Command:** [lupo-scripts/verify_db_against_toons.py](lupo-scripts/verify_db_against_toons.py)
...
**Tools:**
- [lupo-scripts/audit_schema_doctrine.py](lupo-scripts/audit_schema_doctrine.py) — Schema auditing
- [lupo-scripts/flare_edge_suggester.py](lupo-scripts/flare_edge_suggester.py) — Edge discovery
...
```bash
php lupo-scripts/validate_lupopedia_headers.php lupo-docs/database/lupopedia/tables/active/
```
...
**Command:**
```bash
git log --oneline lupo-docs/database/lupopedia/tables/active/ | head -20
git show <commit>:lupo-docs/database/lupopedia/tables/active/lupo_actors.md | head -50
```
...
```
lupo-scripts/discover_table_edges.py
...
|---------------|-------------|---------|-----------|
| Schema DDL | [install_new_lupopedia.sql](lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql#L7) | 158 CREATE TABLE statements | ✅ CANONICAL |
| TOON Structure | [lupo_actors.toon](lupo-database/lupopedia/toon/lupo_actors.toon) | Fields + indexes + doctrine | ✅ CONSISTENT |
| TOON Count | Dir listing | ~148 files | ✅ COMPLETE |
| Header Format | [lupo_actors.md](lupo-docs/database/lupopedia/tables/active/lupo_actors.md#L1-L20) | YAML lupopedia.headers required | ✅ VERIFIED |
| Edges Example | [lupo_actors.md](lupo-docs/database/lupopedia/tables/active/lupo_actors.md#L20-L50) | YAML lupopedia.edges with 20+ relationships | ✅ VERIFIED |
| Edge DB Table | [install_new_lupopedia.sql#L2107](lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql#L2107) | lupo_edges table exists | ✅ PRESENT |
| TOON Generator | [regenerate_toons_docs.py](lupo-scripts/regenerate_toons_docs.py) | Script to export via INFORMATION_SCHEMA | ✅ OPERATIONAL |
| Validator | [validate_lupopedia_headers.php](lupo-scripts/validate_lupopedia_headers.php) | Header validation tool exists | ✅ AVAILABLE |
| No MD Generator | Grep across lupo-scripts/ | No script generates Markdown from TOON | ⚠️ MISSING |
