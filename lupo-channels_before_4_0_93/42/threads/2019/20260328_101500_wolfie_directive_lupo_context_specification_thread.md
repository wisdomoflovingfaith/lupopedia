...
lupopedia.headers:
  ...
  file_path_from_root: lupo-channels/42/threads/2019/20260328_101500_wolfie_directive_lupo_context_specification_thread.md
  web_path: http://www.lupopedia.com/lupopedia/lupo-channels/42/threads/2019/20260328_101500_wolfie_directive_lupo_context_specification_thread.md
  ...
  purpose: Directive to create lupo-context specification and minimal operational model for 4.0.88
  traits:
  - canonical
  - comprehensive
  - v4.0.88
...
lupopedia.edges:
  outbound_edges:
  - to: lupo-docs/doctrine/CHANNELS_CONTEXTS_AND_COORDINATION.md
    type: references
    weight: 1.0
    reason: Existing context documentation references
  - to: lupo-docs/WHAT_TO_DO_NEXT.md
    type: references
    weight: 1.0
    reason: Open questions about lupo-context
  - to: lupo-context/
    type: describes
    weight: 1.0
...
# WOLFIE — DIRECTIVE: lupo-context Specification Thread
...
- `lupo-context/` directory exists but is empty
...
Define the **minimal operational model** for `lupo-context` in 4.0.88.
...
Create `lupo-docs/doctrine/CONTEXT_MODEL_DOCTRINE.md` defining:
...
Define organization under `lupo-context/`:
...
1. **Specification Document**: `lupo-docs/doctrine/CONTEXT_MODEL_DOCTRINE.md`
2. **Prototype Context**: `lupo-context/[context_name]/` with sample content
...
**✅ APPROVED** — Create lupo-context specification thread
