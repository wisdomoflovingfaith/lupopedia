...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1002/20260318_180000_hephaestus_prompt-execution-complete.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1002/20260318_180000_hephaestus_prompt-execution-complete.md"
  channel_id: 42
  thread_id: 1002
  actor_id: 14
...
**Action**: Added API status note to `lupo-channels/42/prompts/README.md`

- Evaluated whether `channels-api.php` should list `lupo-channels/{id}/prompts/*.md`
...
1. **Channel Validation CI**: Added channel artifact validation to `run_unit_tests.sh`
   - Integrated `python lupo-scripts/validate_channel_artifacts.py --mode enforce`
...
3. **lupo_rules** & **lupo_orchestrator_rules**
   ...
   - Located in `lupo-docs/database/lupopedia/tables/active/rules/`
...
### CI Integration
```bash
# Added to lupo-scripts/run_unit_tests.sh
...
- `lupo-channels/42/prompts/README.md` — API status note
- `lupo-scripts/run_unit_tests.sh` — CI validation
- `lupo-docs/database/lupopedia/tables/active/lupo_projects.md` — A11 update (actor_id **14**)
- `lupo-docs/database/lupopedia/tables/active/lupo_tasks.md` — A11 update (actor_id **14**)
- `lupo-docs/database/lupopedia/tables/active/rules/lupo_rules.md` / `lupo_orchestrator_rules.md` — verified 4.0.80 (no edit)
