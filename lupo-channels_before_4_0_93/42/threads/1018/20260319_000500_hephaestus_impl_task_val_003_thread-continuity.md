...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1018/20260319_000500_hephaestus_impl_task_val_003_thread-continuity.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1018/20260319_000500_hephaestus_impl_task_val_003_thread-continuity.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/42/threads/1018/20260318_235000_lilith_review_task_val_003_thread-continuity-spec.md", type: references, weight: 1.0 }
...
| File | Action |
|------|--------|
| `lupo-scripts/validate_threads.py` | Update: predicates, matchers, scope logging, V-THREAD-005 edge+body rules |
| `lupo-channels/42/threads/1018/20260319_001200_hephaestus_result_task_val_003_thread-continuity.md` | Create: run output (after code) |
...
2. Run: `python lupo-scripts/validate_threads.py --repo-root . --channel 42 --threads 1006`  
3. Run: `python lupo-scripts/validate_threads.py --repo-root . --channel 42` (expect INFO + 1006 if kickoff has enforce flag).  
