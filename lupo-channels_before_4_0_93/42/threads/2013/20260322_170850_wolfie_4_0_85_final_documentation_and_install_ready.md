...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "lupo-docs/versions/4.0.85/doctrine_changes/mood_rgb_hybrid_model.md", type: "documents", weight: 1.0, reason: "Thread 2015 final mood_rgb hybrid model migrated here." }
...
| 2015 | `lupo-docs/versions/4.0.85/doctrine_changes/mood_rgb_hybrid_model.md` |
