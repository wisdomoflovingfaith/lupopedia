...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1050/20260322_131757_thoth_bmad_method_workflow_research.md"
  last_modified_utc: "20260322_131757"
  channel_id: 42
  thread_id: 1050
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-docs/versions/4.0.85/federation/bmad_research.md", type: "summarizes", weight: 1.0, reason: "Primary research artifact" }
    - { to: "lupo-docs/versions/4.0.85/TASK_REGISTRY.md", type: "registered_in", weight: 1.0, reason: "Task registration surface" }
    - { to: "lupo-research/bmad_method/docs/reference/workflow-map.md", type: "analyzes", weight: 1.0, reason: "BMAD workflow source" }
---
