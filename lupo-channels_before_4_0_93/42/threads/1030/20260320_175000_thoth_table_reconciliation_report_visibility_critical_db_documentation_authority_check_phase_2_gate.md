...
- What disagrees:
- active doc omits authoritative columns (`message_id`, `source_faucet_slug`, `source_faucet_instance_id`, `read_by_actor_id`, `read_by_actor_utc`, `mood_rgb`, `mood_framework`, `message_body`) and misstates some field typing/nullability.
- Authority source:
