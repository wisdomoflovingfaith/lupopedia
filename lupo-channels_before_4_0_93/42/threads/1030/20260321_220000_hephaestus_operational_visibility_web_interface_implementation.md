...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1030/20260321_220000_hephaestus_operational_visibility_web_interface_implementation.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1030/operational_visibility_implementation"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/42/threads/1031/", type: "uses", weight: 0.95, reason: "Uses canonical schema from Thread 1031" }
    - { to: "lupo-channels/42/threads/1032/", type: "uses", weight: 0.9, reason: "Follows Thread 1032 schema authority doctrine" }
    - { to: "lupo-channels/42/THREAD_INDEX.md", type: "reads", weight: 0.85, reason: "Primary data source for thread information" }
    - { to: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "queries", weight: 0.8, reason: "Database schema for queries" }
...
**File:** `lupo-views/visibility/channels.php`
...
**File:** `lupo-views/visibility/channel_threads.php`
...
**File:** `lupo-views/visibility/attention.php`
...
**File:** `lupo-views/visibility/thread_detail.php`
...
| File | Purpose | Size |
|------|---------|------|
| `lupo-views/visibility/index.php` | Channel Overview | 2.3KB |
| `lupo-views/visibility/channels.php` | Channel Overview logic | 4.1KB |
| `lupo-views/visibility/channel_threads.php` | Channel Thread List | 5.2KB |
| `lupo-views/visibility/attention.php` | Attention View | 3.8KB |
| `lupo-views/visibility/thread_detail.php` | Thread Detail | 6.7KB |
| `lupo-views/visibility/css/style.css` | Responsive styling | 2.9KB |
| `lupo-views/visibility/js/navigation.js` | Basic interactions | 1.2KB |
