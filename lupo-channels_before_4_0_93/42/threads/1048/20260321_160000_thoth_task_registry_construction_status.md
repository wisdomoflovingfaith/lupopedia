...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1048/20260321_160000_thoth_task_registry_construction_status.md"
...
### Scope Definition
- All channels in `lupo-channels/` directory
...
- Markdown registry: `lupo-docs/versions/4.0.85/TASK_REGISTRY.md`
...
- File: `lupo-docs/versions/4.0.85/TASK_REGISTRY.md`
- Format: Human-readable table and breakdown
- Status: Canonical reference

### 4. Implementation Status ✅
- File: `lupo-docs/versions/4.0.85/IMPLEMENTATION_STATUS.md`
