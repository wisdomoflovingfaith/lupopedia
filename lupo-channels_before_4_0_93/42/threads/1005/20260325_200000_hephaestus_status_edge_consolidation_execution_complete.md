...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1005/20260325_200000_hephaestus_status_edge_consolidation_execution_complete.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/42/threads/1005/20260325_185000_hephaestus_edge_model_consolidation_4_0_87.md", type: "completes", weight: 1.0 }
    - { to: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "modifies", weight: 1.0 }
    - { to: "lupo-includes/classes/EmergentRoleDiscovery.php", type: "modifies", weight: 1.0 }
    - { to: "lupo-database/lupopedia/content/lupo-app/Services/ActorService.php", type: "modifies", weight: 1.0 }
    - { to: "lupo-scripts/audit_schema_doctrine.php", type: "modifies", weight: 1.0 }
    - { to: "lupo-database/lupopedia/mysql/migrations/dev_20260325_remove_redundant_edge_tables.sql", type: "creates", weight: 1.0 }
...
**`lupo-scripts/audit_schema_doctrine.php`**
...
### Documentation
- `lupo-docs/database/lupopedia/tables/active/lupo_actor_edges.md` → moved to `tables/deprecated/lupo_actor_edges.md`
- Header updated: `superseded_by: lupo_edges.md`, version set to 4.0.87, deprecation note added

### Migration Script Created
- `lupo-database/lupopedia/mysql/migrations/dev_20260325_remove_redundant_edge_tables.sql`
