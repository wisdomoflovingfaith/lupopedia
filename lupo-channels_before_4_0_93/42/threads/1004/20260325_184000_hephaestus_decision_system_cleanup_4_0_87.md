...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1004/20260325_184000_hephaestus_decision_system_cleanup_4_0_87.md"
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "lupo-bin/cli/decision-cli.php", type: "removes", weight: 1.0 }
    - { to: "lupo-api/v1/decisions-api.php", type: "removes", weight: 1.0 }
    - { to: "lupo-includes/Decision/BayesianDecisionService.php", type: "removes", weight: 1.0 }
...
- `lupo-bin/cli/decision-cli.php` - CLI tool referencing removed tables
- `lupo-api/v1/decisions-api.php` - API endpoint that will fail
- `lupo-includes/Decision/BayesianDecisionService.php` - Service class for removed tables

**Test files to update**:
- `lupo-tests/unit/test_bayesian_decision.php` - Tests for removed functionality
...
```bash
# Remove CLI tool
rm lupo-bin/cli/decision-cli.php

# Remove API endpoint  
rm lupo-api/v1/decisions-api.php

# Remove service class
rm lupo-includes/Decision/BayesianDecisionService.php
```
