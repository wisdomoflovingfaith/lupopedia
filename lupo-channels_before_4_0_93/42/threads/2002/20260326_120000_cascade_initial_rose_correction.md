...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/2002/20260326_120000_cascade_initial_rose_correction.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-docs/versions/4.0.88/SEMANTIC_ARCHITECTURE.md", type: "references", weight: 1.0 }
    - { to: "lupo-channels/42/directives/20260326_rose_correction_final_v2.md", type: "references", weight: 0.9 }
...
1. **`mood_rgb` described as color label** - It's actually 3 RGB axes (00-FF each) forming hex color
...
2. Create directive in proper location (`lupo-channels/42/directives/`)
