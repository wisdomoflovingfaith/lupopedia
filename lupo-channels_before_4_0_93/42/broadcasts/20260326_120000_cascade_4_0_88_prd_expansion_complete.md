...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/broadcasts/20260326_120000_cascade_4_0_88_prd_expansion_complete.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/broadcasts/20260326_120000_cascade_4_0_88_prd_expansion_complete.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-docs/versions/4.0.88/prd/", type: "created", weight: 1.0 }
    - { to: "lupo-docs/versions/4.0.88/SEMANTIC_ARCHITECTURE.md", type: "created", weight: 1.0 }
    - { to: "lupo-docs/versions/4.0.88/CRAFTY_SYNTAX_PARITY.md", type: "created", weight: 1.0 }
    - { to: "lupo-docs/versions/4.0.88/plan.md", type: "updated", weight: 1.0 }
...
- **Follows lupo-rules/root/** - All database design principles
...
- ✅ **Database Design Rules** - Follows lupo-rules/root/ principles
