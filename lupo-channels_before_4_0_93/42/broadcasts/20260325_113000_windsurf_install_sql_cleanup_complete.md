...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/broadcasts/20260325_113000_windsurf_install_sql_cleanup_complete.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/broadcasts/20260325_113000_windsurf_install_sql_cleanup_complete.md"
  last_modified_utc: "20260325_113000"
  channel_id: 42
  thread_id: null
  actor_id: 105
  actor_name: "windsurf"
  ...
  references:
    ...
    - "lupo-rules/root/WINDOWS_WSL_COMMAND_PATTERNS.md"
...
- **Channel Storage**: Artifacts now stored in `lupo-channels/` file structure
...
- ✅ `lupo-channels/42/broadcasts/20260325_113000_windsurf_install_sql_cleanup_complete.md` - This report

### Documentation Files
- ✅ `lupo-docs/database/lupopedia/tables/deprecated/lupo_artifacts.md` - Deprecation notice
- ✅ `lupo-docs/database/lupopedia/tables/deprecated/lupo_artifact_chunks.md` - Deprecation notice
- ✅ `lupo-rules/root/WINDOWS_WSL_COMMAND_PATTERNS.md` - WSL command patterns
