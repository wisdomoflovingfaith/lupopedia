...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/broadcasts/20260325_110000_windsurf_wsl_command_patterns_update.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/broadcasts/20260325_110000_windsurf_wsl_command_patterns_update.md"
  last_modified_utc: "20260325_110000"
  channel_id: 42
  thread_id: null
  actor_id: 105
  actor_name: "windsurf"
...
wsl grep -c "CREATE TABLE" "c:\ServBay\www\servbay\lupopedia\lupo-database\lupopedia\mysql\install\install_new_lupopedia.sql"

# Find all matches with context
wsl grep -n "CREATE TABLE" "c:\ServBay\www\servbay\lupopedia\lupo-database\lupopedia\mysql\install\install_new_lupopedia.sql"

# Case-insensitive search
wsl grep -i "lupo_artifacts" "c:\ServBay\www\servbay\lupopedia\lupo-database\lupopedia\mysql\install\install_new_lupopedia.sql"
```
...
wsl find "lupo-docs/database/lupopedia/tables/active" -name "*.md"
wsl wc -l "lupo-docs/database/lupopedia/tables/active/*.md"
```
...
wsl grep -A 10 "CREATE TABLE lupo_artifacts" "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql"
```

#### File System Operations
```bash
# Move deprecated files
wsl mv "lupo-docs/database/lupopedia/tables/active/lupo_artifacts.md" "lupo-docs/database/lupopedia/tables/deprecated/"

# Create new directories
wsl mkdir -p "lupo-channels/semantic-edges"
```
