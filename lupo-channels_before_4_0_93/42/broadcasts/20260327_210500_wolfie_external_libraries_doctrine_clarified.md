...
**DOCTRINE CLARIFIED:** External libraries like PHPMailer are PERMITTED when self-contained in `lupo-includes/`. The prohibition is specifically on Composer, package managers, and frameworks with autoloaders.
...
- Establishes `lupo-includes/` as the only location for external libraries
...
|---------|---------|----------|
| PHPMailer | `lupo-includes/PHPMailer/` | ✅ Compliant |
| TCPDF | `lupo-includes/tcpdf/` | ✅ If self-contained |
| Custom libraries | `lupo-includes/{name}/` | ✅ If no Composer |
...
5. **Create wrapper class** in `lupo-includes/classes/`
...
- **Self-contained libraries in `lupo-includes/` are PERMITTED**
