...
#   file_path_from_root: "scripts/validate_review_headers.py"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/validate_review_headers.py"
#   status: "deprecated"
#   when_updated: "20260412171953"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "memory/development/canonical/1026/04/validate-review-headers.toon"
#   atoms_toon: null
...
which is not PRD 16 v4.0.99. **Always** use the universal envelope validator instead:
  ...
  python scripts/validate_lupopedia_headers_universal.py <path> [flags]
...
def main() -> int:
    if date.today() > _SHIM_EXPIRATION:
        sys.stderr.write(
            ...
            "Use: python scripts/validate_lupopedia_headers_universal.py <path> [flags]\n"
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "Example:\n"
            "  python scripts/validate_review_headers.py docs/prd/16_lupopedia_headers.md "
    ...
    if not os.path.isfile(vpy):
        sys.stderr.write(
            ...
            "Expected validate_lupopedia_headers_universal.py next to this script under scripts/.\n"
            % vpy.replace("\\", "/")
        )
        return 2
    ...
    sys.stderr.write(
        ...
        "    Use: python scripts/validate_lupopedia_headers_universal.py %s"
