...
#   file_path_from_root: "scripts/verify_db_against_toons.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
Compares current MySQL schema with TOON specifications in database/lupopedia/json/
...
TOON source: database/lupopedia/json/*.json (JSON format, authoritative).
"""
...
# Configuration
TOONS_DIR = "database/lupopedia/json"
OUTPUT_FILE = "docs/reports/DB_SCHEMA_DRIFT_4.0.24.md"
DB_NAME = "lupopedia"
...
def get_current_db_schema():
    ...
    if pymysql is None or get_connection_params is None:
        print("ERROR: pymysql or db_config not available. Install pymysql and ensure db_config.py is in scripts/.", file=sys.stderr)
        return {}
