...
Usage:
  python scripts/validate_trust_ladder_paths.py
  python scripts/validate_trust_ladder_paths.py --strict
  python scripts/validate_trust_ladder_paths.py --root docs/prd
"""
...
def main():
    ...
    print(
        ...
        "See docs/doctrine/CHRONOLOGICAL_TRUST_LADDER.md and "
        "docs/doctrine/TRUST_LADDER_DO_NOT_FIX.txt"
        % (len(all_v),)
    )
