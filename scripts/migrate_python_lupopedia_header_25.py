...
#   file_path_from_root: "scripts/migrate_python_lupopedia_header_25.py"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/migrate_python_lupopedia_header_25.py"
#   status: "complete"
#   when_updated: "20260411035853"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "memory/development/canonical/1026/04/migrate-python-lupopedia-header-25.toon"
#   atoms_toon: null
...
- Regenerate headers with ``python scripts/add_lupopedia_header_to_file.py`` (or batch
...
Usage:
  python scripts/migrate_python_lupopedia_header_25.py
"""
