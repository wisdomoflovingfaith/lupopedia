...
#   file_path_from_root: "scripts/import_filesystem_channels_to_db.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
artifacts under channels/ still exist but the database contains no channels, threads,
...
Usage:
  python scripts/import_filesystem_channels_to_db.py --repo-root .
  python scripts/import_filesystem_channels_to_db.py --repo-root . --channel 42
  python scripts/import_filesystem_channels_to_db.py --repo-root . --thread 1047
  python scripts/import_filesystem_channels_to_db.py --repo-root . --dry-run
  python scripts/import_filesystem_channels_to_db.py --repo-root . --strict
  python scripts/import_filesystem_channels_to_db.py --repo-root . --verbose
...
def discover_channels(repo_root: Path, channel_filter: int | None) -> list[ChannelRecord]:
    """Return list of channel dirs (integer-named) under channels/."""
