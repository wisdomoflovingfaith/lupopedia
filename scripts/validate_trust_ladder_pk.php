...
#   file_path_from_root: "scripts/validate_trust_ladder_pk.php"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/validate_trust_ladder_pk.php"
#   last_modified_utc: "20260412162124"
#   federation_node_id: 0
#   channel_key: "development"
#   trust_tier: "canonical"
#   memory_key: "memory/development/canonical/1026/04/validate-trust-ladder-pk.toon"
 ...
 *
 * Usage (repo root):
 *   php scripts/validate_trust_ladder_pk.php [--calendar-year=YYYY] [--no-db]
 *
 * Exit 0 = no errors; 1 = errors (CI).
 */

$repoRoot = dirname(__DIR__);
require_once $repoRoot . '/includes/classes/IdGenerator.php';
