 ...
 * --write-back uses AgentFileWriter (operator context): path must be under rules/, docs/,
 * channels/, or content/ with an allowed extension (see TODO.md H9). Root-level or other
...
if ($mdPath === '') {
    fwrite(STDERR, "Usage: php scripts/import_content.php <path/to/file.md> [--dry-run] [--write-back]\n");
