...
#   file_path_from_root: "scripts/normalize_lupopedia_md_header_25.py"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/normalize_lupopedia_md_header_25.py"
#   status: "complete"
#   when_updated: "20260415080730"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "memory/development/canonical/1026/04/normalize-lupopedia-md-header-25.toon"
#   atoms_toon: null
...
Usage:
  python scripts/normalize_lupopedia_md_header_25.py [--dry-run] [--check] [--backup] \\
...
def main() -> int:
    parser = argparse.ArgumentParser(
        ...
        epilog="Use --recursive when --path contains ** (e.g. docs/**/*.md).",
    )
    parser.add_argument(
        "--path",
        default="docs/prd/[0-9][0-9]_*.md",
