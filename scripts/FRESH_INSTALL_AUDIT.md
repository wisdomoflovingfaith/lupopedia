...
- [ ] Run `python scripts/verify_seed_data.py`
- [ ] All 13 actors present (including HEPHAESTUS)
- [ ] All 13 agents present
- [ ] Root auth user present
- [ ] If missing, run generated SQL from `scripts/seed_data.sql`
...
php scripts/seed_data_generator.php

# Import seed data SQL
mysql -u root -p lupopedia < scripts/seed_data.sql
