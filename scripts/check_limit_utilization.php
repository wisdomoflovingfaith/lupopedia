...
#   file_path_from_root: "scripts/check_limit_utilization.php"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/check_limit_utilization.php"
#   last_modified_utc: "20260412163625"
#   federation_node_id: 0
#   channel_key: "development"
#   trust_tier: "canonical"
#   memory_key: "memory/development/canonical/1026/04/check-limit-utilization.toon"
...
$prdDir = $repoRoot . DIRECTORY_SEPARATOR . 'docs' . DIRECTORY_SEPARATOR . 'prd';
$skip   = array(
    'PRD_INDEX.md' => true,
    'README.md' => true,
...
$seedCount = 0;
$regPath   = $repoRoot . DIRECTORY_SEPARATOR . 'database' . DIRECTORY_SEPARATOR . 'lupopedia' . DIRECTORY_SEPARATOR . 'actors' . DIRECTORY_SEPARATOR . 'registry.json';
if (is_file($regPath)) {
...
if (is_file($cfg)) {
    require_once $cfg;
    if (file_exists($repoRoot . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'bootstrap.php')) {
...
if ($writeReport) {
    $repDir = $repoRoot . DIRECTORY_SEPARATOR . 'docs' . DIRECTORY_SEPARATOR . 'reports';
    if (!is_dir($repDir)) {
