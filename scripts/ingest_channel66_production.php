...
lupopedia.headers:
  ...
  file_path_from_root: "scripts/ingest_channel66_production.php"
  questions_toon: null
  channel_id: 42
  actor_id: 102
  actor_name: "cursor"
 ...
 * 
 * Usage: php scripts/ingest_channel66_production.php [options]
 * 
 * Options:
...
try {
    ...
    require_once ABSPATH . 'includes/classes/Channel66ProductionConfig.php';
    require_once ABSPATH . 'includes/classes/Channel66ProductionIngester.php';
    require_once ABSPATH . 'includes/classes/Channel66ProductionErrorHandler.php';
    require_once ABSPATH . 'includes/classes/Channel66PerformanceMonitor.php';
    require_once ABSPATH . 'includes/classes/Channel66ProductionLogger.php';
    require_once ABSPATH . 'includes/classes/Channel66BatchProcessor.php';
...
function validateProductionConfig($configFile, $threadId, $batchSize, $memoryLimit) {
    ...
    $requiredDirs = array(
        ABSPATH . 'channels/66',
        ABSPATH . 'database/lupopedia/toon'
    );
