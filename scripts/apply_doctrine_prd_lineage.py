...
Usage:
  python scripts/apply_doctrine_prd_lineage.py --dry-run
  python scripts/apply_doctrine_prd_lineage.py --apply
  python scripts/apply_doctrine_prd_lineage.py --apply --emit-json path.json
"""
...
# PRD id -> filename slug under docs/prd/
PRD_SLUG = {
...
def prd_targets_in_fm(fm_text):
    """Return set of docs/prd/*.md paths found in outbound_edges (regex)."""
    found = set()
