...
#   file_path_from_root: "scripts/safe-migrate.php"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/safe-migrate.php"
#   last_modified_utc: "20260412162124"
#   federation_node_id: 0
#   channel_key: "development"
#   trust_tier: "canonical"
#   memory_key: "memory/development/canonical/1026/04/safe-migrate.toon"
...
#   pk_id: null
#   pk_slug: ""
#   title: "Safe migration runner (DB009)"
#   status: "complete"
#   parent_pk_id: "16"
#   summary: "Validates environment, dangerous-SQL gates, and audit logging; executes migration SQL via PDO_DB per SAFE_MIGRATION doctrine."
#   module: null
#   dialog_transcript: "0/development/safe-migrate"
# ---------------------------------------------------------------------
/**
 ...
 *
 * @see docs/doctrine/SAFE_MIGRATION_DOCTRINE.md
 * @see rules/root/safe-database-operations-doctrine.md
 */
...
require_once $config;
require_once $repo_root . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'bootstrap.php';

$migration_file = isset($argv[1]) ? trim($argv[1]) : '';
if ($migration_file === '') {
    fwrite(STDERR, "Usage: php scripts/safe-migrate.php <path/to/migration.sql>\n");
    exit(1);
}
...
$log_dir = $repo_root . DIRECTORY_SEPARATOR . 'logs' . DIRECTORY_SEPARATOR . 'migrations';
if (!is_dir($log_dir)) {
