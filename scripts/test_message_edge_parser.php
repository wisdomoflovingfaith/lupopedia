...
lupopedia.headers:
  ...
  file_path_from_root: "scripts/test_message_edge_parser.php"
  questions_toon: null
  channel_id: 42
  actor_id: 102
  actor_name: "cursor"
...
$tests = array(
    ...
    array(
        'name' => 'artifact link',
        'message' => 'Open [plan](docs/versions/4.0.86/PLAN.md).',
        'expected' => array(
            array('target_type' => 'artifact', 'target_id' => 'docs/versions/4.0.86/PLAN.md', 'edge_type' => 'reference', 'direction' => 'both', 'metadata_json' => '{}'),
        )
    ),
    array(
        'name' => 'task reference',
