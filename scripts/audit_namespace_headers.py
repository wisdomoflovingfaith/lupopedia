...
#   file_path_from_root: "scripts/audit_namespace_headers.py"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/audit_namespace_headers.py"
#   status: "complete"
#   when_updated: "20260411040000"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "memory/development/canonical/1026/04/audit-namespace-headers.toon"
#   atoms_toon: null
...
Run from repo root: python scripts/audit_namespace_headers.py
"""
...
TABLES_DIR = "docs/database/lupopedia/tables"
REPORT_PATH = "docs/status/module_audit_4_0_99.md"
...
def run_py_validator(root_dir, rel_path):
    ...
    try:
        proc = subprocess.Popen(
            [sys.executable, "scripts/validate_lupopedia_headers_universal.py", full],
            cwd=root_dir,
...
def main():
    ...
    other_dirs = ["docs/versions", "docs/status", "docs/doctrine", "rules", ".cursor"]
    ...
    lines = [
        "# Module audit (4.0.99)",
        "",
        "Generated by `scripts/audit_namespace_headers.py`. Doctrine: LUPOPEDIA_HEADERS_FORMAT.md §2.2; approved taxonomy: " + ", ".join(sorted(APPROVED_MODULES)) + ".",
        "",
        "---",
        "",
        "## Summary",
