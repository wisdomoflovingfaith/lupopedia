...
lupopedia.headers:
  ...
  file_path_from_root: "scripts/session_custodian.php"
  questions_toon: null
  channel_id: 42
  actor_id: 102
  actor_name: "cursor"
...
*/
/**
 * SessionCustodian — optional tool for Antigravity (or any IDE) to audit/correct database/sessions/*.md (4.0.69).
...
$sessionsDir = LUPOPEDIA_PATH . DIRECTORY_SEPARATOR . 'database' . DIRECTORY_SEPARATOR . 'sessions';
$auditOnly = true;
$dryRun = true;
