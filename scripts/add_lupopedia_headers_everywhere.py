...
#   file_path_from_root: "scripts/add_lupopedia_headers_everywhere.py"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/add_lupopedia_headers_everywhere.py"
#   status: "complete"
#   when_updated: "20260412161106"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "memory/development/canonical/1026/04/add-lupopedia-headers-everywhere.toon"
#   atoms_toon: null
...
Usage:
  python scripts/add_lupopedia_headers_everywhere.py --dry-run
  python scripts/add_lupopedia_headers_everywhere.py --under docs --under scripts
  python scripts/add_lupopedia_headers_everywhere.py --all-repo --dry-run
  python scripts/add_lupopedia_headers_everywhere.py --channel-key headers --trust-tier staging
  python scripts/add_lupopedia_headers_everywhere.py --thread-slug my-thread-slug ...
"""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=[],
        metavar="DIR",
        help="Repo-relative directory to scan (repeatable). Default: docs and scripts.",
    )
    parser.add_argument(
        "--all-repo",
        action="store_true",
