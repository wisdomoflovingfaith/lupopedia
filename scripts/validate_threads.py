...
#   file_path_from_root: "scripts/validate_threads.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
Usage:
  python scripts/validate_threads.py --repo-root . --channel 42
  python scripts/validate_threads.py --repo-root . --channel 42 --threads 1006
"""
...
def thread_has_continuity_flag(repo: Path, channel: int, tid: str) -> bool:
    base = repo / "channels" / str(channel) / "threads" / tid
    if not base.is_dir():
        return False
