...
This script imports context artifacts from the context/ folder into the database.
...
Usage:
    ...
    --root-path: Root path to scan (default: 'context/')
"""
...
try:
    ...
    print("   Ensure scripts/lib/db_connection.py exists.")
    sys.exit(1)
...
def validate_headers(headers: Dict, file_path: str, artifact_type: str) -> List[str]:
    ...
    # last_modified_utc: backward compat for pre-v4.0.99 headers (renamed to questions_toon).
