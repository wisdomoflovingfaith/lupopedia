...
#   file_path_from_root: "scripts/validate_todo_plan.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
Spec: channels/42/threads/1012/20260318_180800_hephaestus_spec_validator-complete.md

Usage:
  python scripts/validate_todo_plan.py --repo-root .
  python scripts/validate_todo_plan.py --repo-root . --warnings-as-errors
"""
