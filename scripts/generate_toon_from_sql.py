...
#   file_path_from_root: "scripts/generate_toon_from_sql.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
Canonical schema source: database/lupopedia/mysql/install/install_new_lupopedia.sql
Output: database/lupopedia/toon/<table_name>.toon.json
"""
...
def main() -> int:
    ...
    install_sql = project_root / "database" / "lupopedia" / "mysql" / "install" / "install_new_lupopedia.sql"
    output_dir = project_root / "database" / "lupopedia" / "toon"
