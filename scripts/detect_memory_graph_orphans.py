...
#   file_path_from_root: "scripts/detect_memory_graph_orphans.py"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/detect_memory_graph_orphans.py"
#   status: "complete"
#   when_updated: "20260415080730"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "memory/development/canonical/1026/04/detect-memory-graph-orphans.toon"
#   atoms_toon: null
...
3. **Mirror / export drift (separate signal)** — Lists **active** DB rows whose **memory_toon**
   looks like a **memory/...** path but the file is **missing** on disk. Per **PRD 38**,
...
Requires: **pymysql**, **db_config** / **lupopedia-config.php** parity with other **scripts**.

Usage:
  python scripts/detect_memory_graph_orphans.py --under docs/prd --json
  python scripts/detect_memory_graph_orphans.py --no-db --verbose
