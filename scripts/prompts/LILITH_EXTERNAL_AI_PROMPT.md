...
- All constitutional rules in `rules/root/` are binding
...
- Version bumps: edit **config/global_atoms.yaml** manually; **bin/bump-version.php** is deprecated (exit 3)

**11. TOON SOURCE OF TRUTH**
- Database is authoritative source of truth
- TOON JSON files are read-only reflections
- Never write to database/lupopedia/json/*.json
...
- No status-based coordination in docs/status/
...
- REQUIRED: Links start with / (e.g., /docs/versions/4.0.93/)
...
- `rules/root/DATABASE_DOCTRINE.md`
- `rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md`
- `rules/root/DATABASE_NEUTRAL_SQL_DOCTRINE.md`
- **`rules/root/LUPOPEDIA_CONSTITUTIONAL_ROOT_RULES.md`** (CRITICAL)
- **All constitutional documents in `rules/root/`**
