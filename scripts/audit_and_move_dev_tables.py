...
#   file_path_from_root: "scripts/audit_and_move_dev_tables.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
toon_dir = os.path.join(root_dir, 'database', 'lupopedia', 'toon')
docs_dir = os.path.join(root_dir, 'docs', 'database', 'lupopedia', 'tables', 'active')
...
for root, dirs, files in os.walk(root_dir):
    ...
    dirs[:] = [d for d in dirs if d not in ['.git', 'database', 'docs', '__pycache__', 'node_modules', 'vendor']]
