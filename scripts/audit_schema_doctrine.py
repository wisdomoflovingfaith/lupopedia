...
#   file_path_from_root: "scripts/audit_schema_doctrine.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
Uses TOON files in database/lupopedia/toon/ (or json/ for parsing). No DB connection.
...
JSON_DIR = BASE_DIR / "database" / "lupopedia" / "json"
...
def main():
    ...
    if not json_only:
        ...
        print("Schema source: database/lupopedia/toon")
