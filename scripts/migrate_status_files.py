...
#   file_path_from_root: "scripts/migrate_status_files.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
docs/versions/4.0.80/status_coordination_archive/

Does not delete docs/status/prompts/ or other files unless --extra specified.

Usage:
  python scripts/migrate_status_files.py --repo-root . --execute
  python scripts/migrate_status_files.py --repo-root .   # dry-run
"""
...
def main() -> int:
    ...
    ap.add_argument(
        "--dest",
        default="docs/versions/4.0.80/status_coordination_archive",
