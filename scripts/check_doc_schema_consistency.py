...
#   file_path_from_root: "scripts/check_doc_schema_consistency.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
TOON_DIR = os.path.join(ROOT, 'database', 'lupopedia', 'toon')
INSTALL_SQL = os.path.join(ROOT, 'database', 'lupopedia', 'mysql', 'install', 'install_new_lupopedia.sql')
