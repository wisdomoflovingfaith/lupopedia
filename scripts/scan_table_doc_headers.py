...
#   file_path_from_root: "scripts/scan_table_doc_headers.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
"""
Scan table documentation under docs/database/lupopedia/tables/ for
...
Usage: python scripts/scan_table_doc_headers.py
  (run from repo root)

Output: docs/status/table_doc_header_version_report_4_0_78.md
"""
...
REPORT_PATH = "docs/status/table_doc_header_version_report_4_0_78.md"
...
def write_report(results, root_dir, out_path):
    ...
    lines = [
        ...
        "",
        "Generated by `scripts/scan_table_doc_headers.py`. Use for controlled header/version cleanup; do not mass-edit without this report.",
        "",
        "---",
        "",
        "## Summary",
