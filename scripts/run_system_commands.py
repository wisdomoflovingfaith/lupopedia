...
#   file_path_from_root: "scripts/run_system_commands.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
def load_config():
    """DB params and table prefix from resolved lupopedia-config.php only (Python is not the installer)."""
...
def execute_command(job, config):
    ...
    if command_type == 'python_import_channels_and_artifacts':
        script = args.get('script', 'scripts/import_channels_and_artifacts.py')
