...
See: docs/doctrine/TRUST_LADDER_REGISTRY.md, CHRONOLOGICAL_TRUST_LADDER.md §10.
"""
...
DEFAULT_INSTALL_SQL = (
    PROJECT_ROOT / "database" / "lupopedia" / "mysql" / "install" / "install_new_lupopedia.sql"
)
DEFAULT_REGISTRY = PROJECT_ROOT / "docs" / "doctrine" / "TRUST_LADDER_REGISTRY.md"
