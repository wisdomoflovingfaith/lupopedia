...
Usage:
    python scripts/sync_trust_ladder_registry_to_db.py [options]
...
# ─────────────────────────────────────────────────────────────────────────────
# DB connection (lib.db_connection → resolved lupopedia-config.php only)
# ─────────────────────────────────────────────────────────────────────────────

def get_db_connection(args):
    """Return a MySQL DB-API connection and db_type 'mysql'."""
    ...
    try:
        ...
        raise RuntimeError(
            "Neither pymysql nor MySQLdb is installed. pip install pymysql and retry."
        ) from None
