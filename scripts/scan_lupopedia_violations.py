...
#   file_path_from_root: "scripts/scan_lupopedia_violations.py"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/scan_lupopedia_violations.py"
#   status: "active"
#   when_updated: "20260420080000"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "memory/development/canonical/1026/04/scan-lupopedia-violations.toon"
...
def is_valid_name(name: str) -> Tuple[bool, List[str]]:
    ...
    # Skip top-level * directories (these are the main Lupopedia directories)
    if name.startswith(''):
        return True, []
...
lupopedia.headers:
  header_format_version: "4.1.3"
  file_path_from_root: "memory/doctrine/canonical/filename-doctrine-enforcement-report.toon"
  web_path: "https://www.lupopedia.com/lupopedia/memory/doctrine/canonical/filename-doctrine-enforcement-report.toon"
  status: "active"
...
"""
    ...
    # Save TOON report
    toon_dir = root_path / 'memory' / 'doctrine' / 'canonical'
