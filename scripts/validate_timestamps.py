...
#   file_path_from_root: "scripts/validate_timestamps.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
Usage:
  ...
  python scripts/validate_timestamps.py --dry-run --json
  python scripts/validate_timestamps.py --rename-map rename_map.json --apply-rename-map
"""
