...
#   file_path_from_root: "scripts/generate_planning_toons.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
sql_file = r'C:\ServBay\www\servbay\lupopedia\database\lupopedia\mysql\install\future_features_lupopedia.sql'
output_dir = r'C:\ServBay\www\servbay\lupopedia\docs\database\lupopedia\tables\active\planning'
...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/active/planning/{filename}"
  questions_toon: null
  channel_id: 42
  actor_id: 1003
...
lupopedia.edges:
  ...
  outbound_edges:
    - {{ to: "database/lupopedia/mysql/install/future_features_lupopedia.sql", type: "schema_reference", weight: 1.0 }}
