...
#   file_path_from_root: "scripts/validate_channel_artifacts.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
Usage:
  ...
  python scripts/validate_channel_artifacts.py --repo-root . --channel 42 --enforce-project
  ...
  python scripts/validate_channel_artifacts.py --repo-root . --channel 42 --thread-validation
"""
...
def validate_channel(
    ...
    base = repo / "channels" / str(channel_id)
    if not base.is_dir():
