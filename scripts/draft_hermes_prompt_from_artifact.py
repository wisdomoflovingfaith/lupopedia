...
#   file_path_from_root: "scripts/draft_hermes_prompt_from_artifact.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
Usage:
  python scripts/draft_hermes_prompt_from_artifact.py \\
    --artifact channels/42/threads/1001/some.md --target wolfie --purpose stabilization
...
def main():
    ...
    ap.add_argument('--prompts-dir', default='', help='Default: channels/{id}/prompts')
    ...
    if args.prompts_dir:
        ...
        if not prompts_dir:
            ...
            prompts_dir = os.path.join(repo, 'channels', str(args.channel_id), 'prompts')
