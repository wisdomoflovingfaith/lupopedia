...
lupopedia.headers:
  ...
  file_path_from_root: "scripts/ingest_channel66_headers_bounded_authority.php"
  questions_toon: null
  channel_id: 42
  actor_id: 102
  actor_name: "cursor"
...
require_once ABSPATH . 'includes' . DIRECTORY_SEPARATOR . 'classes' . DIRECTORY_SEPARATOR . 'Channel66HeaderIngester.php';
...
$toonDir = isset($args['toon-dir']) ? (string)$args['toon-dir'] : (ABSPATH . 'database' . DIRECTORY_SEPARATOR . 'lupopedia' . DIRECTORY_SEPARATOR . 'toon');
