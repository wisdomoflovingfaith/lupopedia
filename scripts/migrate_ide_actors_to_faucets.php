...
lupopedia.headers:
  ...
  file_path_from_root: "scripts/migrate_ide_actors_to_faucets.php"
  questions_toon: null
  channel_id: 42
  actor_id: 102
  actor_name: "cursor"
...
/**
 * Find all .metadata.yaml files in actors directory.
 * 
 * @return array Array of file paths
 */
function find_metadata_files() {
    $metadataFiles = array();
    $actorsDir = dirname(__DIR__) . DIRECTORY_SEPARATOR . 'actors';
