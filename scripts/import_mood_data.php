...
lupopedia.headers:
  ...
  file_path_from_root: "scripts/import_mood_data.php"
  questions_toon: null
  channel_id: 42
  actor_id: 102
  actor_name: "cursor"
 ...
 * Default import directory: uploads/mood_data/
 * 
...
function import_mood_data($import_dir = null) {
    ...
    if ($import_dir === null) {
        $import_dir = dirname(__DIR__) . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . 'mood_data';
    }
