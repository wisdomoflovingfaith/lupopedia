...
lupopedia.headers:
  ...
  file_path_from_root: "scripts/verify_architecture_files.php"
  questions_toon: null
  channel_id: 42
  actor_id: 102
  actor_name: "cursor"
...
echo "✓ PHP Classes:\n";
$required_classes = [
    'TemporalTruthMonitor' => 'includes/classes/TemporalTruthMonitor.php',
    'GenesisDoctrineValidator' => 'includes/classes/GenesisDoctrineValidator.php',
    'LABSValidator' => 'includes/classes/LABSValidator.php',
    'ReverseShakaUTC2026' => 'includes/classes/ReverseShakaUTC2026.php',
    'ContinuityValidator' => 'includes/classes/ContinuityValidator.php',
    'ColorProtocol' => 'includes/classes/ColorProtocol.php'
];
...
$toon_dir = $base_dir . '/database/lupopedia/toon';
$required_toons = [
    'lupo_actors.toon',
    'lupo_agents.toon',
