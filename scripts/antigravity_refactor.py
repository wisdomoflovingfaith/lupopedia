...
#   file_path_from_root: "scripts/antigravity_refactor.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
with open("database/lupopedia/mysql/install/future_features_lupopedia.sql", "r", encoding="utf-8") as f:
    future_sql = f.read()

with open("database/lupopedia/mysql/install/install_new_lupopedia.sql", "r", encoding="utf-8") as f:
    install_sql = f.read()
...
with open("database/lupopedia/mysql/install/future_features_lupopedia.sql", "w", encoding="utf-8") as f:
    f.write(future_sql)

with open("database/lupopedia/mysql/install/install_new_lupopedia.sql", "w", encoding="utf-8") as f:
    f.write(install_sql)
