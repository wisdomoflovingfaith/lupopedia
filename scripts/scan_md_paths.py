...
#   file_path_from_root: "scripts/scan_md_paths.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
# minus legacy (which we might want to keep if legacy wasn't renamed to legacy).
...
def analyze_markdown_paths():
    ...
    # Negative lookbehind to avoid matching "scripts/" or "my_scripts/"
