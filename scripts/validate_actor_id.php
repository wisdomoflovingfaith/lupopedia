...
#   file_path_from_root: "scripts/validate_actor_id.php"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/validate_actor_id.php"
#   last_modified_utc: "20260412171224"
#   federation_node_id: 0
#   channel_key: "development"
#   trust_tier: "canonical"
#   memory_key: "memory/development/canonical/1026/04/validate-actor-id.toon"
...
#   status: "complete"
#   parent_pk_id: "00"
#   summary: "Validates seed actor band (actor_id 1-999 ceiling) against database/lupopedia/actors/registry.json; optional --id=N check."
#   module: "tooling"
 ...
 *
 * Usage:
 *   php scripts/validate_actor_id.php           (audit registry.json)
 *   php scripts/validate_actor_id.php --id=123  (single id check)
 */
...
$path = $repoRoot . DIRECTORY_SEPARATOR . 'database' . DIRECTORY_SEPARATOR . 'lupopedia' . DIRECTORY_SEPARATOR . 'actors' . DIRECTORY_SEPARATOR . 'registry.json';
if (!is_file($path)) {
