...
#   file_path_from_root: "scripts/db_config.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
See ``docs/doctrine/PYTHON_DB_CONFIG_AND_SECRETS_4.0.99.md``.
...
3. ``LUPOPEDIA_PATH / lupopedia-config.php`` (repository root — parent of **scripts/**)
...
def _repo_root() -> Path:
    """Filesystem root of the Lupopedia tree (directory that contains scripts/)."""
