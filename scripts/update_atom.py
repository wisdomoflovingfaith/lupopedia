#!/usr/bin/env python3
"""
scripts/update_atom.py — Update global atoms
...
ATOMS_PATH = PROJECT_ROOT / 'config' / 'global_atoms.json'
VERSION_FILE = PROJECT_ROOT / 'config' / 'CURRENT_LUPOPEDIA_VERSION.txt'
