...
#   file_path_from_root: "scripts/fix_unicode_box_drawing_ascii.py"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/fix_unicode_box_drawing_ascii.py"
#   status: "complete"
#   when_updated: "20260410192601"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "memory/development/canonical/1026/04/fix-unicode-box-drawing-ascii.toon"
#   atoms_toon: null
...
Default scope: ``docs/prd/**/*.md`` (recursive glob).

Usage:
  python scripts/fix_unicode_box_drawing_ascii.py [--path GLOB] [--dry-run] [--check] \\
