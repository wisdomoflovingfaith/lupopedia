 ...
 *
 * Usage:
 *   php scripts/generate_headers_from_db.php --file-path rules/root/X.md
 *   php scripts/generate_headers_from_db.php --content-id 123456
 *   php scripts/generate_headers_from_db.php --file-path X.md --dry-run
 *
 * Non-dry-run writes use AgentFileWriter (operator context): file must be under rules/,
 * docs/, channels/, or content/ with an allowed extension (TODO.md H9).
 */
...
require_once LUPOPEDIA_PATH . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'classes/DatabaseFactory.php';
require_once LUPOPEDIA_PATH . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'classes' . DIRECTORY_SEPARATOR . 'HeaderDbSync.php';
require_once LUPOPEDIA_PATH . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'classes' . DIRECTORY_SEPARATOR . 'AgentFileWriter.php';
...
if ($filePath === null && $contentId === null) {
    fwrite(STDERR, "Usage: php scripts/generate_headers_from_db.php --file-path <path> | --content-id <id> [--dry-run]\n");
    exit(2);
}
