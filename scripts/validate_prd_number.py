...
#   file_path_from_root: "scripts/validate_prd_number.py"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/validate_prd_number.py"
#   status: "complete"
#   when_updated: "20260412172857"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "memory/development/canonical/1026/04/validate-prd-number.toon"
#   atoms_toon: null
...
Rules:
  - Filenames under docs/prd/*.md (except PRD_INDEX.md, README, etc.) MUST match ^\d{2}_[^.]+\.md$
  - The two-digit prefix MUST NOT exceed 99.
  - If YAML pk_id or legacy prd_id is an int, it MUST be 0-99.

Exit 1 on violation. See docs/prd/99_limits_for_everything_and_why.md
