...
lupopedia.headers:
  ...
  file_path_from_root: "scripts/verify_dialog_messages.php"
  questions_toon: null
  channel_id: 42
  actor_id: 102
  actor_name: "cursor"
...
require_once dirname(__DIR__) . '/includes/bootstrap-cli.php';

require_once LUPOPEDIA_PATH . '/includes/functions/dialog-helpers.php';
