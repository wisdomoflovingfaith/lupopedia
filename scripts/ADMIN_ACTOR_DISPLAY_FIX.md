...
lupopedia.headers:
  ...
  path_from_lupopedia_root: scripts/ADMIN_ACTOR_DISPLAY_FIX.md
  web_path: https://www.lupopedia.com/lupopedia/scripts/ADMIN_ACTOR_DISPLAY_FIX.md
  status: null
  ...
  thread_key: admin-interface-fix
...
# file: ADMIN_ACTOR_DISPLAY_FIX.md — session: L-LUPO-WOLFIE — delegation: wolfie:root — web_path: http://www.lupopedia.com/scripts/ADMIN_ACTOR_DISPLAY_FIX.md
...
**File**: `includes/themes/default/layouts/admin_layout.php`
