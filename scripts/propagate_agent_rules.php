...
lupopedia.headers:
  ...
  file_path_from_root: "scripts/propagate_agent_rules.php"
  questions_toon: null
  channel_id: 42
  actor_id: 102
  actor_name: "cursor"
 ...
 *   php scripts/propagate_agent_rules.php --target=idea
 *   php scripts/propagate_agent_rules.php --target=jetbrains
 *   php scripts/propagate_agent_rules.php --target=cursor
 *   php scripts/propagate_agent_rules.php --target=kiro
 *   php scripts/propagate_agent_rules.php --target=cascade
 *   php scripts/propagate_agent_rules.php --target=vscode
 */

$repoRoot = dirname(__DIR__);
$rootDir = $repoRoot . DIRECTORY_SEPARATOR . 'rules' . DIRECTORY_SEPARATOR . 'root';
...
function build_rules_from_root($rootDir)
{
    ...
    foreach ($files as $file) {
        ...
        if ($rulesBlock === '') {
            $warnings[] = "WARN: missing lupopedia.rules block in rules/root/$base.md (skipped)";
            continue;
        }
        ...
        if ($ruleId === 'UNKNOWN') {
            $warnings[] = "WARN: missing rule_id in rules/root/$base.md (using UNKNOWN)";
        }
        if ($ruleText === 'Unknown Rule') {
            $warnings[] = "WARN: missing rule_text in rules/root/$base.md (using fallback)";
        }
        ...
        $rules[] = array(
            ...
            'slug' => $base,
            'source_path' => 'rules/root/' . $base . '.md',
...
function write_kiro_outputs($kiroDir, $rules)
{
    ...
    foreach ($rules as $rule) {
        ...
        $mdc .= "  source_path: \"rules/root/" . $rule['slug'] . ".md\"\n";
    ...
    $readme .= "## Propagation\n\n";
    $readme .= "Run: `php scripts/propagate_agent_rules.php --target=kiro`\n\n";
    $readme .= "## Source\n\n";
    $readme .= "All rules are derived from canonical root rules in `rules/root/`.\n";
    $readme .= "See [rules/root/README.md](../rules/root/README.md) for canonical rule documentation.\n";
...
function write_vscode_outputs($vscodeDir, $rules)
{
    ...
    $readme .= "  artifact_type: \"guide\"\n";
    $readme .= "  artifact_kind: \"documentation\"\n";
    $readme .= "  purpose: \"VS Code facet — Lupopedia rules derived from rules/root\"\n";
    $readme .= "---\n\n";
    ...
    $readme .= "## Propagation\n\n";
    $readme .= "Run: `php scripts/propagate_agent_rules.php --target=vscode`\n\n";
    $readme .= "## Source\n\n";
    $readme .= "Canonical rules: `rules/root/`. Facet identity: actor_id **106** (`vscode-ide`).\n";
...
function write_windsurf_outputs($windsurfDir, $rules)
{
    ...
    $readme .= "  next_action:\n";
    $readme .= "    - \"Run propagation: php scripts/propagate_agent_rules.php --target=windsurf\"\n";
    $readme .= "---\n\n";
    ...
    $readme .= "- **rules/** - Individual rule files with LUPOPEDIA HEADERS\n\n";
    $readme .= "## Propagation\n\n";
    $readme .= "Run: `php scripts/propagate_agent_rules.php --target=windsurf`\n\n";
    $readme .= "## Source\n\n";
    $readme .= "All rules are derived from canonical root rules in `rules/root/`.\n";
    $readme .= "See [rules/root/README.md](../../../rules/root/README.md) for canonical rule documentation.\n";
...
function write_lilith_outputs($lilithDir, $rules)
{
    ...
    $readme .= "This directory contains Lilith-specific rule artifacts and non-interference policy derived from canonical root rules in `rules/root/`.\n\n";
    $readme .= "## Propagation\n\n";
    $readme .= "Run: `php scripts/propagate_agent_rules.php --target=lilith`\n\n";
    $readme .= "## Source\n\n";
    $readme .= "All rules are derived from canonical root rules in `rules/root/`.\n";
    $readme .= "See [rules/root/README.md](../rules/root/README.md) for canonical rule documentation.\n";
...
function write_cascade_outputs($cascadeDir, $rules)
{
    ...
    $readme .= "  next_action:\n";
    $readme .= "    - \"Run propagation: php scripts/propagate_agent_rules.php --target=cascade\"\n";
    $readme .= "---\n\n";
    ...
    $readme .= "- **rules/** - Individual rule files with LUPOPEDIA HEADERS\n\n";
    $readme .= "## Propagation\n\n";
    $readme .= "Run: `php scripts/propagate_agent_rules.php --target=cascade`\n\n";
    $readme .= "## Source\n\n";
    $readme .= "All rules are derived from canonical root rules in `rules/root/`.\n";
    $readme .= "See [rules/root/README.md](../../../rules/root/README.md) for canonical rule documentation.\n";
...
function write_lexa_outputs($lexaDir, $rules)
{
    ...
    $readme .= "  next_action:\n";
    $readme .= "    - \"Run propagation: php scripts/propagate_agent_rules.php --target=lexa\"\n";
    $readme .= "---\n\n";
    ...
    $readme .= "- **rules/** - Individual rule files with LUPOPEDIA HEADERS\n\n";
    $readme .= "## Propagation\n\n";
    $readme .= "Run: `php scripts/propagate_agent_rules.php --target=lexa`\n\n";
    $readme .= "## Source\n\n";
    $readme .= "All rules are derived from canonical root rules in `rules/root/`.\n";
    $readme .= "See [rules/root/README.md](../../../rules/root/README.md) for canonical rule documentation.\n";
