...
#   file_path_from_root: "scripts/thoth_worker.py"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/thoth_worker.py"
#   status: "complete"
#   when_updated: "20260415104838"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "memory/development/canonical/1026/04/thoth-worker.toon"
...
GLOBAL_ATOM_PATH = "memory/atoms/lupopedia_global_constants.atom.toon"
...
def _extract_file_path_from_message_text(message_text: str) -> Optional[str]:
    for match in FILE_PATH_RE.findall(message_text or ""):
        ...
        if path.startswith(("", "README.md", "AGENTS.md", "CLAUDE.md", "TODO.md")):
            return path
    return None
