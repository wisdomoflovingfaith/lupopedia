...
#   file_path_from_root: "scripts/import_prd.py"
#   web_path: "https://www.lupopedia.com/lupopedia/scripts/import_prd.py"
#   status: "complete"
#   when_updated: "20260415224017"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "memory/development/canonical/1026/04/import-prd.toon"
#   atoms_toon: null
...
#   summary: "Validates docs/prd/*.md as artifact_type prd with content_parent_id null; runs import_content.py per file with --dry-run / --write-back / --append-history."
# ---------------------------------------------------------------------
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--all",
        action="store_true",
        help="Import every *.md in docs/prd/ (root only, not subfolders).",
    )
