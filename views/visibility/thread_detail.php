...
<body>
    <div class="container">
        ...
        <main>
            ...
            <?php if ($latest_artifact): ?>
                <section class="artifact-info">
                    ...
                    <div class="artifact-actions">
                        ...
                        <?php endif; ?>
                        <a href="/channels/<?php echo $thread['channel_id']; ?>/threads/<?php echo $thread['thread_id']; ?>/" 
                           target="_blank" 
            ...
            if (isset($_SESSION['auth_user_id'])) {
                require_once LUPOPEDIA_ABSPATH . '/includes/HumanRequestService.php';
    ...
    <script src="/views/visibility/js/navigation.js"></script>
</body>
</html>
