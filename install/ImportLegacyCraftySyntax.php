...
lupopedia.headers:
  ...
  file_path_from_root: "install/ImportLegacyCraftySyntax.php"
  web_path: "https://www.lupopedia.com/lupopedia/install/ImportLegacyCraftySyntax.php"
  status: "active"
  when_updated: "20260420180000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "memory/development/canonical/1026/04/import-legacy-crafty-syntax-php.toon"
  atoms_toon: null
...
class ImportLegacyCraftySyntax
{
    ...
    {
        $schemaDir = LUPOPEDIA_PATH . DIRECTORY_SEPARATOR . 'database' . DIRECTORY_SEPARATOR . 'lupopedia' . DIRECTORY_SEPARATOR . 'json';
