...
require_once LUPOPEDIA_PATH . '/includes/classes/AuthSessionManager.php';
...
<head>
    ...
    <link rel="stylesheet" href="<?= htmlspecialchars(LUPOPEDIA_PUBLIC_PATH) ?>/includes/css/main.css">
    <style>
...
<body>
    <div class="actor-selection-container">
        ...
        <?php else: ?>
            <p><em>No actors match this department filter. Choose "All" departments or another department.</em></p>
        <?php endif; ?>
