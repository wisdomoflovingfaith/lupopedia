...
- **4.1.0** will be the first version to support Lupopedia → Lupopedia upgrades. 4.1.0 will not be created until a stable 4.0.x release is published through auto-installers (e.g. Softaculous, Installatron). Until then, 4.0.x remains the development/stabilization series.
  ...
  file_path_from_root: "CHANGELOG_NEW.md"
  file_hash: "65f8cfb0f23f075411876cb292d8f19b150beedcd856276a9b05cf858cc508e4"
  system_version: "4.0.50"
  delegation_chain: null
  needs_review: ["delegation_chain"]
flare.footer:
...
flare.footer:
  ...
  last_verified_by: "windsurf"
  file_path_from_root: "CHANGELOG_NEW.md"
  file_hash: "8944f76da38e2546c944f6a702bf480770b922ef72c4c9f1ea79760d389fbea2"
  system_version: "4.0.50"
  delegation_chain: null
  needs_review: ["delegation_chain"]
flare.footer:
...
Agents: Research existing entries first; consolidate duplicates logically. After editing, run a simple validation (e.g., check that versions are in descending order).

---
# NEW ENTRIES GO HERE (keep newest on top)
...
**Focus**: Rolled-over tasks from v4.0.48  
...
**Status**: ✅ COMPLETED (tasks not done were rolled over to v4.0.49)
...
- ✅ **Relational Decoupling**: Migrated `outbound_edges` and `semantic_tags` into relational edges block.
- ✅ **Mandated Header Comments**: Codified requirement for canonical URL comments in headers (`http://www.lupopedia.com/lupopedia/content/FLARE`).
