...
flare.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["lupo-database\lupopedia\channels\lupo-channels\66\tasks\active\anubis_flare_ingestion_faucet.md"]
      runtime_scope: "cli"
      channels:
...
flare.headers:
  ...
  file_path_from_root: "lupo-database\lupopedia\channels\lupo-channels\66\tasks\active\anubis_flare_ingestion_faucet.md"
...
flame.see:
  mappings:
    - ["lupo-database\lupopedia\channels\lupo-channels\66\tasks\active\anubis_flare_ingestion_faucet.md", "http://www.lupopedia.com/ANUBIS_FLARE_INGESTION_FAUCET"]
