...
flare.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["lupo-database\lupopedia\channels\lupo-channels\42\tasks\completed\anubis_flare_ingestion_faucet.md"]
      runtime_scope: "cli"
      channels:
...
flare.headers:
  ...
  file_path_from_root: "lupo-database\lupopedia\channels\lupo-channels\42\tasks\completed\anubis_flare_ingestion_faucet.md"
  file_hash: "e9636b35f991a66d5f2c31d3baff9f54cfc393e751af3feabfdb8029369b74d2"
...
flame.see:
  mappings:
    - ["lupo-database\lupopedia\channels\lupo-channels\42\tasks\completed\anubis_flare_ingestion_faucet.md", "http://www.lupopedia.com/ANUBIS_FLARE_INGESTION_FAUCET"]
