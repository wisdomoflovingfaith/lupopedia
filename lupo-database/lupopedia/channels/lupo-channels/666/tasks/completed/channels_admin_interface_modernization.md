# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/666/tasks/completed/channels_admin_interface_modernization
...
flare.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["lupo-database/lupopedia/channels/lupo-channels/666/tasks/completed/channels_admin_interface_modernization.md"]
      runtime_scope: "cli"
      channels:
...
flare.headers:
  flare.version: "1.0"
  flare.schema: "task"
  file_path_from_root: "lupo-database/lupopedia/channels/lupo-channels/666/tasks/completed/channels_admin_interface_modernization.md"
...
flame.see:
  mappings:
    - ["lupo-database/lupopedia/channels/lupo-channels/666/tasks/completed/channels_admin_interface_modernization.md", "http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/666/tasks/completed/channels_admin_interface_modernization"]
