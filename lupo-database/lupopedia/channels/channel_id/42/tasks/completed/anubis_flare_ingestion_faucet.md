...
# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/42/tasks/completed/anubis_flare_ingestion_faucet
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["lupo-database/lupopedia/channels/lupo-channels/42/tasks/completed/anubis_flare_ingestion_faucet.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-database/lupopedia/channels/lupo-channels/42/tasks/completed/anubis_flare_ingestion_faucet.md"
  file_hash: "ed5ce8a5f4efd41c07ddb578354734bf80cd17233e946969abcb74acc83ae38c"
...
lupopedia.see:
  mappings:
    - ["lupo-database/lupopedia/channels/lupo-channels/42/tasks/completed/anubis_flare_ingestion_faucet.md", "http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/42/tasks/completed/anubis_flare_ingestion_faucet"]
...
**File Created**: `lupo-channels/42/actors/19/faucets.json`
