# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/42/tasks/completed/ACTOR-PORT-001
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["lupo-database/lupopedia/channels/lupo-channels/42/tasks/completed/ACTOR-PORT-001.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-database/lupopedia/channels/channel_id/42/tasks/completed/ACTOR-PORT-001.md"
...
lupopedia.see:
  mappings:
    - ["lupo-database/lupopedia/channels/lupo-channels/42/tasks/completed/ACTOR-PORT-001.md", "http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/42/tasks/completed/ACTOR-PORT-001"]
