# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/66/tasks/active/actor_help_documentation_validation
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["lupo-database/lupopedia/channels/lupo-channels/66/tasks/active/actor_help_documentation_validation.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-database/lupopedia/channels/channel_id/66/tasks/active/actor_help_documentation_validation.md"
...
lupopedia.see:
  mappings:
    - ["lupo-database/lupopedia/channels/lupo-channels/66/tasks/active/actor_help_documentation_validation.md", "http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/66/tasks/active/actor_help_documentation_validation"]
