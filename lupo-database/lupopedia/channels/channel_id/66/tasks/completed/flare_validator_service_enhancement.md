# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/66/tasks/completed/flare_validator_service_enhancement
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["lupo-database/lupopedia/channels/lupo-channels/66/tasks/completed/flare_validator_service_enhancement.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-database/lupopedia/channels/lupo-channels/66/tasks/completed/flare_validator_service_enhancement.md"
...
lupopedia.see:
  mappings:
    - ["lupo-database/lupopedia/channels/lupo-channels/66/tasks/completed/flare_validator_service_enhancement.md", "http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/66/tasks/completed/flare_validator_service_enhancement"]
