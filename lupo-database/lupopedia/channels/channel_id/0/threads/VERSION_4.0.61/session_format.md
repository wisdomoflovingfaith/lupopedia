...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-database/lupopedia/channels/channel_id/0/threads/VERSION_4.0.61/session_format.md"
...
- [lupo-database/session.md](../../../../../../session.md) — Live session file
