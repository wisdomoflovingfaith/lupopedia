...
- **Auth and actor context:** AuthService getUserByActorId, getUserByActorName, getUserByAuthUserId; ActorService getAuthUserIdForActor, getActorContext; AntigravityContext class; lupo-agents/antigravity/context.php; CLI auth, actor-context; docs/auth.md.
