...
flare.headers:
  flare.version: "1.0"
  file_path_from_root: "lupo-database/lupopedia/actors/actor_id/1/QUICK_REFERENCE.md"
  system_version: "4.0.56"
  channel_id: 42
  actor_id: 1003
  last_modified_utc: "20260303"
  artifact_type: "documentation"
  purpose: "Quick reference for Captain Wolfie AI (Actor 1)"
  tags: ["actor-1", "captain-wolfie", "quick-reference"]
---

# Actor 1 — Quick Reference (Captain Wolfie AI)

**Actor ID:** 1 | **Slug:** captain_wolfie (AI) | **Kind:** agent (core AI)
