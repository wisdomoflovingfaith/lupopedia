...
-- Attach rules to Channel 42 (applied_by_actor_id 10000 = root). Explicit rule_target_id per doctrine.
...
VALUES (1, 1, 'channels', 42, 10000, 100, @now, @now, 0, NULL);
INSERT INTO lupo_rule_targets (rule_target_id, rule_id, target_table, target_id, applied_by_actor_id, priority, created_ymdhis, updated_ymdhis, is_deleted, deleted_ymdhis)
VALUES (2, 2, 'channels', 42, 10000, 100, @now, @now, 0, NULL);
INSERT INTO lupo_rule_targets (rule_target_id, rule_id, target_table, target_id, applied_by_actor_id, priority, created_ymdhis, updated_ymdhis, is_deleted, deleted_ymdhis)
VALUES (3, 3, 'channels', 42, 10000, 100, @now, @now, 0, NULL);
INSERT INTO lupo_rule_targets (rule_target_id, rule_id, target_table, target_id, applied_by_actor_id, priority, created_ymdhis, updated_ymdhis, is_deleted, deleted_ymdhis)
VALUES (4, 4, 'channels', 42, 10000, 100, @now, @now, 0, NULL);
INSERT INTO lupo_rule_targets (rule_target_id, rule_id, target_table, target_id, applied_by_actor_id, priority, created_ymdhis, updated_ymdhis, is_deleted, deleted_ymdhis)
VALUES (5, 5, 'channels', 42, 10000, 100, @now, @now, 0, NULL);
...
INSERT INTO lupo_rule_targets (rule_target_id, rule_id, target_table, target_id, applied_by_actor_id, priority, created_ymdhis, updated_ymdhis, is_deleted, deleted_ymdhis)
VALUES (6, 1002, 'channels', 42, 10000, 100, @now, @now, 0, NULL);
