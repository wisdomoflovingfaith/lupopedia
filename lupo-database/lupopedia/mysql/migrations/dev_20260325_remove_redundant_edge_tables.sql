...
--
-- Code updated:
--   lupo-includes/classes/EmergentRoleDiscovery.php  — queries → lupo_edges
--   lupo-database/lupopedia/content/lupo-app/Services/ActorService.php — JOIN → lupo_edges
--   lupo-scripts/audit_schema_doctrine.php — removed from soft-delete list
--
