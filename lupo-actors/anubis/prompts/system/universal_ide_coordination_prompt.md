...
- lupo-database/lupopedia/actors/actor_id/registry.json (slug anubis)
- lupo-actors/anubis/docs/README.md
...
- lupo-actors/anubis/sessions/<human-slug>/YYYYMMDD/
...
- Roleplay and mood_rgb emotional messaging are prohibited for ANUBIS and reserved for ROSE/DIALOG only.
