...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-prompts/20260312_windsurf_audit_4.0.69_4.0.71_gap_check.md"
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "lupo-prompts/20260312_ide_agent_4.0.72_required_reading.md", type: "references", weight: 0.7 }
...
4. `lupo-prompts/20260312_ide_agent_4.0.72_required_reading.md`
...
- **Session Model A:** All remaining references to `$_SESSION['actor_id']` or legacy session behavior outside the explicitly-marked lupo-legacy/historical docs.
