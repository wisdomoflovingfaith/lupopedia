...
- lupo-database/
- lupo-scripts/
- all version-specific docs under lupo-docs/versions/
...
2. Create a session JSON under `lupo-channels/42/sessions/<human-slug>/YYYYMMDD/` named `<focus>_session_<NN>.json`.  
...
| Session traceability | All sessions must be stored under lupo-channels/42/sessions/… with the schema above |
