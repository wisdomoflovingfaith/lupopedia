...
2. Remove all status files from lupo-docs/status/ and create a README
...
public function handleBroadcast($channel_id, $from_actor_id, $message_text, $message_type = 'broadcast') {
    ...
    // Generate file in lupo-channels/{channel_id}/broadcasts/
    // Return message_id
}
...
public function handleDirectMessage($channel_id, $from_actor_id, $to_actor_id, $message_text, $message_type = 'direct') {
    ...
    // Generate file in lupo-channels/{channel_id}/direct/{to_actor_id}/
    // Return message_id
}
...
public function handleThreadMessage($channel_id, $thread_id, $from_actor_id, $message_text, $message_type = 'thread') {
    ...
    // Generate file in lupo-channels/{channel_id}/threads/{thread_id}/
    // Return message_id
}
...
- [ ] Create lupo-docs/status/README.md with deprecation notice
