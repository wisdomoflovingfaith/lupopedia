...
- Session: `{BASE}lupo-api/session/{action}` 
- Channel message: `{BASE}lupo-api/channel/{channel_id}/message` 
- Thread messages: `{BASE}lupo-api/thread/{thread_id}/messages` 
...
### Doctrine and rules
- lupo-rules/root/lilith-noninterference-doctrine.md (LIL001)
- lupo-rules/root/LILITH_CRITIQUE_DOCTRINE.md
- lupo-rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md
- AGENTS.md
- lupo-database/lupopedia/actors/actor_id/registry.json (actor identity resolution)
