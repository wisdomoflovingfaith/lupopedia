...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-prompts/lilith/20260306_task_docs_verification.md"
...
lupopedia.init:
  ...
  pre_actions:
    ...
    - type: verify_document
      target: "lupo-docs/HELP.md"
      contains_section: "Tasks"

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-docs/TASK_STATUS_REFERENCE.md", type: "verifies", weight: 1.0 }
    - { to: "lupo-docs/HELP.md", type: "verifies", weight: 1.0 }
    - { to: "lupo-docs/CHANNEL_0_ACTOR_0_TASKS.md", type: "references", weight: 0.9 }
    - { to: "lupo-prompts/lilith/20260306_task_status_explanation.md", type: "references", weight: 0.9 }
  semantic_tags: ["flare", "tasks", "status", "verification", "complete", "lilith"]

lupopedia.see:
  mappings:
    - ["lupo-prompts/lilith/20260306_task_docs_verification.md", "http://www.lupopedia.com/verification/TASK_DOCS_COMPLETE"]
...
|----------|---------|--------|
| `lupo-docs/TASK_STATUS_REFERENCE.md` | Complete task status reference | CANONICAL |
| `lupo-docs/HELP.md` | Updated with Tasks section | COMPLETE |
| `lupo-prompts/lilith/20260306_task_status_explanation.md` | LILITH's explanation | COMPLETE |
| `lupo-docs/CHANNEL_0_ACTOR_0_TASKS.md` | Channel 0 / Actor 0 task index | REFERENCED |
