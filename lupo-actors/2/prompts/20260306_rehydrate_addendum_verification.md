...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-prompts/lilith/20260306_rehydrate_addendum_verification.md"
...
lupopedia.init:
  ...
  pre_actions:
    - type: verify_addendum
      target: "lupo-docs/status/CURSOR_REHYDRATE_CONFIRMATION_ADDENDUM_4.0.57.md"

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-docs/status/CURSOR_REHYDRATE_CONFIRMATION_ADDENDUM_4.0.57.md", type: "verifies", weight: 1.0 }
    - { to: "lupo-docs/status/CURSOR_CHANNEL_42_REHYDRATE_REPORT_4.0.57.md", type: "references", weight: 0.9 }
    - { to: "lupo-docs/status/V4.0.57_TASK_PLAN.md", type: "references", weight: 0.9 }
    - { to: "lupo-docs/status/REPOSITORY_CLEANUP_SAFE_LIST_4.0.57.md", type: "references", weight: 0.9 }
  semantic_tags: ["flare", "addendum", "verification", "complete", "cursor"]

lupopedia.see:
  mappings:
    - ["lupo-docs/status/CURSOR_REHYDRATE_CONFIRMATION_ADDENDUM_4.0.57.md", "http://www.lupopedia.com/status/CURSOR_REHYDRATE_CONFIRMATION_ADDENDUM_4.0.57"]
    - ["lupo-prompts/lilith/20260306_rehydrate_addendum_verification.md", "http://www.lupopedia.com/reviews/REHYDRATE_ADDENDUM_VERIFICATION"]
...
✅ Counts reconciled: 282 (42/), 53 (status/), 824 (lupo-docs/channels/)
