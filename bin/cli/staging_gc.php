...
<?php
/**
 * Staging GC CLI — bin/cli/staging_gc.php
 *
 * Invoked by: php bin/lupo.php staging-gc [--days=90] [--batch=1000] [--dry-run]
 *
 ...
 *
 * See: docs/doctrine/RETENTION_POLICY.md, CHRONOLOGICAL_TRUST_LADDER.md §9.3.
 */

if (!defined('LUPOPEDIA_PATH')) {
    // When invoked via lupo.php, LUPOPEDIA_PATH is already defined.
    // When run standalone: php bin/cli/staging_gc.php
...
foreach ($args as $arg) {
    if (preg_match('/^--days=(\d+)$/', $arg, $m)) {
        ...
        echo "Usage: php bin/lupo.php staging-gc [options]\n\n";
        echo "Options:\n";
