 ...
 *
 * Usage:
 *   php bin/export.php --node-id 12345
 *   php bin/export.php --full
 *   php bin/export.php --since 20260401000000
 */
...
require_once $root . '/includes/classes/MemoryExportService.php';
...
fwrite(STDOUT, "Usage:\n");
fwrite(STDOUT, "  php bin/export.php --node-id 12345\n");
fwrite(STDOUT, "  php bin/export.php --full\n");
fwrite(STDOUT, "  php bin/export.php --since 20260401000000\n");
exit(1);
