...
require_once __DIR__ . '/../includes/functions/session_helpers.php';
require_once __DIR__ . '/../includes/functions/ai_activation.php';
require_once __DIR__ . '/../includes/classes/AI/AgentClasses.php';
...
class SystemAgentBoot
{
    ...
    {
        return 'L-0-' . bin2hex(lupo_random_bytes(8)) . '-' . gmdate('YmdHis');
    }
