...
#   file_path_from_root: "bin/agent_poll_tasks.php"
#   web_path: "https://www.lupopedia.com/lupopedia/bin/agent_poll_tasks.php"
#   status: "active"
#   when_updated: "20260416130413"
#   trust_tier: "staging"
#   questions_toon: null
#   memory_toon: "memory/development/staging/2026/04/agent-poll-tasks.toon"
#   atoms_toon: null
...
if ($argc < 2) {
    echo "Usage: php bin/agent_poll_tasks.php <actor_id> [channel_id] [--claim]\n";
    exit(1);
}
