 ...
 *
 * Usage: php bin/query_edges.php [namespace]
 *   php bin/query_edges.php lupopedia.code.logic
 *   php bin/query_edges.php   (all edges, no namespace filter)
 *
...
require_once LUPOPEDIA_PATH . 'includes' . DIRECTORY_SEPARATOR . 'bootstrap.php';
