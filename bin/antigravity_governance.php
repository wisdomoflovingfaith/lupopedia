 ...
 * Scans Markdown under docs/ for canonical Synthesized Documentation headers;
 * reports missing or invalid headers. PHP 7.4+ compatible. Uses LUPOPEDIA_PATH.
 *
 * Usage: php bin/antigravity_governance.php [path]
 *   php bin/antigravity_governance.php
 *   php bin/antigravity_governance.php docs/specs
 *
...
$scanPath = isset($argv[1]) && trim($argv[1]) !== '' ? trim($argv[1]) : (LUPOPEDIA_PATH . 'docs');
