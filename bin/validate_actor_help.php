...
---
flare.headers:
  file_path_from_root: "bin/validate_actor_help.php"
  file_hash: "<?php echo hash_file('bin/validate_actor_help.php'); ?>"
  ...
  purpose: "Validate actor help documentation completeness and quality against defined standards"
  mood_rgb: "4169E1"
...
flare.edges:
  ...
  outbound_edges:
    ...
    - { to: "channels/42/tasks/active/actor_help_documentation_validation_v2.md", type: "implements", weight: 0.9 }
