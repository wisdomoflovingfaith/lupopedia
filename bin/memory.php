<?php
require_once dirname(__DIR__) . '/includes/classes/MemoryGraph.php';

$cmd = isset($argv[1]) ? $argv[1] : '';

switch ($cmd) {
    case 'load-context':
        // Optional: php memory.php load-context memory/2026/04/M-foo.toon
    ...
    case 'set-active-ref':
        // php memory.php set-active-ref memory/2026/04/M-foo.toon
        if (empty($argv[2])) {
    ...
    default:
        ...
        echo "  php memory.php set-active-ref <memory/YYYY/MM/M-id.toon>\n";
        break;
}
