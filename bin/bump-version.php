 ...
 *   file_path_from_root: "bin/bump-version.php"
 *   web_path: "https://www.lupopedia.com/lupopedia/bin/bump-version.php"
 *   status: "deprecated"
 *   when_updated: "20260415180000"
 *   trust_tier: "canonical"
 *   questions_toon: null
 *   memory_toon: "memory/development/canonical/1026/04/bump-version-deprecation.toon"
...
================================================================================
DEPRECATED: bin/bump-version.php (4.0.99+)
================================================================================
...
Single source of truth: memory/atoms/lupopedia_global_constants.atom.toon
  - constants.versioning.current_lupopedia_version
Legacy mirror: config/global_atoms.yaml
  - GLOBAL_CURRENT_LUPOPEDIA_VERSION
  - version

Manual workflow:
  1. Read docs/doctrine/VERSIONING_DOCTRINE.md (especially sections 3 and 10).
...
Legacy copy (same behavior): bin/legacy/bump-version.php
Further context: bin/legacy/README.md
================================================================================
