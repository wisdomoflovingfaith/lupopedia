...
lupopedia.footer:
  outbound_edges:
    ...
    - { to: "lupo-docs/toons/", type: "references", weight: 0.7 }
...
- `lupo-docs/database/lupopedia/tables/` — Complete table documentation and schema reference
- `lupo-docs/doctrine/` — Non-negotiable development rules
- `lupo-docs/toons/` — Schema source of truth
- `lupo-channels/` — Offline governance (broadcasts/tasks/actors)
- `lupo-legacy/craftysyntax/` — Read-only reference code
