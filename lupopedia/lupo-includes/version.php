...
$current_version = $version_from_atom !== null ? $version_from_atom : '2026.1.1.12';
...
if (!defined('LUPOPEDIA_VERSION_DATE')) {
    define('LUPOPEDIA_VERSION_DATE', 20260124203200);
}
...
function lupopedia_get_version() {
    ...
    return defined('LUPOPEDIA_VERSION') ? LUPOPEDIA_VERSION : '2026.1.1.12';
}
