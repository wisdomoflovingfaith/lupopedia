...
//         Copyright (C) 2003-2009 Eric Gerdes   (https://lupopedia.com )
// ----------------------------------------------------------------------------
...
function csgetimage(){	 
   ...
   cscontrol = new Image;      	 
	 var u = 'image.php?randu=' + randu + '&department=<?php echo intval($department); ?>&what=channelcheck&cslhVISITOR=<?php echo $identity['SESSIONID']; ?>&dieat=<?php echo $dieat; ?>';
