    ...
    if (typeof chatelement!='undefined') { 
  	...
  	if(res_typeof=="HTML"){  
	    if( res_timeof>HTMLtimeof ){    
         ...
         up();         
           try {     
            if((window.parent.topof.document.mine.typing_alert_new.checked) && (<?php echo $jsrn; ?> != res_jsrn)){            	
...
function update_typing(){
  if(starttyping_layer_exists == true){     	              
    ...
    if(foundtext == 1){
    	fulloutput = '<TABLE BORDER=0 WIDTH=300><TR BGCOLOR=#000000><TD><TABLE BORDER=0 WIDTH=100% CELLPADDING=0 CELLSPACING=0 BORDER=0><TR><TD width=1 BGCOLOR=#D4DCF2><img src=images/blank.gif width=7 height=120></TD><TD BGCOLOR=#D4DCF2 valign=top><table width=300 bgoclor=DFDFDF><tr><td width=90%><?php echo str_replace("'","\\'",$lang['istyping']); ?></td><td width=10%><a href=javascript:istyping_Layer.hide();><b>X</b></a></td></tr></table><br>' + ouputtext + '</TD></TR></TABLE></TD></TR></TABLE>';
        istyping_Layer.show();
...
?>
 ...
 function callitnow(){
 	 // For some reason BEYOND me this needs to be called in a setTimeout.. 
