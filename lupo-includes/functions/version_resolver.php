 ...
 * 2. lupo-includes/version.php runtime helper (secondary)
 * 3. lupo-config/version.php config fallback (tertiary)
 * 
...
function get_lupopedia_system_version()
{
    ...
    $configVersionFile = __DIR__ . '/../../lupo-config/version.php';
