...
class MessageBuilder
{
    ...
    public function createMessage($channelId, $messageData)
    {
        try {
            ...
            // Insert message
            $sql = "INSERT INTO lupo_dialog_messages (
    ...
    {
        try {
            $sql = "SELECT * FROM lupo_dialog_messages 
    ...
    {
        try {
            $sql = "SELECT COUNT(*) FROM lupo_dialog_messages WHERE channel_id = :channel_id AND is_deleted = 0";
            $stmt = $this->db->prepare($sql);
    ...
    public function deleteMessage($messageId)
    {
        try {
            ...
            $getChannelSql = "SELECT channel_id FROM lupo_dialog_messages WHERE dialog_message_id = :dialog_message_id";
            ...
            $timestamp = $this->generateTimestamp();
            $sql = "UPDATE lupo_dialog_messages 
