...
$current_version = $version_from_atom !== null ? $version_from_atom : '4.0.47';
...
if (!defined('LUPOPEDIA_VERSION_DATE')) {
    define('LUPOPEDIA_VERSION_DATE', 20260226040000);
}
...
function lupopedia_get_version()
{
    ...
    return defined('LUPOPEDIA_VERSION') ? LUPOPEDIA_VERSION : '4.0.47';
}
