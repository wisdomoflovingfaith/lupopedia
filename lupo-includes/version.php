...
$current_version = $version_from_atom !== null ? $version_from_atom : '4.0.67';
...
if (!defined('LUPOPEDIA_VERSION_DATE')) {
    define('LUPOPEDIA_VERSION_DATE', 20260308050000);
}
...
function lupopedia_get_version()
{
    ...
    return defined('LUPOPEDIA_VERSION') ? LUPOPEDIA_VERSION : '4.0.67';
}
...
{
    return function_exists('lupopedia_get_version') ? lupopedia_get_version() : (defined('LUPOPEDIA_VERSION') ? LUPOPEDIA_VERSION : '4.0.67');
}
