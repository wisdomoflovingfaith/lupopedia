...
class AdminActorsHandler
{
    ...
    private static function getActors($db, $prefix, $filter_type, $filter_status)
    {
        ...
        $sql = "SELECT 
                    ...
                    a.actor_type,
                    a.is_agent,
                    (SELECT MIN(ad1.department_id) FROM {$prefix}actor_departments ad1 WHERE ad1.actor_id = a.actor_id AND (ad1.is_deleted = 0 OR ad1.is_deleted IS NULL)) AS department_id,
                    a.actor_source_type,
                    a.actor_source_id,
                    a.is_active,
                    a.created_ymdhis,
