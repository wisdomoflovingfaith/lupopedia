...
class AdminSemanticWidgetHandler
{
    ...
    public static function render($db, $prefix, $base)
    {
        ...
        $html .= '<textarea id="lupo-semantic-snippet-rel" readonly="readonly" rows="4" class="admin-input" style="width:100%;max-width:56rem;font-family:monospace;font-size:0.85rem;">' . htmlspecialchars($snippetRelPlain, ENT_QUOTES, 'UTF-8') . '</textarea>';
        $html .= '<p><button type="button" class="admin-link" id="lupo-semantic-copy-rel">' . htmlspecialchars(lupo_t('admin.semantic.copy', 'Copy to clipboard'), ENT_QUOTES, 'UTF-8') . '</button></p>';
        ...
        $html .= '<textarea id="lupo-semantic-snippet-abs" readonly="readonly" rows="4" class="admin-input" style="width:100%;max-width:56rem;font-family:monospace;font-size:0.85rem;">' . htmlspecialchars($snippetAbsPlain, ENT_QUOTES, 'UTF-8') . '</textarea>';
        $html .= '<p><button type="button" class="admin-link" id="lupo-semantic-copy-abs">' . htmlspecialchars(lupo_t('admin.semantic.copy', 'Copy to clipboard'), ENT_QUOTES, 'UTF-8') . '</button></p>';
        ...
        $html .= '<p class="admin-muted">' . htmlspecialchars(lupo_t('admin.semantic.doc_ref', 'Spec: lupo-docs/prd/21_semantic_navbar.md (API shape, external sites, CORS).'), ENT_QUOTES, 'UTF-8') . '</p>';
        ...
        $html .= '<script type="text/javascript">'
            ...
            . '}'
            . 'var b1=document.getElementById("lupo-semantic-copy-abs");'
            . 'var b2=document.getElementById("lupo-semantic-copy-rel");'
            . 'if(b1)b1.onclick=function(){copy("lupo-semantic-snippet-abs");};'
            . 'if(b2)b2.onclick=function(){copy("lupo-semantic-snippet-rel");};'
            . '})();</script>';
