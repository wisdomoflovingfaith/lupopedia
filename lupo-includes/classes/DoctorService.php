...
class DoctorService
{
    ...
    /**
     * @return string Full path to DOCTOR actor logs (lupo-actors/doctor/logs/)
     */
    public function getLogsDir()
    {
        $dir = $this->abspath . 'lupo-actors/doctor/logs/';
        if (!is_dir($dir)) {
            @mkdir($dir, 0755, true);
        }
        return $dir;
    ...
    /**
     * @return string Full path to DOCTOR actor reports (lupo-actors/doctor/reports/)
     */
    public function getReportsDir()
    {
        $dir = $this->abspath . 'lupo-actors/doctor/reports/';
        if (!is_dir($dir)) {
            @mkdir($dir, 0755, true);
        }
        return $dir;
