...
class ActorLookup
{
    ...
    /**
     * Load registry from lupo-database/lupopedia/actors/registry.json.
     *
     * @return array
     */
    private static function loadRegistry()
    {
        ...
        $path = $base . DIRECTORY_SEPARATOR . 'lupo-database' . DIRECTORY_SEPARATOR . 'lupopedia' . DIRECTORY_SEPARATOR . 'actors' . DIRECTORY_SEPARATOR . 'registry.json';
