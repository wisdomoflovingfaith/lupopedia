...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/prd/14_system_operations.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/prd/14_system_operations.md"
  ...
  purpose: "PRD for system operations, configuration, and maintenance database tables"
  tags:
  - "prd"
  - "database"
  - "namespace"
...
lupopedia.edges:
  outbound_edges:
    ...
    - to: "lupo-docs/prd/01_core_identity.md"
      type: references
      weight: 1.0
      reason: "System operations require identity"
    - to: "lupo-docs/prd/08_governance_rules.md"
      type: references
      weight: 1.0
      reason: "System operations interact with governance"
lupopedia.footer:
...
| `lupo_documentation_frameworks` | Documentation framework definitions | `framework_id` | Documentation system management |
