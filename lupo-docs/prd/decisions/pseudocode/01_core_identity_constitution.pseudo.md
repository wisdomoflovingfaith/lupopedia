...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/prd/decisions/pseudocode/01_core_identity_constitution.pseudo.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/prd/decisions/pseudocode/01_core_identity_constitution.pseudo.md"
  ...
  purpose: "Token-efficient shorthand for PRD 1 — PRD: Core Identity Database Tables"
  tags:
    - pseudocode
    - constitution
    - shorthand
...
---
# PRD 1: PRD: Core Identity Database Tables — Shorthand
...
| `lupo_actor_memory` | Learned behavior |
...
- ✅ MUST respect soft delete: **`UPDATE … SET is_deleted = 1, deleted_ymdhis = :now`**, not hard `DELETE`, unless an explicit constitutional exemption is documented for a scratch table class
- ✅ MUST use deterministic timestamp BIGINT IDs in `YYYYMMDDHHIISS + 4 random digits` format (minimum `202601010000000000`)
- ✅ MUST belong to a row whose stored IP fingerprint is compatible with the current client (e
- ✅ MUST not collapse unrelated users into one session
...
*Source: `lupo-docs/prd/01_core_identity.md`*
