...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/versions/4.0.96/status/PRD_CONSISTENCY_AUDIT_20260407225301.md
  web_path: http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.96/status/PRD_CONSISTENCY_AUDIT_20260407225301.md
  last_modified_utc: "20260407225301"
  when_updated: "20260407225301"
  federation_node_id: 0
  channel_id: 42
  artifact_type: documentation
  artifact_kind: audit
  purpose: "PRD sweep — full constitutional compliance audit of all lupo-docs/prd/*.md files against PRD 00 rules"
  tags:
    - prd
    - audit
    - constitutional
...
lupopedia.edges:
  outbound_edges:
    - to: lupo-docs/prd/00_root_constitutional_system_requirements.md
      type: references
      weight: 1.0
      reason: Constitutional anchor — all checks derived from PRD 00
    - to: lupo-docs/versions/4.0.96/status/PRD_REVIEW_DISCREPANCIES_AND_IMPROVEMENTS_20260407224750.md
      type: references
      weight: 0.9
      reason: Previous audit by LILITH (actor_id 2) — cross-referenced, not duplicated
lupopedia.footer:
  last_verified: "20260407225301"
  verified_by:
    identity_type: actor
    actor_id: 116
...
**Audit scope:** All `lupo-docs/prd/*.md` files (54 files)  
...
**Temporal anchor:** `20260407225301` (from `lupo-bin/temporal_anchor.json`; last session end)  
**Note:** Operator should run `python lupo-bin/tick.py` to refresh the anchor before next session writes.
...
VIOLATION: 27_installer_requirements.md - file_path_from_root has leading slash
  Value: "/lupo-docs/prd/27_installer_requirements.md"
  Fix: Remove the leading "/" → "lupo-docs/prd/27_installer_requirements.md"
```
...
**Rule:** PRD 00 §6 / §9.9 — Legacy `.toon.json` paths are deprecated. Use `lupo-database/lupopedia/json/<table>.json`.

```
VIOLATION: 05_auth_user_actor_agent_transformation.md - Legacy .toon.json reference in edges
  - to: "lupo-database/lupopedia/toon/lupo_actor_auth_users.toon.json" (line 132)
  Fix: → "lupo-database/lupopedia/json/lupo_actor_auth_users.json"

VIOLATION: 18_channel_chat_display.md - Legacy .toon reference in body
  - "lupo-database/lupopedia/toon/lupo_dialog_messages.toon" (line 122)
  Fix: → "lupo-database/lupopedia/json/lupo_dialog_messages.json"

VIOLATION: 36_rose_multi_persona_synthetic_dialog.md - Multiple legacy .toon references
  - Edge: to: "lupo-database/lupopedia/toon/lupo_dialog_messages.toon" (line 60)
  - Body: "lupo-database/lupopedia/toon/lupo_dialog_messages.toon" (line 206)
  - Body: "Schema TOON: lupo-database/lupopedia/toon/lupo_dialog_messages.toon" (line 285)
  Fix: Update all three to json/ path

VIOLATION: 37_kairos_channel_memory_consolidation.md - Multiple legacy .toon references
  - Edge: to: "lupo-database/lupopedia/toon/lupo_actor_memory.toon" (line 60)
  - Edge: to: "lupo-database/lupopedia/toon/lupo_edges.toon" (line 64)
  - Edge: to: "lupo-database/lupopedia/toon/lupo_dialog_messages.toon" (line 68)
  - Body: "lupo-database/lupopedia/toon/lupo_actor_memory.toon" (line 171)
  - Body: "lupo-database/lupopedia/toon/lupo_edges.toon" (line 175)
...
| 15_actors.md | DEPRECATED note; `lupo-memory/YYYY/MM/` as export mirror | ✅ |
...
All 54 `.md` files in `lupo-docs/prd/` have `lupopedia.headers:` frontmatter. ✅
...
| PRD | Reason |
|-----|--------|
| `08_actors.md` | Already SUPERSEDED by `15_actors.md`; body and header both note this. No content referenced as authoritative. Recommend: add `status: deprecated` to header, move to `lupo-docs/prd/deprecated/` if desired |
