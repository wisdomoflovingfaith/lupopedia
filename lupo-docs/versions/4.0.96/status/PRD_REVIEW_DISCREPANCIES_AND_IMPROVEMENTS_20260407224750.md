...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/versions/4.0.96/status/PRD_REVIEW_DISCREPANCIES_AND_IMPROVEMENTS_20260407224750.md
  web_path: http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.96/status/PRD_REVIEW_DISCREPANCIES_AND_IMPROVEMENTS_20260407224750.md
  last_modified_utc: "20260407224750"
  when_updated: "20260407224750"
  federation_node_id: 0
  channel_id: 42
  artifact_type: documentation
  artifact_kind: audit
  purpose: "PRD sweep notes — numbering drift, memory model conflicts, schema/doc mismatches, suggested fixes"
  tags:
    - prd
    - audit
    - "4.0.96"
lupopedia.footer:
  last_verified: "20260407224750"
  verified_by:
    actor_id: 102
...
This file records findings from a pass over `lupo-docs/prd/*.md` (index, README, and cross-file consistency). It is not a full line-by-line audit of every PRD section.
...
3. Regenerate **TOON** files for `lupo_memory_nodes` / `lupo_memory_edges` after install SQL is stable (`lupo-scripts/generate_toon_from_sql.py` or project-standard generator).
