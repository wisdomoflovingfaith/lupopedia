...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.96/note_on_seed_range.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.96/note_on_seed_range.md"
  last_modified_utc: "20260408114106"
  ...
  purpose: "Handoff note to Claude on reduced trust-ladder seed range for 4.0.96"
  tags:
    - note
    - seed_range
    - trust_ladder
...
Script location: `lupo-scripts/sync_trust_ladder_registry_to_db.py`
...
- `lupo-includes/classes/DatabaseFactory.php`
