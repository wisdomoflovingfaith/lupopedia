...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.96/SUMMARY.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.96/SUMMARY.md"
  ...
  purpose: "One-paragraph goals summary for Lupopedia 4.0.96"
  tags: ["version", "4.0.96", "summary", "cursor"]
lupopedia.footer:
...
# file: lupo-docs/versions/4.0.96/SUMMARY.md — delegation: cursor:root
...
| WHERE  | All PRDs, schema, actor registry, lupo-content/, version docs (see CHANGELOG.md) |
...
- memory.json deprecated; root memory nodes in lupo-memory/YYYY/MM/{memory_slug}.json
- Claude Code actor created (actor_id 116); registry and docs updated
- File-backed content system and canonical lupo-content/ structure
...
| WHERE  | `lupo-docs/doctrine/` (CHRONOLOGICAL_TRUST_LADDER, TRUST_LADDER_REGISTRY, RETENTION_POLICY); `lupo-includes/classes/IdGenerator.php`; `app/Services/Kairos/KairosConsolidationService.php`; `lupo-scripts/validate_trust_ladder_registry.py`; `lupo-content/.../captains_log/`; `lupo-docs/versions/4.0.96/` |
