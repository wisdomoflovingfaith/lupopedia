...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/3.0.x/doctrine/DIRECTORY_STRUCTURE_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/3.0.x/doctrine/DIRECTORY_STRUCTURE_DOCTRINE.md"
  last_modified_utc: "20260403114427"
  purpose: "Frozen copy of pre-4.0.x DIRECTORY_STRUCTURE doctrine (3.0.x era); superseded by lupo-docs/doctrine/DIRECTORY_STRUCTURE_DOCTRINE.md"
  superseded_by: "lupo-docs/doctrine/DIRECTORY_STRUCTURE_DOCTRINE.md"
  delegation_chain: "wolfie:root"
  actor_id: 1
  actor_name: "wolfie"
lupopedia.edges:
  outbound_edges:
    - to: "lupo-docs/doctrine/DIRECTORY_STRUCTURE_DOCTRINE.md"
      type: references
      weight: 1.0
      reason: "Canonical 4.0.x directory structure doctrine replaces this snapshot"
lupopedia.footer:
  ...
  verified_by:
    ...
    name: "lilith"
  next_action:
    - "Do not edit live doctrine here; canonical file is lupo-docs/doctrine/DIRECTORY_STRUCTURE_DOCTRINE.md"
---
