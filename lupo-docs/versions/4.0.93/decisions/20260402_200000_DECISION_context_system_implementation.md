...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.93/decisions/20260402_200000_DECISION_context_system_implementation.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.93/decisions/20260402_200000_DECISION_context_system_implementation.md"
  ...
  purpose: "Decision to implement context system for decision documentation"
  tags:
  - "decision"
  - "context"
  - "documentation"
...
Implement a context system in `lupo-contexts/Decisions/` to organize decision documentation with two primary contexts:
...
- **lupo-contexts/Decisions/README.md**: Context overview
