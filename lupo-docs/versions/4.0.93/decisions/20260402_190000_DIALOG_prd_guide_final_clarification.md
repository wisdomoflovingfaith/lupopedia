...
lupopedia.headers:
  ...
  artifact_kind: "audit"
  purpose: "LILITH Audit: PRD Development Guide — Final Clarification of Decision Contexts"
  tags:
  - "audit"
  - "prd"
  - "clarification"
...
|---------|----------|-------|---------|
| **Version-scoped** | `lupo-docs/versions/{version}/decisions/` | System-wide | Architecture decisions for a specific Lupopedia version |
| **PRD-scoped** | `lupo-docs/implementations/{id}_{slug}/decisions/` | PRD-specific | Design decisions for a single PRD implementation |
