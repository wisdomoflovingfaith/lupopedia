...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.93/DATABASE_AUDIT_REPORT.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.93/DATABASE_AUDIT_REPORT.md"
  ...
  purpose: "Detailed audit results for all 166 database tables"
  tags:
  - "database"
  - "audit"
  - "compliance"
...
- **PRDs**: N/A
- **Columns**: 0
- **Status**: ❌ REMOVED from install SQL
