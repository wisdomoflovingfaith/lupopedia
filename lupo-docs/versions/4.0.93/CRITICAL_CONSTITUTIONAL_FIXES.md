...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.93/CRITICAL_CONSTITUTIONAL_FIXES.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.93/CRITICAL_CONSTITUTIONAL_FIXES.md"
  last_modified_utc: "20260330163400"
  channel_id: 42
  ...
  purpose: "Critical fixes to constitutional requirements to prevent doctrine drift"
  tags:
  - "constitutional"
  - "critical"
  - "doctrine"
...
lupopedia.edges:
  outbound_edges:
    - to: "lupo-docs/prd/00_root_constitutional_system_requirements.md"
      type: references
      weight: 1.0
      reason: "Root constitutional requirements updated"
    - to: "lupo-rules/root/"
      type: references
      weight: 1.0
      reason: "Binding constitutional law directory"
lupopedia.footer:
  last_verified: "20260330163400"
  verified_by:
    actor_id: 102
...
### 1. ✅ **Explicit Binding Rule for lupo-rules/root/**
