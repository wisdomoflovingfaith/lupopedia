...
lupopedia.footer:
  ...
  next_action:
    - "Use [TABLE_DOCUMENTATION_4_0_77_STOP_LINE.md](../../status/TABLE_DOCUMENTATION_4_0_77_STOP_LINE.md) for pattern and priorities"
---
...
17. **Namespace audit**
    - [x] [audit_namespace_headers.py](../../../lupo-scripts/audit_namespace_headers.py) and [namespace_audit_4_0_78.md](../../status/namespace_audit_4_0_78.md); artifact-type policy (table required; others optional TBD) (Cursor).
