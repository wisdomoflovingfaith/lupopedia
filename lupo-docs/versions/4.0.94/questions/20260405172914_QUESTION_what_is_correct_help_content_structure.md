...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.94/questions/20260405172914_QUESTION_what_is_correct_help_content_structure.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.94/questions/20260405172914_QUESTION_what_is_correct_help_content_structure.md"
  last_modified_utc: "20260405172914"
  federation_node_id: 0
  channel_id: 42
  thread_id: "4.0.94-help-content-organization"
  question_id: "20260405172914"
  slug: "what-is-correct-help-content-structure"
  title: "What is the correct folder structure for user-side help content?"
  actor_id: 10000
  actor_name: "USER"
  delegation_chain: "user:root"
  artifact_type: "question"
  artifact_kind: "structural"
  purpose: "Question about proper organization of help content in lupo-content directory"
  tags:
  - "question"
  - "help_content"
  - "folder_structure"
...
lupopedia.edges:
  outbound_edges:
    - to: "answers/20260405172914_ANSWER_channel_key_based_organization.md"
      type: "has_answer"
      weight: 1.0
      reason: "Answer explains channel_key-based structure"
    - to: "lupo-docs/prd/29_project_structure.md"
      type: "references"
      weight: 0.8
      reason: "PRD 29 discusses project structure including lupo-content"
    - to: "lupo-docs/prd/02_channels_discussions.md"
      type: "references"
      weight: 0.8
      reason: "PRD 02 covers channel filesystem layout"
lupopedia.footer:
...
I thought the structure of the content directory was `lupo-content\{federation_node_id}\{channel/folder/thread}\{content_file_title}`. Do we have a PRD on how content is organized for that folder in the PRD files? I was a bit confused to see `lupo-content/0/0/`. Maybe we need to look at how we are organizing that content.
...
1. **Unclear Structure:** The `lupo-content/0/0/` structure doesn't match the expected pattern
...
- `lupo-content/0/0/` uses numeric channel_id (0) which is non-semantic
- Development channel (42) shouldn't be used for user-facing help
- No clear dedicated channel for help documentation

### Desired Improvements
- Use `lupo-content/{federation_node_id}/{channel_key}/{content_file}` format
