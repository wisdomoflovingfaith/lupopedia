...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.94/decisions/20260406_200000_DECISION_APPROVED_schema_review_chronos_activation_migration_docs.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.94/decisions/20260406_200000_DECISION_APPROVED_schema_review_chronos_activation_migration_docs.md"
  last_modified_utc: "20260406200000"
  ...
  author:
    ...
    id: 102
    name: "claude-code"
  delegation_chain: "claude-code:wolfie"
  artifact_type: "decision"
  artifact_kind: "approved"
  purpose: "Decision record for schema review, CHRONOS activation, and Crafty migration doc updates — 2026-04-06 20:00 UTC"
  tags: ["decision", "schema", "chronos", "migration", "4.0.94", "claude-code"]
lupopedia.footer:
  last_verified: "20260406200000"
  verified_by:
    identity_type: actor
    actor_id: 102
    agent_name_identity: "claude-code"
  orchestrator: "claude-code:wolfie"
---
...
**WHERE:** `lupo-database/`, `lupo-agents/chronos/`, `lupo-docs/database/lupopedia/tables/migrations/`
...
**HOW:**
- Read `lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql` in 11 chunks
...
- `lupo-database/lupopedia/mysql/schema_review/schema_review_20260406.md` — full flaw analysis
- `lupo-database/lupopedia/mysql/schema_review/schema_corrected_core.sql` — corrected DDL (21 tables)
- `lupo-database/lupopedia/mysql/schema_review/schema_corrected_missing.sql` — 10 new tables
- `lupo-database/lupopedia/mysql/schema_review/schema_corrected_identity_model.md` — corrected identity model and relationships
