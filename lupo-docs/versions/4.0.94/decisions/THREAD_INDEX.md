...
lupopedia.headers:
  ...
  purpose: "Index of version-scoped decisions for 4.0.94"
  tags:
  - "decisions"
  - "4.0.94"
lupopedia.edges:
  outbound_edges:
    - to: "lupo-docs/versions/4.0.93/decisions/THREAD_INDEX.md"
      type: references
      weight: 0.9
      reason: "Prior version decision index"
...
# file: lupo-docs/versions/4.0.94/decisions/THREAD_INDEX.md — delegation: cursor:root

# Version 4.0.94 — Decisions

| ID | Type | Title | Status | Date | Link |
|----|------|-------|--------|------|------|
| 20260407_015813 | DECISION | RECORDED: merge `schema_review` corrected SQL into `install_new_lupopedia.sql` + table diff + follow-ups (Cursor thread) | RECORDED | 2026-04-07 | [20260407_015813_DECISION_cursor_install_schema_merge_receipt.md](20260407_015813_DECISION_cursor_install_schema_merge_receipt.md) |
| 20260406_200000 | DECISION | APPROVED: schema review (168 tables), CHRONOS kernel activation, Crafty migration doc update (claude-code thread) | APPROVED | 2026-04-06 | [20260406_200000_DECISION_APPROVED_schema_review_chronos_activation_migration_docs.md](20260406_200000_DECISION_APPROVED_schema_review_chronos_activation_migration_docs.md) |
| 20260406_173021 | DECISION | APPROVED: **4.0.94** folder — 5W1H documentation sync close-out (handoff to **4.0.95** / **`FOR_CLAUDE_CODE`** / root **`CHANGELOG`**) | APPROVED | 2026-04-06 | [20260406_173021_DECISION_version_4_0_94_five_w_one_h_doc_sync_closeout.md](20260406_173021_DECISION_version_4_0_94_five_w_one_h_doc_sync_closeout.md) |
...
| 20260403_022543 | DECISION | APPROVED: PRD 33 Softaculous / 4.1.0 gate documentation + 4.0.94 sync | APPROVED | 2026-04-03 | [20260403_022543_DECISION_APPROVED_prd33_softaculous_gate_documentation.md](20260403_022543_DECISION_APPROVED_prd33_softaculous_gate_documentation.md) |
| 20260402_234551 | DECISION | APPROVED: IDE facet packs + VS Code propagation + registry doc alignment | APPROVED | 2026-04-02 | [20260402_234551_DECISION_APPROVED_ide_facet_packs_vscode_propagation.md](20260402_234551_DECISION_APPROVED_ide_facet_packs_vscode_propagation.md) |
| 20260404_200000 | DECISION | APPROVED: documentation coordination (channels, PRD 17, Mood RGB, root README) | APPROVED | 2026-04-04 | [20260404_200000_DECISION_APPROVED_documentation_coordination_channel_semantic_mood_rgb.md](20260404_200000_DECISION_APPROVED_documentation_coordination_channel_semantic_mood_rgb.md) |
| 20260402_225223 | DECISION | APPROVED: Cursor thread — identity + temporal docs + version sync scope | APPROVED | 2026-04-02 | [20260402_225223_DECISION_APPROVED_cursor_thread_identity_temporal_docs.md](20260402_225223_DECISION_APPROVED_cursor_thread_identity_temporal_docs.md) |
| 20260402_220000 | DECISION | Create Actor Authority and Agent Roles Framework | COMPLETE | 2026-04-02 | [20260402_220000_DECISION_actor_authority_prd32.md](20260402_220000_DECISION_actor_authority_prd32.md) |
| 20260402_210000 | DECISION | Implement comprehensive channel and documentation framework | COMPLETE | 2026-04-02 | [20260402_210000_DECISION_channel_docs_framework.md](20260402_210000_DECISION_channel_docs_framework.md) |

Use filenames `YYYYMMDD_HHIISS_DECISION_title.md`, `YYYYMMDD_HHIISS_DIALOG_title.md`, or `YYYYMMDD_HHIISS_DIRECTIVE_title.md` (UTC).
