...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.80/status_coordination_archive/multi_agent_doctrine_alignment_4_0_80.md"
  channel_id: 42
  actor_id: 102
  actor_name: "cursor"
...
| [lilith_report_on_lupopedia.md](../../../../lupo-docs/status/lilith_report_on_lupopedia.md) | Lilith clarified as **not** among the eleven primaries; LIL001 unchanged |
...
| [MULTI_AGENT_COORDINATION_DOCTRINE.md](../../../../lupo-rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md) | §7.1 “10” → **eleven** Primary Coordination Personas (internal consistency) |
...
- Older versioned TODO/PLAN under `lupo-docs/versions/4.0.77`–`4.0.79` — not rewritten.

## 4. Current coordination truth (summary)

| Topic | Authority |
|-------|-----------|
| Personas & flow | `lupo-rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md` |
| Artifacts | `lupo-channels/{channel_id}/` + version archive; doctrine artifact prefixes |
...
| Tasks | `lupo-docs/versions/<current>/TODO.md` + registry / AGENTS for actor IDs |
