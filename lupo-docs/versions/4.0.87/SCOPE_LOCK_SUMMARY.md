---
lupopedia.headers:
  file_path_from_root: lupo-docs/versions/4.0.87/SCOPE_LOCK_SUMMARY.md
  last_modified_utc: '20260325104751'
  channel_id: 42
  ...
  purpose: Scope lock summary for version 4.0.87.
  when_updated: '20260325104751'
  web_path: http://www.lupopedia.com/lupo-docs/versions/4.0.87/SCOPE_LOCK_SUMMARY.md
  delegation_chain: cursor:root
lupopedia.footer:
  last_verified: '20260325104751'
...
- Channel stream for `lupo-*` folder organization, deprecated artifact cleanup, and `lupo-docs` accuracy reconciliation
- Channel 63 stream for table/edge documentation under `lupo-docs/database/lupopedia/tables`
