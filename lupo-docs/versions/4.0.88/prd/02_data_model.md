...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.88/prd/02_data_model.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.88/prd/02_data_model.md"
...
lupopedia.footer:
  ...
  next_action:
    ...
    - "Follow lupo-rules/root/ database design principles"
---
...
All database design MUST follow the rules in `lupo-rules/root/`:
...
This table exists in CSV fallback (`lupo-database/lupopedia/csv/lupo_visits.csv`) and may exist in install SQL. If not in install SQL, it needs to be added.
...
2. Create a one-time migration: `lupo-database/lupopedia/mysql/migrations/migration_20260326_semantic_monitoring_v4_0_88.sql`
3. Run through `php lupo-scripts/safe-migrate.php` (DB009 doctrine)
4. Generate TOON files: `python lupo-scripts/generate_toon_from_sql.py`
