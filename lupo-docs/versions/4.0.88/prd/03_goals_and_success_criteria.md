...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.88/prd/03_goals_and_success_criteria.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.88/prd/03_goals_and_success_criteria.md"
  ...
  artifact_type: "prd"
  artifact_kind: "goals"
  purpose: "Version goals, phased delivery plan, and success criteria for 4.0.88 semantic monitoring"
  tags: ["4.0.88", "prd", "goals", "success_criteria", "phases"]
...
lupopedia.footer:
  ...
  orchestrator: "wolfie"
  next_action:
    - "Get Captain Wolfie sign-off on phase ordering and success criteria"
    - "Add engagement tracking goals to success criteria"
...
**Files to study:**
- `lupo-archive/legacy/craftysyntax-3.7.5/gc.php` - Session processing
- `lupo-archive/legacy/craftysyntax-3.7.5/functions.php` - `archivefootsteps()` function
- `lupo-archive/legacy/craftysyntax-3.7.5/livehelp_visit_track` table structure
- `lupo-archive/legacy/craftysyntax-3.7.5/livehelp_paths_*` tables
...
- `lupo-includes/modules/api/semantic-api.php` — extend or create
- `lupo-api/` endpoints
...
**Files modified/created:**
- `lupo-includes/modules/engagement/engagement-controller.php` — NEW
- `lupo-includes/modules/engagement/engagement-model.php` — NEW
