...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.88/CRAFTY_SYNTAX_PARITY.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.88/CRAFTY_SYNTAX_PARITY.md"
  ...
  purpose: "Complete Crafty Syntax 3.7.5 feature parity mapping and migration guide"
  tags: ["4.0.88", "crafty_syntax", "parity", "migration", "feature_mapping"]

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-archive/legacy/craftysyntax-3.7.5/", type: "references", weight: 1.0 }
    - { to: "lupo-docs/doctrine/migrations/", type: "implements", weight: 1.0 }
    - { to: "lupo-docs/database/lupopedia/tables/active/", type: "maps_to", weight: 1.0 }
    - { to: "livehelp_js.php", type: "enhances", weight: 1.0 }
    - { to: "image.php", type: "enhances", weight: 1.0 }
...
lupopedia.footer:
  ...
  orchestrator: "wolfie"
  next_action:
    - "Complete feature audit against Crafty Syntax 3.7.5 source"
    - "Implement missing features identified in parity matrix"
    - "Test migration path from Crafty Syntax to Lupopedia"
---
