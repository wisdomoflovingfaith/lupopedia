---
lupopedia.headers:
  file_path_from_root: lupo-docs/versions/4.0.88/PATH_HASH_VERIFICATION.md
  last_modified_utc: '20260326155700'
  artifact_type: verification_report
  purpose: Verify path hash implementation in generate_content_id.py
  traits:
  - canonical
...
lupopedia.edges:
  outbound_edges:
  - to: lupo-scripts/generate_content_id.py
    type: references
lupopedia.footer:
  verified_by: CURSOR (actor_id=102, via stress test)
  verification_method: Static code inspection + Runtime stress test
  status: VERIFIED
---
...
**Location**: `lupo-scripts/generate_content_id.py`, lines ~60-73
...
**Location**: `lupo-scripts/generate_content_id.py`, lines ~76-126
...
**Command**:
```bash
python lupo-scripts/test_content_id_stress.py
```
...
✅ lupo-channels/42/threads/1001/file.md         → 471195
✅ lupo-chats/chat_002.md                        → 374221
...
```
File 1: lupo-channels/42/threads/1001/msg1.md
File 2: lupo-channels/42/threads/1001/msg2.md
...
```
File 1 path hash: compute_file_path_hash("lupo-channels/42/threads/1001/msg1.md") = 471195

File 2 path hash: compute_file_path_hash("lupo-channels/42/threads/1001/msg2.md") = 614288
                                                                          ^
                                                                        Different char
...
grep -A 20 "def compute_file_path_hash" lupo-scripts/generate_content_id.py

# See it being called
grep -B 5 -A 5 "path_int = compute_file_path_hash" lupo-scripts/generate_content_id.py

# See it being included in ID
grep -B 2 -A 2 "path_int:06d" lupo-scripts/generate_content_id.py
```
...
python lupo-scripts/generate_content_id.py test
...
- [generate_content_id.py](../../lupo-scripts/generate_content_id.py) — Source code
- [test_content_id_stress.py](../../lupo-scripts/test_content_id_stress.py) — Verification test suite
