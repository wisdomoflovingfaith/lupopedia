...
**file_path_from_root:** lupo-docs/versions/4.0.88/PHP56_COMPATIBILITY_DOCTRINE_ENFORCEMENT.md  
**web_path:** http://www.lupopedia.com/lupo-docs/versions/4.0.88/PHP56_COMPATIBILITY_DOCTRINE_ENFORCEMENT.md  
...
**File:** `lupo-rules/root/PHP_VERSION_COMPATIBILITY.md`
...
**File:** `lupo-rules/root/NO_COMPOSER_DOCTRINE.md`
...
**Permitted:**
- Self-contained libraries in `lupo-includes/` (per EXTERNAL_LIBRARIES_DOCTRINE)

**Status:** ✅ ACTIVE

### 3. No Framework Doctrine
**File:** `lupo-rules/root/NO_FRAMEWORK_DOCTRINE.md`
...
**File:** `lupo-rules/root/SHARED_HOSTING_DOCTRINE.md`
...
**File:** `lupo-rules/root/EXTERNAL_LIBRARIES_DOCTRINE.md`
...
1. **Blade Template Files:** 2 files found
   - `lupo-database/lupopedia/content/lupo-app/views/admin/authentication/index.blade.php`
   - `lupo-database/lupopedia/content/lupo-app/views/admin/authentication/mapping.blade.php`
...
**✅ PHPMailer Compliant:**
- Located in `lupo-includes/PHPMailer/`
...
**File:** `lupo-includes/classes/EmailService.php`
...
### 1. Root Rules README
**File:** `lupo-rules/root/README.md`
...
### 4. Rules Summary
**File:** `lupo-docs/status/LUPOPEDIA_RULES_COMPREHENSIVE_SUMMARY.md`
