...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.85/database_changes/schema_reconciliation_and_toon_state.md"
  ...
  purpose: "Canonical 4.0.85 schema reconciliation, TOON parity, and research-boundary state derived from Thread 2004 final outcomes."
---
