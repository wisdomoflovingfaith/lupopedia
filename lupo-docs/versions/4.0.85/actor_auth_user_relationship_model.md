...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.85/actor_auth_user_relationship_model.md"
  ...
  artifact_kind: "guide"
  purpose: "Defines the canonical many-to-many auth_user to actor relationship model for supporting-human routing"
  tags: ["actors", "auth_users", "relationship_model", "routing", "schema", "many_to_many", "thread_2011"]

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "documents", weight: 1.0, reason: "Schema authority for table definition" }
    - { to: "lupo-docs/versions/4.0.85/TASK_REGISTRY.md", type: "references", weight: 0.9, reason: "Task authority" }
