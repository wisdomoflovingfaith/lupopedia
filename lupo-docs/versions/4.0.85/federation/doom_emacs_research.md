...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.85/federation/doom_emacs_research.md"
  ...
  purpose: "Canonical research mapping of Doom Emacs structural patterns into Lupopedia task/edge and decision-lineage concepts."

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/42/threads/2005/THREAD_INDEX.md", type: "thread_context", weight: 1.0, reason: "Publication thread context" }
    - { to: "lupo-research/doom_emacs/README.md", type: "analyzes", weight: 1.0, reason: "Source corpus root" }
    - { to: "lupo-research/doom_emacs/early-init.el", type: "analyzes", weight: 1.0, reason: "Bootstrap and startup sequencing evidence" }
    - { to: "lupo-research/doom_emacs/lisp/doom.el", type: "analyzes", weight: 1.0, reason: "Core load-order and lifecycle hooks evidence" }
    - { to: "lupo-research/doom_emacs/static/init.example.el", type: "analyzes", weight: 0.95, reason: "Module selection and ordering surface" }
    - { to: "lupo-research/doom_emacs/docs/getting_started.org", type: "analyzes", weight: 1.0, reason: "Module anatomy and load order documentation" }
    - { to: "lupo-research/doom_emacs/modules/ui/treemacs/packages.el", type: "analyzes", weight: 0.9, reason: "Cross-module dependency gating patterns" }
    - { to: "lupo-research/doom_emacs/modules/ui/treemacs/doctor.el", type: "analyzes", weight: 0.9, reason: "Constraint/assertion pattern evidence" }
    - { to: "lupo-research/doom_emacs/modules/ui/window-select/packages.el", type: "analyzes", weight: 0.9, reason: "Conditional package-branching pattern evidence" }
---
