...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.85/federation/bmad_research.md"
  ...
  purpose: "Research mapping of BMAD Method workflow, orchestration, and dependency patterns into Lupopedia task and edge semantics."

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-docs/versions/4.0.85/TASK_REGISTRY.md", type: "references", weight: 1.0, reason: "Research is registered as a 4.0.85 task artifact" }
    - { to: "lupo-channels/42/threads/1050/THREAD_INDEX.md", type: "thread_context", weight: 1.0, reason: "Channel 42 thread for this research" }
    - { to: "lupo-research/bmad_method/docs/reference/workflow-map.md", type: "analyzes", weight: 1.0, reason: "Primary BMAD phase and workflow map" }
    - { to: "lupo-research/bmad_method/src/bmm-skills/module.yaml", type: "analyzes", weight: 0.95, reason: "Declares BMAD artifact directories and module structure" }
    - { to: "lupo-research/bmad_method/src/bmm-skills/4-implementation/bmad-sprint-status/workflow.md", type: "analyzes", weight: 0.95, reason: "Status routing and next workflow recommendation logic" }
    - { to: "lupo-research/bmad_method/src/bmm-skills/4-implementation/bmad-correct-course/workflow.md", type: "analyzes", weight: 0.9, reason: "Change impact and rerouting workflow" }
    - { to: "lupo-research/bmad_method/src/bmm-skills/4-implementation/bmad-create-story/workflow.md", type: "analyzes", weight: 0.9, reason: "Story context construction and backlog-to-ready progression" }
---
