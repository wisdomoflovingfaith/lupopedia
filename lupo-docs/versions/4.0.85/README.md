...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.85/README.md"
  ...
  purpose: "Entry point and orientation guide for Lupopedia 4.0.85 version documentation."
---
...
- how mood_rgb is allowed to carry authority versus numeric influence
...
### 5. mood_rgb doctrine structurally resolved (Thread 2015)
4.0.85 now defines mood_rgb as a hybrid system:
...
| `lupo-database/lupopedia/toon/*.toon` | column type reference | generated from install SQL; never hand-edited |
...
| doctrine_changes/mood_rgb_hybrid_model.md | canonical version-scoped summary of Thread 2015 mood_rgb structural resolution |
