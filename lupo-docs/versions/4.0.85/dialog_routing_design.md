...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.85/dialog_routing_design.md"
  ...
  purpose: "Canonical 4.0.85 final state for deterministic actor-to-human routing MVP, including implemented corrections and compliant runtime behavior"
  tags: ["dialog", "routing", "escalation", "athena", "design", "deterministic", "traceability", "thread_2012", "corrected"]

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-docs/versions/4.0.85/actor_auth_user_relationship_model.md", type: "builds_on", weight: 1.0, reason: "Uses many-to-many actor/auth_user support model" }
    - { to: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "references", weight: 0.9, reason: "Schema authority for actor/auth/dialog tables" }
    - { to: "lupo-docs/versions/4.0.85/TASK_REGISTRY.md", type: "references", weight: 0.8, reason: "Task authority" }

lupopedia.footer:
  last_updated: "20260322_170850"
