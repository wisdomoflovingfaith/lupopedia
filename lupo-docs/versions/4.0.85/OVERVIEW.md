...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.85/OVERVIEW.md"
  ...
  purpose: "Overview of Lupopedia 4.0.85 â€” stabilization, TOON parity, documentation finalization."
---
...
| mood_rgb hybrid authority model resolved | COMPLETE | 2015 |
...
Thread 2015 matters because it resolved the structural conflict in mood_rgb semantics. Canonical tokens now carry decision authority, while non-canonical RGB values remain routing influence only.
...
- mood_rgb semantics now use a hybrid authoritative-token plus vector-influence model
