...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.89/crafty_syntax_backlog.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.89/crafty_syntax_backlog.md"
  ...
  purpose: Crafty Syntax feature parity backlog and implementation tracking
  mood_rgb: "666666"
  traits: ["crafty_syntax", "feature_parity", "backlog_tracking", "legacy_analysis"]
  tags: ["4.0.89", "crafty_syntax", "backlog", "feature_parity", "legacy"]

lupopedia.edges:
  outbound_edges:
    - { to: "TODO.md", type: "generates", weight: 1.0 }
    - { to: "PLAN.md", type: "references", weight: 1.0 }
    - { to: "lupo-docs/versions/4.0.88/crafty_syntax_backlog.md", type: "carries_forward", weight: 0.9 }
...
lupopedia.footer:
  ...
  orchestrator: "26:1"
  next_action:
    - "Execute high-priority features from backlog"
    - "Complete legacy code analysis"
    - "Update backlog as features are implemented"
---
...
**Status**: Planned  
**Owner**: HEPHAESTUS  
**Source**: lupo-docs/versions/4.0.88/prd/04_lupopedia_js_foundation.md  
...
**Status**: In Progress  
**Owner**: HEPHAESTUS  
**Source**: lupo-docs/versions/4.0.88/LIVEHELP_OPERATOR_DASHBOARD_SESSION_20260326.md  
