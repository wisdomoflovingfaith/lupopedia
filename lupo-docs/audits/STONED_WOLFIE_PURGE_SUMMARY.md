...
| File | Reason |
|------|--------|
| `lupo-docs/channels/doctrine/QUANTUM_STATE_DOCTRINE.md` | STONED WOLFIE / quantum doctrine; not part of canonical Lupopedia doctrine |
| `lupo-docs/channels/doctrine/SCHRODINGERS_STATE_BLOCK.md` | Schrödinger-state metadata specification; deprecated |
...
| `lupo-docs/channels/doctrine/MANDATORY_STONED_WARNINGS_DOCTRINE.md` | STONED WOLFIE mandatory-warnings doctrine; deprecated |
| `lupo-docs/channels/developer/templates/QUANTUM_WOLFIE_HEADER_TEMPLATE.md` | Quantum/Schrödinger-state header template; deprecated |
| `lupo-docs/channels/doctrine/DIALOG_WARNING_HEADER_TEMPLATE.md` | Stoned Wolfie warning template; deprecated |
...
- **lupo-docs/channels/doctrine/INDEX.md** — Removed links to QUANTUM_STATE_DOCTRINE.md, SCHRODINGERS_STATE_BLOCK.md
- **lupo-docs/channels/doctrine/README.md** — Removed QUANTUM_STATE_DOCTRINE.md, SCHRODINGERS_STATE_BLOCK.md from file list
- **lupo-docs/channels/doctrine/UNIVERSAL_WOLFIE_HEADER_SPECIFICATION.md** — Replaced STONED_WOLFIE frontmatter and `schrodingers_state` block with canonical header
- **lupo-docs/channels/doctrine/WOLFIE_HEADER_DOCTRINE.md** — Removed quantum/superpositional/Schrödinger-state sections and references; renumbered sections
- **lupo-docs/channels/doctrine/WHEELER_MODE_DOCTRINE.md** — Deleted in separate Wheeler/Reverse-20 purge (see WHEELER_REVERSE20_PURGE_SUMMARY.md).
- **lupo-docs/channels/doctrine/DIALOG_DOCTRINE.md** — Removed STONED_WOLFIE from speaker examples
- **lupo-docs/channels/doctrine/VERSION_PLANS_3.0.82_3.0.88.md** — Replaced superposition-resolution language with version/alignment language
...
- **lupo-docs/channels/schema/migrations/3.0.81.md** — Removed `schrodingers_state` frontmatter; rewrote as version/documentation alignment (no quantum collapse); removed quantum doctrine references
- **lupo-docs/channels/schema/migrations/3.0.78.md** — Replaced “Stoned Wolfie” / “STONED WOLFIE” with neutral wording
- **lupo-docs/channels/schema/migrations/4.1.2.md** — Removed stoned_wolfie from message and from New Files table
- **lupo-docs/channels/schema/migrations/3.0.106.md** — Removed QUANTUM_STATE_DOCTRINE.md bullet and `checkQuantumSubsystem()` reference
- **lupo-docs/channels/schema/migrations/3.0.112.md** — Removed QUANTUM_STATE_DOCTRINE.md from doctrine list
- **lupo-docs/channels/overview/postmortems/3.0.81.md** — Removed quantum/superposition/Stoned Wolfie/Schrödinger from frontmatter and body; rewrote as version alignment

### Roadmaps and dialogs
- **lupo-docs/channels/overview/roadmaps/TO_DO_FOR_VERSION_4_1_0.md** — Removed “Stoned Wolfie & Emotional System” section and Stoned Wolfie persona tasks; kept Emotional Metadata; removed Stoned Wolfie commentary block and success-criteria reference
...
### Doctrine (additional)
- **lupo-docs/channels/doctrine/DIRECTORY_STRUCTURE.md** — Restored from legacy-core; had been overwritten with Stoned Wolfie warning template; now contains canonical directory structure doctrine only.
...
- **lupo-docs/channels/overview/versioning/CHANGELOG.md** — Removed STONED_WOLFIE from speaker list; replaced `schrodingers_state` mentions with “(deprecated uncertainty metadata)”
- **lupo-database/install/truth_test_data_captain_wolfie.sql** — Replaced “superpositionally.com” reference with neutral “domain (alternate)” in list context
...
- A Cursor rule (stoned-wolfie-schrodinger-ban) had been added (rule file since removed). It had instructed Cursor to treat STONED WOLFIE, Schrödinger-state, and quantum-state as forbidden. The concepts remain banned; the separate rule file has been removed from the repo.
