...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/audits/VERSION_DOCTRINE_APPLICATION_REPORT.md"
...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "lupo-docs\VERSION_DOCTRINE_APPLICATION_REPORT.md"
...
**Date:** 2026-02-10  
**Scope:** Apply authoritative Version Doctrine across code, lupo-install/seed SQL, migrations, and key docs. Only **3.0.0** (release target) and **4.1.0** (next planned release) may be referenced; **4.0.1–3.0.8** and any version beyond 4.1.0 must not appear in code, SQL, UI, or metadata.
...
| `lupo-database/migrations/install_new_lupopedia.sql` | All DEFAULT '3.0.72' and '3.0.75' → '3.0.0' (protocol_version, doctrine_alignment_version, impact_version, awareness_version, analytics_version, propagation_version, audit_version, refinement_version, calibration_version, sync_version) |
| `lupo-database/migrations/seed_lupopedia.sql` | awareness_version '3.0.72' → '3.0.0' |
| `lupo-database/migrations/dev_20260204_fix_schema_alignment.sql` | All DEFAULT '3.0.72' and '3.0.75' → '3.0.0' |
| `lupo-database/migrations/dev_20260204_fix_schema_alignment_summary.txt` | All 3.0.72 and 3.0.75 → 3.0.0 |
| `lupo-docs/HELPER_TO_CLASS_MAPPING_ANALYSIS.md` | Fallback version example '3.0.35' → '3.0.0' |
| `lupo-docs/REMAINING_HELPERS_REFACTOR_REPORT.md` | Fallback example '3.0.35' → '3.0.0' |
| `lupo-docs/REQUIRED_TABLES_4.1.0.md` | Purpose and heading/version 4.1.0 → 3.0.0 |
...
| `lupo-docs/doctrine/VERSION_DOCTRINE.md` | **New.** Authoritative Version Doctrine (3.0.0 only release, 4.0.1–3.0.8 not releases, upgrade path 3.7.5 → 3.0.0, 4.1.0 only future, code rules, cascade rules, single source of truth). |
...
- **4.1.0** — lupo-docs/REQUIRED_TABLES_4.1.0.md purpose and heading/version (replaced with 3.0.0).
...
- **Only 3.0.0 and 4.1.0 remain (where versions are stated):** Code, lupo-install/seed SQL, and updated docs now use 3.0.0; 4.1.0 appears only as “next planned release” in doctrine and .cursorrules.
...
- **Upgrade path is strictly 3.7.5 → 3.0.0:** Documented in lupo-docs/doctrine/VERSION_DOCTRINE.md and .cursorrules; no upgrade paths to 4.0.1+.
...
**Note:** Internal/historical docs (e.g. CHANGELOG, lupo-docs/channels/overview, migration filenames like 4.2.0_*) were not rewritten; the doctrine allows 4.0.1–3.0.8 and similar to appear in internal docs as development notes. This report and the Version Doctrine apply to code, lupo-install/upgrade SQL, version checks, UI version displays, and documentation that defines the lupo-install/upgrade version.
