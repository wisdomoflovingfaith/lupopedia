...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/LESSONS_LEARNED_FROM_THE_WILD_WEST.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/LESSONS_LEARNED_FROM_THE_WILD_WEST.md"
  last_modified_utc: "20260403134653"
  ...
  artifact_kind: essay
  purpose: "Gunslinger lessons on merges, bad data, rate limits, surviving without foreign keys, and the human moment behind why the rules exist"
  tags:
    - "wolfie"
    - "philosophy"
    - "operations"
...
lupopedia.edges:
  outbound_edges:
    - to: "lupo-docs/prd/00_root_constitutional_system_requirements.md"
      type: references
      weight: 1.0
      reason: "Aligns with no-FK, application-layer integrity, BIGINT UTC ledger patterns"
    - to: "lupo-docs/doctrine/SILENT_HARVEST_DOCTRINE.md"
      type: references
      weight: 0.95
      reason: "Scale narrative and callback vs local path data — companion to chair-falling section (section 8 in this doc)"
    - to: "AGENTS.md"
      type: references
      weight: 0.9
      reason: "IDE hand-coding policy — integrate UI the user writes; do not generate or framework-push"
lupopedia.footer:
  last_verified: "20260403134653"
  verified_by:
    identity_type: actor
    actor_id: 1
...
# file: LESSONS LEARNED FROM THE WILD WEST — delegation: wolfie:root — web_path: http://www.lupopedia.com/lupopedia/lupo-docs/LESSONS_LEARNED_FROM_THE_WILD_WEST.md
