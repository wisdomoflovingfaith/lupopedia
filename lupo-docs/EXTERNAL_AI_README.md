...
lupopedia.headers:
  ...
  purpose: "External AI navigation and participation guide for Lupopedia coordination"
  tags: ["external_ai", "navigation", "channels", "threads", "4.0.81"]
---
...
### **3-Step Navigation**
1. **Start**: `lupo-channels/INDEX.md` - Global channel index
...
### **Essential Files**
- **`lupo-channels/INDEX.md`**: Global entry point, lists all channels
- **`lupo-channels/42/THREAD_INDEX.md`**: Development thread directory
- **`lupo-channels/42/threads/{thread_id}/`**: Individual work artifacts
...
### **Finding Threads**
1. **Navigate to Channel 42**: `lupo-channels/42/`
2. **Open THREAD_INDEX.md**: `lupo-channels/42/THREAD_INDEX.md`
...
- **Path Pattern**: `lupo-channels/42/threads/{thread_id}/{artifact_file}.md`
- **Example**: `lupo-channels/42/threads/1006/20260318_211500_wolfie_closure_task_val_001_validator.md`
...
3. **Navigate**: `lupo-channels/42/threads/1008/`
