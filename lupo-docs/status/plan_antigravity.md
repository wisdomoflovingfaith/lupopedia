...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/status/plan_antigravity.md"
  web_path: "http://www.lupopedia.com/status/plan_antigravity"
...
---
# file: Antigravity Implementation Plan_antigravity — session: L-LUPO-ROOT-ANTIGRAVITY — delegation: wolfie:root (faucet: antigravity) — web_path: http://www.lupopedia.com/status/plan_antigravity
