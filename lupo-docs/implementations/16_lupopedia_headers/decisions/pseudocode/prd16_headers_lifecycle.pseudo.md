...
lupopedia.headers:
  ...
  artifact_kind: "guide"
  purpose: "Pseudocode narrative for PRD 16 — write, verify, edges, history, footer, import sync (not loaded by runtime)"
  tags:
    - "pseudocode"
    - "prd_16"
    - "lupopedia_headers"
    - "implementation_16_lupopedia_headers"
lupopedia.edges:
  outbound_edges:
    - to: "lupo-docs/prd/16_lupopedia_headers.md"
      type: references
      weight: 1.0
      reason: "Canonical PRD for headers and applicability scope"
    - to: "lupo-docs/prd/17_decisions_format.md"
      type: references
      weight: 0.95
      reason: "Pseudocode directory rules; required LUPOPEDIA HEADERS on .pseudo.*"
...
lupopedia.footer:
  ...
  next_action:
    - "Keep aligned with import_content.py and header_db_sync.py when those change"
---
