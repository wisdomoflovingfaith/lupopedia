...
Workspaces for **PRD-driven** implementation tracking. Scaffold from **`_template/`** and **[31_implementation_folder_guidelines](31_implementation_folder_guidelines/README.md)**.
...
- **`_template/`** — Copy structure for new implementation folders.
