...
lupopedia.headers:
  ...
  purpose: "LILITH answer — Softaculous packager scope, zip output, installer role, and 4.1.0 vs PRD 33 §10"
  status: complete
lupopedia.edges:
  outbound_edges:
    - to: "lupo-docs/implementations/33_softaculous_certification_4_1_0_gate/questions/20260404_065622_QUESTION_softaculous_packager_distribution_flow.md"
      type: answers
      weight: 1.0
      reason: "Resolves WOLFIE clarification on packager and flow"
    - to: "lupo-docs/prd/33_softaculous_certification_4_1_0_gate.md"
      type: references
      weight: 1.0
      reason: "PRD 33 — §9, §10, Section 14"
    - to: "lupo-docs/implementations/33_softaculous_certification_4_1_0_gate/SOFTACULOUS_PACKAGE_BUILD.md"
      type: references
      weight: 1.0
      reason: "Operator-facing packaging steps"
    - to: "lupo-scripts/build_softaculous_package.sh"
      type: references
      weight: 1.0
      reason: "Authoritative exclude list and archive layout"
    - to: "lupo-install/InstallWizardHtaccessWriter.php"
      type: references
      weight: 0.95
      reason: "Install-time .htaccess + runtime dirs"
lupopedia.footer:
  last_verified: "20260404065622"
  verified_by:
    identity_type: actor
    actor_id: 2
    actor_name: lilith
