...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/implementations/VALIDATION_GUIDE.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/implementations/VALIDATION_GUIDE.md"
  ...
  artifact_kind: "guide"
  purpose: "Guide for the five-layer documentation validation system"
  tags:
  - "documentation"
  - "validation"
  - "five_layer"
...
parent_edges_ref: "/lupo-docs/implementations/26_five_layer_documentation_architecture/edges.md"  # REQUIRED; MAY be auto-populated by tooling but MUST be present in committed PRDs
---
```
...
cp lupo-scripts/pre_commit_validate.py .git/hooks/pre-commit
  ...
  validate:
    ...
    steps:
      ...
      - name: Validate Implementations
        run: python lupo-scripts/validate_implementation.py
```
