...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/implementations/security_audit_cursor_ide/README.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/implementations/security_audit_cursor_ide/README.md"
  ...
  purpose: "IDE security audit checklist for shared hosting; operational companion to PRD 00 Section 17 (RULE 93.SECURITY)"
  tags:
    - "security"
    - "cursor"
    - "ide"
...
lupopedia.edges:
  outbound_edges:
    - to: "lupo-docs/prd/00_root_constitutional_system_requirements.md"
      type: references
      weight: 1.0
      reason: "Constitutional Section 17 (RULE 93.SECURITY)"
    - to: "lupo-docs/doctrine/AGAPE_DOCTRINE.md"
      type: references
      weight: 0.95
      reason: "AGAPE — technical resilience, not sentimental framing"
    - to: "lupo-includes/classes/LupopediaConfigResolver.php"
      type: references
      weight: 1.0
      reason: "isSafeLocalConfigPath — stream / NUL rejection for config paths"
lupopedia.footer:
...
# file: Cursor IDE security audit checklist (shared hosting) — delegation: cursor:root — web_path: [http://www.lupopedia.com/lupopedia/lupo-docs/implementations/security_audit_cursor_ide/README.md](http://www.lupopedia.com/lupopedia/lupo-docs/implementations/security_audit_cursor_ide/README.md)
...
**Reference:** `LupopediaConfigResolver::isSafeLocalConfigPath()`, `lupo-includes/bootstrap.php` (**`LUPOPEDIA_PATH`** vs **`ABSPATH`**).
...
**Constitutional:** PRD 00 **§15.1**, **§15.3**, **§14.6** (**AGAPE**).
