...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/implementations/26_five_layer_documentation_architecture/discussions/THREAD_INDEX.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/implementations/26_five_layer_documentation_architecture/discussions/THREAD_INDEX.md"
  ...
  purpose: "Index of discussion threads for five-layer documentation architecture"
...
- Primary channel: 42 (Protocol Development) — legacy numeric tree; see also **`lupo-channels/channel_index.md`** and **`lupo-docs/prd/29_project_structure.md`** for the active `lupo-channels/{federation_node_id}/{channel_key}/{thread_key}/` layout.
