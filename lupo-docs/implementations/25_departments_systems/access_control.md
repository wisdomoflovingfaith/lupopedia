...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/implementations/25_departments_systems/access_control.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/implementations/25_departments_systems/access_control.md"
  ...
  purpose: Department-based access control implementation documentation
  tags:
  - "4.0.89"
  - "department_access"
  - "implementation"
...
lupopedia.edges:
  outbound_edges:
    ...
    - to: "DEPARTMENT_MAPPING_TABLES_IMPLEMENTATION.md"
      type: references
      weight: 1.0
      reason: Updated mapping tables implementation
lupopedia.footer:
  version: "4.0.89"
  ...
  next_action:
    ...
    - Monitor actor access by department
---
