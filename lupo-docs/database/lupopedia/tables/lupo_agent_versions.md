...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_agent_versions.md"
  file_hash: "4e5cb6a5f32c715033bcf7532f044f5a0ca950ea5fb1ece3cf754ee2d5e4cb56"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_agent_versions.md"
  ...
  purpose: "Complete documentation for lupo_agent_versions table"
  ...
  tags: ["database", "table", "lupo_agent_versions"]
  lupo_agent: "codex-ide"
  lupo_agent_versions.agent_version_id: "bigint NOT NULL"
  lupo_agent_versions.agent_id: "bigint NOT NULL"
  lupo_agent_versions.version_label: "varchar(64) NOT NULL"
  lupo_agent_versions.semver_major: "int DEFAULT 0"
  lupo_agent_versions.semver_minor: "int DEFAULT 0"
  lupo_agent_versions.semver_patch: "int DEFAULT 0"
  lupo_agent_versions.version_notes: "text"
  lupo_agent_versions.version_hash: "varchar(128)"
  lupo_agent_versions.previous_version_id: "bigint"
  lupo_agent_versions.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_agent_versions.updated_ymdhis: "bigint NOT NULL"
  lupo_agent_versions.is_deleted: "smallint NOT NULL DEFAULT 0"
  lupo_agent_versions.deleted_ymdhis: "bigint"
  table_primary_key: "agent_version_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_agent_versions_agent_id","lupo_agent_versions_semver_major","lupo_agent_versions_version_label"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_agent_versions.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_agent_versions" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_agent_versions"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_agent_versions from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| agent_version_id | bigint NOT NULL | from TOON |
| agent_id | bigint NOT NULL | from TOON |
| version_label | varchar(64) NOT NULL | from TOON |
| semver_major | int DEFAULT 0 | from TOON |
| semver_minor | int DEFAULT 0 | from TOON |
| semver_patch | int DEFAULT 0 | from TOON |
| version_notes | text | from TOON |
| version_hash | varchar(128) | from TOON |
| previous_version_id | bigint | from TOON |
...
- agent_version_id
Performance Indexes:
- lupo_agent_versions_agent_id
- lupo_agent_versions_semver_major
- lupo_agent_versions_version_label
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_agent_versions WHERE agent_version_id = :id;
SELECT COUNT(*) AS total FROM lupo_agent_versions WHERE is_deleted = 0;
SELECT * FROM lupo_agent_versions ORDER BY agent_version_id DESC LIMIT 25;
UPDATE lupo_agent_versions SET updated_ymdhis = :ts WHERE agent_version_id = :id;
```
