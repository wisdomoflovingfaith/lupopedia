...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_agent_files.md"
  file_hash: "ea2ccec28a53dae8842d03e958469cd69cc1c575a4dedc86b047390fec4ffbb3"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_agent_files.md"
  ...
  purpose: "Complete documentation for lupo_agent_files table"
  ...
  tags: ["database", "table", "lupo_agent_files"]
  lupo_agent: "codex-ide"
  lupo_agent_files.file_id: "bigint NOT NULL"
  lupo_agent_files.agent_id: "bigint NOT NULL"
  lupo_agent_files.file_type: "varchar(50) NOT NULL"
  lupo_agent_files.file_name: "varchar(255) NOT NULL"
  lupo_agent_files.file_path: "varchar(500) NOT NULL"
  lupo_agent_files.file_hash: "varchar(64) NOT NULL"
  lupo_agent_files.file_size: "bigint NOT NULL"
  lupo_agent_files.mime_type: "varchar(100)"
  lupo_agent_files.upload_ymdhis: "bigint NOT NULL"
  lupo_agent_files.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_agent_files.updated_ymdhis: "bigint NOT NULL"
  lupo_agent_files.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_agent_files.deleted_ymdhis: "bigint"
  lupo_agent_files.migrated_from_directory: "varchar(255)"
  table_primary_key: "file_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_agent_files_idx_agent_id","lupo_agent_files_idx_file_hash","lupo_agent_files_idx_file_type","lupo_agent_files_idx_is_deleted","lupo_agent_files_idx_upload_ymdhis"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_agent_files.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_agent_files" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_agent_files"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_agent_files from TOON schema.
Type: database_table
...
- file_id
Performance Indexes:
- lupo_agent_files_idx_agent_id
- lupo_agent_files_idx_file_hash
- lupo_agent_files_idx_file_type
- lupo_agent_files_idx_is_deleted
- lupo_agent_files_idx_upload_ymdhis
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_agent_files WHERE file_id = :id;
SELECT COUNT(*) AS total FROM lupo_agent_files WHERE is_deleted = 0;
SELECT * FROM lupo_agent_files ORDER BY file_id DESC LIMIT 25;
UPDATE lupo_agent_files SET updated_ymdhis = :ts WHERE file_id = :id;
```
