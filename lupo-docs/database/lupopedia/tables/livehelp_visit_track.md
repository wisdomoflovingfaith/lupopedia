...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\livehelp_visit_track.md"
...
flare.footer:
  outbound_edges:
    - { to: "docs/toons/livehelp_visit_track.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_visit_track" }
