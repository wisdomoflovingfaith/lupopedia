...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_departments.md"
  file_hash: "34356dcb2a586083eeadc826eb1df5ce4457cd8b32b09895d168eb40bf145549"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_departments.md"
  ...
  purpose: "Complete documentation for lupo_departments table"
  ...
  tags: ["database", "table", "lupo_departments"]
  lupo_agent: "codex-ide"
  lupo_departments.department_id: "bigint NOT NULL"
  lupo_departments.federation_node_id: "bigint NOT NULL"
  lupo_departments.name: "varchar(64) NOT NULL"
  lupo_departments.description: "text"
  lupo_departments.department_type: "varchar(32) NOT NULL DEFAULT 'general'"
  lupo_departments.default_actor_id: "bigint NOT NULL DEFAULT 1"
  lupo_departments.settings_json: "json"
  lupo_departments.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_departments.updated_ymdhis: "bigint NOT NULL"
  lupo_departments.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_departments.deleted_ymdhis: "bigint"
  table_primary_key: "department_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_departments_idx_federation_node","lupo_departments_idx_name","lupo_departments_idx_type"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "docs/toons/lupo_departments.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_departments" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_departments"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_departments from TOON schema.
Type: database_table
...
| name | varchar(64) NOT NULL | from TOON |
| description | text | from TOON |
| department_type | varchar(32) NOT NULL DEFAULT 'general' | from TOON |
| default_actor_id | bigint NOT NULL DEFAULT 1 | from TOON |
| settings_json | json | from TOON |
...
- department_id
Performance Indexes:
- lupo_departments_idx_federation_node
- lupo_departments_idx_name
- lupo_departments_idx_type
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_departments WHERE department_id = :id;
SELECT COUNT(*) AS total FROM lupo_departments WHERE is_deleted = 0;
SELECT * FROM lupo_departments ORDER BY department_id DESC LIMIT 25;
UPDATE lupo_departments SET updated_ymdhis = :ts WHERE department_id = :id;
```
