...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_aliases.md"
  file_hash: "85fb171733cce675b0886021d5877a48be3d2f16068a072b8a9cdced719232b5"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_aliases.md"
  file_hash: "971f290a9bb9be59b8cdaa58500e3731b83e3b28508464c9d4accdc993ee932a"
  ...
  purpose: "Complete documentation for lupo_aliases table"
  ...
  tags: ["database", "table", "lupo_aliases"]
  lupo_agent: "codex-ide"
  lupo_aliases.alias_id: "int NOT NULL"
  lupo_aliases.slug: "varchar(255) NOT NULL"
  lupo_aliases.alias: "varchar(255) NOT NULL"
  lupo_aliases.alias_type: "varchar(50) DEFAULT 'semantic'"
  lupo_aliases.created_at: "bigint"
  table_primary_key: "alias_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_aliases_idx_slug","lupo_aliases_uniq_alias"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "docs/toons/lupo_aliases.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_aliases" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_aliases"]
  version: "4.0.48"
