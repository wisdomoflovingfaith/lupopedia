...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_websites.md"
  file_hash: "dab302417d895a7b98432c4946730bf57c73d9682f2d0d99c191d9ce021698c3"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/livehelp_websites.md"
  file_hash: "364229d79e26e6b77973655667319f0e5b6b779387b888ffeeed927a1c578d08"
  ...
  purpose: "Complete documentation for livehelp_websites table"
  ...
  tags: ["database", "table", "livehelp_websites"]
  lupo_agent: "codex-ide"
  livehelp_websites.id: "int NOT NULL auto_increment"
  livehelp_websites.livehelp_id: "bigint unsigned NOT NULL DEFAULT 1"
  livehelp_websites.site_name: "varchar(45) NOT NULL"
  livehelp_websites.site_url: "varchar(255) NOT NULL"
  livehelp_websites.defaultdepartment: "int NOT NULL"
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/livehelp_websites.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_websites" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "livehelp_websites"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for livehelp_websites from TOON schema.
Type: database_table
...
| site_name | varchar(45) NOT NULL | from TOON |
| site_url | varchar(255) NOT NULL | from TOON |
| defaultdepartment | int NOT NULL | from TOON |
...
Common Queries:
```sql
SELECT * FROM livehelp_websites WHERE id = :id;
SELECT COUNT(*) AS total FROM livehelp_websites WHERE is_deleted = 0;
SELECT * FROM livehelp_websites ORDER BY id DESC LIMIT 25;
UPDATE livehelp_websites SET updated_ymdhis = :ts WHERE id = :id;
```
