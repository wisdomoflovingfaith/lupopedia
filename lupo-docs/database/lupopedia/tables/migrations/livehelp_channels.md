...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_channels.md"
  file_hash: "2dde13c347b2ec839e082a5968b8b6051d8805e31d09a0951e5a8f78ac0549da"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/livehelp_channels.md"
  file_hash: "0a462abf2f8f98045e6a6e8da829457f1dd03caea3ae0c5ff949a57e3e23ef5b"
  ...
  purpose: "Complete documentation for livehelp_channels table"
  ...
  tags: ["database", "table", "livehelp_channels"]
  lupo_agent: "codex-ide"
  livehelp_channels.id: "int NOT NULL auto_increment"
  livehelp_channels.livehelp_id: "bigint unsigned NOT NULL DEFAULT 1"
  livehelp_channels.user_id: "int NOT NULL DEFAULT 0"
  livehelp_channels.statusof: "char(1) NOT NULL DEFAULT ''"
  livehelp_channels.startdate: "bigint NOT NULL DEFAULT 0"
  livehelp_channels.sessionid: "varchar(40) NOT NULL DEFAULT ''"
  livehelp_channels.website: "int NOT NULL DEFAULT 0"
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/livehelp_channels.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_channels" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "livehelp_channels"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for livehelp_channels from TOON schema.
Type: database_table
...
| website | int NOT NULL DEFAULT 0 | from TOON |
...
Common Queries:
```sql
SELECT * FROM livehelp_channels WHERE id = :id;
SELECT COUNT(*) AS total FROM livehelp_channels WHERE is_deleted = 0;
SELECT * FROM livehelp_channels ORDER BY id DESC LIMIT 25;
UPDATE livehelp_channels SET updated_ymdhis = :ts WHERE id = :id;
```
