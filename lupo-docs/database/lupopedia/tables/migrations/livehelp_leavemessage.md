...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_leavemessage.md"
  file_hash: "a529b2cf0bfe6c8465b76f6f729d7762af635e98ac12e7fba8ac40a271050c21"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/livehelp_leavemessage.md"
  file_hash: "c8b74f1fd7685d51b45051e8f6cde0a5e77d13390508ad9c774ef36225c8864a"
  ...
  purpose: "Complete documentation for livehelp_leavemessage table"
  ...
  tags: ["database", "table", "livehelp_leavemessage"]
  lupo_agent: "codex-ide"
  livehelp_leavemessage.id: "int unsigned NOT NULL auto_increment"
  livehelp_leavemessage.livehelp_id: "bigint unsigned NOT NULL DEFAULT 1"
  livehelp_leavemessage.email: "varchar(255) NOT NULL DEFAULT ''"
  livehelp_leavemessage.subject: "varchar(200) NOT NULL DEFAULT ''"
  livehelp_leavemessage.department: "int unsigned NOT NULL DEFAULT 0"
  livehelp_leavemessage.dateof: "bigint NOT NULL DEFAULT 0"
  livehelp_leavemessage.sessiondata: "mediumtext"
  livehelp_leavemessage.deliminated: "mediumtext"
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/livehelp_leavemessage.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_leavemessage" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "livehelp_leavemessage"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for livehelp_leavemessage from TOON schema.
Type: database_table
...
| subject | varchar(200) NOT NULL DEFAULT '' | from TOON |
| department | int unsigned NOT NULL DEFAULT 0 | from TOON |
| dateof | bigint NOT NULL DEFAULT 0 | from TOON |
| sessiondata | mediumtext | from TOON |
| deliminated | mediumtext | from TOON |
...
Common Queries:
```sql
SELECT * FROM livehelp_leavemessage WHERE id = :id;
SELECT COUNT(*) AS total FROM livehelp_leavemessage WHERE is_deleted = 0;
SELECT * FROM livehelp_leavemessage ORDER BY id DESC LIMIT 25;
UPDATE livehelp_leavemessage SET updated_ymdhis = :ts WHERE id = :id;
```
