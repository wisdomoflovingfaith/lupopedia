...
flip.footer: {
  ...
  outbound_edges: [
    { to: "lupo-docs/doctrine/database/crm_leads.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
    { to: "lupo-docs/doctrine/database/crm_lead_messages.md", type: "documents", weight: 0.9, hashtag: "#related" },
