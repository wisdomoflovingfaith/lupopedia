...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_paths_firsts.md"
  file_hash: "081b9ad9d0ba2116fb6dd1d1580da35f001b1e04b0a4cbc6e7775c2e07fdf380"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/livehelp_paths_firsts.md"
  ...
  purpose: "Complete documentation for livehelp_paths_firsts table"
  ...
  tags: ["database", "table", "livehelp_paths_firsts"]
  lupo_agent: "codex-ide"
  livehelp_paths_firsts.id: "int unsigned NOT NULL auto_increment"
  livehelp_paths_firsts.livehelp_id: "bigint unsigned NOT NULL DEFAULT 1"
  livehelp_paths_firsts.visit_recno: "int unsigned NOT NULL DEFAULT 0"
  livehelp_paths_firsts.exit_recno: "int unsigned NOT NULL DEFAULT 0"
  livehelp_paths_firsts.dateof: "int NOT NULL DEFAULT 0"
  livehelp_paths_firsts.visits: "int unsigned NOT NULL DEFAULT 0"
  table_primary_key: "id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["livehelp_id","visit_recno"]
  table_foreign_keys: []
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/livehelp_paths_firsts.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_paths_firsts" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "livehelp_paths_firsts"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for livehelp_paths_firsts from TOON schema.
Type: database_table
...
Common Queries:
```sql
SELECT * FROM livehelp_paths_firsts WHERE id = :id;
SELECT COUNT(*) AS total FROM livehelp_paths_firsts WHERE is_deleted = 0;
SELECT * FROM livehelp_paths_firsts ORDER BY id DESC LIMIT 25;
UPDATE livehelp_paths_firsts SET updated_ymdhis = :ts WHERE id = :id;
```
