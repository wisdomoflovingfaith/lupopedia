...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_operator_departments.md"
  file_hash: "1a3a6950caf4bfff244af97a023cc6ec325ed4a2c59e3e388d046e7664bd2b5b"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/livehelp_operator_departments.md"
  file_hash: "12fb60033597c6315280f430d86716da3da7003de4923323a8e2f8ce62933b3b"
  ...
  purpose: "Complete documentation for livehelp_operator_departments table"
  ...
  tags: ["database", "table", "livehelp_operator_departments"]
  lupo_agent: "codex-ide"
  livehelp_operator_departments.recno: "int NOT NULL auto_increment"
  livehelp_operator_departments.livehelp_id: "bigint unsigned NOT NULL DEFAULT 1"
  livehelp_operator_departments.user_id: "int NOT NULL DEFAULT 0"
  livehelp_operator_departments.department: "int NOT NULL DEFAULT 0"
  livehelp_operator_departments.extra: "varchar(100) NOT NULL DEFAULT ''"
  table_primary_key: "recno"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["department","livehelp_id","user_id"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/livehelp_operator_departments.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_operator_departments" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "livehelp_operator_departments"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for livehelp_operator_departments from TOON schema.
Type: database_table
...
| extra | varchar(100) NOT NULL DEFAULT '' | from TOON |
...
Common Queries:
```sql
SELECT * FROM livehelp_operator_departments WHERE recno = :id;
SELECT COUNT(*) AS total FROM livehelp_operator_departments WHERE is_deleted = 0;
SELECT * FROM livehelp_operator_departments ORDER BY recno DESC LIMIT 25;
UPDATE livehelp_operator_departments SET updated_ymdhis = :ts WHERE recno = :id;
```
