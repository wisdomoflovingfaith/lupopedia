...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_modules_migration.md"
...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "lupo-docs\database\lupopedia\tables\livehelp_modules_migration.md"
...
---
lupopedia.headers: {
  file_path_from_root: "lupo-docs/database/lupopedia/tables/livehelp_modules_migration.md",
  file_hash: "da3fd7b66e1fdb9a5c482872321880d3a6f7d9cd33abd87e6060127b5b9208f0"
  system_version: "4.0.50"
  channel_id: 42,
  mood_rgb: "8B4513",
  purpose: "Migration doctrine for livehelp_modules → lupo_modules (predefined registry)",
...
flip.footer: {
  ...
  outbound_edges: [
    ...
    { to: "lupo-includes/modules/module-loader.php", type: "replaced_by", weight: 0.8, hashtag: "#module_system" }
  ],
