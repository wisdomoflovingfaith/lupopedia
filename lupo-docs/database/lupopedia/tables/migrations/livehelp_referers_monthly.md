...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_referers_monthly.md"
  file_hash: "105413582370b76e53493efbe86a67b0a468075b34d290174190d64f9da37b37"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/livehelp_referers_monthly.md"
  file_hash: "c39b72fcadf99e4ee678f607455824f57b9563bc7729d6e10f238a4e10cc0e8a"
  ...
  purpose: "Complete documentation for livehelp_referers_monthly table"
  ...
  tags: ["database", "table", "livehelp_referers_monthly"]
  lupo_agent: "codex-ide"
  livehelp_referers_monthly.recno: "int NOT NULL auto_increment"
  livehelp_referers_monthly.livehelp_id: "bigint unsigned NOT NULL DEFAULT 1"
  livehelp_referers_monthly.pageurl: "varchar(255) NOT NULL DEFAULT '0'"
  livehelp_referers_monthly.dateof: "int NOT NULL DEFAULT 0"
  livehelp_referers_monthly.levelvisits: "int unsigned NOT NULL DEFAULT 0"
  livehelp_referers_monthly.directvisits: "int unsigned NOT NULL DEFAULT 0"
  livehelp_referers_monthly.parentrec: "int unsigned NOT NULL DEFAULT 0"
  livehelp_referers_monthly.level: "int NOT NULL DEFAULT 0"
  livehelp_referers_monthly.department: "int NOT NULL DEFAULT 0"
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/livehelp_referers_monthly.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_referers_monthly" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "livehelp_referers_monthly"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for livehelp_referers_monthly from TOON schema.
Type: database_table
...
Common Queries:
```sql
SELECT * FROM livehelp_referers_monthly WHERE recno = :id;
SELECT COUNT(*) AS total FROM livehelp_referers_monthly WHERE is_deleted = 0;
SELECT * FROM livehelp_referers_monthly ORDER BY recno DESC LIMIT 25;
UPDATE livehelp_referers_monthly SET updated_ymdhis = :ts WHERE recno = :id;
```
