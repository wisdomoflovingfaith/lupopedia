...
flip.footer: {
  ...
  outbound_edges: [
    { to: "lupo-docs/doctrine/database/channels.md", type: "documents", weight: 0.9, hashtag: "#target_system" },
    { to: "lupo-docs/doctrine/database/actor_channel_roles.md", type: "documents", weight: 0.8, hashtag: "#permissions" },
