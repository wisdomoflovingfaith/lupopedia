...
flip.footer: {
  ...
  outbound_edges: [
    { to: "lupo-docs/doctrine/database/sessions.md", type: "documents", weight: 0.9, hashtag: "#anonymous_sessions" },
    { to: "lupo-docs/doctrine/database/actors.md", type: "documents", weight: 0.8, hashtag: "#no_anonymous_actors" },
