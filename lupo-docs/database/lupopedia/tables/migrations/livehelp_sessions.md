...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_sessions.md"
  file_hash: "d7f3b44fd25a435baf261a10d86f4e619efaf788a175aad82f8f06a87d485461"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/livehelp_sessions.md"
  file_hash: "1d3d6e822ee129e3fc4b09f145255c9d73c0ca43c23c485472d03c31dd6774d6"
  ...
  purpose: "Complete documentation for livehelp_sessions table"
  ...
  tags: ["database", "table", "livehelp_sessions"]
  lupo_agent: "codex-ide"
  livehelp_sessions.session_id: "varchar(100) NOT NULL DEFAULT ''"
  livehelp_sessions.livehelp_id: "bigint unsigned NOT NULL DEFAULT 1"
  livehelp_sessions.session_data: "mediumtext NOT NULL"
  livehelp_sessions.expires: "int NOT NULL DEFAULT 0"
  table_primary_key: "session_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["expires","livehelp_id"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/livehelp_sessions.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_sessions" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "livehelp_sessions"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for livehelp_sessions from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| session_id | varchar(100) NOT NULL DEFAULT '' | from TOON |
| livehelp_id | bigint unsigned NOT NULL DEFAULT 1 | from TOON |
| session_data | mediumtext NOT NULL | from TOON |
| expires | int NOT NULL DEFAULT 0 | from TOON |
...
Common Queries:
```sql
SELECT * FROM livehelp_sessions WHERE session_id = :id;
SELECT COUNT(*) AS total FROM livehelp_sessions WHERE is_deleted = 0;
SELECT * FROM livehelp_sessions ORDER BY session_id DESC LIMIT 25;
UPDATE livehelp_sessions SET updated_ymdhis = :ts WHERE session_id = :id;
```
