...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_permissions.md"
...
flare.footer:
  outbound_edges:
    - { to: "docs/toons/lupo_permissions.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_permissions" }
