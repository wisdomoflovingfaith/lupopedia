...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_federation_category_map.md"
  file_hash: "52152948535a75ea86d410bee123ea71bd1f01948be15c04ab86cb01deaa3d25"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_federation_category_map.md"
  file_hash: "3291f3812d96031babc2a506e3aa88db3cf64d9c646dab2fa63a5b313bb11875"
  ...
  purpose: "Complete documentation for lupo_federation_category_map table"
  ...
  tags: ["database", "table", "lupo_federation_category_map"]
  lupo_agent: "codex-ide"
  lupo_federation_category_map.federation_category_map_id: "bigint NOT NULL"
  lupo_federation_category_map.federation_node_id: "bigint NOT NULL"
  lupo_federation_category_map.federation_category_id: "bigint NOT NULL"
  lupo_federation_category_map.meta_json: "json"
  lupo_federation_category_map.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_federation_category_map.deleted_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_federation_category_map.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_federation_category_map.updated_ymdhis: "bigint NOT NULL DEFAULT 0"
  table_primary_key: "federation_category_map_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_federation_category_map_idx_category","lupo_federation_category_map_idx_is_deleted","lupo_federation_category_map_idx_node"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_federation_category_map.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_federation_category_map" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_federation_category_map"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_federation_category_map from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| federation_category_map_id | bigint NOT NULL | from TOON |
| federation_node_id | bigint NOT NULL | from TOON |
| federation_category_id | bigint NOT NULL | from TOON |
...
Primary Indexes:
- federation_category_map_id
Performance Indexes:
- lupo_federation_category_map_idx_category
- lupo_federation_category_map_idx_is_deleted
- lupo_federation_category_map_idx_node
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_federation_category_map WHERE federation_category_map_id = :id;
SELECT COUNT(*) AS total FROM lupo_federation_category_map WHERE is_deleted = 0;
SELECT * FROM lupo_federation_category_map ORDER BY federation_category_map_id DESC LIMIT 25;
UPDATE lupo_federation_category_map SET updated_ymdhis = :ts WHERE federation_category_map_id = :id;
```
