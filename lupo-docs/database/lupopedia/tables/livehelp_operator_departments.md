...
flare.footer:
  outbound_edges:
    - { to: "docs/toons/livehelp_operator_departments.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_operator_departments" }
