...
lupopedia.headers:
  ...
  web_path: "[lupo_actor_apps](http://www.lupopedia.com/database/lupopedia/tables/active/lupo_actor_apps)"
...
lupopedia.edges:
  comment: "Snapshot of edges for lupo_actor_apps table doc at 4.0.79 (grounded by repo search; non-exhaustive)."
  meta: "php_hits=0 python_hits=0"
  outbound_edges:
    - { to: "database.table.lupo_actor_apps", type: "DEFINES_SCHEMA_FOR", weight: 1.0 }
...
---
# file: lupo_actor_apps ? web_path: http://www.lupopedia.com/database/lupopedia/tables/active/lupo_actor_apps
