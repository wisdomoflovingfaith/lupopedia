...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_federation_categories.md"
  file_hash: "67222b75193edace78662869dddd6a1c8d3d4195601acec371a1a2ada648bfb2"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_federation_categories.md"
  file_hash: "d8b580f48617a2809a4be0f4cae8217bcc8660ba355b0d77ca8cc350c41edd8c"
  ...
  purpose: "Complete documentation for lupo_federation_categories table"
  ...
  tags: ["database", "table", "lupo_federation_categories"]
  lupo_agent: "codex-ide"
  lupo_federation_categories.federation_category_id: "bigint NOT NULL"
  lupo_federation_categories.category_name: "varchar(255) NOT NULL"
  lupo_federation_categories.category_slug: "varchar(255) NOT NULL"
  lupo_federation_categories.category_description: "text"
  lupo_federation_categories.meta_json: "json"
  lupo_federation_categories.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_federation_categories.deleted_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_federation_categories.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_federation_categories.updated_ymdhis: "bigint NOT NULL DEFAULT 0"
  table_primary_key: "federation_category_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_federation_categories_idx_category_slug","lupo_federation_categories_idx_is_deleted"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_federation_categories.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_federation_categories" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_federation_categories"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_federation_categories from TOON schema.
Type: database_table
...
| category_name | varchar(255) NOT NULL | from TOON |
| category_slug | varchar(255) NOT NULL | from TOON |
| category_description | text | from TOON |
...
Performance Indexes:
- lupo_federation_categories_idx_category_slug
- lupo_federation_categories_idx_is_deleted
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_federation_categories WHERE federation_category_id = :id;
SELECT COUNT(*) AS total FROM lupo_federation_categories WHERE is_deleted = 0;
SELECT * FROM lupo_federation_categories ORDER BY federation_category_id DESC LIMIT 25;
UPDATE lupo_federation_categories SET updated_ymdhis = :ts WHERE federation_category_id = :id;
```
