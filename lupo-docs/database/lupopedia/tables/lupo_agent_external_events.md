...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_agent_external_events.md"
  file_hash: "9cb4a70d90d9248b1e024fc84ae480b1b237ffddaf7c881f4930b777509a5ae5"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_agent_external_events.md"
  file_hash: "d6b3acf066e3ed0d08c7de9dac597cba93e73e4c7b145c10a0df7f022e52c7cb"
  ...
  purpose: "Complete documentation for lupo_agent_external_events table"
  ...
  tags: ["database", "table", "lupo_agent_external_events"]
  lupo_agent: "codex-ide"
  lupo_agent_external_events.external_event_id: "bigint NOT NULL"
  lupo_agent_external_events.agent_name: "varchar(255) NOT NULL"
  lupo_agent_external_events.source_system: "varchar(255) NOT NULL"
  lupo_agent_external_events.event_type: "varchar(50) NOT NULL"
  lupo_agent_external_events.event_payload_json: "json"
  lupo_agent_external_events.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  table_primary_key: "external_event_id"
...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_agent_external_events.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_agent_external_events" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_agent_external_events"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_agent_external_events from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| external_event_id | bigint NOT NULL | from TOON |
| agent_name | varchar(255) NOT NULL | from TOON |
| source_system | varchar(255) NOT NULL | from TOON |
| event_type | varchar(50) NOT NULL | from TOON |
| event_payload_json | json | from TOON |
...
Common Queries:
```sql
SELECT * FROM lupo_agent_external_events WHERE external_event_id = :id;
SELECT COUNT(*) AS total FROM lupo_agent_external_events WHERE is_deleted = 0;
SELECT * FROM lupo_agent_external_events ORDER BY external_event_id DESC LIMIT 25;
UPDATE lupo_agent_external_events SET updated_ymdhis = :ts WHERE external_event_id = :id;
```
