...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_agent_experiences.md"
  file_hash: "c18b6ebece056812d3b6ce0990f837a7d961ecab102cdfd6029562a36f935a50"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_agent_experiences.md"
  file_hash: "615e66fb24b20481fd14ffc10743f2e2dbc0fd06c7ae9bf5697b268452caa87c"
  ...
  purpose: "Complete documentation for lupo_agent_experiences table"
  ...
  tags: ["database", "table", "lupo_agent_experiences"]
  lupo_agent: "codex-ide"
  lupo_agent_experiences.link_id: "char(26) NOT NULL"
  lupo_agent_experiences.agent_id: "bigint NOT NULL"
  lupo_agent_experiences.star_id: "char(26) NOT NULL"
  lupo_agent_experiences.intensity: "decimal(3,2)"
  lupo_agent_experiences.context_id: "bigint"
  lupo_agent_experiences.observed_ymdhis: "bigint"
  lupo_agent_experiences.expressed_as_rgb: "char(6)"
  table_primary_key: "link_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_agent_experiences_idx_agent","lupo_agent_experiences_idx_context","lupo_agent_experiences_idx_star"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_agent_experiences.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_agent_experiences" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_agent_experiences"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_agent_experiences from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| link_id | char(26) NOT NULL | from TOON |
| agent_id | bigint NOT NULL | from TOON |
| star_id | char(26) NOT NULL | from TOON |
| intensity | decimal(3,2) | from TOON |
| context_id | bigint | from TOON |
| observed_ymdhis | bigint | from TOON |
| expressed_as_rgb | char(6) | from TOON |
...
- link_id
Performance Indexes:
- lupo_agent_experiences_idx_agent
- lupo_agent_experiences_idx_context
- lupo_agent_experiences_idx_star
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_agent_experiences WHERE link_id = :id;
SELECT COUNT(*) AS total FROM lupo_agent_experiences WHERE is_deleted = 0;
SELECT * FROM lupo_agent_experiences ORDER BY link_id DESC LIMIT 25;
UPDATE lupo_agent_experiences SET updated_ymdhis = :ts WHERE link_id = :id;
```
