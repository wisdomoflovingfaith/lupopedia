...
lupopedia.headers:
  ...
  mood_rgb: "4169E1"
  traits: ["deprecated", "anubis", "audit", "v4.0.70"]
  tags: ["database", "anubis", "revised", "deprecated"]
  lupo_agent: "antigravity"

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_anubis_revised.toon.json", type: "references", weight: 1.0 }
