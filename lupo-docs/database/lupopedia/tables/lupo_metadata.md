...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_metadata.md"
  file_hash: "465931f1862e0b38f2e32911b9d03c3119011dff0e228ff336f0dd1d154674f1"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_metadata.md"
  ...
  purpose: "Complete documentation for lupo_metadata table"
  ...
  tags: ["database", "table", "lupo_metadata"]
  lupo_agent: "codex-ide"
  lupo_metadata.metadata_id: "bigint NOT NULL"
  lupo_metadata.entity_type: "varchar(32) NOT NULL"
  lupo_metadata.entity_id: "bigint NOT NULL"
  lupo_metadata.domain_id: "bigint"
  lupo_metadata.meta_type: "varchar(64)"
  lupo_metadata.property_key: "varchar(255) NOT NULL"
  lupo_metadata.property_value: "text"
  lupo_metadata.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_metadata.updated_ymdhis: "bigint NOT NULL"
  lupo_metadata.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_metadata.deleted_ymdhis: "bigint"
  table_primary_key: "metadata_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_metadata_idx_created_ymdhis","lupo_metadata_idx_domain","lupo_metadata_idx_entity","lupo_metadata_idx_is_deleted","lupo_metadata_idx_meta_type","lupo_metadata_idx_property_key","lupo_metadata_idx_updated_ymdhis","lupo_metadata_unique_entity_domain_property"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "docs/toons/lupo_metadata.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_metadata" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_metadata"]
  version: "4.0.48"
