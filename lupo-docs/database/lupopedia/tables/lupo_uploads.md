...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_uploads.md"
  file_hash: "c189e7277033a241f072244b30db2601b8120ead07a87927b15353269b2e5173"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_uploads.md"
  ...
  purpose: "Complete documentation for lupo_uploads table"
  ...
  tags: ["database", "table", "lupo_uploads"]
  lupo_agent: "codex-ide"
  lupo_uploads.upload_id: "bigint NOT NULL"
  lupo_uploads.actor_id: "bigint NOT NULL"
  lupo_uploads.channel_id: "bigint"
  lupo_uploads.original_filename: "varchar(255) NOT NULL"
  lupo_uploads.stored_filename: "varchar(255) NOT NULL"
  lupo_uploads.file_extension: "varchar(16) NOT NULL"
  lupo_uploads.mime_type: "varchar(128) NOT NULL"
  lupo_uploads.file_size_bytes: "bigint NOT NULL"
  lupo_uploads.storage_path: "varchar(512) NOT NULL"
  lupo_uploads.metadata_json: "json"
  lupo_uploads.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_uploads.updated_ymdhis: "bigint NOT NULL"
  lupo_uploads.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_uploads.deleted_ymdhis: "bigint"
  table_primary_key: "upload_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_uploads_idx_actor_id","lupo_uploads_idx_channel_id","lupo_uploads_idx_created_ymdhis","lupo_uploads_idx_file_extension"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_uploads.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_uploads" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_uploads"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_uploads from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| upload_id | bigint NOT NULL | from TOON |
| actor_id | bigint NOT NULL | from TOON |
| channel_id | bigint | from TOON |
| original_filename | varchar(255) NOT NULL | from TOON |
| stored_filename | varchar(255) NOT NULL | from TOON |
| file_extension | varchar(16) NOT NULL | from TOON |
| mime_type | varchar(128) NOT NULL | from TOON |
| file_size_bytes | bigint NOT NULL | from TOON |
| storage_path | varchar(512) NOT NULL | from TOON |
...
- upload_id
Performance Indexes:
- lupo_uploads_idx_actor_id
- lupo_uploads_idx_channel_id
- lupo_uploads_idx_created_ymdhis
- lupo_uploads_idx_file_extension
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_uploads WHERE upload_id = :id;
SELECT COUNT(*) AS total FROM lupo_uploads WHERE is_deleted = 0;
SELECT * FROM lupo_uploads ORDER BY upload_id DESC LIMIT 25;
UPDATE lupo_uploads SET updated_ymdhis = :ts WHERE upload_id = :id;
```
