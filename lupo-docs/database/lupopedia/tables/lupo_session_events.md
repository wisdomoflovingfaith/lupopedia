...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_session_events.md"
  file_hash: "dd3d919c10b0f9a94a9c0eed878d4e0ab780e3257be898140a9ec90df8553712"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_session_events.md"
  ...
  purpose: "Complete documentation for lupo_session_events table"
  ...
  tags: ["database", "table", "lupo_session_events"]
  lupo_agent: "codex-ide"
  lupo_session_events.session_event_id: "bigint NOT NULL"
  lupo_session_events.session_id: "varchar(255) NOT NULL"
  lupo_session_events.actor_id: "bigint"
  lupo_session_events.tab_id: "varchar(255)"
  lupo_session_events.world_id: "bigint"
  lupo_session_events.world_key: "varchar(255)"
  lupo_session_events.world_type: "varchar(50)"
  lupo_session_events.event_type: "varchar(100) NOT NULL"
  lupo_session_events.event_data: "json"
  lupo_session_events.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  table_primary_key: "session_event_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_session_events_idx_actor_id","lupo_session_events_idx_created_ymdhis","lupo_session_events_idx_event_type","lupo_session_events_idx_session_event_type","lupo_session_events_idx_session_id","lupo_session_events_idx_tab_id","lupo_session_events_idx_world_id"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_session_events.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_session_events" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_session_events"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_session_events from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| session_event_id | bigint NOT NULL | from TOON |
| session_id | varchar(255) NOT NULL | from TOON |
| actor_id | bigint | from TOON |
| tab_id | varchar(255) | from TOON |
| world_id | bigint | from TOON |
| world_key | varchar(255) | from TOON |
| world_type | varchar(50) | from TOON |
...
- session_event_id
Performance Indexes:
- lupo_session_events_idx_actor_id
- lupo_session_events_idx_created_ymdhis
- lupo_session_events_idx_event_type
- lupo_session_events_idx_session_event_type
- lupo_session_events_idx_session_id
- lupo_session_events_idx_tab_id
- lupo_session_events_idx_world_id
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_session_events WHERE session_event_id = :id;
SELECT COUNT(*) AS total FROM lupo_session_events WHERE is_deleted = 0;
SELECT * FROM lupo_session_events ORDER BY session_event_id DESC LIMIT 25;
UPDATE lupo_session_events SET updated_ymdhis = :ts WHERE session_event_id = :id;
```
