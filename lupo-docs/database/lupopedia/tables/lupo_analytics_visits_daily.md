...
flare.footer:
  outbound_edges:
    - { to: "docs/toons/lupo_analytics_visits_daily.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_analytics_visits_daily" }
