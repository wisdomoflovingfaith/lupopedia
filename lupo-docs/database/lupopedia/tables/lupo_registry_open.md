...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_registry_open.md"
  file_hash: "99a7ddbd8957ee4c7e38eb17ac08cf996f67a8c383d702771d0f83eb0148a016"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_registry_open.md"
  file_hash: "1dcbd21c95d6267b42003bc183a66150d60430342a506fd4f08df1a09d308e42"
  ...
  purpose: "Complete documentation for lupo_registry_open table"
  ...
  tags: ["database", "table", "lupo_registry_open"]
  lupo_agent: "codex-ide"
  lupo_registry_open.unregistry_id: "bigint NOT NULL auto_increment"
  lupo_registry_open.entity_type: "varchar(50) NOT NULL"
  lupo_registry_open.entity_index_id: "bigint NOT NULL"
  lupo_registry_open.reason: "varchar(255)"
  lupo_registry_open.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  table_primary_key: "unregistry_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["idx_registry_open_entity_type","idx_registry_open_unique"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_registry_open.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_registry_open" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_registry_open"]
  version: "4.0.48"
  last_verified: "20260227"
  last_verified_by: "codex-ide"
---

# Table: lupo_registry_open

Purpose: Auto-generated documentation for lupo_registry_open from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| unregistry_id | bigint NOT NULL auto_increment | from TOON |
| entity_type | varchar(50) NOT NULL | from TOON |
| entity_index_id | bigint NOT NULL | from TOON |
| reason | varchar(255) | from TOON |
...
- unregistry_id
Performance Indexes:
- idx_registry_open_entity_type
- idx_registry_open_unique
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_registry_open WHERE unregistry_id = :id;
SELECT COUNT(*) AS total FROM lupo_registry_open WHERE is_deleted = 0;
SELECT * FROM lupo_registry_open ORDER BY unregistry_id DESC LIMIT 25;
UPDATE lupo_registry_open SET updated_ymdhis = :ts WHERE unregistry_id = :id;
```
