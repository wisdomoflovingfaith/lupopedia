...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_api_webhooks.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_api_webhooks" }
