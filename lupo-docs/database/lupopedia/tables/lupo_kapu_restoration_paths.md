...
flare.footer:
  outbound_edges:
    - { to: "docs/toons/lupo_kapu_restoration_paths.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_kapu_restoration_paths" }
