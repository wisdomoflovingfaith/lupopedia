...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_actor_object_edges.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_actor_object_edges"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_actor_object_edges`
...
|--------|------|------|-----|---------|-------------|
| actor_object_edge_id | bigint | NO |  | NULL | |
| actor_id | bigint | NO |  | NULL | |
| target_table | varchar(100) | NO |  | NULL | |
| target_id | bigint | NO |  | NULL | |
| edge_type | varchar(50) | NO |  | NULL | |
