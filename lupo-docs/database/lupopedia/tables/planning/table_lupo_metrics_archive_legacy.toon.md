...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_metrics_archive_legacy.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_metrics_archive_legacy"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_metrics_archive_legacy`
...
|--------|------|------|-----|---------|-------------|
| metric_id | int | NO |  | NULL | |
| metric_key | varchar(255) | NO |  | NULL | |
| metric_value | varchar(255) | YES |  | NULL | |
| recorded_at | bigint | YES |  | NULL | |
