...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_gov_events.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_gov_events"
  mood_rgb: "4169E1"
...
| utc_group_id | bigint | NO |  | NULL | |
| semantic_utc_version | varchar(50) | NO |  | NULL | |
| canonical_path | varchar(500) | NO |  | NULL | |
| event_type | varchar(100) | NO |  | NULL | |
| title | varchar(255) | NO |  | NULL | |
| directive_block | text | YES |  | NULL | |
| tldr_summary | text | YES |  | NULL | |
