...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_gov_timeline_nodes.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_gov_timeline_nodes"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_gov_timeline_nodes`
...
|--------|------|------|-----|---------|-------------|
| timeline_node_id | bigint | NO |  | NULL | |
| gov_event_id | bigint | NO |  | NULL | |
| node_type | varchar(100) | NO |  | NULL | |
| node_title | varchar(255) | NO |  | NULL | |
| node_description | text | YES |  | NULL | |
| node_timestamp | bigint | NO |  | NULL | |
| parent_node_id | bigint | YES |  | NULL | |
