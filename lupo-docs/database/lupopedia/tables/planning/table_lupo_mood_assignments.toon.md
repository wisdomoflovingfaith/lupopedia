...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_mood_assignments.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_mood_assignments"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_mood_assignments`
...
|--------|------|------|-----|---------|-------------|
| mood_assignment_id | bigint | NO |  | NULL | |
