...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_modules_departments.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_modules_departments"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_modules_departments`
...
|--------|------|------|-----|---------|-------------|
| module_department_id | bigint | NO |  | NULL | |
| module_id | bigint | NO |  | NULL | |
