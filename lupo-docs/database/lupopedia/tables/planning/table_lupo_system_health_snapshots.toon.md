...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_system_health_snapshots.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_system_health_snapshots"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_system_health_snapshots`
...
|--------|------|------|-----|---------|-------------|
| health_id | bigint | NO |  | NULL | |
| table_count | int | NO |  | NULL | |
| table_ceiling | int | NO |  | NULL | |
| schema_state | varchar(64) | NO |  | unknown | |
| sync_integrity | varchar(32) | NO |  | unknown | |
| emotional_r | decimal(3,2) | YES |  | NULL | |
| emotional_g | decimal(3,2) | YES |  | NULL | |
| emotional_b | decimal(3,2) | YES |  | NULL | |
| emotional_t | decimal(3,2) | YES |  | NULL | |
