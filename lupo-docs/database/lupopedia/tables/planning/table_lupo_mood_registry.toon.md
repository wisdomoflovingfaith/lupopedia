...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_mood_registry.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_mood_registry"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_mood_registry`
...
|--------|------|------|-----|---------|-------------|
| mood_id | bigint | NO |  | NULL | |
| mood_type | varchar(64) | NO |  | NULL | |
| mood_variant | varchar(64) | YES |  | NULL | |
| mood_rgb | char(6) | NO |  | NULL | |
