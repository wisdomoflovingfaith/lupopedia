...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_search_index.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_search_index"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_search_index`
...
|--------|------|------|-----|---------|-------------|
| search_index_id | bigint | NO |  | NULL | |
| domain_id | bigint | NO |  | NULL | |
| entity_type | varchar(50) | NO |  | NULL | |
| entity_id | bigint | NO |  | NULL | |
| title_text | text | YES |  | NULL | |
| body_text | text | YES |  | NULL | |
| keywords_text | text | YES |  | NULL | |
| search_metadata | text | YES |  | NULL | |
| relevance_score | float | YES |  | 1 | |
