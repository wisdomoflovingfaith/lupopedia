...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_hashtags.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_hashtags"
  mood_rgb: "4169E1"
...
|--------|------|------|-----|---------|-------------|
| hashtag_id | bigint | NO |  | NULL | |
| hashtag_slug | varchar(255) | NO |  | NULL | |
