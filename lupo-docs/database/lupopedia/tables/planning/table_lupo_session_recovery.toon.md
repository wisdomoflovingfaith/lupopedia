...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_session_recovery.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_session_recovery"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_session_recovery`
...
|--------|------|------|-----|---------|-------------|
| recovery_id | BIGINT | NO |  | NULL | |
| actor_id | BIGINT | NO |  | NULL | |
| session_id | VARCHAR(255) | NO |  | NULL | |
| session_data | JSON | YES |  | NULL | |
| state_snapshot | JSON | YES |  | NULL | |
| context_data | JSON | YES |  | NULL | |
| last_activity_ymdhis | BIGINT | YES |  | 0 | |
| recovery_attempts | INT | YES |  | 0 | |
| max_recovery_attempts | INT | YES |  | 3 | |
