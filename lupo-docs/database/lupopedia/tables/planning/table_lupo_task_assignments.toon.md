...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_task_assignments.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_task_assignments"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_task_assignments`
...
|--------|------|------|-----|---------|-------------|
| assignment_id | bigint | NO |  | NULL | |
| task_id | bigint | NO |  | NULL | |
| actor_id | bigint | NO |  | NULL | |
| assignment_type | varchar(32) | NO |  | assigned | |
| assigned_by_actor_id | bigint | NO |  | NULL | |
