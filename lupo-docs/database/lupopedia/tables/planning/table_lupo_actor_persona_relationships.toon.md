...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_actor_persona_relationships.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_actor_persona_relationships"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_actor_persona_relationships`
...
|--------|------|------|-----|---------|-------------|
| relationship_id | bigint | NO |  | NULL | |
| actor_id | bigint | NO |  | NULL | |
| persona_id | bigint | NO |  | NULL | |
| relationship_type | varchar(100) | NO |  | NULL | |
| relationship_strength | decimal(5,2) | YES |  | NULL | |
| relationship_context | json | YES |  | NULL | |
