...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_emotional_translations.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_emotional_translations"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_emotional_translations`
...
|--------|------|------|-----|---------|-------------|
| translation_id | bigint | NO |  | NULL | |
| source_framework | varchar(32) | NO |  | NULL | |
| source_state | text | NO |  | NULL | |
| target_framework | varchar(32) | NO |  | NULL | |
| target_state | text | NO |  | NULL | |
| loss_score | decimal(3,2) | NO |  | NULL | |
| created_ymdhis | bigint | NO |  | 0 | |
| last_used_ymdhis | bigint | NO |  | NULL | |
