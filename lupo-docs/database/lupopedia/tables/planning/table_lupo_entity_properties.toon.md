...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_entity_properties.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_entity_properties"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_entity_properties`
...
|--------|------|------|-----|---------|-------------|
| entity_property_id | bigint | NO |  | NULL | |
| entity_type | varchar(64) | NO |  | NULL | |
| entity_id | bigint | NO |  | NULL | |
| domain_id | bigint | NO |  | 1 | |
| property_key | varchar(100) | NO |  | NULL | |
| property_value | text | YES |  | NULL | |
