...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_gov_event_dependencies.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_gov_event_dependencies"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_gov_event_dependencies`
...
|--------|------|------|-----|---------|-------------|
| gov_event_dependency_id | bigint | NO |  | NULL | |
| gov_event_id | bigint | NO |  | NULL | |
| depends_on_event_id | bigint | NO |  | NULL | |
| dependency_type | varchar(50) | NO |  | NULL | |
| notes | text | YES |  | NULL | |
