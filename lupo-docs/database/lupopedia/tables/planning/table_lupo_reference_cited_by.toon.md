...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_reference_cited_by.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_reference_cited_by"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_reference_cited_by`
...
|--------|------|------|-----|---------|-------------|
| reference_cited_by_id | bigint | NO |  | NULL | |
| reference_object_id | bigint | NO |  | NULL | |
| content_id | bigint | NO |  | NULL | |
| section_anchor_slug | varchar(255) | YES |  | NULL | |
| section_order | int | NO |  | 0 | |
