...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_persona_dialogue_patterns.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_persona_dialogue_patterns"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_persona_dialogue_patterns`
...
|--------|------|------|-----|---------|-------------|
| pattern_id | bigint | NO |  | NULL | |
| persona_id | bigint | NO |  | NULL | |
| pattern_type | varchar(100) | NO |  | NULL | |
| pattern_name | varchar(255) | NO |  | NULL | |
| pattern_triggers | json | YES |  | NULL | |
| pattern_responses | json | YES |  | NULL | |
| pattern_context | json | YES |  | NULL | |
| pattern_frequency | decimal(5,2) | YES |  | NULL | |
| pattern_confidence | decimal(5,2) | YES |  | NULL | |
