...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_emotional_frameworks.md"
  file_hash: "aef7daafe0b359d0b18c3227e672a469313ff67f1f388e98751adb7196ec9ad6"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_emotional_frameworks.md"
  file_hash: "e4775a9296f3f1c50a9f3d6dfcefeca39eaa427908c019f7c7347cd23044aa48"
  ...
  purpose: "Complete documentation for lupo_emotional_frameworks table"
  ...
  tags: ["database", "table", "lupo_emotional_frameworks"]
  lupo_agent: "codex-ide"
  lupo_emotional_frameworks.framework_name: "varchar(32) NOT NULL"
  lupo_emotional_frameworks.description: "text"
  lupo_emotional_frameworks.is_default: "tinyint NOT NULL DEFAULT 0"
  lupo_emotional_frameworks.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_emotional_frameworks.updated_ymdhis: "bigint NOT NULL"
  table_primary_key: "framework_name"
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_emotional_frameworks.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_emotional_frameworks" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_emotional_frameworks"]
  version: "4.0.48"
  last_verified: "20260227"
  last_verified_by: "codex-ide"
---

# Table: lupo_emotional_frameworks

Purpose: Auto-generated documentation for lupo_emotional_frameworks from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| framework_name | varchar(32) NOT NULL | from TOON |
...
Common Queries:
```sql
SELECT * FROM lupo_emotional_frameworks WHERE framework_name = :id;
SELECT COUNT(*) AS total FROM lupo_emotional_frameworks WHERE is_deleted = 0;
SELECT * FROM lupo_emotional_frameworks ORDER BY framework_name DESC LIMIT 25;
UPDATE lupo_emotional_frameworks SET updated_ymdhis = :ts WHERE framework_name = :id;
```
