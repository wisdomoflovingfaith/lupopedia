...
lupopedia.conditional:
  ...
  brief:
    ...
    what:
      artifact_type: "guide"
      objective: "lupo_channel_* Tables Overview"
    where:
      repo_paths: ["lupo-docs\database\lupopedia\tables\lupo_channel_tables_overview.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_channel_tables_overview.md"
  file_hash: "bd67d3623dd23a980fc337b48d5ddbe2b79c068e6d554ca009884104d44cccc5"
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  last_verified: "20260304"
  last_verified_by: "antigravity"

lupopedia.see:
  mappings:
    - ["lupo-docs\database\lupopedia\tables\lupo_channel_tables_overview.md", "http://www.lupopedia.com/LUPO_CHANNEL_TABLES_OVERVIEW"]
...
lupo_channels (channel_id)
    â”œâ”€â”€ lupo_channel_content (channel_id)
    â”œâ”€â”€ lupo_channel_files (channel_id)
    â”œâ”€â”€ lupo_channel_state (channel_id)
    â”œâ”€â”€ lupo_channel_logs (channel_id)
    â”œâ”€â”€ lupo_channel_escalation_rules (channel_id)
    â”œâ”€â”€ lupo_channel_escalations (channel_id)
    â”œâ”€â”€ lupo_channel_boot_log (channel_id - legacy)
    â”œâ”€â”€ lupo_channel_boot_detail (channel_id - legacy)
    â”œâ”€â”€ lupo_channel_boot_lifecycle (channel_id)
    â””â”€â”€ lupo_channel_boot_detail_lifecycle (lifecycle_id)
```
