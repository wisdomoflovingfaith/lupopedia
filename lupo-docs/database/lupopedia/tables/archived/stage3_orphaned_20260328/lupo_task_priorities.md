...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_task_priorities.md"
  file_hash: "23cd03787cbf42df4a823065d1635697f9b0cfb3f2cdab6524e20eabab723eeb"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_task_priorities.md"
  file_hash: "33c8d42ee97ad868c1e2321b1a24d51fdeb610885f4db6c9b17cb128af4b2fbd"
  ...
  purpose: "Complete documentation for lupo_task_priorities table"
  ...
  tags: ["database", "table", "lupo_task_priorities"]
  lupo_agent: "codex-ide"
  lupo_task_priorities.priority_id: "bigint NOT NULL"
  lupo_task_priorities.priority_key: "varchar(64) NOT NULL"
  lupo_task_priorities.priority_name: "varchar(255) NOT NULL"
  lupo_task_priorities.priority_level: "int NOT NULL"
  lupo_task_priorities.description: "text"
  lupo_task_priorities.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_task_priorities.updated_ymdhis: "bigint NOT NULL"
  lupo_task_priorities.is_deleted: "tinyint NOT NULL DEFAULT 0"
  table_primary_key: "priority_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_task_priorities_idx_is_deleted","lupo_task_priorities_idx_priority_level","lupo_task_priorities_uniq_priority_key"]
  table_foreign_keys: []
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_task_priorities.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_task_priorities" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_task_priorities"]
  version: "4.0.48"
  last_verified: "20260227"
  last_verified_by: "codex-ide"
---

# Table: lupo_task_priorities

Purpose: Auto-generated documentation for lupo_task_priorities from TOON schema.
Type: database_table
...
| priority_key | varchar(64) NOT NULL | from TOON |
| priority_name | varchar(255) NOT NULL | from TOON |
| priority_level | int NOT NULL | from TOON |
...
- priority_id
Performance Indexes:
- lupo_task_priorities_idx_is_deleted
- lupo_task_priorities_idx_priority_level
- lupo_task_priorities_uniq_priority_key
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_task_priorities WHERE priority_id = :id;
SELECT COUNT(*) AS total FROM lupo_task_priorities WHERE is_deleted = 0;
SELECT * FROM lupo_task_priorities ORDER BY priority_id DESC LIMIT 25;
UPDATE lupo_task_priorities SET updated_ymdhis = :ts WHERE priority_id = :id;
```
