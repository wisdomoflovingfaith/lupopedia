...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_gov_timeline_nodes.md"
  file_hash: "782a1d25a59499f3cfe0319fd032fc5bd00d17c294a60e99158d8ace2384f5a0"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_gov_timeline_nodes.md"
  ...
  purpose: "Complete documentation for lupo_gov_timeline_nodes table"
  ...
  tags: ["database", "table", "lupo_gov_timeline_nodes"]
  lupo_agent: "codex-ide"
  lupo_gov_timeline_nodes.timeline_node_id: "bigint NOT NULL"
  lupo_gov_timeline_nodes.gov_event_id: "bigint NOT NULL"
  lupo_gov_timeline_nodes.node_type: "varchar(100) NOT NULL"
  lupo_gov_timeline_nodes.node_title: "varchar(255) NOT NULL"
  lupo_gov_timeline_nodes.node_description: "text"
  lupo_gov_timeline_nodes.node_timestamp: "bigint NOT NULL"
  lupo_gov_timeline_nodes.parent_node_id: "bigint"
  lupo_gov_timeline_nodes.order_sequence: "int NOT NULL DEFAULT 0"
  lupo_gov_timeline_nodes.metadata_json: "json"
  lupo_gov_timeline_nodes.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_gov_timeline_nodes.updated_ymdhis: "bigint"
  lupo_gov_timeline_nodes.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_gov_timeline_nodes.deleted_ymdhis: "bigint"
  table_primary_key: "timeline_node_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_gov_timeline_nodes_idx_created_ymdhis","lupo_gov_timeline_nodes_idx_gov_event","lupo_gov_timeline_nodes_idx_is_deleted","lupo_gov_timeline_nodes_idx_node_timestamp","lupo_gov_timeline_nodes_idx_node_type","lupo_gov_timeline_nodes_idx_order_sequence","lupo_gov_timeline_nodes_idx_parent_node"]
  table_foreign_keys: []
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_gov_timeline_nodes.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_gov_timeline_nodes" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_gov_timeline_nodes"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_gov_timeline_nodes from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| timeline_node_id | bigint NOT NULL | from TOON |
| gov_event_id | bigint NOT NULL | from TOON |
| node_type | varchar(100) NOT NULL | from TOON |
| node_title | varchar(255) NOT NULL | from TOON |
| node_description | text | from TOON |
| node_timestamp | bigint NOT NULL | from TOON |
| parent_node_id | bigint | from TOON |
| order_sequence | int NOT NULL DEFAULT 0 | from TOON |
...
- timeline_node_id
Performance Indexes:
- lupo_gov_timeline_nodes_idx_created_ymdhis
- lupo_gov_timeline_nodes_idx_gov_event
- lupo_gov_timeline_nodes_idx_is_deleted
- lupo_gov_timeline_nodes_idx_node_timestamp
- lupo_gov_timeline_nodes_idx_node_type
- lupo_gov_timeline_nodes_idx_order_sequence
- lupo_gov_timeline_nodes_idx_parent_node
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_gov_timeline_nodes WHERE timeline_node_id = :id;
SELECT COUNT(*) AS total FROM lupo_gov_timeline_nodes WHERE is_deleted = 0;
SELECT * FROM lupo_gov_timeline_nodes ORDER BY timeline_node_id DESC LIMIT 25;
UPDATE lupo_gov_timeline_nodes SET updated_ymdhis = :ts WHERE timeline_node_id = :id;
```
