...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_world_events.md"
  file_hash: "f902fd268a527db4799194266aa9019f3fcca610d8a7ac2b80352904de47f056"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_world_events.md"
  file_hash: "16fc99cc4b6dcaa864b32e061520f8a133dbd30d28974aba52cd779dee9a5a3b"
  ...
  purpose: "Complete documentation for lupo_world_events table"
  ...
  tags: ["database", "table", "lupo_world_events"]
  lupo_agent: "codex-ide"
  lupo_world_events.world_event_id: "bigint NOT NULL"
  lupo_world_events.world_id: "bigint NOT NULL"
  lupo_world_events.actor_id: "bigint NOT NULL"
  lupo_world_events.event_type: "varchar(100) NOT NULL"
  lupo_world_events.event_data: "json"
  lupo_world_events.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  table_primary_key: "world_event_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_world_events_idx_actor_id","lupo_world_events_idx_created_ymdhis","lupo_world_events_idx_event_type","lupo_world_events_idx_world_id"]
  table_foreign_keys: []
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_world_events.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_world_events" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_world_events"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_world_events from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| world_event_id | bigint NOT NULL | from TOON |
...
- world_event_id
Performance Indexes:
- lupo_world_events_idx_actor_id
- lupo_world_events_idx_created_ymdhis
- lupo_world_events_idx_event_type
- lupo_world_events_idx_world_id
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_world_events WHERE world_event_id = :id;
SELECT COUNT(*) AS total FROM lupo_world_events WHERE is_deleted = 0;
SELECT * FROM lupo_world_events ORDER BY world_event_id DESC LIMIT 25;
UPDATE lupo_world_events SET updated_ymdhis = :ts WHERE world_event_id = :id;
```
