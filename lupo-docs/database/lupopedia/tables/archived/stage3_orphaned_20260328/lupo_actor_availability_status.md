...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/database/lupopedia/tables/active/lupo_actor_availability_status.md
  web_path: http://www.lupopedia.com/database/lupopedia/tables/active/lupo_actor_availability_status
  last_modified_utc: '20260326195900'
  ...
  artifact_kind: table
  namespace: livehelp
  purpose: Schema documentation for live help operator availability tracking table
  tags:
    - database
    - table
    - livehelp
...
lupopedia.edges:
  outbound_edges:
    - to: lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql
      ...
      weight: 1.0
    - to: lupo-database/lupopedia/toon/lupo_actor_availability_status.toon
      type: TOON_reference
      weight: 1.0
...
lupopedia.footer:
  ...
  submitted_utc: "20260326195900"
  last_verified: "20260326195900"
---
...
1. **ActorAvailabilityService** (`lupo-includes/classes/ActorAvailabilityService.php`)
...
2. **ChatRoutingService** (`lupo-includes/classes/ChatRoutingService.php`)
   - Queries available operators when routing new chats

3. **Admin UI** (`lupo-includes/modules/admin/sections/actor-status.php`)
   - Displays operator status board
   - Allows manual status toggle

4. **Live Handler** (`lupo-includes/modules/livehelp/livehelp-handler.php`)
...
Full schema definition stored in: `lupo-database/lupopedia/toon/lupo_actor_availability_status.toon`

Generated/verified with: `python lupo-scripts/verify_db_against_toons.py`
