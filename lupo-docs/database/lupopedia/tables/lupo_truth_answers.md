...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_truth_answers.md"
  file_hash: "ec685c6de2870ccb2c70e41fceef39facec3084f2a425ef38875d8269d3d88ef"
...
flare.headers:
  ...
  purpose: "Complete documentation for lupo_truth_answers table"
  ...
  tags: ["database", "table", "lupo_truth_answers"]
  lupo_agent: "codex-ide"
  lupo_truth_answers.truth_answer_id: "bigint NOT NULL auto_increment"
  lupo_truth_answers.truth_question_id: "bigint NOT NULL"
  lupo_truth_answers.actor_id: "bigint NOT NULL"
  lupo_truth_answers.answer_text: "text"
  lupo_truth_answers.confidence: "decimal(5,2) DEFAULT 0.00"
  lupo_truth_answers.evidence_count: "int DEFAULT 0"
  lupo_truth_answers.source_count: "int DEFAULT 0"
  lupo_truth_answers.status: "varchar(64) DEFAULT 'active'"
  lupo_truth_answers.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_truth_answers.updated_ymdhis: "bigint NOT NULL"
  lupo_truth_answers.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_truth_answers.deleted_ymdhis: "bigint"
  table_primary_key: "truth_answer_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_truth_answers_idx_actor","lupo_truth_answers_idx_created","lupo_truth_answers_idx_question","lupo_truth_answers_idx_status"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_truth_answers.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_truth_answers" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_truth_answers"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_truth_answers from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| truth_answer_id | bigint NOT NULL auto_increment | from TOON |
| truth_question_id | bigint NOT NULL | from TOON |
| actor_id | bigint NOT NULL | from TOON |
| answer_text | text | from TOON |
| confidence | decimal(5,2) DEFAULT 0.00 | from TOON |
| evidence_count | int DEFAULT 0 | from TOON |
| source_count | int DEFAULT 0 | from TOON |
...
- truth_answer_id
Performance Indexes:
- lupo_truth_answers_idx_actor
- lupo_truth_answers_idx_created
- lupo_truth_answers_idx_question
- lupo_truth_answers_idx_status
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_truth_answers WHERE truth_answer_id = :id;
SELECT COUNT(*) AS total FROM lupo_truth_answers WHERE is_deleted = 0;
SELECT * FROM lupo_truth_answers ORDER BY truth_answer_id DESC LIMIT 25;
UPDATE lupo_truth_answers SET updated_ymdhis = :ts WHERE truth_answer_id = :id;
```
