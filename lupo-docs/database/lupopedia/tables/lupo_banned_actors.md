...
flare.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_banned_actors.md"
  file_hash: "de5b9b3488d58a5ff95a6103ba5583519f432a228ebf4d1284197a9c99ead81f"
...
---
flare.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_banned_actors.md"
  ...
  purpose: "Complete documentation for lupo_banned_actors table"
  ...
  tags: ["database", "table", "lupo_banned_actors"]
  lupo_agent: "codex-ide"
  lupo_banned_actors.banned_actor_id: "bigint NOT NULL"
  lupo_banned_actors.actor_id: "bigint NOT NULL"
  lupo_banned_actors.ip_address: "varchar(45)"
  lupo_banned_actors.reason: "varchar(500) NOT NULL"
  lupo_banned_actors.banned_ymdhis: "bigint NOT NULL"
  lupo_banned_actors.banned_by_actor_id: "bigint"
  lupo_banned_actors.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_banned_actors.updated_ymdhis: "bigint NOT NULL"
  lupo_banned_actors.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_banned_actors.deleted_ymdhis: "bigint"
  table_primary_key: "banned_actor_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_banned_actors_idx_actor_id","lupo_banned_actors_idx_ip_address","lupo_banned_actors_idx_is_deleted"]
  table_foreign_keys: []
...
flare.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_banned_actors.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_banned_actors" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_banned_actors"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_banned_actors from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| banned_actor_id | bigint NOT NULL | from TOON |
| actor_id | bigint NOT NULL | from TOON |
| ip_address | varchar(45) | from TOON |
| reason | varchar(500) NOT NULL | from TOON |
| banned_ymdhis | bigint NOT NULL | from TOON |
| banned_by_actor_id | bigint | from TOON |
...
- banned_actor_id
Performance Indexes:
- lupo_banned_actors_idx_actor_id
- lupo_banned_actors_idx_ip_address
- lupo_banned_actors_idx_is_deleted
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_banned_actors WHERE banned_actor_id = :id;
SELECT COUNT(*) AS total FROM lupo_banned_actors WHERE is_deleted = 0;
SELECT * FROM lupo_banned_actors ORDER BY banned_actor_id DESC LIMIT 25;
UPDATE lupo_banned_actors SET updated_ymdhis = :ts WHERE banned_actor_id = :id;
```
