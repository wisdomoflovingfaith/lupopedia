...
lupopedia.headers:
  ...
  mood_rgb: "4169E1"
  traits: ["canonical", "anubis", "integrity", "v4.0.70"]
  tags: ["database", "anubis", "redirects", "reconciliation"]
  lupo_agent: "antigravity"

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_anubis_redirects.toon", type: "references", weight: 1.0 }
