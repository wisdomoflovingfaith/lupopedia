...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_visits.md"
  file_hash: "b4e4ab3df43bf339e3d0da708c50e29721197abfb57311e01854f4b9c285e1d2"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_visits.md"
  ...
  purpose: "Complete documentation for lupo_visits table"
  ...
  tags: ["database", "table", "lupo_visits"]
  lupo_agent: "codex-ide"
  lupo_visits.visit_id: "bigint NOT NULL auto_increment"
  lupo_visits.content_id: "bigint NOT NULL DEFAULT 0"
  lupo_visits.actor_id: "bigint NOT NULL DEFAULT 0"
  lupo_visits.page_url: "varchar(500) NOT NULL"
  lupo_visits.page_domain: "varchar(255) NOT NULL"
  lupo_visits.page_path: "varchar(500) NOT NULL"
  lupo_visits.date_ymd: "int NOT NULL"
  lupo_visits.visits: "int NOT NULL DEFAULT 0"
  lupo_visits.depth: "int NOT NULL DEFAULT 0"
  lupo_visits.metadata_json: "json"
  lupo_visits.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_visits.updated_ymdhis: "bigint NOT NULL DEFAULT 0"
  table_primary_key: "visit_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_visits_content_id","lupo_visits_date_ymd","lupo_visits_page_domain"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_visits.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_visits" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_visits"]
  version: "4.0.48"
