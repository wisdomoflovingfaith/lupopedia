...
lupopedia.headers:
  ...
  artifact_kind: table
  namespace: channels
  purpose: Channel state and metadata; tracks channel configuration, status, and operational
    parameters
  tags:
  - database
  - table
...
lupopedia.edges:
  comment: Snapshot of edges for lupo_channel_state table doc at 4.0.79 (grounded
    by repo search; non-exhaustive).
  meta: php_hits=1 python_hits=1
  outbound_edges:
  - to: database.table.lupo_channel_state
