...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_channel_escalation_rules.md"
  ...
  purpose: "Complete documentation for lupo_channel_escalation_rules table"
  ...
  tags: ["database", "table", "lupo_channel_escalation_rules"]
  lupo_agent: "codex-ide"
  lupo_channel_escalation_rules.rule_id: "bigint NOT NULL"
  lupo_channel_escalation_rules.channel_id: "bigint NOT NULL"
  lupo_channel_escalation_rules.rule_name: "varchar(255) NOT NULL"
  lupo_channel_escalation_rules.rule_description: "text"
  lupo_channel_escalation_rules.rule_type: "varchar(64) NOT NULL"
  lupo_channel_escalation_rules.rule_config_json: "json"
  lupo_channel_escalation_rules.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_channel_escalation_rules.updated_ymdhis: "bigint NOT NULL"
  lupo_channel_escalation_rules.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_channel_escalation_rules.deleted_ymdhis: "bigint"
  table_primary_key: "rule_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_channel_escalation_rules_idx_channel_id","lupo_channel_escalation_rules_idx_rule_type"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_channel_escalation_rules.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_channel_escalation_rules" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_channel_escalation_rules"]
  version: "4.0.48"
  last_verified: "20260227"
  last_verified_by: "codex-ide"
---

# Table: lupo_channel_escalation_rules

Purpose: Auto-generated documentation for lupo_channel_escalation_rules from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| rule_id | bigint NOT NULL | from TOON |
| channel_id | bigint NOT NULL | from TOON |
| rule_name | varchar(255) NOT NULL | from TOON |
| rule_description | text | from TOON |
| rule_type | varchar(64) NOT NULL | from TOON |
| rule_config_json | json | from TOON |
...
- rule_id
Performance Indexes:
- lupo_channel_escalation_rules_idx_channel_id
- lupo_channel_escalation_rules_idx_rule_type
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_channel_escalation_rules WHERE rule_id = :id;
SELECT COUNT(*) AS total FROM lupo_channel_escalation_rules WHERE is_deleted = 0;
SELECT * FROM lupo_channel_escalation_rules ORDER BY rule_id DESC LIMIT 25;
UPDATE lupo_channel_escalation_rules SET updated_ymdhis = :ts WHERE rule_id = :id;
```
