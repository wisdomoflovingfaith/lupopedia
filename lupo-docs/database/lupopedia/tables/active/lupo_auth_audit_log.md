...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_auth_audit_log.md"
  file_hash: "ffd92973e74404c6914a6d4022e33cfe3ca225a72768e9feb67e37c6a8bd03e9"
...
---
lupopedia.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_auth_audit_log.md"
  ...
  purpose: "Complete documentation for lupo_auth_audit_log table"
  ...
  tags: ["database", "table", "lupo_auth_audit_log"]
  lupo_agent: "codex-ide"
  lupo_auth_audit_log.auth_audit_log_id: "bigint NOT NULL"
  lupo_auth_audit_log.user_id: "bigint"
  lupo_auth_audit_log.crafty_operator_id: "int"
  lupo_auth_audit_log.event_type: "varchar(50) NOT NULL"
  lupo_auth_audit_log.system_context: "varchar(50) NOT NULL"
  lupo_auth_audit_log.ip_address: "varchar(45)"
  lupo_auth_audit_log.user_agent: "text"
  lupo_auth_audit_log.event_data: "json"
  lupo_auth_audit_log.success: "tinyint NOT NULL DEFAULT 1"
  lupo_auth_audit_log.error_message: "text"
  lupo_auth_audit_log.created_at: "bigint"
  lupo_auth_audit_log.updated_at: "bigint"
  table_primary_key: "auth_audit_log_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_auth_audit_log_idx_crafty_operator_id","lupo_auth_audit_log_idx_created_at","lupo_auth_audit_log_idx_event_type","lupo_auth_audit_log_idx_success","lupo_auth_audit_log_idx_system_context","lupo_auth_audit_log_idx_user_id"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_auth_audit_log.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_auth_audit_log" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_auth_audit_log"]
  version: "4.0.48"
