...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_governance_overrides.md"
  ...
  purpose: "Complete documentation for lupo_governance_overrides table"
  ...
  tags: ["database", "table", "lupo_governance_overrides"]
  lupo_agent: "codex-ide"
  lupo_governance_overrides.governance_overrid_id: "bigint NOT NULL"
  lupo_governance_overrides.agent_id: "bigint"
  lupo_governance_overrides.applied_by_agent: "bigint"
  lupo_governance_overrides.override_type: "varchar(100) NOT NULL"
  lupo_governance_overrides.target_key: "varchar(150)"
  lupo_governance_overrides.old_value: "text"
  lupo_governance_overrides.new_value: "text"
  lupo_governance_overrides.reason_text: "text"
  lupo_governance_overrides.metadata_json: "json"
  lupo_governance_overrides.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_governance_overrides.expires_ymdhis: "bigint"
  lupo_governance_overrides.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_governance_overrides.deleted_ymdhis: "bigint"
  table_primary_key: "governance_overrid_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_governance_overrides_idx_agent","lupo_governance_overrides_idx_applied_by","lupo_governance_overrides_idx_created","lupo_governance_overrides_idx_target","lupo_governance_overrides_idx_type"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_governance_overrides.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_governance_overrides" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_governance_overrides"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_governance_overrides from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| governance_overrid_id | bigint NOT NULL | from TOON |
| agent_id | bigint | from TOON |
| applied_by_agent | bigint | from TOON |
| override_type | varchar(100) NOT NULL | from TOON |
| target_key | varchar(150) | from TOON |
| old_value | text | from TOON |
| new_value | text | from TOON |
| reason_text | text | from TOON |
...
Primary Indexes:
- governance_overrid_id
Performance Indexes:
- lupo_governance_overrides_idx_agent
- lupo_governance_overrides_idx_applied_by
- lupo_governance_overrides_idx_created
- lupo_governance_overrides_idx_target
- lupo_governance_overrides_idx_type
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_governance_overrides WHERE governance_overrid_id = :id;
SELECT COUNT(*) AS total FROM lupo_governance_overrides WHERE is_deleted = 0;
SELECT * FROM lupo_governance_overrides ORDER BY governance_overrid_id DESC LIMIT 25;
UPDATE lupo_governance_overrides SET updated_ymdhis = :ts WHERE governance_overrid_id = :id;
```
