...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_memory_rollups.md"
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_memory_rollups.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_memory_rollups" }
