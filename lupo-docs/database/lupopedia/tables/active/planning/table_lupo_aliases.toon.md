...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_aliases.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_aliases"
  mood_rgb: "4169E1"
...
|--------|------|------|-----|---------|-------------|
| alias_id | int | NO |  | NULL | |
| slug | varchar(255) | NO |  | NULL | |
| alias | varchar(255) | NO |  | NULL | |
| alias_type | varchar(50) | YES |  | semantic | |
