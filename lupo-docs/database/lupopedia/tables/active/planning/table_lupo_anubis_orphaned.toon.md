...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_anubis_orphaned.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_anubis_orphaned"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_anubis_orphaned`
...
|--------|------|------|-----|---------|-------------|
| anubis_orphaned_id | bigint | NO |  | NULL | |
| table_name | varchar(255) | NO |  | NULL | |
| orphan_id | bigint | NO |  | NULL | |
