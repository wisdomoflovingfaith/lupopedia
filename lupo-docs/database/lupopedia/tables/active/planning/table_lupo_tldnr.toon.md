...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_tldnr.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_tldnr"
  mood_rgb: "4169E1"
...
|--------|------|------|-----|---------|-------------|
| tldnr_id | bigint | NO |  | NULL | |
| slug | varchar(255) | NO |  | NULL | |
| title | varchar(255) | NO |  | NULL | |
| content_text | text | NO |  | NULL | |
| topic_type | varchar(100) | YES |  | NULL | |
| topic_reference | varchar(255) | YES |  | NULL | |
