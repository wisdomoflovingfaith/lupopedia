...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/planning/table_lupo_gov_event_references.toon.md"
  ...
  purpose: "Planned Lupopedia database table: lupo_gov_event_references"
  mood_rgb: "4169E1"
...
# Planned Table: `lupo_gov_event_references`
...
|--------|------|------|-----|---------|-------------|
| reference_id | bigint | NO |  | NULL | |
| gov_event_id | bigint | NO |  | NULL | |
| reference_type | varchar(100) | NO |  | NULL | |
| reference_title | varchar(255) | NO |  | NULL | |
| reference_url | varchar(1000) | YES |  | NULL | |
| reference_content | text | YES |  | NULL | |
| order_sequence | int | NO |  | 0 | |
