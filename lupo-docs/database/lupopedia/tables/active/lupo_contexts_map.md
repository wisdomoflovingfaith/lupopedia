...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_contexts_map.md"
  file_hash: "808332f599d4fa4bac07108497c0e8c55b38b2230dba1eaedf4edba2fdc9d991"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_contexts_map.md"
  file_hash: "d39c39af9e7442042c5a103bc65e94877a07ec852c91a7869e097e9c94d4a44f"
  ...
  purpose: "Complete documentation for lupo_contexts_map table"
  ...
  tags: ["database", "table", "lupo_contexts_map"]
  lupo_agent: "codex-ide"
  lupo_contexts_map.contexts_map_id: "bigint NOT NULL"
  lupo_contexts_map.context_id: "bigint NOT NULL"
  lupo_contexts_map.item_type: "varchar(50) NOT NULL"
  lupo_contexts_map.item_slug: "varchar(255) NOT NULL"
  lupo_contexts_map.description: "text"
  lupo_contexts_map.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_contexts_map.deleted_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_contexts_map.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_contexts_map.updated_ymdhis: "bigint NOT NULL DEFAULT 0"
  table_primary_key: "contexts_map_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_contexts_map_idx_context_id","lupo_contexts_map_idx_context_item","lupo_contexts_map_idx_is_deleted","lupo_contexts_map_idx_item_slug","lupo_contexts_map_idx_item_type"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_contexts_map.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_contexts_map" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_contexts_map"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_contexts_map from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| contexts_map_id | bigint NOT NULL | from TOON |
| context_id | bigint NOT NULL | from TOON |
| item_type | varchar(50) NOT NULL | from TOON |
| item_slug | varchar(255) NOT NULL | from TOON |
...
- contexts_map_id
Performance Indexes:
- lupo_contexts_map_idx_context_id
- lupo_contexts_map_idx_context_item
- lupo_contexts_map_idx_is_deleted
- lupo_contexts_map_idx_item_slug
- lupo_contexts_map_idx_item_type
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_contexts_map WHERE contexts_map_id = :id;
SELECT COUNT(*) AS total FROM lupo_contexts_map WHERE is_deleted = 0;
SELECT * FROM lupo_contexts_map ORDER BY contexts_map_id DESC LIMIT 25;
UPDATE lupo_contexts_map SET updated_ymdhis = :ts WHERE contexts_map_id = :id;
```
