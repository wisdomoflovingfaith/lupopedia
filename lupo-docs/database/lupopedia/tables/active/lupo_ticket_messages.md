...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_ticket_messages.md"
  file_hash: "f95cf2c14422c2104bdcdefeb8f22053b4e6fe2f9bf2e5b28c66bad4d3ee8236"
  ...
  purpose: "Complete documentation for lupo_ticket_messages table"
  ...
  tags: ["database", "table", "lupo_ticket_messages"]
  lupo_agent: "codex-ide"
  lupo_ticket_messages.ticket_message_id: "bigint NOT NULL"
  lupo_ticket_messages.ticket_id: "bigint NOT NULL"
  lupo_ticket_messages.actor_id: "bigint NOT NULL"
  lupo_ticket_messages.message_text: "text NOT NULL"
  lupo_ticket_messages.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_ticket_messages.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_ticket_messages.deleted_ymdhis: "bigint"
  table_primary_key: "ticket_message_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: "lupo_ticket_messages_idx_ticket"
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_ticket_messages.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_ticket_messages" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_ticket_messages"]
  version: "4.0.48"
  last_verified: "20260227"
  last_verified_by: "codex-ide"
---

# Table: lupo_ticket_messages

Purpose: Auto-generated documentation for lupo_ticket_messages from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| ticket_message_id | bigint NOT NULL | from TOON |
| ticket_id | bigint NOT NULL | from TOON |
| actor_id | bigint NOT NULL | from TOON |
| message_text | text NOT NULL | from TOON |
...
- ticket_message_id
Performance Indexes:
- lupo_ticket_messages_idx_ticket
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_ticket_messages WHERE ticket_message_id = :id;
SELECT COUNT(*) AS total FROM lupo_ticket_messages WHERE is_deleted = 0;
SELECT * FROM lupo_ticket_messages ORDER BY ticket_message_id DESC LIMIT 25;
UPDATE lupo_ticket_messages SET updated_ymdhis = :ts WHERE ticket_message_id = :id;
```
