...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_notifications.md"
  file_hash: "5b59a5a79458e1fdb78579ccc0fe4bcfdbf97cfc9356066a0efa8fe5e0cb8536"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_notifications.md"
  ...
  purpose: "Complete documentation for lupo_notifications table"
  ...
  tags: ["database", "table", "lupo_notifications"]
  lupo_agent: "codex-ide"
  lupo_notifications.notification_id: "bigint NOT NULL"
  lupo_notifications.actor_id: "bigint NOT NULL"
  lupo_notifications.from_actor_id: "bigint"
  lupo_notifications.to_actor_id: "bigint"
  lupo_notifications.channel_id: "bigint"
  lupo_notifications.notification_type: "varchar(64) NOT NULL"
  lupo_notifications.title: "varchar(255)"
  lupo_notifications.message: "text"
  lupo_notifications.link_url: "varchar(255)"
  lupo_notifications.is_read: "tinyint NOT NULL DEFAULT 0"
  lupo_notifications.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_notifications.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  table_primary_key: "notification_id"
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_notifications.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_notifications" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_notifications"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_notifications from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| notification_id | bigint NOT NULL | from TOON |
| actor_id | bigint NOT NULL | from TOON |
| from_actor_id | bigint | from TOON |
| to_actor_id | bigint | from TOON |
| channel_id | bigint | from TOON |
| notification_type | varchar(64) NOT NULL | from TOON |
| title | varchar(255) | from TOON |
| message | text | from TOON |
| link_url | varchar(255) | from TOON |
| is_read | tinyint NOT NULL DEFAULT 0 | from TOON |
...
Common Queries:
```sql
SELECT * FROM lupo_notifications WHERE notification_id = :id;
SELECT COUNT(*) AS total FROM lupo_notifications WHERE is_deleted = 0;
SELECT * FROM lupo_notifications ORDER BY notification_id DESC LIMIT 25;
UPDATE lupo_notifications SET updated_ymdhis = :ts WHERE notification_id = :id;
```
