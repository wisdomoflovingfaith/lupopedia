...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_doctrine_evolution_audit.md"
  ...
  purpose: "Complete documentation for lupo_doctrine_evolution_audit table"
  ...
  tags: ["database", "table", "lupo_doctrine_evolution_audit"]
  lupo_agent: "codex-ide"
  lupo_doctrine_evolution_audit.doctrine_evolution_audit_id: "bigint NOT NULL"
  lupo_doctrine_evolution_audit.refinement_id: "bigint NOT NULL"
  lupo_doctrine_evolution_audit.evolution_step: "tinyint NOT NULL"
  lupo_doctrine_evolution_audit.step_description: "varchar(255) NOT NULL"
  lupo_doctrine_evolution_audit.step_status: "varchar(64) DEFAULT 'pending'"
  lupo_doctrine_evolution_audit.step_metadata_json: "json"
  lupo_doctrine_evolution_audit.started_ymdhis: "bigint"
  lupo_doctrine_evolution_audit.completed_ymdhis: "bigint"
  lupo_doctrine_evolution_audit.audit_version: "varchar(20) DEFAULT '3.0.0'"
  table_primary_key: "doctrine_evolution_audit_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_doctrine_evolution_audit_idx_completion_time","lupo_doctrine_evolution_audit_idx_refinement_step","lupo_doctrine_evolution_audit_idx_step_status"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_doctrine_evolution_audit.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_doctrine_evolution_audit" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_doctrine_evolution_audit"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_doctrine_evolution_audit from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| doctrine_evolution_audit_id | bigint NOT NULL | from TOON |
| refinement_id | bigint NOT NULL | from TOON |
| evolution_step | tinyint NOT NULL | from TOON |
| step_description | varchar(255) NOT NULL | from TOON |
| step_status | varchar(64) DEFAULT 'pending' | from TOON |
| step_metadata_json | json | from TOON |
| started_ymdhis | bigint | from TOON |
| completed_ymdhis | bigint | from TOON |
| audit_version | varchar(20) DEFAULT '3.0.0' | from TOON |
...
Primary Indexes:
- doctrine_evolution_audit_id
Performance Indexes:
- lupo_doctrine_evolution_audit_idx_completion_time
- lupo_doctrine_evolution_audit_idx_refinement_step
- lupo_doctrine_evolution_audit_idx_step_status
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_doctrine_evolution_audit WHERE doctrine_evolution_audit_id = :id;
SELECT COUNT(*) AS total FROM lupo_doctrine_evolution_audit WHERE is_deleted = 0;
SELECT * FROM lupo_doctrine_evolution_audit ORDER BY doctrine_evolution_audit_id DESC LIMIT 25;
UPDATE lupo_doctrine_evolution_audit SET updated_ymdhis = :ts WHERE doctrine_evolution_audit_id = :id;
```
