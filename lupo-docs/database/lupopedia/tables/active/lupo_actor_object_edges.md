...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_actor_object_edges.md"
  file_hash: "d087eaa679a3620a3321ac5e6a7e48ecc9d76f3995541d33e9f232af406b5e4f"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_actor_object_edges.md"
  file_hash: "1fd931de217727a8a44f3d921882d956ce9219bc60c750e466997aaae7ad9470"
  ...
  purpose: "Complete documentation for lupo_actor_object_edges table"
  ...
  tags: ["database", "table", "lupo_actor_object_edges"]
  lupo_agent: "codex-ide"
  lupo_actor_object_edges.actor_object_edge_id: "bigint NOT NULL"
  lupo_actor_object_edges.actor_id: "bigint NOT NULL"
  lupo_actor_object_edges.target_table: "varchar(100) NOT NULL"
  lupo_actor_object_edges.target_id: "bigint NOT NULL"
  lupo_actor_object_edges.edge_type: "varchar(50) NOT NULL"
  lupo_actor_object_edges.properties_json: "json"
  lupo_actor_object_edges.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_actor_object_edges.updated_ymdhis: "bigint NOT NULL"
  table_primary_key: "actor_object_edge_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_actor_object_edges_idx_actor_edge_type","lupo_actor_object_edges_idx_target_lookup","lupo_actor_object_edges_uniq_actor_target_type"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_actor_object_edges.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_actor_object_edges" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_actor_object_edges"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_actor_object_edges from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| actor_object_edge_id | bigint NOT NULL | from TOON |
| actor_id | bigint NOT NULL | from TOON |
| target_table | varchar(100) NOT NULL | from TOON |
| target_id | bigint NOT NULL | from TOON |
| edge_type | varchar(50) NOT NULL | from TOON |
...
Primary Indexes:
- actor_object_edge_id
Performance Indexes:
- lupo_actor_object_edges_idx_actor_edge_type
- lupo_actor_object_edges_idx_target_lookup
- lupo_actor_object_edges_uniq_actor_target_type
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_actor_object_edges WHERE actor_object_edge_id = :id;
SELECT COUNT(*) AS total FROM lupo_actor_object_edges WHERE is_deleted = 0;
SELECT * FROM lupo_actor_object_edges ORDER BY actor_object_edge_id DESC LIMIT 25;
UPDATE lupo_actor_object_edges SET updated_ymdhis = :ts WHERE actor_object_edge_id = :id;
```
