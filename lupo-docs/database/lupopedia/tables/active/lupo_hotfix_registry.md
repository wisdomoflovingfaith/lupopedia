...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_hotfix_registry.md"
  file_hash: "c4dd1e2a4d589ba4a79a42bbd79f103a697a4df948bfdbd443b1471744557a74"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_hotfix_registry.md"
  file_hash: "b9e9b1daeceb02ef3a2e103c38f3571f2279262819f7344bd3caddfd6fd55fa5"
  ...
  purpose: "Complete documentation for lupo_hotfix_registry table"
  ...
  tags: ["database", "table", "lupo_hotfix_registry"]
  lupo_agent: "codex-ide"
  lupo_hotfix_registry.hotfix_id: "int NOT NULL"
  lupo_hotfix_registry.hotfix_version: "varchar(20) NOT NULL"
  lupo_hotfix_registry.applied_ymdhis: "bigint NOT NULL"
  lupo_hotfix_registry.applied_by_actor_id: "int"
  lupo_hotfix_registry.description: "text"
  lupo_hotfix_registry.metadata_json: "json"
  table_primary_key: "hotfix_id"
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_hotfix_registry.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_hotfix_registry" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_hotfix_registry"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_hotfix_registry from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| hotfix_id | int NOT NULL | from TOON |
| hotfix_version | varchar(20) NOT NULL | from TOON |
| applied_ymdhis | bigint NOT NULL | from TOON |
| applied_by_actor_id | int | from TOON |
...
Common Queries:
```sql
SELECT * FROM lupo_hotfix_registry WHERE hotfix_id = :id;
SELECT COUNT(*) AS total FROM lupo_hotfix_registry WHERE is_deleted = 0;
SELECT * FROM lupo_hotfix_registry ORDER BY hotfix_id DESC LIMIT 25;
UPDATE lupo_hotfix_registry SET updated_ymdhis = :ts WHERE hotfix_id = :id;
```
