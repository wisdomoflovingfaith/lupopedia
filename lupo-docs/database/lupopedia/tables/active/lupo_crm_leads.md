...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_crm_leads.md"
  file_hash: "505c736a2c5e95d904f37bc046fb9798892c473d729ce5d1a225224d9b8d2bc1"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_crm_leads.md"
  ...
  purpose: "Complete documentation for lupo_crm_leads table"
  ...
  tags: ["database", "table", "lupo_crm_leads"]
  lupo_agent: "codex-ide"
  lupo_crm_leads.crm_lead_id: "bigint NOT NULL"
  lupo_crm_leads.email: "varchar(255)"
  lupo_crm_leads.phone: "varchar(45)"
  lupo_crm_leads.first_name: "varchar(100)"
  lupo_crm_leads.last_name: "varchar(100)"
  lupo_crm_leads.source: "varchar(100)"
  lupo_crm_leads.status: "varchar(50) NOT NULL DEFAULT 'new'"
  lupo_crm_leads.lead_score: "int NOT NULL DEFAULT 0"
  lupo_crm_leads.assigned_to: "bigint"
  lupo_crm_leads.lead_data: "text"
  lupo_crm_leads.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_crm_leads.updated_ymdhis: "bigint NOT NULL"
  lupo_crm_leads.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_crm_leads.deleted_ymdhis: "bigint"
  table_primary_key: "crm_lead_id"
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_crm_leads.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_crm_leads" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_crm_leads"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_crm_leads from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| crm_lead_id | bigint NOT NULL | from TOON |
| email | varchar(255) | from TOON |
| phone | varchar(45) | from TOON |
| first_name | varchar(100) | from TOON |
| last_name | varchar(100) | from TOON |
| source | varchar(100) | from TOON |
| status | varchar(50) NOT NULL DEFAULT 'new' | from TOON |
| lead_score | int NOT NULL DEFAULT 0 | from TOON |
| assigned_to | bigint | from TOON |
| lead_data | text | from TOON |
...
Common Queries:
```sql
SELECT * FROM lupo_crm_leads WHERE crm_lead_id = :id;
SELECT COUNT(*) AS total FROM lupo_crm_leads WHERE is_deleted = 0;
SELECT * FROM lupo_crm_leads ORDER BY crm_lead_id DESC LIMIT 25;
UPDATE lupo_crm_leads SET updated_ymdhis = :ts WHERE crm_lead_id = :id;
```
