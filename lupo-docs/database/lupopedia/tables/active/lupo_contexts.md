...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_contexts.md"
  file_hash: "db21d8e3b6fe23f58e314c1e0615ec16f3fd8cdff5aa53a2cf71e1899dfad4e0"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_contexts.md"
  ...
  purpose: "Complete documentation for lupo_contexts table"
  ...
  tags: ["database", "table", "lupo_contexts"]
  lupo_agent: "codex-ide"
  lupo_contexts.context_id: "int NOT NULL"
  lupo_contexts.context_code: "varchar(16) NOT NULL"
  lupo_contexts.context_name: "varchar(255) NOT NULL"
  lupo_contexts.context_description: "text"
  lupo_contexts.parent_context_id: "int"
  lupo_contexts.is_system: "tinyint NOT NULL DEFAULT 0"
  lupo_contexts.is_fiction: "tinyint NOT NULL DEFAULT 0"
  lupo_contexts.is_installation_local: "tinyint NOT NULL DEFAULT 0"
  lupo_contexts.sort_order: "int NOT NULL DEFAULT 0"
  lupo_contexts.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_contexts.updated_ymdhis: "bigint NOT NULL"
  lupo_contexts.weight_score: "decimal(5,2) NOT NULL DEFAULT 0.00"
  lupo_contexts.is_active: "tinyint NOT NULL DEFAULT 1"
  lupo_contexts.metadata_json: "json"
  table_primary_key: "context_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_contexts_idx_parent_context","lupo_contexts_uq_context_code"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_contexts.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_contexts" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_contexts"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_contexts from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| context_id | int NOT NULL | from TOON |
| context_code | varchar(16) NOT NULL | from TOON |
| context_name | varchar(255) NOT NULL | from TOON |
| context_description | text | from TOON |
| parent_context_id | int | from TOON |
| is_system | tinyint NOT NULL DEFAULT 0 | from TOON |
| is_fiction | tinyint NOT NULL DEFAULT 0 | from TOON |
| is_installation_local | tinyint NOT NULL DEFAULT 0 | from TOON |
...
| weight_score | decimal(5,2) NOT NULL DEFAULT 0.00 | from TOON |
...
- context_id
Performance Indexes:
- lupo_contexts_idx_parent_context
- lupo_contexts_uq_context_code
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_contexts WHERE context_id = :id;
SELECT COUNT(*) AS total FROM lupo_contexts WHERE is_deleted = 0;
SELECT * FROM lupo_contexts ORDER BY context_id DESC LIMIT 25;
UPDATE lupo_contexts SET updated_ymdhis = :ts WHERE context_id = :id;
```
