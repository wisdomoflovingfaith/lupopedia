...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_channel_boot_log.md"
  file_hash: "4175f726849d4668f4cee9b8959cc072ee6d293daefddcf892c5c13cab8b4c89"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_channel_boot_log.md"
  ...
  purpose: "Complete documentation for lupo_channel_boot_log table"
  ...
  tags: ["database", "table", "lupo_channel_boot_log"]
  lupo_agent: "codex-ide"
  lupo_channel_boot_log.boot_id: "bigint NOT NULL"
  lupo_channel_boot_log.actor_id: "bigint"
  lupo_channel_boot_log.session_id: "varchar(64)"
  lupo_channel_boot_log.boot_start_time: "bigint"
  lupo_channel_boot_log.boot_end_time: "bigint"
  lupo_channel_boot_log.boot_status: "varchar(64) NOT NULL DEFAULT 'started'"
  lupo_channel_boot_log.channels_loaded: "int NOT NULL DEFAULT 0"
  lupo_channel_boot_log.total_channels: "int NOT NULL DEFAULT 0"
  lupo_channel_boot_log.error_details: "json"
  lupo_channel_boot_log.performance_metrics: "json"
  lupo_channel_boot_log.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  table_primary_key: "boot_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_channel_boot_log_idx_actor_session","lupo_channel_boot_log_idx_boot_status_time"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_channel_boot_log.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_channel_boot_log" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_channel_boot_log"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_channel_boot_log from TOON schema.
Type: database_table
...
| session_id | varchar(64) | from TOON |
| boot_start_time | bigint | from TOON |
| boot_end_time | bigint | from TOON |
| boot_status | varchar(64) NOT NULL DEFAULT 'started' | from TOON |
| channels_loaded | int NOT NULL DEFAULT 0 | from TOON |
| total_channels | int NOT NULL DEFAULT 0 | from TOON |
| error_details | json | from TOON |
| performance_metrics | json | from TOON |
...
- boot_id
Performance Indexes:
- lupo_channel_boot_log_idx_actor_session
- lupo_channel_boot_log_idx_boot_status_time
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_channel_boot_log WHERE boot_id = :id;
SELECT COUNT(*) AS total FROM lupo_channel_boot_log WHERE is_deleted = 0;
SELECT * FROM lupo_channel_boot_log ORDER BY boot_id DESC LIMIT 25;
UPDATE lupo_channel_boot_log SET updated_ymdhis = :ts WHERE boot_id = :id;
```
