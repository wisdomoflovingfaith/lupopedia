...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/decisions/lupo_decisions.md"
  channel_id: 42
  actor_id: 102
  actor_name: "hermes"
  faucet_name: "cascade"
  ...
  tags: ["table_documentation", "decisions", "bayesian", "analytics", "4.0.80"]
  created_ymdhis: 20260317_213000
---
...
- **Actor**: `lupo_decisions.actor_id` → `lupo_actors.actor_id`
- **Channel**: `lupo_decisions.channel_id` → `lupo_channels.channel_id`
- **Project**: `lupo_decisions.project_id` → `lupo_projects.project_id`
- **Session**: `lupo_decisions.session_id` → `lupo_sessions.session_id`
- **Creator**: `lupo_decisions.created_by_actor_id` → `lupo_actors.actor_id`

### Hierarchical Relationships
- **Root Decision**: `lupo_decisions.root_decision_id` → `lupo_decisions.decision_id`
- **Parent Decision**: `lupo_decisions.parent_decision_id` → `lupo_decisions.decision_id`
- **Child Decisions**: Reverse relationship for decision trees

### Evidence Relationships
- **Decision Evidence**: `lupo_decision_evidence.decision_id` → `lupo_decisions.decision_id`
