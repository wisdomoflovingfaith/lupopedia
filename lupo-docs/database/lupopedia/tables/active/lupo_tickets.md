...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_tickets.md"
  file_hash: "05a8a49d6727c963990923a3028ea6da17a6db83d145f0b876b53a3d51814923"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_tickets.md"
  ...
  purpose: "Complete documentation for lupo_tickets table"
  ...
  tags: ["database", "table", "lupo_tickets"]
  lupo_agent: "codex-ide"
  lupo_tickets.ticket_id: "bigint NOT NULL"
  lupo_tickets.channel_id: "bigint NOT NULL"
  lupo_tickets.actor_id: "bigint NOT NULL"
  lupo_tickets.status: "varchar(64) NOT NULL DEFAULT 'open'"
  lupo_tickets.priority: "varchar(64) NOT NULL DEFAULT 'medium'"
  lupo_tickets.subject: "varchar(255) NOT NULL"
  lupo_tickets.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_tickets.updated_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_tickets.metadata_json: "json"
  lupo_tickets.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_tickets.deleted_ymdhis: "bigint"
  table_primary_key: "ticket_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_tickets_idx_actor","lupo_tickets_idx_channel","lupo_tickets_idx_status"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_tickets.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_tickets" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_tickets"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_tickets from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| ticket_id | bigint NOT NULL | from TOON |
| channel_id | bigint NOT NULL | from TOON |
| actor_id | bigint NOT NULL | from TOON |
| status | varchar(64) NOT NULL DEFAULT 'open' | from TOON |
| priority | varchar(64) NOT NULL DEFAULT 'medium' | from TOON |
| subject | varchar(255) NOT NULL | from TOON |
...
- ticket_id
Performance Indexes:
- lupo_tickets_idx_actor
- lupo_tickets_idx_channel
- lupo_tickets_idx_status
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_tickets WHERE ticket_id = :id;
SELECT COUNT(*) AS total FROM lupo_tickets WHERE is_deleted = 0;
SELECT * FROM lupo_tickets ORDER BY ticket_id DESC LIMIT 25;
UPDATE lupo_tickets SET updated_ymdhis = :ts WHERE ticket_id = :id;
```
