...
lupopedia.headers:
  ...
  mood_rgb: "4169E1"
  traits: ["canonical", "acl", "cursor_domain", "v4.0.70"]
  tags: ["database", "capabilities", "usage", "metrics"]
  lupo_agent: "cursor"

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_capability_usage.toon.json", type: "schema_reference", weight: 1.0 }
