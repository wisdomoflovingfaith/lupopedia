...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_task_dependencies.md"
  file_hash: "8e1c23921d86d0a38720d964f2d94d426e718f7471f4aa49fe4dde892d30ebc3"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_task_dependencies.md"
  file_hash: "3f14fd42548b4a6b5a989d9bbfde7fa9b1971efb507b99bb5d4e24636cccf6d4"
  ...
  purpose: "Complete documentation for lupo_task_dependencies table"
  ...
  tags: ["database", "table", "lupo_task_dependencies"]
  lupo_agent: "codex-ide"
  lupo_task_dependencies.dependency_id: "bigint NOT NULL"
  lupo_task_dependencies.task_id: "bigint NOT NULL"
  lupo_task_dependencies.depends_on_task_id: "bigint NOT NULL"
  lupo_task_dependencies.dependency_type: "varchar(32) NOT NULL DEFAULT 'blocks'"
  lupo_task_dependencies.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_task_dependencies.updated_ymdhis: "bigint NOT NULL"
  lupo_task_dependencies.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_task_dependencies.deleted_ymdhis: "bigint"
  table_primary_key: "dependency_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_task_dependencies_idx_dependency_type","lupo_task_dependencies_idx_depends_on_task_id","lupo_task_dependencies_idx_is_deleted","lupo_task_dependencies_idx_task_id"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_task_dependencies.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_task_dependencies" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_task_dependencies"]
  version: "4.0.48"
  last_verified: "20260227"
  last_verified_by: "codex-ide"
---

# Table: lupo_task_dependencies

Purpose: Auto-generated documentation for lupo_task_dependencies from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| dependency_id | bigint NOT NULL | from TOON |
| task_id | bigint NOT NULL | from TOON |
| depends_on_task_id | bigint NOT NULL | from TOON |
| dependency_type | varchar(32) NOT NULL DEFAULT 'blocks' | from TOON |
...
- dependency_id
Performance Indexes:
- lupo_task_dependencies_idx_dependency_type
- lupo_task_dependencies_idx_depends_on_task_id
- lupo_task_dependencies_idx_is_deleted
- lupo_task_dependencies_idx_task_id
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_task_dependencies WHERE dependency_id = :id;
SELECT COUNT(*) AS total FROM lupo_task_dependencies WHERE is_deleted = 0;
SELECT * FROM lupo_task_dependencies ORDER BY dependency_id DESC LIMIT 25;
UPDATE lupo_task_dependencies SET updated_ymdhis = :ts WHERE dependency_id = :id;
```
