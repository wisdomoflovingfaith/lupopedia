...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_system_logs.md"
  file_hash: "3827a0edbfd0166d39fcf48ca9ab347c299ee9888a7ae7fc871864bc0bdff37e"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_system_logs.md"
  ...
  purpose: "Complete documentation for lupo_system_logs table"
  ...
  tags: ["database", "table", "lupo_system_logs"]
  lupo_agent: "codex-ide"
  lupo_system_logs.log_id: "bigint NOT NULL"
  lupo_system_logs.event_type: "varchar(64) NOT NULL"
  lupo_system_logs.severity: "varchar(16) NOT NULL DEFAULT 'info'"
  lupo_system_logs.actor_slug: "varchar(64)"
  lupo_system_logs.message: "text NOT NULL"
  lupo_system_logs.context_json: "json"
  lupo_system_logs.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_system_logs.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_system_logs.deleted_ymdhis: "bigint"
  lupo_system_logs.recursion_depth: "tinyint DEFAULT 1"
  lupo_system_logs.observation_latency_ms: "int"
  lupo_system_logs.temporal_anomaly_score: "decimal(3,2)"
  table_primary_key: "log_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_system_logs_idx_actor_slug","lupo_system_logs_idx_created_ymdhis","lupo_system_logs_idx_event_type","lupo_system_logs_idx_is_deleted","lupo_system_logs_idx_severity"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_system_logs.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_system_logs" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_system_logs"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_system_logs from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| log_id | bigint NOT NULL | from TOON |
| event_type | varchar(64) NOT NULL | from TOON |
| severity | varchar(16) NOT NULL DEFAULT 'info' | from TOON |
| actor_slug | varchar(64) | from TOON |
| message | text NOT NULL | from TOON |
...
| recursion_depth | tinyint DEFAULT 1 | from TOON |
| observation_latency_ms | int | from TOON |
| temporal_anomaly_score | decimal(3,2) | from TOON |
...
- log_id
Performance Indexes:
- lupo_system_logs_idx_actor_slug
- lupo_system_logs_idx_created_ymdhis
- lupo_system_logs_idx_event_type
- lupo_system_logs_idx_is_deleted
- lupo_system_logs_idx_severity
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_system_logs WHERE log_id = :id;
SELECT COUNT(*) AS total FROM lupo_system_logs WHERE is_deleted = 0;
SELECT * FROM lupo_system_logs ORDER BY log_id DESC LIMIT 25;
UPDATE lupo_system_logs SET updated_ymdhis = :ts WHERE log_id = :id;
```
