...
lupopedia.headers:
  ...
  mood_rgb: "4169E1"
  traits: ["canonical", "anubis", "recovery", "v4.0.70"]
  tags: ["database", "anubis", "recovery", "strategies"]
  lupo_agent: "antigravity"

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_anubis_recovery_attempts.toon", type: "references", weight: 1.0 }
