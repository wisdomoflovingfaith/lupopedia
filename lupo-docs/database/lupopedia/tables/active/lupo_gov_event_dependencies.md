...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_gov_event_dependencies.md"
  file_hash: "bb0f92d03cd48f62acb9de9ee5391fe273368ef8275fddc0c073358a26b995e7"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_gov_event_dependencies.md"
  file_hash: "9bc5cda949d6c83ad622278df9dd868a860c112b949ec6d79f7725806d0ea994"
  ...
  purpose: "Complete documentation for lupo_gov_event_dependencies table"
  ...
  tags: ["database", "table", "lupo_gov_event_dependencies"]
  lupo_agent: "codex-ide"
  lupo_gov_event_dependencies.gov_event_dependency_id: "bigint NOT NULL"
  lupo_gov_event_dependencies.gov_event_id: "bigint NOT NULL"
  lupo_gov_event_dependencies.depends_on_event_id: "bigint NOT NULL"
  lupo_gov_event_dependencies.dependency_type: "varchar(50) NOT NULL"
  lupo_gov_event_dependencies.notes: "text"
  lupo_gov_event_dependencies.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_gov_event_dependencies.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_gov_event_dependencies.deleted_ymdhis: "bigint"
  table_primary_key: "gov_event_dependency_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_gov_event_dependencies_idx_depends_on_event_id","lupo_gov_event_dependencies_idx_gov_event_id"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_gov_event_dependencies.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_gov_event_dependencies" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_gov_event_dependencies"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_gov_event_dependencies from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| gov_event_dependency_id | bigint NOT NULL | from TOON |
| gov_event_id | bigint NOT NULL | from TOON |
| depends_on_event_id | bigint NOT NULL | from TOON |
| dependency_type | varchar(50) NOT NULL | from TOON |
...
Primary Indexes:
- gov_event_dependency_id
Performance Indexes:
- lupo_gov_event_dependencies_idx_depends_on_event_id
- lupo_gov_event_dependencies_idx_gov_event_id
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_gov_event_dependencies WHERE gov_event_dependency_id = :id;
SELECT COUNT(*) AS total FROM lupo_gov_event_dependencies WHERE is_deleted = 0;
SELECT * FROM lupo_gov_event_dependencies ORDER BY gov_event_dependency_id DESC LIMIT 25;
UPDATE lupo_gov_event_dependencies SET updated_ymdhis = :ts WHERE gov_event_dependency_id = :id;
```
