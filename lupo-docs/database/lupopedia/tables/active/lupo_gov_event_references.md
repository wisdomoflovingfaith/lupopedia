...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_gov_event_references.md"
  file_hash: "da66df85f1369bae863a0ab5fef497eaea277e813e7c076da36cbf30c61f1de9"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_gov_event_references.md"
  ...
  purpose: "Complete documentation for lupo_gov_event_references table"
  ...
  tags: ["database", "table", "lupo_gov_event_references"]
  lupo_agent: "codex-ide"
  lupo_gov_event_references.reference_id: "bigint NOT NULL"
  lupo_gov_event_references.gov_event_id: "bigint NOT NULL"
  lupo_gov_event_references.reference_type: "varchar(100) NOT NULL"
  lupo_gov_event_references.reference_title: "varchar(255) NOT NULL"
  lupo_gov_event_references.reference_url: "varchar(1000)"
  lupo_gov_event_references.reference_content: "text"
  lupo_gov_event_references.order_sequence: "int NOT NULL DEFAULT 0"
  lupo_gov_event_references.metadata_json: "json"
  lupo_gov_event_references.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_gov_event_references.updated_ymdhis: "bigint"
  lupo_gov_event_references.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_gov_event_references.deleted_ymdhis: "bigint"
  table_primary_key: "reference_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_gov_event_references_idx_created_ymdhis","lupo_gov_event_references_idx_gov_event","lupo_gov_event_references_idx_is_deleted","lupo_gov_event_references_idx_order_sequence","lupo_gov_event_references_idx_reference_type"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_gov_event_references.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_gov_event_references" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_gov_event_references"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_gov_event_references from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| reference_id | bigint NOT NULL | from TOON |
| gov_event_id | bigint NOT NULL | from TOON |
| reference_type | varchar(100) NOT NULL | from TOON |
| reference_title | varchar(255) NOT NULL | from TOON |
| reference_url | varchar(1000) | from TOON |
| reference_content | text | from TOON |
...
- reference_id
Performance Indexes:
- lupo_gov_event_references_idx_created_ymdhis
- lupo_gov_event_references_idx_gov_event
- lupo_gov_event_references_idx_is_deleted
- lupo_gov_event_references_idx_order_sequence
- lupo_gov_event_references_idx_reference_type
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_gov_event_references WHERE reference_id = :id;
SELECT COUNT(*) AS total FROM lupo_gov_event_references WHERE is_deleted = 0;
SELECT * FROM lupo_gov_event_references ORDER BY reference_id DESC LIMIT 25;
UPDATE lupo_gov_event_references SET updated_ymdhis = :ts WHERE reference_id = :id;
```
