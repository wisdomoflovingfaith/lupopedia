...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_actor_handshakes.md"
  ...
  purpose: "Complete documentation for lupo_actor_handshakes table"
  ...
  tags: ["database", "table", "lupo_actor_handshakes"]
  lupo_agent: "codex-ide"
  lupo_actor_handshakes.actor_handshake_id: "bigint NOT NULL"
  lupo_actor_handshakes.actor_id: "bigint NOT NULL"
  lupo_actor_handshakes.actor_type: "varchar(32) NOT NULL"
  lupo_actor_handshakes.utc_timestamp: "bigint NOT NULL"
  lupo_actor_handshakes.purpose: "varchar(500)"
  lupo_actor_handshakes.constraints_json: "json"
  lupo_actor_handshakes.forbidden_actions_json: "json"
  lupo_actor_handshakes.context: "text"
  lupo_actor_handshakes.expires_utc: "bigint"
  lupo_actor_handshakes.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_actor_handshakes.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_actor_handshakes.deleted_ymdhis: "bigint"
  table_primary_key: "actor_handshake_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_actor_handshakes_idx_actor_id","lupo_actor_handshakes_idx_is_deleted","lupo_actor_handshakes_idx_utc_timestamp"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_actor_handshakes.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_actor_handshakes" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_actor_handshakes"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_actor_handshakes from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| actor_handshake_id | bigint NOT NULL | from TOON |
| actor_id | bigint NOT NULL | from TOON |
| actor_type | varchar(32) NOT NULL | from TOON |
| utc_timestamp | bigint NOT NULL | from TOON |
| purpose | varchar(500) | from TOON |
| constraints_json | json | from TOON |
| forbidden_actions_json | json | from TOON |
| context | text | from TOON |
| expires_utc | bigint | from TOON |
...
- actor_handshake_id
Performance Indexes:
- lupo_actor_handshakes_idx_actor_id
- lupo_actor_handshakes_idx_is_deleted
- lupo_actor_handshakes_idx_utc_timestamp
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_actor_handshakes WHERE actor_handshake_id = :id;
SELECT COUNT(*) AS total FROM lupo_actor_handshakes WHERE is_deleted = 0;
SELECT * FROM lupo_actor_handshakes ORDER BY actor_handshake_id DESC LIMIT 25;
UPDATE lupo_actor_handshakes SET updated_ymdhis = :ts WHERE actor_handshake_id = :id;
```
