...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_search_rebuild_log.md"
  file_hash: "a7b24f397bbea73462bc03fbe67ed51b7344c24504adcf5034deb71371372b46"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_search_rebuild_log.md"
  ...
  purpose: "Complete documentation for lupo_search_rebuild_log table"
  ...
  tags: ["database", "table", "lupo_search_rebuild_log"]
  lupo_agent: "codex-ide"
  lupo_search_rebuild_log.search_rebuild_log_id: "bigint NOT NULL"
  lupo_search_rebuild_log.entity_type: "varchar(50) NOT NULL"
  lupo_search_rebuild_log.entity_id: "bigint NOT NULL"
  lupo_search_rebuild_log.action: "varchar(64) NOT NULL"
  lupo_search_rebuild_log.status: "varchar(64) NOT NULL DEFAULT 'pending'"
  lupo_search_rebuild_log.attempts: "tinyint NOT NULL DEFAULT 0"
  lupo_search_rebuild_log.last_error: "text"
  lupo_search_rebuild_log.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_search_rebuild_log.processed_ymdhis: "bigint"
  lupo_search_rebuild_log.next_attempt_ymdhis: "bigint"
  lupo_search_rebuild_log.is_deleted: "tinyint NOT NULL DEFAULT 0"
  table_primary_key: "search_rebuild_log_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_search_rebuild_log_idx_created","lupo_search_rebuild_log_idx_entity","lupo_search_rebuild_log_idx_status_retry","lupo_search_rebuild_log_unique_entity_operation"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_search_rebuild_log.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_search_rebuild_log" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_search_rebuild_log"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_search_rebuild_log from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| search_rebuild_log_id | bigint NOT NULL | from TOON |
| entity_type | varchar(50) NOT NULL | from TOON |
| entity_id | bigint NOT NULL | from TOON |
| action | varchar(64) NOT NULL | from TOON |
| status | varchar(64) NOT NULL DEFAULT 'pending' | from TOON |
| attempts | tinyint NOT NULL DEFAULT 0 | from TOON |
| last_error | text | from TOON |
| created_ymdhis | bigint NOT NULL DEFAULT 0 | from TOON |
| processed_ymdhis | bigint | from TOON |
| next_attempt_ymdhis | bigint | from TOON |
...
Primary Indexes:
- search_rebuild_log_id
Performance Indexes:
- lupo_search_rebuild_log_idx_created
- lupo_search_rebuild_log_idx_entity
- lupo_search_rebuild_log_idx_status_retry
- lupo_search_rebuild_log_unique_entity_operation
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_search_rebuild_log WHERE search_rebuild_log_id = :id;
SELECT COUNT(*) AS total FROM lupo_search_rebuild_log WHERE is_deleted = 0;
SELECT * FROM lupo_search_rebuild_log ORDER BY search_rebuild_log_id DESC LIMIT 25;
UPDATE lupo_search_rebuild_log SET updated_ymdhis = :ts WHERE search_rebuild_log_id = :id;
```
