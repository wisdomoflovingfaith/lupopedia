...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_referers.md"
  file_hash: "2b7e0fbf3f6aef45f520faf0c74133103d4485e271e3cf5b209d5ea6eb096d3d"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_referers.md"
  ...
  purpose: "Complete documentation for lupo_referers table"
  ...
  tags: ["database", "table", "lupo_referers"]
  lupo_agent: "codex-ide"
  lupo_referers.referer_id: "bigint NOT NULL auto_increment"
  lupo_referers.content_id: "bigint NOT NULL"
  lupo_referers.actor_id: "bigint NOT NULL"
  lupo_referers.referer_url: "varchar(2000)"
  lupo_referers.referer_domain: "varchar(255)"
  lupo_referers.referer_path: "varchar(2000)"
  lupo_referers.referer_content_id: "bigint"
  lupo_referers.date_ymd: "int NOT NULL"
  lupo_referers.visits: "int NOT NULL DEFAULT 1"
  lupo_referers.depth: "int NOT NULL DEFAULT 0"
  lupo_referers.metadata_json: "json"
  table_primary_key: "referer_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_referers_idx_actor_id","lupo_referers_idx_content_id","lupo_referers_idx_date","lupo_referers_idx_referer_content_id","lupo_referers_idx_referer_domain"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_referers.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_referers" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_referers"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_referers from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| referer_id | bigint NOT NULL auto_increment | from TOON |
| content_id | bigint NOT NULL | from TOON |
| actor_id | bigint NOT NULL | from TOON |
| referer_url | varchar(2000) | from TOON |
| referer_domain | varchar(255) | from TOON |
| referer_path | varchar(2000) | from TOON |
| referer_content_id | bigint | from TOON |
| date_ymd | int NOT NULL | from TOON |
| visits | int NOT NULL DEFAULT 1 | from TOON |
...
- referer_id
Performance Indexes:
- lupo_referers_idx_actor_id
- lupo_referers_idx_content_id
- lupo_referers_idx_date
- lupo_referers_idx_referer_content_id
- lupo_referers_idx_referer_domain
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_referers WHERE referer_id = :id;
SELECT COUNT(*) AS total FROM lupo_referers WHERE is_deleted = 0;
SELECT * FROM lupo_referers ORDER BY referer_id DESC LIMIT 25;
UPDATE lupo_referers SET updated_ymdhis = :ts WHERE referer_id = :id;
```
