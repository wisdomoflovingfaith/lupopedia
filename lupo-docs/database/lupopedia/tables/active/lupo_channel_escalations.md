...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_channel_escalations.md"
  ...
  purpose: "Complete documentation for lupo_channel_escalations table"
  ...
  tags: ["database", "table", "lupo_channel_escalations"]
  lupo_agent: "codex-ide"
  lupo_channel_escalations.escalation_id: "bigint NOT NULL"
  lupo_channel_escalations.channel_id: "bigint NOT NULL"
  lupo_channel_escalations.thread_id: "bigint"
  lupo_channel_escalations.actor_id: "bigint"
  lupo_channel_escalations.escalated_to_actor_id: "bigint"
  lupo_channel_escalations.escalation_reason: "varchar(512)"
  lupo_channel_escalations.metadata_json: "json"
  lupo_channel_escalations.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_channel_escalations.updated_ymdhis: "bigint NOT NULL"
  lupo_channel_escalations.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_channel_escalations.deleted_ymdhis: "bigint"
  table_primary_key: "escalation_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_channel_escalations_idx_actor_id","lupo_channel_escalations_idx_channel_id","lupo_channel_escalations_idx_escalated_to_actor_id","lupo_channel_escalations_idx_thread_id"]
  table_foreign_keys: []
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_channel_escalations.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_channel_escalations" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_channel_escalations"]
  version: "4.0.48"
  last_verified: "20260227"
  last_verified_by: "codex-ide"
---

# Table: lupo_channel_escalations

Purpose: Auto-generated documentation for lupo_channel_escalations from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| escalation_id | bigint NOT NULL | from TOON |
| channel_id | bigint NOT NULL | from TOON |
| thread_id | bigint | from TOON |
| actor_id | bigint | from TOON |
| escalated_to_actor_id | bigint | from TOON |
| escalation_reason | varchar(512) | from TOON |
...
- escalation_id
Performance Indexes:
- lupo_channel_escalations_idx_actor_id
- lupo_channel_escalations_idx_channel_id
- lupo_channel_escalations_idx_escalated_to_actor_id
- lupo_channel_escalations_idx_thread_id
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_channel_escalations WHERE escalation_id = :id;
SELECT COUNT(*) AS total FROM lupo_channel_escalations WHERE is_deleted = 0;
SELECT * FROM lupo_channel_escalations ORDER BY escalation_id DESC LIMIT 25;
UPDATE lupo_channel_escalations SET updated_ymdhis = :ts WHERE escalation_id = :id;
```
