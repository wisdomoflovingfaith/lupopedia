...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\database\lupopedia\tables\lupo_world_registry.md"
  file_hash: "03d192e697b714412517bec15121c97be6424114db12eb583be117f227a032fa"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_world_registry.md"
  file_hash: "b09462d6fdd70cf478cc43cc59a2ee8d84dffe25e067d1c905326fe44715201b"
  ...
  purpose: "Complete documentation for lupo_world_registry table"
  ...
  tags: ["database", "table", "lupo_world_registry"]
  lupo_agent: "codex-ide"
  lupo_world_registry.world_id: "bigint NOT NULL"
  lupo_world_registry.world_key: "varchar(255) NOT NULL"
  lupo_world_registry.world_type: "varchar(64) NOT NULL"
  lupo_world_registry.world_label: "varchar(255) NOT NULL"
  lupo_world_registry.world_metadata: "json"
  lupo_world_registry.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_world_registry.updated_ymdhis: "bigint NOT NULL"
  lupo_world_registry.is_active: "tinyint NOT NULL DEFAULT 1"
...
lupopedia.footer:
  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_world_registry.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_world_registry" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_world_registry"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_world_registry from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| world_id | bigint NOT NULL | from TOON |
| world_key | varchar(255) NOT NULL | from TOON |
| world_type | varchar(64) NOT NULL | from TOON |
| world_label | varchar(255) NOT NULL | from TOON |
| world_metadata | json | from TOON |
...
- world_id
Performance Indexes:
- lupo_world_registry_idx_created_ymdhis
- lupo_world_registry_idx_is_active
- lupo_world_registry_idx_world_type
- lupo_world_registry_unique_world_key
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_world_registry WHERE world_id = :id;
SELECT COUNT(*) AS total FROM lupo_world_registry WHERE is_deleted = 0;
SELECT * FROM lupo_world_registry ORDER BY world_id DESC LIMIT 25;
UPDATE lupo_world_registry SET updated_ymdhis = :ts WHERE world_id = :id;
```
