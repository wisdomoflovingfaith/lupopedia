---
lupopedia.init:
  file_identity: "SCHEMA_REGISTRY_KIRO.md"
  artifact_type: "schema-registry"
...
lupopedia.metadata:
  ...
  title:
    - { schema_ref: "lupo_metadata", entity_type: "file", meta_type: "property", property_value: "KIRO Schema Registry", channel_id: 42, class_name: "lupopedia_metadata", created_ymdhis: 20260314000000, updated_ymdhis: 20260314000000 }
  description:
    - { schema_ref: "lupo_metadata", entity_type: "file", meta_type: "property", property_value: "Master schema inventory: TOONs, docs, migration refs, domain assignment (KIRO canonical)", channel_id: 42, class_name: "lupopedia_metadata", created_ymdhis: 20260314000000, updated_ymdhis: 20260314000000 }
  keywords:
    - { schema_ref: "lupo_metadata", entity_type: "file", meta_type: "property", property_value: "database, schema, registry, coordination, kiro, canonical", channel_id: 42, class_name: "lupopedia_metadata", created_ymdhis: 20260314000000, updated_ymdhis: 20260314000000 }
  author:
...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/SCHEMA_REGISTRY_KIRO.md"
  web_path: "http://www.lupopedia.com/SCHEMA_REGISTRY_KIRO"
  ...
  purpose: "Master schema inventory: TOONs, docs, migration refs, domain assignment (KIRO canonical)"
  mood_rgb: "4169E1"
  traits: ["canonical", "schema_registry", "kiro_authority", "v4.0.74"]
  tags: ["database", "schema", "registry", "coordination", "kiro", "canonical"]

lupopedia.session:
  session_id: "L-KIRO-SCHEMA-REGISTRY-20260314"
  session_name: "L-KIRO-SCHEMA-REGISTRY-20260314"
  actor_id: 100
  actor_name: "kiro"
  faucet_name: "kiro"
  channel_id: 42
...
lupopedia.edges:
  ...
  semantic_tags: ["schema", "registry", "coordination", "kiro", "database"]
...
lupopedia.footer:
  ...
  orchestrator: "kiro"
  next_action:
    - "Coordinate multi-agent documentation program based on this registry"
    - "Resolve TOON format discrepancy (YAML vs JSON)"
    - "Establish clear domain boundaries between agents"
    - "Update main README.md with database documentation program findings"
---
...
**Version:** 4.0.74  
**Source:** TOONs in `lupo-database/lupopedia/toon/` (230+ `.toon` YAML files) per Captain Wolfie directive  
...
1. **Correct TOON source**: References `lupo-database/lupopedia/toon/` (YAML format) not `lupo-docs/toons/` (JSON format)
...
| `lupo-docs/toons/` | `.toon.json` (JSON) | 221 files | `lupo_actors.toon.json`: `actor_id` as primary key |

**Resolution**: Per Captain Wolfie directive, `lupo-database/lupopedia/toon/` (YAML format) is canonical. All agents must reference this location.
...
| **lupo_doctrine_evolution_audit** | Governance | Doctrine evolution audit | KIRO | Active | tables/lupo_doctrine_evolution_audit.md | — | |
...
- **TOON tables (YAML)**: 230+ files in `lupo-database/lupopedia/toon/`
...
These appear in existing docs or migration references but **do not** have a current TOON in `lupo-database/lupopedia/toon/`. Treated as **Removed** or **Uncertain** until verified.
