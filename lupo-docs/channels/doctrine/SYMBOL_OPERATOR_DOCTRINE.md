...
> Table count/ceiling is **advisory** (Captain directive 4.0.74). Schema expansion is permitted when justified; do not block new tables solely on a numeric ceiling.
