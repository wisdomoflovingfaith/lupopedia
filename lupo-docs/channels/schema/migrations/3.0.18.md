...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "lupo-docs\channels\schema\migrations\3.0.18.md"
...
1. **Collections Dropdown Component** (`lupo-includes/ui/components/collections_dropdown.php`)
   ...
   - Lists collections via AJAX from `lupo-api/list_user_collections.php`
...
3. **API Endpoint** (`lupo-api/list_user_collections.php`)
...
3. **API Endpoint** - Ensure API endpoint exists:
   - `lupo-api/list_user_collections.php` (should already exist from previous work)
...
- **Dependencies**: `lupo-api/list_user_collections.php`, `lupo-api/load_collection_tabs.php`
