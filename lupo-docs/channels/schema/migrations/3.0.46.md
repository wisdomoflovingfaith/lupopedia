...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "lupo-docs\channels\schema\migrations\3.0.46.md"
...
- `lupo-api/v1/dialog/health.php` - Health check endpoint
- `lupo-api/v1/dialog/metrics.php` - Metrics endpoint
...
1. **Database Migration Required** - Run `lupo-database/migrations_legacy/schema_sync_3_0_46_missing_tables.sql` to add 2 missing tables
2. **Deploy New Files:**
   - Bridge doctrine files (`lupo-docs/doctrine/*BRIDGE.md`)
   - Deployment scripts (`deploy/apply_dialog_schema.php`)
   - API endpoints (`lupo-api/v1/dialog/*`, `lupo-api/dialog/*`)
...
- **Bridge Files:** See `lupo-docs/doctrine/*BRIDGE.md` files
- **Dialog System:** See `lupo-docs/dev/DIALOG_SYSTEM_IMPLEMENTATION_PLAN.md`
