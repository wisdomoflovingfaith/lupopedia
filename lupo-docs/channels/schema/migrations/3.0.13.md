...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "lupo-docs\channels\schema\migrations\3.0.13.md"
...
1. **Universal Wolfie Header Specification (WHS)**
   - New document: `lupo-docs/doctrine/UNIVERSAL_WOLFIE_HEADER_SPECIFICATION.md`
...
2. **Lupopedia Header Profile (LHP)**
   - New document: `lupo-docs/doctrine/LUPOPEDIA_HEADER_PROFILE.md`
...
1. Backup your documentation files in `lupo-docs/doctrine/` and `lupo-docs/agents/`
...
2. Update `lupo-includes/version.php` version constants to 3.0.13
3. Review new documentation files:
   - `lupo-docs/doctrine/UNIVERSAL_WOLFIE_HEADER_SPECIFICATION.md`
   - `lupo-docs/doctrine/LUPOPEDIA_HEADER_PROFILE.md`
4. Review updated documentation:
   - `lupo-docs/doctrine/WOLFIE_HEADER_DOCTRINE.md`
   - `lupo-docs/agents/WOLFIE_HEADER_SPECIFICATION.md`
...
- Review `lupo-docs/doctrine/UNIVERSAL_WOLFIE_HEADER_SPECIFICATION.md` for universal format
- Review `lupo-docs/doctrine/LUPOPEDIA_HEADER_PROFILE.md` for Lupopedia-specific extensions
- Review `CHANGELOG.md` for detailed change list
- Check `lupo-docs/doctrine/WOLFIE_HEADER_DOCTRINE.md` for complete doctrine
