...
lupopedia.headers:
  ...
  file_path_from_root: ".\docs\channels\schema\migrations\3.0.102.md"
  file_hash: "895e24f471370e79793682285d10ddc01883e204b95ffc0258c0e1c9d58235ba"
...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "lupo-docs\channels\schema\migrations\3.0.102.md"
  file_hash: "99d7fc37b37d0e5b8c3960834dd424d3241d99ea6dd9c0839d9721c5c05626a0"
  file_path_from_root: "lupo-docs\channels\schema\migrations\3.0.102.md"
  file_hash: "1150e875e3638b018dd01d6f4a743629f5f6d780537cf4a6a3371c2175bfe2e5"
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for 3.0.102.md"
  mood_rgb: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "schema", "migrations", "30102md"]
  lupo_agent: "windsurf"
...
dialog:
  ...
  mood_RGB: "00FF00"
  message: "Migration notes for version 3.0.102 - PHP schema alignment and LIMITS enforcement implementation."
tags:
  categories: ["migration", "schema", "php"]
  collections: ["core-docs", "migrations"]
  channels: ["dev"]
file:
  title: "Migration Notes for Version 3.0.102"
...
# Migration Notes for Version 3.0.102
...
#### ChannelBuilder.php
**Changes:**
- Updated version tags to 3.0.102
- Updated default version in metadata to 3.0.102
...
- Updated version tag to 3.0.102
...
2. **Version Rollback:**
   - Update version atoms back to 3.0.101
...
- `lupo-database/schema/dialog_system_schema.sql`: Actual database schema
- `audits/php_implementation_audit_3.0.101.md`: Audit that identified these issues
- `lupo-docs/doctrine/TABLE_COUNT_DOCTRINE.md`: Table count limits doctrine
