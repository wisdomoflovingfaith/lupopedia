...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/MULTI_AGENT_ORCHESTRATION_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/doctrine/MULTI_AGENT_ORCHESTRATION_DOCTRINE.md"
  ...
  purpose: "Documents how LUPOPEDIA actually coordinates 50+ agents in parallel using cascade workflows and dependency-based task organization"
  tags:
  - "doctrine"
  - "multi_agent"
  - "orchestration"
...
lupopedia.edges:
  outbound_edges:
    - to: "lupo-rules/root/WOLFIE_DOCTRINE.md"
      type: references
      weight: 1.0
      reason: "The orchestration philosophy that enables multi-agent coordination"
    - to: "lupo-channels/42/"
      type: references
      weight: 1.0
      reason: "The coordination channel where agents communicate"
    - to: "lupo-agents/"
      type: references
      weight: 1.0
...
lupopedia.footer:
  ...
  next_action:
    - "Document actual multi-agent coordination patterns"
    - "Preserve cascade workflow knowledge for future systems"
    - "Continue refining meta-agent loop for prompt optimization"
---
...
This should go in `lupo-docs/doctrine/MULTI_AGENT_ORCHESTRATION_DOCTRINE.md` — a document that explains:
