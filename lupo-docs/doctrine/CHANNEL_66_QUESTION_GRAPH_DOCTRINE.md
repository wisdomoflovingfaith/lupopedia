...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/CHANNEL_66_QUESTION_GRAPH_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupo-docs/doctrine/CHANNEL_66_QUESTION_GRAPH_DOCTRINE.md"
  ...
  purpose: "Canonical definition of Channel 66 as the question-driven semantic graph system and its role as the doctrine-creation and issue-resolution backbone of Lupopedia"
  traits: ["canonical", "doctrine", "channel_66", "semantic_graph", "question_resolution", "4.0.84"]
  tags: ["channel_66", "question_graph", "doctrine_creation", "semantic_system", "governance"]
lupopedia.edges:
  outbound_edges:
...
lupopedia.footer:
  ...
  enforcement: "binding"
  next_action:
    - "Ensure all new doctrine creation flows through Channel 66 question-resolution model"
    - "Cross-link all Channel 66 decisions to downstream implementation threads"
---
...
| 5. Closure & Issuance | WOLFIE | Binding doctrine artifact (produced in `lupo-docs/doctrine/` or pushed from thread artifact) | closed |
