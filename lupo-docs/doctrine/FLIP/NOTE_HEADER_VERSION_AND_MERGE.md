# ⚠️ DEPRECATED - NOTE HEADER VERSION AND MERGE
...
X-Lupo-File-Path: lupo-docs/doctrine/FLIP/NOTE_HEADER_VERSION_AND_MERGE.md
---
...
- `lupo-docs/doctrine/VERSIONING_DOCTRINE.md` — canonical current version
...
- **Paths and references:** Check `lupo-docs/doctrine/FLIP/`, `lupo-docs/doctrine/VERSIONING_DOCTRINE.md`, and `lupo-docs/doctrine/database/` for current 4.0.x positions before applying 3.x-era text.

---

## 3. Where this note lives

- **This file:** `lupo-docs/doctrine/FLIP/NOTE_HEADER_VERSION_AND_MERGE.md`
