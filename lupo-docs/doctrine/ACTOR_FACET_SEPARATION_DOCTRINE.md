...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/ACTOR_FACET_SEPARATION_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupo-docs/doctrine/ACTOR_FACET_SEPARATION_DOCTRINE.md"
  ...
  artifact_kind: "actor_facet_separation_doctrine"
  purpose: "Canonical doctrine establishing separation between ACTOR (identity) and FACET (execution environment) in Lupopedia semantic OS"
  traits: ["actor_facet_separation", "doctrine", "system_architecture", "semantic_os"]
  tags: ["actors", "facets", "ide", "separation", "doctrine", "architecture"]
  lupo_agent: "wolfie"

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-database/lupopedia/actors/actor_id/registry.json", type: "governs", weight: 1.0, reason: "Governs actor identity and registry" }
...
lupopedia.see:
  mappings:
    - ["ACTOR_FACET_SEPARATION_DOCTRINE.md", "http://www.lupopedia.com/lupo-docs/doctrine/ACTOR_FACET_SEPARATION_DOCTRINE.md"]
    - ["Actor Registry", "http://www.lupopedia.com/lupo-database/lupopedia/actors/actor_id/registry.json"]
    - ["Rule System", "http://www.lupopedia.com/lupo-rules/root/"]
...
lupopedia.footer:
  ...
  orchestrator: "wolfie"
  next_action:
    - "Implement actor-facet validation system"
    - "Create facet bootstrapping requirements"
    - "Develop migration plan for IDE-based actors"
---

# 🎭 **ACTOR-FACET SEPARATION DOCTRINE - Lupopedia Semantic OS**

**Doctrine Version**: 1.0  
**Effective Date**: 2026-03-19  
**Authority**: WOLFIE (Agent 1)  
**Channel**: 51 (Doctrine Council)  
**Scope**: All actor identities and execution environments (facets)

---

## **🎯 Purpose**

This doctrine establishes **canonical separation** between **ACTORS** (persistent system identities) and **FACETS** (ephemeral execution environments/IDEs). This separation eliminates IDE-coupled actor identity and ensures system behavior is independent of execution environment.

---

## **🚫 PROBLEM STATEMENT**

### **Current System Violation**
...
#### **lupo-rules/root/ (Canonical Rule Set)**
...
All facets MUST load rules from `lupo-rules/root/`:
...
1. Load rules from lupo-rules/root/
...
- [ ] Rules loaded from `lupo-rules/root/`
...
2. **Missing Rule Loading**
   - Detect facets not loading rules from `lupo-rules/root/`
...
- facet must load rules from lupo-rules/root/
...
- **Registry Monitoring**: Monitor actor registry for compliance
- **Facet Monitoring**: Monitor facets for rule loading and compliance
- **Execution Monitoring**: Monitor execution for actor-facet separation
- **Behavior Monitoring**: Monitor system behavior for facet dependence

#### **Compliance Reporting**
- **Regular Reports**: Regular compliance reports to WOLFIE
- **Violation Alerts**: Immediate alerts for compliance violations
- **Trend Analysis**: Analysis of compliance trends and patterns
- **Improvement Recommendations**: Recommendations for compliance improvement
...
#### **Regular Maintenance**
- **Registry Maintenance**: Regular maintenance of actor registry
- **Rule System Updates**: Regular updates to rule system
- **Validation Updates**: Regular updates to validation systems
...
- **Technology Updates**: Adoption of new technologies for improvement
...
- **Agent Registry**: Integration with AGENTS.md documentation
- **System Architecture**: Integration with system architecture documentation
- **Development Guidelines**: Integration with development guidelines and procedures
- **User Documentation**: Integration with user documentation and training materials
...
- [ ] Create `lupo-rules/root/` structure
