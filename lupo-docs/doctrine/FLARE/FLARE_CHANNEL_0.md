...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/FLARE/FLARE_CHANNEL_0.md"
...
lupopedia.footer:
  outbound_edges:
    ...
    - { to: "lupo-docs/doctrine/FLARE/FLARE_OVERVIEW.md", type: "references", weight: 0.9 }
    - { to: "lupo-docs/doctrine/FLIP/FLP_CHANNEL_0.md", type: "supersedes", weight: 0.8 }
    - { to: "lupo-channels/0/broadcasts/", type: "references", weight: 0.8 }
