...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/doctrine/CONTEXT_MODEL_DOCTRINE.md
  web_path: http://www.lupopedia.com/lupopedia/lupo-docs/doctrine/CONTEXT_MODEL_DOCTRINE.md
  ...
  purpose: Define the minimal operational model for lupo-context in 4.0.88
  traits:
  - canonical
  - comprehensive
  - v4.0.88
...
lupopedia.edges:
  ...
  - to: lupo-docs/doctrine/CHANNELS_CONTEXTS_AND_COORDINATION.md
    type: references
    weight: 1.0
    reason: Existing context documentation
  ...
  - to: lupo-context/
    type: defines
    weight: 1.0
    reason: Target directory for implementation
...
lupopedia.footer:
  ...
  next_action:
  - THOTH to review and formalize specification
  - Create first prototype context
  - Validate integration with existing systems
---

# CONTEXT MODEL DOCTRINE
## Minimal Operational Model for lupo-context (4.0.88)
...
2. Context moved to `lupo-context/archived/` 
...
**Implementation**:
- Task files in `lupo-context/{context}/tasks/`
...
**Implementation**:
- Question files in `lupo-context/{context}/questions/`
...
**Implementation**:
- Report files in `lupo-context/{context}/reports/`
