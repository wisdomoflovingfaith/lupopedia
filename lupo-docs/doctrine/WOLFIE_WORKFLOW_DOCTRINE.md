...
lupopedia.edges:
  outbound_edges:
    - to: "lupo-docs/doctrine/MOBILE_SEPARATION_DOCTRINE.md"
      type: references
      weight: 1.0
      reason: "Runtime: separate mobile/desktop routes, Two-UI ownership, shared DB"
    - to: "lupo-docs/LESSONS_LEARNED_FROM_THE_WILD_WEST.md"
      type: references
      weight: 0.95
      reason: "Hand-coded desktop templates; IDE integrates"
    - to: "lupo-docs/prd/35_mobile_native_app_separation.md"
      type: references
      weight: 0.9
      reason: "Mobile web vs native operator app scope"
...
lupopedia.footer:
  ...
  verified_by:
    ...
    name: "lilith"
  next_action:
    - "Consumer features: mobile-first skeleton then desktop masterpiece; admin/operator: desktop-first; operators on phone → native app per PRD 35"
---
