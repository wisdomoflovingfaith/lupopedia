...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/FEDERATION_SCOPING_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/doctrine/FEDERATION_SCOPING"
...
Session files under `lupo-database/sessions/*.md` may include both:
