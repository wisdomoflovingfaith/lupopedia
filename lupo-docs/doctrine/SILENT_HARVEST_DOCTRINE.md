...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/SILENT_HARVEST_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/doctrine/SILENT_HARVEST_DOCTRINE.md"
  last_modified_utc: "20260403125504"
  ...
  purpose: "Frame Crafty-era and Lupopedia path/visit analytics as a long-horizon, aggregated foundation for navigation and federation discovery — with privacy and disclosure obligations"
  status: active
  tags:
    - analytics
    - paths
...
lupopedia.edges:
  outbound_edges:
    - to: "lupo-docs/prd/34_federation_node_semantic_network.md"
      type: references
      weight: 1.0
      reason: "Navigation compiler and cross-node analysis — planned deliverables"
    - to: "lupo-docs/prd/11_analytics_tracking.md"
      type: references
      weight: 0.95
      reason: "Analytics, paths, visits semantics"
    - to: "lupo-docs/prd/00_root_constitutional_system_requirements.md"
      type: references
      weight: 1.0
      reason: "Data handling under constitutional rules"
    - to: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql"
      type: references
      weight: 1.0
      reason: "Canonical lupo_visits, lupo_paths, lupo_visits_daily, lupo_referers_daily"
    - to: "lupo-rules/root/WOLFIE_DOCTRINE.md"
      type: references
      weight: 0.85
      reason: "Historical Crafty scale narrative (1.2M installations) — in-repo lineage"
    - to: "lupo-docs/doctrine/CRAFTY_NODE_REACTIVATION_STRATEGY.md"
      type: references
      weight: 1.0
      reason: "Dormant Crafty → Lupopedia reactivation; consent order"
    - to: "lupo-docs/LESSONS_LEARNED_FROM_THE_WILD_WEST.md"
      type: references
      weight: 0.9
      reason: "WOLFIE human context — chair-falling moment; why survivability matters"
lupopedia.footer:
  last_verified: "20260403125504"
  verified_by:
    identity_type: actor
    actor_id: 2
    name: "lilith"
  next_action:
    - "Keep navigation compiler scope aligned with PRD 34 and actual table columns"
    - "Review public messaging with legal/privacy counsel before any broad disclosure campaign"
    - "Reconcile headline install counts with evidence sources (WOLFIE lineage vs operator telemetry) before external comms"
---

# file: SILENT_HARVEST_DOCTRINE — delegation: cursor:root — web_path: http://www.lupopedia.com/lupopedia/lupo-docs/doctrine/SILENT_HARVEST_DOCTRINE.md
...
Crafty Syntax was widely deployed for many years as live-help software. In-repo lineage text (e.g. **[WOLFIE_DOCTRINE.md](../../lupo-rules/root/WOLFIE_DOCTRINE.md)** — *on the order of **1.2 million installations** over multi-decade operation*) describes **historical reach**; it is **not** a substitute for an independently audited census in this repository.
...
Authoritative DDL: **`lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql`**.
