...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/SYSTEM_LIMITS_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupo-docs/doctrine/SYSTEM_LIMITS_DOCTRINE.md"
  ...
  purpose: "Canonical doctrine defining global system limits and enforcement rules for Lupopedia semantic OS"
  traits: ["system_limits", "doctrine", "governance", "semantic_os"]
  tags: ["limits", "doctrine", "system", "governance", "constraints"]
  lupo_agent: "wolfie"

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-database/lupopedia/tables/", type: "limits", weight: 1.0, reason: "Limits database table count" }
