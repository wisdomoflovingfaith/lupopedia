...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/DOCUMENTATION_AS_DATA_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-docs/doctrine/DOCUMENTATION_AS_DATA_DOCTRINE.md"
  last_modified_utc: "20260402230000"
  federation_node_id: 0
  channel_id: 42
  thread_id: "documentation-as-data-doctrine"
  author:
    type: "actor"
    id: 2
    name: "LILITH"
  ...
  purpose: "Clarifies that files and database are two views of the same documentation system"
  tags:
  - "documentation"
  - "database"
  - "sync"
...
lupopedia.edges:
  outbound_edges:
    - to: "lupo-docs/prd/26_five_layer_documentation_architecture.md"
      type: references
      weight: 1.0
      reason: "Five-layer architecture applies to both file and database views"
    - to: "lupo-docs/doctrine/DOCUMENTATION_ARCHITECTURE.md"
      type: references
      weight: 1.0
      reason: "5W1H framework applies to both views"
    - to: "lupo-scripts/import_content.py"
      type: references
      weight: 1.0
      reason: "Sync process between file and database views"
    - to: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql"
      type: references
      weight: 0.8
      reason: "Database schema for documentation tables"
lupopedia.footer:
...
├─────────────────────────────┼───────────────────────────────┤
│ lupo-docs/prd/26_*.md       │ lupo_contents (content rows)   │
...
```python
# 1. Read file
file_content = read_markdown_file("/lupo-docs/prd/26_five_layer_documentation_architecture.md")
