...
flip.footer: {
  outbound_edges: [
    { to: "tools/vsx-extension/", type: "references", weight: 1.0 },
    { to: "docs/status/antigravity_vsx_extension_update_4_0_35.md", type: "references", weight: 1.0 },
    { to: "docs/status/vsx_extension_status.md", type: "references", weight: 1.0 }
  ],
  semantic_tags: ["doctrine", "vsx_extension", "md_fallback", "offline_mode", "antigravity"]
}
---
