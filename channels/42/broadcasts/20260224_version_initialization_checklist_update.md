---
wolfie.headers: {
  file_path_from_root: "channels/42/broadcasts/20260224_version_initialization_checklist_update.md",
  ...
  graph_stats: { inbound_count: 2, outbound_count: 4, centrality_score: 0.85 }
}

flip.footer: {
  inbound_edges: [
    { from: "channels/42/broadcasts/20260224_version_4_0_42_initialized.md", type: "updates", weight: 0.9, hashtag: "#initialization" },
    { from: "docs/versions/4.0.42/TODO.md", type: "improves", weight: 0.8, hashtag: "#process" }
  ],
  outbound_edges: [
  ...
  referenced_by_actors: [1001, 1002, 1003, 1004, 1005, 10000],
