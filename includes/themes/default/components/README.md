...
lupopedia.headers:
  ...
  file_path_from_root: "includes/themes/default/components/README.md"
  file_hash: "f10272e8c4647bd098d22218beb6a29ba8bf7c93f3423bfaa3d89bf78b149fb6"
...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "includes\themes\default\components\README.md"
  file_hash: "935d77a290ef05fc6a75759531814bb4d8621dcda937e13c5fa6a313595a70f7"
  file_path_from_root: "includes\themes\default\components\README.md"
  file_hash: "0737a33f29c8710c346577c9c8d9b76261c51849cb2b9371cc1fffd591f3c4d5"
  ...
  tags: ["includes", "themes", "default", "components", "readmemd"]
  lupo_agent: "windsurf"
...
**Related Files:**
- Layout: `/includes/themes/default/layouts/main_layout.php`
...
**Related Files:**
- Layout: `/includes/themes/default/layouts/main_layout.php`
- Semantic Panel: `/includes/themes/default/components/semantic_panel.php`
- CSS: Included in component (inline styles)
...
**Related Files:**
- Layout: `/includes/themes/default/layouts/main_layout.php`
- Footer: `/includes/themes/default/components/footer.php`
- CSS: Included in component (inline styles)
...
**Related Files:**
- Layout: `/includes/themes/default/layouts/main_layout.php`
- ConnectionsService: `/includes/classes/ConnectionsService.php`
- CSS: Included in component (inline styles)
...
**Related Files:**
- Renderer: `/includes/functions/render-saved-collections.php`
...
Collections Dropdown component (optional legacy include).
...
**Canonical UI:** `main_layout.php` **saved-collections-nav** (light blue master Collections + green tabs). **topbar.php** does not include this file (avoid duplicate controls and conflicting dropdowns).

**Usage (manual / experimental only):**
```php
...
- Layout: `/includes/themes/default/layouts/main_layout.php` - Contains modal and collection management functions
- Topbar: `/includes/themes/default/components/topbar.php` - Includes this component
