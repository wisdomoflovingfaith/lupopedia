 ...
 * wolfie.header.placement: /includes/themes/default/components/footer.php
...
?>
<!-- Footer: path includes/themes/default/components/footer.php — fixed semantic icon bar toggled from main_layout title row (#footer-semantic-nav). -->
<footer class="main-footer">
    <!-- Semantic Navigation Bar (share, like, TRUTH, help, …) -->
    <div class="semantic-nav-bar" id="footer-semantic-nav" role="navigation" aria-label="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('layout.main_layout.footer_semantic_nav_aria', 'Semantic tools') : 'Semantic tools', ENT_QUOTES, 'UTF-8'); ?>" hidden>
...
body:not(.semantic-nav-visible) .main-footer {
    padding-top: 0;
}
