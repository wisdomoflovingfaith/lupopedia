 ...
 * wolfie.header.placement: /includes/ui/ui-loader.php
...
/**
 * ---------------------------------------------------------
 * Layer helper (DynLayer-compatible API, eval-free)
 * ---------------------------------------------------------
 * crafty_syntax_eyes.js uses new DynLayer(id) — provided by layers.js as LupoLayer alias.
 * Do not load includes/js/dynlayer.js in the same page (duplicate globals).
 */
lupo_enqueue_js(LUPOPEDIA_PUBLIC_PATH . '/includes/js/layers.js');
 ...
 * ---------------------------------------------------------
 */
lupo_enqueue_js(LUPOPEDIA_PUBLIC_PATH . '/includes/js/crafty_syntax_eyes.js');
 ...
 * ---------------------------------------------------------
 */
lupo_enqueue_css(LUPOPEDIA_PUBLIC_PATH . '/includes/css/navigation.css');
lupo_enqueue_js(LUPOPEDIA_PUBLIC_PATH . '/includes/js/navigation.js');
 ...
 * ---------------------------------------------------------
 */
lupo_enqueue_css(LUPOPEDIA_PUBLIC_PATH . '/includes/css/truth.css');
