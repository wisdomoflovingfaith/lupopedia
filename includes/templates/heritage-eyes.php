 ...
 *   require LUPOPEDIA_ABSPATH . 'includes/templates/heritage-eyes.php';
 *
 * Requires static assets under web root: images/ (GIF/PNG sprites per WOLFIE).
 * Behavior: includes/js/heritage-eyes.js (no DynLayer, no layers.js).
 *
 * Master stage (#heritage-master-stage): one position:fixed full-viewport wrapper with a
...
$imgBase = $pub . '/images/';
$heritageJsSrc = $pub . '/includes/js/heritage-eyes.js';
...
<div id="heritage-master-stage" class="heritage-master-stage" style="position:fixed;left:0;top:0;width:100%;height:100%;margin:0;padding:0;border:0;z-index:<?php echo $stageZOut; ?>;pointer-events:none;overflow:visible;">
<div id="eyesnewsDiv" style="position:absolute;z-index:8;left:20px;top:160px;">
<img src="<?php echo htmlspecialchars($imgBase . 'blank.gif', ENT_QUOTES, 'UTF-8'); ?>" id="heritage-tempeyes" name="tempeyes" width="5" height="2" border="0" alt="live help">
</div>
<div id="closedblockDiv" style="position:absolute;z-index:5;left:15px;top:416px;width:346px;height:94px;visibility:hidden;">
<img src="<?php echo htmlspecialchars($imgBase . 'closed2.gif', ENT_QUOTES, 'UTF-8'); ?>" id="heritage-closed" width="346" height="94" alt="closed eyes" name="closedeyes">
</div>
<div id="backblockDiv" style="position:absolute;z-index:1;left:580px;top:210px;width:369px;height:152px;visibility:hidden;">
<img src="<?php echo htmlspecialchars($imgBase . 'right4.gif', ENT_QUOTES, 'UTF-8'); ?>" id="heritage-whites" height="152" width="369" alt="eye whites" name="eyewhites">
</div>
<div id="lefteyeblockDiv" style="position:absolute;z-index:2;left:230px;top:110px;width:38px;height:38px;visibility:hidden;">
<img src="<?php echo htmlspecialchars($imgBase . 'blueeye.gif', ENT_QUOTES, 'UTF-8'); ?>" id="heritage-eyetwo" height="38" width="38" border="0" name="eyetwo" alt="right">
</div>
<div id="righteyeblockDiv" style="position:absolute;z-index:3;left:547px;top:321px;width:38px;height:38px;visibility:hidden;">
<img src="<?php echo htmlspecialchars($imgBase . 'blueeye.gif', ENT_QUOTES, 'UTF-8'); ?>" id="heritage-eyeone" height="38" width="38" border="0" name="eyeone" alt="eye">
</div>
<div id="lidsblockDiv" style="position:absolute;z-index:4;left:715px;top:406px;width:346px;height:94px;visibility:hidden;">
<img src="<?php echo htmlspecialchars($imgBase . 'lids2.gif', ENT_QUOTES, 'UTF-8'); ?>" id="heritage-lids" width="346" height="94" alt="lids" name="lids">
</div>
