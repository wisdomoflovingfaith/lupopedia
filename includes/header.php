...
lupopedia.headers:
  ...
  file_path_from_root: "includes/header.php"
  web_path: "http://www.lupopedia.com/lupopedia/includes/header.php"
  questions_toon: null
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo htmlspecialchars($lupoPubSlash !== '' ? $lupoPubSlash . '/images/logoface.png' : 'images/logoface.png', ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <?php endif; ?>
    <meta property="og:image" content="<?php echo htmlspecialchars(($lupoPublicBase !== '' ? $lupoPublicBase : '') . '/images/s1.png', ENT_QUOTES, 'UTF-8'); ?>">
...
#firstHeading { 
    ...
    <script>
    (function () {
        if (typeof window.toggleSavedCollectionsDropdown !== 'undefined') {
            return;
        }
        ...
        window.toggleSavedCollectionsDropdown = toggleSavedCollectionsDropdown;
...
<a href="<?php echo htmlspecialchars($lupoPublicBase !== '' ? $lupoPublicBase . '/index.php' : '/index.php', ENT_QUOTES, 'UTF-8'); ?>" class="nav-logo" onclick="scrollToTop()" title="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('nav.logo_title', 'Lupopedia home') : 'Lupopedia home', ENT_QUOTES, 'UTF-8'); ?>">
     <img src="<?php echo htmlspecialchars($lupoPublicBase !== '' ? $lupoPublicBase . '/images/logoface.png' : 'images/logoface.png', ENT_QUOTES, 'UTF-8'); ?>?1766754946" alt="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('nav.logo_alt', 'Lupopedia') : 'Lupopedia', ENT_QUOTES, 'UTF-8'); ?>" width="50" height="50" border="0" style="border-radius: 50%;" />
 </a>
 </div>
        <nav class="main-nav">
                ...
                <div class="nav-user">
                    ...
                    if (!function_exists('lupo_render_login_status')) {
                        $auth_ui_helpers_path = defined('LUPOPEDIA_PATH') 
                            ? LUPOPEDIA_PATH . '/includes/functions/auth-ui-helpers.php'
    ...
    function saveCollection() {
        ...
        fetch(lupoPubUrl('api/save_collection.php'), {
            method: 'POST',
            headers: {
    ...
    function loadCollectionsList() {
        ...
        fetch(lupoPubUrl('api/list_collections.php'))
        .then(function(response) { return response.json(); })
        .then(function(data) {
    ...
    function loadCollectionById(collectionId, collectionName) {
        ...
        fetch(lupoPubUrl('api/load_collection.php'), {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    function deleteCollection(collectionId) {
        ...
        fetch(lupoPubUrl('api/delete_collection.php'), {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
<div class="content-list-container">
   ...
   <div class="dropdown">
    <img src="<?php echo htmlspecialchars($lupoPublicBase !== '' ? $lupoPublicBase . '/images/addshortcut.png' : 'images/addshortcut.png', ENT_QUOTES, 'UTF-8'); ?>" width="42" height="42" onclick="toggleMenu('shortcutDropdown', event)" style="cursor:pointer;"> 
  ...
  <div class="dropdown">
    <img src="<?php echo htmlspecialchars($lupoPublicBase !== '' ? $lupoPublicBase . '/images/contents.png' : 'images/contents.png', ENT_QUOTES, 'UTF-8'); ?>" width="42" height="42" onclick="toggleMenu('contentsDropdown', event)" style="cursor:pointer;">
 ...
 &nbsp;
  <img src="<?php echo htmlspecialchars($lupoPublicBase !== '' ? $lupoPublicBase . '/images/edges.png' : 'images/edges.png', ENT_QUOTES, 'UTF-8'); ?>" width="77" height="42"   style="cursor:pointer; ">
