 ...
 *
 * FILE: includes/classes/DatabaseFactory.php
 * TYPE: php
 */
...
if (!class_exists('PDO_DB')) {
    // This file lives in includes/classes/; PDO_DB is in the same directory.
...
class DatabaseFactory {
    ...
    public static function getConnection() {
        ...
        error_log("[DatabaseFactory] CONNECT: host=$host db=$name type=$type");
