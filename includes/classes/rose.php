 ...
 *
 * PURPOSE:
 *   Read channel artifacts from channels/, synthesize responses,
...
class ROSE
{
    ...
    public function __construct($db)
    {
        $this->db = $db;
        $this->pdo = $db->getPdo();
        $this->channelsPath = LUPOPEDIA_PATH . '/channels';
        $this->outputPath = LUPOPEDIA_PATH . '/chats/rose/json';
    ...
    {
        $registryPath = LUPOPEDIA_PATH . '/database/lupopedia/actors/actor_id/registry.json';
