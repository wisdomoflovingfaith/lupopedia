...
class ToonValidator
{
    ...
    public function __construct($db = null)
    {
        ...
        $this->toon_dir = $base . DIRECTORY_SEPARATOR . 'database' . DIRECTORY_SEPARATOR . 'lupopedia' . DIRECTORY_SEPARATOR . 'toon';
    }
    ...
    /**
     * Load TOON file for a table (.toon.json in database/lupopedia/toon)
     *
     * @param string $table
