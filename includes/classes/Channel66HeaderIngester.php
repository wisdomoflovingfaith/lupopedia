 ...
 * - discover files under channels/66/threads/<threadId>/*.md (scope-root aware)
 ...
 * - per-file JSONL logging to logs/admin/
 */
...
require_once __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'database' . DIRECTORY_SEPARATOR . 'lupopedia' . DIRECTORY_SEPARATOR . 'content' . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'Services' . DIRECTORY_SEPARATOR . 'Validation' . DIRECTORY_SEPARATOR . 'HeaderValidationService.php';
...
class Channel66HeaderIngester
{
    ...
    private function discoverThreadFiles($scopeRoot, $threadId)
    {
        $threadDir = rtrim($scopeRoot, DIRECTORY_SEPARATOR)
            . DIRECTORY_SEPARATOR . 'channels' . DIRECTORY_SEPARATOR . '66' . DIRECTORY_SEPARATOR . 'threads'
