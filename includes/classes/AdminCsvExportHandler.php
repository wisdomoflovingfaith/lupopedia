...
class AdminCsvExportHandler
{
    ...
    {
        $toonDir = LUPOPEDIA_PATH . '/database/lupopedia/toon';
        $csvDir = LUPOPEDIA_PATH . '/database/lupopedia/csv';
    ...
    private static function exportTable($db, $prefix, $tableName, $toonFile, $csvDir)
    {
        ...
        return array(
            'status' => 'success',
            'file_path' => 'database/lupopedia/csv/' . $tableName . '.csv',
            'row_count' => $rowCount
        );
    }
            ...
            <div class="admin-form">
                <form method="post" action="<?php echo htmlspecialchars($base . '/admin.php?section=csv-export'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <p><strong>Output Directory:</strong> database/lupopedia/csv/</p>
