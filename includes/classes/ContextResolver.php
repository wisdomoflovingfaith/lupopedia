...
#   file_path_from_root: "includes/classes/ContextResolver.php"
...
class ContextResolver
{
    ...
    public static function resolve($db, $table_prefix, $state_file, $base_path)
    {
        ...
        $session_md = $base_path . (defined('LUPO_DATABASE_DIR') ? LUPO_DATABASE_DIR : 'database') . '/session.md';
    ...
    {
        $reg = $base_path . 'database/lupopedia/actors/registry.json';
    ...
    /**
     * Try to get context from database/session.md (key: value or YAML-like).
     *
