 ...
 *
 * Doctrine source of truth: docs/doctrine/TRUST_LADDER_REGISTRY.md
 * Sync script: scripts/sync_trust_ladder_registry_to_db.py
 *
    ...
    private static function loadCacheIfNeeded()
    {
        ...
        try {
            ...
            $msg = 'TrustLadderRegistry: failed to load from DB — ' . $e->getMessage()
                . '. Run scripts/sync_trust_ladder_registry_to_db.py to reconcile.';
            if ($isDev) {
