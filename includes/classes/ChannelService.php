...
/**
 * LUPOPEDIA HEADERS (class file — YAML excerpt; canonical format: docs/doctrine/LUPOPEDIA_HEADERS/)
 *
 * lupopedia.headers:
 *   lupopedia.schema: class
 *   file_path_from_root: includes/classes/ChannelService.php
 ...
 *   purpose: Channel thread JSON mirror under channels and inserts into lupo_dialog_messages.
