<?php
// includes/classes/MemoryExportService.php
//
// PRD 38: mirror lupo_memory_nodes (+ edges) to memory/YYYY/MM/{slug}.json
// Runtime rows: created_ymdhis SHOULD match the 14-digit prefix of memory_node_id (IdGenerator).
// Seed / pre-existing rows: memory_node_id may be low; created_ymdhis may be 0 — export uses 19700101000000 for path/slug (memory/1970/01/).
