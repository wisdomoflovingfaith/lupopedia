 ...
 * On parse failure logs to actors/0/logs/parser_errors.log and returns empty headers.
 * PHP 5.3+ compatible.
 *
 * @package Lupopedia
 */
...
{
    const MAX_DEPTH = 2;
    const PARSER_LOG = 'actors/0/logs/parser_errors.log';
    ...
    /**
     * Log parse error to actors/0/logs/parser_errors.log.
     *
    ...
    {
        $log_dir = $base_path !== '' ? rtrim($base_path, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . 'actors' . DIRECTORY_SEPARATOR . '0' . DIRECTORY_SEPARATOR . 'logs' : '';
