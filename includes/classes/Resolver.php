...
class Resolver
{
     ...
     *
     * Legacy path: actors/{actor_id}/
     * Deterministic-ID path: actors/YYYY/MM/{actor_id}/ when actor_id is 18-digit YmdHis+hash.
     *
    ...
    public static function actorPath($base_path, $actors_dir, $actor_id)
    {
        ...
        // Deterministic actor ID layout: actors/YYYY/MM/actor_id
        ...
        // Legacy fallback: actors/actor_id
    ...
    /**
     * Resolve actor workspace path by relative dir (e.g. actors/system). For name-based dirs.
     * Returns real path if under actors root; otherwise null.
     *
     * @param string $base_path LUPOPEDIA_ABSPATH
     * @param string $actor_dir_rel Relative dir from registry (e.g. actors/system)
    ...
    /**
     * Resolve channel path: channels/{node_id}/{channel_id}/.
     *
