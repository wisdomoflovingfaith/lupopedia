...
class HelpRenderer
{
    ...
    public function showQuickRef()
    {
        ...
        echo "  help       Full help\n";
        echo "\n";
        echo "  Invoke: php bin/lupo.php <command>\n";
    ...
    public function showTopicHelp($topic)
    {
        ...
        if (isset($topics[$topic])) {
            ...
            echo "Try: php bin/lupo.php help\n";
        }
    }
    ...
    public function getContextualSuggestions()
    {
        ...
        if ($mode === 'human_direct') {
            ...
            $suggestions[] = "Session context can be set in database/session.md.";
        }
        return $suggestions;
    }
    ...
    {
        $content = "Each actor has a workspace: /actors/{actor_name}/\n";
    ...
    protected function getDoctorHelp()
    {
        ...
        $content .= "  * Registry file (database/lupopedia/actors/registry.json or actor_id/registry.json)\n";
        $content .= "  * Session file (database/session.md, optional for CLI fallback)\n";
    ...
    protected function getListHelp()
    {
        ...
        $content .= "Thread copy: channels/0/threads/VERSION_4.0.61/tldr.md\n";
