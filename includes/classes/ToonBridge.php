...
class ToonBridge {
     ...
     *   
     *   edges:
     *     - to: docs/prd/02_channels_discussions.md, type: references
     *     - to: docs/prd/16_lupopedia_headers.md, type: references
     * 
     * JSON-style (legacy):
     *   {
     ...
     * @param string $baseDir Base directory (LUPOPEDIA_PATH . '/memory')
