 ...
 * Chip layout must match CSS --admin-nav-chip-w / --admin-nav-chip-h and GAP (0 = no seam).
...
(function (window, document) {
    ...
    function getSquares() {
        return document.querySelectorAll('#admin-intro-overlay .admin-intro-sq');
    }
    ...
    function finishIntro(app, overlay, shell) {
        ...
        app.classList.add('admin-app--scroll-mode');
        app.classList.add('admin-app--shell-ready');

        window.setTimeout(function () {
            app.classList.add('admin-app--mid-expanded');
    ...
    function start() {
        ...
        var shell = document.getElementById('admin-scroll-shell');
