...
lupopedia.headers:
  ...
  file_path_from_root: "includes/functions/auth-helpers.php"
  web_path: "http://www.lupopedia.com/lupopedia/includes/functions/auth-helpers.php"
  questions_toon: null
...
$session_compat_path = (defined('LUPOPEDIA_PATH') ? LUPOPEDIA_PATH : dirname(dirname(__DIR__))) . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'functions' . DIRECTORY_SEPARATOR . 'session-compat-5.6.php';
