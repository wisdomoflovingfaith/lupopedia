...
lupopedia.headers:
  ...
  file_path_from_root: "includes/functions/README.md"
...
lupopedia.headers:
  ...
  tags: ["includes", "functions", "readmemd"]
  lupo_agent: "windsurf"
...
**Related Files:**
- Component: `/includes/themes/default/components/saved-collections-nav.php`
