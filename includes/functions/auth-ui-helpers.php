...
lupopedia.headers:
  ...
  file_path_from_root: "includes/functions/auth-ui-helpers.php"
  web_path: "http://www.lupopedia.com/lupopedia/includes/functions/auth-ui-helpers.php"
  questions_toon: null
...
function lupo_render_login_status($user = null, $is_operator = false)
{
    ...
    if ($user !== null && is_array($user) && !empty($user)) {
        ...
        $avatar_url = $base . '/uploads/avatars/' . $auth_user_id . '_avatar.jpg';
        $avatar_fallback = $base . '/images/logoface.png';
