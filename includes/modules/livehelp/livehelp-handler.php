...
require_once LUPOPEDIA_PATH . '/includes/classes/ActorAvailabilityService.php';
require_once LUPOPEDIA_PATH . '/includes/classes/ChatRoutingService.php';
require_once LUPOPEDIA_PATH . '/includes/classes/ChatService.php';
...
function handle_send_message()
{
    ...
    require_once LUPOPEDIA_PATH . '/includes/classes/LupoEmojiPath.php';
