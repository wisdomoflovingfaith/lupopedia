...
require_once LUPOPEDIA_ABSPATH . '/includes/modules/content/content-model.php';
...
if (file_exists(LUPOPEDIA_ABSPATH . '/includes/functions/collection-tabs-loader.php')) {
    require_once LUPOPEDIA_ABSPATH . '/includes/functions/collection-tabs-loader.php';
}
