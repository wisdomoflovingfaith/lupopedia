...
lupopedia.headers:
  ...
  file_path_from_root: "includes/modules/crafty_syntax/CRAFTY_SYNTAX_SQL_TOON_REPORT.md"
...
lupopedia.headers:
  ...
  tags: ["includes", "modules", "crafty_syntax", "crafty_syntax_sql_toon_reportmd"]
  lupo_agent: "windsurf"
...
**Scope:** All PHP files under `includes/modules/crafty_syntax/`  
