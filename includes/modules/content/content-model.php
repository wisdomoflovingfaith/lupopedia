 ...
 * wolfie.header.placement: /includes/modules/content/content-model.php
...
function _content_attach_flare_headers($content, $db, $prefix)
{
    ...
    try {
        $flare = $db->fetchRow(
            "SELECT flare_version, flare_schema, file_path_from_root, web_path, last_modified_utc, system_version, channel_id, actor_id, delegation_chain, artifact_type, artifact_kind, purpose, mood_vector, traits, tags, lupo_agent, agent_name_identity FROM {$flare_table} WHERE content_id = :cid",
