...
lupopedia.headers:
  ...
  file_path_from_root: "includes/modules/channels/channel-typing-api.php"
  web_path: "http://www.lupopedia.com/lupopedia/includes/modules/channels/channel-typing-api.php"
  questions_toon: null
...
if (!class_exists('IdGenerator', false)) {
    require_once rtrim($app_root, '/\\') . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'classes' . DIRECTORY_SEPARATOR . 'IdGenerator.php';
}
if (!class_exists('DatabaseFactory', false)) {
    require_once rtrim($app_root, '/\\') . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'classes' . DIRECTORY_SEPARATOR . 'DatabaseFactory.php';
}
