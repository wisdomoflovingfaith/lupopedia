...
try {
    ...
    $sampleChannelData = [
        ...
        'artifacts' => [
            [
                'file_path' => LUPOPEDIA_PATH . '/lupo-channels/42/threads/1001/20260323_234500_wolfie_rose_identity_canonization_and_agent_propagation.md',
                'actor_name' => 'wolfie',
...
- lupo-agents/3/system_prompt.txt',
    ...
    $outputDir = LUPOPEDIA_PATH . '/lupo-chats/rose/json';
    if (!is_dir($outputDir)) {
