// src/lupopedia/headers/parser/types.ts

/**
 * WOLFIE/LUPOPEDIA HEADER v2 Header Structure
 */
export interface LupopediaHeaderV2 {
    lupopedia: {
        headers: {
...
/**
 * LUPOPEDIA HEADER v2 Footer Structure
 */
export interface LupopediaFooterV2 {
    lupopedia: {
        footer: {
...
/**
 * LUPOPEDIA HEADER v3 Header Structure (Draft)
 */
export interface LupopediaHeaderV3 {
    identity: {
...
/**
 * LUPOPEDIA HEADER v3 Footer Structure (Draft)
 */
export interface LupopediaFooterV3 {
    relations: {
        inbound?: Array<{
            type: string;
            source: string;
...
export interface HeaderArtifact {
    filePath: string;
    fileHash: string;
    header: LupopediaHeaderV2 | LupopediaHeaderV3;
    footer?: LupopediaFooterV2 | LupopediaFooterV3;
