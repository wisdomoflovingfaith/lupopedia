...
SELECT
    ...
    1,
    'Canonical governance log for constitutional events, doctrine changes, approvals, kapu rulings, and system-wide governance actions.',
    'Open',
    NULL,
    JSON_OBJECT(
...
WHERE NOT EXISTS (
    ...
    WHERE channel_id = 9000
      AND project_slug = 'gov-constitutional-log'
);
