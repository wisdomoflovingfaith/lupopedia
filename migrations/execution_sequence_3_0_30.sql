...
-- SOURCE migrations/migration_orchestrator_schema_3_0_25_cleanup.sql;
-- SOURCE migrations/ephemeral_schema_3_0_25_cleanup.sql;

-- ========================================
-- STEP 2: Create Schema Infrastructure
-- ========================================
-- Create orchestration schema (8 tables)
SOURCE migrations/migration_orchestrator_schema_3_0_25.sql;

-- Create ephemeral schema (5 tables)
SOURCE migrations/ephemeral_schema_3_0_25.sql;

-- ========================================
-- STEP 3: Doctrine Tab Mappings
-- ========================================
-- Map agent doctrine files (13 files → tab 13)
SOURCE migrations/doctrine_agent_tab_mapping_3_0_26.sql;

-- Map versioning doctrine files (3 files → tab 21)
SOURCE migrations/doctrine_versioning_tab_mapping_3_0_26.sql;

-- Map SQL doctrine files (7 files → tab 11)
SOURCE migrations/doctrine_sql_tab_mapping_3_0_25.sql;

-- ========================================
-- STEP 4: Verification
-- ========================================
-- Run verification queries to confirm success
SOURCE migrations/verification_queries_3_0_30.sql;
