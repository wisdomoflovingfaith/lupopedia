#!/usr/bin/env php
<?php
// VERSION: dynamic via LUPOPEDIA_VERSION atom-backed loader
...
try {
    switch ($command) {
        ...
        case 'whoami':
            ...
            $system_version = function_exists('get_lupo_version') ? get_lupo_version() : (defined('LUPOPEDIA_VERSION') ? LUPOPEDIA_VERSION : '0.0.0');
        ...
        case 'see':
            ...
            break;
        case 'version':
            $ver = function_exists('get_lupo_version') ? get_lupo_version() : '0.0.0';
