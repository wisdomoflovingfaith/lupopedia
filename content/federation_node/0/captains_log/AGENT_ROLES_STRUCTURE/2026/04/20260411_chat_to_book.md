...
lupopedia.headers:
  ...
  path_from_lupopedia_root: content/federation_node/0/captains_log/AGENT_ROLES_STRUCTURE/2026/04/20260411_chat_to_book.md
  web_path: https://www.lupopedia.com/lupopedia/content/federation_node/0/captains_log/AGENT_ROLES_STRUCTURE/2026/04/20260411_chat_to_book.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/captains_log/canonical/1026/04/chat-to-book.toon
  atoms_toon: null
...
- **[Entry 005: The Unified Theory](../../../../content/federation_node/0/captains_log/20260409_UNIFIED_THEORY.md)** — how 25 years of path aggregation, memory rollup, headers, semantic edges, and federation finally became one thing
- **[Entry 006: The Department Doctrine](../../../../content/federation_node/0/captains_log/20260409_DEPARTMENT_DOCTRINE.md)** — pure coders, no AI, Notepad or nothing

**And the system itself:**
- `docs/prd/50_agent_coordination_protocol.md` — the chat interface spec
- `includes/js/layers.js` — DOM manipulation without frameworks
- `includes/js/collections.js` — the collections bar
- `includes/js/semantic-widget.js` — the eye that follows your mouse
