---
  ...
  file_path_from_root: "content/federation_node/0/captains_log/20260418_ai_stop_helping_learn_token_toon_and_doctrine.md"
  web_path: "https://www.lupopedia.com/lupopedia/content/federation_node/0/captains_log/20260418_ai_stop_helping_learn_token_toon_and_doctrine.md"
  status: "active"
  when_updated: "20260417205659"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "memory/captains_log/canonical/1026/04/ai-stop-helping-learn-token-toon-doctrine.toon"
  atoms_toon: null
...
1. **Memory sidecar `.toon` (this repo):** Files under `memory/...` pointed to by `memory_toon` in headers are often **JSON-shaped metadata** (`header_bridge`, `edges`, `purpose`) emitted by `generate_memory_from_header.py`. They are **not** automatically the compact wire format below. Tools and humans should not assume every `.toon` extension is Token-Oriented Object Notation.

2. **Schema TOON exports:** Table-shape mirrors such as `database/lupopedia/toon/*.toon.json` are **generated column dictionaries** from install SQL. Same word family, different job.
...
- JavaScript/TypeScript ecosystems may use `@toon-format/toon` or similar in **tooling** that is not imported by `includes` bootstrap.
- Python: community encoders/decoders where appropriate for scripts under `scripts/`.
...
**See also:** `content/federation_node/0/captains_log/20260409_TOON_AWAKENING.md` (naming and awakening thread), `docs/prd/16_lupopedia_headers.md` (header and `memory_toon` discipline).
...
lupopedia.headers:
  header_format_version: "4.1.3"
  file_path_from_root: "memory/captains_log/canonical/2026/04/ai-stop-helping-learn-token-toon-doctrine.toon"
  web_path: "https://www.lupopedia.com/lupopedia/memory/captains_log/canonical/2026/04/ai-stop-helping-learn-token-toon-doctrine.toon"
  status: "live"
...
# memory/captains_log/canonical/2026/04/ai-stop-helping-learn-token-toon-doctrine.toon
...
1. **Memory sidecar `.toon` files**  
   Files under `memory/...` (including this one) pointed to by `memory_toon` in headers. These are structured metadata documents (often JSON-shaped with `header_bridge`, `edges`, `purpose`, etc.) generated or maintained by Lupopedia tooling. They are **not** automatically Token-Oriented Object Notation. Treat the `.toon` extension as a Lupopedia memory marker, not a wire format guarantee.

2. **Schema TOON exports** (`database/lupopedia/toon/*.toon.json` or similar)  
...
- These tools live in `scripts/` or build pipelines and are **not** imported into `includes` core bootstrap.
...
**See also:**  
- `content/federation_node/0/captains_log/20260409_TOON_AWAKENING.md` (naming and awakening thread)  
- `docs/prd/16_lupopedia_headers.md` (header and `memory_toon` discipline)  
