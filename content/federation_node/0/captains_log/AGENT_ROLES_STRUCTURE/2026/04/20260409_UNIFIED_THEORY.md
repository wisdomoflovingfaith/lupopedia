...
lupopedia.headers:
  ...
  path_from_lupopedia_root: content/federation_node/0/captains_log/AGENT_ROLES_STRUCTURE/2026/04/20260409_UNIFIED_THEORY.md
  web_path: https://www.lupopedia.com/lupopedia/content/federation_node/0/captains_log/AGENT_ROLES_STRUCTURE/2026/04/20260409_UNIFIED_THEORY.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/captains_log/canonical/1026/04/unified-theory.toon
  atoms_toon: null
...
```markdown
# file: Captain's Log — The Unified Theory — delegation: wolfie:root — web_path: http://www.lupopedia.com/lupopedia/content/federation_node/0/captains_log/20260409_UNIFIED_THEORY.md
...
---
1. Created as **Staging** (`memory/{channel_key}/staging/2026/04/...`)
2. Reviewed, edges added, verified
3. Promoted to **Canonical** (`memory/{channel_key}/canonical/1026/04/...`)
...
- `docs/prd/` (especially semantic widget & session transcripts)
