...
lupopedia.headers:
  ...
  file_path_from_root: "content/federation_node/0/captains_log/20260412_THE_CHAT_WARS_EPISODE_IV_A_NEW_HOPE.md"
  web_path: "[https://www.lupopedia.com/lupopedia/content/federation_node/0/captains_log/20260412_THE_CHAT_WARS_EPISODE_IV_A_NEW_HOPE.md](https://www.lupopedia.com/lupopedia/content/federation_node/0/captains_log/20260412_THE_CHAT_WARS_EPISODE_IV_A_NEW_HOPE.md)"
  last_modified_utc: "20260412230000"
  federation_node_id: 0
  channel_key: "captains_log"
  trust_tier: "canonical"
  memory_key: "memory/captains_log/canonical/1026/04/chat-wars-episode-iv.toon"
...
*Registry cross-refs:* * **`docs/prd/02_channels_discussions.md`** — The engine that wouldn't die.  
* **`docs/prd/81_agent_orchestration_chat.md`** — Surveillance with benefits.  
* **`docs/versions/4.0.99/BREAKTHROUGH_REGISTRY.md`** — Edge #8 (Humor as a system state).
