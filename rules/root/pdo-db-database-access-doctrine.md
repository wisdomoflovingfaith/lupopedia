...
lupopedia.headers:
  ...
  path_from_lupopedia_root: rules/root/pdo-db-database-access-doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/rules/root/pdo-db-database-access-doctrine.md
  status: null
