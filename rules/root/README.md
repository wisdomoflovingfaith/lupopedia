...
lupopedia.headers:
  ...
  path_from_lupopedia_root: rules/root/README.md
  web_path: https://www.lupopedia.com/lupopedia/rules/root/README.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/rules/canonical/1026/04/readme-root.toon
  atoms_toon: memory/atoms/lupopedia_global_constants.atom.toon
  transcript_jsonl: 0/rules/readme-root
  artifact_type: documentation
  artifact_kind: guide
  channel_key: rules
  federation_node_id: 0
  thread_key: rules-index
  lupopedia.schema: documentation
  prd_cluster: null
  title: README.md -- Root Rules Index
  summary: Comprehensive index of all root rules and doctrines for Lupopedia development
---
...
---
# file: Root Rules Index — session: L-LUPO-WOLFIE — delegation: wolfie:root — web_path: [http://www.lupopedia.com/rules/root/](http://www.lupopedia.com/rules/root/)
...
**Permitted Libraries:** Self-contained libraries in `includes/` are allowed, but subject to the rules in **[EXTERNAL_LIBRARIES_DOCTRINE.md](EXTERNAL_LIBRARIES_DOCTRINE.md)**
...
- Channel-based communication on disk: **active** layout `channels/{federation_node_id}/{channel_key}/{thread_key}/` (see `docs/prd/29_project_structure.md`); legacy numeric `channels/{channel_id}/threads/...` for DB/API-mirrored artifacts; archive-only `channels_before_4_0_93/`
...
**Structure (API-mirrored / numeric):** `channels/{channel_id}/{type}/...` — see doctrine for `threads/{dialog_thread_id}/`  
**Documentation threads (4.0.94+):** `channels/{federation_node_id}/{channel_key}/{thread_key}/` with `decisions/`, `questions/`, `answers/`, `comments/` per PRD 17  
...
**Rule:** **No guessed “current UTC”** from LLM context. Run `python bin/tick.py`; reuse `python bin/echo_anchor_utc.py` in the same batch.  
**Detail:** [docs/doctrine/TICK_PY_DOCTRINE.md](../../docs/doctrine/TICK_PY_DOCTRINE.md)
...
**Generation:** `python scripts/generate_toon_files.py`
...
### **[../../docs/doctrine/WOLFIE_WAY_MYTHOLOGY_DOCTRINE.md](../../docs/doctrine/WOLFIE_WAY_MYTHOLOGY_DOCTRINE.md)**
...
### **[../../docs/doctrine/MULTI_AGENT_5W1H_DOCTRINE.md](../../docs/doctrine/MULTI_AGENT_5W1H_DOCTRINE.md)**
...
### **[../../docs/doctrine/DOCUMENTATION_AS_DATA_DOCTRINE.md](../../docs/doctrine/DOCUMENTATION_AS_DATA_DOCTRINE.md)**
...
### **[../../docs/doctrine/DOCUMENTATION_ARCHITECTURE.md](../../docs/doctrine/DOCUMENTATION_ARCHITECTURE.md)**
...
**Alias:** [`docs/doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_DOCTRINE.md`](../../docs/doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_DOCTRINE.md) — bookmark path only; must not diverge  
**Companion (format / tooling):** [`docs/doctrine/LUPOPEDIA_HEADERS/README.md`](../../docs/doctrine/LUPOPEDIA_HEADERS/README.md)

### **[RULE_FILES_HEADER_REQUIREMENT.md](RULE_FILES_HEADER_REQUIREMENT.md)**
**Purpose:** Meta-rule requiring headers on ALL rule files  
**Requirement:** ALL files in `rules/root/` MUST have complete LUPOPEDIA headers  
...
**Location:** `docs/versions/{version}/`  
...
**Migration Policy**: One-time changes via `tmp/run_*.php` only  
...
- Migrations: `/tmp/run_*.php` (admin access required)
- Debug: `/tests/debug_*.php` (read-only diagnostics)
**File Organization**:
...
- [ ] Use `includes/` for external libraries
...
- [ ] Place in `includes/{library-name}/`
- [ ] No Composer files
...
3. **[docs/doctrine/](../docs/doctrine/)** - Complete doctrine collection
4. **[channels/](../channels/)** - Channel-based communication

### Version-Specific:
- **[docs/versions/](../docs/versions/)** - All version documentation
