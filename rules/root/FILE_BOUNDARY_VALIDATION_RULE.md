...
lupopedia.headers:
  ...
  path_from_lupopedia_root: rules/root/FILE_BOUNDARY_VALIDATION_RULE.md
  web_path: https://www.lupopedia.com/lupopedia/rules/root/FILE_BOUNDARY_VALIDATION_RULE.md
  status: null
...
2. **Is Within Controlled Directories**
   ...
   - `docs/doctrine/` (doctrine files)
   - `rules/root/` (rule files)
...
```php
validateFileModification('channels/51/threads/1037/artifact.md', 1);
