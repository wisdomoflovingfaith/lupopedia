...
lupopedia.headers:
  ...
  path_from_lupopedia_root: rules/root/TIMESTAMP_FORMAT_ENFORCEMENT.md
  web_path: https://www.lupopedia.com/lupopedia/rules/root/TIMESTAMP_FORMAT_ENFORCEMENT.md
  status: null
...
# file: TIMESTAMP_FORMAT_ENFORCEMENT.md — session: L-LUPO-WOLFIE — delegation: wolfie:root — web_path: http://www.lupopedia.com/rules/root/TIMESTAMP_FORMAT_ENFORCEMENT.md
...
Add to `scripts/propagate_agent_rules.php` to inject the timestamp notice into every agent's rule files:
