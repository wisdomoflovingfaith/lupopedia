...
lupopedia.headers:
  ...
  path_from_lupopedia_root: rules/root/WINDOWS_WSL_COMMAND_PATTERNS.md
  web_path: https://www.lupopedia.com/lupopedia/rules/root/WINDOWS_WSL_COMMAND_PATTERNS.md
  status: null
...
wsl grep -A 5 -B 2 "lupo_artifacts" "database/lupopedia/mysql/install/install_new_lupopedia.sql"

# Case-insensitive search
wsl grep -i "rose" "includes/classes/rose.php"
```

#### File Operations
```bash
# Count lines in file
wsl wc -l "docs/database/lupopedia/tables/active/lupo_edges.md"

# Find files by pattern
wsl find "docs/database/lupopedia/tables/active" -name "*edges*.md"
