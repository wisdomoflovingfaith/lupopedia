...
lupopedia.headers:
  ...
  path_from_lupopedia_root: rules/root/DATABASE_DOCTRINE.md
  web_path: https://www.lupopedia.com/lupopedia/rules/root/DATABASE_DOCTRINE.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/database-doctrine.toon
...
**Every table MUST have documentation in `docs/database/lupopedia/tables/active/`.**
