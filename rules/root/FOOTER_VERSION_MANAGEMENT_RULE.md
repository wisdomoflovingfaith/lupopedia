...
lupopedia.headers:
  ...
  path_from_lupopedia_root: rules/root/FOOTER_VERSION_MANAGEMENT_RULE.md
  web_path: https://www.lupopedia.com/lupopedia/rules/root/FOOTER_VERSION_MANAGEMENT_RULE.md
  status: null
...
python scripts/validate_footers.py [directory]

# Validate specific file
python scripts/validate_footers.py [file]
```
