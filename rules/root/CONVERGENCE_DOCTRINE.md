...
lupopedia.headers:
  ...
  path_from_lupopedia_root: rules/root/CONVERGENCE_DOCTRINE.md
  web_path: https://www.lupopedia.com/lupopedia/rules/root/CONVERGENCE_DOCTRINE.md
  status: null
...
- **Source of Truth**: `database/lupopedia/actors/actor_id/registry.json`
...
1. **Load canonical registry** from `database/lupopedia/actors/actor_id/registry.json`
