...
**file_path_from_root:** rules/root/EXTERNAL_LIBRARIES_DOCTRINE.md  
**web_path:** http://www.lupopedia.com/rules/root/EXTERNAL_LIBRARIES_DOCTRINE.md  
...
- [ ] Code is placed in `includes/{library-name}/` 
...
|---------|---------|-------|
| **Self-contained libraries in `includes/`** | `includes/PHPMailer/` | Must be included manually, no Composer |
...
- All external code must be in `includes/`
