...
lupopedia.headers:
  ...
  file_path_from_root: "rules/root/WOLFIE_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupopedia/rules/root/WOLFIE_DOCTRINE.md"
...
lupopedia.edges:
  outbound_edges:
    - to: "docs/doctrine/CASCADE_FALLBACK_DOCTRINE.md"
      type: references
      weight: 1.0
    ...
    - to: "docs/doctrine/DATABASE_NEUTRALITY_DOCTRINE.md"
      type: references
      weight: 1.0
...
| Authority | Reference |
|-----------|-----------|
| Root Constitution | `rules/root/LUPOPEDIA_CONSTITUTIONAL_ROOT_RULES.md` |
| This Doctrine | `rules/root/WOLFIE_DOCTRINE.md` |
...
5. Actor workspace: actors/YYYY/MM/{actor_id}/
...
|------------|-------|--------|
| `agents/` | Immutable agent template | Suggest modifying for runtime behavior |
| `actors/` | Runtime actor instance | Treat as agent template |
