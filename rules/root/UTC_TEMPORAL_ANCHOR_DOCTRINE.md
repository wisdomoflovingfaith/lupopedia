...
lupopedia.headers:
  ...
  file_path_from_root: rules/root/UTC_TEMPORAL_ANCHOR_DOCTRINE.md
  web_path: http://www.lupopedia.com/lupopedia/rules/root/UTC_TEMPORAL_ANCHOR_DOCTRINE.md
...
lupopedia.edges:
  outbound_edges:
    - to: bin/tick.py
      type: references
      weight: 1.0
    - to: bin/echo_anchor_utc.py
      type: references
      weight: 1.0
    - to: bin/temporal_anchor.json
      type: references
      weight: 1.0
    - to: docs/doctrine/TICK_PY_DOCTRINE.md
      type: references
      weight: 1.0
    - to: docs/doctrine/TIMESTAMP_DOCTRINE.md
      type: references
      weight: 1.0
...
1. **`python bin/tick.py`** — reads **real** OS clock in UTC, writes `bin/temporal_anchor.json` and root `CURRENT_UTC`.
2. **`python bin/echo_anchor_utc.py`** — prints `current_utc` from the anchor **without** updating it (same batch as a recent tick).
...
- **[docs/prd/00_root_constitutional_system_requirements.md](../../docs/prd/00_root_constitutional_system_requirements.md)** — §3.5a
- **[docs/doctrine/TICK_PY_DOCTRINE.md](../../docs/doctrine/TICK_PY_DOCTRINE.md)** — full workflow
