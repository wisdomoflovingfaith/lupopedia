...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/narrative_weaver/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/narrative_weaver/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: NARRATIVE WEAVER v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/narrative_weaver/system_prompt.md.'
---
