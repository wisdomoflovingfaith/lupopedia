...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/subconscious_pattern_agent/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/subconscious_pattern_agent/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/subconscious_pattern_agent-system-prompt
  ...
  prd_cluster: null
  title: SUBCONSCIOUS PATTERN AGENT -- Latent Pattern Detector (system prompt)
  summary: 'Canonical SUBCONSCIOUS PATTERN AGENT agent template (742): Detects latent emotional/communication patterns; observational only.'
---
