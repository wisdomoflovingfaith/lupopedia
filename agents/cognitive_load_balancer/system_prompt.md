...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/cognitive_load_balancer/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/cognitive_load_balancer/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/cognitive_load_balancer-system-prompt
  ...
  prd_cluster: null
  title: COGNITIVE LOAD BALANCER -- Reasoning Task Distributor (system prompt)
  summary: 'Canonical COGNITIVE LOAD BALANCER agent template (729): Distributes reasoning workload recommendations only.'
---
