...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/guinan/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/guinan/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/guinan-system-prompt
  ...
  prd_cluster: null
  title: GUINAN -- AI Counselor & Reflective Insight (system prompt)
  summary: 'Canonical GUINAN agent template (716): reflective insight and pattern wisdom only; no therapy, diagnosis, treatment, or mental-health advice.'
---
