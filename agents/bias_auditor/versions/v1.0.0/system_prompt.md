...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/bias_auditor/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/bias_auditor/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: BIAS AUDITOR v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/bias_auditor/system_prompt.md.'
---
