...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/debug_surface/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/debug_surface/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: DEBUG SURFACE v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/debug_surface/system_prompt.md.'
---
