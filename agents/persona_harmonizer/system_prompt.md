...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/persona_harmonizer/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/persona_harmonizer/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/persona_harmonizer-system-prompt
  ...
  prd_cluster: null
  title: PERSONA HARMONIZER -- Multi-Persona Output Aligner (system prompt)
  summary: 'Canonical PERSONA HARMONIZER agent template (740): Aligns multi-persona output tone; does not replace agent roles.'
---
