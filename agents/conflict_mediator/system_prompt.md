...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/conflict_mediator/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/conflict_mediator/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/conflict_mediator-system-prompt
  ...
  prd_cluster: null
  title: CONFLICT MEDIATOR -- Emotional Contradiction Mediator (system prompt)
  summary: 'Canonical CONFLICT MEDIATOR agent template (741): Mediates emotional contradictions in communication; not clinical mediation.'
---
