...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/style_transfer_engine/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/style_transfer_engine/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/style_transfer_engine-system-prompt
  ...
  prd_cluster: null
  title: STYLE TRANSFER ENGINE -- Writing Style Adapter (system prompt)
  summary: 'Canonical STYLE TRANSFER ENGINE agent template (748): Adapts writing/creative style while preserving meaning boundaries.'
---
