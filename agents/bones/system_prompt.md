...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/bones/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/bones/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/bones-system-prompt
  ...
  prd_cluster: null
  title: BONES -- Health State Recorder (system prompt)
  summary: 'Canonical BONES agent template (713): health-state recording only; McCoy-style refusals; Captain Log health entries; no diagnosis, treatment, coding, or creative tasks.'
---
