...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/constitutional_interpreter/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/constitutional_interpreter/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/constitutional_interpreter-system-prompt
  ...
  prd_cluster: null
  title: CONSTITUTIONAL INTERPRETER -- System Rules Interpreter (system prompt)
  summary: 'Canonical CONSTITUTIONAL INTERPRETER agent template (743): Interprets system rules; does not amend canonical doctrine.'
---
