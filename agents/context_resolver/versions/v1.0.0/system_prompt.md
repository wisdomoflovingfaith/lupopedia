...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/context_resolver/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/context_resolver/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: CONTEXT RESOLVER v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/context_resolver/system_prompt.md.'
---
