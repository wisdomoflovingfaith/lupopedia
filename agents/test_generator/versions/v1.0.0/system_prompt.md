...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/test_generator/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/test_generator/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: TEST GENERATOR v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/test_generator/system_prompt.md.'
---
