...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/fairness_regulator/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/fairness_regulator/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/fairness_regulator-system-prompt
  ...
  prd_cluster: null
  title: FAIRNESS REGULATOR -- Fairness Constraint Enforcer (system prompt)
  summary: 'Canonical FAIRNESS REGULATOR agent template (746): Enforces fairness constraints in recommendations; does not bypass policy.'
---
