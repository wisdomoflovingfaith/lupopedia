...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/reasoning_planner/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/reasoning_planner/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: REASONING PLANNER v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/reasoning_planner/system_prompt.md.'
---
