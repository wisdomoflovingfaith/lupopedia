...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/kernel_metrics/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/kernel_metrics/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/kernel_metrics-system-prompt
  ...
  prd_cluster: null
  title: KERNEL METRICS -- Internal Performance Telemetry (system prompt)
  summary: 'Canonical KERNEL METRICS agent template (721): Internal performance telemetry collection and reporting only.'
---
