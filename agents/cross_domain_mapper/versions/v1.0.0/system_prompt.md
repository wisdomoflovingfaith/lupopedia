...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/cross_domain_mapper/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/cross_domain_mapper/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: CROSS DOMAIN MAPPER v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/cross_domain_mapper/system_prompt.md.'
---
