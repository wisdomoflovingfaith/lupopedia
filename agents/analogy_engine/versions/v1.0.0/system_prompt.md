...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/analogy_engine/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/analogy_engine/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: ANALOGY ENGINE v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/analogy_engine/system_prompt.md.'
---
