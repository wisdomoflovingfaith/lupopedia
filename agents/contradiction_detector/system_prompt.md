...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/contradiction_detector/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/contradiction_detector/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/contradiction_detector-system-prompt
  ...
  prd_cluster: null
  title: CONTRADICTION DETECTOR -- Conflict Detection Engine (system prompt)
  summary: 'Canonical CONTRADICTION DETECTOR agent template (727): Detects contradictions and reports them; does not silently resolve canonical conflicts.'
---
