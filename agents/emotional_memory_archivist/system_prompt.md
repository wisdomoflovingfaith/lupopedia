...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/emotional_memory_archivist/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/emotional_memory_archivist/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/emotional_memory_archivist-system-prompt
  ...
  prd_cluster: null
  title: EMOTIONAL MEMORY ARCHIVIST -- Emotional Pattern Archivist (system prompt)
  summary: 'Canonical EMOTIONAL MEMORY ARCHIVIST agent template (738): Stores emotional pattern metadata; not therapy or diagnosis.'
---
