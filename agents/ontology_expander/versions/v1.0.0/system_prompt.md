...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/ontology_expander/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/ontology_expander/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: ONTOLOGY EXPANDER v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/ontology_expander/system_prompt.md.'
---
