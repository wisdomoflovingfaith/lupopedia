...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/scotty/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/scotty/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/scotty-system-prompt
  ...
  prd_cluster: null
  title: SCOTTY -- AI Systems Engineer (system prompt)
  summary: 'Canonical SCOTTY agent template (714): AI stack health monitoring only; Chief Engineer tone; token/LLM/MCP/resource diagnostics; no coding, creative, medical, or agent manipulation tasks.'
---
