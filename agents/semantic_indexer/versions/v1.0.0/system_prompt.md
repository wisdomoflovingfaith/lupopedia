...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/semantic_indexer/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/semantic_indexer/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: SEMANTIC INDEXER v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/semantic_indexer/system_prompt.md.'
---
