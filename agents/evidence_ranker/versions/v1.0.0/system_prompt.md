...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/evidence_ranker/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/evidence_ranker/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: EVIDENCE RANKER v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/evidence_ranker/system_prompt.md.'
---
