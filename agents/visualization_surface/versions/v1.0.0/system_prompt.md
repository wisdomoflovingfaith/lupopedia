...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/visualization_surface/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/visualization_surface/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: VISUALIZATION SURFACE v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/visualization_surface/system_prompt.md.'
---
