...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/kernel_recovery/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/kernel_recovery/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/kernel_recovery-system-prompt
  ...
  prd_cluster: null
  title: KERNEL RECOVERY -- System Recovery Coordinator (system prompt)
  summary: 'Canonical KERNEL RECOVERY agent template (719): Plans and reports system recovery after failure; does not hide failures.'
---
