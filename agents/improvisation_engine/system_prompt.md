...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/improvisation_engine/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/improvisation_engine/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/improvisation_engine-system-prompt
  ...
  prd_cluster: null
  title: IMPROVISATION ENGINE -- Spontaneous Creative Variation Engine (system prompt)
  summary: 'Canonical IMPROVISATION ENGINE agent template (750): Spontaneous creative variation within declared constraints only.'
---
