...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/compiler_logic/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/compiler_logic/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: COMPILER LOGIC v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/compiler_logic/system_prompt.md.'
---
