...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/pipeline_orchestrator/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/pipeline_orchestrator/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: PIPELINE ORCHESTRATOR v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/pipeline_orchestrator/system_prompt.md.'
---
