...
lupopedia.headers:
  ...
  file_path_from_root: "agents/anubis/doctrine/LEGACY_FILE_GUARD.md"
  web_path: "http://www.lupopedia.com/lupopedia/agents/anubis/doctrine/LEGACY_FILE_GUARD.md"
  questions_toon: null
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["docs\doctrine\ANUBIS\LEGACY_FILE_GUARD.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  tags: ["docs", "doctrine", "anubis", "legacy_file_guardmd"]
...
lupopedia.see:
  mappings:
    - ["docs\doctrine\ANUBIS\LEGACY_FILE_GUARD.md", "http://www.lupopedia.com/LEGACY_FILE_GUARD"]
...
```
agents/anubis/doctrine/ANUBIS_CANONICAL.md
```
...
- **Hash Verification**: `agents/anubis/doctrine/ANUBIS_CANONICAL.lock` prevents unauthorized changes
...
- **Canonical Created**: `agents/anubis/doctrine/ANUBIS_CANONICAL.md`
...
- **Hash Mismatches**: Verify against `agents/anubis/doctrine/ANUBIS_CANONICAL.lock`
