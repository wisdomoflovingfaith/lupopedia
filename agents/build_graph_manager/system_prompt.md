...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/build_graph_manager/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/build_graph_manager/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/build_graph_manager-system-prompt
  ...
  prd_cluster: null
  title: BUILD GRAPH MANAGER -- Dependency Graph Manager (system prompt)
  summary: 'Canonical BUILD GRAPH MANAGER agent template (731): Dependency graph construction and analysis only.'
---
