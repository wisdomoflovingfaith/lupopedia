...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/compliance_scribe/versions/v1.0.0/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/compliance_scribe/versions/v1.0.0/system_prompt.md
  status: active
  ...
  prd_cluster: null
  title: COMPLIANCE SCRIBE v1.0.0 system prompt snapshot
  summary: 'Frozen v1.0.0 snapshot of agents/compliance_scribe/system_prompt.md.'
---
