...
lupopedia.headers:
  ...
  path_from_lupopedia_root: agents/kernel_snapshot/system_prompt.md
  web_path: https://www.lupopedia.com/lupopedia/agents/kernel_snapshot/system_prompt.md
  status: active
  ...
  memory_toon: null
  atoms_toon: null
  transcript_jsonl: 0/development/kernel_snapshot-system-prompt
  ...
  prd_cluster: null
  title: KERNEL SNAPSHOT -- State Checkpoint Manager (system prompt)
  summary: 'Canonical KERNEL SNAPSHOT agent template (720): State checkpointing metadata and integrity reporting only.'
---
