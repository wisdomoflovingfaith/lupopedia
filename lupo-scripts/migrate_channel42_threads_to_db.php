...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-scripts/migrate_channel42_threads_to_db.php"
 ...
 *
 * Reads JSON thread files from lupo-channels/42/threads/ (excluding archive/)
 * and inserts into lupo_dialog_threads and lupo_dialog_messages.
 * Optionally moves processed files to lupo-channels/42/threads/archive/.
 *
...
$threads_dir = $base . DIRECTORY_SEPARATOR . 'lupo-channels' . DIRECTORY_SEPARATOR . '42' . DIRECTORY_SEPARATOR . 'threads';
