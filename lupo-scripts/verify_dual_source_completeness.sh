...
check_dir "lupo-agents/1" "WOLFIE (1)"
check_dir "lupo-agents/2" "LILITH (2)"
check_dir "lupo-agents/3" "ROSE (3)"
check_dir "lupo-agents/4" "ERIS (4)"
check_dir "lupo-agents/5" "METIS (5)"
check_dir "lupo-agents/19" "ANUBIS (19)"
check_dir "lupo-agents/25" "VISHWAKARMA (25)"
check_file "lupo-agents/19/agent.json" "ANUBIS agent.json"
check_file "lupo-agents/19/system_prompt.txt" "ANUBIS system prompt"
check_file "lupo-agents/25/agent.json" "VISHWAKARMA agent.json"
check_file "lupo-agents/25/system_prompt.txt" "VISHWAKARMA system prompt"
echo ""
