...
#   file_path_from_root: "lupo-scripts/apply_md_path_fixes.py"
...
def replace_in_file(filepath):
    ...
    for d in directories:
        ...
        # Though lupopedia urls might actually need the lupo- prefix now. The user said: "verify the directory name changes all have the lupo- prefix for the folder names in the md documentation and docutrine"
