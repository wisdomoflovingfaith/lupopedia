...
#   file_path_from_root: "lupo-scripts/validate_table_docs.py"
...
TOON_DIR = Path("lupo-database/lupopedia/toon")
TABLE_DOCS_DIR = Path("lupo-docs/database/lupopedia/tables")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Comma-separated table-doc subdirs under lupo-docs/database/lupopedia/tables",
    )
