...
TARGETS = [
    ("CONSTITUTIONAL RULES", "lupo-rules/root/LUPOPEDIA_CONSTITUTIONAL_ROOT_RULES.md"),
    ("WOLFIE DOCTRINE", "lupo-rules/root/WOLFIE_DOCTRINE.md"),
    ("CORE IDENTITY RULES", "lupo-docs/prd/01_core_identity.md"),
    ("FEDERATION INTAKE DOCTRINE", "lupo-docs/prd/20_federation_intake_doctrine.md")
]
...
def compile_rules():
    ...
    compiled.append("# Source: lupo-scripts/compile_agent_rules.py\n")
