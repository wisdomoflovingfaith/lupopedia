...
(Battle Report 20260403). Does not scan lupo-agents/ (ANUBIS agent doctrine moved out).

Usage:
  python lupo-scripts/inject_orphan_prd_manual_batch.py --dry-run
  python lupo-scripts/inject_orphan_prd_manual_batch.py --apply
"""
...
# PRD id -> slug under lupo-docs/prd/
PRD_SLUG = {
...
ORPHAN_MAP = {
    # A — Actor / identity (32)
    "lupo-docs/doctrine/ACTOR_AGENT_AUTH_USER_MODEL.md": [32],
    "lupo-docs/doctrine/ACTOR_PRIMARY_KEY_DOCTRINE.md": [32],
    "lupo-docs/doctrine/ACTOR_REQUIREMENTS.md": [32],
    "lupo-docs/doctrine/AUTH_DOCTRINE.md": [32],
    "lupo-docs/doctrine/IDENTITY_MODEL.md": [32],
    "lupo-docs/doctrine/IDENTITY_MODEL_QUICKSTART_4.0.88.md": [32],
    "lupo-docs/doctrine/SESSION_MODEL.md": [32],
    # C — Infrastructure (33 / 29)
    "lupo-docs/doctrine/CLOUDFLARE_DOCTRINE.md": [33],
    "lupo-docs/doctrine/CLOUDFLARE_VS_FLARE.md": [33],
    "lupo-docs/doctrine/DIRECTORY_STRUCTURE_DOCTRINE.md": [29],
    "lupo-docs/doctrine/EMOJI_AND_SMILIES.md": [33],
    "lupo-docs/doctrine/HEALTH_CHECK_DOCTRINE.md": [33],
    "lupo-docs/doctrine/MINIMAL_HOSTING_REQUIREMENTS.md": [33],
    # D — Development / CLI / registry
    "lupo-docs/doctrine/CLI_DOCTRINE.md": [0],
    "lupo-docs/doctrine/CONFIGURATION_DOCTRINE.md": [0],
    "lupo-docs/doctrine/CONTEXT_MODEL_DOCTRINE.md": [26],
    "lupo-docs/doctrine/DUAL_CONTEXT_IDENTITY_DOCTRINE.md": [26],
    "lupo-docs/doctrine/JSON_SCHEMA_REFERENCE_DOCTRINE.md": [26],
    "lupo-docs/doctrine/PROJECT_REGISTRY_DOCTRINE.md": [29],
    "lupo-docs/doctrine/PROJECT_REGISTRY_WORKFLOW.md": [29],
    "lupo-docs/doctrine/SYSTEM_LIMITS_DOCTRINE.md": [0],
    "lupo-docs/doctrine/TOON_DOCTRINE.md": [26],
    # E — LUPOPEDIA_HEADERS version subtree (16)
    "lupo-docs/doctrine/LUPOPEDIA_HEADERS/DEPRECATION_FLARE_FLIP_FLP.md": [16],
    "lupo-docs/doctrine/LUPOPEDIA_HEADERS/versions/2.0/changelog.md": [16],
    "lupo-docs/doctrine/LUPOPEDIA_HEADERS/versions/2.0/decisions.md": [16],
    "lupo-docs/doctrine/LUPOPEDIA_HEADERS/versions/2.0/observations.md": [16],
    "lupo-docs/doctrine/LUPOPEDIA_HEADERS/versions/2.0/README.md": [16],
    "lupo-docs/doctrine/LUPOPEDIA_HEADERS/versions/2.0/todo.md": [16],
    # F — Rose / communication (18)
    "lupo-docs/doctrine/COMMUNICATION_DOCTRINE.md": [18],
    "lupo-docs/doctrine/HELP_SYSTEM_DOCTRINE.md": [18],
    "lupo-docs/doctrine/ROSE_DOCTRINE.md": [18],
    "lupo-docs/doctrine/ROSE_PACKET_MAPPING.md": [18],
    "lupo-docs/doctrine/RUNTIME_ORCHESTRATION_LOOP.md": [18],
    # G — Collections / hierarchy (26)
    "lupo-docs/doctrine/COLLECTIONS_DOCTRINE.md": [26],
    "lupo-docs/doctrine/HIERARCHY_DOCTRINE.md": [26],
    # H — Table management (11 per category table; PRD file is analytics — lineage hook)
    "lupo-docs/doctrine/TABLE_COUNT_DOCTRINE.md": [11],
    # I — Root rules external (00)
    "lupo-docs/doctrine/ROOTRULES_EXTERNAL_ACTOR.md": [0],
}
