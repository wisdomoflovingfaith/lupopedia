    ...
    def worker_thread(thread_id):
        ...
        try:
            for i in range(iterations_per_thread):
                file_path = f'lupo-channels/42/threads/{thread_id:03d}/artifact_{i:06d}.md'
...
def test_path_hash_consistency():
    ...
    test_paths = [
        'lupo-channels/42/threads/1001/file.md',
        'lupo-channels/42/broadcasts/bcast_001.md',
        'lupo-content/article_v1.md',
        'lupo-chats/chat_002.md',
    ]
...
def test_concurrent_actors():
    ...
    def worker_allocate(actor_id, count=1000):
        ...
        for i in range(count):
            file_path = f'lupo-channels/42/actor_{actor_id}_{i:06d}.md'
            content_id = generate_content_id(file_path)
            results.append({
