...
Check-Dir "lupo-agents/1" "WOLFIE (1)"
Check-Dir "lupo-agents/2" "LILITH (2)"
Check-Dir "lupo-agents/3" "ROSE (3)"
Check-Dir "lupo-agents/4" "ERIS (4)"
Check-Dir "lupo-agents/5" "METIS (5)"
Check-Dir "lupo-agents/19" "ANUBIS (19)"
Check-Dir "lupo-agents/25" "VISHWAKARMA (25)"
Check-File "lupo-agents/19/agent.json" "ANUBIS agent.json"
Check-File "lupo-agents/19/system_prompt.txt" "ANUBIS system prompt"
Check-File "lupo-agents/25/agent.json" "VISHWAKARMA agent.json"
Check-File "lupo-agents/25/system_prompt.txt" "VISHWAKARMA system prompt"
Write-Host ""
