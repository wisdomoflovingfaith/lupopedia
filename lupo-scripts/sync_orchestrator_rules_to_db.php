...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-scripts/sync_orchestrator_rules_to_db.php"
 ...
 * Reads every .md file in lupo-rules/root/, computes checksum, inserts/updates lupo_orchestrator_rules.
...
$rules_dir = $base . 'lupo-rules' . DIRECTORY_SEPARATOR . 'root' . DIRECTORY_SEPARATOR;

if (!is_dir($rules_dir)) {
    fwrite(STDERR, "Rules directory not found: lupo-rules/root/\n");
    exit(1);
}
...
if (empty($files)) {
    echo "No .md files in lupo-rules/root/\n";
    exit(0);
}
