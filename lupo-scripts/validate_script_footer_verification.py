...
#   file_path_from_root: "lupo-scripts/validate_script_footer_verification.py"
#   last_modified_utc: "20260324182000"
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
def main() -> int:
    ...
    scripts = sorted((root / "lupo-scripts").rglob("*.py")) + sorted(
        (root / "lupo-scripts").rglob("*.php")
    )
