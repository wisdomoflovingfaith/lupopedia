...
#   file_path_from_root: "lupo-scripts/convert_json_to_toon.py"
...
"""
Convert JSON-format files from lupo-database/lupopedia/json/ (files with .json, .toon,
or .toon.json extension) to TOON format (YAML) in lupo-database/lupopedia/toon/
