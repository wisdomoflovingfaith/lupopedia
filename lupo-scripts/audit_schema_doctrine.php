...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-scripts/audit_schema_doctrine.php"
 ...
 *
 * Uses TOON files in lupo-database/lupopedia/toon/ (generated from the database) as the
...
$toonDir = $baseDir . DIRECTORY_SEPARATOR . 'lupo-database' . DIRECTORY_SEPARATOR . 'lupopedia' . DIRECTORY_SEPARATOR . 'toon';
$jsonDir = $baseDir . DIRECTORY_SEPARATOR . 'lupo-database' . DIRECTORY_SEPARATOR . 'lupopedia' . DIRECTORY_SEPARATOR . 'json';
...
if (!$jsonOnly) {
    ...
    echo "Schema source: lupo-database/lupopedia/toon\n";
