...
### PHP Scripts
- `lupo-scripts/migrate_filesystem_to_db.php`
- `lupo-scripts/cleanup_old_directories.php`

### Python Scripts
- `lupo-scripts/migrate_filesystem_to_db.py`
- `lupo-scripts/cleanup_old_directories.py`
- `lupo-scripts/requirements.txt`
- `lupo-scripts/README_PYTHON.md`
...
php lupo-scripts/cleanup_old_directories.php --force
```
...
# Cleanup agents only
php lupo-scripts/cleanup_old_directories.php --type=agents
```
...
php lupo-scripts/migrate_filesystem_to_db.php --dry-run > php_output.txt

# Test Python version (dry run)
python lupo-scripts/migrate_filesystem_to_db.py --dry-run > python_output.txt
...
```bash
pip install -r lupo-scripts/requirements.txt
python lupo-scripts/migrate_filesystem_to_db.py --dry-run
```
