...
lupopedia.headers:
  ...
  file_path_from_root: lupo-channels/42/threads/2007/20260327_223000_wolfie_final_execution_directive_approved.md
...
lupopedia.edges:
  ...
  - to: lupo-channels/42/threads/2007/20260327_233000_wolfie_lupopedia_organization_4_0_88_integration_and_corruption_assessment.md
    type: gates_remediation_of
    weight: 1.0
    reason: ATHENA remediation plan context
  - to: lupo-scripts/generate_table_docs_from_toons.py
  ...
  - to: lupo-actors/23/lupo-tools/hephaestus_execution_plan.md
    type: delegates_to
    weight: 1.0
...
**Execution:**
- Tables documented in `lupo-docs/database/lupopedia/tables/active/` that are **NOT** in `install_new_lupopedia.sql` shall be:
  - Identified in precondition audit
  - Moved to `lupo-docs/archived/non_schema_tables_20260327/` (new directory)
...
| `verify_db_against_toons.py` | ✅ Exists (lupo-scripts/) | Precondition 1 gate check. Run before TOON regeneration. |
...
- [ ] Audit git history for corrupted files
  - **Command:** `git log --oneline lupo-docs/database/lupopedia/tables/active/ | head -50`
...
- [ ] Identify ~10-12 aspirational tables for archival
  ...
  - **Action:** Create `lupo-docs/archived/non_schema_tables_20260327/` directory
  - **Log:** Create `DEPRECATION_MANIFEST.md` listing moved files + rationale

### Tooling Creation

- [ ] Create `lupo-scripts/generate_table_docs_from_toons.py`
  - **Input:** `lupo-database/lupopedia/toon/` directory + TOON file list
  - **Output:** Markdown files in `lupo-docs/database/lupopedia/tables/active/` with:
...
- [ ] **DB Validation Report**
  - Output: `lupo-channels/42/threads/2007/20260327_221000_hephaestus_phase1_db_validation.md`
...
- [ ] **Git History Audit Report**
  - Output: `lupo-channels/42/threads/2007/20260327_221500_hephaestus_phase1_git_history_audit.md`
...
- [ ] **Aspirational Table Inventory**
  - Output: `lupo-docs/archived/non_schema_tables_20260327/DEPRECATION_MANIFEST.md`
...
- [ ] **Tooling Approval Report**
  - Output: `lupo-channels/42/threads/2007/20260327_222500_hephaestus_phase1_tooling_status.md`
...
- [ ] **Deliver:** `lupo-channels/42/threads/2007/20260327_225000_hephaestus_phase1_completion_report.md`
...
- [THOTH Semantic Truth Validation](lupo-channels/42/threads/2007/20260327_220000_thoth_semantic_truth_validation_regeneration_source.md) — Source authority assessment
- [ATHENA Remediation Plan](lupo-channels/42/threads/2007/20260327_233000_wolfie_lupopedia_organization_4_0_88_integration_and_corruption_assessment.md) — Remediation context
- [Thread Index](lupo-channels/42/threads/2007/THREAD_INDEX.md) — Navigation
