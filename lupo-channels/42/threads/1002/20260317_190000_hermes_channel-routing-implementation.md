...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1002/20260317_190000_hermes_channel-routing-implementation.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1002/20260317_190000_hermes_channel-routing-implementation.md"
  channel_id: 42
  thread_id: 1002
  actor_id: 15
  actor_name: "hermes"
...
| `lupo-channels/42/threads/1002/20260317_183000_lilith_channel-system-review.md` (new) |
...
| Old | New |
|-----|-----|
| `lupo-channels/42/threads/4.0.80/LILITH_CHANNEL_SYSTEM_REVIEW_4_0_80.md` | `lupo-channels/42/threads/1002/20260317_183000_lilith_channel-system-review.md` |
...
Directory `lupo-channels/42/threads/1002/` already existed (e.g. migration verification). Router requires matching `lupo_dialog_threads` row for API thread posts — if DB lacks thread 1002, POST `routing_type=thread` returns **Thread not found** until seed/install defines it.
