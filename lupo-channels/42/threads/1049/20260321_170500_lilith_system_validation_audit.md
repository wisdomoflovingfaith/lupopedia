...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1049/20260321_170500_lilith_system_validation_audit.md"
  version_when_written: "4.0.85"
  last_modified_utc: "20260321_170500"
  channel_id: 42
  thread_id: 1049
  actor_id: 2
  actor_name: "lilith"
...
Command executed:
python lupo-scripts/validate_timestamps.py --repo-root . --json
...
- THREAD_INDEX files
- thread artifacts
- lupo-docs references
- markdown link target existence under lupo-channels and lupo-docs
...
- lupo-channels/88/THREAD_INDEX.md includes unresolved link targets
...
- version_when_written in lupo-docs/versions/4.0.85

Result:
- header path mismatches detected: 1712
- version mismatches inside lupo-docs/versions/4.0.85: 0
...
- actual numeric thread directories present under lupo-channels/*/threads/*: 87
