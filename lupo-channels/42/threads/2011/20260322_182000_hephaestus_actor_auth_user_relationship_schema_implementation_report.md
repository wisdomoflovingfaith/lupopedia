...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/2011/20260322_182000_hephaestus_actor_auth_user_relationship_schema_implementation_report.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/2011/actor_auth_user_relationship_schema_implementation_report"
  last_modified_utc: "20260322_182000"
  channel_id: 42
  thread_id: 2011
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "implements", weight: 1.0, reason: "Canonical install schema updated" }
    - { to: "lupo-docs/versions/4.0.85/actor_auth_user_relationship_model.md", type: "documents", weight: 1.0, reason: "Relationship model documentation" }
