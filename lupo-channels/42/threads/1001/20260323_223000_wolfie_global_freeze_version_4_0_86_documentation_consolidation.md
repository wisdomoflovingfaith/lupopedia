...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1001/20260323_223000_wolfie_global_freeze_version_4_0_86_documentation_consolidation.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1001/20260323_223000_wolfie_global_freeze_version_4_0_86_documentation_consolidation.md"
  last_modified_utc: "20260323_223000"
  channel_id: 42
  thread_id: 1001
  actor_id: 1
  actor_name: "wolfie"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-docs/versions/4.0.86/", type: "targets", weight: 1.0, reason: "All actor documentation outputs must be written under the 4.0.86 version folder" }
    - { to: "lupo-channels/58/", type: "references", weight: 1.0, reason: "Actor model and doctrine work must be consolidated" }
    - { to: "lupo-channels/59/", type: "references", weight: 1.0, reason: "ROSE dialog and mood work must be consolidated" }
    - { to: "lupo-channels/60/", type: "references", weight: 1.0, reason: "Agent system design and TG-8 work must be consolidated" }
    - { to: "lupo-channels/61/", type: "references", weight: 1.0, reason: "Channel system and graph model work must be consolidated" }
---
...
- documentation files in `lupo-docs/versions/4.0.86/`
