...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1001/20260325_211000_lilith_ws6_test_suite_completion_report.md"
  last_modified_utc: "20260325211000"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/42/threads/1001/20260325_193000_lilith_test_suite_update_4_0_87.md", type: "implements", weight: 1.0 }
    - { to: "lupo-docs/versions/4.0.88/TODO.md", type: "updates", weight: 1.0 }
    - { to: "lupo-docs/versions/4.0.88/CHANGELOG.md", type: "updates", weight: 1.0 }
...
- ✅ **Decision API Endpoints** (`lupo-api/v1/decisions-api.php`): No endpoint tests
- ✅ **Decision CLI** (`lupo-bin/cli/decision-cli.php`): No CLI tests
...
- **Checks**:
  - TOON/JSON schema files in `lupo-database/lupopedia/toon/`
