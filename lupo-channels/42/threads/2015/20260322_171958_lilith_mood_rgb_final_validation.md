...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/2015/20260322_171958_lilith_mood_rgb_final_validation.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/2015/mood_rgb_final_validation"
  last_modified_utc: "20260322_171958"
  channel_id: 42
  thread_id: 2015
  ...
  artifact_type: "audit"
  artifact_kind: "mood_rgb_final_validation"
  purpose: "Final LILITH validation of the resolved 4.0.85 mood_rgb doctrine for structural consistency, behavioral safety, vector containment, runtime alignment, and neutral-default safety."
  mood_rgb: "00FF00"
  tags: ["lilith", "audit", "mood_rgb", "final_validation", "4.0.85"]
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "lupo-channels/42/threads/2015/20260322_170424_athena_mood_rgb_structural_resolution.md", type: "validates", weight: 1.0, reason: "Validates the structural resolution against runtime behavior." }
...
# LILITH Final Validation: mood_rgb Doctrine
...
`metrics.php` aggregates `mood_rgb` as telemetry only. This does not create semantic authority and is aligned with the doctrine.
