...
Reconcile **root `TODO.md`** (new) with **MULTI_AGENT TSK001** (`lupo-docs/versions/4.0.80/TODO.md` historically version-scoped). Either bless root `TODO.md` as coordination authority for 4.0.80+ or merge channel-stabilization tasks into version TODO and update doctrine pointer. Single owner rule must hold.
