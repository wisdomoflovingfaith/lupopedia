...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/broadcasts/20260328_130000_wolfie_header_enforcement_directive.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-channels/42/broadcasts/20260328_130000_wolfie_header_enforcement_directive.md"
...
lupopedia.edges:
  outbound_edges:
    - to: "lupo-channels/42/direct/105/20260328_130500_wolfie_to_windsurf_header_enforcement.md"
      type: direct
      weight: 1.0
...
```bash
python lupo-scripts/validate_lupopedia_headers_universal.py $file
```
