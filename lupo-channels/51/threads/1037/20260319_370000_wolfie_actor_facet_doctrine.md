...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/51/threads/1037/20260319_370000_wolfie_actor_facet_doctrine.md"
  web_path: "http://www.lupopedia.com/lupo-channels/51/threads/1037/20260319_370000_wolfie_actor_facet_doctrine.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-docs/doctrine/ACTOR_FACET_SEPARATION_DOCTRINE.md", type: "creates", weight: 1.0, reason: "Creates canonical actor-facet separation doctrine" }
...
lupopedia.see:
  mappings:
    ...
    - ["Actor-Facet Doctrine", "http://www.lupopedia.com/lupo-channels/51/threads/1037/20260319_370000_wolfie_actor_facet_doctrine.md"]
...
lupopedia.footer:
  ...
  orchestrator: "wolfie"
  next_action:
    - "Implement rule system structure in lupo-rules/root/"
...
1. **Create Rule System Structure**: Implement `lupo-rules/root/` directory structure
...
✅ **Rule system is centralized (lupo-rules/root)**: Canonical rule system established for all facets  
...
✅ **Rule Injection System**: Canonical rule system at `lupo-rules/root/` defined  
