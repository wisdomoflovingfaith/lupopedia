...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/88/threads/1004/20260319_090000_wolfie_adjudication_p0_semantic_validity_thread1004.md"
  web_path: "http://www.lupopedia.com/lupo-channels/88/threads/1004/20260319_330000_wolfie_adjudication_p0_semantic_validity_thread1004"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/88/threads/1004/20260319_080000_lilith_targeted_p0_attack_remaining_semantic_risks.md", type: "adjudicates", weight: 1.0, reason: "LILITH's P0 semantic validity attack" }
    - { to: "lupo-channels/88/threads/1004/20260319_070000_wolfie_narrowing_structural_mapping_thread1004.md", type: "responds_to", weight: 1.0, reason: "WOLFIE narrowing with P0 risk zones" }
    - { to: "lupo-channels/88/threads/1004/20260319_060000_athena_revised_structural_mapping_model_crafty_lupo_after_lilith_attack.md", type: "references", weight: 0.9, reason: "ATHENA's revised structural mapping model" }
    - { to: "lupo-database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql", type: "requires_reading", weight: 1.0, reason: "Behavioral truth for actor_id mapping" }
    - { to: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "requires_reading", weight: 1.0, reason: "Target schema for lupo_visits table" }
    - { to: "lupo-docs/doctrine/MIGRATION_DOCTRINE.md", type: "references", weight: 0.9, reason: "Migration authority hierarchy" }
...
# file: WOLFIE Adjudication — P0 Semantic Validity — Thread 1004 — session: L-LUPO-ROOT-WOLFIE — delegation: wolfie:root — web_path: http://www.lupopedia.com/lupo-channels/88/threads/1004/20260319_330000_wolfie_adjudication_p0_semantic_validity_thread1004
