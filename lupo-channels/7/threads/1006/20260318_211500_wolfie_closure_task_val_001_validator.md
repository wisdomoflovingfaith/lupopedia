...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/7/threads/1006/20260318_211500_wolfie_closure_task_val_001_validator.md"
  web_path: "http://www.lupopedia.com/lupo-channels/7/threads/1006/20260318_211500_wolfie_closure_task_val_001_validator.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/7/threads/1006/20260318_210000_lilith_review_task_val_001_validator-implementation.md", type: addresses, weight: 1.0, reason: "V-THREAD-005 closure addresses implementation review" }
---
...
- **File**: `lupo-scripts/validate_todo_plan.py`
...
#### **Integration Layer**
- **File**: `lupo-scripts/validate_channel_artifacts.py`
...
### **Where It Lives**
- **Primary Script**: `lupo-scripts/validate_todo_plan.py`
- **Integration Point**: `lupo-scripts/validate_channel_artifacts.py`
- **Documentation**: Thread 1006 artifacts and Thread 1012 specification
- **Execution**: `python lupo-scripts/validate_todo_plan.py --repo-root .`
