...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/66/threads/1005/20260320_700000_lilith_headers_improvement_plan_channel_scoped_metadata_sync.md"
...
From `lupo-scripts/generate_headers_from_db.py`:
...
From `lupo-scripts/import_content.py`:
...
- A table is write-critical when any of the following are true:
  - Referenced by request-path modules under `lupo-includes/modules/` for create/update operations.
