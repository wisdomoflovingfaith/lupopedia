...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/66/threads/1003/20260319_320000_wolfie_doctrine_execution_collections_namespaces.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/66/threads/1003/20260319_310000_wolfie_doctrine_update_plan_collections_namespaces.md", type: "executes_plan_for", weight: 1.0, reason: "Executes doctrine update plan from 310000" }
    ...
    - { to: "lupo-channels/66/threads/1003/20260319_300000_hephaestus_implementation_implications_collections_vs_namespaces.md", type: "references", weight: 0.9, reason: "HEPHAESTUS implementation guided doctrine updates" }
...
# file: WOLFIE Doctrine Execution — Collections vs Namespaces — session: L-LUPO-ROOT-WOLFIE — delegation: wolfie:root — web_path: http://www.lupopedia.com/lupo-channels/66/threads/1003/20260319_320000_wolfie_doctrine_execution_collections_namespaces

# WOLFIE Doctrine Execution — Collections vs Namespaces (Thread 1003)
...
|-------|--------|----------------|
| **lupo-docs/doctrine/COLLECTIONS_DOCTRINE.md** | **Updated** | Added critical distinction: collections drive nav/tabs/URLs/breadcrumbs but do NOT define filesystem directory layout. Added precedence section: policy → namespace, nav → collections, path → filesystem. |
...
- Explicit precedence table: Policy/validation → namespace wins; Navigation/tabs → collections win; Filesystem → directory doctrine wins
...
- ✅ Operational position locked (290000)
- ✅ Implementation implications complete (300000)
- ✅ Doctrine updates executed (this artifact)
- ✅ Precedence model established
- ✅ Inheritance paths defined for Threads 1001/1002
...
*End of WOLFIE doctrine execution — Thread 1003.*
