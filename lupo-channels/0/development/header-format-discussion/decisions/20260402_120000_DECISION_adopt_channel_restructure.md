...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/0/development/header-format-discussion/decisions/20260402_120000_DECISION_adopt_channel_restructure.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-channels/0/development/header-format-discussion/decisions/20260402_120000_DECISION_adopt_channel_restructure.md"
...
1. Archive old channels to `lupo-channels_before_4_0_93/`
2. Create new structure with `lupo-channels/{federation_node_id}/{channel_key}/`
...
- Created new channel structure under `lupo-channels/0/`
- Created standard subfolders for each channel
- Created `channel_index.md` with channel mappings
- Example: `lupo-channels/0/development/header-format-discussion/decisions/20260402_120000_DECISION_adopt_channel_restructure.md`
