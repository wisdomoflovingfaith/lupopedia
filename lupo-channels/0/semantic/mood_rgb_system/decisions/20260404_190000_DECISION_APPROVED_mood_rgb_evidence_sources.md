...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/0/semantic/mood_rgb_system/decisions/20260404_190000_DECISION_APPROVED_mood_rgb_evidence_sources.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-channels/0/semantic/mood_rgb_system/decisions/20260404_190000_DECISION_APPROVED_mood_rgb_evidence_sources.md"
  ...
  purpose: "Record archive evidence threads used to validate Mood RGB operational tokens"
  status: "approved"
  tags:
    - "mood_rgb"
    - "decision"
...
# DECISION (APPROVED): Mood RGB — evidence sources
...
Operational **mood_rgb** semantics in Lupopedia were validated against live thread artifacts in **channel 42** (pre–4.0.93 on-disk tree). Those files are preserved under **`lupo-channels_before_4_0_93/42/`** — not under the active **`lupo-channels/{federation_node_id}/{channel_key}/{thread_key}/`** tree.
...
- New Mood RGB decisions and narrative should extend this thread and **`lupo-docs/doctrine/MOOD_RGB_DOCTRINE.md`** (summary).
