...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/0/semantic/mood_rgb_system/decisions/20260404_190100_DECISION_APPROVED_mood_rgb_color_definitions.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-channels/0/semantic/mood_rgb_system/decisions/20260404_190100_DECISION_APPROVED_mood_rgb_color_definitions.md"
  ...
  purpose: "Canonical tokens and R/G/B channel meanings for mood_rgb"
  status: "approved"
  tags:
    - "mood_rgb"
    - "decision"
...
# DECISION (APPROVED): Mood RGB — color definitions and tokens
...
- Default: **`666666`**
- Field name: **`mood_rgb`** (see also companion **`mood_label`** for human readers)
...
Full narrative, runtime rules, CADUCEUS alignment, and examples — see **`lupo-docs/doctrine/MOOD_RGB_DOCTRINE.md`** (summary) and prior repository history for the long-form doctrine text.
