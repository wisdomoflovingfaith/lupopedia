...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/channel_reservations.md"
  web_path: "http://www.lupopedia.com/lupo-channels/channel_reservations.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/channel_creation_doctrine.md", type: "references", weight: 1.0, reason: "References channel creation doctrine" }
    - { to: "lupo-channels/channel_index.md", type: "complements", weight: 1.0, reason: "Complements active channel index" }
...
lupopedia.see:
  mappings:
    - ["channel_reservations.md", "http://www.lupopedia.com/lupo-channels/channel_reservations.md"]
