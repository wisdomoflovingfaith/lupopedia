...
?   ?   ??? 20260120_consolidation_execute_3.1.19.sql
?   ?   ??? 20260120_consolidation_plan_3.1.18.sql
?   ?   ??? 20260120_drop_legacy_tables_and_set_limit_3.1.17.sql
...
?   ?   ??? 3.1.12_add_four_tables_to_ceiling_180.sql
?   ?   ??? 3.1.1_add_missing_emotional_agents.sql
?   ?   ??? 3.1.1_backup_table_template.sql
?   ?   ??? 3.1.2_clarify_mood_rgb_terminology.sql
?   ?   ??? 3.1.3_insert_pack_role_registry.sql
?   ?   ??? 3.1.3_rename_dialog_messages_to_dialog_doctrine.sql
?   ?   ??? 3.1.4_insert_symbolic_actor_meta.sql
?   ?   ??? 3.1.4_lupopedia_minimal_rest_api_tables.sql
?   ?   ??? 3.1.5_add_fork_justification_artifact_type.sql
?   ?   ??? 3.1.5_insert_exhusband_agent.sql
?   ?   ??? 3.1.6_create_labs_declarations_table.sql
...
?   ??? prompts/
?   ?   ??? 3.1.16_cursor_complete.txt
?   ?   ??? 3.1.16_cursor_instruction.txt
?   ?   ??? 3.1.20_cursor_complete.txt
