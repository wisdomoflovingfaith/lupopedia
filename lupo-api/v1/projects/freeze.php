<?php
/**
 * Lupopedia REST API — Freeze Project
 * POST /api/v1/projects/freeze.php (body: project_id [, updated_by_actor_id])
 *
 * @version 4.0.76
 */
...
$ok = $svc->freezeProject($id, $updated_by);
if (!$ok) {
    http_response_code(400);
    echo json_encode(array('error' => 'Freeze failed', 'project_id' => $id, 'utc_timestamp' => gmdate('YmdHis')));
    exit;
}
