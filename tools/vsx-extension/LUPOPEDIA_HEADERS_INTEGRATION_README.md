...
lupopedia.headers:
  ...
  file_path_from_root: "tools/vsx-extension/LUPOPEDIA_HEADERS_INTEGRATION_README.md"
...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "tools\vsx-extension\LUPOPEDIA HEADER_INTEGRATION_README.md"
...
2. **Python Audit Tool** (`scripts/lupopedia_header_audit.py`)
   - LUPOPEDIA Header validation across all docs/
...
```bash
# From repo root
python scripts/lupopedia_header_audit.py
```
...
⚙️ Add LUPOPEDIA Headers to missing files? (y/N): y
  ✓ Added LUPOPEDIA Header: docs/specs/API_ENDPOINTS_NEW.md
  ...
...
1. From repo root: `python scripts/lupopedia_header_audit.py`
...
- Run from repo root: `python scripts/lupopedia_header_audit.py`
