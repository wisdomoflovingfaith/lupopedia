...
def base_url_for_node(federation_node_id=None):
    ...
    LUPO_FEDERATION_NODE_ID can be set for future path-prefix use (e.g. database/files/<id>/).
    """
...
def build_header(path, original_text):
    ...
    mood_vector = MOOD_VECTOR_DEFAULT
...
f"  orchestrator: \"{VERIFIED_BY}\"\n"
f"  next_action:\n"
f"    - \"Review and validate LUPOPEDIA HEADERS for this file\"\n"
f"    - \"Ensure file_path_from_root and identity line follow doctrine\"\n"
f"    - \"Update next_action with 1-3 contextual suggestions for this artifact\"\n\n"
f"flame.see:\n"
f"  mappings:\n"
