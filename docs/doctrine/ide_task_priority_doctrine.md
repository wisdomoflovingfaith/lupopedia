...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/ide_task_priority_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/ide_task_priority_doctrine.md
  status: ''
