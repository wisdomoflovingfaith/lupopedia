...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/release_artifact_approval_governance_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/release_artifact_approval_governance_doctrine.md
  status: ''
