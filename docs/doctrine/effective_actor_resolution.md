...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/effective_actor_resolution.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/effective_actor_resolution.md
  status: ''
