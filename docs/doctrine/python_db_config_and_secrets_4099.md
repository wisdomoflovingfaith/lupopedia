...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/python_db_config_and_secrets_4099.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/python_db_config_and_secrets_4099.md
  status: active
