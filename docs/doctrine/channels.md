> **This file is legacy. For the canonical definition of channels, see PRD 02 and docs/doctrine/channel_model_doctrine.md. Channels are semantic containers, not conversational rooms.**

---
lupopedia.headers:
  header_format_version: "4.1.8"
  path_from_lupopedia_root: docs/doctrine/channels.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/channels.md
  status: ''
