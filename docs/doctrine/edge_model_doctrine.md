...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/edge_model_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/edge_model_doctrine.md
  status: ''
  ...
  summary: ''
---
# file: EDGE_MODEL_DOCTRINE — delegation: thoth:knowledge — web_path: http://www.lupopedia.com/docs/doctrine/EDGE_MODEL_DOCTRINE
...
- [install_new_lupopedia.sql](../../database/lupopedia/mysql/install/install_new_lupopedia.sql)
