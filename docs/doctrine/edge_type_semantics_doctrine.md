...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/edge_type_semantics_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/edge_type_semantics_doctrine.md
  status: ''
...
- TOON: `database/lupopedia/toon/lupo_edge_type_definitions.toon`
