...
The **current version** of Lupopedia is **4.0.18**.
...
**Provenance (4.0.18):** Version bump from 4.0.17; FLIP header provenance remains as in 4.0.17.
...
| **Canonical version** | The canonical current version is **4.0.19**. |
