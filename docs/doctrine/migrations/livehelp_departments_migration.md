---
wolfie.headers: {
  file_path_from_root: "docs/doctrine/migrations/livehelp_departments_migration.md",
  ...
  hashtags: ["#migration", "#crafty_syntax", "#livehelp_departments", "#departments", "#imported", "#upgrade_path"],
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/doctrine/database/departments.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
