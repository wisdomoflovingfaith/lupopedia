---
wolfie.headers: {
  file_path_from_root: "docs/doctrine/migrations/livehelp_operator_departments_migration.md",
  ...
  hashtags: ["#migration", "#crafty_syntax", "#livehelp_operator_departments", "#actor_departments", "#imported", "#upgrade_path"],
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/doctrine/database/actor_departments.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
