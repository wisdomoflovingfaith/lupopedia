...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/migrations/livehelp_migrations_readme.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/migrations/livehelp_migrations_readme.md
  status: ''
