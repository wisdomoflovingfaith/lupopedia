---
wolfie.headers: {
  file_path_from_root: "docs/doctrine/migrations/livehelp_layerinvites_migration.md",
  ...
  hashtags: ["#migration", "#crafty_syntax", "#livehelp_layerinvites", "#layer_invites", "#imported", "#upgrade_path"],
