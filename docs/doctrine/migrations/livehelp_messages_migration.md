---
wolfie.headers: {
  file_path_from_root: "docs/doctrine/migrations/livehelp_messages_migration.md",
  ...
  hashtags: ["#migration", "#crafty_syntax", "#livehelp_messages", "#dropped", "#transcripts", "#upgrade_path"],
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/doctrine/database/dialog_messages.md", type: "documents", weight: 0.9, hashtag: "#target_table" },
