---
wolfie.headers: {
  file_path_from_root: "docs/doctrine/migrations/livehelp_smilies_migration.md",
  ...
  hashtags: ["#migration", "#crafty_syntax", "#livehelp_smilies", "#emoji", "#dropped", "#upgrade_path"],
