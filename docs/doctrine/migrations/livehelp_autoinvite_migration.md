---
wolfie.headers: {
  file_path_from_root: "docs/doctrine/migrations/livehelp_autoinvite_migration.md",
  ...
  hashtags: ["#migration", "#crafty_syntax", "#livehelp_autoinvite", "#auto_invite", "#imported", "#upgrade_path"],
