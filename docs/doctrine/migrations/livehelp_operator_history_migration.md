---
wolfie.headers: {
  file_path_from_root: "docs/doctrine/migrations/livehelp_operator_history_migration.md",
  ...
  hashtags: ["#migration", "#crafty_syntax", "#livehelp_operator_history", "#audit_log", "#imported", "#upgrade_path"],
