---
wolfie.headers: {
  file_path_from_root: "docs/doctrine/migrations/livehelp_paths_firsts_migration.md",
  ...
  hashtags: ["#migration", "#crafty_syntax", "#livehelp_paths", "#analytics", "#imported", "#upgrade_path"],
