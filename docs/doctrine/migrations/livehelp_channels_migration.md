---
wolfie.headers: {
  file_path_from_root: "docs/doctrine/migrations/livehelp_channels_migration.md",
  ...
  hashtags: ["#migration", "#crafty_syntax", "#livehelp_channels", "#dropped", "#channels", "#upgrade_path"],
