---
wolfie.headers: {
  file_path_from_root: "docs/doctrine/migrations/livehelp_operator_channels_migration.md",
  ...
  hashtags: ["#migration", "#crafty_syntax", "#livehelp_operator_channels", "#dropped", "#presence", "#upgrade_path"],
