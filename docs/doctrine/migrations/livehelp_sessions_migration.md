---
wolfie.headers: {
  file_path_from_root: "docs/doctrine/migrations/livehelp_sessions_migration.md",
  ...
  hashtags: ["#migration", "#crafty_syntax", "#livehelp_sessions", "#sessions", "#dropped", "#upgrade_path"],
...
flip.footer: {
  inbound_edges: [
    ...
    { from: "database/migrations/import_from_old_crafty_syntax.sql", type: "documents", weight: 0.8, hashtag: "#migration" }
  ],
  outbound_edges: [
    { to: "docs/doctrine/database/sessions.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
