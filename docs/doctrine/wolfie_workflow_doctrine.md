...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/wolfie_workflow_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/wolfie_workflow_doctrine.md
  status: active
  ...
  summary: ''
---
# file: WOLFIE_WORKFLOW_DOCTRINE — web_path: /docs/doctrine/WOLFIE_WORKFLOW_DOCTRINE.md
...
| **One backend** | Same **PDO_DB**, same services, same business rules—two **presentation** tracks. (**Installer** DB driver carve-out: **`docs/doctrine/DATABASE_DOCTRINE.md`** — **Runtime database access (PDO_DB) and installer exception**.) |
