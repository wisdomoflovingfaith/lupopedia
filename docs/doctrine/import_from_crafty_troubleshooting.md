...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/import_from_crafty_troubleshooting.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/import_from_crafty_troubleshooting.md
  status: ''
