...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/init/lupo_initialization_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/init/lupo_initialization_doctrine.md
  status: ''
