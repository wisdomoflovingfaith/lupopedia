...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/message_attribution.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/message_attribution.md
  status: ''
...
- Proper parameter binding for **`PDO_DB`** (named placeholders; **installer exception:** **`docs/doctrine/DATABASE_DOCTRINE.md`** — **Runtime database access (PDO_DB) and installer exception**)
