...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/cascade_table_ceiling_protocol.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/cascade_table_ceiling_protocol.md
  status: ''
