...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/table_ceiling_defense_plan.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/table_ceiling_defense_plan.md
  status: ''
