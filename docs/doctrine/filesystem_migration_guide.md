...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/filesystem_migration_guide.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/filesystem_migration_guide.md
  status: ''
