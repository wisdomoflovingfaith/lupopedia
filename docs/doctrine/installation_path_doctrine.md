...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/installation_path_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/installation_path_doctrine.md
  status: ''
...
*See also: [Subdirectory Installation Doctrine](../channels/doctrine/SUBDIRECTORY_INSTALLATION_DOCTRINE.md) in `docs/channels/doctrine/`.*
