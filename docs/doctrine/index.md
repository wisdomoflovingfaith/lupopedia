...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/index.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/index.md
  status: ''
...
🔒 **Binding doctrine (single file):** [`rules/root/LUPOPEDIA_HEADERS_DOCTRINE.md`](../../rules/root/LUPOPEDIA_HEADERS_DOCTRINE.md) — field matrix + DB mapping; [`LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_DOCTRINE.md`](LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_DOCTRINE.md) is a stable alias only.
