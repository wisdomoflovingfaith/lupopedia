...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/lupopedia-headers/lupopedia_headers_migration.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/lupopedia-headers/lupopedia_headers_migration.md
  status: ''
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/lupopedia-headers-migration-v3.toon
  atoms_toon: null
  ...
  thread_key: headers-migration-v3
...
Use `channels/registry.json` for `channel_id` -> `channel_key` translation.
