...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/lupopedia-headers/versioning_model.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/lupopedia-headers/versioning_model.md
  status: ''
  ...
  summary: ''
---
# file: VERSIONING_MODEL (compatibility notice) — delegation: cursor:root — web_path: [http://www.lupopedia.com/lupopedia/docs/doctrine/LUPOPEDIA_HEADERS/VERSIONING_MODEL.md](http://www.lupopedia.com/lupopedia/docs/doctrine/LUPOPEDIA_HEADERS/VERSIONING_MODEL.md)
