...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/lupopedia-headers/optional_blocks.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/lupopedia-headers/optional_blocks.md
  status: ''
  ...
  thread_key: headers-optional-v3
