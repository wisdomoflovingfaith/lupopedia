...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/lupopedia-headers/versions/2.0/todo.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/lupopedia-headers/versions/2.0/todo.md
  status: ''
  ...
  thread_key: headers-version-2.0-todo
...
|-----------|-----|-----|--------|
| `docs/` headers | ~85% | 15% | In progress |
| `channels/` headers | ~90% | 10% | In progress |
| `scripts/` comments | ~70% | 30% | In progress |
| `includes/` comments | ~60% | 40% | In progress |
