...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/lupopedia-headers/versions/2.0/decisions.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/lupopedia-headers/versions/2.0/decisions.md
  status: ''
  ...
  thread_key: headers-version-2.0-decisions
...
### Context
Headers need to evolve over time. Without versioned documentation, it's unclear which fields belong to which version. Validators must handle multiple versions. **Update (PRD 16, 2026-04-18):** the **4.1.3** header contract is **frozen** until the Crafty Syntax human live-help baseline is complete; normative evolution is **paused** until **4.1.5+** while validators continue to branch on declared legacy versions.
