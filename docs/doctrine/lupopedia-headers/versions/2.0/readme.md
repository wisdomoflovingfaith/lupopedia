...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/lupopedia-headers/versions/2.0/readme.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/lupopedia-headers/versions/2.0/readme.md
  status: ''
  ...
  thread_key: headers-version-2.0
