...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/chat_ui_javascript_shared_state_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/chat_ui_javascript_shared_state_doctrine.md
  status: active
  ...
  thread_key: chat-ui-js-shared-state
