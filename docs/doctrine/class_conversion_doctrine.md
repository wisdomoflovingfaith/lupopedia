...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/class_conversion_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/class_conversion_doctrine.md
  status: ''
...
- No database logic (procedures, triggers, views, FKs, etc.); PDO only, manual SQL (**runtime:** **`PDO_DB`**; **installer exception:** **`docs/doctrine/DATABASE_DOCTRINE.md`** — **Runtime database access (PDO_DB) and installer exception**)
