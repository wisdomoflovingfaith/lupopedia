...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/crafty_syntax_migration_project_brief.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/crafty_syntax_migration_project_brief.md
  status: ''
