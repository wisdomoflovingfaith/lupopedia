...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/reverse_engineering_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/reverse_engineering_doctrine.md
  status: active
