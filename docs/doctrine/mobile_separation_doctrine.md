...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/mobile_separation_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/mobile_separation_doctrine.md
  status: active
  ...
  summary: ''
---
# file: MOBILE_SEPARATION_DOCTRINE — web_path: /docs/doctrine/MOBILE_SEPARATION_DOCTRINE.md
...
| Output | Hand-written PHP/HTML/CSS/JS in product paths (e.g. themes, `ui/`, page templates) | Simpler files under **`mobile/`** or parallel routes—**no** DynAPI complexity unless **APPROVED** |
...
Canonical product spec: **[PRD 28 — Semantic Monitoring Widget (The Eye)](docs/prd/28_semantic_monitoring_widget.md)**. This section states **how** Two-UI applies to The Eye: **same tracking intent and backend contracts**, **different presentation** by device.
