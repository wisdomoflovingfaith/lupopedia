...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/hybrid_actor_doctrine_4029.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/hybrid_actor_doctrine_4029.md
  status: ''
