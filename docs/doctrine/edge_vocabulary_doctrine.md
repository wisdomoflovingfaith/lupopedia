...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/edge_vocabulary_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/edge_vocabulary_doctrine.md
  status: ''
...
- `database/lupopedia/mysql/install/install_new_lupopedia.sql` — `lupo_edges`, `lupo_actor_edges` schema.
- `docs/status/cursor_actors_channels_semantic_architecture_4.0.69.md` — edges and semantic layer.
- `docs/doctrine/FEDERATION_SCOPING_DOCTRINE.md` — domain_id vs channel_id on edges.
