...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/task_planning_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/task_planning_doctrine.md
  status: ''
...
- Phase 3Z: Search Instrumentation — Requires Phase 2 complete; can run concurrently with Phase 3A
...
**Canonical root rule:** `rules/root/task-planning-doctrine.md` (PLAN001). All IDE agents (Cursor, Antigravity, Windsurf, Kiro, Warp, Trae, etc.) must follow this doctrine when producing or editing implementation plans.
