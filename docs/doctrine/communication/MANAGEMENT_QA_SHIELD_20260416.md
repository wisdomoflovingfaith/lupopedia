...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/communication/MANAGEMENT_QA_SHIELD_20260416.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/communication/MANAGEMENT_QA_SHIELD_20260416.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/management-qa-shield-20260416.toon
  atoms_toon: null
...
**Proof:** See the staged handoffs under `memory/development/staging/` for the operator channel this cycle.
...
**Proof:** See the `bin/agent_poll_tasks.php` script and related endpoints.
