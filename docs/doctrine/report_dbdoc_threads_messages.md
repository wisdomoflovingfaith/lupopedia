...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/report_dbdoc_threads_messages.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/report_dbdoc_threads_messages.md
  status: ''
