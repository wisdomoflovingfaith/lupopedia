...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/lexa_gateway_integration.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/lexa_gateway_integration.md
  status: ''
...
**Location:** `includes/gateway/LEXA_GatewayGuard.php`
