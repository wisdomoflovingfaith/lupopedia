...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/project_registry_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/project_registry_doctrine.md
  status: active
