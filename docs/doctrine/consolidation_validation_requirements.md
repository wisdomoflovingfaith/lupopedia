...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/consolidation_validation_requirements.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/consolidation_validation_requirements.md
  status: ''
