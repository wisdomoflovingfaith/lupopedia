# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/flare_apply
---
flare.headers:
  flare.version: "1.0"
...
- **Refresh existing headers** (path normalization, `web_path`, `flame.see`) when run with `--refresh`.
