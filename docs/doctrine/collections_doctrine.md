...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/collections_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/collections_doctrine.md
  status: active
...
- TOONs: `database/lupopedia/toon/lupo_collections.toon`, `lupo_collection_tabs.toon`, `lupo_collection_tab_map.toon`, `lupo_collection_tab_paths.toon`
- Web navigation: `docs/specs/WEB_NAVIGATION_ARCHITECTURE.md`
- Orchestration: `docs/architecture/HOW_ACTORS_ORCHESTRATE_ON_CHANNELS.md`
