...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/rootrules_external_actor.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/rootrules_external_actor.md
  status: active
