...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/lupopedia_headers_and_metadata_bridge.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/lupopedia_headers_and_metadata_bridge.md
  status: ''
