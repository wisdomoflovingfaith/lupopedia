...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/crafty_syntax_import_implementation_checklist.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/crafty_syntax_import_implementation_checklist.md
  status: ''
...
lupopedia.edges: []
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for CRAFTY_SYNTAX_IMPORT_IMPLEMENTATION_CHECKLIST.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "doctrine", "crafty_syntax_import_implementation_checklistmd"]
  lupo_agent: "windsurf"
