...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/dual_context_and_opposition_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/dual_context_and_opposition_doctrine.md
  status: ''
