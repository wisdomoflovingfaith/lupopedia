...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/multi_agent_orchestration_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/multi_agent_orchestration_doctrine.md
  status: ''
  ...
  thread_key: multi-agent-orchestration
