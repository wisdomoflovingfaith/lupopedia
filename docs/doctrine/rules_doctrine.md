...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/rules_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/rules_doctrine.md
  status: ''
...
- List rules: `php bin/lupo.php rules --check [target_table] [target_id]`
- Evaluate: `php bin/lupo.php rules --evaluate [target_table] [target_id] [context_json]`
- Example: `php bin/lupo.php rules --check channels 42`

## See also

- [channels/42/content/federation_node_id/0/RULES.md](../../channels/42/content/federation_node_id/0/RULES.md) — Channel 42 rules with LUPOPEDIA header
