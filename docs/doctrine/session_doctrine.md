...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/session_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/session_doctrine.md
  status: ''
...
Download script (scripts/update_geoip_db.sh):
...
php
// includes/classes/GeoIpService.php
class GeoIpService {
