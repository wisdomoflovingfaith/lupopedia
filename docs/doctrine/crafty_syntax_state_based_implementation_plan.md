...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/crafty_syntax_state_based_implementation_plan.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/crafty_syntax_state_based_implementation_plan.md
  status: ''
...
lupopedia.edges: []
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for CRAFTY_SYNTAX_STATE_BASED_IMPLEMENTATION_PLAN.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "doctrine", "crafty_syntax_state_based_implementation_planmd"]
  lupo_agent: "windsurf"
...
- [ ] **Option Z:** Assign new unique emails to duplicates (admin-provided or auto-generated).
