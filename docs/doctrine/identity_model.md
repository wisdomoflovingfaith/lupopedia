...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/identity_model.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/identity_model.md
  status: ''
...
- filesystem path: actors/<actor_slug>/
- meaning: canonical role identity independent of execution surface

### AGENT
- DB canonical: agent_id
- readable canonical: agent_slug
- filesystem path (preferred): agents/<agent_slug>/
- backward compatibility: numeric alias path may exist (example: agents/3/)
...
SLUY = canonical human and filesystem identity.
