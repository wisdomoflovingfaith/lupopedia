...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/crafty_syntax_integration_plan.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/crafty_syntax_integration_plan.md
  status: ''
...
- **Low Xisk:** Cross-install API testing requires 2 live Lupopedia installs
- **Low Xisk:** Rate limiting may need Redis for production-scale enforcement
