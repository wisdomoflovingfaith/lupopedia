...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/lilith_external_research_directive.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/lilith_external_research_directive.md
  status: ''
  ...
  thread_key: external-research-analysis
...
Store external research findings in `content/federation_node_id/3/` directory:

```
content/federation_node_id/3/deepseek_analysis_YYYYMMDD.md
+-- lupopedia.headers
...
lupopedia.edges:
  outbound_edges:
    - to: "content/federation_node_id/3/deepseek_analysis_20260328.md"
      type: references
      weight: 1.0
      reason: "DeepSeek analysis of external research capabilities"
    - to: "rules/root/EXTERNAL_RESEARCH_DOCTRINE.md"
      type: informs
      weight: 0.8
