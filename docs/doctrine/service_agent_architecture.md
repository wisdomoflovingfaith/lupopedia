...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/service_agent_architecture.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/service_agent_architecture.md
  status: ''
  ...
  thread_key: service-agent-architecture
