...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/OPEN_QUESTIONS_PROTOCOL.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/OPEN_QUESTIONS_PROTOCOL.md
  status: active
...
- When an agent encounters a problem or has a question, they MUST include it in the `open_questions` field of their `changelog-pending` JSON buffer entry.
