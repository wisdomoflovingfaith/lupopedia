...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/auth_users_actors_agents_faucets_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/auth_users_actors_agents_faucets_doctrine.md
  status: ''
