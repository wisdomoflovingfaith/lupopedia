...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/cli_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/cli_doctrine.md
  status: active
  ...
  summary: ''
---
# file: CLI_DOCTRINE — delegation: cursor:root
...
- `php bin/lupo.php help` — Main help menu
- `php bin/lupo.php help --quick` — Quick reference card
- `php bin/lupo.php help --web` — Open web help in browser
- `php bin/lupo.php help <topic>` — Topic-specific help (whoami, context, actors, workspace, flare, version)

### docs

Show path to documentation hub or a specific topic.

- `php bin/lupo.php docs` — Path to docs/HELP.md
- `php bin/lupo.php docs <topic>` — Path to docs/<topic>.md if it exists
...
Run system health checks. When `agents/1009/doctor.php` exists, the DOCTOR actor (1009) runs; otherwise the built-in **lupo_doctor_health_check()** runs.
...
1. **session.md** — `database/session.md` (first-class when present)
