...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/anubis_fallback_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/anubis_fallback_doctrine.md
  status: ''
