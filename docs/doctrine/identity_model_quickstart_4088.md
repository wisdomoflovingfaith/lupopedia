...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/identity_model_quickstart_4088.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/identity_model_quickstart_4088.md
  status: active
...
lupopedia.headers:
  ...
  file_path_from_root: "docs/doctrine/IDENTITY_MODEL_QUICKSTART_4.0.88.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/doctrine/IDENTITY_MODEL_QUICKSTART_4.0.88.md"
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "docs/database/lupopedia/tables/active/lupo_actors.md", type: "references", weight: 0.9 }
    - { to: "docs/database/lupopedia/tables/active/lupo_actor_channel_roles.md", type: "references", weight: 0.9 }
    - { to: "docs/database/lupopedia/tables/active/lupo_departments.md", type: "references", weight: 0.9 }

lupopedia.edges:
  outbound_edges:
    - to: "docs/prd/32_actor_authority_agent_roles.md"
      type: implements
      weight: 1.0
...
# file: IDENTITY MODEL QUICKSTART — delegation: wolfie:root — web_path: [http://www.lupopedia.com/lupopedia/docs/doctrine/IDENTITY_MODEL_QUICKSTART_4.0.88.md](http://www.lupopedia.com/lupopedia/docs/doctrine/IDENTITY_MODEL_QUICKSTART_4.0.88.md)
...
- **[lupo_actors.md](docs/database/lupopedia/tables/active/lupo_actors.md)** - Actor table schema
- **[lupo_actor_channel_roles.md](docs/database/lupopedia/tables/active/lupo_actor_channel_roles.md)** - Channel roles schema
- **[lupo_departments.md](docs/database/lupopedia/tables/active/lupo_departments.md)** - Department schema
