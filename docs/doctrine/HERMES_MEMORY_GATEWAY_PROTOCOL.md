...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/HERMES_MEMORY_GATEWAY_PROTOCOL.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/HERMES_MEMORY_GATEWAY_PROTOCOL.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/hermes-protocol.toon
  atoms_toon: null
...
### 1.1 Path Resolution
- **Base Directory:** `memory/transcripts/`
- **Full Path:** `{base}/{federation_node_id}/{channel_key}/{thread_slug}.jsonl`
- **Example:** `memory/transcripts/0/development/hermes-memory-gateway.jsonl`
