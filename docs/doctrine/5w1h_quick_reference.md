...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/5w1h_quick_reference.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/5w1h_quick_reference.md
  status: ''
  ...
  thread_key: 5w1h-quick-reference
...
| **Where** | Context section and file paths | `## Where: auth/, users/ tables` |
...
lupopedia.headers:
  ...
  file_path_from_root: "docs/prd/XX_TITLE.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/prd/XX_TITLE.md"
  # ... required fields ...
---
...
lupopedia.headers:
  ...
  when_updated: "20260402020000"
  file_path_from_root: "docs/versions/4.0.93/decisions/YYYYMMDD_HHIISS_QUESTION_topic.md"
  # ... required fields ...
---
