...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/CONTEXT_AUTHORITY_MODEL.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/CONTEXT_AUTHORITY_MODEL.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/context-authority-model.toon
  atoms_toon: null
...
allowed cross-channel rules (see `docs/doctrine/gaps/MEMORY_CHANNEL_ENFORCEMENT.md`
and `allowed_cross_channel_memory` in `channels/registry.json`).
...
- `docs/doctrine/gaps/MEMORY_CHANNEL_ENFORCEMENT.md` — channel enforcement gaps
- `docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md` — coordination via channels
- `docs/doctrine/ide_agent_continuity_protocol.md` — handoff protocol between agents
