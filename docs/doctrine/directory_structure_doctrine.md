...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/directory_structure_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/directory_structure_doctrine.md
  status: active
  ...
  thread_key: doctrine-directory-structure
