...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/two_layer_security_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/two_layer_security_doctrine.md
  status: active
