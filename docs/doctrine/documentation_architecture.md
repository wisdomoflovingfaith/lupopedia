...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/documentation_architecture.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/documentation_architecture.md
  status: ''
  ...
  thread_key: documentation-architecture
...
```
docs/versions/4.0.94/prd/31_context_system.md
```
...
lupopedia.edges:
  outbound_edges:
    - to: "/docs/prd/26_five_layer_architecture.md"
      type: references
      weight: 1.0
```
...
```
docs/implementations/31_context_system/discussions/
...
## How
Creates contexts/ folder hierarchy.
...
```
docs/implementations/31_context_system/
+-- README.md
+-- authors.md
+-- edges.md
+-- discussions/
...
|---------------|----------|---------|
| **PRD Decisions** | `docs/implementations/{id}_{slug}/decisions/` | `implementations/30_prd_development_guide/decisions/20260402_120000_DECISION_naming_fix.md` |
| **Version Decisions** | `docs/versions/{version}/decisions/` | `versions/4.0.93/decisions/20260402_210000_DECISION_prd31_rejection.md` |
| **Channel Decisions** | `channels/{federation_node_id}/{channel_key}/{thread_key}/decisions/` (active); or legacy `channels/{channel_id}/threads/{thread_id}/` | e.g. `channels/0/development/header-format-discussion/decisions/20260402_120000_DECISION_adopt_channel_restructure.md`; legacy e.g. `channels/42/threads/1001/...` |
