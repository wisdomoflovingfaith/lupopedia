...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/relation_registry.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/relation_registry.md
  status: ''
...
| Relation Type | Direction | Meaning |
|---------------|-----------|---------|
| `emotional_dependency` | Bi-directional | Source's `mood_vector` is influenced by target's state. |
