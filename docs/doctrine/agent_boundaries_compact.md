...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/agent_boundaries_compact.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/agent_boundaries_compact.md
  status: ''
...
lupopedia.edges: []
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for AGENT_BOUNDARIES_COMPACT.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "doctrine", "agent_boundaries_compactmd"]
  lupo_agent: "windsurf"
...
- Interact with DB through **`PDO_DB`** (named placeholders; **no mysqli** in runtime — **installer exception:** **`docs/doctrine/DATABASE_DOCTRINE.md`** — **Runtime database access (PDO_DB) and installer exception**)
