...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/actor_department_auth_user_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/actor_department_auth_user_doctrine.md
  status: ''
  ...
  thread_key: actor-department-auth-user
