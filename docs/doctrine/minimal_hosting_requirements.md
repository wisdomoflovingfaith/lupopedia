...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/minimal_hosting_requirements.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/minimal_hosting_requirements.md
  status: ''
