...
**Current version (as of this note):** **4.0.13**
...
Do not leave `file.last_modified_system_version` as `0000` or an old 3.x value when you have actually edited the file. Use the current patch version (e.g. 4.0.13, then 4.0.14 when we bump).

---

## 2. 3.x vs 4.0.13 — check existing docs when merging

Incoming prompts or legacy material may refer to **version 3.x** (e.g. 3.0.x, 3.1.x). We are on **4.0.13** now. When merging or updating docs:
