...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/headers/flip_footer_doctrine_4_0_31.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/headers/flip_footer_doctrine_4_0_31.md
  status: ''
...
- `node_color`: Field to use for node color (e.g., "mood_vector").
