...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/wolfie_way_mythology_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/wolfie_way_mythology_doctrine.md
  status: ''
  ...
  thread_key: wolfie-way-mythology
