...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/identity_authority_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/identity_authority_doctrine.md
  status: ''
