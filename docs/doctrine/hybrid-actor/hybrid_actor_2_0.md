...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/doctrine/hybrid-actor/hybrid_actor_2_0.md
  web_path: https://www.lupopedia.com/lupopedia/docs/doctrine/hybrid-actor/hybrid_actor_2_0.md
  status: ''
...
security_first_actor:
  core_attributes:
    ...
    emotional_geometry: "mood_vector_vector"
