...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/task_status_reference.md
  web_path: https://www.lupopedia.com/lupopedia/docs/task_status_reference.md
  status: ''
...
```
database/lupopedia/channels/channel_id/{channel_id}/tasks/
+-- pending/
+-- active/
+-- completed/
+-- blocked/
...
ls database/lupopedia/channels/channel_id/0/tasks/completed/
ls database/lupopedia/channels/channel_id/0/tasks/blocked/
ls database/lupopedia/channels/channel_id/0/tasks/failed/
ls database/lupopedia/channels/channel_id/0/tasks/archived/
```
...
grep -rl 'assigned_to:.*lilith' database/lupopedia/channels/channel_id/0/tasks/
```
