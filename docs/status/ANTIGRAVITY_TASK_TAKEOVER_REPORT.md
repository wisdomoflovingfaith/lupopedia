...
|-------------|--------|-------|
| Flame header enhancements (flame.init / flame.close) | Completed (Antigravity); documented and doctrine-aligned | FLARE_ENHANCEMENTS_PLAN_4.0.56.md, FLARE_ENHANCEMENTS_REPORT_4.0.56.md |
| Typed actions, execution modes, safety rule | Completed | Mandatory only for active artifact kinds |
| flame.see URL mappings | Documented | FLARE_DOCTRINE.md Section 17; index and CLI |
| flare.conditional guards & brief | Documented | FLARE_DOCTRINE.md Section 16 |
