...
| 3 | Add `flame.see` mapping for the report itself | Done |
...
- `docs/status/LILITH_FLAME_FAUCET_REPORT.md` — header fixes, flame.see, Section 19 quote, faucet ID rationale, by_actor example, test output examples.
