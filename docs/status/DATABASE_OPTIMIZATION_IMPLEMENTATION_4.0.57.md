...
---
# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/status/DATABASE_OPTIMIZATION_IMPLEMENTATION_4.0.57
flare.headers:
  flare.version: "1.0"
  flare.schema: "report"
...
- **Lilith (actor 2):** **Delegation triggered.** This report is flame-aligned (FLARE headers, flame.init/close, implementation artifact). Lilith is proactively delegated for meta-review; `delegation_chain: "2:1003:10000"` (Lilith delegated by Cursor from Captain). Rationale: flame-aligned artifact; review requested for canonical order and Safety Rule.
