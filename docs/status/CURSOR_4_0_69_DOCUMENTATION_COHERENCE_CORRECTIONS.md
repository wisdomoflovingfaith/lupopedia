...
- **AGENTS.md** headers still use legacy `flare.headers` and version 4.0.57; consider aligning to LUPOPEDIA HEADERS and 4.0.69 in a future pass (not done here to avoid scope creep).
