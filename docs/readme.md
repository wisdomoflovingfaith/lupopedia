...
lupopedia.headers:
  ...
  web_path: "http://www.lupopedia.com/lupopedia/docs/README.md"
  questions_toon: null
...
---
# file: Documentation Index — delegation: cursor:root — web_path: http://www.lupopedia.com/lupopedia/docs/README.md
...
1. **[docs/INIT_README.md](INIT_README.md)** — Prerequisites and "Before You Read" for init.
2. **[docs/doctrine/LUPOPEDIA_HEADERS/](doctrine/LUPOPEDIA_HEADERS/README.md)** — Header format, file order (first line `---`, identity line after closing `---`), block order.
3. **[docs/doctrine/init/LUPO_INITIALIZATION_DOCTRINE.md](doctrine/init/LUPO_INITIALIZATION_DOCTRINE.md)** — Full prerequisite list and why each is required.
...
- **[Channel System Doctrine (51 and system channels)](../backups/filesystem_migration_20260131_133426/channels/5100/identity-layer-architecture.md)** - Lupopedia Channel Architecture: Complete documentation of the Semantic OS identity layer covering channels, actors, and memberships.
