...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for ETHICAL_FOUNDATIONS.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "doctrine", "ethical_foundationsmd"]
  lupo_agent: "windsurf"
...
2. **Path Z:** Remain passive/do nothing → **FORBIDDEN**  
...
### Scenario Z: Resource Allocation
