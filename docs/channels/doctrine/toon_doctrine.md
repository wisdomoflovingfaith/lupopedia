...
**CRITICAL:** TOON files in `database/lupopedia/toon/` are **READ-ONLY** for all IDEs and agents.
...
- Generates TOON files in `database/lupopedia/toon/`
...
- `database/lupopedia/toon/` â€” Table structure definitions (READ-ONLY, generated from database)
- `database/refactors/` â€” Table and column mapping files (EDITABLE - migration mappings)
- `agents/` â€” Agent configuration files (READ-ONLY unless explicitly instructed)
- Other schema mapping locations

**Critical Rule:**
- TOON files in `database/lupopedia/toon/` are READ-ONLY (generated from database)
...
**Agents must use TOON files in `database/lupopedia/toon/` as READ-ONLY references for table structure and column names.**

**Critical Rules:**
- TOON files in `database/lupopedia/toon/` are authoritative **references** (read-only)
...
- Do NOT modify TOON files in `database/lupopedia/toon/` â€” they are regenerated automatically
...
- âŒ **DO NOT** modify files in `database/lupopedia/toon/` â€” those are read-only
...
- Table structure definitions (`database/lupopedia/toon/{table_name}.json`)
- Agent configurations (`agents/{agent_name}/`)
...
**When Cursor encounters a TOON file in `database/lupopedia/toon/`:**
...
**Critical Rule:**
- TOON files in `database/lupopedia/toon/` are READ-ONLY
...
1. **TOON files in `database/lupopedia/toon/`** â€” READ-ONLY, regenerated by Python cron job
