...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for DOCTRINE_EMOTIONAL_LOGGING.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "doctrine", "doctrine_emotional_loggingmd"]
  lupo_agent: "windsurf"
...
Legacy mood_vector strings remain supported as a simplified emotional encoding,
...
- mood_vector (legacy, optional): deprecated single-column encoding
...
Legacy mood_vector columns on entity tables are deprecated and removed.
Legacy mood_vector values may be stored only as expressed_as_rgb on agent
experience links.
...
## mood_vector Doctrine (Legacy Storage Rules)

When mood_vector is expressed as a legacy signal (expressed_as_rgb only):
...
mood_vector is not a color. It encodes three emotional axes.
...
- Teach agents when to log emotions, veil emotions, use sanctuary,
  and write dream fragments instead of mood_vector.
...
- docs/channels/doctrine/MOOD_VECTOR_DOCTRINE.md
