...
lupopedia.headers:
  ...
  file_hash: "1593ca081c7382e027693531fcb45350b017baa4f7475adfd20457f7e3006ee1"
...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for INGESTION_DOCTRINE.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "doctrine", "ingestion_doctrinemd"]
  lupo_agent: "windsurf"
...
This dataset reflects a **large historical footprint** (often stated as **1,000,000+** lifetime installs and **~144,000** active/reporting-era nodes — confirm in `docs/doctrine/SILENT_HARVEST_DOCTRINE.md` before external use) and, for a **given imported database**, provides a **high-fidelity** map of that install’s Crafty-era footprint.
