...
lupopedia.headers:
  ...
  lupopedia.edges: []
  file_path_from_root: "docs\channels\doctrine\legacy-import\deprecated\DEPRECATED_EMOTIONAL_GEOMETRY.md"
  file_hash: "f380d9eb43b962a5ea9742a2acc38b19daf952d95d208bcf7de4e492f710b6e7"
  file_path_from_root: "docs\channels\doctrine\legacy-import\deprecated\DEPRECATED_EMOTIONAL_GEOMETRY.md"
  file_hash: "5e8ccf624fbc775eeb9e8a901647bd371ec7d9d4a8051ea804afef05cf8283ed"
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for DEPRECATED_EMOTIONAL_GEOMETRY.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "doctrine", "legacy-import", "deprecated", "deprecated_emotional_geometrymd"]
  lupo_agent: "windsurf"
...
dialog:
  speaker: CURSOR
  target: @everyone
  message: "Created deprecated emotional geometry documentation for legacy models (3.0.x–4.2.x). Documents scalar and 5-tuple models replaced by 2-actor mood vector geometry."
  mood: "FF6600"
tags:
...
**Replacement**: See [EMOTIONAL_GEOMETRY_DOCTRINE.md](../EMOTIONAL_GEOMETRY_DOCTRINE.md) for the canonical 2-actor mood vector model.
...
**After (CURRENT)**:
```php
// Map primary axis (x) to axis components
$mood = [
...
- **4.4.x**: Full replacement with 2-actor mood vector model
...
- [MOOD_VECTOR_DOCTRINE.md](../../MOOD_VECTOR_DOCTRINE.md) - RGB mood specification
