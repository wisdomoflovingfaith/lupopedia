...
**Previous Model**: hex-byte vector values treated as literal colors
**Updated Model**: hex-byte vector values represent 3-axis emotional coordinates
