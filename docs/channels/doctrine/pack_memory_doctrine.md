...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for PACK_MEMORY_DOCTRINE.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "doctrine", "pack_memory_doctrinemd"]
  lupo_agent: "windsurf"
...
**Canonical Axis Mapping:** X = +1, Y = 0, Z = -1. This fixed mapping ensures consistent emotional geometry interpretation.
...
**Location:** `includes/Pack/Memory/PackMemoryEngine.php`
