...
- **Emotional Geometry**: Dedicated range for mood vector-based emotional agents

## Range Map (0–9999)

| Range | Label | Purpose |
|-------|-------|---------|
| **0–49** | **Kernel agents** | Core semantic OS entities (SYSTEM, CAPTAIN, WOLFIE, THOTH, ANUBIS, MAAT, LILITH, agape (Survivability lens), ERIS, etc.) |
...
| **1000–1999** | **Emotional geometry agents** | Core EMO_* agents operating on mood vector model |
...
- **23**: CHRONOS
- **24**: CADUCEUS
- **25**: agape (Survivability lens agent)
- **26**: ERIS
...
**Rules:**
- Emotional domains are **independent systems**, not a single mood vector model
...
- These are the "organs" of the OS: SYSTEM, CAPTAIN, WOLFIE, THOTH, ANUBIS, MAAT, LILITH, agape (Survivability lens), ERIS, etc.
...
- **2026-01-13**: Removed single mood vector model, replaced with per-domain 3-axis geometries
