...
lupopedia.headers:
  ...
  file_path_from_root: "docs/channels/doctrine/doctrines/COLOR_DOCTRINE.md"
  file_hash: "4140275b242ac68cf8ceb3a92d5164604ed21b70ba7af8bbd343a3e999974f5e"
...
lupopedia.headers:
  ...
  lupopedia.edges: []
  file_path_from_root: "docs\channels\doctrine\doctrines\COLOR_DOCTRINE.md"
  file_hash: "a284200c20ac6d8a2ab8341470391797c1ebbce95141ed5200b422c73e39394a"
  file_path_from_root: "docs\channels\doctrine\doctrines\COLOR_DOCTRINE.md"
  file_hash: "abb1f7772c6fc980b93cc9fcf6f03aa4f55a4dd17f9837462583b3021884375f"
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for COLOR_DOCTRINE.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "doctrine", "doctrines", "color_doctrinemd"]
  lupo_agent: "windsurf"
...
dialog:
  ...
  target: "@everyone"
  mood_vector: "00FF00"
  message: "Created RGB Mapping Protocol (Color Doctrine) v1.0 - defines how emotional scores map to mood vectors"
tags:
...
file:
  ...
  description: "Defines how emotional scores map to mood vectors in Lupopedia"
  version: "1.0.0"
  status: published
...
*Defines how emotional scores map to mood vectors in Lupopedia*

---

## 🟩 1. Purpose

The **RGB Mapping Protocol** defines how Lupopedia converts emotional state vectors into mood vector representations. This protocol enables:
...
This protocol provides deterministic, governed mapping from the Mood System's multi-axis emotional vectors to standardized mood vector values.
...
Use standard mood vector distance:
...
All agents must:
- **Calculate hex-byte vector values** using defined mapping functions
...
A new subsystem compares Mood Vector outputs with ATP clusters to detect emotional mismatch. High discrepancy indicates potential performative signaling or unresolved tension.
