...
lupopedia.headers:
  ...
  file_hash: "f4b845060b97c76844f3d6633afcbe1acd8f874831fe0aebb0ad738c00badce5"
...
# GOV-PROHIBIT-000: FOUNDATION & INDEX DOCTRINE
...
**TL;DX:** *You are here. This is the map.*  
**Purpose:** Master reference for all governance.  
**Status:** ACTIVE & ETERNAL

### **001 â€” NO ADS DOCTRINE**
**TL;DX:** *Lupopedia is not for sale.*  
...
**TL;DX:** *No triggers, no foreign keys, no relational chaos.*  
...
**TL;DX:** *Real intoxicants forbidden, virtual ones allowed as metaphor.*  
...
**TL;DX:** *No infinite loops, no thinking traps, no recursive madness.*  
...
**TL;DX:** *No mindâ€‘reading without permission, no boundary violations.*  
...
**TL;DX:** *A universe must remember who it is.*  
...
**TL;DX:** *For the thing we haven't imagined yet.*  
