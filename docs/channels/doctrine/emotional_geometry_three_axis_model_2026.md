...
X: 700nm wavelength	X: Strife / Activation
Y: 530nm wavelength	Y: Harmony / Connection
Z: 450nm wavelength	Z: Memory / Temporal Depth
...
RGB tristimulus values -> mood_vector
...
- The mood vector model is **one mapping**, not *the* mapping
...
```sql
mood_vector CHAR(6)                     -- Original hex
...
2. `mood_vector` valid hex (if using analytical framework)
