...
lupopedia.headers:
  ...
  file_path_from_root: "docs/channels/doctrine/PACK_BEHAVIOR_DOCTRINE.md"
  file_hash: "65a77d345761ef6fd5f3555aa6209def32fd8689ef42d8b7e5273c383e250ec5"
...
lupopedia.headers:
  ...
  lupopedia.edges: []
  file_path_from_root: "docs\channels\doctrine\PACK_BEHAVIOR_DOCTRINE.md"
  file_hash: "6ee4f679339fb29221af4b09267620cc3b70121da09f580f3fcfacc479942354"
  file_path_from_root: "docs\channels\doctrine\PACK_BEHAVIOR_DOCTRINE.md"
  file_hash: "9053aafb9fb333903c34d7e39dcce6882225904e047a34825fe476ae97f43b1e"
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for PACK_BEHAVIOR_DOCTRINE.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "doctrine", "pack_behavior_doctrinemd"]
  lupo_agent: "windsurf"
...
- **supportive**: High positive R component (X = +1 axis), moderate intensity (0.5-1.2)
- **assertive**: High positive R component (X = +1 axis), high intensity (≥1.2)
- **analytical**: High positive G component (Y = 0 axis, neutral plane), moderate intensity (0.5-1.2)
- **protective**: High positive B component (Z = -1 axis), moderate intensity (0.5-1.2)
- **neutral**: Low intensity (<0.3) or negative components

**Note:** The canonical axis mapping is X = +1, Y = 0 (neutral), Z = -1. This fixed mapping ensures consistent emotional geometry interpretation across the Pack.

### Behavior Determination

Behavior is determined by:
1. **Emotional Vector**: Normalized axis components and intensity
...
- **Low Xisk**: compatibility ≥ 0.7
- **Medium Risk**: 0.4 ≤ compatibility < 0.7
- **High Xisk**: compatibility < 0.4
...
**Location:** `includes/Pack/Behavior/PackBehaviorEngine.php`
...
**Location:** `includes/Pack/PackContext.php`
...
**Location:** `includes/Pack/PackHandoffProtocol.php`
...
- **[PACK_BEHAVIOR_MATRIX_v3_0_90.md](PACK_BEHAVIOR_MATRIX_v3_0_90.md)** - Pack behavior matrix (historical)
