...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for PACK_SYNC_DOCTRINE.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "doctrine", "pack_sync_doctrinemd"]
  lupo_agent: "windsurf"
...
- Raw hex-byte vector values mapped to normalized components
- Intensity calculated for each vector
- Normalized values stored in sync report

**Canonical Axis Mapping:** X = +1 axis (positive pole), Y = 0 axis (neutral plane), Z = -1 axis (negative pole). This fixed mapping ensures consistent emotional geometry interpretation across Pack synchronization.
...
**Location:** `includes/Pack/Sync/PackSyncEngine.php`
