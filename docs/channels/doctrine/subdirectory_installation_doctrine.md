...
```php
// âœ… CORRECT
<link rel="stylesheet" href="<?php echo LUPOPEDIA_PUBLIC_PATH; ?>/includes/css/main.css">
<script src="<?php echo LUPOPEDIA_PUBLIC_PATH; ?>/includes/js/lupopedia.js"></script>

// âŒ WRONG
<link rel="stylesheet" href="/includes/css/main.css">
<script src="/includes/js/lupopedia.js"></script>
```
