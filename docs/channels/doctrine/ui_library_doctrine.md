...
lupopedia.headers:
  ...
  file_path_from_root: "docs/channels/doctrine/UI_LIBRARY_DOCTRINE.md"
  file_hash: "7f54ee227f7ff93e348adfabfda306faee7a8fe21ab2ad1a6bd0bbbe8698208b"
...
lupopedia.headers:
  ...
  lupopedia.edges: []
  file_path_from_root: "docs\channels\doctrine\UI_LIBRARY_DOCTRINE.md"
  file_hash: "662d8699cc7b4ff402ee0c2b070277791bad8b32b5452f39bb7e15422dacbff2"
  file_path_from_root: "docs\channels\doctrine\UI_LIBRARY_DOCTRINE.md"
  file_hash: "6ffc51e4ff19091d83bed49553a758673733cbe10fccd32ff86653457d8b6549"
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for UI_LIBRARY_DOCTRINE.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "doctrine", "ui_library_doctrinemd"]
  lupo_agent: "windsurf"
...
- ✅ Load them from the vendor JS folder (`/includes/js/`)
...
- Load from `/includes/js/jquery.js` (or similar)
...
- Load from `/includes/js/tinymce/` (or similar)
...
- Load from `/includes/js/dynlayer.js` (or similar)
...
These libraries will be placed in `/includes/js/` during UI migration:
...
<!-- DynLayer -->
<script src="/includes/js/dynlayer.js"></script>
```
...
- Libraries will be moved into `/includes/js/` during migration steps
...
5. ✅ Load libraries from `/includes/js/` when placed there
