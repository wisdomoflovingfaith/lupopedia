...
// File: includes/classes/agent-stats.php
class AgentStats {
...
// File: includes/classes/federationsync.php
...
```php
<?php
// File: includes/classes/agent-calculator.php
...
-- âŒ NEVER DO THIS
CREATE DEFINEX = 'root'@'localhost' PROCEDURE sync_data()
BEGIN
    -- ... logic ...
END;
```
