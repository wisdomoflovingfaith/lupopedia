...
lupopedia.headers:
  ...
  file_hash: "ab9404591690cc430e2f3d65c8eac48ccd53827f39262456f547afd11d30de5d"
...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for DIALOG_DOCTRINE.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "doctrine", "dialog_doctrinemd"]
  lupo_agent: "windsurf"
...
```
dialogs/
+-- changelog_dialog.md              # Default thread (MANDATORY)
+-- changelog_readme.md              # README-specific changes
+-- changelog_todo.md                # TODO and task tracking
+-- [specific_file]_dialog.md        # Dedicated file threads
+-- [topic_name]_dialog.md           # Topic-specific threads
+-- [component_name]_dialog.md       # Component-specific threads
```
...
```
agents/
+-- 15/  # Terminal AI slot 15
|   +-- agent.json
+-- 42/  # Terminal AI slot 42
|   +-- agent.json
...
**Mood Field (mood_vector):**
- **Format:** 6-character hex color (XXYYZZ) - MUST use `mood_vector` field name
...
- **Standard:** WOLFIE Header 3.1.6 standard requires `mood_vector` (not `mood`)
...
- **Use mood_vector** - Field name must be `mood_vector` (WOLFIE Header 3.1.6 standard)
...
**Target:** @everyone
**Mood_Vector:** 0066FF
**Message:** "Finalizing documentation before handoff to implementation team. UTC_TIMEKEEPEX: 20260119174500."
```
