...
lupopedia.headers:
  ...
  tags: ["docs", "channels", "doctrine", "wolfie_header_doctrinemd"]
  lupo_agent: "windsurf"
...
```yaml
file.lupopedia.UTC_TIMEKEEPEX: UTC_TIMEKEEPER  # OX: file.lupopedia.5: 5
```
...
```yaml
GOV-AD-PROHIBIT-001: true  # OX: file.lupopedia.gov_ad_prohibit_001: true
```
...
- **mood_vector** - Emotional context (6-character hex color)
...
- **dialog block** with new speaker, message, and mood_vector
