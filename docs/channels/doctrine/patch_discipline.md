...
lupopedia.headers:
  ...
  tags: ["docs", "channels", "doctrine", "patch_disciplinemd"]
  lupo_agent: "windsurf"
...
FILES: docs/auth/AUTH_SPEC.md, includes/auth/auth.php, database/auth_tables.sql
...
- Hand off to CURSOR: Implementation changes (includes/auth/auth.php)
