...
Routes are integrated in `includes/modules/module-loader.php` with priority:
1. AUTH (highest)
2. **HELP** (new)
3. **LIST** (new)
4. TRUTH
...
- Modules: `includes/modules/{module}/`
- Views: `includes/modules/{module}/views/`
