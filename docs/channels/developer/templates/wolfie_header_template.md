...
lupopedia.headers:
  ...
  file_path_from_root: "docs/channels/developer/templates/WOLFIE_HEADER_TEMPLATE.md"
...
dialog:
  ...
  mood_vector: "[HEX_COLOR]"  # Emotional tensor: strife/harmony/memory axes encoded as hex. NOT actual mood vectors.
...
dialog:
  ...
  mood_vector: "9900FF"  # Emotional tensor: strife (99=high), harmony (00=low), memory (FF=high). Hex encoding only.
  message: |
