...
lupopedia.headers:
  ...
  file_hash: "84b90dab418df260b1a57778cff643e64ca9233fdf15ef2a581a3383517311ae"
...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for COMPANY_REGISTRATIONS.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "appendix", "company_registrationsmd"]
  lupo_agent: "windsurf"
...
**Business Registration Number (SD filing ID):** UB313079  
**ID:** UB313079 (same as Business Registration Number)  
...
### Federal Registration Summary (Sanitized)

**Legal name:** Lupopedia LLC  
**Entity type:** Single-Member LLC (Disregarded Entity)  
**State of formation:** South Dakota  
**Formation date:** November 2025 (SD DBA filed 2025-11-06; see above)  
**Name control (IRS):** LUPO  

**Principal business activity:** Online Retail / Digital Support Tiers  
**Reason for EIN (application):** Started a new business  

**EIN status:** Assigned  
**Policy:** The **numeric EIN** and **IRS assignment letter** are stored **offline only**. They **MUST NOT** be committed to this repository, `config/global_atoms.yaml`, or any public artifact.

**Federal compliance posture (application attestations):**

| Topic | Status |
|-------|--------|
| W-2 employees | No |
| Excise tax (Form 720) | No |
| Gambling / wagering | No |
| Alcohol / tobacco / firearms | No |
| Heavy highway vehicles | No |

**Canonical atom (sanitized fields only):** `@GLOBAL.LUPOPEDIA_COMPANY_STRUCTURE` in `config/global_atoms.yaml`
...
The original PDF registration documents may be stored in the project repository at:
...
**Federal EIN letter:** **offline only** -- do **not** add IRS CP-575 / 147C or the EIN digits to the repo.

**Note:** The `docs/appendix/legal/` directory should be created and state PDF files should be placed there when available. None are checked in as of last doc update.
