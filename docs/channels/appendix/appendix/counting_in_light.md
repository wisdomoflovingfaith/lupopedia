...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/channels/appendix/appendix/counting_in_light.md
  web_path: https://www.lupopedia.com/lupopedia/docs/channels/appendix/appendix/counting_in_light.md
  status: ''
...
Counting‑in‑Light is the emotional coordinate system used across Lupopedia to encode tone, urgency, and emotional context into dialog messages, agent communication, and UI indicators. It maps message posture onto a three-axis vector stored in XXYYZZ hex-byte.
...
Canonical doctrine home now lives in `docs/doctrine/COUNTING_IN_LIGHT.md`.

Canonical current-runtime interpretation still lives in `docs/doctrine/MOOD_VECTOR_DOCTRINE.md`.
...
High X = "this needs attention now."
...
High Y = "this is supportive or calming."
...
High Z = "this matters beyond the moment."
...
- The stored value looks like a color because it uses `XXYYZZ`.
...
The `mood_vector` field in Inline Dialog uses this system:
...
- **COUNTING_IN_LIGHT Doctrine:** `docs/doctrine/COUNTING_IN_LIGHT.md` - Canonical doctrine-level axis explanation
- **MOOD VECTOR Doctrine:** `docs/doctrine/MOOD_VECTOR_DOCTRINE.md` - Mood color usage across agents
- **ROSE Doctrine:** `docs/doctrine/ROSE_DOCTRINE.md` - ROSE role boundaries and commentary responsibilities
- **DIALOG Agent Guide:** `agents/3/COUNTING_IN_LIGHT.md` - DIALOG-specific mood assignment guide
