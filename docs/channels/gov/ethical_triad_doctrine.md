...
file.name: "ETHICAL_TRIAD_DOCTRINE.md"
...
dialog:
  speaker: JETBRAINS
  target: @everyone
  message: "Created Ethical Triad Doctrine for governance doctrine coverage."
tags:
  categories: ["doctrine", "governance"]
  collections: ["core-docs", "governance"]
  channels: ["gov", "dev"]
file:
  title: "Ethical Triad Doctrine"
  description: "Defines the three ethical tests that every governance decision must satisfy."
...
Defines the three ethical tests that every governance decision must satisfy.
...
- Transparency: intent and impact are explicitly stated before action.
- Consent: affected actors retain informed choice and opt-out paths.
- Reciprocity: benefits flow to the user and system, not exploitation.
...
- ../doctrine/ETHICAL_FOUNDATIONS.md
