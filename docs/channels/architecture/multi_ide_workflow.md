...
lupopedia.headers:
  ...
  file_hash: "2e6535fda41f92e6bc006b18432fe3c8bc6f5a394db4e31e73a230e365d946db"
...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for multi-ide-workflow.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "architecture", "multi-ide-workflowmd"]
  lupo_agent: "windsurf"
...
Database (Source of Truth)
    |
    +-â†’ Toon Files (Distributed Truth)
    |       |
    |       +-â†’ Cursor (Fast Prototyping)
    |       |       +-â†’ Active Tab: New Features
    |       |
    |       +-â†’ Cascade (Legacy Integration)
    |       |       +-â†’ Active Tab: Legacy Code
    |       |
    |       +-â†’ JetBrains (Deployment)
    |       |       +-â†’ Active Tab: Git/VCS
    |       |
    |       +-â†’ Notepad++ (Precision Editing)
    |               +-â†’ Active Tab: Manual Regex
    |
    +-â†’ Changes Flow Back Up
            |
            +-â†’ Database Updated
                    |
                    +-â†’ Cycle Repeats
