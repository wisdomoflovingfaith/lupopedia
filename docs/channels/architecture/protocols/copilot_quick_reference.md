...
mood_vector         // Emotional coordinate (XXYYZZ)
...
- **Persona Agents (100+)** - Conversational (LILITH, ARA, agape (Survivability lens), etc.)
...
### What It Is
Emotional coordinate system using hex-byte vector values (XXYYZZ).
...
### Usage
- Dialog messages include `mood_vector` field
