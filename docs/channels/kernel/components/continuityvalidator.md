...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for ContinuityValidator.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "kernel", "components", "continuityvalidatormd"]
  lupo_agent: "windsurf"
...
```php
require_once 'includes/classes/ContinuityValidator.php';
...
```bash
php tests/ContinuityValidatorTest.php
```
