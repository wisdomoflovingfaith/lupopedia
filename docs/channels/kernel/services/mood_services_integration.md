...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for MOOD_SERVICES_INTEGRATION.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "kernel", "services", "mood_services_integrationmd"]
  lupo_agent: "windsurf"
...
COMMENT='Actor mood logging table for 2-actor mood vector model';
```
...
if ($mood) {
    ...
    echo "  X (Strife): {$mood['mood_r']}\n";
    echo "  Y (Harmony): {$mood['mood_g']}\n";
    echo "  Z (Memory): {$mood['mood_b']}\n";
...
function processSummaryAndLogMood(int $actorId, string $moodVectorHex, ActorMoodService $service): void
{
...
- `doctrine/EMOTIONAL_GEOMETRY_DOCTRINE.md` - Canonical 2-actor mood vector model
- `docs/appendix/COUNTING_IN_LIGHT.md` - RGB axis semantics
- `doctrine/deprecated/DEPRECATED_EMOTIONAL_GEOMETRY.md` - Legacy models

### 9.3 Database Schema
- `database/lupopedia/toon/actor_moods.toon` - TOON definition
