...
file:
  ...
  description: "Emotional mismatch detection between Mood Vector and ATP with CRF context analysis"
  version: "1.0.0"
  status: published
...
*Emotional mismatch detection between Mood Vector and ATP with CRF context analysis*

---

## 🟩 1. Purpose

The **Affective Discrepancy Engine** compares Mood Vector outputs with ATP clusters to detect emotional mismatch. This engine enables:
