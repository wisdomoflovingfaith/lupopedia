...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for DIALOG_SYSTEM_IMPLEMENTATION_PLAN.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "dialogs", "dev", "dialog_system_implementation_planmd"]
  lupo_agent: "windsurf"
...
### ✅ What EXISTS
1. **Core Classes** (all in `includes/`)
...
**Tasks:**
1. Create `includes/classes/pdo-db.php`
...
1. Create `api/dialog/send-message.php`
   - Accept POST with: `actor_id`, `content`, `mood_vector`, `to_actor`
...
**Tasks:**
1. Create `includes/classes/dialog-agent.php`
...
- **Option Z:** Quick start (minimum viable, ~90 minutes)
