...
lupopedia.headers:
  ...
  lupopedia.edges: []
  file_path_from_root: "docs\channels\dialogs\agents\INLINE_DIALOG_SPECIFICATION.md"
  file_hash: "5ec78280678ba1815324d9f0153177a0fa7b82a8f5f9a770c6e403bdd0acddd9"
  file_path_from_root: "docs\channels\dialogs\agents\INLINE_DIALOG_SPECIFICATION.md"
  file_hash: "466e82cb50726cf8ec48da778acb0613ac1bddd90d271396b5dfb2a25f5c1efc"
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for INLINE_DIALOG_SPECIFICATION.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "dialogs", "agents", "inline_dialog_specificationmd"]
  lupo_agent: "windsurf"
...
DIALOG:
  ...
  mood_vector: <XXYYZZ> (optional, Counting-in-Light mood color)
---
```
...
### **3.5 `mood_vector` (optional)**  
- Type: string (6-character hex color: XXYYZZ)  
...
- `mood_vector` â†’ `mood_vector` field (if provided)
...
function storeDialog(string $speaker, string $target, string $message, ?string $mood_vector = null): void {
    ...
    $db->insert('dialog_messages', [
        ...
        'mood_vector' => $mood_vector ?? '666666',
        'message_type' => 'text',
...
function updateFileHeaderDialog(string $filePath, string $speaker, string $target, string $message): void {
    ...
    if (isset($header['dialog'])) {
        storeDialog(
            ...
            $header['dialog']['mood_vector'] ?? null
        );
    }
...
- Both use the same dialog format (`speaker`, `target`, `message`, optional `date_ymdhis`, optional `mood_vector`)
