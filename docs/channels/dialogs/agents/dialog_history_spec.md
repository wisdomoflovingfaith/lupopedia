...
lupopedia.headers:
  ...
  file_path_from_root: "docs/channels/dialogs/agents/DIALOG_HISTORY_SPEC.md"
  file_hash: "343951839aa210385739a86b3ef37ddc4e82c7d9430b4f01a167e1774496c8ed"
...
lupopedia.headers:
  ...
  lupopedia.edges: []
  file_path_from_root: "docs\channels\dialogs\agents\DIALOG_HISTORY_SPEC.md"
  file_hash: "8df1f1e85f6fd54377f94091b12ec4117434a4e9bb97d37d9bbfbc214af5876e"
  file_path_from_root: "docs\channels\dialogs\agents\DIALOG_HISTORY_SPEC.md"
  file_hash: "c06c50c089dd69bf1a860f354f9e2347e6879eb997a055b6e05099b6f5b9bea5"
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for DIALOG_HISTORY_SPEC.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "dialogs", "agents", "dialog_history_specmd"]
  lupo_agent: "windsurf"
...
2. **Extract each block exactly as written**, including:
   ...
   - `mood_vector` â€” Counting-in-Light mood color (if present)
...
dialog:
  ...
  target: @CURSOR
  mood_vector: "00A0FF"
  message: Update CHANGELOG.md to include recent work: Inline Dialog Spec 3.0.0, Counting-in-Light Doctrine, mood_vector column, CHAR(6) philosophy, and WOLFIE Header updates.
---
