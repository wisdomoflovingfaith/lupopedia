...
lupopedia.headers:
  ...
  file_hash: "4aff9e34b35e20d922c21a55d9eb9644298e9b734f0574319ba621d1635e5fd4"
...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for DIALOG_SYSTEM_IMPLEMENTATION_COMPLETE.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "dialogs", "dialog_system_implementation_completemd"]
  lupo_agent: "windsurf"
...
RewriteEngine On
RewriteRule ^api/dialog/(.*)$ includes/Dialog/Api/DialogApi.php [L]
```
...
require_once 'includes/Dialog/Database/DialogDatabase.php';
require_once 'includes/Dialog/LLM/OpenAIProvider.php';
