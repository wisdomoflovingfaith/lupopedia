...
lupopedia.headers:
  ...
  file_path_from_root: "docs/channels/overview/versioning/4.2.1_hotfix_window.md"
...
- Emotional metadata (mood_vector) format fixes  
