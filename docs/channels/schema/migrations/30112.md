...
- `includes/Pack/PackRegistry.php` - Agent registration
- `includes/Pack/PackContext.php` - Context management
- `includes/Pack/PackHandoffProtocol.php` - Handoff coordination
...
- `includes/EmotionalGeometry/EmotionalGeometryEngine.php` - Core engine
...
- `includes/Pack/Behavior/PackBehaviorEngine.php` - Behavior engine
...
- `includes/Pack/Memory/PackMemoryEngine.php` - Memory engine
...
- `includes/Pack/Sync/PackSyncEngine.php` - Sync engine
