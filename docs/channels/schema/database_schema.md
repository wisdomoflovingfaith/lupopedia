...
1. **Toon Files** (`database/lupopedia/toon/*.toon` and `database/lupopedia/toon/*.json`)
   ...
   - Example: `database/lupopedia/toon/actors.toon` shows the complete structure of the `actors` table
