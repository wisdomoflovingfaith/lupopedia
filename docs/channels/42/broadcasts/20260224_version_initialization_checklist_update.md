...
lupopedia.headers:
  ...
  file_hash: "89def3849fbde95f1baaff1f28de1ea97fd6dc888fd37bad0fd91462b976b670"
...
flip.footer: {
  ...
  outbound_edges: [
    ...
    { to: "includes/functions/load_atoms.php", type: "documents", weight: 1.0, hashtag: "#atoms" },
...
3. install.php
4. **NEW:** includes/functions/load_atoms.php (line 58)
