...
lupopedia.headers:
  ...
  file_hash: "62df74c322b2f9fc7062272c9e9d3f760b6581584c21b7a63834a62faa1c949a"
...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for WOLFIE_HEADER_SPECIFICATION.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "agents", "wolfie_header_specificationmd"]
  lupo_agent: "windsurf"
...
**mood_vector** (Required)  
Emotional context expressed as a 6-character hexadecimal mood vector code. Examples: `"00FF00"` (green/positive), `"FF0000"` (red/urgent), `"0066FF"` (blue/informational)
...
- `mood_vector` MUST be a 6-character hex color (e.g., `"00FF00"`)  
...
file.lupopedia.UTC_TIMEKEEPEX: UTC_TIMEKEEPER
---
```
...
- **v3.1.6** (2026-01-19) â€” Canonical specification update  
  ...
  - Standardized dialog block format with `mood_vector` field (replaces `mood`)
