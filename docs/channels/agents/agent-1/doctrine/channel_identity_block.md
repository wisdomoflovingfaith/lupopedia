...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for CHANNEL_IDENTITY_BLOCK.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "agents", "agent-1", "doctrine", "channel_identity_blockmd"]
  lupo_agent: "windsurf"
...
- **Pole Z:** Second polar agent (agent_id)
...
**Note:** Emotional poles must map to valid agents in the emotional geometry doctrine. Each agent's mood is tracked per the MOOD_VECTOR_DOCTRINE.
...
- **[MOOD_VECTOR Doctrine](../../../doctrine/MOOD_VECTOR_DOCTRINE.md)** — Mood tracking specification
