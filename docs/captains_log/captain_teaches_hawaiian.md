...
## 3. Why Hawaiian Fixes the Problem
...
## 4. Why This Matters for Lupopedia
...
## Why Hawaiian Semantics Are NOT the Same as English Prompt Engineering
...
## The One Sentence That Will Click

> **Prompt engineering tries to control English.**  
> **Hawaiian semantics eliminates the parts of English that break AI.**
```

## The Accident (I Got Mad and Yelled in Hawaiian)
...
## One Word, One Job — The Danger Words

These are the words that break AI if interpreted in English. So I defined them explicitly.

### make
- Pidgin meaning: dead / deceased
- English false meaning: create

### pau
- Pidgin meaning: finished / done / complete
- English false meaning: pause

### choke
- Pidgin meaning: many / a lot
- English false meaning: choking

### bus’ up
- Pidgin meaning: broken / damaged
- English false meaning: “bus”

### ono
- Pidgin meaning: delicious / good
- English false meaning: “one‑oh”

### pilau
- Pidgin meaning: rotten / nasty (food context)
- Doctrine meaning: bad / corrupt / not good
- English false meaning: spoiled food

### huli
- Pidgin meaning: turn / flip
- English false meaning: Hulu

### holo
- Pidgin meaning: go / run
- English false meaning: hollow

### pau hana
- Pidgin meaning: after work / end of workday
- English false meaning: power hammer

### moke
- Meaning: big, tough local guy; enforcer type
- Replaces “kanak” to avoid confusion with “kanaka”

### kanak (deprecated)
- Meaning: bully, troublemaker, problem child
- Deprecated because it is too close to “kanaka”

### kanaka
- Meaning: person, human being, Native Hawaiian
- NOT slang

### beef
- Pidgin meaning: conflict, argument, trouble
- English false meaning: meat

### stink‑eye
- Pidgin meaning: glare, warning look
- English false meaning: smell / odor
...
## 🔥 HERMES Semantic Tokens (One Word, One Job)
...
### kumu
- source of truth
- where correct understanding comes from

### ohana
- all actors involved
- everyone in the handoff
...
### puka
- structural gap
- missing piece or absence

These are not labels. They are semantic contracts.

## ʻĀINA — Land. Physical Earth. Not a Metaphor.
...
## HAOLE — Context Gap, Not Identity
...
## 🔥 Hawaiian / Pidgin Temporal Operators (Workflow Modifiers)

**bumbye**
- Meaning: later / eventually
- Use: queue for later
