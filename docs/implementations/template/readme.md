...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/_template/README.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/_template/README.md"
  questions_toon: null
...
- Folder name: `{prd_file_stem}` — exact PRD basename without `.md` (e.g., `25_departments_system`)
...
lupopedia.headers:
  ...
  lupopedia.schema: implementation
  when_updated: "20260402000000"
  file_path_from_root: "docs/implementations/25_departments_system/feature.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/25_departments_system/feature.md"
  federation_node_id: 0
  channel_id: 42
...
lupopedia.edges:
  outbound_edges:
    - to: "docs/prd/25_departments_system.md"
      type: questions
      weight: 1.0
...
1. Copy this folder to `docs/implementations/{prd_file_stem}/` (folder name = PRD basename without `.md`; see **PRD 31**)
2. Update all headers with correct paths and parent PRD
3. Add implementation files as needed
4. Update `docs/implementations/README.md` index
