...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/{implementation_id}/questions/clarification/YYYYMMDD_HHIISS_QUESTION_title.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/{implementation_id}/questions/clarification/YYYYMMDD_HHIISS_QUESTION_title.md"
  questions_toon: null
