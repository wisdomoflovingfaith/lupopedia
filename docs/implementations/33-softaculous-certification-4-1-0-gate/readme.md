...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/33_softaculous_certification_4_1_0_gate/README.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/33_softaculous_certification_4_1_0_gate/README.md"
  questions_toon: null
...
| **`SOFTACULOUS_PACKAGE_BUILD.md`** | **FTP-safe zip/tar spec**, dotfile rules, validation checklist, **`scripts/build_softaculous_package.sh`** |
...
- **Backlog:** [docs/versions/4.0.94/TODO.md](../../versions/4.0.94/TODO.md)
