...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/implementations/validation_guide.md
  web_path: https://www.lupopedia.com/lupopedia/docs/implementations/validation_guide.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/validation-guide.toon
  atoms_toon: null
  transcript_jsonl: 0/development/validation-guide
  ...
  title: Five-Layer Documentation Validation Guide
  summary: Automated validation guide for Lupopedia Five-Layer Documentation Architecture compliance, schema validation, and implementation standards.
---
