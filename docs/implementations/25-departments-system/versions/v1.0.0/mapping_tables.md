...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/implementations/25-departments-system/versions/v1.0.0/mapping_tables.md
  web_path: https://www.lupopedia.com/lupopedia/docs/implementations/25-departments-system/versions/v1.0.0/mapping_tables.md
  status: ''
