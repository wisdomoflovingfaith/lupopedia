...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/16_lupopedia_headers/decisions/pseudocode/prd16_headers_lifecycle.pseudo.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/16_lupopedia_headers/decisions/pseudocode/prd16_headers_lifecycle.pseudo.md"
  questions_toon: null
...
**Canonical spec:** [`docs/prd/16_lupopedia_headers.md`](../../../../prd/16_lupopedia_headers.md)  
**Doctrine:** [`docs/doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_FORMAT.md`](../../../../doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_FORMAT.md), [`LUPOPEDIA_HEADERS_DOCTRINE.md`](../../../../doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_DOCTRINE.md), [`VALIDATORS_AND_TOOLING.md`](../../../../doctrine/LUPOPEDIA_HEADERS/VALIDATORS_AND_TOOLING.md)
...
- **`when_updated`**, **`last_modified_utc`**, footer **`last_verified`**: use **real UTC** via `python bin/tick.py`, then paste **`current_utc`** (14 digits) for the batch.
...
```text
python scripts/validate_lupopedia_headers_universal.py <path-to.md>
python scripts/validate_lupopedia_headers_universal.py <path-to.md> --check-links
```
...
```text
python scripts/validate_lupopedia_headers.py <path-to.md>
```

- Focused pass; shared patterns in `scripts/lib/header_validation.py`.
...
```text
python scripts/validate_lupopedia_headers_universal.py <path-to.md> --check-db
```
...
|------|-------------------|
| Validate file | `python scripts/validate_lupopedia_headers_universal.py <file.md>` |
| Validate + broken edge paths | `… <file.md> --check-links` |
| Validate + DB parity | `… <file.md> --check-db` |
| Import + sync | `python scripts/import_content.py <file.md>` (see script for `--write-back`, **`--append-history`**, DB env) |
| UTC for headers | `python bin/tick.py` — optional **`--copy`** copies **`current_utc`** to clipboard if **`pyperclip`** is installed |
| Sync implementation | `scripts/lib/header_db_sync.py` → **`sync_header_artifact_to_db`** |
