...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd_proposals/91_A-i_INTENT_ENCODING_DRAFT_v0_1_0.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd_proposals/91_A-i_INTENT_ENCODING_DRAFT_v0_1_0.md
  status: development
  when_updated: "20260816222312"
  trust_tier: development
  questions_toon: null
  memory_toon: memory/development/development/1026/08/91_a_intent_encoding_draft_v0_1_0.toon
  atoms_toon: memory/channels/atoms/lupopedia_global_constants.atom.toon
  transcript_jsonl: 0/development/prd-91-intent-encoding-v0-1-0
  artifact_type: prd
  ...
  prd_cluster: 91_A_90_A_01_A_98_A_16_C
  title: "SUPERSEDED: PRD 91 Intent Encoding Draft v0.1.0 baseline"
  summary: "Reviewed baseline Draft v0.1.0 preserved for review history. Do not implement from this file. Working draft is docs/prd/91_A-i_INTENT_ENCODING.md v0.1.1."
  edges_toon: null
...
lupopedia.identity:
  ...
  LUP.HEX: PRT.HEX.000001.000035.000000.ROOT.EN.000100
  LUP.SHORT: PRT.LUP
...
lupopedia.map:
  index: PRT.HEX.000001.000035.000000.ROOT.EN.000100
  web_path: https://www.lupopedia.com/lupopedia/docs/prd_proposals/91_A-i_INTENT_ENCODING_DRAFT_v0_1_0.md
  path_from_lupopedia_root: docs/prd_proposals/91_A-i_INTENT_ENCODING_DRAFT_v0_1_0.md
  prd_cluster: 91_A_90_A_01_A_98_A_16_C
  edges_toon: null
...
---
# SUPERSEDED: PRD 91 Draft v0.1.0 baseline

This file is preserved for review history. Do not implement from this file.

**Working draft:** `docs/prd/91_A-i_INTENT_ENCODING.md` (Draft v0.1.1)

The original reviewed title and body follow unchanged.

# PRD 91 - Intent Encoding Doctrine

Version: Draft v0.1.0
Status: Development proposal - noncanonical
Date: 2026-08-16
Proposed authority: Lupopedia constitutional doctrine
Final authority: Eric Robin Gerdes / Captain Wolfie
PRD number: Provisionally reserved pending registry verification
...
PRD 91 introduces no new mandatory Lupopedia header fields in Draft v0.1.0. A future header reference must be justified separately and must not duplicate the full Intent Contract in every file.
...
- formalize W0LFIE through W9LFIE selectors
