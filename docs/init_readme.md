...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/init_readme.md
  web_path: https://www.lupopedia.com/lupopedia/docs/init_readme.md
  status: ''
...
1. **LUPOPEDIA HEADERS** — [docs/doctrine/LUPOPEDIA_HEADERS/README.md](doctrine/LUPOPEDIA_HEADERS/README.md), [LUPOPEDIA_HEADERS_FORMAT.md](doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_FORMAT.md)  
...
2. **Lupopedia Versioning Doctrine** — [docs/doctrine/VERSIONING_DOCTRINE.md](doctrine/VERSIONING_DOCTRINE.md)  
...
3. **Directory and project structure** — [README.md](../../README.md) (project root), [docs/README.md](../../README.md)  
   Where init-related and doctrine files live. **Why:** Required before adding or moving init-controlled artifacts.

4. **Agent & Faucet Doctrine** — [docs/doctrine/ActorFaucetOntology.md](doctrine/ActorFaucetOntology.md), [docs/doctrine/FAUCET_TRACEABILITY_DOCTRINE.md](doctrine/FAUCET_TRACEABILITY_DOCTRINE.md)  
...
5. **Semantic graph & collections** (recommended) — [docs/channels/doctrine/SEMANTIC_GRAPH_DOCTRINE.md](channels/doctrine/SEMANTIC_GRAPH_DOCTRINE.md), [docs/doctrine/COLLECTIONS_DOCTRINE.md](doctrine/COLLECTIONS_DOCTRINE.md)  
...
For the authoritative list, rationale, and definition of `lupopedia.init`, see **[docs/doctrine/init/LUPO_INITIALIZATION_DOCTRINE.md](doctrine/init/LUPO_INITIALIZATION_DOCTRINE.md)**.
