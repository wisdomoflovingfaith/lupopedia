...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.2/TODO.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.2/TODO.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/version-4-1-2-todo.toon
  atoms_toon: null
...
- [ ] **P0-Z: API Endpoints** — `/api/routing/send-to-channel`, `/api/context/switch`, `/api/agent/status`.
...
- **Changelog Consolidation:** Successfully merged 35 pending Markdown fragments (2026-04-16 to 2026-04-17) into `docs/versions/4.1.2/CHANGELOG.md` using a new 10-minute temporal merge rule.
