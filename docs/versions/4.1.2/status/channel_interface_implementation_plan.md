...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.2/status/channel_interface_implementation_plan.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.2/status/channel_interface_implementation_plan.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/channel-interface-implementation-plan.toon
  atoms_toon: null
...
**Source artifacts:**
- Blog: `content/federation_node/0/captains_log/20260415_the_stickynote_interface.md`
- PRD 02 (updated): `docs/prd/02_channels_discussions.md`
- Gap analysis: `docs/versions/4.1.2/status/auggie_sticky_note_channel_review.md`
- Q&A: `docs/versions/4.1.2/status/questions_answers.md`
- Open questions: `docs/versions/4.1.2/status/open_questions.md`
...
**Output:** SQL migration files in `database/lupopedia/mysql/`.
...
**Files:** `database/lupopedia/mysql/migrations/4_1_2_orchestration_tables.sql`
**Validation:** Run against dev DB; confirm table count within PRD 99 limits.

### P0-Z: API Endpoints (new)
...
**Files:** `api/routing/`, `api/context/`, `api/agent/`, `api/scratchpad/`
...
| Left panel HTML | Add `<div class="left-panel">` with actors/files/tasks | All existing CSS |
| Target Actor Tabs | Add `<div class="active-target-bar">` above input | CSRF, AJAX poll |
