...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.2/status/session_closeout_report_20260415_1912.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.2/status/session_closeout_report_20260415_1912.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/version-4-1-2-session-closeout-report-20260415-1912.toon
  atoms_toon: null
...
- **Observed issue:** initial edge imports reported unresolved targets for outbound paths like `docs/versions/4.1.2/README.md`.
...
- **Ambiguity Z:** whether edge targets should resolve via `lupo_contents` only or via memory sidecars first.
