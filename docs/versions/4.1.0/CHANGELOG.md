...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.0/CHANGELOG.md
...
**What changed:**
- Added `CANONICAL_YEAX = "1026"` constant to `header_spec_v3_1.py` with trust-ladder arithmetic docstring
