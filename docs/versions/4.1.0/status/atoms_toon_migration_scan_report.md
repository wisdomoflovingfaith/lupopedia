...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.0/status/atoms_toon_migration_scan_report.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.0/status/atoms_toon_migration_scan_report.md
  status: active
...
- `docs/versions/4.0.99/status/open_questions.md` (OQ-39, logged this session)
...
All PRD files under `docs/prd/` that contain a Lupopedia header with `module:` in the header zone.
...
|------|------------------------|-----------------|
| `docs/prd/00_root_constitutional_system_requirements.md` | `"constitution"` | Set `atoms_toon: null` (string is NOT a `.atoms.toon` path) |
| `docs/prd/08_core_agents_system.md` | `"agents"` | Set `atoms_toon: null` |
| `docs/prd/43_parent_child_trust_ladder.md` | `"architecture"` | Set `atoms_toon: null` |
| `docs/prd/81_agent_orchestration_chat.md` | `"orchestration"` | Set `atoms_toon: null` |
| `docs/prd/99_limits_for_everything_and_why.md` | `"governance"` | Set `atoms_toon: null` |
| `docs/prd/decisions/pseudocode/02_channels_discussions_constitutionpseudo.md` | `"orchestration"` | Set `atoms_toon: null` |
...
All files under `docs/doctrine/` that contain a Lupopedia header with `module:`.
...
`scripts/lib/header_validation.py`
...
- `scripts/validate_lupopedia_headers_universal.py` — L1451, L2038 (code refs)
- `scripts/validate_lupopedia_headers.py` — L52 field list, L143 empty-string check
- `scripts/new_validate_lupopedia_headers_universal.py` — L116, L129 field order list
- `scripts/add_lupopedia_header_to_file.py` — L24, L217, L297 (template emits `module: null`)
- `scripts/audit_namespace_headers.py` — L63 (code ref)
...
- `agents/thoth/system_prompt.txt` or similar — scan detected 1 agent file with `module:` in header zone

### 2G. Historical Version Artifacts (historical_version_artifact) — 44 files

Files under `docs/versions/` (excluding 4.1.0/ which is new).

**Non-null `module` in historical:**
- `docs/versions/4.0.99/status/session_report_20260412_collections_architecture_cascade.md`: `"status"` — intentional historical record
...
- `docs/prd/` (120 files)
- `docs/doctrine/` (208 files)
- `scripts/` (script own-headers only, not code body)
...
- `scripts/audit_namespace_headers.py`
- `docs/prd/16_lupopedia_headers.md` (body text + examples)
- `docs/doctrine/lupopedia-headers/lupopedia_headers_format.md` (body text + examples)
- `docs/doctrine/lupopedia-headers/validators_and_tooling.md`
- `.cursor/rules/lupopedia-headers-mandatory.mdc`
...
| File / Path | Reason |
|-------------|--------|
| `docs/versions/4.0.99/` (44 files) | Historical version artifacts — frozen records |
| `docs/archive/` (if present) | Archive — must not be rewritten |
| `memory/` (TOON files) | JSON sidecars — do not have YAML header zone |
| `scripts/audit_toon_reserved_words.py` | References `"module"` as a reserved word name, not a field reference |
