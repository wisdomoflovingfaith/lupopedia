...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.0/status/atoms_toon_migration_change_report.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.0/status/atoms_toon_migration_change_report.md
  status: complete
...
## Phase 1 — PRD 16 Spec Update (`docs/prd/16_lupopedia_headers.md`)
...
**Created:** `docs/doctrine/lupopedia-headers/atoms_toon_schema.md`
...
**Script:** `scripts/migrate_module_to_atoms_toon.py` (new, ~170 lines)
...
| File | Old value |
|------|-----------|
| `docs/prd/00_root_constitutional_system_requirements.md` | `module: "constitution"` |
| `docs/prd/08_core_agents_system.md` | `module: "agents"` |
| `docs/prd/43_parent_child_trust_ladder.md` | `module: "architecture"` |
| `docs/prd/81_agent_orchestration_chat.md` | `module: "orchestration"` |
| `docs/prd/99_limits_for_everything_and_why.md` | `module: "governance"` |
| `docs/prd/decisions/pseudocode/02_channels_discussions_constitutionpseudo.md` | `module: "orchestration"` |
...
- `docs/versions/**` (status, open_questions — manually updated)
- `scripts/*.py` without Lupopedia headers (tools, helpers, PHP, SQL)
- `agents/*/system_prompt.txt` (most skipped — no `module:` in header zone)
