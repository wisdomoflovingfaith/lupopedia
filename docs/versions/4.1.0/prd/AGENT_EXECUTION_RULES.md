...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.0/prd/AGENT_EXECUTION_RULES.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.0/prd/AGENT_EXECUTION_RULES.md
  status: active
