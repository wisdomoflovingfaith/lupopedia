...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.3/DATABASE_SEED_DEPENDENCIES.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.3/DATABASE_SEED_DEPENDENCIES.md
  status: development
  when_updated: '20260513033046'
  trust_tier: development
  questions_toon: null
  memory_toon: memory/database/development/1026/04/database-seed-dependencies-md.toon
  atoms_toon: null
