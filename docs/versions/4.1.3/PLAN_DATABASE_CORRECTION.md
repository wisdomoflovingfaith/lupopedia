...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.3/PLAN_DATABASE_CORRECTION.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.3/PLAN_DATABASE_CORRECTION.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/database/canonical/1026/04/database-correction-plan.toon
  atoms_toon: null
...
======================================================================
   ...
   Issues: See docs/versions/4.1.3/DATABASE_IMPORT_AUDIT.md
====================================================================== */
```
...
**Files**:
- `docs/versions/4.1.3/todo.md` (already done)
- `docs/versions/4.1.3/plan.md`
