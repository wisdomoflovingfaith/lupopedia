...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.3/status/channels-interface-implementation-status.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.3/status/channels-interface-implementation-status.md
  status: active
...
**PRD reference:** `docs/prd/02_channels_discussions.md` (v4.1.3)
**Date:** 2026-04-17
...
Row 1, Col 1 : #feed           (message feed + feed-top nav)
...
**Historical reference:** `archive/legacy/craftysyntax-3.7.5/admin_chat_bot.php`
