...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.3/status/updated_installer_screens.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.3/status/updated_installer_screens.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/registry/status/1026/04/actor-registration-and-sync-report.toon
  atoms_toon: null
...
<div class="step-container">
    ...
    <p class="step-description">
        Scanning the actors/ directory to register all filesystem actors in the database.
...
$(document).ready(function() {
    const actors = [
        {id: 0, name: 'system', memoryPath: 'memory/actors/0/', quota: 500},
        {id: 1, name: 'wolfie', memoryPath: 'memory/actors/1/', quota: 500},
        {id: 2, name: 'lilith', memoryPath: 'memory/actors/2/', quota: 500},
        // ... all actors
    ];
...
<div class="form-section">
    ...
    <div class="form-group">
        ...
        <input type="text" id="memory_base_path" name="memory_base_path" 
               value="<?php echo LUPOPEDIA_PATH; ?>/memory" 
               class="form-control">
    ...
    <div class="form-group">
        ...
        <input type="text" id="handoff_base_path" name="handoff_base_path" 
               value="<?php echo LUPOPEDIA_PATH; ?>/handoffs" 
               class="form-control">
