...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.3/status/actor_rebuild_plan.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.3/status/actor_rebuild_plan.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/registry/status/1026/04/actor-rebuild-plan.toon
  atoms_toon: null
...
function configureMemoryPaths($actor_id, $actor_name) {
    $memory_path = LUPOPEDIA_PATH . "/memory/actors/{$actor_id}/";
    $handoff_path = LUPOPEDIA_PATH . "/handoffs/{$actor_name}/";
...
|----------|------|---------|------|-------------|
| 0 | system | 0 | System Kernel | memory/actors/0/ |
| 1 | wolfie | 0,42 | Captain | memory/actors/1/ |
| 2 | lilith | 51 | Constitutional Auditor | memory/actors/2/ |
| 3 | rose | 42 | Dialogue Specialist | memory/actors/3/ |
| 9 | anubis | 0,42,666 | Custodian | memory/actors/9/ |

### IDE Agents (100-115)
| Actor ID | Name | Channel | Role | Memory Path |
|----------|------|---------|------|-------------|
| 100 | kiro | 42 | IDE Faucet | memory/actors/100/ |
| 101 | windsurf | 42 | IDE Faucet | memory/actors/101/ |
| 102 | cursor | 42 | IDE Faucet | memory/actors/102/ |
| 105 | cascade | 42 | IDE Faucet | memory/actors/105/ |

### Specialized Agents (700+)
| Actor ID | Name | Channel | Role | Memory Path |
|----------|------|---------|------|-------------|
| 703 | asclepius | 42 | Medical | memory/actors/703/ |
| 704 | apollo | 42 | Creative | memory/actors/704/ |
| 705 | agape | 42 | Emotional | memory/actors/705/ |
...
2. **Filesystem Verification**
   - Verify actors/ directory structure
