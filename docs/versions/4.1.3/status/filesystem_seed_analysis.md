...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.3/status/filesystem_seed_analysis.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.3/status/filesystem_seed_analysis.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/registry/status/1026/04/filesystem-seed-analysis.toon
  atoms_toon: null
  ...
  summary: Analysis of agents/ directory structure and configurations for 4.1.3 seed generation
---
...
From `database/lupopedia/actors/actor_id/registry.json`:
...
VALUES
(0, 'system', 'system', 'System', 'system', 'system', 'memory/actors/0/', 'handoffs/system/', ...),
(1, 'wolfie', 'captain', 'Captain', 'system', 'captain', 'memory/actors/1/', 'handoffs/wolfie/', ...),
-- ... all 47 actors
```
...
1. Scan agents/ directory for all agents
