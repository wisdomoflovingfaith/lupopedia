...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.3/todo.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.3/todo.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/version-4-1-3-todo.toon
  atoms_toon: null
  ...
  summary: PRD-first dependency graph A to E for 4.1.3 Crafty 3.7.5 live-help parity; F reserved for 4.1.5+ orchestration. Layer A ASCII audit via scripts/sanitize_ascii.py --fix.
---
lupopedia.edges:
  outbound_edges: []
...
# TODO -- Lupopedia Dependency Chain (Target: Stable by June 1, 2026) (CLOSED)

**Scope of 4.1.3:** Minimal stable Crafty Syntax 3.7.5 live-help parity + clean substrate.  
Multi-AI orchestration starts in 4.1.5+.
...
A -> B -> C -> D -> E   (4.1.3 ends here)  
          v  
          F   (Multi-AI Orchestration - 4.1.5+)
...
- `database/lupopedia/mysql/install/install_new_lupopedia.sql` (canonical DDL)
- `database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql` (import script)
- `database/lupopedia/mysql/import/old_crafty_syntax_3_7_5_start.sql` (legacy schema)
- `docs/prd/13_crafty_integration.md` (integration specification)
...
## F - Multi-AI Orchestration (Real Lupopedia Power - 4.1.5+)
...
- The Micro-PRD "Prompt as Artifact (Deferred to 4.1.5+)" is noted and will be the first major item in F.
- High-priority unblocked items right now: Layer A, especially running `python scripts/sanitize_ascii.py --fix` across the repo and completing the PRD 02 finalization + header audit.

Migration sequencing documented and locked. Next phase: Blog only. No further database import or migration work.

---

## REMINDER: For 4.1.5+ development, you can:
