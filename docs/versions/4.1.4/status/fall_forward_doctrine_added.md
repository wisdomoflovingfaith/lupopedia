...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.4/status/fall_forward_doctrine_added.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.4/status/fall_forward_doctrine_added.md
  status: active
