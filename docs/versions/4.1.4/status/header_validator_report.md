...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.4/status/header_validator_report.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.4/status/header_validator_report.md
  status: active
