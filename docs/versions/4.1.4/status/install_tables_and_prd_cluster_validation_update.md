...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.4/status/install_tables_and_prd_cluster_validation_update.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.4/status/install_tables_and_prd_cluster_validation_update.md
  status: active
