...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.4/status/prd_55_workflow_model_created.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.4/status/prd_55_workflow_model_created.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/prd-55-workflow-model-created.toon
  atoms_toon: null
...
**Created:** `docs/prd/55_A_WORKFLOW_AND_CHECKPOINT_MODEL.md`  
