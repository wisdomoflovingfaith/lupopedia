...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.4/status/pk_naming_fix_for_missing_install_tables.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.4/status/pk_naming_fix_for_missing_install_tables.md
  status: active
