...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.4/status/db_mutation_control_and_alignment_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.4/status/db_mutation_control_and_alignment_doctrine.md
  status: active
