...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.4/status/GEMINI_SOLVED_AGAPE_GOLD_STAR.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.4/status/GEMINI_SOLVED_AGAPE_GOLD_STAR.md
  status: active
