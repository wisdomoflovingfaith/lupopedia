...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.1.5/patches/20260421_prd49_critical_fixes.sql"
  web_path: "https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/patches/20260421_prd49_critical_fixes.sql"
  status: "active"
  ...
  summary: "ALTER TABLE patch for 5 blocking defects in truth tables + 2 constitutional fixes in crafty_user_mapping. Unblocks May 1 Crafty Syntax delivery. Apply against a fresh install OR a live 4.1.5 dev database."
*/

-- ============================================================
-- PATCH: PRD 49 Critical Fixes -- 2026-04-21
-- Target version: Lupopedia 4.1.5
-- Apply to: fresh install_new_lupopedia.sql OR live 4.1.5 dev DB
...
-- ============================================================
-- END OF PATCH
-- After applying: run php bin/memory.php load-context
--                 and python bin/pending.py --actor 116 --check
-- ============================================================
