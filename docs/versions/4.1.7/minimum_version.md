# Lupopedia 4.1.7 Minimum Version Target
...
- All PRD files carry valid 4.1.7 headers (22 fields, locked format).
...
- Softaculous certification gate (PRD 33) -- post-4.1.7.
...
This document defines the ceiling for 4.1.7 scope.
