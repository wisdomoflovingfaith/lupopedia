...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.0.99/status/missing_table_analysis.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.0.99/status/missing_table_analysis.md
  status: null
...
| JSON schema dir (`database/lupopedia/json/`) | **178** | `Get-ChildItem *.json \| Measure-Object` |
...
| `includes/classes/DialogMvpService.php` | ✅ Referenced | `updateReadLog()` method (line 487) writes to this table |
...
`DialogMvpService::updateReadLog()` in `includes/classes/DialogMvpService.php` (line 477):
...
| Create `database/lupopedia/json/lupo_dialog_read_log.json` schema file | Dev | HIGH |
...
- `docs/versions/4.0.99/status/open_questions.md` — OQ-04
- `docs/versions/4.0.99/status/claude_database_table_review.md` — §2.5
- `includes/classes/DialogMvpService.php` — `updateReadLog()` method
- `database/lupopedia/mysql/install/install_new_lupopedia_clean.sql` — line 2156 (source of truth for schema)
- `database/lupopedia/mysql/install/install_new_lupopedia.sql` — canonical installer (needs update)
