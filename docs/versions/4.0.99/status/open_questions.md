...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.0.99/status/open_questions.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.0.99/status/open_questions.md
  status: active
...
* WHEN: 20260413000000
* WHO: Actor 116
* FILE / AREA: database/lupopedia/json/lupo_dialog_recent_files.json
* TYPE: open_question
* SEVERITY: blocking
* STATUS: resolved
...
* WHEN: 20260413000000
* WHO: Actor 116
* FILE / AREA: database/lupopedia/json/lupo_dialog_pending_tasks.json
* TYPE: open_question
* SEVERITY: blocking
* STATUS: resolved
...
* WHEN: 20260413000000
* WHO: Actor 116
* FILE / AREA: database/lupopedia/json/lupo_dialog_read_log.json
...
* WHEN: 20260414153000
* WHO: Actor GEMINI
* FILE / AREA: `includes/classes/pdo_db.php` / `prepareParams()`
* TYPE: critical_bug
* SEVERITY: blocking
* STATUS: resolved
...
* FILE / AREA: `includes/modules/crafty_syntax/livehelp.php`, `visitor-image.php`, `visitor-chat-stream.php`
* TYPE: implementation_note
* SEVERITY: blocking
* STATUS: resolved
* RELATED TO: OQ-05
...
* WHEN: 20260414120000
* WHO: Actor CLAUDE_CODE
* FILE / AREA: `includes/classes/pdo_db.php` / `DialogMvpService::createDialogMessage()`
...
* WHY: Column mismatches cause silent send failures. The correct column list must be verified against `database/lupopedia/json/lupo_dialog_messages.json`. There is currently no build-time validation.
...
* WHEN: 20260414120000
* WHO: Actor CLAUDE_CODE
* FILE / AREA: `api/dialog/fetch-messages.php`
* TYPE: open_question
* SEVERITY: important_non_blocking
* STATUS: resolved
...
* WHEN: 20260414120000
* WHO: Actor CLAUDE_CODE
* FILE / AREA: `docs/prd/32_actor_authority_agent_roles.md` vs `includes/classes/DialogMvpService.php`
* TYPE: ambiguity
* SEVERITY: important_non_blocking
* STATUS: resolved
...
* WHEN: 20260414120000
* WHO: Actor CLAUDE_CODE
* FILE / AREA: `docs/prd/32_actor_authority_agent_roles.md` sec. 2.3.2 / `docs/doctrine/AGENT_REGISTRY.md`
* TYPE: open_question
* SEVERITY: future_improvement
* STATUS: resolved
...
* WHEN: 20260414160000
* WHO: VS_CODE
* FILE / AREA: docs/prd/00_root_constitutional_system_requirements.md, docs/prd/16_lupopedia_headers.md
* TYPE: implementation_note
* SEVERITY: important_non_blocking
* STATUS: new
...
* WHEN: 20260414160000
* WHO: VS_CODE
* FILE / AREA: docs/prd/32_actor_authority_agent_roles.md, DialogMvpService.php
* TYPE: ambiguity
* SEVERITY: important_non_blocking
* STATUS: resolved
...
* WHEN: 20260414160000
* WHO: VS_CODE
* FILE / AREA: includes/classes/DialogMvpService.php, database/lupopedia/json/lupo_dialog_messages.json
* TYPE: schema_improvement
* SEVERITY: important_non_blocking
* STATUS: resolved
...
* WHEN: 20260414153000
* WHO: ARA
* FILE / AREA: docs/prd/02_channels_discussions.md + duplicate PRD 81 and 88 files
* TYPE: ambiguity
* SEVERITY: important_non_blocking
* STATUS: resolved
...
* WHEN: 20260414153500
* WHO: ARA
* FILE / AREA: docs/prd/32_actor_authority_agent_roles.md vs DialogMvpService.php + channels/index.php
* TYPE: ambiguity
* SEVERITY: important_non_blocking
* STATUS: resolved
...
* WHEN: 20260414154000
* WHO: ARA
* FILE / AREA: api/dialog/fetch-messages.php (see also OQ-12, OQ-19)
* TYPE: schema_improvement
* SEVERITY: important_non_blocking
* STATUS: resolved
* RESOLUTION (20260414000000): Resolved by OQ-12 fix (same root; merged). See OQ-12 resolution.
...
* WHEN: 20260414154200
* WHO: ARA
* FILE / AREA: includes/classes/DialogMvpService.php + lupo_dialog_messages TOON/JSON
* TYPE: schema_improvement
* SEVERITY: important_non_blocking
* STATUS: resolved
...
* WHEN: 20260414154700
* WHO: ARA
* FILE / AREA: scripts/validate_lupopedia_headers_universal.py + onboarding flow
* TYPE: implementation_note
* SEVERITY: important_non_blocking
* STATUS: new
...
* WHEN: 20260414220000
* WHO: Auggie
* FILE / AREA: `agents/rose/capabilities.json` /
  `docs/prd/36_rose_multi_persona_synthetic_dialog.md`
* TYPE: schema_improvement
* SEVERITY: important_non_blocking
* STATUS: resolved
* RESOLUTION (20260414000000): Added `"memory_graph_query"` and `"transcript_fetch"` to `agents/rose/capabilities.json`. Bumped `schema_version` to `"4.0.99"` and `when_updated_utc` to `"20260414000000"`.
...
* WHEN: 20260414220000
* WHO: Auggie
* FILE / AREA: `channels/index.php` (memory browser tab) / `docs/prd/02_channels_discussions.md`
  §Memory Browser
* TYPE: implementation_note
* SEVERITY: important_non_blocking
* STATUS: new
...
* IDEAL FUTURE CHANGE: Implement the memory browser tab in `channels/index.php`: read from
  ...
  `api/memory/browse.php`.
* CAN WORK CONTINUE: yes
---
## OQ-29: major_agents_manifest.json still uses numeric agent_dirs (should be slug-based)
* WHEN: 20260414220000
* WHO: Auggie
* FILE / AREA: `database/lupopedia/actors/major_agents_manifest.json`
* TYPE: schema_improvement
* SEVERITY: important_non_blocking
* STATUS: resolved
* RESOLUTION (20260414000000): File already had slug-based `agent_dir` values when audited (`"agents/wolfie"`, `"agents/rose"`, etc.). The JSON's own `notes` field confirms: "All agent_dirs corrected to slug-based paths (numeric dirs were stale)." `schema_version` is already `"4.0.99"`. No action required.
...
* WHEN: 20260414220000
* WHO: Auggie
* FILE / AREA: `database/lupopedia/actors/registry.json`
* TYPE: schema_improvement
* SEVERITY: important_non_blocking
* STATUS: resolved
* RESOLUTION (20260414000000): `database/lupopedia/actors/registry.json` was already at `"schema_version": "4.0.99"`. Audit found `database/lupopedia/projects/registry.json` at `"4.0.77"` — bumped to `"4.0.99"`. Added `"schema_version": "4.0.99"` to `channels/registry.json` (field was absent). Per-actor data files under `database/lupopedia/actors/actor_id/` have older versions but are individual actor snapshots; those are not seed registry files and out of scope for this fix.
* WHAT: `actors/registry.json` declares `"schema_version": "4.0.69"`. The current platform version is
  `4.0.99` (per `config/global_atoms.yaml` and all active PRD headers). The registry is a seed artifact
...
* WHEN: 20260414220000
* WHO: Auggie
* FILE / AREA: `memory/development/staging/2026/04/16_lupopedia_headers.toon` /
...
* IDEAL FUTURE CHANGE: Add PRD 16 to a "high-authority maintenance list" that is checked during every memory
  graph audit run. Any new doctrine file under `docs/doctrine/LUPOPEDIA_HEADERS/` should automatically
...
* WHAT: The file opens with `lupopedia.headers:` on line 1 and `lupopedia.footer:` on line 2 (consecutive,
  ...
  `memory_key` points to `memory/development/canonical/1026/04/chronological-trust-ladder.toon`
...
* WHEN: 20260414220000
* WHO: Auggie
* FILE / AREA: `memory/development/staging/2026/04/` (all 66 active PRD TOONs)
* TYPE: ambiguity
* SEVERITY: future_improvement
* STATUS: new
...
FILE / AREA: `docs/doctrine/` (all doctrine .md files); `memory/development/canonical/1026/04/`
...
IDEAL FUTURE CHANGE: Run the same memory_key audit against `docs/doctrine/*.md` that was run
...
FILE / AREA: `docs/prd/81_agent_orchestration_chat.md`;
`memory/development/staging/2026/04/81_agent_orchestration_chat.toon`
...
* FILE / AREA: `scripts/rename_last_modified_to_questions_toon.py` / all `docs/prd/*.md`
* TYPE: implementation_note
* SEVERITY: important_non_blocking
* STATUS: resolved
...
* WHEN: 20260415050000
* WHO: Auggie (Actor 116)
* FILE / AREA: `scripts/validate_lupopedia_headers_universal.py` — required-fields loop (~line 1456)
* TYPE: implementation_note
* SEVERITY: important_non_blocking
* STATUS: resolved
...
* WHEN: 20260414000000
* WHO: Claude Code (Actor 116)
* FILE / AREA: `for_claude.md`, `docs/prd/16_lupopedia_headers.md`, `agents/thoth/`, `database/lupopedia/json/lupo_atoms.json`
* TYPE: open_question
...
* FILES FLAGGED:
  1. `docs/prd/00_root_constitutional_system_requirements.md` — `module: "constitution"`
  2. `docs/prd/08_core_agents_system.md` — `module: "agents"`
  3. `docs/prd/43_parent_child_trust_ladder.md` — `module: "architecture"`
  4. `docs/prd/81_agent_orchestration_chat.md` — `module: "orchestration"`
  5. `docs/prd/99_limits_for_everything_and_why.md` — `module: "governance"`
  6. `docs/prd/decisions/pseudocode/02_channels_discussions_constitutionpseudo.md` — `module: "orchestration"`
