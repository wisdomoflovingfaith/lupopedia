...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.0.99/status/lupopedia_header_review.md
...
**P0-Z: Fix `web_path` to use `https://` across all 66 PRDs**
...
**P1-Z: Upgrade 21 PRDs from 4.0.98 → 4.0.99**
...
**P2-Z: Add sidecar filename convention note to PRD 16**
...
- [ ] P0-Z: PRD 16 itself passes its own validator
...
- [ ] P1-Z: JSONL post-freeze writes stopped
