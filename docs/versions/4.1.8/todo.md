...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.8/todo.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.8/todo.md
  status: active
  when_updated: '20260516003658'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/federation_interpreter_rules.toon
  atoms_toon: null
  transcript_jsonl: 0/development/version-4-1-8-todo
  ...
  prd_cluster: 00_A
  title: Lupopedia 4.1.8 TODO (carried from 4.1.7)
  summary: Backlog carried from docs/versions/4.1.7/todo.md; new federation_nodes PHP validator TODO appended.
---
