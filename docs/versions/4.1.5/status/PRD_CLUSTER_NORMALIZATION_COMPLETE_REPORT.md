...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/PRD_CLUSTER_NORMALIZATION_COMPLETE_REPORT.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/PRD_CLUSTER_NORMALIZATION_COMPLETE_REPORT.md
  status: active
