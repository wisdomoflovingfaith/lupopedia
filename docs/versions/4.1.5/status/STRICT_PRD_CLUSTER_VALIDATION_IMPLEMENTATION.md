...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/STRICT_PRD_CLUSTER_VALIDATION_IMPLEMENTATION.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/STRICT_PRD_CLUSTER_VALIDATION_IMPLEMENTATION.md
  status: active
