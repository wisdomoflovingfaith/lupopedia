...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/prd_08_c_alignment_patch.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/prd_08_c_alignment_patch.md
  status: active
