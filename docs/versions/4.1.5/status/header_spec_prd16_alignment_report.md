...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/header_spec_prd16_alignment_report.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/header_spec_prd16_alignment_report.md
  status: active
