...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/castcade_directive_prd_primacy.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/castcade_directive_prd_primacy.md
  status: complete
