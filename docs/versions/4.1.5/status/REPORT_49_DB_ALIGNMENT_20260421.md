...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/REPORT_49_DB_ALIGNMENT_20260421.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/REPORT_49_DB_ALIGNMENT_20260421.md
  status: active
...
Option B is not ready. Both options must be decided before the installer is tagged 4.1.5.
