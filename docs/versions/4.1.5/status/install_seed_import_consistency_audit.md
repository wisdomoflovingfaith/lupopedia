...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/install_seed_import_consistency_audit.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/install_seed_import_consistency_audit.md
  status: active
