...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/human_only_install_validation.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/human_only_install_validation.md
  status: active
