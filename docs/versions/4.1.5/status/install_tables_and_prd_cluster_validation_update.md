...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/install_tables_and_prd_cluster_validation_update.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/install_tables_and_prd_cluster_validation_update.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/install-tables-and-prd-cluster-validation-update.toon
  atoms_toon: null
  ...
  summary: Report on adding 4 missing tables to canonical installer, updating install/wizard headers to 4.1.5, and formalizing prd_cluster-driven code validation doctrine.
---
...
-- PK names follow RULE 93.PK_NAMINY: <singular_table_name>_id
-- ============================================================================
```
...
## 4. INSTALL / WIZARD FILES UPDATED TO 4.1.5
...
2. **`install/ImportLegacyCraftySyntax.php`**
   - Previous version: "4.1.3"
   - Updated to: "4.1.5"
   - Added prd_cluster: `00_A_FORBIDDEN_AND_WHY_00_C_ROOT_CONSTITUTIONAL_SYSTEM_REQUIREMENTS_16_B_ATOMS_16_C_HEADERS_26_A_FIVE_LAYER_DOCUMENTATION_ARCHITECTURE`

3. **`install/InstallWizardHtaccessWriter.php`**
   - Previous: No lupopedia headers
   - Added complete lupopedia.headers with version "4.1.5"
   - Added prd_cluster: `00_A_FORBIDDEN_AND_WHY_00_C_ROOT_CONSTITUTIONAL_SYSTEM_REQUIREMENTS_16_B_ATOMS_16_C_HEADERS_26_A_FIVE_LAYER_DOCUMENTATION_ARCHITECTURE`

4. **`install/InstallWizardMdImporter.php`**
   - Previous: Old @wolfie.headers format
   - Replaced with lupopedia.headers format version "4.1.5"
   - Added prd_cluster: `00_A_FORBIDDEN_AND_WHY_00_C_ROOT_CONSTITUTIONAL_SYSTEM_REQUIREMENTS_16_B_ATOMS_16_C_HEADERS_26_A_FIVE_LAYER_DOCUMENTATION_ARCHITECTURE`
...
2. **`install/ImportLegacyCraftySyntax.php`** - Missing prd_cluster field entirely
3. **`install/InstallWizardHtaccessWriter.php`** - Missing lupopedia.headers entirely
4. **`install/InstallWizardMdImporter.php`** - Had old @wolfie.headers format, no prd_cluster
...
2. Are they current? (header_format_version = "4.1.5")
...
**Headers Updated:** 4 install/wizard files updated to 4.1.5 with proper prd_cluster
