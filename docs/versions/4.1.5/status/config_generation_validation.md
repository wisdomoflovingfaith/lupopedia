...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/config_generation_validation.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/config_generation_validation.md
  status: active
...
**Report File:** `docs/versions/4.1.5/status/config_generation_validation.md`  
