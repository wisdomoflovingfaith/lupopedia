...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/install_path_audit.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/install_path_audit.md
  status: active
