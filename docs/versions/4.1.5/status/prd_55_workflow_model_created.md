...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/prd_55_workflow_model_created.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/prd_55_workflow_model_created.md
  status: active
