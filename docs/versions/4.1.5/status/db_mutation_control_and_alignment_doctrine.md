...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/versions/4.1.5/status/db_mutation_control_and_alignment_doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/docs/versions/4.1.5/status/db_mutation_control_and_alignment_doctrine.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/db-mutation-control-and-alignment-doctrine.toon
  atoms_toon: null
