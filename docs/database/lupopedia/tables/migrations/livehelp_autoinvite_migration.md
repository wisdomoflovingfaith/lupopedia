...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_autoinvite_migration.md"
...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "docs\database\lupopedia\tables\livehelp_autoinvite_migration.md"
...
lupopedia.headers: {
  ...
  channel_id: 42,
  mood_vector: "8B4513",
  purpose: "Migration doctrine for livehelp_autoinvite â†’ lupo_crafty_syntax_auto_invite",
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/database/lupopedia/tables/active/lupo_crafty_syntax_auto_invite.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
