...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_leads_migration.md"
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/database/lupopedia/tables/active/lupo_crm_leads.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
    { to: "docs/database/lupopedia/tables/active/lupo_crm_lead_messages.md", type: "documents", weight: 0.9, hashtag: "#related" },
