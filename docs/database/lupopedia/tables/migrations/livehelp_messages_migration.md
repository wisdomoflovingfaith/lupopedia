...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_messages_migration.md"
...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "docs\database\lupopedia\tables\livehelp_messages_migration.md"
...
lupopedia.headers: {
  ...
  channel_id: 42,
  mood_vector: "8B4513",
  purpose: "Migration doctrine for livehelp_messages â†’ dropped (transcripts from livehelp_transcripts)",
...
flip.footer: {
  inbound_edges: [
    ...
    { from: "docs/doctrine/migrations/livehelp_transcripts_migration.md", type: "references", weight: 0.8, hashtag: "#related" }
  ],
  outbound_edges: [
    { to: "docs/database/lupopedia/tables/active/lupo_dialog_messages.md", type: "documents", weight: 0.9, hashtag: "#target_table" },
    { to: "docs/doctrine/migrations/livehelp_transcripts_migration.md", type: "references", weight: 0.8, hashtag: "#durable_data" },
