...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_leavemessage_migration.md"
...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "docs\database\lupopedia\tables\livehelp_leavemessage_migration.md"
...
flip.footer: {
  ...
  outbound_edges: [
    ...
    { to: "docs/database/lupopedia/tables/active/lupo_crm_leads.md", type: "related_to", weight: 0.5, hashtag: "#offline_forms" }
  ],
