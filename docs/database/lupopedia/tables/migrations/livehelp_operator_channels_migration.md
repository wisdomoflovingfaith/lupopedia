...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_operator_channels_migration.md"
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/database/lupopedia/tables/active/lupo_channels.md", type: "documents", weight: 0.9, hashtag: "#target_system" },
    { to: "docs/database/lupopedia/tables/active/lupo_actor_channel_roles.md", type: "documents", weight: 0.8, hashtag: "#permissions" },
