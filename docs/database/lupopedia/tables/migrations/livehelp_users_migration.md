...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_users_migration.md"
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/database/lupopedia/tables/active/lupo_auth_users.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
    { to: "docs/database/lupopedia/tables/active/lupo_actors.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
...
- **lupo_auth_users** â€” authentication and credentials (username, display_name, email, password_hash, auth_provider, provider_id, last_login_ymdhis). On import, **auth_user_id = 10000 + livehelp_users.user_id** so that human IDs stay in the reserved range (actor_id 0â€“9999 = agents/system only; humans â‰¥ 10000).
