...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_departments_migration.md"
...
lupopedia.headers: {
  ...
  channel_id: 42,
  mood_vector: "8B4513",
  purpose: "Migration doctrine for livehelp_departments â†’ lupo_departments/lupo_department_metadata",
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/database/lupopedia/tables/active/lupo_departments.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
    { to: "docs/doctrine/migrations/livehelp_operator_departments_migration.md", type: "references", weight: 0.9, hashtag: "#related" },
