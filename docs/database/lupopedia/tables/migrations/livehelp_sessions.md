...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_sessions.md"
...
---
lupopedia.headers:
  file_path_from_root: "docs/database/lupopedia/tables/livehelp_sessions.md"
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "database/lupopedia/toon/livehelp_sessions.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_sessions" }
