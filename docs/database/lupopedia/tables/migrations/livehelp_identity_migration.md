...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_identity_migration.md"
...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "docs\database\lupopedia\tables\livehelp_identity_migration.md"
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/database/lupopedia/tables/active/lupo_sessions.md", type: "documents", weight: 0.9, hashtag: "#anonymous_sessions" },
    { to: "docs/database/lupopedia/tables/active/lupo_actors.md", type: "documents", weight: 0.8, hashtag: "#no_anonymous_actors" },
