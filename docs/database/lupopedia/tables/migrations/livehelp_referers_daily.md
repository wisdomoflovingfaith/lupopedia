...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_referers_daily.md"
...
---
lupopedia.headers:
  file_path_from_root: "docs/database/lupopedia/tables/livehelp_referers_daily.md"
  file_hash: "72d91cd05b0e19157f6281d87b9a1a8593b81793b76446d99c1269164ba1a3d2"
  ...
  purpose: "Complete documentation for livehelp_referers_daily table"
  ...
  tags: ["database", "table", "livehelp_referers_daily"]
  lupo_agent: "codex-ide"
  livehelp_referers_daily.recno: "int NOT NULL auto_increment"
  livehelp_referers_daily.livehelp_id: "bigint unsigned NOT NULL DEFAULT 1"
  livehelp_referers_daily.pageurl: "varchar(255) NOT NULL DEFAULT '0'"
  livehelp_referers_daily.dateof: "int NOT NULL DEFAULT 0"
  livehelp_referers_daily.levelvisits: "int unsigned NOT NULL DEFAULT 0"
  livehelp_referers_daily.directvisits: "int unsigned NOT NULL DEFAULT 0"
  livehelp_referers_daily.parentrec: "int unsigned NOT NULL DEFAULT 0"
  livehelp_referers_daily.level: "int NOT NULL DEFAULT 0"
  livehelp_referers_daily.department: "int NOT NULL DEFAULT 0"
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "database/lupopedia/toon/livehelp_referers_daily.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_referers_daily" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "livehelp_referers_daily"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for livehelp_referers_daily from TOON schema.
Type: database_table
...
Common Queries:
```sql
SELECT * FROM livehelp_referers_daily WHERE recno = :id;
SELECT COUNT(*) AS total FROM livehelp_referers_daily WHERE is_deleted = 0;
SELECT * FROM livehelp_referers_daily ORDER BY recno DESC LIMIT 25;
UPDATE livehelp_referers_daily SET updated_ymdhis = :ts WHERE recno = :id;
```
