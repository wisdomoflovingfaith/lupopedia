...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_emails_migration.md"
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/database/lupopedia/tables/active/lupo_crm_lead_messages.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
