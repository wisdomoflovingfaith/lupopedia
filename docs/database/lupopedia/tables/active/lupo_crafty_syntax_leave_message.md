...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/database/lupopedia/tables/active/lupo_crafty_syntax_leave_message.md
  web_path: https://www.lupopedia.com/lupopedia/docs/database/lupopedia/tables/active/lupo_crafty_syntax_leave_message.md
  status: ''
