...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/database/lupopedia/tables/active/lupo_agents.md
  web_path: https://www.lupopedia.com/lupopedia/docs/database/lupopedia/tables/active/lupo_agents.md
  status: ''
...
## Doctrine
- Canonical DDL: `database/lupopedia/mysql/install/install_new_lupopedia.sql` (`{{prefix}}agents`)
- JSON/TOON under `database/lupopedia/json/` and `toon/` should match install; regenerate via `scripts/generate_toon_from_sql.py` when install changes
