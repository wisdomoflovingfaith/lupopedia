...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/database/lupopedia/tables/active/lupo_actor_auth_users.md
  web_path: https://www.lupopedia.com/lupopedia/docs/database/lupopedia/tables/active/lupo_actor_auth_users.md
  status: ''
