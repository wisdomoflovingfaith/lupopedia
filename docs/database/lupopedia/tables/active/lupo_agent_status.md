...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/database/lupopedia/tables/active/lupo_agent_status.md
  web_path: https://www.lupopedia.com/lupopedia/docs/database/lupopedia/tables/active/lupo_agent_status.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/lupo_agent_status.toon
  atoms_toon: null
...
- **Source of Truth:** Aligns with `database/lupopedia/json/lupo_agent_status.json`.
