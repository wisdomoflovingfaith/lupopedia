...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/database/lupopedia/tables/active/lupo_projects.md
  web_path: https://www.lupopedia.com/lupopedia/docs/database/lupopedia/tables/active/lupo_projects.md
  status: ''
