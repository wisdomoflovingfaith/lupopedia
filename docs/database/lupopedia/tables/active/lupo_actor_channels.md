...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/active/lupo_actor_channels.md"
...
lupopedia.edges:
  ...
  - to: debug_captain.php
    ...
    confidence: 0.7
    source: "code-scan"
  - to: includes/classes/AgentAwarenessLayer.php
    type: USED_IN_PHP
    weight: 0.9
    confidence: 0.7
    source: "code-scan"
  - to: includes/classes/ContentChannelActorResolver.php
    type: USED_IN_PHP
    weight: 0.9
    confidence: 0.7
    source: "code-scan"
  - to: includes/modules/api/channels-api.php
    type: USED_IN_PHP
    weight: 0.9
    confidence: 0.7
    source: "code-scan"
  - to: includes/modules/channels/ChannelsController.php
    ...
    confidence: 0.7
    source: "code-scan"
  - to: includes/modules/channels/channels-controller.php
    type: USED_IN_PHP
    weight: 0.9
    confidence: 0.7
    source: "code-scan"
  - to: scripts/verify_grounded_architecture.php
    ...
    confidence: 0.7
    source: "code-scan"
  - to: tests/unit/channel_api_security_test.php
    type: USED_IN_PHP
    weight: 0.7
    confidence: 0.7
    source: "code-scan"
