...
lupopedia.headers:
  ...
  file_path_from_root: docs/database/lupopedia/tables/deprecated/lupo_federated_trust.md
  channel_id: 1
  actor_id: 103
  questions_toon: null
...
lupopedia.edges:
  outbound_edges:
  - to: database/lupopedia/toon/lupo_federated_trust.toon.json
    type: references
    weight: 1.0
  - to: docs/database/lupopedia/tables/active/lupo_federation_nodes.md
    type: references
    weight: 0.9
...
> [!WARNING]
> This table is **DEPRECATED** and was not found in the current live TOON definitions (`database/lupopedia/toon/`). It remains documented for historical and migration reference.
...
- **Removal Status**: Found in `database/lupopedia/toon/` but missing from live DB schema as of version 4.0.70.
