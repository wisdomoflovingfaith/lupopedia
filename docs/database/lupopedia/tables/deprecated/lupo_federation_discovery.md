...
lupopedia.headers:
  ...
  file_path_from_root: docs/database/lupopedia/tables/deprecated/lupo_federation_discovery.md
  channel_id: 1
  actor_id: 103
  questions_toon: null
...
lupopedia.edges:
  outbound_edges:
  - to: database/lupopedia/toon/lupo_federation_discovery.toon.json
    type: references
    weight: 1.0
...
> [!WARNING]
> This table is **DEPRECATED** and was not found in the current live TOON definitions. It exists in `database/lupopedia/toon/` but is absent from `database/lupopedia/toon/`.
