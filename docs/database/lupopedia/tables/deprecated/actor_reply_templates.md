...
﻿---
lupopedia.headers:
  file_path_from_root: "docs/database/lupopedia/tables/deprecated/actor_reply_templates.md"
...
- { to: "docs/database/lupopedia/tables/lupo_actors.md", type: "references", weight: 1.0 }
    - { to: "database/lupopedia/toon/lupo_actor_reply_templates.toon.json", type: "schema_reference", weight: 1.0 }
...
**Schema:** See `database/lupopedia/toon/lupo_actor_reply_templates.toon.json`. Primary key: `actor_reply_template_id`. Columns include actor_id, template_key, template_text, usage_context, and lifecycle fields.
...
**Migration:** `docs/doctrine/migrations/livehelp_quick_migration.md`, `import_from_old_crafty_syntax.sql`. id â†’ actor_reply_template_id, user â†’ actor_id, name â†’ template_key, message â†’ template_text, typeof â†’ usage_context. livehelp_quick â†’ IMPORTED â†’ DROPPED.
