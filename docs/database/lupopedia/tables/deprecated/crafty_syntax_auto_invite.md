---
lupopedia.headers:
  file_path_from_root: "docs/database/lupopedia/tables/deprecated/crafty_syntax_auto_invite.md"
...
- { to: "docs/database/lupopedia/tables/departments.md", type: "references", weight: 0.7 }
    - { to: "database/lupopedia/toon/lupo_crafty_syntax_auto_invite.toon.json", type: "schema_reference", weight: 1.0 }
...
**Schema:** See `database/lupopedia/toon/lupo_crafty_syntax_auto_invite.toon.json`. Primary key: `crafty_syntax_auto_invite_id`. All columns must match TOON.
...
**Migration:** `docs/doctrine/migrations/livehelp_autoinvite_migration.md`, `import_from_old_crafty_syntax.sql`. Full field mapping in migration file. Legacy table is CONVERTed to utf8mb4, then data imported; livehelp_autoinvite â†’ IMPORTED â†’ DROPPED.
