...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/active/lupo_metrics_archive_legacy.md"
  file_hash: "47150785d806afd64af163bdcda3f066e6c854e514da956f8e1bf7db9b883777"
...
---
lupopedia.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_metrics_archive_legacy.md"
  file_hash: "75be91cf3e15787940350e4b7ef6f5ad5c21d3a7c57136e8e21fe8b84d376a04"
  ...
  purpose: "Complete documentation for lupo_metrics_archive_legacy table"
  ...
  tags: ["database", "table", "lupo_metrics_archive_legacy"]
  lupo_agent: "codex-ide"
  lupo_metrics_archive_legacy.metric_id: "int NOT NULL"
  lupo_metrics_archive_legacy.metric_key: "varchar(255) NOT NULL"
  lupo_metrics_archive_legacy.metric_value: "varchar(255)"
  lupo_metrics_archive_legacy.recorded_at: "bigint"
  table_primary_key: "metric_id"
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "database/lupopedia/toon/lupo_metrics_archive_legacy.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_metrics_archive_legacy" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_metrics_archive_legacy"]
  version: "4.0.48"
  last_verified: "20260227"
  last_verified_by: "codex-ide"
---

# Table: lupo_metrics_archive_legacy

Purpose: Auto-generated documentation for lupo_metrics_archive_legacy from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| metric_id | int NOT NULL | from TOON |
| metric_key | varchar(255) NOT NULL | from TOON |
| metric_value | varchar(255) | from TOON |
| recorded_at | bigint | from TOON |
...
Common Queries:
```sql
SELECT * FROM lupo_metrics_archive_legacy WHERE metric_id = :id;
SELECT COUNT(*) AS total FROM lupo_metrics_archive_legacy WHERE is_deleted = 0;
SELECT * FROM lupo_metrics_archive_legacy ORDER BY metric_id DESC LIMIT 25;
UPDATE lupo_metrics_archive_legacy SET updated_ymdhis = :ts WHERE metric_id = :id;
```
