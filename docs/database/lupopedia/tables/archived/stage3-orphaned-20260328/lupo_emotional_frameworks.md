...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/active/lupo_emotional_frameworks.md"
...
---
lupopedia.headers:
  file_path_from_root: "docs/database/lupopedia/tables/lupo_emotional_frameworks.md"
...
lupopedia.footer:
  outbound_edges:
    - { to: "database/lupopedia/toon/lupo_emotional_frameworks.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_emotional_frameworks" }
