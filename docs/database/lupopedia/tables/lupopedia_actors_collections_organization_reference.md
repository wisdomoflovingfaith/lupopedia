...
lupopedia.headers:
  ...
  file_path_from_root: docs/database/lupopedia/tables/lupopedia_actors_collections_organization_reference.md
  channel_id: 42
  actor_id: 102
...
lupopedia.edges:
  ...
  - to: database/lupopedia/toon/
    type: references
    weight: 1.0
  - to: docs/database/lupopedia/tables/active/lupo_actors.md
    type: references
    weight: 0.95
  - to: docs/database/lupopedia/tables/active/lupo_collections.md
    type: references
    weight: 0.95
  - to: docs/database/lupopedia/tables/active/lupo_channels.md
    type: references
    weight: 0.95
  - to: docs/database/lupopedia/tables/active/lupo_sessions.md
    type: references
    weight: 0.9
  - to: docs/database/lupopedia/tables/active/lupo_registry.md
    type: references
    weight: 0.95
  - to: docs/doctrine/DATABASE_DOCTRINE.md
    type: references
    weight: 1.0
  - to: docs/doctrine/COLLECTIONS_DOCTRINE.md
    type: references
    weight: 0.95
  - to: docs/doctrine/FEDERATION_SCOPING_DOCTRINE.md
    type: references
    weight: 0.95
  - to: docs/doctrine/SESSION_DOCTRINE.md
    type: references
    weight: 0.9
  - to: docs/ACTOR_REGISTRATION_CHECKLIST.md
    type: references
    weight: 0.95
  - to: docs/ACTOR_FORENSIC_LOGGING_AND_COLLECTIONS_INTELLIGENCE_PLAN.md
    type: references
    weight: 0.9
...
Doctrine documents and root rules apply to this reference as follows. Rule IDs are declared in `rules/root/` and are stable for lookup.

| Section | Related Canonical Doctrine |
|---|---|
| Actor system | `rules/root/pk-reference-naming-doctrine.md`, `rules/root/reserved-id-doctrine.md`, `docs/doctrine/REGISTRY_DOCTRINE.md`, `docs/doctrine/IDENTITY_LAYERS_DOCTRINE.md` |
| Collections | `docs/doctrine/COLLECTIONS_DOCTRINE.md`, `docs/doctrine/DATABASE_DOCTRINE.md` |
| Organization | `docs/doctrine/FEDERATION_SCOPING_DOCTRINE.md`, `docs/doctrine/REGISTRY_DOCTRINE.md`, `docs/doctrine/channels.md` |
| Sessions and auth boundaries | `docs/doctrine/SESSION_DOCTRINE.md`, `docs/doctrine/AUTHORIZATION_DOCTRINE.md` |
| Core database constraints | `docs/doctrine/DATABASE_DOCTRINE.md` |

### Rule ID Quick Reference

Rule IDs below are taken from `rules/root/` and are relevant to this reference. Use the root files as the source of truth.

| Domain / operation | Rule ID | Rule document |
|-------------------|---------|----------------|
| No foreign keys / no DB logic | DB001 | `rules/root/database-logic-prohibition-doctrine.md` |
| PK and reference column naming | DB004 | `rules/root/pk-reference-naming-doctrine.md` |
| Reserved ID (no AUTO_INCREMENT for registry tables) | DB006 | `rules/root/reserved-id-doctrine.md` |
| TOON / install SQL as schema authority | DB007 | `rules/root/toon-source-of-truth.md` |
| Agent identity and actor pairing | ACT001 | `rules/root/ide-agent-identity-actor-pairing-doctrine.md` |
| Channels, federation, offline session context | CTX001 | `rules/root/channels-federation-offline-session-doctrine.md` |
...
2. Regenerate TOON files (project workflow: `scripts/generate_toon_files.py`).
...
- `docs/database/lupopedia/tables/active/lupo_channels.md`
- `docs/database/lupopedia/tables/active/lupo_sessions.md`
- `docs/doctrine/DATABASE_DOCTRINE.md`
- `docs/doctrine/COLLECTIONS_DOCTRINE.md`
- `docs/doctrine/FEDERATION_SCOPING_DOCTRINE.md`
- `docs/doctrine/SESSION_DOCTRINE.md`
- `docs/ACTOR_REGISTRATION_CHECKLIST.md`
- `docs/ACTOR_FORENSIC_LOGGING_AND_COLLECTIONS_INTELLIGENCE_PLAN.md`
