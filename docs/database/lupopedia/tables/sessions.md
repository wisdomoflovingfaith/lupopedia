...
**Schema:** See `database/lupopedia/toon/lupo_sessions.toon.json`. Primary key: `session_id`. Timestamps BIGINT UTC (e.g. expires_ymdhis). Session data is stored in the payload/lifecycle columns as defined in the TOON.
