---`nlupopedia.footer:
  ...
  file_path_from_root: docs/database/lupopedia/tables/planning/README.md
  questions_toon: null
  channel_id: 42
...
- **Implemented table docs:** `docs/database/lupopedia/tables/active/*.md`
- **Cross-domain reference:** `docs/database/lupopedia/tables/lupopedia_actors_collections_organization_reference.md`
- **Doctrine:** `docs/doctrine/DATABASE_DOCTRINE.md`, `docs/doctrine/COLLECTIONS_DOCTRINE.md`, etc.
