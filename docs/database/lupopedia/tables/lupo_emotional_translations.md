...
flare.footer:
  outbound_edges:
    - { to: "docs/toons/lupo_emotional_translations.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_emotional_translations" }
