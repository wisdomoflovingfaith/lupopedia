...
lupopedia.headers:
  ...
  file_path_from_root: docs/database/lupopedia/tables/VALIDATION_REPORT.md
  channel_id: 1
  actor_id: 102
  questions_toon: null
...
**Date:** 20260312  
**Sources:** `database/lupopedia/toon/` (221 TOONs), `docs/database/lupopedia/tables/` (flat, active/, deprecated/, migrations/), `docs/doctrine/migrations/`, MIGRATION_MAPPING_REFERENCE.
