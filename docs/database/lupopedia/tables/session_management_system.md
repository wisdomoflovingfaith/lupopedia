...
lupopedia.edges:
  outbound_edges:
    - { to: "database/lupopedia/toon/lupo_sessions.toon.json", type: "schema_reference", weight: 1.0 }
    - { to: "bin/session_manager.php", type: "implementation_reference", weight: 0.9 }
    - { to: "docs/doctrine/FLARE/FLARE_DOCTRINE.md", type: "references", weight: 1.0 }
    - { to: "database/lupopedia/toon/lupo_channel_logs.toon.json", type: "related_schema", weight: 0.8 }
    - { to: "database/lupopedia/toon/lupo_channel_boot_lifecycle.toon.json", type: "integration_reference", weight: 0.8 }
...
|--------------------|----------------------|------|-------------|
| `current_session_id` | `session_id` | varchar(128) | UUID with actor prefix (e.g., `L-1006-<uuid>`). |
...
## Default Sessions
Default session templates are stored in `sessions/actor_<id>_default.json` for key actors. These provide pre-configured sessions for init/boot, synced to DB if missing. All use L-<actor_id> prefix, 'active' status, and role-specific metadata.
...
```json
{
  "current_session_id": "L-0-00000000-0000-0000-0000-000000000000",
  "actor_id": 0,
...
```json
{
  "current_session_id": "L-1002-00000000-0000-0000-0000-000000000000",
  "actor_id": 1002,
  "federation_node_id": 0,
  "last_active_ymdhis": "20260301134200",
  "system_version": "4.0.53",
...
Use `loadDefaultSessionIfMissing()` from `includes/functions/session_helpers.php` to automatically load and sync defaults during boot/install.
...
## References
- `database/lupopedia/toon/lupo_sessions.toon.json`
- `bin/session_manager.php`
- `docs/doctrine/FLARE/FLARE_DOCTRINE.md`
- `database/lupopedia/toon/lupo_channel_logs.toon.json`
