...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/database/lupopedia/windsurf_migration_domain_completion_note.md
  web_path: https://www.lupopedia.com/lupopedia/docs/database/lupopedia/windsurf_migration_domain_completion_note.md
  status: ''
...
- `docs/doctrine/migrations/livehelp_migrations_readme.md` - Primary migration reference
