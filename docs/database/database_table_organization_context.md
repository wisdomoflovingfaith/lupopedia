...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/database/database_table_organization_context.md
  web_path: https://www.lupopedia.com/lupopedia/docs/database/database_table_organization_context.md
  status: ''
