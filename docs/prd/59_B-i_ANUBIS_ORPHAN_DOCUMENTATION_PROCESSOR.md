...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/59_B-i_ANUBIS_ORPHAN_DOCUMENTATION_PROCESSOR.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/59_B-i_ANUBIS_ORPHAN_DOCUMENTATION_PROCESSOR.md
  status: active
