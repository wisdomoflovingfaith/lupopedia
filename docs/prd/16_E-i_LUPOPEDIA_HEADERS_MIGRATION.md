...
lupopedia.headers:
  ...
  summary: Migration guide for Lupopedia header contract at version 4.1.5. Covers legacy field aliases, per-file migration workflow, and content_slug removal.
---
<!-- ASCII_ART_BLOCK -->
