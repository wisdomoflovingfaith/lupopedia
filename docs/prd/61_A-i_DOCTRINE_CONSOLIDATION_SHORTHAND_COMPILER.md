...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/61_A-i_DOCTRINE_CONSOLIDATION_SHORTHAND_COMPILER.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/61_A-i_DOCTRINE_CONSOLIDATION_SHORTHAND_COMPILER.md
  status: draft
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/61_doctrine_consolidation_shorthand_compiler.toon
  atoms_toon: null
  ...
  prd_cluster: 61_A-i_00_A-i_FORBIDDEN_AND_WHY_61_A_DOCTRINE_CONSOLIDATION_SHORTHAND_COMPILER
...
2. A **canonical shorthand TOON** representation for compact exchange between humans, IDE agents, and `memory/` pipelines ??? **subordinate** to the full [**TOON Ordering Specification v1.0.0**](../doctrine/TOON_ORDERING_SPEC.md) and [**PRD 16**](../prd/16_lupopedia_headers.md) / [**PRD 38**](../prd/38_memory_unification.md).
...
nodes: [
  ...
  [2, "memory_key", "memory/development/canonical/1026/04/61-doctrine-consolidation-shorthand-compiler.toon"],
...
edges: [
  ...
  [1, "to_path", "docs/prd/53_runtime_guard.md"],
...
```yaml
hdr: [
  [0, "file_path_from_root", "docs/prd/61_doctrine_consolidation_shorthand_compiler.md"],
  [1, "pk_id", 61],
...
3. **After edit:** Run **`python bin/tick.py`** once per batch; set **`when_updated`** and **`last_modified_utc`** from **`python bin/echo_anchor_utc.py`** output.
4. **Validate:** **`python scripts/validate_lupopedia_headers_universal.py <path>`** ??? fix failures before commit.
...
2. **JSON master ??? TOON:** When the pipeline uses paired JSON + TOON under **`memory/`**, edit **`.json`** then run **`python scripts/json_to_toon.py --json <path>.json --toon <path>.toon`**.
...
1. **New files:** **`python scripts/add_lupopedia_header_to_file.py <path> [--create]`** or copy from [`TEMPLATES_NEW_FILE.md`](../doctrine/LUPOPEDIA_HEADERS/TEMPLATES_NEW_FILE.md).
...
|------|-----|-------------|----------------|
| `61_doctrine_consolidation_shorthand_compiler.md` | `docs/doctrine/TOON_ORDERING_SPEC.md` | `doctrine_rule` | `ordered_array_shape` |
| `61_doctrine_consolidation_shorthand_compiler.md` | `docs/prd/16_lupopedia_headers.md` | `doctrine_rule` | `header_envelope` |
| `61_doctrine_consolidation_shorthand_compiler.md` | `docs/prd/38_memory_unification.md` | `doctrine_rule` | `memory_graph_target` |
| `61_doctrine_consolidation_shorthand_compiler.md` | `docs/prd/50_agent_coordination_protocol.md` | `doctrine_rule` | `coordination_invariants` |
| `61_doctrine_consolidation_shorthand_compiler.md` | `docs/prd/53_runtime_guard.md` | `doctrine_rule` | `enforcement_guard` |
| `61_doctrine_consolidation_shorthand_compiler.md` | `docs/prd/58_transcript_filter.md` | `doctrine_rule` | `enforcement_filter` |
| `61_doctrine_consolidation_shorthand_compiler.md` | `docs/prd/54_actor_compliance.md` | `doctrine_rule` | `enforcement_compliance` |
| `61_doctrine_consolidation_shorthand_compiler.md` | `docs/prd/60_orchestrator_scheduler.md` | `doctrine_rule` | `enforcement_scheduler` |
| `61_doctrine_consolidation_shorthand_compiler.md` | `docs/doctrine/AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md` | `doctrine_rule` | `harness_doctrine_mirror` |
| `61_doctrine_consolidation_shorthand_compiler.md` | `docs/doctrine/VALIDATION_PATTERNS.md` | `doctrine_rule` | `validation_index_mirror` |
