...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/30_A-i_CHANNEL_USAGE_PATTERNS.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/30_A-i_CHANNEL_USAGE_PATTERNS.md
  status: active
