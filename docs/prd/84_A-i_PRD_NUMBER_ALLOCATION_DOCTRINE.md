...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/84_A-i_PRD_NUMBER_ALLOCATION_DOCTRINE.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/84_A-i_PRD_NUMBER_ALLOCATION_DOCTRINE.md
  status: active
