...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/54_A-i_ACTOR_COMPLIANCE.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/54_A-i_ACTOR_COMPLIANCE.md
  status: draft
  ...
  prd_cluster: 54_A-i_00_A-i_FORBIDDEN_AND_WHY_54_A_ACTOR_COMPLIANCE
