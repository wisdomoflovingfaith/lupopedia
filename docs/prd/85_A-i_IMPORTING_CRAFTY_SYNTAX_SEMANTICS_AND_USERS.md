...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/85_A-i_IMPORTING_CRAFTY_SYNTAX_SEMANTICS_AND_USERS.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/85_A-i_IMPORTING_CRAFTY_SYNTAX_SEMANTICS_AND_USERS.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/85-importing-crafty-syntax-semantics-and-users.toon
  ...
  prd_cluster: 00_A-i_79_A-i_85_A-i
  title: 'PRD 85: Importing Crafty Syntax Semantics and Users - 4.1.5'
...
- **File:** `database/lupopedia/json/lupo_auth_users.json`
...
Constants are in memory/atoms/lupopedia_global_constants.atom.toon (user_id_space).
...
**File:** `database/lupopedia/mysql/seed/seed_4.1.3.sql`
...
**File:** `database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql`
...
- `install/InstallWizardHtaccessWriter.php` - .htaccess writer
- `install/InstallWizardMdImporter.php` - Markdown importer
...
2. `database/lupopedia/mysql/seed/seed_4.1.3.sql`
   - Removed old user ID references (1000, 420)
   - Updated comments

3. `database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql`
...
4. `docs/prd/85_importing_crafty_syntax_semantics_and_users.md` (this file)
