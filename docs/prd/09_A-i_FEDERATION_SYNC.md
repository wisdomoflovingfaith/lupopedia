...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/09_A-i_FEDERATION_SYNC.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/09_A-i_FEDERATION_SYNC.md
  status: active
  ...
  prd_cluster: 09_A-i_00_A-i_FORBIDDEN_AND_WHY_09_A_FEDERATION_SYNC
