...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/48_A-i_MANUAL_ORCHESTRATION_GAP.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/48_A-i_MANUAL_ORCHESTRATION_GAP.md
  status: active
  ...
  prd_cluster: 00_A-i_FORBIDDEN_AND_WHY_16_C_HEADERS_48_A-i_MANUAL_ORCHESTRATION_GAP
