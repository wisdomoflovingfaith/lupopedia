...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/75_A-i_TEMPORAL_SYSTEM.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/75_A-i_TEMPORAL_SYSTEM.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/75_temporal_system.toon
  atoms_toon: null
  transcript_jsonl: 0/development/prd_files/temporal-system
  artifact_type: prd
  ...
  prd_cluster: 00_A-i_75_A-i
  title: 'PRD 75: Temporal System - Canonical UTC Authority'
  summary: null
---
...
**See also:** Database Doctrine #4 in `rules/root/LUPOPEDIA_CONSTITUTIONAL_ROOT_RULES.md`
...
2. **Structured Temporal Data**: Read from bin/temporal_anchor.json
3. **Generating Timestamps**: Call bin/tick.py
...
- Point to bin/tick.py as the implementation
...
- **Implemented by**: bin/tick.py
- **Enforced by**: All Lupopedia components
- **Documented in**: docs/prd/00_root_constitutional_system_requirements.md
