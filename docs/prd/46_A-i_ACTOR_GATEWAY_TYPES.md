...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/46_A-i_ACTOR_GATEWAY_TYPES.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/46_A-i_ACTOR_GATEWAY_TYPES.md
  status: draft
  ...
  prd_cluster: 46_A-i_00_A-i_FORBIDDEN_AND_WHY_46_A_ACTOR_GATEWAY_TYPES
