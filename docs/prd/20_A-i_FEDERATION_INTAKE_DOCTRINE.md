...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/20_A-i_FEDERATION_INTAKE_DOCTRINE.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/20_A-i_FEDERATION_INTAKE_DOCTRINE.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/20_federation_intake_doctrine.toon
  atoms_toon: null
...
1. **Isolation** ???????? Each external source gets its own directory under `research/federation_nodes/{federation_node_id}/{source_name}/`
...
2. **Create Directory** at `research/federation_nodes/{node_id}/{source_name}/`
...
```yaml
paths:
  - pattern: "research/federation_nodes/**/*.md"
    read_only: true
