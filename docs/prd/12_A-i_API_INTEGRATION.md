...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/12_A-i_API_INTEGRATION.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/12_A-i_API_INTEGRATION.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/12_api_integration.toon
  atoms_toon: null
