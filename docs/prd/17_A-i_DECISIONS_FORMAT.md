...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/17_A-i_DECISIONS_FORMAT.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/17_A-i_DECISIONS_FORMAT.md
  status: active
