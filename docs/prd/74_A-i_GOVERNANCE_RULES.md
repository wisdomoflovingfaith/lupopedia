...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/74_A-i_GOVERNANCE_RULES.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/74_A-i_GOVERNANCE_RULES.md
  status: active
