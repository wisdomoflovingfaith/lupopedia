...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/decisions/pseudocode/01_core_identity_constitutionpseudo.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/decisions/pseudocode/01_core_identity_constitutionpseudo.md
  status: ''
  ...
  thread_key: pseudocode-01-core-identity
