...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/decisions/pseudocode/02_channels_discussions_constitutionpseudo.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/decisions/pseudocode/02_channels_discussions_constitutionpseudo.md
  status: active
  ...
  thread_key: pseudocode-02-channels-discussions
