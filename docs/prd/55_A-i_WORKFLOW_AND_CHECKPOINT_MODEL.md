...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/55_A-i_WORKFLOW_AND_CHECKPOINT_MODEL.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/55_A-i_WORKFLOW_AND_CHECKPOINT_MODEL.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/55-workflow-and-checkpoint-model.toon
  atoms_toon: null
