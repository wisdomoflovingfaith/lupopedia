...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/52_A-i_MEMORY_GRAPH_FOCUS_MANIFEST.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/52_A-i_MEMORY_GRAPH_FOCUS_MANIFEST.md
  status: draft
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/52_memory_graph_focus_manifest.toon
  atoms_toon: null
  ...
  prd_cluster: 52_A-i_00_A-i_FORBIDDEN_AND_WHY_52_A_MEMORY_GRAPH_FOCUS_MANIFEST
...
|--------|----------------|------|------|
| **A. JSON file** | e.g. **`config/focus_manifest.json`** (name not normative until shipped) | Version-controlled, easy for IDE agents | Not multi-tenant; merge conflicts |
...
3. Document one or two **stock** manifests (e.g. **`registry_pass`**, **`header_migration`**) in **`docs/doctrine/`** or channel threads.
