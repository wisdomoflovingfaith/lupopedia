...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/43_A-i_PARENT_CHILD_TRUST_LADDER.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/43_A-i_PARENT_CHILD_TRUST_LADDER.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: memory/development/canonical/1026/04/43_parent_child_trust_ladder.toon
  atoms_toon: null
  ...
  prd_cluster: 43_A-i_00_A-i_FORBIDDEN_AND_WHY_43_A_PARENT_CHILD_TRUST_LADDER
...
All trust ladder tables registered in **`docs/doctrine/TRUST_LADDER_REGISTRY.md`** **MUST** implement the year offset convention on **18-digit** PKs:
