...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/47_A-i_ACTOR_RUNTIME_DIRECTORY_STRUCTURE.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/47_A-i_ACTOR_RUNTIME_DIRECTORY_STRUCTURE.md
  status: active
  ...
  prd_cluster: 47_A-i_00_A-i_FORBIDDEN_AND_WHY_47_A_ACTOR_RUNTIME_DIRECTORY_STRUCTURE
