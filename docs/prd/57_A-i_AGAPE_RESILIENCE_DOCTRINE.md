...
lupopedia.headers:
  ...
  path_from_lupopedia_root: docs/prd/57_A-i_AGAPE_RESILIENCE_DOCTRINE.md
  web_path: https://www.lupopedia.com/lupopedia/docs/prd/57_A-i_AGAPE_RESILIENCE_DOCTRINE.md
  status: active
