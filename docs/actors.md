...
- **Comparison:** last_modified_utc, optional body hash, and specific fields (e.g. flare.edges).
...
- **Side-effects:** Read-only by default; writes allowed only if `flare.conditional.guards_allow` permits.
