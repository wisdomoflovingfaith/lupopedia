...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-rules/cursor/required-tables-future-features-doctrine.md"
  web_path: "http://www.lupopedia.com/rules/cursor/required-tables-future-features-doctrine"
  ...
  purpose: "Required-tables split, future_features_lupopedia.sql canonical, install/future separation, migrations cleanup, patch-only versioning, directory tree integrity, audit maintenance. Mandatory for every patch cycle 4.0.2 to 4.0.999."
...
---
# file: Rule — Required Tables and Future Features Doctrine — session: L-LUPO-WOLFIE — delegation: wolfie:root — web_path: http://www.lupopedia.com/rules/cursor/required-tables-future-features-doctrine
