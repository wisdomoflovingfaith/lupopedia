...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-rules/cursor/single-install-no-4.0-upgrade-doctrine.md"
  web_path: "http://www.lupopedia.com/rules/cursor/single-install-no-4.0-upgrade-doctrine"
...
---
# file: Rule — Single Install, No Lupopedia Upgrade Until 4.1.0 — session: L-LUPO-WOLFIE — delegation: wolfie:root — web_path: http://www.lupopedia.com/rules/cursor/single-install-no-4.0-upgrade-doctrine
