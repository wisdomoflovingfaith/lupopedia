...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-rules/cursor/reserved-id-doctrine.md"
  web_path: "http://www.lupopedia.com/rules/cursor/reserved-id-doctrine"
...
---
# file: Rule — RESERVED ID DOCTRINE — session: L-LUPO-WOLFIE — delegation: wolfie:root — web_path: http://www.lupopedia.com/rules/cursor/reserved-id-doctrine
