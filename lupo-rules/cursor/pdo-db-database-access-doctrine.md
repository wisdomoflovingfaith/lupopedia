...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-rules/cursor/pdo-db-database-access-doctrine.md"
  web_path: "http://www.lupopedia.com/rules/cursor/pdo-db-database-access-doctrine"
...
---
# file: Rule — PDO_DB Database Access Doctrine — session: L-LUPO-WOLFIE — delegation: wolfie:root — web_path: http://www.lupopedia.com/rules/cursor/pdo-db-database-access-doctrine
