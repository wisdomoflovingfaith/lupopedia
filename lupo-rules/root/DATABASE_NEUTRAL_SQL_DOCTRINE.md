...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-rules/root/DATABASE_NEUTRAL_SQL_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-rules/root/DATABASE_NEUTRAL_SQL_DOCTRINE.md"
  ...
  artifact_kind: "rule"
  purpose: Enforce database-neutral SQL for cross-platform compatibility
  tags:
  - "4.0.89"
  - "database"
  - "sql"
...
lupopedia.edges:
  outbound_edges:
    - to: "lupo-includes/classes/DatabaseFactory.php"
      type: references
      weight: 1.0
      reason: Database abstraction implementation
    - to: "lupo-docs/versions/4.0.89/CHANGELOG.md"
      type: references
      weight: 1.0
      reason: Documented database abstraction in 4.0.89
lupopedia.footer:
  ...
  next_action:
    - "Enforce database-neutral SQL in all new code"
    - "Update existing code to use DatabaseFactory"
    - "Test schema compatibility on both MySQL and PostgreSQL"
---
