...
lupopedia.headers:
  ...
  purpose: Establish mandatory requirement for LUPOPEDIA headers on all files in the Lupopedia system
  tags:
  - headers
  - validation
  - requirements
...
- **Action:** Use `python lupo-scripts/validate_headers.py` to rewrite
...
### Required (All Files)
- **All doctrine files** - `lupo-rules/root/*.md`
- **All channel artifacts** - `lupo-channels/{channel_id}/**/*.md`
- **All version documents** - `lupo-docs/versions/{version}/**/*.md`
- **All status reports** - `lupo-docs/status/*.md`
- **All broadcast messages** - `lupo-channels/{channel_id}/broadcasts/*.md`
...
python lupo-scripts/validate_headers.py [directory]

# Validate single file
python lupo-scripts/validate_headers.py [file]
```
...
lupopedia.headers:
  ...
  file_path_from_root: lupo-rules/root/[FILENAME].md
  web_path: http://www.lupopedia.com/lupo-rules/root/[FILENAME].md
...
lupopedia.headers:
  ...
  file_path_from_root: lupo-channels/[channel_id]/[type]/[FILENAME].md
  web_path: http://www.lupopedia.com/lupo-channels/[channel_id]/[type]/[FILENAME].md
  last_modified_utc: YYYYMMDDHHIISS
  system_version: 4.0.89
...
python lupo-scripts/validate_headers.py lupo-rules/root/

# Validate specific file
python lupo-scripts/validate_headers.py lupo-rules/root/README.md

# Validate channel artifacts
python lupo-scripts/validate_headers.py lupo-channels/42/

# Check validation results
python lupo-scripts/validate_headers.py --report lupo-rules/root/
```
