...
**file_path_from_root:** lupo-rules/root/SHARED_HOSTING_DOCTRINE.md  
**web_path:** http://www.lupopedia.com/lupo-rules/root/SHARED_HOSTING_DOCTRINE.md  
...
```php
// These constants are defined in lupo-config.php
...
$config_path = __DIR__ . '/../lupo-config.php';

// WRONG - Absolute system path
$config_path = '/var/www/html/lupopedia/lupo-config.php';
```
