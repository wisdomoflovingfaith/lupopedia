...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-prompts/cursor/20260306_actor_primary_key_restructure.md"
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "lupo-docs/doctrine/ACTOR_PRIMARY_KEY_DOCTRINE.md", type: "creates", weight: 1.0 }
  semantic_tags: ["cursor", "actor", "primary_key", "restructure", "directive"]

lupopedia.see:
  mappings:
    - ["lupo-prompts/cursor/20260306_actor_primary_key_restructure.md", "http://www.lupopedia.com/directives/ACTOR_PRIMARY_KEY_RESTRUCTURE"]
...
Create `lupo-database/migrations/20260306_actor_primary_key_migration.sql` (or under `lupo-database/lupopedia/mysql/` per project layout):
...
- Create `lupo-docs/doctrine/ACTOR_PRIMARY_KEY_DOCTRINE.md`: rationale, canonical actor names table, registry structure, code patterns (ActorService, FLARE, SQL joins), backward compatibility, migration path.
