...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-prompts/lilith/20260306_doctor_sql_final.md"
...
lupopedia.init:
  ...
  pre_actions:
    - type: dependency_check
      target: "lupo-prompts/lilith/20260306_doctor_sql_queries.md"

lupopedia.edges:
  outbound_edges:
    - { to: "lupo-prompts/lilith/20260306_doctor_sql_queries.md", type: "verifies", weight: 1.0 }
    - { to: "lupo-docs/TASK_STATUS_REFERENCE.md", type: "references", weight: 0.9 }
    - { to: "lupo-docs/doctrine/", type: "references", weight: 0.8 }
  semantic_tags: ["flare", "doctor", "sql", "verification", "complete", "lilith"]

lupopedia.see:
  mappings:
    - ["lupo-prompts/lilith/20260306_doctor_sql_final.md", "http://www.lupopedia.com/verification/DOCTOR_SQL_FINAL"]
