...
**Numeric channel trees** (e.g. channel **42**) may exist under the **active** `lupo-channels/` tree when provisioned by the router/seed, or **only** under **`lupo-channels_before_4_0_93/{channel_id}/`** for pre–4.0.93 snapshots. Do not assume `lupo-channels/42/` exists in the active tree without checking; **§6–8 example links** point at **archive** paths where those files are preserved.
...
`lupo-channels/{federation_node_id}/{channel_key}/{thread_key}/`

Example: `lupo-channels/0/organization/prd_29_project_organization/` with `decisions/`, `questions/`, `answers/`, `comments/` per **`lupo-docs/prd/17_decisions_format.md`**. Register channels in **`lupo-channels/channel_index.md`**. Pre–4.0.93 on-disk trees are archived under **`lupo-channels_before_4_0_93/`** (read-only; see **`lupo-docs/prd/29_project_structure.md`**).
...
- **Strategy reference:** [ATHENA thread-creation policy](../../lupo-channels_before_4_0_93/42/threads/1002/20260317_223020_athena_thread-creation-policy.md) (thread 1002; **archive**). **WOLFIE directive:** `20260317_224500_wolfie_thread-provisioning-option-a.md` (same thread).
...
- **Reference review:** [LILITH channel system review, thread 1001](../../lupo-channels_before_4_0_93/42/threads/1001/20260317_223420_lilith_channel-system-review.md) (**archive**).
...
- **Naming:** `YYYYMMDD_HHIISS_hermes_prompt_{target_slug}_{purpose}.md` — see [prompts README](../../lupo-channels_before_4_0_93/42/prompts/README.md) (**archive**).
...
- **Human directive:** [20260317_230500 wisdomoflovingfaith channel-system directive](../../lupo-channels_before_4_0_93/42/threads/1001/20260317_230500_wisdomoflovingfaith_channel-system-docs-and-routing-directive.md) (**archive**).
