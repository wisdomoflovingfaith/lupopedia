...
lupopedia.metadata:
  comment: "Convergence Doctrine - forced canonical system state adoption for all agents."

lupopedia.headers:
  lupopedia.version: "4.0.82"
  lupopedia.schema: "rule"
  system_version: "4.0.82"
  file_path_from_root: "lupo-rules/root/CONVERGENCE_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupo-rules/root/CONVERGENCE_DOCTRINE"
  ...
  purpose: "Canonical convergence doctrine - force all agents/facets/IDE surfaces to single reality"
  tags: ["wolfie", "convergence", "canonical", "no_drift", "identity_lock"]

lupopedia.rules:
  comment: "Convergence Doctrine - non-negotiable identity/state truth enforcement."
  declares:
    - rule_id: "CONVERGENCE001"
      rule_text: "All agents must converge to the same canonical system state; actor identity is permanent; state is mutable; always return canonical actors by actor_id even if banned; never create variant actors."
      scope: "all_agents"
  ...
  provenance:
    authored_by: "wolfie"
    authored_date: "20260319"
    last_reviewed_by: "wolfie"
    last_reviewed_date: "20260319"
    version: "1.0"
...
lupopedia.footer:
  ...
  next_action:
    ...
    - "Enforce variant actor bans"
    - "Audit compliance"

---

# file: CONVERGENCE DOCTRINE — canonical system reality enforcement
