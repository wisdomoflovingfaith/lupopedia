...
#   file_path_from_root: "lupo-api/dialog/post-message.php"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-api/dialog/post-message.php"
#   status: "complete"
...
function post_message_log_defect($pattern_id, $context = array())
{
    try {
        ...
        $context['emitter'] = 'lupo-api/dialog/post-message.php';
...
// lupo-docs/doctrine/COUNTING_IN_LIGHT_DOCTRINE.md: default neutral 666666 on this path.
