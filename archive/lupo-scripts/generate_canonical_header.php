...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-scripts/generate_canonical_header.php"
  questions_toon: null
  channel_id: 42
  actor_id: 102
  actor_name: "cursor"
...
{
    private const TEMPLATE_PATH = __DIR__ . '/../lupo-templates/canonical_wolfie_header_template.yaml';
