...
#   file_path_from_root: "lupo-scripts/import_channels_and_artifacts.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
# lupo-scripts on path for lib.* and db_config
...
def load_config():
    """Canonical DB config from resolved lupopedia-config.php only."""
