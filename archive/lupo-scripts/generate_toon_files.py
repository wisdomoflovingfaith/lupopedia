...
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/generate_toon_files.py"
#   status: "complete"
#   when_updated: "20260415233000"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/canonical/1026/04/generate-toon-files.toon"
#   atoms_toon: null
...
#   summary: "Exports live MySQL table schema to lupo-database/lupopedia/json and toon; structure only; optional install gap fill."
# ---------------------------------------------------------------------
"""
...
JSON_DIR = os.path.join(BASE_DIR, 'lupo-database', 'lupopedia', 'json')
TOON_DIR = os.path.join(BASE_DIR, 'lupo-database', 'lupopedia', 'toon')
