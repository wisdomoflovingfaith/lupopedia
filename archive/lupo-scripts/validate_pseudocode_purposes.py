...
per lupo-docs/prd/17_decisions_format.md (classification mirrors
...
# Repository root: parent of lupo-scripts/
...
def classify_purpose(filename, rel_norm):
    ...
    Aligns with lupo-docs/prd/17_decisions_format.md and validate_pseudocode_discipline.py:
    Purpose 1 — *_constitution.pseudo.md, 00_*.pseudo.md digests, lupopedia_quickstart.pseudo.md,
    and all .pseudo.md / .pseudo.txt under lupo-docs/decisions/pseudocode/ (cross-cutting routers).
    ...
    if fn.startswith("00_") and (fn.endswith(".pseudo.md") or fn.endswith(".pseudo.txt")):
        return "p1"
    # Entire lupo-docs/decisions/pseudocode/ tree = Purpose 1 digest/router (not .pseudo.php)
    if "lupo-docs/decisions/pseudocode/" in rel and (
