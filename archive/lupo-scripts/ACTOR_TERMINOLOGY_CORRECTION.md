...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-scripts/ACTOR_TERMINOLOGY_CORRECTION.md"
  web_path: "http://www.lupopedia.com/lupo-scripts/ACTOR_TERMINOLOGY_CORRECTION.md"
  last_modified_utc: "20260328120000"
  when_updated: "20260328120000"
  system_version: "4.0.89"
  channel_id: 42
  thread_id: "actor-terminology-correction"
  actor_id: 1
  actor_name: "wolfie"
  delegation_chain: "wolfie:root"
  artifact_type: documentation
  artifact_kind: terminology_correction
  purpose: Correct misleading variable names - users can only be one actor at a time
  tags:
  - "terminology"
  - "correction"
  - "actor"
...
lupopedia.edges:
  outbound_edges:
    - to: "lupo-includes/modules/actors/views/my-profile.php"
      type: references
      weight: 1.0
      reason: Fixed variable name from has_multiple_actors to user_can_switch_actors
    - to: "lupo-includes/themes/default/components/topbar.php"
      type: references
      weight: 1.0
      reason: Fixed variable name and comment for clarity
    - to: "lupo-includes/classes/AuthSessionManager.php"
      type: references
      weight: 1.0
      reason: Clarified that getActorsUserCanActAs returns available actors, not current actors
lupopedia.footer:
  ...
  next_action:
  - Review all actor-related code for similar terminology issues
  - Update documentation to clarify actor switching behavior
---

# file: ACTOR_TERMINOLOGY_CORRECTION.md — session: L-LUPO-WOLFIE — delegation: wolfie:root — web_path: http://www.lupopedia.com/lupo-scripts/ACTOR_TERMINOLOGY_CORRECTION.md
...
### **1. My Profile Page**
**File**: `lupo-includes/modules/actors/views/my-profile.php`
...
### **2. Topbar Component**
**File**: `lupo-includes/themes/default/components/topbar.php`
