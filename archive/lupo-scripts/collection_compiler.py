...
#   file_path_from_root: "lupo-scripts/collection_compiler.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/collection_compiler.py"
#   status: "complete"
#   when_updated: "20260412123957"
#   trust_tier: "staging"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/staging/2026/04/collection-compiler.toon"
#   atoms_toon: null
...
Doctrine (normative):
  lupo-docs/doctrine/collection_payload_format_v1_0_0.md
...
Coordination:
  lupo-docs/prd/50_agent_coordination_protocol.md section 1.4
  lupo-docs/prd/38_memory_unification.md section 18

CLI:
  python lupo-scripts/collection_compiler.py --repo-root . --config my_collection.json --output payload.json
...
Config JSON (minimal):
  {
    ...
    "federation_node_id": 0,
    "memory_key": "lupo-memory/development/canonical/1026/04/example",
    "public_url_prefix": "https://www.lupopedia.com/lupopedia",
    "provenance_actor_id": 102,
    "provenance_tool": "collection_compiler_v1",
    "tabs": [
      {"tab_id": 101, "tab_name": "PRDs", "file_patterns": ["lupo-docs/prd/00_*.md"]}
    ]
  }
