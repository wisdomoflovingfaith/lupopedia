...
#   file_path_from_root: "lupo-scripts/generate_headers.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/generate_headers.py"
#   status: "deprecated"
#   when_updated: "20260412021730"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/canonical/1026/04/generate-headers-deprecated.toon"
#   atoms_toon: null
...
1. **lupo-scripts/add_lupopedia_header_to_file.py** — bootstrap new files;
2. **lupo-scripts/normalize_lupopedia_md_header_25.py** — migrate dense v4.0.99 envelopes;
3. **python lupo-scripts/validate_lupopedia_headers_universal.py** — validate;
4. **lupo-scripts/import_content.py** — promote file + sync metadata/edges into DB.

**Archived (unsupported):** ``lupo-scripts/legacy/generate_headers_archived_20260412.py``
...
def main() -> int:
    ...
    if args.legacy_archive_path:
        print("lupo-scripts/legacy/generate_headers_archived_20260412.py")
        return 0
    ...
    sys.stderr.write(
        ...
        "  - python lupo-scripts/validate_lupopedia_headers_universal.py\n"
        "  - lupo-scripts/import_content.py (file to DB)\n\n"
        "Archived copy (unsupported): "
        "lupo-scripts/legacy/generate_headers_archived_20260412.py\n"
        "  python lupo-scripts/generate_headers.py --legacy-archive-path\n\n"
        "See: lupo-scripts/legacy/README.md\n"
    )
    return 3
