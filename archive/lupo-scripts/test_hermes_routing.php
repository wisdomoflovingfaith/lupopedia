...
#   file_path_from_root: "lupo-scripts/test_hermes_routing.php"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/test_hermes_routing.php"
#   status: "complete"
...
# ---------------------------------------------------------------------
/**
 * CLI regression test for HermesService (PRD 82). Survivability: lupo-docs/doctrine/SURVIVABILITY_DOCTRINE.md
 ...
 * Transcript JSONL: PRD 82 canonical path lupo-memory/transcripts/{federation_node_id}/{channel_key}/{thread_slug}.jsonl only;
 * no lupo-channels/{channel_id}/transcript.jsonl mirror.
 * mood_vector / Counting in Light: lupo-docs/doctrine/COUNTING_IN_LIGHT_DOCTRINE.md — this script does not set mood columns.
 */
...
$channelId = 42;
$assigneeActorId = 102;
// PRD 82 (lupo-docs/prd/82_hermes_message_routing_memory_gateway.md): transcript path is lupo-memory/transcripts only; no channel-based mirror.
$federation_node_id = 0;
$channel_key = 'development';
...
// PRD 82 canonical transcript path (lupo-docs/prd/82_hermes_message_routing_memory_gateway.md); no channel_id mirror under lupo-channels/.
$tpath = LUPOPEDIA_PATH . DIRECTORY_SEPARATOR . 'lupo-memory' . DIRECTORY_SEPARATOR . 'transcripts'
...
echo "[OK] Transcript written to lupo-memory/transcripts/{$federation_node_id}/{$channel_key}/{$thread_slug}.jsonl\n";
