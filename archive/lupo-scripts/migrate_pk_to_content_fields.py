...
#   file_path_from_root: "lupo-scripts/migrate_pk_to_content_fields.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/migrate_pk_to_content_fields.py"
#   status: "complete"
#   when_updated: "20260415180000"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/canonical/1026/04/migrate-pk-to-content-fields.toon"
#   atoms_toon: null
...
Usage:
  python lupo-scripts/migrate_pk_to_content_fields.py <file_or_glob> [<file2> ...]   # dry-run
  python lupo-scripts/migrate_pk_to_content_fields.py --commit <file_or_glob> ...   # write changes
  python lupo-scripts/migrate_pk_to_content_fields.py --all                          # scan git-tracked .md files (dry-run)
  python lupo-scripts/migrate_pk_to_content_fields.py --all --commit                 # write all
