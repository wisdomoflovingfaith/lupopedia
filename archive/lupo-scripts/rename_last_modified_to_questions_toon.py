...
#   file_path_from_root: "lupo-scripts/rename_last_modified_to_questions_toon.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/rename_last_modified_to_questions_toon.py"
#   status: "active"
#   when_updated: "20260415050000"
#   trust_tier: "staging"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/staging/2026/04/rename-last-modified-to-questions-toon.toon"
#   atoms_toon: null
...
#   title: ""
#   summary: "One-shot migration: rename last_modified_utc to questions_toon: null in the comment-grid own-headers of all Python scripts in lupo-scripts/ and lupo-bin/"
# ---------------------------------------------------------------------
"""
...
Usage:
    python lupo-scripts/rename_last_modified_to_questions_toon.py --dry-run
    python lupo-scripts/rename_last_modified_to_questions_toon.py
"""
...
def main():
    ...
    for d in ('lupo-scripts', 'lupo-scripts/lib', 'lupo-bin'):
        p = Path(d)
        if not p.is_dir():
            continue
        print(f'\n--- {d}/ ---')
