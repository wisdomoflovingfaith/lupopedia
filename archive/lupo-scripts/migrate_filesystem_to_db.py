...
#   file_path_from_root: "lupo-scripts/migrate_filesystem_to_db.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/migrate_filesystem_to_db.py"
#   status: "deprecated"
#   when_updated: "20260412015258"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/canonical/1026/04/migrate-filesystem-deprecated.toon"
#   atoms_toon: null
...
1. **lupo-scripts/import_content.py** — file promotion; deterministic **content_id** (SHA256);
2. **python lupo-scripts/validate_lupopedia_headers_universal.py** — header validation;
...
``lupo-scripts/legacy/migrate_filesystem_to_db_archived_20260412.py`` — prints an extra
...
def main() -> int:
    ...
    if args.legacy_archive_path:
        print("lupo-scripts/legacy/migrate_filesystem_to_db_archived_20260412.py")
        return 0
    ...
    sys.stderr.write(
        ...
        "Alternatives:\n"
        "  - lupo-scripts/import_content.py (deterministic content_id; header sync)\n"
        ...
        "lupo-scripts/legacy/migrate_filesystem_to_db_archived_20260412.py\n"
        "  python lupo-scripts/migrate_filesystem_to_db.py --legacy-archive-path\n\n"
