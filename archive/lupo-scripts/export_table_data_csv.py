...
#   file_path_from_root: "lupo-scripts/export_table_data_csv.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
SECURITY RULES:
  ...
  - Output directory: lupo-database/lupopedia/csv/ (gitignored)

Usage:
  python lupo-scripts/export_table_data_csv.py
  python lupo-scripts/export_table_data_csv.py --tables lupo_actors lupo_collections
  python lupo-scripts/export_table_data_csv.py --limit 100

Options:
  --tables TABLE [TABLE ...]   Export only these specific tables (still subject to exclusions)
  --limit N                    Max rows per table (default: 500)
  --output-dir PATH            Output directory (default: lupo-database/lupopedia/csv/)
"""
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", metavar="PATH",
                        help="Output directory (default: lupo-database/lupopedia/csv/)")
    ...
    if args.output_dir:
        ...
        output_dir = project_root / "lupo-database" / "lupopedia" / "csv"
