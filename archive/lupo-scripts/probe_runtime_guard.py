...
#   file_path_from_root: "lupo-scripts/probe_runtime_guard.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/probe_runtime_guard.py"
#   status: "complete"
#   when_updated: "20260412122132"
#   trust_tier: "staging"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/staging/2026/04/probe-runtime-guard.toon"
#   atoms_toon: null
...
Doctrine (normative human rules):
  lupo-docs/doctrine/AI_ACTOR_COMPETENCY_TEST_PATTERN.md
  lupo-docs/doctrine/AI_ACTOR_KNOWLEDGE_UPDATE_PROTOCOL.md
  lupo-docs/doctrine/AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md

Coordination PRD: lupo-docs/prd/50_agent_coordination_protocol.md sections 1.2-1.3
...
CLI:
  python lupo-scripts/probe_runtime_guard.py < sample.txt
  python lupo-scripts/probe_runtime_guard.py --file sample.txt
  python lupo-scripts/probe_runtime_guard.py --file sample.txt --no-fence
  python lupo-scripts/probe_runtime_guard.py --file sample.txt --prompt-file prompt.txt
  python lupo-scripts/probe_runtime_guard.py --file ack.txt --knowledge-ack
