...
#   file_path_from_root: "lupo-scripts/validate_livehelp_import.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
Usage: python lupo-scripts/validate_livehelp_import.py

DB: **lupopedia-config.php** via **lib.db_connection** (same resolver as other tools). Python is not
the installer: there is no env bypass if the config file is missing.
