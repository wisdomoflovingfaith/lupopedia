...
#   file_path_from_root: lupo-scripts/fix_web_path_https.py
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/fix_web_path_https.py"
#   status: "active"
#   when_updated: "20260415020000"
#   trust_tier: "staging"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/staging/2026/04/fix-web-path-https.toon"
#   atoms_toon: null
...
Targets: lupo-docs/prd/*.md by default.
Use --dir to point at another directory, or pass explicit file paths.

Usage:
  python lupo-scripts/fix_web_path_https.py --dry-run
  python lupo-scripts/fix_web_path_https.py
  python lupo-scripts/fix_web_path_https.py lupo-scripts/*.py lupo-includes/*.php
"""
...
def main():
    ...
    ap.add_argument('paths', nargs='*', help='Files to process (default: lupo-docs/prd/*.md)')
    ap.add_argument('--dir', default='lupo-docs/prd',
                    help='Directory to scan (default: lupo-docs/prd); scans *.md')
