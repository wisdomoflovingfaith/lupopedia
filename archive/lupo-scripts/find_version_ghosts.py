#!/usr/bin/env python3
"""
Scan lupo-docs/doctrine/ and lupo-docs/prd/ for 3.0.x contamination and related smells:
...
Usage:
  python lupo-scripts/find_version_ghosts.py
  python lupo-scripts/find_version_ghosts.py --out lupo-docs/implementations/29_project_structure/status/version_ghosts_report.json
  python lupo-scripts/find_version_ghosts.py --require-zero   # exit 1 if any finding
"""
...
# Legacy top-level paths called out in LILITH audit (not lupo-docs)
