...
#   file_path_from_root: "lupo-scripts/graph_reconciliation_pass.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/graph_reconciliation_pass.py"
#   status: "not_started"
#   when_updated: "20260411154305"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/canonical/1026/04/graph-reconciliation-pass.toon"
#   atoms_toon: null
...
Spec: ``lupo-docs/versions/4.0.99/BREAKTHROUGH_REGISTRY.md`` §2.10 (tri-surface HEADER <-> GRAPH <-> MIRROR,
...
Usage:
  ...
  python lupo-scripts/graph_reconciliation_pass.py --under lupo-docs/prd --json
  python lupo-scripts/graph_reconciliation_pass.py --under lupo-docs/versions/4.0.99 --verbose
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--under",
        default="",
        help="Restrict scan to this path relative to repo root (default: lupo-docs/prd).",
    )
    parser.add_argument("--json", action="store_true", help="Emit JSON report on stdout.")
    parser.add_argument("-v", "--verbose", action="store_true", help="Per-file stub lines to stderr.")
    args = parser.parse_args()

    under = (args.under or "").strip() or "lupo-docs/prd"
