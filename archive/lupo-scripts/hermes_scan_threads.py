...
#   file_path_from_root: "lupo-scripts/hermes_scan_threads.py"
#   questions_toon: null
#   channel_id: 42
#   actor_id: 102
#   actor_name: "cursor"
...
Usage:
  python lupo-scripts/hermes_scan_threads.py --repo-root . --channel 42 --threads 1001,1002
"""
...
def main():
    ...
    rows = []
    for tid in tids:
        d = os.path.join(root, "lupo-channels", str(args.channel), "threads", tid)
