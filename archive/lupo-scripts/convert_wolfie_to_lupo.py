...
Targets: lupo-docs/doctrine and lupo-docs/prd (excluding versions/3.0.x and archive).

Usage:
  python lupo-scripts/convert_wolfie_to_lupo.py          # dry-run (JSON to stdout)
  python lupo-scripts/convert_wolfie_to_lupo.py --apply  # write files
"""
