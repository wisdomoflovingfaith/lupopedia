...
#   file_path_from_root: "lupo-scripts/fix_double_headers.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/fix_double_headers.py"
#   status: "complete"
#   when_updated: "20260411035853"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/canonical/1026/04/fix-double-headers.toon"
#   atoms_toon: null
...
Usage:
  python lupo-scripts/fix_double_headers.py [--dry-run] [--backup] [--verbose] [--preset ...]
  python lupo-scripts/fix_double_headers.py --path "lupo-docs/prd/*.md"
  python lupo-scripts/fix_double_headers.py --file lupo-docs/prd/16_lupopedia_headers.md --verbose
  python lupo-scripts/fix_double_headers.py --universal-validate
"""
...
_PRESET_GLOBS = {
    "numbered-prd": "lupo-docs/prd/[0-9][0-9]_*.md",
    "all-prd": "lupo-docs/prd/*.md",
    "doctrine": "lupo-docs/doctrine/**/*.md",
    "lupo-docs": "lupo-docs/**/*.md",
}
