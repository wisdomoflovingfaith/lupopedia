 ...
 * Reports drift only; does not auto-correct. See lupo-docs/doctrine/SESSION_RECONCILIATION_DOCTRINE.md.
 *
 * Usage:
...
$sessionsDir = LUPOPEDIA_PATH . '/lupo-database/sessions';
$useDb = true;
...
if ($useDb && file_exists(LUPOPEDIA_PATH . '/lupo-includes/bootstrap.php')) {
    try {
