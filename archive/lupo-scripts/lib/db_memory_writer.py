...
#   file_path_from_root: "lupo-scripts/lib/db_memory_writer.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/lib/db_memory_writer.py"
#   status: "complete"
#   when_updated: "20260417113952"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/canonical/1026/04/db-memory-writer.toon"
#   atoms_toon: null
...
class DBMemoryWriter:
    def __init__(
        ...
        # Repository root: lupo-scripts/lib -> lupo-scripts -> repo
    ...
    def _write_toon_file_fallback(
        ...
        if not filesystem_path:
            ...
            filesystem_path = "lupo-memory/fallback/{0}.json".format(toon_id)
