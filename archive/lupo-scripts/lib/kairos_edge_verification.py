...
#   file_path_from_root: "lupo-scripts/lib/kairos_edge_verification.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/lib/kairos_edge_verification.py"
#   status: "complete"
#   when_updated: "20260412022326"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/canonical/115/04/kairos-edge-verification.toon"
#   atoms_toon: null
...
# (e.g. **1026** ≈ calendar **2026**) used under lupo-memory for many artifacts.
...
``lupo-memory/development/canonical/115/04/kairos-edge-verification.toon`` — **115**
is **KAIROS** ``actor_id``, not the **{year_offset}/{month}** bucket pattern
(e.g. **1026/04** for 2026) common elsewhere under ``lupo-memory/``. Both conventions
...
CLI (repo root):
  ...
  python lupo-scripts/lib/kairos_edge_verification.py --test --file lupo-docs/prd/16_lupopedia_headers.md
  python lupo-scripts/lib/kairos_edge_verification.py --stale-edges --limit 50
"""
