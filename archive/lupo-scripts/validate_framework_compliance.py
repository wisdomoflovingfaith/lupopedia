...
def validate_channel_content(channel_path):
    ...
    forbidden_patterns = [
        ...
        (r'```(sql|php|javascript|python)', "Code blocks in channel (should be in lupo-docs)"),
    ]
...
def main():
    ...
    if args.all:
        ...
        impl_base = os.path.join(script_dir, "..", "lupo-docs", "implementations")
        channels_base = os.path.join(script_dir, "..", "lupo-channels")
