...
#   file_path_from_root: "lupo-scripts/migrate_module_to_atoms_toon.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/migrate_module_to_atoms_toon.py"
#   status: "active"
#   when_updated: "20260415050000"
#   trust_tier: "staging"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/staging/2026/04/migrate-module-to-atoms-toon.toon"
#   atoms_toon: null
...
Usage:
  python lupo-scripts/migrate_module_to_atoms_toon.py [roots...] [--write] [--verbose]

Defaults:
  roots = lupo-docs/prd lupo-docs/doctrine lupo-scripts lupo-agents
...
def main() -> int:
    ...
    parser.add_argument("roots", nargs="*", default=["lupo-docs/prd", "lupo-docs/doctrine", "lupo-scripts", "lupo-agents"])
