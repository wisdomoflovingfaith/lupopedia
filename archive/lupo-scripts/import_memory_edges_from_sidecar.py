...
#   file_path_from_root: "lupo-scripts/import_memory_edges_from_sidecar.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/import_memory_edges_from_sidecar.py"
#   status: "complete"
#   when_updated: "20260417114057"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/canonical/1026/04/import-memory-edges-from-sidecar.toon"
#   atoms_toon: null
...
#   summary: "Scans lupo-memory sidecars, resolves outbound edge targets to memory_node_id or content_id, and inserts idempotent rows into lupo_memory_edges."
# ---------------------------------------------------------------------
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--root",
        default="lupo-memory",
        help="Root directory to scan for sidecar .json files (default: lupo-memory)",
    )
    parser.add_argument(
        "--sidecar",
        default="",
    ...
    sidecar_source_index = _build_sidecar_source_index((repo_root / "lupo-memory").resolve())
