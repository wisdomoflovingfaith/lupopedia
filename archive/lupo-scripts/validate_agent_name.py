...
#   file_path_from_root: "lupo-scripts/validate_agent_name.py"
#   web_path: "https://www.lupopedia.com/lupopedia/lupo-scripts/validate_agent_name.py"
#   status: "complete"
#   when_updated: "20260418153241"
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/canonical/1026/04/validate-agent-name.toon"
#   atoms_toon: null
...
#   summary: "Enforces DISALLOWED_AGENT_NAMES.md: exact set, regex patterns, charset; optional scan of lupo-agents for duplicates and collisions."
# ---------------------------------------------------------------------
"""
CLI validator for new agent pack slugs and agent.json agent_key/slug fields.

Normative list: lupo-docs/doctrine/DISALLOWED_AGENT_NAMES.md (keep in sync with DISALLOWED_EXACT below).
"""
...
# Must match lupo-docs/doctrine/DISALLOWED_AGENT_NAMES.md section 2 (exact names, lowercase).
...
def scan_root(repo_root, agents_subdir):
    """
    Scan top-level directories under lupo-agents: structural slug rules on dirname,
...
def main():
    ...
    parser.add_argument("--scan-root", action="store_true", help="Scan lupo-agents top-level dirs for duplicates and disallowed names")
    parser.add_argument(
        "--agents-dir",
        default="lupo-agents",
        help="Relative to repo root for --scan-root (default: lupo-agents)",
    )
