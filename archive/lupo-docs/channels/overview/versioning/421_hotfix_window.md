...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/channels/overview/versioning/4.2.1_hotfix_window.md"
  file_hash: "304ff86b3c9b3d46fb2e402b52c8fcaffeb1fef89d76ee336a8a7a1a8684c2b6"
...
lupopedia.headers:
  ...
  lupopedia.edges: []
  file_path_from_root: "lupo-docs\channels\overview\versioning\4.2.1_hotfix_window.md"
  file_hash: "675f09e56fa2b5fc958747612868239ab44a0a5a28ced0dec370741bf88dbdc7"
  file_path_from_root: "lupo-docs\channels\overview\versioning\4.2.1_hotfix_window.md"
  file_hash: "fd3801b576df34d39b89cc431a5a81cc7de8d409a8a93c0d620bf571abc961cb"
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for 4.2.1_hotfix_window.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "overview", "versioning", "421_hotfix_windowmd"]
  lupo_agent: "windsurf"
...
### **Documentation**
- `lupo-docs/versioning/4.2.1_hotfix_window.md` (this document)  
- `lupo-docs/versioning/4.2.1_changes.md` (summary of fixes applied)  
...
### **Registry**
- `lupo-database/hotfix_registry_4.2.1.json` (record of all fixes)  
- `lupo-docs/hotfixes/4.2.1/` (archived fix documentation)  
...
find . -name "*.md" -type f -exec grep -l "3.1.20" {} \; | while read file; do
...
| Version | `3.1.20` in file header | Change to `4.2.0` |
...
4. `lupo-docs/versioning/HOTFIX_PROCESS.md` - General procedures  
