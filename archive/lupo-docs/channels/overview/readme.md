...
lupopedia.headers:
  ...
  lupopedia.edges: []
  file_path_from_root: "lupo-docs\channels\overview\README.md"
  file_hash: "aa482a219f25eeddba29a4f384f186a9498a611b524a6526d4cf605fff25b1c1"
  file_path_from_root: "lupo-docs\channels\overview\README.md"
  file_hash: "54389609cb87251c3d9e953a006417f645c269e5f1bf1af544ab6bc4dfcae236"
  ...
  tags: ["docs", "channels", "overview", "readmemd"]
  lupo_agent: "windsurf"
...
- **[LEGACY_REFACTOR_PLAN.md](../developer/modules/LEGACY_REFACTOR_PLAN.md)** â€” Comprehensive plan for refactoring legacy GLOBAL_PROJECT_CRAFTY_SYNTAX files from `lupo-legacy/craftysyntax/` to `lupopedia/`
...
- **[AI_SCHEMA_GUIDE.md](../schema/AI_SCHEMA_GUIDE.md)** â€” Why `lupo-database/csv_data/` and `lupo-database/toon_data/` exist and why AI tools must use them

**Schema Reference Files:**
- `lupo-database/toon_data/*.toon` â€” 149 TOON files (read-only, auto-generated by Python script)
- `lupo-database/csv_data/*.csv` â€” CSV schema snapshots (lightweight, AI-friendly format)
- `lupo-database/refactors/*.toon` â€” Legacy table mapping files
...
**Note:** `lupo-docs/GETTING_STARTED/` directory is reserved for future Getting Started guides.
...
- **[COUNTING_IN_LIGHT.md](../appendix/appendix/COUNTING_IN_LIGHT.md)** â€” Counting-in-Light doctrine (mood vector color system)
...
8. **Schema Reference:** Use `lupo-database/toon_data/*.toon` files (read-only) for exact table structures
...
```
lupo-docs/
+-- core/           # Core architecture and design principles
+-- modules/        # First-party modules and integrations
+-- doctrine/       # Mandatory rules and non-negotiable principles
+-- lupo-agents/         # AI agent system and communication
+-- schema/         # Database schema and reference
+-- dev/            # Installation, setup, and development guides
+-- protocols/      # Communication and synchronization protocols
+-- history/        # Project history and lineage
+-- appendix/       # Reference materials and miscellaneous
+-- README.md       # This file
```
