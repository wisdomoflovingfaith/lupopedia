...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/channels/doctrine/MOOD_VECTOR_DOCTRINE.md"
...
**Critical:** R, G, and B are abstract emotional axes, not literal color meanings. User interfaces **MUST** treat `mood_vector` as coordinates, not as culturally fixed color semantics. The hex encoding is coincidental and carries no color semantics.
