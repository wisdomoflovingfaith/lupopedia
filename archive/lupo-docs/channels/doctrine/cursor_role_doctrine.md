...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/channels/doctrine/CURSOR_ROLE_DOCTRINE.md"
...
- **Emotional metadata** is stored per channel (mood vector, channel context)
...
- AI agents (WOLFIE, agape (Survivability lens), ROSE) join the channel to help the user
