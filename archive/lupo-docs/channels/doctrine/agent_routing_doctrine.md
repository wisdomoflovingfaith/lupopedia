...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/channels/doctrine/AGENT_ROUTING_DOCTRINE.md"
  file_hash: "fb266a699fd45b8bfc79e0244a9ae4c59c40965b2b96658f91c652ff00033b4d"
...
These values are extracted from mood_vector:

R = hex_to_int(mood_vector[0:2])  
G = hex_to_int(mood_vector[2:4])  
B = hex_to_int(mood_vector[4:6])
...
- identical mood_vector values must reuse cached currents,
