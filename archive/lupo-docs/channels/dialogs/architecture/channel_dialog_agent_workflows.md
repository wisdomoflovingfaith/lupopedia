...
lupopedia.headers:
  ...
  lupopedia.edges: []
  file_path_from_root: "lupo-docs\channels\dialogs\architecture\CHANNEL_DIALOG_AGENT_WORKFLOWS.md"
  file_hash: "3c6f00f4725477063f0250df0053d8b8b3b2e9d9c0d0a103e7fb3d7561dcb92b"
  file_path_from_root: "lupo-docs\channels\dialogs\architecture\CHANNEL_DIALOG_AGENT_WORKFLOWS.md"
  file_hash: "d85f2ccd34af08920edc7741b40988a708e1b785127ce1fef0c80dfe6e0ce7c7"
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for CHANNEL_DIALOG_AGENT_WORKFLOWS.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "dialogs", "architecture", "channel_dialog_agent_workflowsmd"]
  lupo_agent: "windsurf"
...
**Example:**
- Channel: `lupopedia 3.0.16 - lupo-channels/documentation/database refinement`
...
**Toon File Location:**
```
lupo-database/toon_data/<table_name>.toon
lupo-database/toon_data/<table_name>.txt
```

**Toon File Format:**
- JSON format containing table schema, column definitions, and sample data
- Generated by `lupo-database/generate_toon_files.py`
...
Toon files are generated by `lupo-database/generate_toon_files.py`:

**Command:**
```bash
python lupo-database/generate_toon_files.py [--limit=1000]
```

**Output:**
- `lupo-database/toon_data/<table_name>.toon` (JSON format)
- `lupo-database/toon_data/<table_name>.txt` (same content, different extension)
...
with open('lupo-database/toon_data/lupo_channels.toon', 'r') as f:
...
2. **Optional:** Read from `lupo-database/toon_data/<table_name>.toon` (schema reference)
...
- `mood_vector` â€” Mood color (6-char hex)
...
- **Location:** `lupo-database/toon_data/<table_name>.toon`
- **Format:** JSON with table schema, columns, sample data, migration metadata
- **Generation:** `lupo-database/generate_toon_files.py`
