...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/channels/schema/migrations/3.0.7.md"
...
1. **AI Uncertainty Expression Doctrine**
   - New doctrine file: `lupo-docs/doctrine/AI_UNCERTAINTY_EXPRESSION_DOCTRINE.md`
...
3. **TRUTH Module Test Data**
   - New SQL seed file: `lupo-database/install/truth_test_data_captain_wolfie.sql`
...
4. **Release Readiness Checklist**
   - New checklist file: `lupo-docs/RELEASE_READINESS_CHECKLIST_3.0.7.md`
...
1. Replace `lupo-includes/classes/ConnectionsService.php` with the updated version
...
SOURCE lupo-database/install/truth_test_data_captain_wolfie.sql;
```
...
1. Restore `lupo-includes/classes/ConnectionsService.php` from backup
...
- Check `lupo-docs/RELEASE_READINESS_CHECKLIST_3.0.7.md` for verification steps
