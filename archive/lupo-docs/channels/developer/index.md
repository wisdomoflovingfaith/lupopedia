...
lupopedia.headers:
  ...
  tags: ["docs", "channels", "developer", "indexmd"]
  lupo_agent: "windsurf"
...
dialog:
  speaker: JETBRAINS
  target: @everyone
  message: "Created channel index for developer documentation organization."
tags:
  categories: ["documentation", "index", "channels"]
  collections: ["core-docs"]
  channels: ["dev"]
file:
  title: "developer Channel Index"
  description: "Index for developer channel documentation"
  version: GLOBAL_CURRENT_LUPOPEDIA_VERSION
  status: published
  author: GLOBAL_CURRENT_AUTHORS
---

# developer Channel Index
...
- [dev/AUTH_INTEGRATION_CHECKS_3.0.8.md](dev/AUTH_INTEGRATION_CHECKS_3.0.8.md)
- [dev/AUTH_READINESS_REPORT_3.0.8.md](dev/AUTH_READINESS_REPORT_3.0.8.md)
- [dev/AUTH_SCHEMA_SUMMARY_3.0.8.md](dev/AUTH_SCHEMA_SUMMARY_3.0.8.md)
- [dev/AUTH_SQL_VERIFICATION_3.0.8.md](dev/AUTH_SQL_VERIFICATION_3.0.8.md)
- [dev/AUTH_TESTING_CHECKLIST_3.0.8.md](dev/AUTH_TESTING_CHECKLIST_3.0.8.md)
- [dev/CONTRIBUTOR_TRAINING.md](dev/CONTRIBUTOR_TRAINING.md)
- [dev/DOCUMENTATION_STYLE_GUIDE.md](dev/DOCUMENTATION_STYLE_GUIDE.md)
- [dev/FOR_INSTALLERS_AND_USERS.md](dev/FOR_INSTALLERS_AND_USERS.md)
- [dev/IDENTITY_PROPAGATION_COMPLETE.md](dev/IDENTITY_PROPAGATION_COMPLETE.md)
- [dev/INSTALLER_FLOW.md](dev/INSTALLER_FLOW.md)
- [dev/PHASE_A_CODE_UPDATE_PLAN.md](dev/PHASE_A_CODE_UPDATE_PLAN.md)
- [dev/TOON_METADATA_RECOMMENDATIONS.md](dev/TOON_METADATA_RECOMMENDATIONS.md)
- [dev/VERSION_PATCH_PROCEDURE.md](dev/VERSION_PATCH_PROCEDURE.md)
- [dev/WOLFIE_HEADER_GLOBAL_ATOMS_GUIDE.md](dev/WOLFIE_HEADER_GLOBAL_ATOMS_GUIDE.md)
- [dev/WOLFIE_TIMESTAMP_DOCTRINE.md](dev/WOLFIE_TIMESTAMP_DOCTRINE.md)
- [DEVELOPER_GUIDELINES.md](DEVELOPER_GUIDELINES.md)
- [LUPOPEDIA_HELP.md](LUPOPEDIA_HELP.md)
- [modules/CONTENT_INTERFACE_AND_NAVIGATION.md](modules/CONTENT_INTERFACE_AND_NAVIGATION.md)
- [modules/HELP_LIST_MODULES_COMPLETE.md](modules/HELP_LIST_MODULES_COMPLETE.md)
- [modules/LEGACY_REFACTOR_PLAN.md](modules/LEGACY_REFACTOR_PLAN.md)
