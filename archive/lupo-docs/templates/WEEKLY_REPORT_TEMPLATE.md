...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/templates/WEEKLY_REPORT_TEMPLATE.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/templates/WEEKLY_REPORT_TEMPLATE.md"
  status: "active"
  when_updated: "20260417002719"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/weekly-report-template.toon"
  atoms_toon: null
  ...
  summary: "Reusable weekly management report skeleton. Canonical example: lupo-docs/versions/4.1.2/status/ACCEPTED_WEEKLY_REPORT_2026_04_16.md. Fill placeholders; keep traceability."
---
# file: WEEKLY_REPORT_TEMPLATE.md — template — web_path: [https://www.lupopedia.com/lupopedia/lupo-docs/templates/WEEKLY_REPORT_TEMPLATE.md](https://www.lupopedia.com/lupopedia/lupo-docs/templates/WEEKLY_REPORT_TEMPLATE.md)

<!--
This template is derived from an accepted management report (2026-04-16).

Canonical example (immutable): lupo-docs/versions/4.1.2/status/ACCEPTED_WEEKLY_REPORT_2026_04_16.md
...
<!-- Typical rows: this file path; memory JSON+TOON pair; atoms_toon if used; transcript.jsonl + THREAD_MANIFEST; evidence index; translation model; continuity doctrine; staging handoffs. Copy row shape from lupo-docs/versions/4.1.2/status/ACCEPTED_WEEKLY_REPORT_2026_04_16.md section 15. -->
