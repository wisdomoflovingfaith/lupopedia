...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.99/status/session_report_20260412_eod_kairos_pattern6_agents_cursor102.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.0.99/status/session_report_20260412_eod_kairos_pattern6_agents_cursor102.md"
  questions_toon: null
  federation_node_id: 0
  channel_key: "development"
  trust_tier: "canonical"
  memory_key: "lupo-memory/development/canonical/1026/04/session-report-20260412-eod-kairos.toon"
...
**Anchored:** **`20260412023225`** (`python lupo-bin/tick.py`). **Wall time:** **02:32 UTC**.
...
| **`AGENTS.md` `memory_key`** | Validator **PASS** without **`--strict-memory-pair`**; strict CI may require creating **`lupo-memory/.../agents-md.toon`** (+ JSON) and restoring edge/footer payload into sidecar. |
