...
57 of 178 tables have no `.md` file in `lupo-docs/database/lupopedia/tables/active/`.
...
|--------|-------------|-------|
| Install SQL | `lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql` | 4,770 lines, 178 tables |
| JSON schemas | `lupo-database/lupopedia/json/*.json` | 179 files |
| Table docs | `lupo-docs/database/lupopedia/tables/active/*.md` | 121 files |
