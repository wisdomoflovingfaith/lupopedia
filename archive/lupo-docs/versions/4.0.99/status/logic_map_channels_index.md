...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.0.99/status/logic_map_channels_index.md"
  web_path: "https://www.lupopedia.com/lupopedia/logic_map_channels_index"
  questions_toon: null
  federation_node_id: 0
  channel_key: "development"
  trust_tier: "canonical"
  memory_key: "lupo-memory/development/canonical/1026/04/logic-map-channels-index-toon"
...
**References**:
- PRD 02: `lupo-docs/prd/02_channels_discussions.md`
- Truth Anchor: `lupo-memory/development/canonical/1026/04/readme-wtf-md.toon`
- Table JSONs: `lupo-database/lupopedia/json/`
