...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.4/status/canonical_22_field_rebuild_report.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.4/status/canonical_22_field_rebuild_report.md"
  status: "active"
  when_updated: "20260422030000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/canonical-22-field-rebuild-report.toon"
  atoms_toon: null
...
```bash
# Test Results:
python lupo-scripts/validate_lupopedia_headers_universal.py --reject-legacy-fields test_content_slug.md
# ❌ Exit code: True (FAILED) - content_slug rejected

python lupo-scripts/validate_lupopedia_headers_universal.py --reject-legacy-fields test_pk_slug.md  
# ❌ Exit code: True (FAILED) - pk_slug rejected

python lupo-scripts/validate_lupopedia_headers_universal.py --reject-legacy-fields test_prd_slug.md
# ❌ Exit code: True (FAILED) - prd_slug rejected

python lupo-scripts/validate_lupopedia_headers_universal.py --reject-legacy-fields test_missing_prd_cluster.md
...
- `lupo-hooks/pre-commit.sh` (Linux/Mac)
- `lupo-hooks/pre-commit.bat` (Windows)
...
### Test Infrastructure
- `lupo-scripts/test_canonical_22_field_validation.py`
...
`lupo-scripts/lib/header_spec_v3_1.py` is now the **single source of truth**:
...
python lupo-scripts/validate_lupopedia_headers_universal.py --reject-legacy-fields
...
python lupo-scripts/validate_lupopedia_headers_universal.py --reject-legacy-files
python lupo-hooks/pre_commit_validate.py
