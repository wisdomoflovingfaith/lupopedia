...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.4/status/install_wizard_classes_header_alignment.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.4/status/install_wizard_classes_header_alignment.md"
  status: "active"
  when_updated: "20260422100000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/install-wizard-classes-header-alignment.toon"
  atoms_toon: null
...
8. ✅ `memory_toon` - "lupo-memory/development/canonical/1026/04/install-wizard-classes-php.toon"
9. ✅ `atoms_toon` - null
