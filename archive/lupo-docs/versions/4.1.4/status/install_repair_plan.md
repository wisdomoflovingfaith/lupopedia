...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.4/status/install_repair_plan.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.4/status/install_repair_plan.md"
  status: "active"
  when_updated: "20260422095000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/install-repair-plan.toon"
  atoms_toon: null
...
- System requires "4.1.4" per PRD 16 + PRD 86
- **Severity:** CRITICAL
- **File:** `install.php`
...
3. Change to: `header_format_version: "4.1.4"`
4. Save file
...
**Steps:**
1. Create archive directory: `lupo-archive/seed-files/`
...
- `lupo-database/lupopedia/mysql/install/install_new_lupopedia_backup_20260406.sql`
- `lupo-database/lupopedia/mysql/install/install_new_lupopedia_clean.sql`
- `lupo-database/lupopedia/mysql/import/import_from_old_crafty_syntax_old_20260406.sql`

**Steps:**
1. Create archive directory: `lupo-archive/sql-backups/`
