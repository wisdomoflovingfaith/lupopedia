...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/versions/4.1.4/status/agent_alias_normalization_report.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.4/status/agent_alias_normalization_report.md"
  status: active
  when_updated: "20260422010000"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/agent-alias-normalization-report.toon
  atoms_toon: null
...
**Location:** `lupo-config/naming_aliases.json`
...
**Location:** `lupo-scripts/agent_alias_resolver.py`
...
```bash
# Test resolution
python lupo-scripts/agent_alias_resolver.py --test

# List all mappings
python lupo-scripts/agent_alias_resolver.py --list

# Resolve specific name with debug
python lupo-scripts/agent_alias_resolver.py gemni --debug

# Verify no prefix matching
python lupo-scripts/agent_alias_resolver.py ca  # Returns "ca" unchanged
```
...
- **NEW:** `lupo-config/naming_aliases.json` - Alias configuration
- **NEW:** `lupo-scripts/agent_alias_resolver.py` - Resolver utility
- **NEW:** `lupo-docs/versions/4.1.4/status/agent_alias_normalization_report.md` - This report
- **REMOVED:** `lupo-registry/agent_aliases.json` - Moved to lupo-config
...
4. **Moved config to lupo-config** - Proper separation of concerns
