...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.4/status/REPORT_49_DB_ALIGNMENT_20260421.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.4/status/REPORT_49_DB_ALIGNMENT_20260421.md"
  status: "active"
...
`lupo-memory/{channel_key}/questions/{YYYY}/{MM}/{slug}.questions.toon`. The `slug` comes
