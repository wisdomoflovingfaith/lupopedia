...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.4/status/pk_naming_fix_for_missing_install_tables.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.4/status/pk_naming_fix_for_missing_install_tables.md"
  status: "active"
  when_updated: "20260422100000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/pk-naming-fix-for-missing-install-tables.toon"
  atoms_toon: null
...
**File:** `lupo-docs/prd/00_C_ROOT_CONSTITUTIONAL_SYSTEM_REQUIREMENTS.md`
...
### Migration SQL
**File:** `lupo-database/lupopedia/mysql/migrations/4_1_2_orchestration_tables.sql`
**Changes:**
...
### PRD Documentation
**File:** `lupo-docs/prd/08_A_CORE_AGENTS_SYSTEM.md`
**Changes:**
...
**File:** `lupo-docs/prd/82_A_HERMES_MESSAGE_ROUTING_MEMORY_GATEWAY.md`
**Changes:**
- Updated `prd_cluster` to include constitutional requirements
