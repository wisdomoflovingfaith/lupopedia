...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/versions/4.1.4/status/validator_null_id_parent_patch_report.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.4/status/validator_null_id_parent_patch_report.md"
  status: active
  when_updated: "20260422020000"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/validator-null-id-parent-patch-report.toon
  atoms_toon: null
...
`lupo-docs/versions/4.1.4/status/validator_null_id_parent_patch_report.md`
