...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.4/status/fresh_reinstall_preflight_checklist.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.4/status/fresh_reinstall_preflight_checklist.md"
  status: "active"
  when_updated: "20260422094500"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/fresh-reinstall-preflight-checklist.toon"
  atoms_toon: null
  ...
  summary: "Complete pre-flight checklist for safe fresh reinstall testing of Lupopedia 4.1.4."
---
...
### 🚨 CRITICAL BLOCKERS
- [ ] install.php header version updated to 4.1.4
...
- [ ] install.php header version is 4.1.2 (must be 4.1.4)
...
Fix install.php header version to 4.1.4, then proceed with fresh reinstall testing.
