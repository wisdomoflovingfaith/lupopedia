...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.4/changelog.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.4/changelog.md"
  status: "active"
  when_updated: "20260421050000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/version-4-1-4-changelog.toon"
  atoms_toon: null
  ...
  content_slug: "version-4-1-4-changelog"
  cluster_name: "version-4-1-4"
  artifact_number: "001"
---

# Lupopedia Version 4.1.4 Changelog

## Overview
Version 4.1.4 implements the PRD system transformation from documentation to a semantic operating system with standardized naming conventions.
...
### Global Atoms Update
- Updated `GLOBAL_CURRENT_LUPOPEDIA_VERSION` to "4.1.4"
...
- Version 4.1.4 directory structure created
