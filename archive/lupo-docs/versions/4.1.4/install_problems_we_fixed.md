...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.4/install_problems_we_fixed.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.4/install_problems_we_fixed.md"
  status: "active"
  when_updated: "20260422000000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/install_problems_we_fixed.toon"
  atoms_toon: null
...
**Root Cause:** Installer uses `install/seed_lupopedia_4_1_0.sql`, not the version in `lupo-database/` directory.
...
2. `lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql` - Fixed SQL syntax errors
