...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.0/open_questions.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.0/open_questions.md"
  status: "active"
  when_updated: "20260415102813"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/version-4-1-0-open-questions.toon"
  atoms_toon: null
...
- Merged from `lupo-docs/versions/4.1.0/status/open_questions.md` on 20260415101800; that file is now deleted.
...
`lupo-database/lupopedia/json/lupo_dialog_messages.json`.
...
**FILE / AREA:** `lupo-api/dialog/fetch-messages.php` — polling endpoint
...
**WHEN:** 20260415091500
**WHO:** AUGGIE
**AREA:** lupo-scripts/validate_lupopedia_headers_universal.py + PRD 16
**STATUS:** open
...
2. Require `/lupo-memory/atoms/canonical/1026/...` for all atoms_toon
...
**QUESTION:**
Should the canonical active plan live only in `lupo-docs/versions/4.1.0/plan.md`, or should there also be a root-level planning file (e.g. `plan.md` or `4.1.0-plan.md` at repo root) aligned to Codex markdown structure?
...
**QUESTION:**
PRD 02 documents the live feed polling endpoint as `GET /api/chat/messages`. `channels/index.php` polls `GET /lupo-api/dialog/fetch-messages.php`. These are different URL namespaces and conventions. Which is canonical? Is `/api/chat/messages` an aspirational spec or a future refactor target?
...
**OPTIONS:**
1. Adopt `/lupo-api/dialog/fetch-messages.php` as canonical; update PRD 02
...
## OQ-11: Tasks sidebar element `lupo-tasks-list` is not in the HTML
...
**OPTIONS:**
1. Add `<div id="lupo-tasks-list">` to the channel sidebar HTML
...
2. Build standalone `lupo-api/hermes/route.php` called after message save
...
## OQ-18: `lupo-layers.js` dependency — undocumented; PRD 02 forbids framework polyfills
...
**QUESTION:**
`channels/index.php` loads `<script src="<?= $base ?>/lupo-includes/js/lupo-layers.js"></script>` before the inline polling JS. PRD 02 says the polling loop MUST be plain JavaScript with no framework polyfills. What is `lupo-layers.js`? Is it a utility library, a framework shim, or part of the admin layout? Is it required for the channel page or is it loaded by the admin layout template unconditionally?

**WHY THIS MATTERS:**
If `lupo-layers.js` provides polyfills or overrides `fetch`, the transport model behavior may differ across environments. PRD 02's "no framework" rule is a constitutional constraint.

**OPTIONS:**
1. Document `lupo-layers.js` in PRD 02 as the approved utility layer
...
**WHEN:** 20260415101800
**WHO:** AUGGIE
**AREA:** lupo-includes/modules/content/content-controller.php
**STATUS:** open
...
**WHEN:** 20260415101800
**WHO:** AUGGIE
**AREA:** lupo-docs/prd/73_collections_navigation.md §Table Details vs content-controller.php L1071-1077
**STATUS:** open
...
**WHEN:** 20260415101800
**WHO:** AUGGIE
**AREA:** lupo-docs/prd/73_collections_navigation.md §8 (Sync Strategy)
**STATUS:** open
...
**WHEN:** 20260415101800
**WHO:** AUGGIE
**AREA:** lupo-docs/prd/73_collections_navigation.md §Tables in This Namespace
**STATUS:** open
...
**WHEN:** 20260415101800
**WHO:** AUGGIE
**AREA:** lupo-docs/prd/73_collections_navigation.md — `lupo_collections.item_count`; `lupo_folder_map.item_count`
**STATUS:** open
...
**WHEN:** 20260415101800
**WHO:** AUGGIE
**AREA:** lupo-docs/prd/73_collections_navigation.md §lupo_paths vs lupo-includes/modules/module-loader.php
**STATUS:** open
...
<!-- Canonical refs: lupo-docs/doctrine/counting_in_light.md,    -->
<!-- lupo-docs/doctrine/mood_vector_doctrine.md,                    -->
...
**WHEN:** 20260415102457
**WHO:** AUGGIE
**AREA:** lupo-docs/doctrine/counting_in_light.md + mood_vector_doctrine.md vs channels/index.php L175
...
**OPTIONS:**
1. Add `mood_vector` validation to `lupo-api/dialog/send-message.php` — accept any hex but flag non-canonical values with a WARN log
