...
lupopedia.headers:
  ...
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.0/CHANGELOG.md"
  status: "active"
  when_updated: "20260415101800"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/version-4-1-0-changelog.toon"
  atoms_toon: null
...
---
# file: Lupopedia 4.1.0 changelog — session: 4.1.0 — delegation: wolf:root — web_path: [https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.0/CHANGELOG.md](https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.0/CHANGELOG.md)
...
**Files:**
- lupo-docs/prd/02_channels_discussions.md (header only)
...
**Files:**
- lupo-docs/versions/4.1.0/CHANGELOG.md (new)
- lupo-docs/versions/4.1.0/status/open_questions.md (new)
- lupo-docs/versions/4.1.0/plan.md (new)
...
**Files:**
- lupo-docs/prd/02_channels_discussions.md (body only; header preserved)
...
- Created 10 new `.toon` sidecar files in `lupo-memory/development/canonical/1026/04/`
...
- lupo-memory/development/canonical/1026/04/readme-root.toon (updated)
- lupo-memory/development/canonical/1026/04/agents-md.toon (updated)
- lupo-memory/development/canonical/1026/04/root-changelog.toon (updated)
- lupo-memory/development/canonical/1026/04/lupopedia-quick-reference.toon (updated)
- lupo-memory/development/canonical/1026/04/claude-md.toon (new)
- lupo-memory/development/canonical/1026/04/cursor-md.toon (new)
- lupo-memory/development/canonical/1026/04/gemini-md.toon (new)
- lupo-memory/development/canonical/1026/04/contributing-md.toon (new)
- lupo-memory/development/canonical/1026/04/onboarding-md.toon (new)
- lupo-memory/development/canonical/1026/04/quickstart-md.toon (new)
- lupo-memory/development/canonical/1026/04/organization-md.toon (new)
- lupo-memory/development/canonical/1026/04/changelog-archive.toon (new)
- lupo-memory/development/canonical/1026/04/captain-wolfie-workflow.toon (new)
- lupo-memory/development/canonical/1026/04/todo-md.toon (new)
...
**What changed:**
- Reviewed PRD 02 against `channels/index.php`; added OQ-03 through OQ-16 (14 questions) to `lupo-docs/versions/4.1.0/status/open_questions.md`
...
**Files:**
- lupo-docs/versions/4.1.0/status/open_questions.md (OQ-03 through OQ-28 added; when_updated bumped)
