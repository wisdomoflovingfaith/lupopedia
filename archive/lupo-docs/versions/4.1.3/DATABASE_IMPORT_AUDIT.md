...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.3/DATABASE_IMPORT_AUDIT.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.3/DATABASE_IMPORT_AUDIT.md"
  status: "active"
  when_updated: "20260419200000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/database/canonical/1026/04/database-import-audit.toon"
  atoms_toon: null
...
**Files Analyzed**: 
- `lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql` (142 tables)
- `lupo-database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql` 
- `lupo-database/lupopedia/mysql/import/old_crafty_syntax_3_7_5_start.sql` (34 tables)
