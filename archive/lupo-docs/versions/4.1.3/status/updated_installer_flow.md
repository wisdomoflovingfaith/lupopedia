...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.3/status/updated_installer_flow.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.3/status/updated_installer_flow.md"
  status: "active"
  when_updated: "20260420080000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/registry/status/1026/04/updated-installer-flow.toon"
  atoms_toon: null
...
**Features:**
- Scan lupo-actors/ directory for numeric actor IDs
...
$memory_config = [
    'memory_path' => LUPOPEDIA_PATH . '/lupo-memory',
    'handoff_path' => LUPOPEDIA_PATH . '/lupo-handoffs',
    'actor_memory' => []
];
...
- `lupo-memory/actors/{actor_id}/` - Individual actor memory
- `lupo-handoffs/{actor_name}/` - Actor handoff directories
- `lupo-channels/registry/` - Channel registry storage
