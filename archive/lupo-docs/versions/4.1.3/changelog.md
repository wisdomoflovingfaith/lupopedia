...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.3/changelog.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.3/changelog.md"
  status: "active"
  when_updated: "20260420180000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/version-4-1-3-changelog.toon"
  atoms_toon: null
  ...
  summary: "Entries appended from lupo-changelog-pending JSON by consolidate_lupo_changelog_pending.py."
---
# Lupopedia 4.1.3 -- Changelog

Consolidated **buffer** entries (WHO / UTC / WHAT) from `lupo-changelog-pending/*.json` per
...
- All installer, wizard, and import logic now load JSON schemas from lupo-database/lupopedia/json/
...
- Created/updated lupo-install/ImportLegacyCraftySyntax.php
- Loads JSON schema
...
## Entry
<!-- lupo-changelog-merged: 20260419211230_cursor_seed_dependency_doc_hardening.json -->
...
- **WHAT:**
  ...
  - Files: `lupo-docs/versions/4.1.3/DATABASE_SEED_DEPENDENCIES.md`

## Entry
<!-- lupo-changelog-merged: 20260420074000_cascade_installer_wizard_debugging_analysis.json -->
...
- **WHAT:**
  ...
  - Files created:
    - `lupo-docs/versions/4.1.3/status/install_wizard_analysis.md`
    - `lupo-docs/versions/4.1.3/status/updated_installer_flow.md`
    - `lupo-docs/versions/4.1.3/status/filesystem_seed_analysis.md`
    - `lupo-docs/versions/4.1.3/status/actor_rebuild_plan.md`
    - `lupo-database/lupopedia/mysql/seed/seed_4.1.3.sql`
    - `lupo-database/lupopedia/mysql/migrate/actor_rebuild_4.1.3.sql`
    - `lupo-docs/versions/4.1.3/status/updated_installer_screens.md`
...
## Entry
<!-- lupo-changelog-merged: 20260419200000_cascade_database_import_reconciliation.json -->
- **WHO:** cascade (actor_id 102)
...
- **WHAT:**
  ...
  - Files: 
    ...
    - `lupo-docs/versions/4.1.3/DATABASE_IMPORT_AUDIT.md` (NEW)
    - `lupo-docs/versions/4.1.3/PLAN_DATABASE_CORRECTION.md` (NEW)
    - `lupo-docs/versions/4.1.3/TODO.md` (updated)
  - Status: Import script now safe with warnings, critical blockers removed

## Entry
<!-- lupo-changelog-merged: 20260419203000_cascade_actor_auth_linkage_repair.json -->
- **WHO:** cascade (actor_id 102)
...
- **WHAT:**
  ...
  - Files: `lupo-database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql`
  - Status: Actor linkage repaired, canonical identity mapping preserved

## Entry
<!-- lupo-changelog-merged: 20260419204500_cascade_incomplete_mappings_documentation.json -->
- **WHO:** cascade (actor_id 102)
...
- **WHAT:**
  ...
  - Files: 
    - `lupo-docs/versions/4.1.3/DATABASE_INCOMPLETE_MAPPINGS.md` (NEW)
    - `lupo-database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql` (comments)
    - `lupo-docs/versions/4.1.3/TODO.md` (updated)
  - Status: 5 tables require decisions on import strategy

## Entry
<!-- lupo-changelog-merged: 20260419210000_cascade_mapping_classification.json -->
- **WHO:** cascade (actor_id 102)
...
- **WHAT:**
  ...
  - Files: 
    - `lupo-docs/versions/4.1.3/DATABASE_MAPPING_CLASSIFICATION.md` (NEW)
    - `lupo-docs/versions/4.1.3/DATABASE_INCOMPLETE_MAPPINGS.md` (updated)
    - `lupo-docs/versions/4.1.3/TODO.md` (updated)
    - `lupo-database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql` (comments)
  - Status: 1 patchable now, 2 seed-dependent, 2 deferred, 1 intentionally dropped

## Entry
<!-- lupo-changelog-merged: 20260419211500_cascade_livehelp_modules_patch.json -->
- **WHO:** cascade (actor_id 102)
...
- **WHAT:**
  ...
  - Files: 
    - `lupo-database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql` (patched)
    - `lupo-docs/versions/4.1.3/DATABASE_INCOMPLETE_MAPPINGS.md` (updated)
    - `lupo-docs/versions/4.1.3/DATABASE_MAPPING_CLASSIFICATION.md` (updated)
    - `lupo-docs/versions/4.1.3/TODO.md` (updated)
  - Status: livehelp_modules fully patched, 4 tables remaining incomplete

## Entry
<!-- lupo-changelog-merged: 20260419213000_cascade_seed_dependency_analysis.json -->
- **WHO:** cascade (actor_id 102)
...
- **WHAT:**
  ...
  - Files: 
    - `lupo-docs/versions/4.1.3/DATABASE_SEED_DEPENDENCIES.md` (NEW)
    - `lupo-docs/versions/4.1.3/DATABASE_MAPPING_CLASSIFICATION.md` (updated)
    - `lupo-docs/versions/4.1.3/TODO.md` (updated)
    - `lupo-database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql` (comments)
...
## Entry
<!-- lupo-changelog-merged: 20260417071250_cursor_5f8c3a7be6514870a6ce96f85d1143f1.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `AGENTS.md`, `lupo-docs/doctrine/CHANGELOG_BUFFER_ARCHITECTURE.md`
  - Related toons:
    - `lupo-memory/development/canonical/1026/04/agents-md.toon`
    - `lupo-memory/development/canonical/1026/04/changelog-buffer-architecture-md.toon`

## Entry
<!-- lupo-changelog-merged: 20260417071544_cursor_7a4b9f2d1c.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260417071640_cursor_c9e8f4d2ab.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-includes/bootstrap.php`, `lupo-docs/versions/4.1.2/buffer/20260417071640_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417071904_cursor_1d2f8b6a4c.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupopedia-config-sample.php`, `lupo-docs/versions/4.1.2/buffer/20260417071904_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417072047_cursor_8e1c4d6ab2.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-includes/classes/LupopediaConfigResolver.php`, `lupo-docs/versions/4.1.2/buffer/20260417072047_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417072349_cursor_e5b2d7f9a1.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `install_wizard_classes.php`, `lupo-docs/versions/4.1.2/buffer/20260417072349_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417072515_antigravity_a1b2c3.json -->
- **WHO:** antigravity
...
- **WHAT:**
  ...
  - Files: `lupo-includes/bootstrap.php`

## Entry
<!-- lupo-changelog-merged: 20260417072637_cursor_3ab7f1d2c4.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `install_wizard_classes.php`, `lupo-docs/versions/4.1.2/buffer/20260417072637_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417072645_antigravity_cfgsmp.json -->
- **WHO:** antigravity
- **CHANNEL / THREAD:** development / header-update
...
## Entry
<!-- lupo-changelog-merged: 20260417072802_antigravity_instwiz.json -->
- **WHO:** antigravity
- **CHANNEL / THREAD:** development / header-update
...
## Entry
<!-- lupo-changelog-merged: 20260417072820_cursor_9bf4d1e2a8.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `app/Services/ApiProviderChainService.php`, `lupo-docs/versions/4.1.2/buffer/20260417072820_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417072920_antigravity_polish.json -->
- **WHO:** antigravity
- **CHANNEL / THREAD:** development / header-update
...
## Entry
<!-- lupo-changelog-merged: 20260417072920_cursor_4d1a8f2bce.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `install.php`, `lupo-docs/versions/4.1.2/buffer/20260417072920_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417073013_cursor_6e1b2d4fa9.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/16_lupopedia_headers.md`, `lupo-docs/prd/16_lupopedia_headers_migration.md`, `lupo-docs/prd/16_lupopedia_headers_examples.md`, `lupo-docs/versions/4.1.2/buffer/20260417073013_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417073210_antigravity_clean.json -->
- **WHO:** antigravity
- **CHANNEL / THREAD:** development / header-update
...
## Entry
<!-- lupo-changelog-merged: 20260417073224_cursor_b2e91c4d7a.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `AGENTS.md`, `lupo-docs/versions/4.1.2/buffer/20260417073224_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417073324_antigravity_inst.json -->
- **WHO:** antigravity
- **CHANNEL / THREAD:** development / header-update
...
## Entry
<!-- lupo-changelog-merged: 20260417073437_cursor_8c2e1f5ab4.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/doctrine/CHANGELOG_BUFFER_ARCHITECTURE.md`, `lupo-docs/versions/4.1.2/buffer/20260417073437_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417073556_cursor_a9d24e1f6b.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-includes/bootstrap.php`, `lupo-docs/versions/4.1.2/buffer/20260417073556_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417073722_antigravity_boot.json -->
- **WHO:** antigravity
- **CHANNEL / THREAD:** development / header-update
...
## Entry
<!-- lupo-changelog-merged: 20260417073758_cursor_1fe9c2b4ad.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-memory/development/staging/2026/04/cursor_handoff.toon`, `lupo-docs/versions/4.1.2/buffer/20260417073758_102.md`
  - Related toons:
    - `lupo-memory/development/staging/2026/04/cursor_handoff.toon`
  - Handoff to: `antigravity-ide`

## Entry
<!-- lupo-changelog-merged: 20260417074010_antigravity_configres.json -->
- **WHO:** antigravity
- **CHANNEL / THREAD:** development / header-update
- **UTC (BIGINT):** `20260417074010`
- **WHAT:**
  - Polished LupopediaConfigResolver.php header to use canonical PHP grid format and clean values.
  - Files: `lupo-includes/classes/LupopediaConfigResolver.php`

## Entry
<!-- lupo-changelog-merged: 20260417074210_antigravity_wizclass.json -->
- **WHO:** antigravity
- **CHANNEL / THREAD:** development / header-update
...
## Entry
<!-- lupo-changelog-merged: 20260417074448_antigravity_apiproc.json -->
- **WHO:** antigravity
- **CHANNEL / THREAD:** development / header-update
...
## Entry
<!-- lupo-changelog-merged: 20260417075457_antigravity_api_fix.json -->
- **WHO:** antigravity
- **CHANNEL / THREAD:** development / header-update
...
## Entry
<!-- lupo-changelog-merged: 20260417092315_cursor_5ac18efb42.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/16_lupopedia_headers.md`, `lupo-docs/doctrine/runtime/ANUBIS_QUEUE_EXECUTION_PROPOSAL.md`, `lupo-docs/versions/4.1.2/buffer/20260417092315_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417094016_cursor_9d4a7f1b2c3e4d5f.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-memory/lupopedia_headers/canonical/2026/04/16_lupopedia_headers.toon`, `lupo-memory/memory/canonical/2026/04/38_memory_unification.toon`, `lupo-docs/versions/4.1.2/buffer/20260417094016_102.md`
  - Related toons:
    - `lupo-memory/lupopedia_headers/canonical/2026/04/16_lupopedia_headers.toon`
    - `lupo-memory/memory/canonical/2026/04/38_memory_unification.toon`
...
## Entry
<!-- lupo-changelog-merged: 20260417094411_cursor_7c1d9e5a3b42f1d0.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql`, `lupo-docs/versions/4.1.2/buffer/20260417094411_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417095522_cursor_18ae42c7d9f1438b.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/16_lupopedia_headers.md`, `lupo-docs/versions/4.1.2/buffer/20260417095522_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417095805_cursor_4b7a9de31c0f4a22.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/16_lupopedia_headers.md`, `lupo-scripts/validate_lupopedia_headers_universal.py`, `lupo-docs/versions/4.1.2/buffer/20260417095805_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417100528_cursor_e3474cb95a7d4d70.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/16_lupopedia_headers.md`, `lupo-scripts/lib/header_spec_v3_1.py`, `lupo-scripts/validate_lupopedia_headers_universal.py`, `lupo-docs/doctrine/runtime/ANUBIS_QUEUE_EXECUTION_PROPOSAL.md`, `lupo-docs/versions/4.1.2/buffer/20260417100528_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417100835_cursor_a1e7f95c4d2b46fa.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-scripts/lib/header_spec_v3_1.py`, `lupo-docs/versions/4.1.2/buffer/20260417100835_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417100950_cursor_6f4c9a1be8324d17.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-scripts/validate_lupopedia_headers_universal.py`, `lupo-docs/versions/4.1.2/buffer/20260417100950_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417101921_cursor_2f8e3a96dc7541ab.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/16_lupopedia_headers.md`, `lupo-docs/versions/4.1.2/buffer/20260417101921_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417102228_cursor_9c5f2b41a7d84e23.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/versions/4.1.2/status/open_questions.md`, `lupo-docs/versions/4.1.2/buffer/20260417102228_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417102548_cursor_73f2a9c18e4d4b6f.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/16_lupopedia_headers.md`, `lupo-docs/versions/4.1.2/buffer/20260417102548_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417102802_cursor_0f37c5b2d14a4e6a.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/versions/4.1.2/status/open_questions.md`, `lupo-docs/versions/4.1.2/buffer/20260417102802_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417104335_cursor_8d0f0e16fd834227.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/38_memory_unification.md`, `lupo-docs/versions/4.1.2/buffer/20260417104335_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417105049_cursor_58409c15370d48ff.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-scripts/import_memory_edges_from_sidecar.py`, `lupo-scripts/lib/db_memory_writer.py`, `lupo-docs/versions/4.1.2/buffer/20260417105049_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417111930_cursor_3d8a1f56b8544f86.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-scripts/lib/db_memory_writer.py`, `lupo-scripts/import_memory_edges_from_sidecar.py`, `lupo-docs/versions/4.1.2/status/open_questions.md`, `lupo-docs/versions/4.1.2/CHANGELOG.md`, `lupo-docs/versions/4.1.2/buffer/20260417111930_102.md`

## Entry
<!-- lupo-changelog-merged: 20260417192105_cursor_prd02_ui_layout.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/02_channels_discussions.md`, `lupo-changelog-pending/20260417192105_cursor_prd02_ui_layout.json`

## Entry
<!-- lupo-changelog-merged: 20260417192257_cursor_version_413_scaffold.json -->
- **WHO:** cursor
- **CHANNEL / THREAD:** development / version-4-1-3
- **UTC (BIGINT):** `20260417192257`
- **WHAT:**
  - Bumped project version to 4.1.3 in global_atoms.yaml, README, global constants atom, version.php; created lupo-docs/versions/4.1.3 scaffold (buffer/archive, status).
  - Files: `lupo-config/global_atoms.yaml`, `README.md`, `lupo-memory/atoms/lupopedia_global_constants.atom.toon`, `lupo-includes/version.php`, `lupo-changelog-pending/20260417192257_cursor_version_413_scaffold.json`

## Entry
<!-- lupo-changelog-merged: 20260417193000_cursor_channels_mockup_layout.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `channels/index.php`, `lupo-api/dialog/fetch-messages.php`, `lupo-includes/functions/channel_chat_row.php`, `lupo-changelog-pending/20260417193000_cursor_channels_mockup_layout.json`

## Entry
<!-- lupo-changelog-merged: 20260417203317_cursor_send_route_channels.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-includes/functions/channel_chat_row.php`, `channels/index.php`, `lupo-api/dialog/channel-members.php`, `lupo-api/dialog/send-route-copy.php`
  - Related toons:
    - `lupo-memory/development/staging/2026/04/channel-members-api.toon`
    - `lupo-memory/development/staging/2026/04/send-route-copy-api.toon`

## Entry
<!-- lupo-changelog-merged: 20260417211834_cursor_prompt_library_dispatch.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `channels/index.php`, `lupo-includes/modules/module-loader.php`, `lupo-includes/modules/api/prompts-api.php`, `app/Services/PromptLibraryService.php`, `lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql`

## Entry
<!-- lupo-changelog-merged: 20260417212939_cursor_changelog_consolidator.json -->
- **WHO:** cursor
- **CHANNEL / THREAD:** development / changelog-consolidator
- **UTC (BIGINT):** `20260417212939`
- **WHAT:**
  - Added consolidate_lupo_changelog_pending.py for JSON buffer merges into lupo-docs/versions/4.1.3/changelog.md, merged 45 pending entries, archived orphans, updated CHANGELOG_BUFFER_ARCHITECTURE and merge_changelog_buffer docstring.
  - Files: `lupo-scripts/consolidate_lupo_changelog_pending.py`, `lupo-scripts/merge_changelog_buffer.py`, `lupo-docs/versions/4.1.3/changelog.md`, `lupo-docs/doctrine/CHANGELOG_BUFFER_ARCHITECTURE.md`, `lupo-changelog-archive.legacy-fragment.md`

## Entry
<!-- lupo-changelog-merged: 20260418035707_cursor_eod_session_handoff.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `channels/index.php`, `lupo-templates/admin/api_dashboard.php`, `lupo-docs/prd/45_template_first_staged_ui_workflow.md`, `lupo-docs/prd/PRD_INDEX.md`, `lupo-docs/prd/02_channels_discussions.md`, `lupo-content/federation_node/0/captains_log/20260418_apple2e_2_supercomputer.md`, `lupo-includes/functions/channel_chat_row.php`, `lupo-api/dialog/fetch-messages.php`, `lupo-scripts/consolidate_lupo_changelog_pending.py`

## Entry
<!-- lupo-changelog-merged: 20260418172738_cursor_todo_ui_model.json, 20260418173241_cursor_todo_milestones.json -->
- **WHO:** cursor
- **CHANNEL / THREAD:** development / 4-1-3-todo
- **UTC (BIGINT):** `20260418172738`
- **WHAT:**
  - Added UI and data model decisions section to lupo-docs/versions/4.1.3/todo.md (actor live help baseline, canned vs saved_prompt, terminology, mode separation).
  - Revised 4.1.3 todo.md milestones: May 1 ship for baseline, May rolling 4.1.4/4.1.5, June 1 4.2.0; added integration checkpoint note.
  - Files: `lupo-docs/versions/4.1.3/todo.md`

## Entry
<!-- lupo-changelog-merged: 20260418184001_cursor_prd02_projection.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/02_channels_discussions.md`

## Entry
<!-- lupo-changelog-merged: 20260418184432_cursor_prd17_workflow.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/17_decisions_format.md`

## Entry
<!-- lupo-changelog-merged: 20260418184639_cursor_prd02_enforcement.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260418185514_cursor_prd02_release_line.json -->
- **WHO:** cursor
- **CHANNEL / THREAD:** development / prd-02-release-line
- **UTC (BIGINT):** `20260418185514`
- **WHAT:**
  - PRD 02 release-line correction: 4.1.4-4.1.9 orchestration dev, 4.2.0 first public only; no false deferral of orchestration to 4.2.0; fresh-install / no Lupopedia-to-Lupopedia upgrade note; TOC, summary, Orchestration intro, scattered labels.
  - Files: `lupo-docs/prd/02_channels_discussions.md`

## Entry
<!-- lupo-changelog-merged: 20260418190503_cursor_prd17_pass.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260418190751_cursor_prd02_final_pass.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260418191306_cursor_utf8_write_guard.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `app/Services/HermesService.php, lupo-includes/classes/Utf8StructuredWrite.php, lupo-scripts/generate_json_headers.py, lupo-scripts/utf8_structured_write.py`

## Entry
<!-- lupo-changelog-merged: 20260418192221_cursor_emoji_doctrine.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/doctrine/EMOJI_AND_SMILIES.md, lupo-docs/doctrine/SMILIES_IMPLEMENTATION.md, lupo-memory/development/canonical/1026/04/emoji-and-smilies.json, lupo-memory/development/canonical/1026/04/emoji-and-smilies.toon`

## Entry
<!-- lupo-changelog-merged: 20260418192619_cursor_header_freeze_413.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `.cursor/rules/lupopedia-headers-mandatory.mdc, AGENTS.md, lupo-changelog-pending/20260418192619_cursor_header_freeze_413.json, lupo-docs/doctrine/lupopedia-headers/lupopedia_headers_format.md, lupo-docs/doctrine/lupopedia-headers/templates_new_file.md, lupo-docs/doctrine/lupopedia-headers/validators_and_tooling.md, lupo-docs/doctrine/lupopedia-headers/versions/2.0/decisions.md, lupo-docs/prd/16_lupopedia_headers.md, lupo-docs/prd/17_decisions_format.md`

## Entry
<!-- lupo-changelog-merged: 20260418200257_cursor_prd16_atoms_spec.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-changelog-pending/20260418200257_cursor_prd16_atoms_spec.json, lupo-docs/prd/16_atoms_system_and_global_constants.md, lupo-docs/prd/PRD_INDEX.md, lupo-memory/headers/canonical/1026/04/16-atoms-system-global-constants.json, lupo-memory/headers/canonical/1026/04/16-atoms-system-global-constants.toon, lupo-scripts/generate_prd_index.py`
  - Related toons:
    - `lupo-memory/headers/canonical/1026/04/16-atoms-system-global-constants.toon`

## Entry
<!-- lupo-changelog-merged: 20260418200841_cursor_utf8structuredwrite_hardening.json -->
- **WHO:** cursor
- **CHANNEL / THREAD:** development / utf8-structured-write
...
- **WHAT:**
  ...
  - Files: `lupo-changelog-pending/20260418200841_cursor_utf8structuredwrite_hardening.json, lupo-includes/classes/Utf8StructuredWrite.php`

## Entry
<!-- lupo-changelog-merged: 20260418200947_cursor_hermes_hardening.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `app/Services/HermesService.php, lupo-changelog-pending/20260418200947_cursor_hermes_hardening.json`

## Entry
<!-- lupo-changelog-merged: 20260418201851_cursor_utf8_py_hardening.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-changelog-pending/20260418201851_cursor_utf8_py_hardening.json, lupo-scripts/utf8_structured_write.py`

## Entry
<!-- lupo-changelog-merged: 20260418202017_cursor_generate_json_headers.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-changelog-pending/20260418202017_cursor_generate_json_headers.json, lupo-scripts/generate_json_headers.py`

## Entry
<!-- lupo-changelog-merged: 20260418210404_cursor_prd_index_audit_wrap.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `ORGANIZATION.md, lupo-changelog-pending/20260418210404_cursor_prd_index_audit_wrap.json, lupo-docs/prd/03_goals_and_success_criteria.md, lupo-docs/prd/19_garbage_collection_system.md, lupo-docs/prd/21_semantic_navbar.md, lupo-docs/prd/26_five_layer_documentation_architecture.md, lupo-docs/prd/PRD_INDEX.md`

## Entry
<!-- lupo-changelog-merged: 20260418210750_cursor_organization_placement_gate.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `ORGANIZATION.md, lupo-changelog-pending/20260418210750_cursor_organization_placement_gate.json`

## Entry
<!-- lupo-changelog-merged: 20260418211412_cursor_prd45_workflow_gates.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-agents/_shared/ide_facet_base_system_prompt.txt, lupo-changelog-pending/20260418211412_cursor_prd45_workflow_gates.json, lupo-docs/prd/13_crafty_integration.md, lupo-docs/prd/29_project_structure.md, lupo-docs/prd/31_implementation_folder_guidelines.md, lupo-docs/prd/45_template_first_staged_ui_workflow.md, lupo-docs/prd/PRD_INDEX.md`

## Entry
<!-- lupo-changelog-merged: 20260418211622_cursor_prd16_doc_fixes.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-changelog-pending/20260418211622_cursor_prd16_doc_fixes.json, lupo-docs/prd/16_lupopedia_headers.md`

## Entry
<!-- lupo-changelog-merged: 20260418212313_cursor_prd17_channel_first.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-changelog-pending/20260418212313_cursor_prd17_channel_first.json, lupo-docs/prd/17_decisions_format.md, lupo-docs/prd/PRD_INDEX.md`

## Entry
<!-- lupo-changelog-merged: 20260418221552_cursor_ascii_doctrine_lilith.json -->
- **WHO:** cursor
- **CHANNEL / THREAD:** development / lilith-directive-ascii
- **UTC (BIGINT):** `20260418221552`
- **WHAT:**
  - Added LILITH ASCII-only doctrine to AGENTS.md, ORGANIZATION.md encoding section, and lupo-agents/_shared/ide_facet_base_system_prompt.txt; ASCII-normalized shared IDE prompt; AGENTS header thread_id null.
  - Files: `AGENTS.md, ORGANIZATION.md, lupo-agents/_shared/ide_facet_base_system_prompt.txt, lupo-changelog-pending/20260418221552_cursor_ascii_doctrine_lilith.json`

## Entry
<!-- lupo-changelog-merged: 20260418221750_cursor_prd_index_primary_ascii.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `ORGANIZATION.md, lupo-changelog-pending/20260418221750_cursor_prd_index_primary_ascii.json, lupo-docs/prd/PRD_INDEX.md, lupo-scripts/generate_prd_index.py`

## Entry
<!-- lupo-changelog-merged: 20260418221907_cursor_prd45_thread_graph_refs.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-changelog-pending/20260418221907_cursor_prd45_thread_graph_refs.json, lupo-docs/prd/45_template_first_staged_ui_workflow.md`

## Entry
<!-- lupo-changelog-merged: 20260418224537_cursor_prd13_polish.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `_fix_prd13_tmp.py, lupo-docs/prd/13_crafty_integration.md`

## Entry
<!-- lupo-changelog-merged: 20260418225627_cursor_lilith_ascii_root_docs.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260418233700_cursor_personal_context_isolation.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/doctrine/PERSONAL_CONTEXT_ISOLATION.md, lupo-docs/prd/00_root_constitutional_system_requirements.md, lupo-memory/development/canonical/1026/04/personal-context-isolation.json, lupo-memory/development/canonical/1026/04/personal-context-isolation.toon`
  - Related toons:
    - `lupo-memory/development/canonical/1026/04/personal-context-isolation.toon`

## Entry
<!-- lupo-changelog-merged: 20260418234047_cursor_onboarding_prd_first_docs.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260418234246_cursor_contributing_prd_first_docs.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260418234424_cursor_readme_prd_first_docs.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260418234551_cursor_agents_prd_first_docs.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260418234714_cursor_personal_context_non_system.json -->
- **WHO:** cursor
- **CHANNEL / THREAD:** development / personal-context-isolation
...
- **WHAT:**
  ...
  - Files: `lupo-docs/doctrine/PERSONAL_CONTEXT_ISOLATION.md`

## Entry
<!-- lupo-changelog-merged: 20260419000416_cursor_prd00_header_413_ascii.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-docs/prd/00_root_constitutional_system_requirements.md`

## Entry
<!-- lupo-changelog-merged: 20260419000543_cursor_onboarding_enforcement.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260419000721_cursor_contributing_enforcement.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260419002533_cursor_captains_log_em_dash_headers.json -->
- **WHO:** cursor
...
- **WHAT:**
  ...
  - Files: `lupo-content/federation_node/0/captains_log/30_the_em_dash_conspiracy.md, lupo-memory/captains_log/canonical/1026/04/30-em-dash-conspiracy.json, lupo-memory/captains_log/canonical/1026/04/30-em-dash-conspiracy.toon`
  - Related toons:
    - `lupo-memory/captains_log/canonical/1026/04/30-em-dash-conspiracy.toon`

## Entry
<!-- lupo-changelog-merged: 20260419013442_cursor_channel_feed_visibility_dark_rows.json -->
- **WHO:** cursor
...
## Entry
<!-- lupo-changelog-merged: 20260419185114_cursor_4_1_3_todo_rewrite.json -->
- **WHO:** cursor (actor_id 102)
...
## Entry
<!-- lupo-changelog-merged: 20260419190254_cursor_todo_dependency_chain.json -->
- **WHO:** cursor (actor_id 102)
- **CHANNEL / THREAD:** development / 4-1-3-planning
...
## Entry
<!-- lupo-changelog-merged: 20260419190519_cursor_report_todo_dependency.json -->
- **WHO:** cursor (actor_id 102)
- **CHANNEL / THREAD:** development / 4-1-3-docs
- **UTC (BIGINT):** `20260419190519`
- **WHAT:**
  - Synced TODO when_updated; rewrote Helen weekly report for Thursday cadence, removed dated milestones and May 1 4.1.4 kickoff, added Next Dependencies table aligned with layers A-F and channel row/task notes.
  - Files: `lupo-docs/versions/4.1.3/TODO.md`, `lupo-docs/versions/4.1.3/REPORT_EMAIL_TO_HELEN_2026_04_23.md`

## Entry
<!-- lupo-changelog-merged: 20260419190851_cursor_todo_report_sanitize_ascii.json -->
- **WHO:** cursor (actor_id 102)
- **CHANNEL / THREAD:** development / 4-1-3-docs
- **UTC (BIGINT):** `20260419190851`
- **WHAT:**
  - TODO Layer A now cites lupo-scripts/sanitize_ascii.py --fix; Helen report ties Thursday cadence, Next Dependencies, and status tables to that ASCII audit path.
  - Files: `lupo-docs/versions/4.1.3/TODO.md`, `lupo-docs/versions/4.1.3/REPORT_EMAIL_TO_HELEN_2026_04_23.md`

## Entry
<!-- lupo-changelog-merged: 20260419203203_cursor_database_migration_plan_docs.json -->
- **WHO:** cursor (actor_id 102)
- **CHANNEL / THREAD:** database / crafty-import-plan
- **UTC (BIGINT):** `20260419203203`
- **WHAT:**
  - Added TODO_DATABASE_MIGRATION.md and PLAN_DATABASE_MIGRATION.md under lupo-docs/versions/4.1.3 with measured table counts (34 Crafty, 140 install), blockers, doctrine violations, livehelp mapping matrix, and ordered fix plan; no SQL edits.
  - Files: `lupo-docs/versions/4.1.3/TODO_DATABASE_MIGRATION.md`, `lupo-docs/versions/4.1.3/PLAN_DATABASE_MIGRATION.md`, `lupo-memory/database/canonical/1026/04/database-migration-plan.json`, `lupo-memory/database/canonical/1026/04/database-migration-plan.toon`

## Entry
<!-- lupo-changelog-merged: 20260419203703_cursor_cascade_db_handoff_toon.json -->
- **WHO:** cursor (actor_id 102)
- **CHANNEL / THREAD:** database / cascade-handoff
- **UTC (BIGINT):** `20260419203703`
- **WHAT:**
  - Created TOON_DB_HANDOFF_FOR_CASCADE.md under lupo-docs/agents/cascade/handoff with PRD 16 header and memory sidecar for Cascade/Windsurf database facet bootstrap.
  - Files: `lupo-docs/agents/cascade/handoff/TOON_DB_HANDOFF_FOR_CASCADE.md`, `lupo-memory/database/canonical/1026/04/cascade-windsurf-db-handoff.json`, `lupo-memory/database/canonical/1026/04/cascade-windsurf-db-handoff.toon`
  - Files: `channels/index.php, lupo-includes/functions/channel_chat_row.php, lupo-includes/modules/channels/channel-messages-api.php, lupo-api/dialog/fetch-messages.php`

## Entry
<!-- lupo-changelog-merged: 20260419210000_claude_todo_database_migration_sync.json -->
...
- **WHAT:**
  ...
  - Files: `lupo-docs/versions/4.1.3/TODO_DATABASE_MIGRATION.md`

## Entry
<!-- lupo-changelog-merged: 20260419215000_claude_plan_database_migration_sync.json -->
- **WHO:** claude (actor_id 116)
...
- **WHAT:**
  ...
  - Files: `lupo-docs/versions/4.1.3/PLAN_DATABASE_MIGRATION.md`, `lupo-docs/versions/4.1.3/changelog.md`
