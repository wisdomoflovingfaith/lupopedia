...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/versions/4.1.2/README.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/versions/4.1.2/README.md"
  status: "active"
  when_updated: "20260415223156"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/version-4-1-2-readme.toon"
  atoms_toon: null
...
- `lupo-scripts/validate_lupopedia_headers_universal.py` — canonical validator (v4.1.2)
- `lupo-scripts/lib/header_spec_v3_1.py` — 22-field canonical order
- `lupo-docs/prd/16_lupopedia_headers.md` — normative spec
- `lupo-docs/prd/16_lupopedia_headers_migration.md` — migration rules
- `lupo-memory/atoms/lupopedia_global_constants.atom.toon` — global constants
