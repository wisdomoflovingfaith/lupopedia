...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/HERMES_DOCTRINE.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/HERMES_DOCTRINE.md"
  status: "active"
  when_updated: "20260416144907"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/hermes-doctrine.toon"
  atoms_toon: null
...
- **Agent receives:** Cursor polls `python lupo-bin/pending.py` and receives the task.
...
- **Path:** `lupo-memory/transcripts/{node}/{channel}/{thread_slug}.jsonl`
...
- **Path:** `lupo-memory/{channel}/staging/{YYYY}/{MM}/{thread_slug}.toon`
