...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/AI_ACTOR_COMPETENCY_TEST_PATTERN.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/AI_ACTOR_COMPETENCY_TEST_PATTERN.md"
  status: "active"
  when_updated: "20260412120900"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/ai-actor-competency-test-pattern.toon"
  atoms_toon: null
  ...
  content_id: null
  pk_id: null
  pk_slug: "ai-actor-competency-test-pattern"
  parent_pk_id: ""
...
| `PROBE_BOUNDARY_VIOLATION` | No extractable artifact per harness ([`probe_runtime_guard.py`](../../lupo-scripts/probe_runtime_guard.py)). |
...
|----------------------|-----|-------------|----------------|
| `AI_ACTOR_COMPETENCY_TEST_PATTERN.md` | `lupo-docs/doctrine/AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md` | `doctrine_rule` | `harness_and_guards` |
| `AI_ACTOR_COMPETENCY_TEST_PATTERN.md` | `lupo-docs/doctrine/AI_ACTOR_KNOWLEDGE_UPDATE_PROTOCOL.md` | `doctrine_rule` | `graph_remediation` |
| `AI_ACTOR_COMPETENCY_TEST_PATTERN.md` | `lupo-docs/prd/50_agent_coordination_protocol.md` | `doctrine_rule` | `probe_coordination` |
| `AI_ACTOR_COMPETENCY_TEST_PATTERN.md` | `lupo-docs/doctrine/VALIDATION_PATTERNS.md` | `doctrine_rule` | `validator_index` |
...
Reference: [`AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md`](AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md), [`probe_runtime_guard.py`](../../lupo-scripts/probe_runtime_guard.py).
...
**Three control layers** (harness, runtime guard, transcript filter) — normative description: [`AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md`](AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md). **Reference guard script:** `python lupo-scripts/probe_runtime_guard.py` (first fenced code block or **`ERROR: PROBE_BOUNDARY_VIOLATION`**).
...
- **Harness and guards:** [`AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md`](AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md); `lupo-scripts/probe_runtime_guard.py`.
...
- **Multi-agent coordination:** [`lupo-rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md`](../../lupo-rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md)
- **Header validation:** `python lupo-scripts/validate_lupopedia_headers_universal.py <path>`
