...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md"
  status: "active"
  when_updated: "20260412131327"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/ai-actor-probe-harness-and-guards.toon"
  atoms_toon: null
  ...
  content_id: null
  pk_id: null
  pk_slug: "ai-actor-probe-harness-and-guards"
  parent_pk_id: ""
...
|------|-------------------|
| `PROBE_BOUNDARY_VIOLATION` | No extractable artifact per harness rules (reference: [`probe_runtime_guard.py`](../../lupo-scripts/probe_runtime_guard.py)). |
...
|----------------------|-----|-------------|----------------|
| `AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md` | `lupo-docs/prd/56_probe_harness_v2.md` | `doctrine_rule` | `harness_spec` |
| `AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md` | `lupo-docs/prd/53_runtime_guard.md` | `doctrine_rule` | `runtime_guard_spec` |
| `AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md` | `lupo-docs/prd/58_transcript_filter.md` | `doctrine_rule` | `transcript_filter_spec` |
| `AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md` | `lupo-docs/prd/50_agent_coordination_protocol.md` | `doctrine_rule` | `coordination_protocol` |
| `AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md` | `lupo-docs/doctrine/VALIDATION_PATTERNS.md` | `doctrine_rule` | `validator_index` |
...
|------|-----|-------------|----------------|
| `AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md` | `lupo-docs/prd/61_doctrine_consolidation_shorthand_compiler.md` | `doctrine_rule` | `invariant_checklist_harness_doctrine` |
...
Reference script behavior: [`probe_runtime_guard.py`](../../lupo-scripts/probe_runtime_guard.py) implements **fail-closed** extract for **`PROBE_BOUNDARY_VIOLATION`** (exit code **2**).
...
**Reference implementation:** `python lupo-scripts/probe_runtime_guard.py` (stdin, file, or import).
