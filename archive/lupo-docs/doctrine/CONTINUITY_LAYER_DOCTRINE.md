...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/CONTINUITY_LAYER_DOCTRINE.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/CONTINUITY_LAYER_DOCTRINE.md"
  status: "active"
  when_updated: "20260416215839"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/continuity-layer-doctrine.toon"
  atoms_toon: null
...
- **PRD 38** — Memory unification and persistence boundaries: `lupo-docs/prd/38_memory_unification.md`
- **Translation channel** — Audience-layer explanation of continuity: `lupo-channels/0/translation/concepts/01_continuity_layer.md` (must stay aligned with this doctrine)
- **Production precedent (Captain narrative)** — Honolulu DMV continuity work (1999): `lupo-content/federation_node/0/captains_log/20260416_dmv_1999_continuity_precedent.md`

## 5. Weekly report cross-check

Executive weekly report (week of 2026-04-10 through 2026-04-16) Section 5 claims are satisfied when this file and the translation concept above remain aligned. Evidence index: `lupo-docs/versions/4.1.2/status/weekly_report_evidence_index_20260416.md`.
