...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/runtime/ANUBIS_QUEUE_EXECUTION_PROPOSAL.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/runtime/ANUBIS_QUEUE_EXECUTION_PROPOSAL.md"
  status: "draft"
  when_updated: "20260417100528"
  trust_tier: "development"
  questions_toon: null
  memory_toon: "lupo-memory/development/development/2026/04/anubis-queue-execution-proposal-md.toon"
  atoms_toon: null
...
---
# file: ANUBIS_QUEUE_EXECUTION_PROPOSAL.md — session: development — delegation: cursor:102 — web_path: [https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/runtime/ANUBIS_QUEUE_EXECUTION_PROPOSAL.md](https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/runtime/ANUBIS_QUEUE_EXECUTION_PROPOSAL.md)
...
2. Append-only log file:
   - `lupo-logs/anubis/orphan_repair/YYYYMMDD.log`
