...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/PERSONAL_CONTEXT_ISOLATION.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/PERSONAL_CONTEXT_ISOLATION.md"
  status: "active"
  when_updated: "20260418234714"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/personal-context-isolation.toon"
  atoms_toon: null
...
- Files under **`lupo-agents/`**, **`lupo-docs/`** (including PRDs and doctrine), **`lupo-memory/`**, **`lupo-scripts/`**, **`lupo-changelog-pending/`**, **`lupo-channels/`** when used for coordination artifacts, decisions, and work products (not personal narrative storage), **`lupo-rules/`**, **`lupo-includes/`**, **`app/`** (when committed as product source)
...
- **Agent prompts**, **IDE rule packs**, **implementation mirrors** under **`lupo-docs/implementations/`**, and similar maintainer-authored surfaces
...
**Not in scope:** Public **actor** / **facet** personas, **registry-backed** identities, **channel-attributed** technical posts, **auth_user** rows with **policy-allowed** fields, and **ROSE** / dialog product behavior where **[PRD 36](lupo-docs/prd/36_rose_multi_persona_synthetic_dialog.md)** explicitly defines synthetic dialog storage.
...
- **ROSE** and **dialog** systems only where **[PRD 36](lupo-docs/prd/36_rose_multi_persona_synthetic_dialog.md)** explicitly defines storage and retention.
...
4. **Constitutional anchor:** **[PRD 00](lupo-docs/prd/00_root_constitutional_system_requirements.md)** references this file under **System integrity rules** so IDE agents and humans see the boundary at the constitutional layer.
