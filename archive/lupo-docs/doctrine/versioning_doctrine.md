...
lupopedia.headers:
  ...
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/VERSIONING_DOCTRINE.md"
  status: "active"
  when_updated: "20260418000000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/versioning-doctrine.toon"
  atoms_toon: null
...
This is the single, canonical versioning doctrine for Lupopedia. Only this file (`lupo-docs/doctrine/VERSIONING_DOCTRINE.md`) is authoritative. No duplicates, suffixes, or alternate versioning doctrine files are permitted.
...
Do NOT imply that 4.1.4-4.1.9 are guaranteed, automatic, or expected just because they are numerically next. Internal development does not automatically yield a version bump.
...
| Rule | Statement |
|------|-----------|
| **Single file** | Only `lupo-docs/doctrine/VERSIONING_DOCTRINE.md` is authoritative; no duplicates or suffixed copies. |
