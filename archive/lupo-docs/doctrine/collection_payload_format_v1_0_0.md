...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/collection_payload_format_v1_0_0.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/collection_payload_format_v1_0_0.md"
  status: "active"
  when_updated: "20260412124740"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/collection-payload-format-v1-0-0.toon"
  atoms_toon: null
...
|------------------------|-----|-------------|----------------|
| `collection_payload_format_v1_0_0.md` | `lupo-docs/prd/00_root_constitutional_system_requirements.md` | `doctrine_rule` | `defines` |
| `collection_payload_format_v1_0_0.md` | `lupo-docs/prd/38_memory_unification.md` | `doctrine_rule` | `binds_memory_graph` |
| `collection_payload_format_v1_0_0.md` | `lupo-docs/prd/50_agent_coordination_protocol.md` | `doctrine_rule` | `governs_ingestion` |
| `collection_payload_format_v1_0_0.md` | `lupo-docs/doctrine/AGENT_ORCHESTRATION.md` | `doctrine_rule` | `orchestration_surface` |
| `collection_payload_format_v1_0_0.md` | `lupo-docs/doctrine/VALIDATION_PATTERNS.md` | `doctrine_rule` | `validator_input` |
| `collection_payload_format_v1_0_0.md` | `lupo-docs/prd/52_memory_graph_focus_manifest.md` | `doctrine_rule` | `graph_focus_lens` |
| `collection_payload_format_v1_0_0.md` | `lupo-docs/prd/53_runtime_guard.md` | `doctrine_rule` | `runtime_guard_input` |
| `collection_payload_format_v1_0_0.md` | `lupo-docs/prd/54_actor_compliance.md` | `doctrine_rule` | `compliance_evaluation` |
| `collection_payload_format_v1_0_0.md` | `lupo-docs/prd/56_probe_harness_v2.md` | `doctrine_rule` | `probe_harness` |
| `collection_payload_format_v1_0_0.md` | `lupo-docs/prd/58_transcript_filter.md` | `doctrine_rule` | `transcript_classification` |
| `collection_payload_format_v1_0_0.md` | `lupo-docs/prd/60_orchestrator_scheduler.md` | `doctrine_rule` | `orchestrator_scheduler` |
...
|------|-----|-------------|----------------|
| `lupo-docs/prd/53_runtime_guard.md` | `lupo-docs/prd/54_actor_compliance.md` | `doctrine_rule` | `violations_recorded` |
| `lupo-docs/prd/54_actor_compliance.md` | `lupo-docs/prd/60_orchestrator_scheduler.md` | `doctrine_rule` | `priority_adjustment` |
| `lupo-docs/prd/60_orchestrator_scheduler.md` | `lupo-docs/prd/56_probe_harness_v2.md` | `doctrine_rule` | `dispatches_probes` |
| `lupo-docs/prd/56_probe_harness_v2.md` | `lupo-docs/prd/58_transcript_filter.md` | `doctrine_rule` | `telemetry_hygiene` |
...
- **File → JSON:** [`lupo-scripts/collection_compiler.py`](../../lupo-scripts/collection_compiler.py) — Markdown globs under a repo root → v1.0.0 payload (non-normative convenience; field rules here remain authoritative).
- Install DDL: `lupo_collections`, `lupo_collection_tabs`, `lupo_memory_nodes`, `lupo_memory_edges` in `lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql`
