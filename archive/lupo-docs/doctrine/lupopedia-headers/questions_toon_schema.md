...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/lupopedia-headers/questions_toon_schema.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/lupopedia-headers/questions_toon_schema.md"
  status: "draft"
  when_updated: "20260414000000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/questions-toon-schema.toon"
  atoms_toon: null
...
**Path convention:**
```
lupo-memory/questions/{channel_key}/{trust_tier}/{display_year}/{MM}/{slug}.questions.toon
```

**Example path (PRD 16):**
```
lupo-memory/questions/headers/canonical/1026/04/16-lupopedia-headers.questions.toon
```
