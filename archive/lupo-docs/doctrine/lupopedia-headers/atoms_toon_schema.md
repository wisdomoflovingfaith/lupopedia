...
lupopedia.headers:
   ...
   file_path_from_root: "lupo-docs/doctrine/lupopedia-headers/atoms_toon_schema.md"
   web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/lupopedia-headers/atoms_toon_schema.md"
   status: "active"
   when_updated: "20260418XXXXXX"  # Update with current UTC before commit
   trust_tier: "staging"
   questions_toon: null
   memory_toon: "lupo-memory/development/staging/2026/04/atoms-toon-schema.toon"
   atoms_toon: null
...
This file is **secondary explanatory/reference documentation** for the `atoms_toon` header field. The **primary source of truth for documentation** is the PRD corpus in `lupo-docs/prd/`, with PRDs grouped in the numeric namespace **00–99** (there is never a PRD 100). If this file conflicts with a PRD, the PRD governs. See `lupo-docs/prd/PRD_INDEX.md` and `lupo-docs/prd/readme.md` for namespace organization; these are supporting references, not replacements for PRDs themselves.
...
atoms_toon: "lupo-docs/doctrine/lupopedia-headers/lupopedia-headers.atoms.toon"
...
- **lupo-docs/prd/PRD_INDEX.md** — PRD namespace organization
- **lupo-docs/prd/readme.md** — PRD corpus overview
- **lupo-docs/doctrine/VERSIONING_DOCTRINE.md** — versioning and atoms source-of-truth doctrine
- **lupo-docs/doctrine/lupopedia-headers/validators_and_tooling.md** — validator behavior
- **lupo-scripts/migrate_module_to_atoms_toon.py** — migration script (module → atoms_toon)
- **lupo-scripts/lib/header_validation.py** — `validate_atoms_toon()` function
