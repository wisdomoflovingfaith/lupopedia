...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/LILITH_TEACH_DONT_ONLY_TELL.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/LILITH_TEACH_DONT_ONLY_TELL.md"
  status: "active"
  when_updated: "20260419100312"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/lilith-teach-dont-only-tell.toon"
  atoms_toon: null
  ...
  content_slug: "lilith-teach-dont-only-tell"
...
- **`lupo_agents` / actor tooling** around pattern metrics and **`AGAPE_PATTERN_REPORT`** (see **`AGAPE_DEFECT_TAXONOMY.md`**, **`COUNTING_IN_LIGHT_DOCTRINE.md`**, **`lupo-agents/agape/system_prompt.md`**).
...
| Header contract | **`lupo-docs/doctrine/lupopedia-headers/`** + validators |
| Actor and facet IDs | **`lupo-database/lupopedia/actors/`** registries |
| Trust ladder | **PRD 43** + trust ladder doctrine |
| Channel keys | **`lupo-channels/`** index and registry artifacts per project layout |
