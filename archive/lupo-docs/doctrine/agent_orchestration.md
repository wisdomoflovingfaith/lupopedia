...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/AGENT_ORCHESTRATION.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/AGENT_ORCHESTRATION.md"
  status: "active"
  when_updated: "20260412124551"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/agent-orchestration.toon"
  atoms_toon: null
...
- **Multi-agent doctrine (root):** [`lupo-rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md`](../../lupo-rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md)
- **Agent coordination PRD:** [`lupo-docs/prd/50_agent_coordination_protocol.md`](../prd/50_agent_coordination_protocol.md) — transcripts, pending tasks, memory graph; **no human message routing**; **section 1.4** collection payload ingestion.
...
- **Compiler (files → JSON):** [`lupo-scripts/collection_compiler.py`](../../lupo-scripts/collection_compiler.py) — optional glob-driven build of a v1.0.0 payload from Markdown under a repo root.
...
- **All probe-scoped output MUST pass through the runtime guard** before routing or persistence as a routed artifact — canonical script: [`lupo-scripts/probe_runtime_guard.py`](../../lupo-scripts/probe_runtime_guard.py); normative PRD: [PRD 53](../prd/53_runtime_guard.md).
...
**Tooling:** [`lupo-scripts/collection_compiler.py`](../../lupo-scripts/collection_compiler.py) (files → JSON); harness backlog in [`VALIDATION_PATTERNS.md`](VALIDATION_PATTERNS.md).
...
| Target | Role |
|--------|------|
| [`lupo-docs/prd/50_agent_coordination_protocol.md`](../prd/50_agent_coordination_protocol.md) | Coordination law, §§1.2–1.7 contracts and machines |
| [`lupo-docs/prd/52_memory_graph_focus_manifest.md`](../prd/52_memory_graph_focus_manifest.md) | Graph focus lens (**not** the runtime guard) |
| [`lupo-docs/prd/53_runtime_guard.md`](../prd/53_runtime_guard.md) | **Runtime guard** (machine filter) |
| [`lupo-docs/prd/54_actor_compliance.md`](../prd/54_actor_compliance.md) | Actor compliance evaluation |
| [`lupo-docs/prd/56_probe_harness_v2.md`](../prd/56_probe_harness_v2.md) | Probe harness v2 |
| [`lupo-docs/prd/58_transcript_filter.md`](../prd/58_transcript_filter.md) | Transcript classification before routing |
| [`lupo-docs/prd/60_orchestrator_scheduler.md`](../prd/60_orchestrator_scheduler.md) | Orchestrator scheduler |
