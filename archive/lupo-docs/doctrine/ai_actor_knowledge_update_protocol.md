...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/doctrine/AI_ACTOR_KNOWLEDGE_UPDATE_PROTOCOL.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/doctrine/AI_ACTOR_KNOWLEDGE_UPDATE_PROTOCOL.md"
  status: "active"
  when_updated: "20260412121720"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/ai-actor-knowledge-update-protocol.toon"
  atoms_toon: null
...
|----------------------|-----|-------------|----------------|
| `AI_ACTOR_KNOWLEDGE_UPDATE_PROTOCOL.md` | `lupo-docs/doctrine/AI_ACTOR_COMPETENCY_TEST_PATTERN.md` | `doctrine_rule` | `probe_prerequisite` |
| `AI_ACTOR_KNOWLEDGE_UPDATE_PROTOCOL.md` | `lupo-docs/doctrine/AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md` | `doctrine_rule` | `guard_and_transcript` |
| `AI_ACTOR_KNOWLEDGE_UPDATE_PROTOCOL.md` | `lupo-docs/prd/38_memory_unification.md` | `doctrine_rule` | `memory_graph` |
| `AI_ACTOR_KNOWLEDGE_UPDATE_PROTOCOL.md` | `lupo-docs/prd/50_agent_coordination_protocol.md` | `doctrine_rule` | `coordination_surface` |
| `AI_ACTOR_KNOWLEDGE_UPDATE_PROTOCOL.md` | `lupo-docs/doctrine/VALIDATION_PATTERNS.md` | `doctrine_rule` | `validator_index` |

---

## 1. Memory is a graph, not a blob

Authoritative storage is **`lupo_memory_nodes`** plus **`lupo_memory_edges`** ([`install_new_lupopedia.sql`](../../lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql)), with optional **filesystem mirror** under **`lupo-memory/`** per **PRD 38**.
...
When the DB is unreachable, follow **`database-offline-fallback-import`** rules: write **structured** artifacts under **`lupo-memory/`** or channel threads so they can be **re-ingested** into **`lupo_memory_nodes`** / **`lupo_memory_edges`** later — still **node-shaped**, not narrative-only notes.
...
- **Harness / runtime guard:** [`AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md`](AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md); `lupo-scripts/probe_runtime_guard.py`
...
- **Schema reference:** `lupo-database/lupopedia/toon/lupo_memory_nodes.toon.json`, `lupo_memory_edges.toon.json`; DDL in `lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql`.
