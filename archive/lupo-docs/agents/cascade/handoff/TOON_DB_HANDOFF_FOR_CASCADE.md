...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/agents/cascade/handoff/TOON_DB_HANDOFF_FOR_CASCADE.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/agents/cascade/handoff/TOON_DB_HANDOFF_FOR_CASCADE.md"
  status: "active"
  when_updated: "20260419203703"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/database/canonical/1026/04/cascade-windsurf-db-handoff.toon"
  atoms_toon: null
  ...
  content_slug: "toon-db-handoff-for-cascade"
...
- `lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql` is the single canonical schema (path in repo as of this handoff).
- Wolfie may edit the live DB directly in phpMyAdmin.
- Cascade must mirror those changes into:
  - `install_new_lupopedia.sql`
  - PRD 13 (`lupo-docs/prd/13_crafty_integration.md` and related database doctrine)
...
**Related plan docs (read first):** `lupo-docs/versions/4.1.3/TODO_DATABASE_MIGRATION.md`, `lupo-docs/versions/4.1.3/PLAN_DATABASE_MIGRATION.md`.
