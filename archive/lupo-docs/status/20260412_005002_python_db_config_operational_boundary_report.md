...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/status/20260412_005002_python_db_config_operational_boundary_report.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/status/20260412_005002_python_db_config_operational_boundary_report.md"
  questions_toon: null
  federation_node_id: 0
  channel_key: "development"
  trust_tier: "canonical"
  memory_key: "lupo-memory/development/canonical/1026/04/python-db-config-operational-boundary-report.toon"
  artifact_type: documentation
  artifact_kind: guide
  thread_id: "python-db-config-operational-boundary-20260412"
  content_id: null
  pk_id: null
  pk_slug: ""
  ...
  module: null
  dialog_transcript: "0/development/python_db_config_boundary"
---
# Python DB config operational boundary — session report

**Packed UTC anchor:** `20260412005002` (from `python lupo-bin/tick.py` for this batch). **Human-visible:** **2026-04-12 00:50:02 UTC** (hour **00**).
...
| Implementer | **Cursor IDE Agent** (actor_id **102**) | Edited `lupo-scripts/db_config.py`, `lupo-scripts/lib/db_connection.py`, dependent scripts under `lupo-scripts/` and `lupo-tools/`, and doctrine `PYTHON_DB_CONFIG_AND_SECRETS_4.0.99.md`; appended `lupo-docs/versions/4.0.98/CHANGELOG.md`. |

## WHERE it applies

- **Canonical resolver:** `lupo-scripts/db_config.py` (`resolve_lupopedia_config_path`, `load_db_config`, `get_table_prefix`, `LupopediaConfigError`).
- **Shared connection surface:** `lupo-scripts/lib/db_connection.py` (`get_connection_params`, `merge_connection_params_with_args`).
- **Callers:** DB-touching Python under `lupo-scripts/` and selected `lupo-tools/` (importers, validators, memory writer, edge queries, etc.).
- **Doctrine:** `lupo-docs/doctrine/PYTHON_DB_CONFIG_AND_SECRETS_4.0.99.md`.
- **Receipt:** `lupo-docs/versions/4.0.98/CHANGELOG.md` (session entry **2026-04-12 00:50 UTC**).
