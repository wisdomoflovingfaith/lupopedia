...
file_being_updated: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql"
...
`lupo-memory/atoms/lupopedia_global_constants.atom.toon` should contain:
