...
what_ai_did_wrong: "Placed WHY file in repository root instead of lupo-docs/why/ as required by PRD 98_A."
...
recommended_fix: "Update PRD 98_A to clearly state that all WHY files must be placed in lupo-docs/why/. Add validation and agent prompt guidance."
validator_output: "WHY file detected outside lupo-docs/why/ directory."
...
- The file was created in the repository root instead of the required lupo-docs/why/ directory.

**Violation Details:**
- The placement of the WHY file did not follow PRD 98_A Section 2, which mandates a flat structure in lupo-docs/why/.
...
**Prevention Measures:**
- Update PRD 98_A to explicitly require all WHY files to be placed in lupo-docs/why/.
