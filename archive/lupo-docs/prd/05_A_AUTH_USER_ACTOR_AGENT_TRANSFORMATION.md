...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/prd/05_A_AUTH_USER_ACTOR_AGENT_TRANSFORMATION.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/05_A_AUTH_USER_ACTOR_AGENT_TRANSFORMATION.md"
  status: "active"
  when_updated: "20260422030000"   # ← run tick.py again after final edit
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/05_auth_user_actor_agent_transformation.toon"
  atoms_toon: null
