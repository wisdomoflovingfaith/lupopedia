...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/37_A_KAIROS_CHANNEL_MEMORY_CONSOLIDATION.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/37_A_KAIROS_CHANNEL_MEMORY_CONSOLIDATION.md"
  status: active
  when_updated: "20260421223000"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/37_kairos_channel_memory_consolidation.toon
  atoms_toon: null
...
**`lupo_memory_nodes`** (TOON under `lupo-database/lupopedia/toon/`):
...
**`lupo_edges`** (`lupo-database/lupopedia/toon/lupo_edges.toon.json`):
