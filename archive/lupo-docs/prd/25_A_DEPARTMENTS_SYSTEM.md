...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/25_A_DEPARTMENTS_SYSTEM.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/25_A_DEPARTMENTS_SYSTEM.md"
  status: active
  when_updated: "20260422232349"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/25_departments_system.toon
  atoms_toon: null
...
Fresh seed (**`lupo-database/lupopedia/mysql/seed/seed_4.2.0.sql`**) places these actors in **`lupo_actor_departments`** for **`department_id = 0`** with **`role_key = hybrid`** (plus **system** rows for actor **0** and **ANUBIS 19**):
