...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/prd/00_E_LUPOPEDIA_VS_FRAMEWORKS_EXPLAINER.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/00_E_LUPOPEDIA_VS_FRAMEWORKS_EXPLAINER.md"
  status: "active"
  when_updated: "20260423021405"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/prd/canonical/1026/04/00-e-lupopedia-vs-frameworks-explainer.toon"
...
# **Lupopedia vs Frameworks — The Explainer**

## **1. What Lupopedia *Is***
Lupopedia is a **constitutional semantic operating system** for multi‑agent environments.

It is defined by:

- **PRD‑first governance** — PRDs are law, not documentation.  
- **AGAPE HARD GATE** — no action without full causal reconstruction.  
- **WHY files** — every violation becomes case law.  
- **Deterministic, file‑backed execution** — shared‑hosting compatible, ASCII‑only.  
- **Identity hierarchy** — Auth User → Actor → Agent.  
- **Learning transfer** — agents don't just fix errors; they *understand* them.

Lupopedia is **not** a framework.  
It is **not** a toolkit.  
It is **not** a prompt‑router.  
It is **not** a LangChain competitor.
