...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/00_B_SYSTEM_CANONICAL_EXPLANATION.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/00_B_SYSTEM_CANONICAL_EXPLANATION.md"
  status: active
  when_updated: "20260422204314"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/prd/canonical/1026/04/prd-system-canonical-explanation.toon
  atoms_toon: null
...
## 8. CAPTAIN'S LOG = NARRATIVE LAYER
...
## IMPLEMENTATION NOTES FOR 4.1.4+
...
- **Transcripts**: `lupo-memory/transcripts/{federation_node_id}/{channel_key}/{prd_cluster}.jsonl`
- **Staging Memory**: `lupo-memory/{channel_key}/staging/{YYYY}/{MM}/{prd_cluster}.toon`
- **Canonical Memory**: `lupo-memory/{channel_key}/canonical/1026/{MM}/{prd_cluster}.toon`
...
**STATUS**: ACTIVE - CANONICAL - v4.1.4 READY
