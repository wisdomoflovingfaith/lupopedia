...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/50_B_CRAFTY_SYNTAX_MODIFIED_FEATURES.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/50_B_CRAFTY_SYNTAX_MODIFIED_FEATURES.md"
  status: active
