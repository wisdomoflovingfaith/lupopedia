...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/02_B_CHANNELS_DB_OVERVIEW.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/02_B_CHANNELS_DB_OVERVIEW.md"
  status: active
  ...
  prd_cluster: 00_A_FORBIDDEN_AND_WHY_02_B_CHANNELS_DB_OVERVIEW
