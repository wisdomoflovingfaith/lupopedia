...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/00_A_FORBIDDEN_AND_WHY.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/00_A_FORBIDDEN_AND_WHY.md"
  status: active
  when_updated: "20260422213923"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/forbidden/canonical/1026/04/00-forbidden-and-why.toon
  atoms_toon: null
...
**FORBIDDEN:** Any agent or actor reading, referencing, or using content from the Captain's Log directory (`lupo-content/.../captains_log/` or any file whose path contains "CAPTAINS_LOG").
...
When validation fails, the system MUST automatically generate a permanent "why" record in `lupo-docs/why/`. This turns every violation into searchable, clusterable documentation that becomes part of the living constitution.

### 11.2 Why File Structure

**Directory:** `lupo-docs/why/`
...
2. **Atoms** - Global constants, invariants, definitions from the file referenced in the PRD's atoms_toon field. For header-related operations, use `lupo-memory/atoms/lupopedia_global_constants.atom.toon` (truth cannot drift)
...
documented in `lupo-docs/why/why_20260421_221540_79_A_85_A_user_id_space_undocumented.md`.
...
**ATOM CONSTANTS (from lupo-memory/atoms/lupopedia_global_constants.atom.toon):**
