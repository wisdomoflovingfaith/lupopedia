...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/08_A_CORE_AGENTS_SYSTEM.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/08_A_CORE_AGENTS_SYSTEM.md"
  status: active
  when_updated: "20260422232349"
  trust_tier: seed
  questions_toon: null
  memory_toon: lupo-memory/development/seed/2026/04/08_core_agents_system.toon
  atoms_toon: null
