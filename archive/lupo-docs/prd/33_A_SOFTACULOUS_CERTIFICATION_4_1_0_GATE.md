...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/33_A_SOFTACULOUS_CERTIFICATION_4_1_0_GATE.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/33_A_SOFTACULOUS_CERTIFICATION_4_1_0_GATE.md"
  status: active
  when_updated: "20260421223000"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/33_softaculous_certification_4_1_0_gate.toon
  atoms_toon: null
...
**Neither** approach is mandated in this PRD until an **APPROVED** decision (channel **`decisions/`** or **`lupo-docs/status/`**) picks one (or a **hybrid**: defaults on disk, overrides in DB). **4.2.0 gate:** the **chosen** approach is **implemented**, **English** ships as default, and **at least two** additional locales from the Crafty reference set (e.g. **Spanish**, **German**) are **demonstrably switchable** in the UI????????or deferral is **APPROVED** with hoster-visible rationale.
