...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/50_A_CRAFTY_SYNTAX_FEATURES_IN_LUPOPEDIA.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/50_A_CRAFTY_SYNTAX_FEATURES_IN_LUPOPEDIA.md"
  status: active
