...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/78_A_CLI_INTERFACE_PRD.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/78_A_CLI_INTERFACE_PRD.md"
  status: active
  when_updated: "20260422232349"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/78_cli_interface_prd.toon
  atoms_toon: null
