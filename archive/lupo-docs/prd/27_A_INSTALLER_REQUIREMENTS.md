...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/27_A_INSTALLER_REQUIREMENTS.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/27_A_INSTALLER_REQUIREMENTS.md"
  status: active
  when_updated: "20260422232349"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/27_installer_requirements.toon
  atoms_toon: null
...
- **Consolidated seed:** After DDL, the wizard runs `install/seed_lupopedia_4_2_0.sql` (single file). Source fragments remain in `lupo-database/lupopedia/mysql/seed/` for history and regeneration; rebuild with `lupo-scripts/build_consolidated_seed_4_2_0.py` when those sources change.
