...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/53_A_RUNTIME_GUARD.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/53_A_RUNTIME_GUARD.md"
  status: draft
  when_updated: "20260421223000"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/53_runtime_guard.toon
  atoms_toon: null
  ...
  prd_cluster: 00_A_FORBIDDEN_AND_WHY_53_A_RUNTIME_GUARD
...
The **master outline** referred to this work as **PRD 52**. In this repository **PRD 52** is **[52_memory_graph_focus_manifest.md](52_memory_graph_focus_manifest.md)** (Memory Graph Focus Manifest). This specification is **PRD 53** to avoid collision. Cross-links and tooling **SHOULD** use **`pk_id: 53`** and path **`lupo-docs/prd/53_runtime_guard.md`**.
...
4. **Continuation-after-artifact** ??? When policy requires ???single artifact then silence,??? flag extra probe content as violation (profile: **probe_runtime**; align with [`probe_runtime_guard.py`](../../lupo-scripts/probe_runtime_guard.py)).
...
| `PROBE_BOUNDARY_VIOLATION` | No extractable artifact per harness ([PRD 50](50_agent_coordination_protocol.md) section 1.2); align with [`probe_runtime_guard.py`](../../lupo-scripts/probe_runtime_guard.py). |
...
**Example B (collection scope fail):** Active collection contains only `lupo-docs/prd/53_runtime_guard.md`; examinee cites `lupo-docs/prd/99_other.md`; guard emits **`ACTOR_OUT_OF_COLLECTION_SCOPE`**.

## 9. Normative documentation graph (outbound edges)

| From | To | `edge_type` | `relationship` |
|------|-----|-------------|----------------|
| `53_runtime_guard.md` | `lupo-docs/prd/00_root_constitutional_system_requirements.md` | `doctrine_rule` | `constitutional_anchor_state_machines` |
| `53_runtime_guard.md` | `lupo-docs/prd/50_agent_coordination_protocol.md` | `doctrine_rule` | `coordinates_probes` |
| `53_runtime_guard.md` | `lupo-docs/prd/52_memory_graph_focus_manifest.md` | `doctrine_rule` | `graph_focus_lens` |
| `53_runtime_guard.md` | `lupo-docs/prd/54_actor_compliance.md` | `doctrine_rule` | `violations_recorded` |
| `53_runtime_guard.md` | `lupo-docs/prd/56_probe_harness_v2.md` | `doctrine_rule` | `probe_harness_v2` |
| `53_runtime_guard.md` | `lupo-docs/prd/58_transcript_filter.md` | `doctrine_rule` | `transcript_classification` |
| `53_runtime_guard.md` | `lupo-docs/prd/60_orchestrator_scheduler.md` | `doctrine_rule` | `orchestrator_scheduler` |
| `53_runtime_guard.md` | `lupo-docs/prd/38_memory_unification.md` | `doctrine_rule` | `audit_memory_graph` |
| `53_runtime_guard.md` | `lupo-docs/doctrine/AI_ACTOR_PROBE_HARNESS_AND_GUARDS.md` | `doctrine_rule` | `harness_alignment` |
| `53_runtime_guard.md` | `lupo-docs/prd/61_doctrine_consolidation_shorthand_compiler.md` | `doctrine_rule` | `invariant_checklist_enforcement` |
...
| **Auditor** (e.g. LILITH) | May consume **guard_event** stream; **MUST NOT** widen examinee permissions ([`lilith-noninterference-doctrine.md`](../../lupo-rules/root/lilith-noninterference-doctrine.md) ??? LIL001). |
