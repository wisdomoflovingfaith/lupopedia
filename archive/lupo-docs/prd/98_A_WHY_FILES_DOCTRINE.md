...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/98_A_WHY_FILES_DOCTRINE.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/98_A_WHY_FILES_DOCTRINE.md"
  status: active
  when_updated: "20260422232349"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/prd/canonical/1026/04/98-why-files-doctrine.toon
  atoms_toon: null
...
**All WHY violation reports MUST be created in the directory `lupo-docs/why/`.**

**Agents are FORBIDDEN from creating WHY files in the repository root or any other location.**

Validators MUST reject any WHY file created outside `lupo-docs/why/`.

WHY file generation logic MUST default to `lupo-docs/why/` as the output path.
...
file_being_updated: "lupo-docs/prd/16_C_LUPOPEDIA_HEADERS.md"
...
WHY_FILE_CONFIG = {
  "enabled": True,
  "auto_generate": True,
  "directory": "lupo-docs/why/",  # Hard requirement: all WHY files must be here
