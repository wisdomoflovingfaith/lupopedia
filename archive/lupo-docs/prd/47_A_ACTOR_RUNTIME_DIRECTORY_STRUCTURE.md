...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/47_A_ACTOR_RUNTIME_DIRECTORY_STRUCTURE.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/47_A_ACTOR_RUNTIME_DIRECTORY_STRUCTURE.md"
  status: active
  when_updated: "20260421223000"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/47_actor_runtime_directory_structure.toon
  atoms_toon: null
  ...
  summary: "Defines the canonical lupo-runtime directory structure for actor task isolation, channel coordination, and runtime state management."
---
...
#### 3.2.1 `lupo-runtime/channels.jsonl`
...
#### 3.2.2 `lupo-runtime/{channel_key}/actors.jsonl`
...
#### 3.2.3 `lupo-runtime/{channel_key}/{actor_id}/tasks.jsonl`
...
#### 3.2.4 `lupo-runtime/{channel_key}/{actor_id}/interrupts.jsonl`
...
#### 3.2.5 `lupo-runtime/{channel_key}/{actor_id}/dependencies.jsonl`
...
#### 3.2.6 `lupo-runtime/{channel_key}/{actor_id}/install_state.json`
