...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/73_A_COLLECTIONS_NAVIGATION.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/73_A_COLLECTIONS_NAVIGATION.md"
  status: active
  when_updated: "20260422232349"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/73_collections_navigation.toon
  atoms_toon: null
