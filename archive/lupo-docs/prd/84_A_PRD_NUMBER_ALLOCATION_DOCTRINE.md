...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/84_A_PRD_NUMBER_ALLOCATION_DOCTRINE.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/84_A_PRD_NUMBER_ALLOCATION_DOCTRINE.md"
  status: active
  when_updated: "20260421223000"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/84_prd_number_allocation_doctrine.toon
  atoms_toon: null
...
* `00_A` → all files matching `lupo-docs/prd/00_A*` 
* `16_C` → all files matching `lupo-docs/prd/16_C*` 
* `55_A` → all files matching `lupo-docs/prd/55_A*` 
