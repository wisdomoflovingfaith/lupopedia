...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/56_A_PROBE_HARNESS_V2.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/56_A_PROBE_HARNESS_V2.md"
  status: draft
  when_updated: "20260421223000"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/56_probe_harness_v2.toon
  atoms_toon: null
  ...
  prd_cluster: 00_A_FORBIDDEN_AND_WHY_56_A_PROBE_HARNESS_V2
...
Define **Probe Harness v2**, the successor operational pattern to ad-hoc scripting + [`probe_runtime_guard.py`](../../lupo-scripts/probe_runtime_guard.py) alone. The harness **delivers** reproducible probe packages, **binds** [collection payload v1.0.0](../doctrine/collection_payload_format_v1_0_0.md) when needed, **enforces** termination, and **coordinates** with [PRD 53](53_runtime_guard.md), [PRD 54](54_actor_compliance.md), [PRD 58](58_transcript_filter.md), and [PRD 60](60_orchestrator_scheduler.md).
...
|------|-----|-------------|----------------|
| `56_probe_harness_v2.md` | `lupo-docs/prd/00_root_constitutional_system_requirements.md` | `doctrine_rule` | `constitutional_contracts_state_machines` |
| `56_probe_harness_v2.md` | `lupo-docs/prd/50_agent_coordination_protocol.md` | `doctrine_rule` | `probe_protocol` |
| `56_probe_harness_v2.md` | `lupo-docs/prd/52_memory_graph_focus_manifest.md` | `doctrine_rule` | `graph_focus_lens` |
| `56_probe_harness_v2.md` | `lupo-docs/prd/53_runtime_guard.md` | `doctrine_rule` | `enforcement` |
| `56_probe_harness_v2.md` | `lupo-docs/prd/54_actor_compliance.md` | `doctrine_rule` | `compliance_hooks` |
| `56_probe_harness_v2.md` | `lupo-docs/prd/58_transcript_filter.md` | `doctrine_rule` | `telemetry_hygiene` |
| `56_probe_harness_v2.md` | `lupo-docs/prd/60_orchestrator_scheduler.md` | `doctrine_rule` | `slot_allocation` |
| `56_probe_harness_v2.md` | `lupo-docs/doctrine/collection_payload_format_v1_0_0.md` | `doctrine_rule` | `optional_payload` |
