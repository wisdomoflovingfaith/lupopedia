...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/60_A_ORCHESTRATOR_SCHEDULER.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/60_A_ORCHESTRATOR_SCHEDULER.md"
  status: draft
  when_updated: "20260421223000"
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/60_orchestrator_scheduler.toon
  atoms_toon: null
  ...
  prd_cluster: 00_A_FORBIDDEN_AND_WHY_60_A_ORCHESTRATOR_SCHEDULER
...
|------|-----|-------------|----------------|
| `60_orchestrator_scheduler.md` | `lupo-docs/prd/00_root_constitutional_system_requirements.md` | `doctrine_rule` | `constitutional_contracts_state_machines` |
| `60_orchestrator_scheduler.md` | `lupo-docs/prd/38_memory_unification.md` | `doctrine_rule` | `graph_load` |
| `60_orchestrator_scheduler.md` | `lupo-docs/prd/50_agent_coordination_protocol.md` | `doctrine_rule` | `coordination_transport` |
| `60_orchestrator_scheduler.md` | `lupo-docs/prd/52_memory_graph_focus_manifest.md` | `doctrine_rule` | `focus_hydration` |
| `60_orchestrator_scheduler.md` | `lupo-docs/prd/53_runtime_guard.md` | `doctrine_rule` | `guard_pipeline` |
| `60_orchestrator_scheduler.md` | `lupo-docs/prd/54_actor_compliance.md` | `doctrine_rule` | `reads_actor_state` |
| `60_orchestrator_scheduler.md` | `lupo-docs/prd/56_probe_harness_v2.md` | `doctrine_rule` | `dispatches_probes` |
| `60_orchestrator_scheduler.md` | `lupo-docs/prd/58_transcript_filter.md` | `doctrine_rule` | `transcript_segmentation` |
| `60_orchestrator_scheduler.md` | `lupo-docs/prd/60_orchestrator_scheduler.md` | `doctrine_rule` | `scheduler_invariants_self_anchor` |
| `60_orchestrator_scheduler.md` | `lupo-docs/prd/61_doctrine_consolidation_shorthand_compiler.md` | `doctrine_rule` | `invariant_checklist_scheduler` |
