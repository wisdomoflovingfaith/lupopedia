...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/prd/48_A_MANUAL_ORCHESTRATION_GAP.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/48_A_MANUAL_ORCHESTRATION_GAP.md"
  status: "active"
  when_updated: "20260422000000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/48-manual-orchestration-gap.toon"
  atoms_toon: null
...
### 2.2 Emoji Stripping
- Python script exists in `lupo-scripts/` (but not web-accessible)
...
- **Requirement**: PHP version of existing `lupo-scripts/strip_emoji.py`
