...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/prd/16_D_LUPOPEDIA_HEADERS_EXAMPLES.md
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/16_D_LUPOPEDIA_HEADERS_EXAMPLES.md"
  status: active
...
See also:
lupo-docs/prd/00_A_FORBIDDEN_AND_WHY.md
lupo-docs/prd/00_ROOT_CONSTITUTIONAL_SYSTEM_REQUIREMENTS.md
lupo-docs/prd/16_C_LUPOPEDIA_HEADERS.md
...
lupopedia.headers:
  header_format_version: "4.1.4"
  file_path_from_root: "lupo-docs/prd/example.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/example.md"
  status: "active"
  when_updated: "20260421130000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/headers/canonical/1026/04/example.toon"
  atoms_toon: "lupo-memory/atoms/lupopedia_global_constants.atom.toon"
...
#   trust_tier: "canonical"
#   questions_toon: null
#   memory_toon: "lupo-memory/development/canonical/1026/04/example-py.toon"
#   atoms_toon: "lupo-memory/atoms/lupopedia_global_constants.atom.toon"
...
| `memory_toon` | `lupo-memory/captains_log/canonical/1026/04/...` | Year offset applied (2026 -> 1026) |
...
lupopedia.headers:
  header_format_version: "4.1.4"
  file_path_from_root: "lupo-memory/doctrine/canonical/filename-normalization-session-2026-04-20.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-memory/doctrine/canonical/filename-normalization-session-2026-04-20.md"
  status: "active"
  when_updated: "20260420060000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/doctrine/canonical/filename-normalization-session-2026-04-20.toon"
  atoms_toon: null
...
lupopedia.footer:
  pending_edges:
    - to: lupo-docs/prd/16_C_LUPOPEDIA_HEADERS.md
