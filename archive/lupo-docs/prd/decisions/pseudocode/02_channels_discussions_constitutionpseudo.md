...
lupopedia.headers:
  ...
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/prd/decisions/pseudocode/02_channels_discussions_constitution.pseudo.md"
  questions_toon: null
  federation_node_id: 0
  channel_key: "development"
  trust_tier: "canonical"
  memory_key: "lupo-memory/development/canonical/1026/04/02-channels-discussions-constitution.toon"
  artifact_type: prd
...
lupo-bin/agent_wrapper.php 102 development 2026-04-12 -- php script.php

# Agent task polling (run every 30 seconds)
lupo-scripts/agent_poll_tasks.php 102 development 2026-04-12
```
...
│  │ 📄 lupo-scripts/validate_actor_id.php       (10 min ago)   │     │
│  │ 📄 lupo-docs/prd/16_lupopedia_headers.md    (15 min ago)   │     │
│  └────────────────────────────────────────────────────────────┘     │
│                                                                      │
├─────────────────────────────────────────────────────────────────────┤
...
*Source: `lupo-docs/prd/02_channels_discussions.md` and `lupo-docs/prd/81_agent_orchestration_chat.md`*
