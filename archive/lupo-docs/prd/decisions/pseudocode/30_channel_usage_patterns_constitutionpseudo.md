...
- **Channel filesystem** (`lupo-channels/â€¦`) is **Tier 1** coordination per [PRD 26](26_five_layer_documentation_architecture.md). **Permanent** specifications and doctrine live under **`lupo-docs/`**.
