...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_config_migration.md"
...
lupopedia.headers: {
  ...
  channel_id: 42,
  mood_vector: "8B4513",
  purpose: "Migration doctrine for livehelp_config â†’ lupo_modules.config_json (module_id = 1)",
