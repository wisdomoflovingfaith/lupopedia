...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_visits_monthly.md"
  file_hash: "69459a2bdbdaa10ae3c2b86e0e801f3d3ee0c45fa3ca559669d20a3208c6bc60"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/livehelp_visits_monthly.md"
  file_hash: "ecbec69a135f5fae1f4f824c852e27e597b2466ae713efe97540758caeec72d2"
  ...
  purpose: "Complete documentation for livehelp_visits_monthly table"
  ...
  tags: ["database", "table", "livehelp_visits_monthly"]
  lupo_agent: "codex-ide"
  livehelp_visits_monthly.recno: "int NOT NULL auto_increment"
  livehelp_visits_monthly.pageurl: "varchar(255) NOT NULL DEFAULT '0'"
  livehelp_visits_monthly.dateof: "int NOT NULL DEFAULT 0"
  livehelp_visits_monthly.levelvisits: "int unsigned NOT NULL DEFAULT 0"
  livehelp_visits_monthly.directvisits: "int unsigned NOT NULL DEFAULT 0"
  livehelp_visits_monthly.parentrec: "int unsigned NOT NULL DEFAULT 0"
  livehelp_visits_monthly.level: "int NOT NULL DEFAULT 0"
  livehelp_visits_monthly.department: "int NOT NULL DEFAULT 0"
  table_primary_key: "recno"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["dateof","department","directvisits","levelvisits","pageurl","parentrec"]
  table_foreign_keys: []
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/livehelp_visits_monthly.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_visits_monthly" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "livehelp_visits_monthly"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for livehelp_visits_monthly from TOON schema.
Type: database_table
...
Common Queries:
```sql
SELECT * FROM livehelp_visits_monthly WHERE recno = :id;
SELECT COUNT(*) AS total FROM livehelp_visits_monthly WHERE is_deleted = 0;
SELECT * FROM livehelp_visits_monthly ORDER BY recno DESC LIMIT 25;
UPDATE livehelp_visits_monthly SET updated_ymdhis = :ts WHERE recno = :id;
```
