...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_quick.md"
  file_hash: "aa398baa59315745f5a8a8f57664bf3d24ab0850c12e60f43eabd8126fa75c40"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/livehelp_quick.md"
  file_hash: "a6b00e86838a78a6b1945b6062edbdf0a5876265d2da4b0f817b2b0e85dd1026"
  ...
  purpose: "Complete documentation for livehelp_quick table"
  ...
  tags: ["database", "table", "livehelp_quick"]
  lupo_agent: "codex-ide"
  livehelp_quick.id: "int NOT NULL auto_increment"
  livehelp_quick.livehelp_id: "bigint unsigned NOT NULL DEFAULT 1"
  livehelp_quick.name: "varchar(50) NOT NULL DEFAULT ''"
  livehelp_quick.typeof: "varchar(30) NOT NULL DEFAULT ''"
  livehelp_quick.message: "mediumtext"
  livehelp_quick.visiblity: "varchar(20) NOT NULL DEFAULT ''"
  livehelp_quick.department: "varchar(60) NOT NULL DEFAULT '0'"
  livehelp_quick.user: "int NOT NULL DEFAULT 0"
  livehelp_quick.ishtml: "varchar(3) NOT NULL DEFAULT ''"
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/livehelp_quick.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_quick" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "livehelp_quick"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for livehelp_quick from TOON schema.
Type: database_table
...
| name | varchar(50) NOT NULL DEFAULT '' | from TOON |
| typeof | varchar(30) NOT NULL DEFAULT '' | from TOON |
| message | mediumtext | from TOON |
| visiblity | varchar(20) NOT NULL DEFAULT '' | from TOON |
| department | varchar(60) NOT NULL DEFAULT '0' | from TOON |
| user | int NOT NULL DEFAULT 0 | from TOON |
| ishtml | varchar(3) NOT NULL DEFAULT '' | from TOON |
...
Common Queries:
```sql
SELECT * FROM livehelp_quick WHERE id = :id;
SELECT COUNT(*) AS total FROM livehelp_quick WHERE is_deleted = 0;
SELECT * FROM livehelp_quick ORDER BY id DESC LIMIT 25;
UPDATE livehelp_quick SET updated_ymdhis = :ts WHERE id = :id;
```
