...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/migrations/livehelp_emailque_migration.md"
...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "lupo-docs\database\lupopedia\tables\livehelp_emailque_migration.md"
...
---
lupopedia.headers: {
  file_path_from_root: "lupo-docs/database/lupopedia/tables/livehelp_emailque_migration.md",
  file_hash: "20310be56efccf019f306610d07cc43f154a13409d48cc12ef342135d6749f7d"
  system_version: "4.0.50"
  channel_id: 42,
  mood_vector: "8B4513",
  purpose: "Migration doctrine for livehelp_emailque â†’ dropped (mail subsystem handles delivery)",
...
flip.footer: {
  ...
  outbound_edges: [
    ...
    { to: "lupo-docs/doctrine/migrations/livehelp_emails_migration.md", type: "related_to", weight: 0.6, hashtag: "#email_system" }
  ],
