...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_analytics_paths.md"
  file_hash: "49e1c3aef21a5ce04cc5f7fb90d020186fe0f4ebdc9a019274a25b9886fa38d8"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_analytics_paths.md"
  ...
  purpose: "Complete documentation for lupo_analytics_paths table"
  ...
  tags: ["database", "table", "lupo_analytics_paths"]
  lupo_agent: "codex-ide"
  lupo_analytics_paths.analytics_path_id: "bigint NOT NULL auto_increment"
  lupo_analytics_paths.from_page_id: "bigint"
  lupo_analytics_paths.to_page_id: "bigint"
  lupo_analytics_paths.year_month_yyyymm: "char(6) NOT NULL"
  lupo_analytics_paths.transition_type: "varchar(64) NOT NULL"
  lupo_analytics_paths.transition_count: "int NOT NULL DEFAULT 0"
  lupo_analytics_paths.metadata_json: "json"
  lupo_analytics_paths.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_analytics_paths.updated_ymdhis: "bigint NOT NULL"
  lupo_analytics_paths.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_analytics_paths.deleted_ymdhis: "bigint"
  table_primary_key: "analytics_path_id"
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_analytics_paths.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_analytics_paths" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_analytics_paths"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_analytics_paths from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| analytics_path_id | bigint NOT NULL auto_increment | from TOON |
| from_page_id | bigint | from TOON |
| to_page_id | bigint | from TOON |
| year_month_yyyymm | char(6) NOT NULL | from TOON |
| transition_type | varchar(64) NOT NULL | from TOON |
| transition_count | int NOT NULL DEFAULT 0 | from TOON |
...
Common Queries:
```sql
SELECT * FROM lupo_analytics_paths WHERE analytics_path_id = :id;
SELECT COUNT(*) AS total FROM lupo_analytics_paths WHERE is_deleted = 0;
SELECT * FROM lupo_analytics_paths ORDER BY analytics_path_id DESC LIMIT 25;
UPDATE lupo_analytics_paths SET updated_ymdhis = :ts WHERE analytics_path_id = :id;
```
