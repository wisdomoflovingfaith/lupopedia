...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_tab_events.md"
  file_hash: "453979ccfe057b1194088843dc45117907375c6496db01b8568e4751f654ac73"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_tab_events.md"
  ...
  purpose: "Complete documentation for lupo_tab_events table"
  ...
  tags: ["database", "table", "lupo_tab_events"]
  lupo_agent: "codex-ide"
  lupo_tab_events.tab_event_id: "bigint NOT NULL"
  lupo_tab_events.tab_id: "varchar(255) NOT NULL"
  lupo_tab_events.session_id: "varchar(255)"
  lupo_tab_events.actor_id: "bigint"
  lupo_tab_events.world_id: "bigint"
  lupo_tab_events.world_key: "varchar(255)"
  lupo_tab_events.world_type: "varchar(50)"
  lupo_tab_events.event_type: "varchar(100) NOT NULL"
  lupo_tab_events.event_data: "json"
  lupo_tab_events.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  table_primary_key: "tab_event_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_tab_events_idx_actor_id","lupo_tab_events_idx_created_ymdhis","lupo_tab_events_idx_event_type","lupo_tab_events_idx_session_id","lupo_tab_events_idx_tab_event_type","lupo_tab_events_idx_tab_id","lupo_tab_events_idx_world_id"]
  table_foreign_keys: []
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_tab_events.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_tab_events" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_tab_events"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_tab_events from TOON schema.
Type: database_table
...
| Column | Type | Notes |
|---|---|---|
| tab_event_id | bigint NOT NULL | from TOON |
| tab_id | varchar(255) NOT NULL | from TOON |
| session_id | varchar(255) | from TOON |
...
- tab_event_id
Performance Indexes:
- lupo_tab_events_idx_actor_id
- lupo_tab_events_idx_created_ymdhis
- lupo_tab_events_idx_event_type
- lupo_tab_events_idx_session_id
- lupo_tab_events_idx_tab_event_type
- lupo_tab_events_idx_tab_id
- lupo_tab_events_idx_world_id
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_tab_events WHERE tab_event_id = :id;
SELECT COUNT(*) AS total FROM lupo_tab_events WHERE is_deleted = 0;
SELECT * FROM lupo_tab_events ORDER BY tab_event_id DESC LIMIT 25;
UPDATE lupo_tab_events SET updated_ymdhis = :ts WHERE tab_event_id = :id;
```
