...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_mood_registry.md"
...
lupopedia.headers:
  ...
  lupo_mood_registry.mood_vector: "char(6) NOT NULL"
  ...
  table_indexes: ["lupo_mood_registry_idx_mood_vector","lupo_mood_registry_idx_mood_type"]
  table_foreign_keys: []
...
| mood_vector | char(6) NOT NULL | from TOON |
...
- mood_id
Performance Indexes:
- lupo_mood_registry_idx_mood_vector
