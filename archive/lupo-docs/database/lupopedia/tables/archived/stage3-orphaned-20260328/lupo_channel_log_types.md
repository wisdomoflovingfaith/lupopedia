...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_channel_log_types.md"
  file_hash: "c9491184e74a3111eb65c480992ebf08879fb4c85a7aad3535bb7579b2e7d6f1"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_channel_log_types.md"
  file_hash: "8856c77fcc881385142f665f5709cc9b79e340bcac99e9c6db89218e481f8d0e"
  ...
  purpose: "Complete documentation for lupo_channel_log_types table"
  ...
  tags: ["database", "table", "lupo_channel_log_types"]
  lupo_agent: "codex-ide"
  lupo_channel_log_types.log_type_id: "bigint NOT NULL"
  lupo_channel_log_types.type_key: "varchar(64) NOT NULL"
  lupo_channel_log_types.type_label: "varchar(255) NOT NULL"
  lupo_channel_log_types.description: "text"
  lupo_channel_log_types.is_system: "tinyint NOT NULL DEFAULT 0"
  lupo_channel_log_types.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_channel_log_types.updated_ymdhis: "bigint NOT NULL"
  lupo_channel_log_types.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_channel_log_types.deleted_ymdhis: "bigint"
  table_primary_key: "log_type_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: "lupo_channel_log_types_uniq_type_key"
  table_foreign_keys: []
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_channel_log_types.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_channel_log_types" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_channel_log_types"]
  version: "4.0.48"
  last_verified: "20260227"
  last_verified_by: "codex-ide"
---

# Table: lupo_channel_log_types

Purpose: Auto-generated documentation for lupo_channel_log_types from TOON schema.
Type: database_table
...
| type_label | varchar(255) NOT NULL | from TOON |
...
- log_type_id
Performance Indexes:
- lupo_channel_log_types_uniq_type_key
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_channel_log_types WHERE log_type_id = :id;
SELECT COUNT(*) AS total FROM lupo_channel_log_types WHERE is_deleted = 0;
SELECT * FROM lupo_channel_log_types ORDER BY log_type_id DESC LIMIT 25;
UPDATE lupo_channel_log_types SET updated_ymdhis = :ts WHERE log_type_id = :id;
```
