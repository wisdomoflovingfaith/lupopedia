...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_meta_log_events.md"
  file_hash: "eca10d271ac434e032655c7d2df121a771c777cb209f73afe8fbdc6e85a3adc6"
...
---
lupopedia.headers:
  file_path_from_root: "lupo-docs/database/lupopedia/tables/lupo_meta_log_events.md"
  file_hash: "6b6bdd60aa0af7f34693021e4664d32bbd2fe3ae3125ced88ef0a1a53ec6131b"
  ...
  purpose: "Complete documentation for lupo_meta_log_events table"
  ...
  tags: ["database", "table", "lupo_meta_log_events"]
  lupo_agent: "codex-ide"
  lupo_meta_log_events.event_id: "bigint NOT NULL"
  lupo_meta_log_events.depth: "tinyint NOT NULL"
  lupo_meta_log_events.event_type: "varchar(64) NOT NULL DEFAULT 'recursion'"
  lupo_meta_log_events.actor_id: "bigint"
  lupo_meta_log_events.created_ymdhis: "bigint NOT NULL DEFAULT 0"
  lupo_meta_log_events.is_deleted: "tinyint NOT NULL DEFAULT 0"
  lupo_meta_log_events.deleted_ymdhis: "bigint"
  table_primary_key: "event_id"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["lupo_meta_log_events_idx_actor_id","lupo_meta_log_events_idx_created_ymdhis","lupo_meta_log_events_idx_depth","lupo_meta_log_events_idx_is_deleted"]
  table_foreign_keys: []
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "lupo-database/lupopedia/toon/lupo_meta_log_events.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "lupo_meta_log_events" }
  ...
  inbound_edges: []
  semantic_tags: ["database", "table", "lupo_meta_log_events"]
  version: "4.0.48"
...
Purpose: Auto-generated documentation for lupo_meta_log_events from TOON schema.
Type: database_table
...
| depth | tinyint NOT NULL | from TOON |
| event_type | varchar(64) NOT NULL DEFAULT 'recursion' | from TOON |
...
- event_id
Performance Indexes:
- lupo_meta_log_events_idx_actor_id
- lupo_meta_log_events_idx_created_ymdhis
- lupo_meta_log_events_idx_depth
- lupo_meta_log_events_idx_is_deleted
Index Strategy: derived from TOON index definitions.

## 5. Usage Patterns
Common Queries:
```sql
SELECT * FROM lupo_meta_log_events WHERE event_id = :id;
SELECT COUNT(*) AS total FROM lupo_meta_log_events WHERE is_deleted = 0;
SELECT * FROM lupo_meta_log_events ORDER BY event_id DESC LIMIT 25;
UPDATE lupo_meta_log_events SET updated_ymdhis = :ts WHERE event_id = :id;
```
