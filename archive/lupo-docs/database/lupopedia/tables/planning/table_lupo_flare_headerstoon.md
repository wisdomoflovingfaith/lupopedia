...
lupopedia.headers:
  ...
  file_path_from_root: lupo-docs/database/lupopedia/tables/planning/table_lupo_flare_headers.toon.md
...
content_id bigint NOT NULL,
  ...
  purpose text,
  mood_vector varchar(6) DEFAULT NULL,
...
| mood_vector | varchar(6) | YES |  | NULL | |
