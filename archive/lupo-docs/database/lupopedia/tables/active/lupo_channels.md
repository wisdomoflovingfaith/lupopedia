...
lupopedia.headers:
  ...
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/database/lupopedia/tables/active/lupo_channels.md"
  questions_toon: null
  federation_node_id: 0
  channel_key: "development"
  trust_tier: "canonical"
  memory_key: "lupo-memory/development/canonical/1026/04/lupo-channels.toon"
  artifact_type: documentation
  artifact_kind: table_schema
  thread_id: ""
  content_id: null
  pk_id: null
  pk_slug: "lupo-channels"
  ...
  module: null
  dialog_transcript: "0/development/lupo-channels"
---
...
**Tooling (2026-04-12):** `lupo-scripts/export_channel_snapshots.py` is **deprecated** (exit stub only). Prefer **DB queries**, **`lupo_memory_nodes` / `lupo_memory_edges`**, **`php lupo-bin/export.php`**, or **`lupo-scripts/export_memory_nodes_116.py`**. Unsupported archived copy: **`lupo-scripts/legacy/export_channel_snapshots_archived_20260324.py`** (see **`lupo-scripts/legacy/README.md`**).
