...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/lupo_sticky_notes.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-docs/database/lupopedia/tables/active/lupo_sticky_notes.md"
  status: "active"
  when_updated: "20260415214000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/lupo_sticky_notes.toon"
  atoms_toon: null
...
- **Source of Truth:** Aligns with `lupo-database/lupopedia/json/lupo_sticky_notes.json`.
