...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/0/translation/concepts/08_crafty_syntax_migration.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-channels/0/translation/concepts/08_crafty_syntax_migration.md"
  status: "active"
...
- **Legacy Crafty Syntax PHP is not executed** as the Lupopedia engine. The supported path is **import and transform** from Crafty **3.7.5** data using the canonical importer SQL: `lupo-database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql` plus install/seed alignment.
...
## Developer Wording
Study Crafty Syntax in `lupo-legacy/` as **read-only reference**. Implement behavior in Lupopedia PHP/JS using PDO and current headers. Respect polling and operator semantics without copying unmaintained PHP 5.6 execution paths into the live request chain.
