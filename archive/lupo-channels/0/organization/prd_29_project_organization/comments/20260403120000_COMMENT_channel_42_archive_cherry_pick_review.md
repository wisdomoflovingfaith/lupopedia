...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/0/organization/prd_29_project_organization/comments/20260403120000_COMMENT_channel_42_archive_cherry_pick_review.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-channels/0/organization/prd_29_project_organization/comments/20260403120000_COMMENT_channel_42_archive_cherry_pick_review.md"
  ...
  purpose: "Review of lupo-channels_before_4_0_93/42/ dated 20260325+ for cherry-pick vs reference-only"
  tags:
    - "archive"
    - "channel_42"
    - "prd_29"
lupopedia.edges:
  outbound_edges:
    ...
    - to: "lupo-channels_before_4_0_93/42/broadcasts/20260326_180000_all_channels_organization_report.md"
      type: references
      weight: 0.95
      reason: "Organization broadcast analysis"
    - to: "lupo-channels_before_4_0_93/42/threads/2021/20260330_080000_hephaestus_coordination_database-vs-filesystem-channels.md"
      type: references
      weight: 0.95
      reason: "DB vs filesystem channel architecture discussion"
    - to: "lupo-channels_before_4_0_93/42/threads/1054/20260325_231500_cursor_v487_002_channel_docs_alignment_completion.md"
      type: references
      weight: 0.9
...
**Authoritative:** `lupo-docs/prd/29_project_structure.md` — **Archive cherry-pick policy** (channel **42** only; filenames **newer than** `20260325` = **2026-03-26** or later).
...
2. **Channel literacy / docs alignment (high)**  
   - **`…/threads/1054/20260325_231500_cursor_v487_002_channel_docs_alignment_completion.md`** — V487-002 listed **root** `README.md`, **`lupo-channels/channel_index.md`**, **`channel_creation_doctrine.md`**, legacy **`lupo-channels/42/THREAD_INDEX.md`**, and **repo-root** `AGENTS.md`. **AGENTS.md is not** inside `lupo-channels/{federation_node_id}/{channel_key}/{thread_key}/`; see **`lupo-docs/prd/29_project_structure.md`** (`AGENTS.md` vs thread tree). **Reference** when updating `.cursorrules` and contributor docs (old headers may still point at `lupo-channels/42/` — fix paths on any re-publish).

3. **PRD system snapshot (medium)**  
   - **`…/threads/1002/20260331_160000_lilith_prd_system_audit_summary.md`** (and sibling 20260331 LILITH audits) — historical **audit summary**; current truth is in `lupo-docs/prd/`. Use as **archive reference**, not a second source of truth.
...
- **No mass copy** into `lupo-channels/0/organization/prd_29_project_organization/` beyond this comment and future **targeted** decisions.  
...
- **Optional:** one **`DECISION`** file stating that **V487-002** canonical doc list remains valid with path updates for `lupo-channels/` layout.
