...
--
-- NOTE (4.0.98+): Canonical DDL is `lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql`
-- (`thread_key` column + UNIQUE on federation_node_id, channel_id, thread_key). Use this file only
-- for repairing older DBs created before that merge; fresh installs must not depend on it.
