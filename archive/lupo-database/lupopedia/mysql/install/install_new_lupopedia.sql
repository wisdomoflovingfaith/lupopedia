...
-- lupo_dialog_recent_files: tracks files recently discussed or modified within a channel for sidebar navigation
-- [EJECTED 4.1.2] dialog_recent_files removed
...
--      in lupo-config/llm_keys.php (excluded from git via .gitignore) and set
