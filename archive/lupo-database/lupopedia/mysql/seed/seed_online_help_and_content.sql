...
-- Paths: lupo-content/federation_node/0/captains_log/*.md
...
(
    ...
    '["#captains-log"]',
    'file_backed',
    'lupo-content/federation_node/0/captains_log/20260408_CHRONOLOGICAL_TRUST_LADDER.md'
),
(
    1000064, 0, 0, 1,
    ...
    '["#captains-log"]',
    'file_backed',
    'lupo-content/federation_node/0/captains_log/20260409_HEADER_WARS.md'
),
(
    1000065, 0, 0, 1,
...
(
    ...
    '["#captains-log"]',
    'file_backed',
    'lupo-content/federation_node/0/captains_log/20260409_UNIFIED_THEORY.md'
),
(
    1000067, 0, 0, 1,
    ...
    '["#captains-log"]',
    'file_backed',
    'lupo-content/federation_node/0/captains_log/20260409_DEPARTMENT_DOCTRINE.md'
),
(
    1000068, 0, 0, 1,
    ...
    '["#captains-log"]',
    'file_backed',
    'lupo-content/federation_node/0/captains_log/20260409_COLLECTIONS_WAR.md'
)
