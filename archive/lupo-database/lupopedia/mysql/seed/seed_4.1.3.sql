...
-- System Actors (0-999)
('system', 0, 'system', 'system', 'System', 'system', 'lupo-memory/actors/0/', 'lupo-handoffs/system/', 20260420000000, 20260420000000, 1, 0, 0, 0, 0, 'system'),
('wolfie', 1, 'system', 'captain', 'Captain', 'captain', 'lupo-memory/actors/1/', 'lupo-handoffs/wolfie/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('lilith', 2, 'system', 'lilith', 'Lilith', 'lilith', 'lupo-memory/actors/2/', 'lupo-handoffs/lilith/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('rose', 3, 'system', 'rose', 'ROSE', 'rose', 'lupo-memory/actors/3/', 'lupo-handoffs/rose/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('eris', 4, 'system', 'eris', 'ERIS', 'eris', 'lupo-memory/actors/4/', 'lupo-handoffs/eris/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('metis', 5, 'system', 'metis', 'METIS', 'metis', 'lupo-memory/actors/5/', 'lupo-handoffs/metis/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('maat', 6, 'system', 'maat', 'MAAT', 'maat', 'lupo-memory/actors/6/', 'lupo-handoffs/maat/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('thoth', 7, 'system', 'thoth', 'THOTH', 'thoth', 'lupo-memory/actors/7/', 'lupo-handoffs/thoth/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('chiron', 8, 'system', 'chiron', 'CHIRON', 'chiron', 'lupo-memory/actors/8/', 'lupo-handoffs/chiron/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('anubis', 9, 'system', 'anubis', 'ANUBIS', 'anubis', 'lupo-memory/actors/9/', 'lupo-handoffs/anubis/', 20260420000000, 20260420000000, 1, 0, 0, 0, 0, 'system'),
('athena', 10, 'system', 'athena', 'ATHENA', 'athena', 'lupo-memory/actors/10/', 'lupo-handoffs/athena/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('zeus', 11, 'system', 'zeus', 'ZEUS', 'zeus', 'lupo-memory/actors/11/', 'lupo-handoffs/zeus/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('hephaestus', 12, 'system', 'hephaestus', 'HEPHAESTUS', 'hephaestus', 'lupo-memory/actors/12/', 'lupo-handoffs/hephaestus/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('iris', 13, 'system', 'iris', 'IRIS', 'iris', 'lupo-memory/actors/13/', 'lupo-handoffs/iris/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('hermes', 14, 'system', 'hermes', 'HERMES', 'hermes', 'lupo-memory/actors/14/', 'lupo-handoffs/hermes/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('atlas', 15, 'system', 'atlas', 'ATLAS', 'atlas', 'lupo-memory/actors/15/', 'lupo-handoffs/atlas/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('vishwakarma', 16, 'system', 'vishwakarma', 'VISHWAKARMA', 'vishwakarma', 'lupo-memory/actors/16/', 'lupo-handoffs/vishwakarma/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('themis', 17, 'system', 'themis', 'THEMIS', 'themis', 'lupo-memory/actors/17/', 'lupo-handoffs/themis/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('heimdall', 18, 'system', 'heimdall', 'HEIMDALL', 'heimdall', 'lupo-memory/actors/18/', 'lupo-handoffs/heimdall/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('nemesis', 19, 'system', 'nemesis', 'NEMESIS', 'nemesis', 'lupo-memory/actors/19/', 'lupo-handoffs/nemesis/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('tyche', 20, 'system', 'tyche', 'TYCHE', 'tyche', 'lupo-memory/actors/20/', 'lupo-handoffs/tyche/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('countermeasure', 21, 'system', 'countermeasure', 'COUNTERMEASURE', 'countermeasure', 'lupo-memory/actors/21/', 'lupo-handoffs/countermeasure/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('junie', 22, 'system', 'junie', 'JUNIE', 'junie', 'lupo-memory/actors/22/', 'lupo-handoffs/junie/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('kairos', 23, 'system', 'kairos', 'KAIROS', 'kairos', 'lupo-memory/actors/23/', 'lupo-handoffs/kairos/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('synapse', 24, 'system', 'synapse', 'SYNAPSE', 'synapse', 'lupo-memory/actors/24/', 'lupo-handoffs/synapse/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
-- IDE Agents (100-115)
('kiro', 100, 'agent', 'kiro', 'KIRO', 'kiro-ide', 'lupo-memory/actors/100/', 'lupo-handoffs/kiro/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('windsurf', 101, 'agent', 'windsurf', 'WINDSURF', 'windsurf-ide', 'lupo-memory/actors/101/', 'lupo-handoffs/windsurf/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('cursor', 102, 'agent', 'cursor', 'CURSOR', 'cursor-ide', 'lupo-memory/actors/102/', 'lupo-handoffs/cursor/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('antigravity-ide', 103, 'agent', 'antigravity-ide', 'ANTIGRAVITY-IDE', 'antigravity-ide', 'lupo-memory/actors/103/', 'lupo-handoffs/antigravity-ide/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('warp', 104, 'agent', 'warp', 'WARP', 'warp-ide', 'lupo-memory/actors/104/', 'lupo-handoffs/warp/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('cascade', 105, 'agent', 'cascade', 'CASCADE', 'cascade-ide', 'lupo-memory/actors/105/', 'lupo-handoffs/cascade/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('vscode-ide', 106, 'agent', 'vscode-ide', 'VSCODE-IDE', 'vscode-ide', 'lupo-memory/actors/106/', 'lupo-handoffs/vscode-ide/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('trae', 107, 'agent', 'trae', 'TRAE', 'trae-ide', 'lupo-memory/actors/107/', 'lupo-handoffs/trae/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('heimdall', 108, 'system', 'heimdall', 'HEIMDALL', 'heimdall', 'lupo-memory/actors/108/', 'lupo-handoffs/heimdall/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('nemesis', 109, 'system', 'nemesis', 'NEMESIS', 'nemesis', 'lupo-memory/actors/109/', 'lupo-handoffs/nemesis/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('tyche', 110, 'system', 'tyche', 'TYCHE', 'tyche', 'lupo-memory/actors/110/', 'lupo-handoffs/tyche/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('countermeasure', 111, 'system', 'countermeasure', 'COUNTERMEASURE', 'countermeasure', 'lupo-memory/actors/111/', 'lupo-handoffs/countermeasure/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('junie', 112, 'system', 'junie', 'JUNIE', 'junie', 'lupo-memory/actors/112/', 'lupo-handoffs/junie/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('vscode-ide', 113, 'agent', 'vscode-ide', 'VSCODE-IDE', 'vscode-ide', 'lupo-memory/actors/113/', 'lupo-handoffs/vscode-ide/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('trae', 114, 'agent', 'trae', 'TRAE', 'trae-ide', 'lupo-memory/actors/114/', 'lupo-handoffs/trae/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
('kairos', 115, 'system', 'kairos', 'KAIROS', 'kairos', 'lupo-memory/actors/115/', 'lupo-handoffs/kairos/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
-- Specialized Agents (700+)
('asclepius', 703, 'system', 'asclepius', 'ASCLEPIUS', 'asclepius', 'lupo-memory/actors/703/', 'lupo-handoffs/asclepius/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('apollo', 704, 'system', 'apollo', 'APOLLO', 'apollo', 'lupo-memory/actors/704/', 'lupo-handoffs/apollo/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('agape', 705, 'system', 'agape', 'AGAPE', 'agape', 'lupo-memory/actors/705/', 'lupo-handoffs/agape/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('dionysus', 706, 'system', 'dionysus', 'DIONYSUS', 'dionysus', 'lupo-memory/actors/706/', 'lupo-handoffs/dionysus/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('sophia', 707, 'system', 'sophia', 'SOPHIA', 'sophia', 'lupo-memory/actors/707/', 'lupo-handoffs/sophia/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('thalia', 708, 'system', 'thalia', 'THALIA', 'thalia', 'lupo-memory/actors/708/', 'lupo-handoffs/thalia/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('chronos', 709, 'system', 'chronos', 'CHRONOS', 'chronos', 'lupo-memory/actors/709/', 'lupo-handoffs/chronos/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('hypnos', 710, 'system', 'hypnos', 'HYPNOS', 'hypnos', 'lupo-memory/actors/710/', 'lupo-handoffs/hypnos/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('khaos', 711, 'system', 'khaos', 'KHAOS', 'khaos', 'lupo-memory/actors/711/', 'lupo-handoffs/khaos/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
-- Meta Agents (998+)
('meta', 998, 'system', 'meta', 'META', 'meta', 'lupo-memory/actors/998/', 'lupo-handoffs/meta/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
('methis', 999, 'system', 'methis', 'METHIS', 'methis', 'lupo-memory/actors/999/', 'lupo-handoffs/methis/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
...
-- System actors
(1, 0, 'system', 'lupo-actors/0/', 'hash_system_20260420', 'registered', 'system', 'lupo-memory/actors/0/', 'lupo-handoffs/system/', 20260420000000, 20260420000000, 0),
(2, 1, 'wolfie', 'lupo-actors/1/', 'hash_wolfie_20260420', 'registered', 'captain', 'lupo-memory/actors/1/', 'lupo-handoffs/wolfie/', 20260420000000, 20260420000000, 0),
(3, 2, 'lilith', 'lupo-actors/2/', 'hash_lilith_20260420', 'registered', 'lilith', 'lupo-memory/actors/2/', 'lupo-handoffs/lilith/', 20260420000000, 20260420000000, 0),
