...
--   (1, 'template', 'Agent Template Layer', 'template', 'Immutable filesystem blueprint. Lives in lupo-agents/{slug}/', 0, NULL, 20260406000000),
--   (2, 'runtime',  'Actor Runtime Layer',  'runtime',  'Living runtime instance. Lives in lupo-actors/{actor_id}/', 1, NULL, 20260406000000);
