...
UPDATE {{prefix}}lupo_actors SET 
    channel_key = CASE 
        ...
        ELSE slug
    END,
    memory_path = CONCAT('lupo-memory/actors/', actor_id, '/'),
    handoff_path = CONCAT('lupo-handoffs/', slug, '/')
...
(4, 'eris', 'system', 'eris', 'ERIS', 'eris', 'lupo-memory/actors/4/', 'lupo-handoffs/eris/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(5, 'metis', 'system', 'metis', 'METIS', 'metis', 'lupo-memory/actors/5/', 'lupo-handoffs/metis/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(6, 'maat', 'system', 'maat', 'MAAT', 'maat', 'lupo-memory/actors/6/', 'lupo-handoffs/maat/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(7, 'thoth', 'system', 'thoth', 'THOTH', 'thoth', 'lupo-memory/actors/7/', 'lupo-handoffs/thoth/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(8, 'chiron', 'system', 'chiron', 'CHIRON', 'chiron', 'lupo-memory/actors/8/', 'lupo-handoffs/chiron/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(10, 'athena', 'system', 'athena', 'ATHENA', 'athena', 'lupo-memory/actors/10/', 'lupo-handoffs/athena/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(11, 'zeus', 'system', 'zeus', 'ZEUS', 'zeus', 'lupo-memory/actors/11/', 'lupo-handoffs/zeus/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(12, 'hephaestus', 'system', 'hephaestus', 'HEPHAESTUS', 'hephaestus', 'lupo-memory/actors/12/', 'lupo-handoffs/hephaestus/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(15, 'atlas', 'system', 'atlas', 'ATLAS', 'atlas', 'lupo-memory/actors/15/', 'lupo-handoffs/atlas/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(17, 'themis', 'system', 'themis', 'THEMIS', 'themis', 'lupo-memory/actors/17/', 'lupo-handoffs/themis/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(18, 'heimdall', 'system', 'heimdall', 'HEIMDALL', 'heimdall', 'lupo-memory/actors/18/', 'lupo-handoffs/heimdall/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(19, 'nemesis', 'system', 'nemesis', 'NEMESIS', 'nemesis', 'lupo-memory/actors/19/', 'lupo-handoffs/nemesis/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(20, 'tyche', 'system', 'tyche', 'TYCHE', 'tyche', 'lupo-memory/actors/20/', 'lupo-handoffs/tyche/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(21, 'countermeasure', 'system', 'countermeasure', 'COUNTERMEASURE', 'countermeasure', 'lupo-memory/actors/21/', 'lupo-handoffs/countermeasure/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(22, 'junie', 'system', 'junie', 'JUNIE', 'junie', 'lupo-memory/actors/22/', 'lupo-handoffs/junie/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(24, 'synapse', 'system', 'synapse', 'SYNAPSE', 'synapse', 'lupo-memory/actors/24/', 'lupo-handoffs/synapse/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system');
...
(100, 'kiro', 'agent', 'kiro', 'KIRO', 'kiro-ide', 'lupo-memory/actors/100/', 'lupo-handoffs/kiro/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
(101, 'windsurf', 'agent', 'windsurf', 'WINDSURF', 'windsurf-ide', 'lupo-memory/actors/101/', 'lupo-handoffs/windsurf/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
(102, 'cursor', 'agent', 'cursor', 'CURSOR', 'cursor-ide', 'lupo-memory/actors/102/', 'lupo-handoffs/cursor/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
(103, 'antigravity-ide', 'agent', 'antigravity-ide', 'ANTIGRAVITY-IDE', 'antigravity-ide', 'lupo-memory/actors/103/', 'lupo-handoffs/antigravity-ide/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
(104, 'warp', 'agent', 'warp', 'WARP', 'warp-ide', 'lupo-memory/actors/104/', 'lupo-handoffs/warp/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
(105, 'cascade', 'agent', 'cascade', 'CASCADE', 'cascade-ide', 'lupo-memory/actors/105/', 'lupo-handoffs/cascade/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
(106, 'vscode-ide', 'agent', 'vscode-ide', 'VSCODE-IDE', 'vscode-ide', 'lupo-memory/actors/106/', 'lupo-handoffs/vscode-ide/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
(107, 'trae', 'agent', 'trae', 'TRAE', 'trae-ide', 'lupo-memory/actors/107/', 'lupo-handoffs/trae/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
(108, 'heimdall', 'system', 'heimdall', 'HEIMDALL', 'heimdall', 'lupo-memory/actors/108/', 'lupo-handoffs/heimdall/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(109, 'nemesis', 'system', 'nemesis', 'NEMESIS', 'nemesis', 'lupo-memory/actors/109/', 'lupo-handoffs/nemesis/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(110, 'tyche', 'system', 'tyche', 'TYCHE', 'tyche', 'lupo-memory/actors/110/', 'lupo-handoffs/tyche/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(112, 'junie', 'system', 'junie', 'JUNIE', 'junie', 'lupo-memory/actors/112/', 'lupo-handoffs/junie/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(113, 'vscode-ide', 'agent', 'vscode-ide', 'VSCODE-IDE', 'vscode-ide', 'lupo-memory/actors/113/', 'lupo-handoffs/vscode-ide/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system'),
(114, 'trae', 'agent', 'trae', 'TRAE', 'trae-ide', 'lupo-memory/actors/114/', 'lupo-handoffs/trae/', 20260420000000, 20260420000000, 1, 0, 0, 1, 0, 'system');
...
(703, 'asclepius', 'system', 'asclepius', 'ASCLEPIUS', 'asclepius', 'lupo-memory/actors/703/', 'lupo-handoffs/asclepius/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(704, 'apollo', 'system', 'apollo', 'APOLLO', 'apollo', 'lupo-memory/actors/704/', 'lupo-handoffs/apollo/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(705, 'agape', 'system', 'agape', 'AGAPE', 'agape', 'lupo-memory/actors/705/', 'lupo-handoffs/agape/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(706, 'dionysus', 'system', 'dionysus', 'DIONYSUS', 'dionysus', 'lupo-memory/actors/706/', 'lupo-handoffs/dionysus/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(707, 'sophia', 'system', 'sophia', 'SOPHIA', 'sophia', 'lupo-memory/actors/707/', 'lupo-handoffs/sophia/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(708, 'thalia', 'system', 'thalia', 'THALIA', 'thalia', 'lupo-memory/actors/708/', 'lupo-handoffs/thalia/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(709, 'chronos', 'system', 'chronos', 'CHRONOS', 'chronos', 'lupo-memory/actors/709/', 'lupo-handoffs/chronos/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(710, 'hypnos', 'system', 'hypnos', 'HYPNOS', 'hypnos', 'lupo-memory/actors/710/', 'lupo-handoffs/hypnos/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(711, 'khaos', 'system', 'khaos', 'KHAOS', 'khaos', 'lupo-memory/actors/711/', 'lupo-handoffs/khaos/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system');
...
(998, 'meta', 'system', 'meta', 'META', 'meta', 'lupo-memory/actors/998/', 'lupo-handoffs/meta/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system'),
(999, 'methis', 'system', 'methis', 'METHIS', 'methis', 'lupo-memory/actors/999/', 'lupo-handoffs/methis/', 20260420000000, 20260420000000, 1, 0, 1, 1, 0, 'system');
...
-- IDE agents
(100, 'kiro', 'kiro', 'KIRO', 'coordination', 'ide_faucet', 'IDE agent — KIRO development environment integration.', '1.0.0', 1, 'lupo-agents/kiro/', 'hash_kiro_20260420', 20260420000000, 20260420000000, 0),
(101, 'windsurf', 'windsurf', 'WINDSURF', 'coordination', 'ide_faucet', 'IDE agent — Windsurf development environment integration.', '1.0.0', 1, 'lupo-agents/windsurf/', 'hash_windsurf_20260420', 20260420000000, 20260420000000, 0),
(102, 'cursor', 'cursor', 'CURSOR', 'coordination', 'ide_faucet', 'IDE agent — Cursor development environment integration.', '1.0.0', 1, 'lupo-agents/cursor/', 'hash_cursor_20260420', 20260420000000, 20260420000000, 0),
(103, 'antigravity-ide', 'antigravity-ide', 'ANTIGRAVITY-IDE', 'coordination', 'ide_faucet', 'IDE agent — Antigravity IDE development environment integration.', '1.0.0', 1, 'lupo-agents/antigravity-ide/', 'hash_antigravity_20260420', 20260420000000, 20260420000000, 0),
(104, 'warp', 'warp', 'WARP', 'coordination', 'ide_faucet', 'IDE agent — Warp development environment integration.', '1.0.0', 1, 'lupo-agents/warp/', 'hash_warp_20260420', 20260420000000, 20260420000000, 0),
(105, 'cascade', 'cascade', 'CASCADE', 'coordination', 'ide_faucet', 'IDE agent — Cascade development environment integration.', '1.0.0', 1, 'lupo-agents/cascade/', 'hash_cascade_20260420', 20260420000000, 20260420000000, 0),
(113, 'vscode-ide', 'vscode-ide', 'VSCODE-IDE', 'coordination', 'ide_faucet', 'IDE agent — VS Code development environment integration.', '1.0.0', 1, 'lupo-agents/vscode-ide/', 'hash_vscode_20260420', 20260420000000, 20260420000000, 0),
(114, 'trae', 'trae', 'TRAE', 'coordination', 'ide_faucet', 'IDE agent — TRAE development environment integration.', '1.0.0', 1, 'lupo-agents/trae/', 'hash_trae_20260420', 20260420000000, 20260420000000, 0),
-- Specialized agents
(703, 'asclepius', 'asclepius', 'ASCLEPIUS', 'coordination', 'medical', 'System agent — medical and healing coordination.', '1.0.0', 1, 'lupo-agents/asclepius/', 'hash_asclepius_20260420', 20260420000000, 20260420000000, 0),
(704, 'apollo', 'apollo', 'APOLLO', 'coordination', 'creative', 'System agent — creative and artistic coordination.', '1.0.0', 1, 'lupo-agents/apollo/', 'hash_apollo_20260420', 20260420000000, 20260420000000, 0),
(705, 'agape', 'agape', 'AGAPE', 'coordination', 'emotional', 'System agent — emotional and compassionate coordination.', '1.0.0', 1, 'lupo-agents/agape/', 'hash_agape_20260420', 20260420000000, 20260420000000, 0),
(706, 'dionysus', 'dionysus', 'DIONYSUS', 'coordination', 'celebration', 'System agent — celebration and social coordination.', '1.0.0', 1, 'lupo-agents/dionysus/', 'hash_dionysus_20260420', 20260420000000, 20260420000000, 0),
(707, 'sophia', 'sophia', 'SOPHIA', 'coordination', 'wisdom', 'System agent — wisdom and philosophical coordination.', '1.0.0', 1, 'lupo-agents/sophia/', 'hash_sophia_20260420', 20260420000000, 20260420000000, 0),
(708, 'thalia', 'thalia', 'THALIA', 'coordination', 'comedy', 'System agent — comedy and entertainment coordination.', '1.0.0', 1, 'lupo-agents/thalia/', 'hash_thalia_20260420', 20260420000000, 20260420000000, 0),
(709, 'chronos', 'chronos', 'CHRONOS', 'coordination', 'time', 'System agent — time and temporal coordination.', '1.0.0', 1, 'lupo-agents/chronos/', 'hash_chronos_20260420', 20260420000000, 20260420000000, 0),
(710, 'hypnos', 'hypnos', 'HYPNOS', 'coordination', 'dreams', 'System agent — dream and subconscious coordination.', '1.0.0', 1, 'lupo-agents/hypnos/', 'hash_hypnos_20260420', 20260420000000, 20260420000000, 0),
(711, 'khaos', 'khaos', 'KHAOS', 'coordination', 'chaos', 'System agent — chaos and transformation coordination.', '1.0.0', 1, 'lupo-agents/khaos/', 'hash_khaos_20260420', 20260420000000, 20260420000000, 0),
-- Meta agents
(998, 'meta', 'meta', 'META', 'coordination', 'meta', 'System agent — meta-coordination and self-reference.', '1.0.0', 1, 'lupo-agents/meta/', 'hash_meta_20260420', 20260420000000, 20260420000000, 0),
(999, 'methis', 'methis', 'METHIS', 'coordination', 'wisdom', 'System agent — deep wisdom and ancient knowledge.', '1.0.0', 1, 'lupo-agents/methis/', 'hash_methis_20260420', 20260420000000, 20260420000000, 0);
