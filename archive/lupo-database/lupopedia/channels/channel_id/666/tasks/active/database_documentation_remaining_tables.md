# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/666/tasks/active/database_documentation_remaining_tables
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["lupo-database/lupopedia/channels/lupo-channels/666/tasks/active/database_documentation_remaining_tables.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-database/lupopedia/channels/channel_id/666/tasks/active/database_documentation_remaining_tables.md"
...
lupopedia.see:
  mappings:
    - ["lupo-database/lupopedia/channels/lupo-channels/666/tasks/active/database_documentation_remaining_tables.md", "http://www.lupopedia.com/lupo-database/lupopedia/channels/lupo-channels/666/tasks/active/database_documentation_remaining_tables"]
