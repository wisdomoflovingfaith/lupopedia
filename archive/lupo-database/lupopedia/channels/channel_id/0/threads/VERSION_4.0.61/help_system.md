...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-database/lupopedia/channels/channel_id/0/threads/VERSION_4.0.61/help_system.md"
  questions_toon: null
...
- **lupo-docs/HELP.md** as documentation hub
...
- `web-help.php` (optional web endpoint for lupo-docs/HELP.md)
