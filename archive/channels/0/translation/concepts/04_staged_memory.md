...
lupopedia.headers:
  ...
  file_path_from_root: "channels/0/translation/concepts/04_staged_memory.md"
  web_path: "https://www.lupopedia.com/lupopedia/channels/0/translation/concepts/04_staged_memory.md"
  status: "active"
...
Memory persistence is split across the trust ladder. Agents write working logs to `memory/*/staging/`. These documents remain non-binding until a human or auditing actor runs a promotion execution block to move them to `memory/*/canonical/`, at which point they become binding doctrine.
