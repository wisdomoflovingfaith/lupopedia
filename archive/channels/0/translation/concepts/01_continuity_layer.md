...
lupopedia.headers:
  ...
  file_path_from_root: "channels/0/translation/concepts/01_continuity_layer.md"
  web_path: "https://www.lupopedia.com/lupopedia/channels/0/translation/concepts/01_continuity_layer.md"
  status: "active"
...
## Developer Wording
Treat filesystem artifacts as **continuity evidence and staging**, not silent replacements for `PDO_DB`. Hermes-style hooks may append transcripts and staging memory under documented paths; promotion to trusted reference remains explicit. See `docs/prd/38_memory_unification.md`.
...
Honolulu **DMV** continuity work in **1999** (solo developer, production pressure): disciplined reference exports and structured content so operations could continue during database instability. Narrative anchor: `content/federation_node/0/captains_log/20260416_dmv_1999_continuity_precedent.md`.
