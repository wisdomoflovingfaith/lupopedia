...
lupopedia.headers:
  ...
  file_path_from_root: "channels/0/semantic/mood_vector_system/decisions/20260404_190100_DECISION_APPROVED_mood_vector_color_definitions.md"
  web_path: "http://www.lupopedia.com/lupopedia/channels/0/semantic/mood_vector_system/decisions/20260404_190100_DECISION_APPROVED_mood_vector_color_definitions.md"
  questions_toon: null
...
lupopedia.edges:
  outbound_edges:
    ...
    - to: "docs/doctrine/COUNTING_IN_LIGHT.md"
      type: complements
      weight: 1.0
...
Full narrative, runtime rules, CADUCEUS alignment, and examples — see **`docs/doctrine/MOOD_VECTOR_DOCTRINE.md`** (summary) and prior repository history for the long-form doctrine text.
