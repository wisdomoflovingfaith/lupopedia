...
lupopedia.headers:
  ...
  file_path_from_root: "channels/0/semantic/mood_vector_system/README.md"
  web_path: "http://www.lupopedia.com/lupopedia/channels/0/semantic/mood_vector_system/README.md"
  questions_toon: null
...
The short **root doctrine** lives at **`docs/doctrine/MOOD_VECTOR_DOCTRINE.md`** (summary + pointers here).

Filename pattern (UTC): **`YYYYMMDD_HHIISS_TYPE_TITLE.md`**; under **`decisions/`** use **`DECISION_STATUS_TITLE`**. See **`docs/prd/17_decisions_format.md`**.
