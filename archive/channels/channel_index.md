...
lupopedia.headers:
  ...
  web_path: "https://www.lupopedia.com/lupopedia/channels/channel_index.md"
  status: "active"
  when_updated: "20260418142000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "memory/channels/canonical/1026/04/channel-index.toon"
  atoms_toon: null
...
| 0 | organization | Organization | Repo layout, docs system structure, PRD 29 coordination. **Key status file:** [documentation_gaps.md](../docs/versions/4.1.2/status/documentation_gaps.md) |
...
Old numeric channels are archived in `channels_before_4_0_93/` for historical reference. New work should use the human-readable structure above.
