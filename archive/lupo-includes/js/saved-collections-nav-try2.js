...
(function () {
    ...
    function lupoDbgMasterHydrateIfNeeded() {
        var panel = document.getElementById('lupo-try2-master-panel') || document.getElementById('lupo-dbg-master-panel');
        ...
        var url = (base === '' ? '' : base) + '/lupo-api/list_nav_collections_grouped.php';
        fetch(url)
            .then(function (r) {
                return r.json();
            })
            .then(function (data) {
                var master = document.querySelector('.lupo-master-collections-wrap');
            ...
            .catch(function () {
                var m = document.querySelector('.lupo-master-collections-wrap');
