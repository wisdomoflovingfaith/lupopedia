...
if ($action === 'save' || $action === 'dispatch') {
    ...
    if (file_exists($app_root . DIRECTORY_SEPARATOR . 'lupo-includes' . DIRECTORY_SEPARATOR . 'functions' . DIRECTORY_SEPARATOR . 'security.php')) {
        require_once $app_root . DIRECTORY_SEPARATOR . 'lupo-includes' . DIRECTORY_SEPARATOR . 'functions' . DIRECTORY_SEPARATOR . 'security.php';
    }
