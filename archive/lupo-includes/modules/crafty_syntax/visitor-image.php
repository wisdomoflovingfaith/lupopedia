...
if ($session_id !== '' && $what === 'getstate') {
    ...
    try {
        ...
        $stmt = $db->prepare(
            "INSERT INTO {$prefix}sessions (session_id, actor_id, federation_node_id, ip_hash, ua_hash, session_identity_hash, last_activity_ymdhis, created_ymdhis, updated_ymdhis, name_key, is_named)" .
            " VALUES (:sid, 0, 1, :ip_hash, :ua_hash, :identity_hash, :now, :now, :now, NULL, 0)" .
