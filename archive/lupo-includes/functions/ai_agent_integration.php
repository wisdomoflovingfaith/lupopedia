...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-includes/functions/ai_agent_integration.php"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-includes/functions/ai_agent_integration.php"
  questions_toon: null
...
function lupo_ai_integration_core_agents_ordered()
{
    ...
    $path = $root . DIRECTORY_SEPARATOR . 'lupo-database' . DIRECTORY_SEPARATOR . 'lupopedia' . DIRECTORY_SEPARATOR . 'actors' . DIRECTORY_SEPARATOR . 'registry.json';
    if (!is_file($path)) {
        return $fallback;
    }
