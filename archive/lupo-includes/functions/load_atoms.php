 ...
 * 1) lupo-memory/atoms/lupopedia_global_constants.atom.toon
...
function get_lupopedia_version()
{
    ...
    $atom_path = $root . DIRECTORY_SEPARATOR . 'lupo-memory' . DIRECTORY_SEPARATOR . 'atoms' . DIRECTORY_SEPARATOR . 'lupopedia_global_constants.atom.toon';
