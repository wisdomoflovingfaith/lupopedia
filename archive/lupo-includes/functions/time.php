<?php
/**
 * Temporal anchor pulse — refresh lupo-bin/temporal_anchor.json from PHP (real UTC).
 *
 * Keeps the same single source of truth as python lupo-bin/tick.py so IDE, chat, and
...
function lupo_pulse_temporal_anchor($minSeconds = 60)
{
    ...
    $anchorPath = $root . DIRECTORY_SEPARATOR . 'lupo-bin' . DIRECTORY_SEPARATOR . 'temporal_anchor.json';
