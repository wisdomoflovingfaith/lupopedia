...
<div class="content-list-container">
   ...
   <div class="dropdown">
    <img src="<?php echo htmlspecialchars($lupoPublicBase !== '' ? $lupoPublicBase . '/lupo-images/addshortcut.png' : 'lupo-images/addshortcut.png', ENT_QUOTES, 'UTF-8'); ?>" width="42" height="42" onclick="toggleMenu('shortcutDropdown', event)" style="cursor:pointer;"> 
  ...
  <div class="dropdown">
    <img src="<?php echo htmlspecialchars($lupoPublicBase !== '' ? $lupoPublicBase . '/lupo-images/contents.png' : 'lupo-images/contents.png', ENT_QUOTES, 'UTF-8'); ?>" width="42" height="42" onclick="toggleMenu('contentsDropdown', event)" style="cursor:pointer;">
