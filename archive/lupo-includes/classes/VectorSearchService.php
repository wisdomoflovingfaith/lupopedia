...
/**
 * wolfie.headers: {
 *   file_path_from_root: "lupo-includes/classes/VectorSearchService.php",
...
class VectorSearchService
{
    ...
    public function __construct()
    {
        ...
        $this->indexUrl = defined('PINECONE_INDEX_URL') ? PINECONE_INDEX_URL : 'https://lupo-semantic-os.svc.pinecone.io';
    }
