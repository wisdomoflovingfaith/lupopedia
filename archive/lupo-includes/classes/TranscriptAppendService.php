<?php
/**
 * PRD 16 §9 — DB-first transcript append (canonical write path).
 *
...
class TranscriptAppendService
{
     ...
     * @param array  $input channel_key, message, from_actor_id, dialog_transcript; optional created_ymdhis, task, context, federation_node_id override
    ...
    public static function append($db, $input, $options = array())
    {
        ...
        $row = array(
            ...
            'source_faucet_slug' => null,
            'source_faucet_instance_id' => null,
            'to_actor_id' => null,
            'read_by_actor_id' => 0,
            'read_by_actor_utc' => 0,
            'message_text' => $text,
