...
class AdminChannelChatHandler
{
    ...
    {
        require_once LUPOPEDIA_PATH . '/lupo-includes/classes/EffectiveActorResolver.php';
        ...
        ob_start();
        include LUPOPEDIA_PATH . '/lupo-includes/themes/default/layouts/admin_sections/channel_chat.php';
        return ob_get_clean();
    }
