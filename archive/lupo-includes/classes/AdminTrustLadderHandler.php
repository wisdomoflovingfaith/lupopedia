...
class AdminTrustLadderHandler
{
    ...
    {
        $registryPath = LUPOPEDIA_PATH . '/lupo-docs/doctrine/TRUST_LADDER_REGISTRY.md';
        $installSqlPath = LUPOPEDIA_PATH . '/lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql';
    ...
    private static function panelTierStats($db, $prefix)
    {
        ...
        $cutoff90 = '';
        if (class_exists('timestamp_ymdhis', false) || file_exists(LUPOPEDIA_PATH . '/lupo-includes/classes/TimestampYmdhis.php')) {
