...
class SkillService
{
    ...
    /** @var string base path for lupo-actors and lupo-skills */
    private $base_path;
    ...
    {
        $actors_dir = $this->base_path . DIRECTORY_SEPARATOR . 'lupo-actors';
     ...
     *
     * @param int $actor_id
     * @return string directory name (e.g. wolfie) for lupo-actors/{slug}
     */
    private function actorIdToSlug($actor_id)
    {
        ...
        $reg_path = $this->base_path . DIRECTORY_SEPARATOR . 'lupo-database' . DIRECTORY_SEPARATOR . 'lupopedia' . DIRECTORY_SEPARATOR . 'actors' . DIRECTORY_SEPARATOR . 'registry.json';
    ...
    /**
     * Get skill details from lupo-skills/{skill_name}/README.md.
     *
     * @param string $skill_name
    ...
    {
        $skill_dir = $this->base_path . DIRECTORY_SEPARATOR . 'lupo-skills' . DIRECTORY_SEPARATOR . str_replace(array('/', '\\'), '', $skill_name);
