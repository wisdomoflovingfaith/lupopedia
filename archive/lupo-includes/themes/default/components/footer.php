 ...
 * wolfie.header.placement: /lupo-includes/themes/default/components/footer.php
...
?>
<!-- Footer: path lupo-includes/themes/default/components/footer.php — fixed semantic icon bar toggled from main_layout title row (#lupo-footer-semantic-nav). -->
<footer class="main-footer">
    <!-- Semantic Navigation Bar (share, like, TRUTH, help, …) -->
    <div class="semantic-nav-bar" id="lupo-footer-semantic-nav" role="navigation" aria-label="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('layout.main_layout.footer_semantic_nav_aria', 'Semantic tools') : 'Semantic tools', ENT_QUOTES, 'UTF-8'); ?>" hidden>
...
.main-footer {
    margin-top: auto;
    padding-top: 60px; /* Space for fixed semantic nav bar when visible */
}

/* No reserved gap when the bar is hidden (title-row toggle; main-layout.css body class). */
body:not(.lupo-semantic-nav-visible) .main-footer {
    padding-top: 0;
}
