...
$loader_shell = ($root !== '') ? ($root . '/lupo-includes/functions/collection-tabs-loader.php') : '';
...
$lupo_body_layout_class = ($lupo_public_shell === 'scroll') ? 'lupo-scroll-layout' : 'lupo-book-layout';
...
<head>
    ...
    body.lupo-book-layout .resources-top-left,
    .content-list-container.lupo-book-layout .resources-top-left {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s1b.png') center / cover no-repeat;
    }
    body.lupo-book-layout .resources-top-center,
    .content-list-container.lupo-book-layout .resources-top-center {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s2b.png');
        background-repeat: repeat-x;
        background-position: center top;
    }
    body.lupo-book-layout .resources-top-right,
    .content-list-container.lupo-book-layout .resources-top-right {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s3b.png') center / cover no-repeat;
    }
    body.lupo-book-layout .resources-middle-left,
    .content-list-container.lupo-book-layout .resources-middle-left {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s4b.png');
        background-repeat: repeat-y;
        background-position: left center;
    }
    body.lupo-book-layout .resources-middle-center,
    .content-list-container.lupo-book-layout .resources-middle-center {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s5.png');
        background-repeat: repeat;
        padding: 20px;
    }
    body.lupo-book-layout .resources-middle-right,
    .content-list-container.lupo-book-layout .resources-middle-right {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s6b.png');
        background-repeat: repeat-y;
        background-position: right center;
    }
    body.lupo-book-layout .resources-bottom-left,
    .content-list-container.lupo-book-layout .resources-bottom-left {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s7b.png') center / cover no-repeat;
    }
    body.lupo-book-layout .resources-bottom-center,
    .content-list-container.lupo-book-layout .resources-bottom-center {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s8b.png');
        background-repeat: repeat-x;
        background-position: center bottom;
    }
    body.lupo-book-layout .resources-bottom-right,
    .content-list-container.lupo-book-layout .resources-bottom-right {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s9b.png') center / cover no-repeat;
    }
    body.lupo-scroll-layout .resources-top-left,
    .content-list-container.lupo-scroll-layout .resources-top-left {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s1a.png') center / cover no-repeat;
    }
    body.lupo-scroll-layout .resources-top-center,
    .content-list-container.lupo-scroll-layout .resources-top-center {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s2a.png');
        background-repeat: repeat-x;
        background-position: center top;
    }
    body.lupo-scroll-layout .resources-top-right,
    .content-list-container.lupo-scroll-layout .resources-top-right {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s3a.png') center / cover no-repeat;
    }
    body.lupo-scroll-layout .resources-middle-left,
    .content-list-container.lupo-scroll-layout .resources-middle-left {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s4a.png');
        background-repeat: repeat-y;
        background-position: left center;
    }
    body.lupo-scroll-layout .resources-middle-center,
    .content-list-container.lupo-scroll-layout .resources-middle-center {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s5a.png');
        background-repeat: repeat;
        padding: 20px;
    }
    body.lupo-scroll-layout .resources-middle-right,
    .content-list-container.lupo-scroll-layout .resources-middle-right {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s6a.png');
        background-repeat: repeat-y;
        background-position: right center;
    }
    body.lupo-scroll-layout .resources-bottom-left,
    .content-list-container.lupo-scroll-layout .resources-bottom-left {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s7a.png') center / cover no-repeat;
    }
    body.lupo-scroll-layout .resources-bottom-center,
    .content-list-container.lupo-scroll-layout .resources-bottom-center {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s8a.png');
        background-repeat: repeat-x;
        background-position: center bottom;
    }
    body.lupo-scroll-layout .resources-bottom-right,
    .content-list-container.lupo-scroll-layout .resources-bottom-right {
        background: url('<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/s9a.png') center / cover no-repeat;
    }
    </style>
...
<input type="hidden" id="lupo-current-content-id" name="lupo_current_content_id" value="<?= (int) $page_content_id ?>">
...
<?php
$lupo_sc_try2 = LUPOPEDIA_PATH . '/lupo-includes/themes/default/components/saved-collections-nav-try2.php';
...
<script src="<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-includes/js/saved-collections-nav-try2.js"></script>

<?php if (!$hide_semantic_nav): ?>
<!-- 9-slice book shell: grid lives on .content-list-container (main is landmark only; display:contents in CSS). -->
<main id="lupo-book-shell" class="lupo-book-shell">
<div class="content-list-container <?= htmlspecialchars($lupo_body_layout_class, ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="resources-top-center">
        <!-- Shortcut Dropdown -->
        <div class="dropdown">
            <img src="<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/addshortcut.png" width="42" height="42" onclick="lupoOpenShortcutDropdown(event)" style="cursor:pointer;" alt="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('layout.main_layout.shortcut_trigger_alt', 'Add shortcut') : 'Add shortcut', ENT_QUOTES, 'UTF-8'); ?>" title="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('layout.main_layout.shortcut_trigger_alt', 'Add shortcut') : 'Add shortcut', ENT_QUOTES, 'UTF-8'); ?>"> 
                ...
                <div id="shortcut-tabs-list">
                    ...
                    <?php if (!empty($tabs_data) && is_array($tabs_data)): ?>
                        <?php foreach ($tabs_data as $main_tab => $sub_tabs): ?>
                            ...
                            ?>
                            <a href="javascript:void(0)" class="main-tab lupo-shortcut-pin" role="button" data-collection-tab-id="<?= $root_tab_id ?>" onclick="lupoAddCurrentPageToCollectionTab(this); return false;">| <?= htmlspecialchars($main_tab) ?></a>
                            <?php if (is_array($sub_tabs)): ?>
                                <?php if (!empty($sub_tabs['_children']) && is_array($sub_tabs['_children'])): ?>
                                    <?php foreach ($sub_tabs['_children'] as $child): ?>
                                        ...
                                        ?>
                                        <a href="javascript:void(0)" class="sub-tab lupo-shortcut-pin" role="button" data-collection-tab-id="<?= $ctid ?>" onclick="lupoAddCurrentPageToCollectionTab(this); return false;">|— <?= htmlspecialchars($cname) ?></a>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <?php foreach ($sub_tabs as $key => $value): ?>
                                        ...
                                        ?>
                                        <a href="javascript:void(0)" class="sub-tab lupo-shortcut-pin" role="button" data-collection-tab-id="0" onclick="lupoAddCurrentPageToCollectionTab(this); return false;">|— <?= htmlspecialchars($value) ?></a>
                                    <?php endforeach; ?>
                                <?php endif; ?>
        ...
        <!-- Contents Dropdown -->
        <div class="dropdown">
            <img src="<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/contents.png" width="42" height="42" onclick="toggleMenu('contentsDropdown', event)" style="cursor:pointer;" alt="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('layout.main_layout.contents_trigger_alt', 'Page contents') : 'Page contents', ENT_QUOTES, 'UTF-8'); ?>" title="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('layout.main_layout.contents_trigger_alt', 'Page contents') : 'Page contents', ENT_QUOTES, 'UTF-8'); ?>">
        ...
        &nbsp;
        <div class="lupo-semantic-nav-title-triggers" style="display: flex; align-items: center; margin-left: auto; gap: 4px;">
            <img src="<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/semantic_show_icon.png" width="194" height="42" class="lupo-semantic-show-nav-trigger edges-responsive" style="cursor:pointer;" role="button" tabindex="0" alt="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('layout.main_layout.semantic_show_alt', 'Show footer semantic bar') : 'Show footer semantic bar', ENT_QUOTES, 'UTF-8'); ?>" title="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('layout.main_layout.semantic_show_alt', 'Show footer semantic bar') : 'Show footer semantic bar', ENT_QUOTES, 'UTF-8'); ?>">
            <img src="<?= LUPOPEDIA_PUBLIC_PATH ?>/lupo-images/semantic_hide_icon.png" width="44" height="42" class="lupo-semantic-hide-nav-trigger edges-responsive" role="button" tabindex="0" alt="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('layout.main_layout.semantic_hide_alt', 'Hide footer semantic bar') : 'Hide footer semantic bar', ENT_QUOTES, 'UTF-8'); ?>" title="<?php echo htmlspecialchars(function_exists('lupo_t') ? lupo_t('layout.main_layout.semantic_hide_alt', 'Hide footer semantic bar') : 'Hide footer semantic bar', ENT_QUOTES, 'UTF-8'); ?>">
        </div>
    </div>
    ...
    if ($lupo_at !== '' || $lupo_mk !== '') {
        echo ' data-lupo-artifact-type="' . htmlspecialchars($lupo_at, ENT_QUOTES, 'UTF-8') . '"';
        echo ' data-lupo-memory-key="' . htmlspecialchars($lupo_mk, ENT_QUOTES, 'UTF-8') . '"';
    }
    if ($lupo_edge_focus !== '') {
        echo ' data-lupo-edge-focus="' . htmlspecialchars($lupo_edge_focus, ENT_QUOTES, 'UTF-8') . '"';
    }
    ?>>
