 ...
 * ---------------------------------------------------------
 * crafty_syntax_eyes.js uses new DynLayer(id) — provided by lupo-layers.js as LupoLayer alias.
 * Do not load lupo-includes/js/dynlayer.js in the same page (duplicate globals).
 */
lupo_enqueue_js(LUPOPEDIA_PUBLIC_PATH . '/lupo-includes/js/lupo-layers.js');
