...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/25_departments_system/decisions/THREAD_INDEX.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/25_departments_system/decisions/THREAD_INDEX.md"
  questions_toon: null
...
- Primary channel: 42 (Protocol Development) — legacy numeric tree; see **`channels/channel_index.md`** and **`docs/prd/29_project_structure.md`** for the active path layout.
