...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/34_federation_node_semantic_network/edges.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/34_federation_node_semantic_network/edges.md"
  questions_toon: null
...
| [install SQL](../../../database/lupopedia/mysql/install/install_new_lupopedia.sql) | references | Current federation DDL |
