...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/IMPLEMENTATION_QUESTIONS_GUIDE.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/IMPLEMENTATION_QUESTIONS_GUIDE.md"
  questions_toon: null
...
Structured **questions**, **answers**, and **decisions** for a feature **belong under** **`docs/implementations/{prd_file_stem}/`**, where **`prd_file_stem`** matches the canonical PRD **`docs/prd/{prd_file_stem}.md`**. **Normative layout and lifecycle:** **[PRD 31 — Implementation folder guidelines](../prd/31_implementation_folder_guidelines.md)**. **Constitutional summary:** **[PRD 00 — Section 5.8](../prd/00_root_constitutional_system_requirements.md)** (IDE mirroring rule). **Index:** **[implementations/README.md](README.md)**.
...
python scripts/validate_implementation_questions.py 25_departments_system

# Validate all implementations
python scripts/validate_implementation_questions.py --all
```
