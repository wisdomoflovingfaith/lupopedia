...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/16_lupopedia_headers/decisions/pseudocode/sync_header_artifact_to_db.pseudo.php"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/16_lupopedia_headers/decisions/pseudocode/sync_header_artifact_to_db.pseudo.php"
  questions_toon: null
...
lupopedia.edges:
  outbound_edges:
    - to: "scripts/lib/header_db_sync.py"
      type: references
      weight: 1.0
...
*/
/**
 * PSEUDOCODE — mirrors intent of scripts/lib/header_db_sync.py
 ...
 *
 * Spec: docs/prd/16_lupopedia_headers.md
 * Python source of truth: scripts/lib/header_db_sync.py
 */
