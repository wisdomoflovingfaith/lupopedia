...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/26_five_layer_documentation_architecture/edges.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/26_five_layer_documentation_architecture/edges.md"
  questions_toon: null
...
### PHP Classes
- **ImplementationValidator**: scripts/validate_implementation.py - Main validation logic
- **DocumentationFactory**: includes/classes/DocumentationFactory.php - Document generation

### Scripts
- **validate_implementation.py**: scripts/ - Validation enforcement
- **pre_commit_validate.py**: scripts/ - CI integration

### Services
- **ValidationService**: includes/services/ValidationService.php - Validation API
...
- **Shared Components**: scripts/validate_implementation.py - Validation script
...
### Templates
- **documentation_index.php**: views/admin/ - Documentation management
- **validation_report.php**: views/admin/ - Validation results

### JavaScript
- **documentation_manager.js**: ui/js/ - Documentation UI interactions
- **validation_status.js**: ui/js/ - Real-time validation status

### CSS
- **documentation.css**: ui/css/ - Documentation styling
