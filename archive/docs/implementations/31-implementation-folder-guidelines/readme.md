...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/31_implementation_folder_guidelines/README.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/31_implementation_folder_guidelines/README.md"
  questions_toon: null
...
```bash
python scripts/validate_implementation_questions.py 31_implementation_folder_guidelines
```
