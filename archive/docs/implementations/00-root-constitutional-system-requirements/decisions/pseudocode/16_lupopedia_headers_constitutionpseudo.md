...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/00_root_constitutional_system_requirements/decisions/pseudocode/16_lupopedia_headers_constitution.pseudo.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/00_root_constitutional_system_requirements/decisions/pseudocode/16_lupopedia_headers_constitution.pseudo.md"
  questions_toon: null
...
| **`when_updated` / `last_modified_utc`** | **14-digit BIGINT UTC** from **`python bin/tick.py`** batch — **no** guessed time. |
...
- Validate: **`python scripts/validate_lupopedia_headers_universal.py`**
- Import + metadata sync: **`import_content.py`**, **`scripts/lib/header_db_sync.py`**
