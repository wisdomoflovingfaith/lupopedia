...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/{number}_{name}/decisions/YYYYMMDD_HHIISS_DECISION_purpose_TITLE.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/{number}_{name}/decisions/YYYYMMDD_HHIISS_DECISION_purpose_TITLE.md"
  questions_toon: null
