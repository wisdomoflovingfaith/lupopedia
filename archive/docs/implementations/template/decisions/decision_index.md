...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/{number}_{name}/decisions/DECISION_INDEX.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/{number}_{name}/decisions/DECISION_INDEX.md"
  questions_toon: null
