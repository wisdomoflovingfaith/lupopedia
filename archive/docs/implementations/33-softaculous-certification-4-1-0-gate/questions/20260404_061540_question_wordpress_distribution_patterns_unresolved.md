...
lupopedia.headers:
  ...
  file_path_from_root: "docs/implementations/33_softaculous_certification_4_1_0_gate/questions/20260404_061540_QUESTION_wordpress_distribution_patterns_unresolved.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/implementations/33_softaculous_certification_4_1_0_gate/questions/20260404_061540_QUESTION_wordpress_distribution_patterns_unresolved.md"
  questions_toon: null
...
Study session **UTC `20260404061540`**. Reference: **`archive/legacy/wordpress-reference/`** (WordPress **6.9.4** in this checkout). See **PRD 33 Section 14** and **`status/wordpress_study_20260404.md`**.
...
- **PRD:** Section **14.4** in `docs/prd/33_softaculous_certification_4_1_0_gate.md`

## Next steps (for implementers)

- [ ] Execute phases in **`status/wordpress_pattern_implementation_tasks_20260404.md`**
- [ ] Track rows in **`docs/versions/`** current **`TODO.md`** per **PRD 33 §12**
