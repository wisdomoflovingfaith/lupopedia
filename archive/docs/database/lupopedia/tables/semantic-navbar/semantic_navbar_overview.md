...
lupopedia.headers:
  ...
  file_path_from_root: docs/database/lupopedia/tables/semantic_navbar/SEMANTIC_NAVBAR_OVERVIEW.md
...
- **Existing tables:** See `docs/database/lupopedia/tables/active/` for lupo_paths, lupo_edges, lupo_collections, lupo_collection_tabs, lupo_collection_tab_map, lupo_collection_tab_paths, lupo_contents, lupo_truth_knowledge, lupo_truth_answers, lupo_visits.
...
See also: **SEMANTIC_NAVBAR_TABLE_AUDIT_REPORT.md** and **docs/frontend/semantic_navbar.md** (API endpoints, SQL usage, data flow diagram, external-site behavior).
