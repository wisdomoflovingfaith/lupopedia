...
lupopedia.headers:
  ...
  file_path_from_root: docs/database/lupopedia/tables/PROJECT_REGISTRY_SCHEMA_DESIGN.md
...
lupopedia.edges:
  ...
  - to: docs/doctrine/PROJECT_REGISTRY_DOCTRINE.md
    type: implements
    weight: 1.0
  - to: docs/database/lupopedia/tables/sql_drafts/create_lupo_projects.sql.md
    type: specifies
    weight: 0.95
