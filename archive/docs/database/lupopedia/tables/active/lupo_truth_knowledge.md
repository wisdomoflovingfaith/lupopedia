...
file_path_from_root: "docs/database/lupopedia/tables/active/lupo_truth_knowledge.md"
web_path: "http://www.lupopedia.com/lupopedia/docs/database/lupopedia/tables/active/lupo_truth_knowledge.md"
...
lupopedia.edges:
  ...
  outbound_edges:
  - to: "database/lupopedia/json/lupo_truth_knowledge.json"
    type: "references"
    weight: 1.0
