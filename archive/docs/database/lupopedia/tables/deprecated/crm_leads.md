---
lupopedia.headers:
  file_path_from_root: "docs/database/lupopedia/tables/deprecated/crm_leads.md"
...
- { to: "docs/database/lupopedia/tables/crm_lead_messages.md", type: "references", weight: 0.8 }
    - { to: "database/lupopedia/toon/lupo_crm_leads.toon.json", type: "schema_reference", weight: 1.0 }
...
**Schema:** See `database/lupopedia/toon/lupo_crm_leads.toon.json`. Primary key: `lead_id` (or as in TOON). All column names and types must match the TOON.
...
**Migration:** `docs/doctrine/migrations/livehelp_leads_migration.md`, `import_from_old_crafty_syntax.sql`. Field mapping and ID preservation as defined in the migration doc and import SQL. livehelp_leads â†’ IMPORTED â†’ DROPPED.
