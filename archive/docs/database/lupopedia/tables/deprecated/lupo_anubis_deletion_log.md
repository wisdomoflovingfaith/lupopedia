...
lupopedia.headers:
  ...
  file_path_from_root: docs/database/lupopedia/tables/deprecated/lupo_anubis_deletion_log.md
  channel_id: 1
  actor_id: 103
  questions_toon: null
...
lupopedia.edges:
  outbound_edges:
  - to: database/lupopedia/toon/lupo_anubis_deletion_log.toon.json
    type: references
    weight: 1.0
