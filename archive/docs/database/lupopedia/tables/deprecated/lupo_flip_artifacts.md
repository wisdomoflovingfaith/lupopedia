...
lupopedia.headers:
  ...
  file_path_from_root: docs/database/lupopedia/tables/deprecated/lupo_flip_artifacts.md
  channel_id: 1
  actor_id: 103
  questions_toon: null
...
lupopedia.edges:
  outbound_edges:
  - to: database/lupopedia/toon/lupo_flip_artifacts.toon.json
    type: references
    weight: 1.0
  - to: docs/database/lupopedia/tables/active/lupo_artifacts.md
    type: references
    weight: 0.9
