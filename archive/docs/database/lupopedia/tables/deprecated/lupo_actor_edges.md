...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/deprecated/lupo_actor_edges.md"
  file_hash: "f232016988acc4bf29d0349e11fded2179da28936840b1126e9c86da6367770b"
  last_updated_utc: "20260325000000"
  ...
  purpose: "DEPRECATED 4.0.87 - lupo_actor_edges removed, consolidated into lupo_edges"
  namespace: "core"
  mood_vector: "4169E1"
  traits: ["deprecated", "v4.0.87"]
  tags: ["documentation", "deprecated", "edge_consolidation"]
  lupo_agent: "cursor"

lupopedia.edges:
  outbound_edges:
    - { to: "docs/database/lupopedia/tables/active/lupo_edges.md", type: "superseded_by", weight: 1.0 }
...
flip.footer: {
  outbound_edges: [
    { to: "database/lupopedia/toon/lupo_actor_edges.toon.json", type: "schema_reference", weight: 1.0 },
