...
lupopedia.headers:
  ...
  file_path_from_root: docs/database/lupopedia/tables/TABLE_INDEX_KIRO.md
...
lupopedia.edges:
  outbound_edges:
  - to: docs/database/lupopedia/tables/TABLE_INDEX.md
    type: references
    weight: 1.0
...
**Version:** 4.0.74  
**Source:** `database/lupopedia/toon/` (YAML TOONs) per Captain Wolfie directive  
**Purpose:** Comprehensive table index with KIRO authority and multi-agent domain coverage
...
4. **TOON source**: References `database/lupopedia/toon/` (YAML format)
...
|----------|-------|-------|
| **Total TOON tables (YAML)** | 230+ | `database/lupopedia/toon/` |
