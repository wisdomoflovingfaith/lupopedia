...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["docs\database\lupopedia\tables\lupo_channel_tables_overview.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/active/lupo_channel_tables_overview.md"
  ...
  tags: ["docs", "database", "lupopedia", "tables", "lupo_channel_tables_overviewmd"]
...
lupopedia.see:
  mappings:
    - ["docs\database\lupopedia\tables\lupo_channel_tables_overview.md", "http://www.lupopedia.com/LUPO_CHANNEL_TABLES_OVERVIEW"]
...
- **Complete TOON Listing**: All `lupo_channel_*.toon.json` files in `database/lupopedia/toon/`
