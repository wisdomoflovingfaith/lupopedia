---`nlupopedia.footer:
  ...
  file_path_from_root: docs/database/lupopedia/tables/active/lupo_decision_evidence.md
  channel_id: 42
  actor_id: 102
  actor_name: hermes
  faucet_name: cascade
...
- **Decision**: `lupo_decision_evidence.decision_id` â†’ `lupo_decisions.decision_id`
- **Channel**: `lupo_decision_evidence.channel_id` â†’ `lupo_channels.channel_id`
- **Project**: `lupo_decision_evidence.project_id` â†’ `lupo_projects.project_id`
