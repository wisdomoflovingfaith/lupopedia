...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/active/lupo_llm_performance.md"
...
flip.footer: {
  outbound_edges: [
    { to: "database/lupopedia/toon/lupo_llm_performance.toon.json", type: "schema_reference", weight: 1.0 },
...
- **Agent Identity:** `actor_id` â†’ `lupo_agents.agent_id`
