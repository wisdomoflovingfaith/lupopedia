...
- { to: "docs/database/lupopedia/tables/actor_departments.md", type: "references", weight: 0.9 }
    ...
    - { to: "database/lupopedia/toon/lupo_departments.toon.json", type: "schema_reference", weight: 1.0 }
...
**Schema:** See `database/lupopedia/toon/lupo_departments.toon.json`. Primary key: `department_id`. No AUTO_INCREMENT for reserved IDs (0, 1); installer/seed set them explicitly.
