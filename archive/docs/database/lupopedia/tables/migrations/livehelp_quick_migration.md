...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_quick_migration.md"
...
lupopedia.headers:
  ...
  lupopedia.schema: "documentation"
  lupopedia.edges: []
  file_path_from_root: "docs\database\lupopedia\tables\livehelp_quick_migration.md"
...
---
lupopedia.headers: {
  file_path_from_root: "docs/database/lupopedia/tables/livehelp_quick_migration.md",
  file_hash: "62cd1ca2e49855d343169dcfbc15c0014538105d9de9aa46059028a58276aa62"
  system_version: "4.0.50"
  channel_id: 42,
  mood_vector: "8B4513",
  purpose: "Migration doctrine for livehelp_quick â†’ lupo_actor_reply_templates",
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/database/lupopedia/tables/active/lupo_actor_reply_templates.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
