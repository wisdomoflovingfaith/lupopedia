...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_visit_track.md"
  file_hash: "437a15f26c57830516a60ae0f917819b1a4a782d1982c62288119fc2c7704434"
...
lupopedia.headers:
  ...
  purpose: "Complete documentation for livehelp_visit_track table"
  ...
  tags: ["database", "table", "livehelp_visit_track"]
  lupo_agent: "codex-ide"
  livehelp_visit_track.recno: "int NOT NULL auto_increment"
  livehelp_visit_track.livehelp_id: "bigint unsigned NOT NULL DEFAULT 1"
  livehelp_visit_track.sessionid: "varchar(40) NOT NULL DEFAULT '0'"
  livehelp_visit_track.location: "varchar(255) NOT NULL DEFAULT ''"
  livehelp_visit_track.page: "bigint NOT NULL DEFAULT 0"
  livehelp_visit_track.title: "varchar(100) NOT NULL DEFAULT ''"
  livehelp_visit_track.whendone: "bigint NOT NULL DEFAULT 0"
  livehelp_visit_track.referrer: "varchar(255) NOT NULL DEFAULT ''"
  table_primary_key: "recno"
  table_engine: "unknown"
  table_charset: "unknown"
  table_collation: "unknown"
  table_indexes: ["livehelp_id","location","page","sessionid","whendone"]
  table_foreign_keys: []
...
lupopedia.footer:`n  approved_for_release: "4.1.0"`n  approval_status: "approved"`n  approved_by_actor_id: 1`n  approved_utc: 20260326192115`n  outbound_edges:
    - { to: "database/lupopedia/toon/livehelp_visit_track.toon.json", type: "schema_reference", weight: 1.0, reason: "TOON schema definition", db_source: "livehelp_visit_track" }
...
Purpose: Auto-generated documentation for livehelp_visit_track from TOON schema.
Type: database_table
...
| sessionid | varchar(40) NOT NULL DEFAULT '0' | from TOON |
| location | varchar(255) NOT NULL DEFAULT '' | from TOON |
| page | bigint NOT NULL DEFAULT 0 | from TOON |
| title | varchar(100) NOT NULL DEFAULT '' | from TOON |
| whendone | bigint NOT NULL DEFAULT 0 | from TOON |
| referrer | varchar(255) NOT NULL DEFAULT '' | from TOON |
...
Common Queries:
```sql
SELECT * FROM livehelp_visit_track WHERE recno = :id;
SELECT COUNT(*) AS total FROM livehelp_visit_track WHERE is_deleted = 0;
SELECT * FROM livehelp_visit_track ORDER BY recno DESC LIMIT 25;
UPDATE livehelp_visit_track SET updated_ymdhis = :ts WHERE recno = :id;
```
