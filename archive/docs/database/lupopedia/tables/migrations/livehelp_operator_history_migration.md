...
lupopedia.headers:
  ...
  file_path_from_root: "docs/database/lupopedia/tables/migrations/livehelp_operator_history_migration.md"
...
flip.footer: {
  ...
  outbound_edges: [
    { to: "docs/database/lupopedia/tables/active/lupo_audit_log.md", type: "documents", weight: 1.0, hashtag: "#target_table" },
