...
lupopedia.footer:
  outbound_edges:
    - { to: "includes/modules/module-loader.php", type: "references", weight: 0.8, reason: "API routing" }
...
**Status:** Implemented in `includes/modules/api/channels-admin-api.php` and routed via `includes/modules/module-loader.php`.
