...
lupopedia.headers:
  ...
  file_path_from_root: "docs/doctrine/SEMANTIC_MONITORING_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/doctrine/SEMANTIC_MONITORING_DOCTRINE.md"
  status: "active"
