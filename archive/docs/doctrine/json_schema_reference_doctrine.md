...
lupopedia.headers:
  ...
  file_path_from_root: "docs/doctrine/JSON_SCHEMA_REFERENCE_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/doctrine/JSON_SCHEMA_REFERENCE_DOCTRINE.md"
  status: "active"
