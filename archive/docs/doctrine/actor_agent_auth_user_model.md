...
lupopedia.headers:
  ...
  file_path_from_root: "docs/doctrine/ACTOR_AGENT_AUTH_USER_MODEL.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/doctrine/ACTOR_AGENT_AUTH_USER_MODEL.md"
  status: "active"
