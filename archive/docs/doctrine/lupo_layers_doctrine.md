...
lupopedia.headers:
  ...
  file_path_from_root: "docs/doctrine/LUPO_LAYERS_DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/doctrine/LUPO_LAYERS_DOCTRINE.md"
  status: "active"
