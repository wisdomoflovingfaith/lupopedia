...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/24_A_ACTOR_ONBOARDING_FLOW.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/24_A_ACTOR_ONBOARDING_FLOW.md"
  status: active
