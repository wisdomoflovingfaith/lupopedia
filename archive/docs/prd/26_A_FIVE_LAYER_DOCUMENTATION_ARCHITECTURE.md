...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/26_A_FIVE_LAYER_DOCUMENTATION_ARCHITECTURE.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/26_A_FIVE_LAYER_DOCUMENTATION_ARCHITECTURE.md"
  status: active
