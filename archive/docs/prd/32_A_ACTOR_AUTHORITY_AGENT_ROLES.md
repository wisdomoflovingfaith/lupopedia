...
lupopedia.headers:
  ...
  file_path_from_root: "docs/prd/32_A_ACTOR_AUTHORITY_AGENT_ROLES.md"
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/32_A_ACTOR_AUTHORITY_AGENT_ROLES.md"
  status: "active"
