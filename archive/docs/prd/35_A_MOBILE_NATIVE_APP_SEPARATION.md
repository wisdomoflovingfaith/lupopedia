...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/35_A_MOBILE_NATIVE_APP_SEPARATION.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/35_A_MOBILE_NATIVE_APP_SEPARATION.md"
  status: active
