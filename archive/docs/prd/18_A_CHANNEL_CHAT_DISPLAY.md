...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/18_A_CHANNEL_CHAT_DISPLAY.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/18_A_CHANNEL_CHAT_DISPLAY.md"
  status: active
