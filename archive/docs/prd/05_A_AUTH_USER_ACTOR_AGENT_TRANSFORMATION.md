...
lupopedia.headers:
  ...
  file_path_from_root: "docs/prd/05_A_AUTH_USER_ACTOR_AGENT_TRANSFORMATION.md"
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/05_A_AUTH_USER_ACTOR_AGENT_TRANSFORMATION.md"
  status: "active"
