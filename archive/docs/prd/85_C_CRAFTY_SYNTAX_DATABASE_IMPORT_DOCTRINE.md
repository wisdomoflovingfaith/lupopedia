...
lupopedia.headers:
  ...
  file_path_from_root: "docs/prd/85_C_CRAFTY_SYNTAX_DATABASE_IMPORT_DOCTRINE.md"
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/85_C_CRAFTY_SYNTAX_DATABASE_IMPORT_DOCTRINE.md"
  status: "active"
