...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/52_A_MEMORY_GRAPH_FOCUS_MANIFEST.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/52_A_MEMORY_GRAPH_FOCUS_MANIFEST.md"
  status: draft
