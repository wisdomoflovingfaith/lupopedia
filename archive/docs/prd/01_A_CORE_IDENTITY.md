...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/01_core_identity.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/01_core_identity.md"
  status: active
  ...
  prd_cluster: 00_A_FORBIDDEN_AND_WHY_01_A_CORE_IDENTITY
