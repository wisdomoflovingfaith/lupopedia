...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/45_A_TEMPLATE_FIRST_STAGED_UI_WORKFLOW.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/45_A_TEMPLATE_FIRST_STAGED_UI_WORKFLOW.md"
  status: active
