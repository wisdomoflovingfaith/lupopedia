...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/22_A_WEB_NAVIGATION_ARCHITECTURE.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/22_A_WEB_NAVIGATION_ARCHITECTURE.md"
  status: active
