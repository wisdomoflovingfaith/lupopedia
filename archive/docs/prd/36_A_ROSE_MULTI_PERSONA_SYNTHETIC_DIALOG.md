...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/36_A_ROSE_MULTI_PERSONA_SYNTHETIC_DIALOG.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/36_A_ROSE_MULTI_PERSONA_SYNTHETIC_DIALOG.md"
  status: active
