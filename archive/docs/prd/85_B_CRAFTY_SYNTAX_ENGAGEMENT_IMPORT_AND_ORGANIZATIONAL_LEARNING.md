...
lupopedia.headers:
  ...
  file_path_from_root: "docs/prd/85_B_CRAFTY_SYNTAX_ENGAGEMENT_IMPORT_AND_ORGANIZATIONAL_LEARNING.md"
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/85_B_CRAFTY_SYNTAX_ENGAGEMENT_IMPORT_AND_ORGANIZATIONAL_LEARNING.md"
  status: "active"
