...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/19_A_GARBAGE_COLLECTION_SYSTEM.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/19_A_GARBAGE_COLLECTION_SYSTEM.md"
  status: active
