...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/98_B_THE_CAPTAINS_LOG_HUMAN_ONLY_ENTERTAINMENT_LAYER.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/98_B_THE_CAPTAINS_LOG_HUMAN_ONLY_ENTERTAINMENT_LAYER.md"
  status: active
...
PRD 98 defines the Captain's Log as a human-only entertainment layer. It is completely isolated from doctrine, schema, rules, and agent/actor reasoning. Agents and actors must never read it, reference it, or use it for any purpose.
