...
lupopedia.headers:
  ...
  file_path_from_root: "docs/prd/decisions/pseudocode/23_health_check_asclepius_prd_constitution.pseudo.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/prd/decisions/pseudocode/23_health_check_asclepius_prd_constitution.pseudo.md"
  questions_toon: null
