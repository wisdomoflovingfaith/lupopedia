...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/34_A_FEDERATION_NODE_SEMANTIC_NETWORK.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/34_A_FEDERATION_NODE_SEMANTIC_NETWORK.md"
  status: active
