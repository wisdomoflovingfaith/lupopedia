...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/78_A_CLI_INTERFACE_PRD.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/78_A_CLI_INTERFACE_PRD.md"
  status: active
