...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/61_A_DOCTRINE_CONSOLIDATION_SHORTHAND_COMPILER.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/61_A_DOCTRINE_CONSOLIDATION_SHORTHAND_COMPILER.md"
  status: draft
