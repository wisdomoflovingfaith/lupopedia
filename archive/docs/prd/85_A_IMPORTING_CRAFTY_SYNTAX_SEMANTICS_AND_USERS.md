...
lupopedia.headers:
  ...
  file_path_from_root: "docs/prd/85_A_IMPORTING_CRAFTY_SYNTAX_SEMANTICS_AND_USERS.md"
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/85_A_IMPORTING_CRAFTY_SYNTAX_SEMANTICS_AND_USERS.md"
  status: "active"
