...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/42_A_CONTENT_SEEDING_AND_TRUTH_TABLES.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/42_A_CONTENT_SEEDING_AND_TRUTH_TABLES.md"
  status: active
