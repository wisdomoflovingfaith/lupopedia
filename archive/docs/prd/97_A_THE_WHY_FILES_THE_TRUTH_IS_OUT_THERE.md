...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/97_A_THE_WHY_FILES_THE_TRUTH_IS_OUT_THERE.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/97_A_THE_WHY_FILES_THE_TRUTH_IS_OUT_THERE.md"
  status: active
