...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/00_C_ROOT_CONSTITUTIONAL_SYSTEM_REQUIREMENTS.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/00_C_ROOT_CONSTITUTIONAL_SYSTEM_REQUIREMENTS.md"
  status: active
...
This section **binds** IDE agents and human contributors when writing or reviewing code. It **extends** **section 3.6** (database-neutral SQL + application-layer discipline), **section 15** (extension and permission probing, no auto-**chmod**), and **section 14.6** (**Survivability Doctrine** - graceful failure). Operational checklist: **`docs/implementations/security_audit_cursor_ide/README.md`**.
