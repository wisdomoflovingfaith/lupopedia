...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/00_B_SYSTEM_CANONICAL_EXPLANATION.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/00_B_SYSTEM_CANONICAL_EXPLANATION.md"
  status: active
