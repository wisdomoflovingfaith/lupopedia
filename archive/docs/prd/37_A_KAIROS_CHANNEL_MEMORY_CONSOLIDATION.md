...
lupopedia.headers:
  ...
  file_path_from_root: docs/prd/37_A_KAIROS_CHANNEL_MEMORY_CONSOLIDATION.md
  web_path: "https://www.lupopedia.com/lupopedia/docs/prd/37_A_KAIROS_CHANNEL_MEMORY_CONSOLIDATION.md"
  status: active
  ...
  prd_cluster: 00_A_FORBIDDEN_AND_WHY_37_A_KAIROS_CHANNEL_MEMORY_CONSOLIDATION
