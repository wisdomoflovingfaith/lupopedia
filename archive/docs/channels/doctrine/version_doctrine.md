...
lupopedia.headers:
  ...
  file_hash: "cff712a34c1320ee65b47ce112e9bb4093614f146a2ea27392e41ae25d10ea69"
...
lupopedia.headers:
  ...
  tags: ["docs", "channels", "doctrine", "version_doctrinemd"]
  lupo_agent: "windsurf"
...
- [ ] Verify `config/global_atoms.yaml` version matches `includes/version.php` constants
...
- `includes/functions/load_atoms.php` - Atom loader function (Phase 2)
