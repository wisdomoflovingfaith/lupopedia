...
lupopedia.headers:
  ...
  file_hash: "6ea6ce5d213a8884161631fd67f3800cadee30c8742b965a9cc37bf0d24668b2"
...
- **verify all column names exist in the toon file** (`database/lupopedia/toon/{new_table_name}.toon` - TOON format)
...
**All 145 tables have toon files in `database/lupopedia/toon/`.**
...
- **All column names must be verified against toon files in `database/lupopedia/toon/` (TOON format)**
...
3. **Follow refactor TOON files and toon data files** â€” Never guess table/column mappings; all 149 tables have toon files in `database/lupopedia/toon/` (TOON format) for exact column names; never convert TOON to JSON (see [TOON_DOCTRINE.md](TOON_DOCTRINE.md))
