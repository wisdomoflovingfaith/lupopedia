...
lupopedia.headers:
  ...
  file_hash: "bdaa0bbf716b33b8c5f1b9abd1832884f72a731a4d31eca6724f14180778516f"
...
lupopedia.headers:
  ...
  artifact_type: "guide"
  artifact_kind: "documentation"
  purpose: "Documentation for CONFIGURATION_DOCTRINE.md"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["docs", "channels", "doctrine", "configuration_doctrinemd"]
  lupo_agent: "windsurf"
...
- Module classes (inside `/includes/modules/`)
- Agent classes (e.g., `classes/thoth.php`, `classes/hermes.php`)
- UI controller classes (inside `/includes/ui/`)
...
lupopedia-loader.php          â† Procedural (must stay procedural)
  +-- functions-core.php      â† Procedural (may contain functions)
  +-- modules/module-loader.php â† Procedural (loads OOP modules)
  +-- agents/agent-loader.php â† Procedural (loads OOP agent classes)
  +-- ui/ui-loader.php        â† Procedural (loads OOP UI controllers)

includes/
  +-- classes/pdo_db.php        â† OOP class (allowed and encouraged)
  +-- classes/thoth.php         â† OOP class (allowed and encouraged)
  +-- modules/
      +-- crafty_syntax/
          +-- classes/crafty.php â† OOP class (allowed and encouraged)
```
