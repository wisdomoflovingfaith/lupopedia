...
### Schema File
- **File**: `database/migrations/cip_analytics_schema_3_0_75.sql`
...
SOURCE database/migrations/cip_analytics_schema_3_0_75.sql;
```

### 2. PHP Class Integration
- Deploy new CIP classes to `includes/classes/`
