...
```
legacy/craftysyntax/
+-- admin_*.php          (Admin interface files)
+-- user_*.php           (User-facing files)
+-- data_*.php           (Data management files)
+-- class/               (Class files)
...
lupopedia/
+-- modules/
|   +-- craftysyntax/    (Crafty Syntax module files)
|       +-- admin/       (Admin interface)
|       +-- user/        (User-facing)
|       +-- api/         (API endpoints)
|       +-- includes/    (Shared includes)
+-- includes/       (Shared classes and functions)
+-- content/        (Content and assets)
+-- ...                  (Other Lupopedia files)
```
...
**Destination:** `lupopedia/includes/classes/*.php`

**Examples:**
- `class/operator.php` â†’ `includes/classes/operator.php`
- `class/sessionmanager.php` â†’ `includes/classes/session-manager.php`

### **4.5 Function Libraries**

**Source:** `legacy/craftysyntax/functions.php` or `data_*.php`  
**Destination:** `lupopedia/includes/` or `modules/craftysyntax/includes/`

**Examples:**
- `functions.php` â†’ `includes/crafty-functions.php`
...
**Refactored:**
```php
require_once __DIR__ . '/../../includes/classes/pdo_db.php';
...
require_once __DIR__ . '/../../includes/crafty-functions.php';
```
...
2. Convert to `includes/classes/*.php` format
