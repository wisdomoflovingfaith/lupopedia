...
lupopedia.headers:
  ...
  file_hash: "abb0c6cf0a209d02e295db34db3d34c7c19fdd4186162a8eddd2ca87c1b2c439"
...
**File:** `includes/security/password-hash.php`
...
**File:** `includes/functions/session-helpers.php`
...
**File:** `includes/modules/module-loader.php`
...
**File:** `includes/modules/auth/auth-renderer.php`
...
**File:** `includes/lupopedia-loader.php`
...
- Log to file: `includes/logs/auth-errors.log` (create if needed)
...
- `includes/security/password-hash.php`
- `includes/functions/session-helpers.php`
- `includes/functions/auth-helpers.php`
- `includes/modules/auth/auth-controller.php`
- `includes/modules/auth/auth-renderer.php`
