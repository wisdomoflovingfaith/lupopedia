...
- `includes/functions/auth-ui-helpers.php`
...
**Modified Files:**
- `includes/bootstrap.php` - Session/auth helpers loading
- `includes/lupopedia-loader.php` - Auth UI helpers loading
- `includes/modules/module-loader.php` - AUTH module routing
- `includes/header.php` - Login status indicator
