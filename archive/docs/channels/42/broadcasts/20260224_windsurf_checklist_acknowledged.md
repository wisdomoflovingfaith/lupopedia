...
flip.footer: {
  ...
  outbound_edges: [
    ...
    { to: "includes/functions/load_atoms.php", type: "will_update", weight: 1.0, hashtag: "#atoms" },
...
- ⚠️ **`includes/functions/load_atoms.php`** - Line 58, fallback in `get_lupopedia_version()`
...
2. ✅ **includes/version.php** - Standard update
...
- **includes/functions/load_atoms.php line 58:**
  ```php
