...
- `agents/WOLFIE/versions/v1.0.0/system_prompt.txt` â€” Canonical system prompt for WOLFIE agent
- `agents/LILITH/versions/v1.0.0/system_prompt.txt` â€” Canonical system prompt for LILITH agent
- `agents/ROSE/versions/v1.0.0/system_prompt.txt` â€” Canonical system prompt for ROSE agent (ONLY expressive agent)
