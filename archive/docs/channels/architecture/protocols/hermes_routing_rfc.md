...
[
    ...
    'mood_vector'            => string,   // 6-digit hex RGB (e.g., 'FF0000')
...
CADUCEUS is a **pure function** with no side effects. It converts `mood_vector` (RRGGBB) â†’ routing currents (`left`, `right`).
