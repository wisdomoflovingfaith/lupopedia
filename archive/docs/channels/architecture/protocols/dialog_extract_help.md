...
lupopedia.headers:
  ...
  file_hash: "f0817f15d94bc8a18b18b3488b81cea0d5dc61169f08e9273291f5887dfef444"
...
- `mood_vector` - From dialog block (6 hex digits, no #) or default '666666'
- `created_ymdhis` - From `date_ymdhis` in dialog block or current UTC timestamp
- `artifacts` - NULL

### Validation
- Messages must be â‰¤ 272 characters
- `mood_vector` must be exactly 6 hex digits (no leading #)
