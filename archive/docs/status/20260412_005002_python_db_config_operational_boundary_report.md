...
lupopedia.headers:
  ...
  file_path_from_root: "docs/status/20260412_005002_python_db_config_operational_boundary_report.md"
  ...
  memory_key: "memory/development/canonical/1026/04/python-db-config-operational-boundary-report.toon"
