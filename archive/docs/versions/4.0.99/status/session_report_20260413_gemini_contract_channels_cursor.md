...
*   **Architectural Ancestry:** The connection to DynAPI/DHTML "Dynamic Layers" in `layers.js` is a critical "missing link" in understanding how Lupopedia handles UI. It explains the preference for absolute positioning and manual DOM manipulation over modern layout engines.
