...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.99/analysis/wolfie/crafty_data_analysis.md"
  web_path: "https://www.lupopedia.com/lupopedia/docs/versions/4.0.99/analysis/wolfie/crafty_data_analysis.md"
  questions_toon: null
  federation_node_id: 0
  channel_key: "development"
  trust_tier: "canonical"
  memory_key: "memory/development/canonical/1026/04/analysis-wolfie-crafty-data.toon"
...
- **Legacy dump (schema + data):** [`database/lupopedia/mysql/import/old_crafty_syntax_3_7_5_start.sql`](../../../../../database/lupopedia/mysql/import/old_crafty_syntax_3_7_5_start.sql) (~279 KiB, ~4.9k lines).
- **Import transform:** [`database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql`](../../../../../database/lupopedia/mysql/import/import_from_old_crafty_syntax.sql) (~72 KiB, ~1.8k lines). Uses template `{{prefix}}` (installed as `lupo_`).
