...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.99/PLAN.md"
  web_path: "https://www.lupopedia.com/lupopedia/docs/versions/4.0.99/PLAN.md"
  questions_toon: null
  federation_node_id: 0
  channel_key: "development"
  trust_tier: "canonical"
  memory_key: "memory/development/canonical/1026/04/version-4-0-99-plan.toon"
...
- Comprehensive cross-file audit (CLAUDE.md, README_WTF.md, all PRDs in docs/prd/) with actionable recommendations
...
**Still queued (unchanged):** Optional **historical path** audit under **`docs/versions/4.0.93`** / **`4.0.96–98/status`** — **documentation-only**, WOLFIE-scoped.
...
- **`docs/prd/50_agent_coordination_protocol.md`** repaired to dense **v4.0.99** envelope (closing `---`, missing keys, **`dialog_transcript`**, ASCII example UI).
...
- **Completion criteria:** single script outputs JSON/TOON/validation status and missing-edge diagnostics. *(Note: `scripts/audit_prd_memory_pairs.py` and related status artifacts landed in 4.0.98 — close Phase P when criteria are verified signed-off.)*
