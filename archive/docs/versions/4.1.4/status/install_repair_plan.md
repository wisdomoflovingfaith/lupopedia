...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.1.4/status/install_repair_plan.md"
  web_path: "https://www.lupopedia.com/lupopedia/docs/versions/4.1.4/status/install_repair_plan.md"
  status: "active"
