...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.1.4/status/overview_md_header_patch.md"
  web_path: "https://www.lupopedia.com/lupopedia/docs/versions/4.1.4/status/overview_md_header_patch.md"
  status: "active"
