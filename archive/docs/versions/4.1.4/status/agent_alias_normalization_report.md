...
lupopedia.headers:
  ...
  file_path_from_root: docs/versions/4.1.4/status/agent_alias_normalization_report.md
...
- **NEW:** `docs/versions/4.1.4/status/agent_alias_normalization_report.md` - This report
