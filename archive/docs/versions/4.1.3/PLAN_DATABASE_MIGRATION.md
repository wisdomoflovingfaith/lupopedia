...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.1.3/PLAN_DATABASE_MIGRATION.md"
  web_path: "https://www.lupopedia.com/lupopedia/docs/versions/4.1.3/PLAN_DATABASE_MIGRATION.md"
  status: "active"
...
**Sync rule:** Keep this file substantively aligned with **`docs/versions/4.1.3/TODO_DATABASE_MIGRATION.md`** except for this header block and the **PLAN** title line. Note: PLAN uses "MIGRATED (DEV IMPORT -- NOT PRODUCTION SAFE)" where TODO uses "MAPPED (DEV IMPORT)"; the intent is identical.
