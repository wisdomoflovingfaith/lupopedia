...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.1.3/TODO.md"
  ...
  summary: "PRD-first dependency graph A to E for 4.1.3 Crafty 3.7.5 live-help parity; F reserved for 4.1.4+ orchestration. Layer A ASCII audit via scripts/sanitize_ascii.py --fix."
---
lupopedia.edges:
  outbound_edges: []
