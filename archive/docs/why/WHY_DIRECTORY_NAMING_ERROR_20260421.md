...
- **`docs/versions/4.1.4/status/agent_alias_normalization_report.md`** - Update all references from `registry/agent_aliases.json` to `config/naming_aliases.json` (COMPLETED)

## PRD FILES TO UPDATE
- `scripts/agent_alias_resolver.py` - Path reference updated (DONE)
- `docs/versions/4.1.4/status/agent_alias_normalization_report.md` - Documentation updated (DONE)
