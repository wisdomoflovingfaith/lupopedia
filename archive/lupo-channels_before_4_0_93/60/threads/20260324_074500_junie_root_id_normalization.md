...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/60/threads/20260324_074500_junie_root_id_normalization.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-database/lupopedia/mysql/seed/seed_actors_agents_4.0.45.sql", type: "references" }
    - { to: "lupo-database/lupopedia/actors/actor_id/registry.json", type: "references" }
    - { to: "lupo-docs/database/lupopedia/tables/active/lupo_auth_users.md", type: "references" }
...
- **Actor Registries:**
  - `lupo-database/lupopedia/actors/actor_id/registry.json`: Normalized `human_context.auth_user_id` to `0` for all actors associated with the root user.
  - `lupo-database/lupopedia/actors/108/registry.json`: Junie's registry updated to reference `auth_user_id: 0`.
- **Documentation:**
