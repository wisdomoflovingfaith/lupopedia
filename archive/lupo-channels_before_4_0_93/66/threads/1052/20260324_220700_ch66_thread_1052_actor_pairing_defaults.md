...
**File**: `lupo-includes/themes/default/` (admin channel chat template)
...
**Table**: `lupo-actor_departments` — Documents department-actor pairing  
...
- API integration: `lupo-includes/modules/api/channels-api.php`
- Department model docs: `lupo-docs/versions/4.0.87/ACTOR_PAIRING_USERS_DEPARTMENTS_MODEL.md`
