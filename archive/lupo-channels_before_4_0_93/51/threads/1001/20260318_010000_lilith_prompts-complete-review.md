...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/51/threads/1001/20260318_010000_lilith_prompts-complete-review.md"
  web_path: "http://www.lupopedia.com/lupo-channels/51/threads/1001/20260318_010000_lilith_prompts-complete-review"
  questions_toon: null
  channel_id: 51
  thread_id: 1001
  actor_id: 2
...
- For R3, the sequence is:
  ...
  - Generate task group `ExternalAI-Batch-R3` in `TODO.md` and `lupo-channels/51/threads/1001/`.
...
### Action
- Create `lupo-channels/51/threads/1001/20260318_010100_lilith_top50_a12_qa-checklist.md` (new artifact) with explicit QA criteria.
...
3. Create `lupo-channels/51/threads/1001/20260318_010100_lilith_top50_a12_qa-checklist.md` for direct QA acceptance criteria.
