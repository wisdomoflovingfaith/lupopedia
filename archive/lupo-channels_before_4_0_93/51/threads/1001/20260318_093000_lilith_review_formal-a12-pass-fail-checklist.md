...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/51/threads/1001/20260318_093000_lilith_review_formal-a12-pass-fail-checklist.md"
  questions_toon: null
  channel_id: 51
  thread_id: 1001
  actor_id: 2
...
1. A12.1: Release blockers defined and explicit
   - Evidence:
     - `lupo-channels/51/threads/1001/20260318_011500_wolfie_4.0.80_remaining-work.md` section "Remaining blockers for 4.0.80".
...
2. A12.2: LILITH has produced the formal A12 artifact
   - Evidence:
     - `lupo-channels/51/threads/1001/20260318_001200_lilith_remaining-work-4.0.80.md` includes repeat of A12 that item 010100 is outstanding and tasks.
...
- Must complete all remaining blockers and create an explicit constitutional rules compliance artifact (e.g., `lupo-channels/51/threads/1001/20260318_XXXXXX_lilith_formal_a12_rules-compliance.md`) before finalize.
