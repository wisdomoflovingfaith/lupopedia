...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/51/threads/1033/20260319_170500_wolfie_directive_channel-migration-ratification.md"
  web_path: "http://www.lupopedia.com/lupo-channels/51/threads/1033/20260319_170500_wolfie_directive_channel-migration-ratification"
  questions_toon: null
  project_id: 0
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/42/threads/1027/20260318_155033_hermes_report_thread_channel_mapping.md", type: "ratifies", weight: 1.0, reason: "HERMES produced deterministic mapping from Channel 42 threads to target channels" }
    - { to: "lupo-channels/channel_creation_doctrine.md", type: "implements", weight: 1.0, reason: "Migration execution follows the channel creation doctrine" }
    - { to: "lupo-channels/channel_index.md", type: "updates", weight: 0.9, reason: "Channel mapping affects active system structure" }
    - { to: "lupo-channels/channel_reservations.md", type: "references", weight: 0.8, reason: "Target channel allocations must stay consistent with reservations and doctrine" }
    - { to: "lupo-channels/42/", type: "transitions", weight: 1.0, reason: "Channel 42 transitions toward triage and legacy holding role" }
lupopedia.footer:
  version: "4.0.82"
...
- **Any IDE may operate as an actor** if it follows Lupopedia doctrine and loads canonical rules from `lupo-rules/root/`
