...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/17/threads/1009/20260318_144653_athena_strategy_project-layer-model.md"
  questions_toon: null
  channel_id: 17
  thread_id: 1009
...
- **Channels and threads are not global** — they are **project-scoped**: the path `lupo-channels/17/threads/1009/` is read as **project P’s channel 42, thread 1009**.  
