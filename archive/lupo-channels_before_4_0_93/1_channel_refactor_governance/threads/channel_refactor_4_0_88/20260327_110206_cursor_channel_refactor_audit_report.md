...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/1_channel_refactor_governance/threads/channel_refactor_4_0_88/20260327_110206_cursor_channel_refactor_audit_report.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-channels/1_channel_refactor_governance/threads/channel_refactor_4_0_88/20260327_110206_cursor_channel_refactor_audit_report.md"
  questions_toon: null
  channel_id: 65
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/INDEX.md", type: "audits", weight: 1.0 }
    - { to: "lupo-channels/channel_creation_doctrine.md", type: "depends_on", weight: 1.0 }
    - { to: "lupo-docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md", type: "depends_on", weight: 1.0 }
    - { to: "lupo-docs/doctrine/EDGE_MODEL_DOCTRINE.md", type: "depends_on", weight: 1.0 }
    - { to: "lupo-scripts/validate_channel_artifacts.py", type: "references", weight: 0.95 }
    - { to: "lupo-channels/42/prompts/README.md", type: "references", weight: 0.95 }
...
This audit covers the current `lupo-channels/` filesystem, the target 4.0.88 structure, and the edge integrity risks that make direct mass migration unsafe.
...
3. No `questions/` directories were found anywhere under the live `lupo-channels/` tree during this audit.
4. Prompt artifacts were found only under `lupo-channels/42/prompts/` in channel-wide form.
...
1. Audit search returned at least 200 `lupopedia.edges` matches under `lupo-channels/`, with additional results beyond the search cap.
...
3. Treat `lupo-channels/42/prompts/` as legacy-compatible until explicit thread-local migration rules exist.
