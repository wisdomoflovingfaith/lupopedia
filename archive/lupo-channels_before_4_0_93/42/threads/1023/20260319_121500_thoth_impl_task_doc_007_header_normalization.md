...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1023/20260319_121500_thoth_impl_task_doc_007_header_normalization.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1023/20260319_121500_thoth_impl_task_doc_007_header_normalization.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1023
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/42/threads/1022/20260319_130000_wolfie_review_task_wolfie_ai_artifacts_001.md", type: "addresses", weight: 1.0, reason: "Applies WOLFIE review required actions for Artifacts 1-3" }
    - { to: "lupo-docs/origin/WOLFIE_ORIGIN.md", type: "updates", weight: 1.0 }
    - { to: "lupo-docs/doctrine/TIMESTAMP_DOCTRINE.md", type: "updates", weight: 1.0 }
    - { to: "lupo-docs/doctrine/FALLBACK_ENGINEERING.md", type: "updates", weight: 1.0 }
    - { to: "lupo-docs/doctrine/HEADER_STRUCTURE_DOCTRINE.md", type: "enforces", weight: 0.95 }
    - { to: "lupo-docs/doctrine/LUPOPEDIA_HEADERS/VALIDATORS_AND_TOOLING.md", type: "updates", weight: 0.95 }
...
1. Removed `lupopedia.init` and `lupopedia.metadata` from:
   - `lupo-docs/origin/WOLFIE_ORIGIN.md`
   - `lupo-docs/doctrine/TIMESTAMP_DOCTRINE.md`
   - `lupo-docs/doctrine/FALLBACK_ENGINEERING.md`
