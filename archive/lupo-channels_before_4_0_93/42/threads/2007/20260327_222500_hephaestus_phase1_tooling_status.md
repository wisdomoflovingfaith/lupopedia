...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/2007/20260327_222500_hephaestus_phase1_tooling_status.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-channels/42/threads/2007/Phase1_Tooling_Status_20260327.md"
  questions_toon: null
  channel_id: 42
  actor_id: 23
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-scripts/generate_table_docs_from_toons.py", type: "references", weight: 1.0 }
...
**File Location**: `lupo-scripts/generate_table_docs_from_toons.py`  
...
lupopedia.headers:
  lupopedia.schema: "documentation"
  file_path_from_root: "lupo-docs/database/lupopedia/tables/active/{table_name}.md"
...
**Issue Fixed**: Output directory path corrected from `docs/specs/` to `lupo-docs/reports/`  
**Status**: ✅ FUNCTIONAL  
...
**Command**: `python lupo-scripts/generate_table_docs_from_toons.py --help`  
