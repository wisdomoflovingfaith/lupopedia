...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1038/20260321_210000_thoth_corrected_human_verification_architecture.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1038/corrected_architecture"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/42/threads/1038/20260321_170000_athena_human_verification_workflow_and_supporting_actor_model.md", type: "corrects", weight: 1.0, reason: "Addresses LILITH audit findings on doctrine violations" }
    - { to: "lupo-channels/42/threads/1035/20260321_140000_wolfie_governance_directive_doctrine_authority_validation_and_refactor_safety.md", type: "aligns_with", weight: 0.95, reason: "Ensures full governance doctrine compliance" }
    - { to: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "defines", weight: 0.9, reason: "Schema definition (explicit columns, normalized tables)" }
    - { to: "lupo-docs/doctrine/LUPOPEDIA_HEADERS/README.md", type: "complies_with", weight: 0.9, reason: "No ad-hoc header extensions - formal governance only" }
...
$request_data = [
  ...
  'context' => [
    [
      'type' => 'thread_excerpt',
      'content' => '...',
      'source_artifact' => 'lupo-channels/42/threads/1038/...',
    ]
  ]
];
...
1. **Create doctrine:**
   - `lupo-docs/doctrine/HUMAN_VERIFICATION_WORKFLOW_DOCTRINE.md`
...
2. **Create guides:**
   - `lupo-docs/guides/WEB_VERIFICATION_INBOX_GUIDE.md`
   - `lupo-docs/guides/VERIFICATION_API.md` (for agents creating requests)
   - `lupo-docs/guides/ACTOR_ADMINISTRATION.md`
