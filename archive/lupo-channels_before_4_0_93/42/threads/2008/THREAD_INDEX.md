...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/2008/THREAD_INDEX.md"
  questions_toon: null
  channel_id: 42
  thread_id: 2008
  actor_id: 1
...
- lupo-channels/{id}/threads/{thread_id}/ artifact storage
- THREAD_INDEX.md navigation-only convention
- TASK_REGISTRY as single source of truth

## Output Artifact

Canonical docs file to be placed at: `lupo-docs/versions/4.0.85/workflow_model.md` (or equivalent)
