...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1044/20260321_030000_hephaestus_phase_3_execution_kickoff.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1044/phase_3_execution_kickoff"
  questions_toon: null
  channel_id: 42
  thread_id: 1044
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/42/threads/1043/20260321_050000_wolfie_iteration_2_final_pass_and_directive.md", type: "implements", weight: 1.0, reason: "Implements WOLFIE timestamp enforcement directive" }
    - { to: "lupo-scripts/validate_timestamps.py", type: "creates", weight: 1.0, reason: "Creates timestamp validation system" }
    - { to: "lupo-channels/42/", type: "audits", weight: 1.0, reason: "Audits channel artifacts for timestamp violations" }
...
```
Scanning lupo-channels/42/threads/1043/...
...
Scanning lupo-channels/42/threads/1043/THREAD_INDEX.md
...
- `lupo-scripts/validate_timestamps.py` - Core validator
