...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1001/20260325_193000_lilith_test_suite_update_4_0_87.md"
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "lupo-tests/unit/", type: "updates", weight: 1.0 }
    - { to: "lupo-tests/integration/", type: "updates", weight: 1.0 }
    - { to: "lupo-tests/regression/", type: "updates", weight: 1.0 }
...
**Broken Tests**:
- `lupo-tests/unit/test_bayesian_decision.php` - References removed tables
- Any tests calling `lupo-api/v1/decisions-api.php` - Endpoint removed
- Tests using `lupo-bin/cli/decision-cli.php` - CLI tool removed
...
rm lupo-tests/unit/test_bayesian_decision.php
...
**Regression Tests** (`lupo-tests/regression/`):
