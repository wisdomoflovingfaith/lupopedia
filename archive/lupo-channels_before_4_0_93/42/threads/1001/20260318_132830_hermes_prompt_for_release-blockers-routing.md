...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1001/20260318_132830_hermes_prompt_for_release-blockers-routing.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1001/20260318_132830_hermes_prompt_for_release-blockers-routing.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1001
  actor_id: 15
  ...
  source_artifact:
    - "lupo-channels/42/threads/1001/20260318_080000_wolfie_orchestration_state.md"
---
...
- **Artifacts location constraint (this routing run)**: write all outputs to `lupo-channels/42/threads/1001/` only.
...
- `lupo-channels/42/threads/1001/20260318_052500_wolfie_table-doc-ground-truth-status.md`
...
### Files to read (exact)
- `lupo-channels/42/threads/1001/20260318_011500_wolfie_4.0.80_remaining-work.md` (lists A12 requirement)
- `lupo-channels/42/threads/1001/20260318_001200_lilith_remaining-work-4.0.80.md` (P0 criteria framing)
- `lupo-channels/42/threads/1001/20260318_010000_lilith_prompts-complete-review.md` (states intent to create A12 checklist)
...
- `lupo-channels/42/threads/1001/20260318_012000_wolfie_channel-hermes-mvp-stabilization.md` (MVP loop + boundaries)
...
- `lupo-channels/42/threads/1001/` (all `.md`)
...
- `lupo-channels/42/threads/1001/20260318_080000_wolfie_orchestration_state.md` (source)
- `lupo-channels/42/threads/1001/20260318_051500_wolfie_4.0.80_release-readiness.md` (blockers framing)
...
This routing prompt is “satisfied” when each target actor posts the requested artifact(s) back into `lupo-channels/42/threads/1001/` with canonical filenames and explicit evidence pointers.
