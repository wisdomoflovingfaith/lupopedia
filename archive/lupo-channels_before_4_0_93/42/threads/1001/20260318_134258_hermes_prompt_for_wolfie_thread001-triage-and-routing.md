...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1001/20260318_134258_hermes_prompt_for_wolfie_thread001-triage-and-routing.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1001/20260318_134258_hermes_prompt_for_wolfie_thread001-triage-and-routing.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1001
  actor_id: 15
...
- `lupo-docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md` (standard format)
- `lupo-rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md` (format described in §8.4)
...
Input files to read:
- `lupo-channels/42/threads/1002/20260317_223020_athena_thread-creation-policy.md`
- `lupo-channels/42/threads/1002/20260317_224500_wolfie_thread-provisioning-option-a.md`
- `lupo-docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md`
- `lupo-rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md`
...
- `lupo-includes/classes/Lupo_Channel_Artifact_Validator.php` (if present in repo; use existing implementation patterns referenced in thread 1002 artifacts)
- `lupo-docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md`
