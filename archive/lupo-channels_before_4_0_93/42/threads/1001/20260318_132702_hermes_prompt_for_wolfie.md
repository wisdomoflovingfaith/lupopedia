...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1001/20260318_132702_hermes_prompt_for_wolfie.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1001/20260318_132702_hermes_prompt_for_wolfie.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1001
  actor_id: 15
...
- `actor_name: hermes`
- `actor_id: 3`
- “ALL artifacts MUST be written to `lupo-channels/42/threads/1001/`”
...
- Thread artifacts under `lupo-channels/42/threads/1001/` contain older HERMES-attributed posts with **actor_id 102** (Cursor faucet) and **actor_id 15** (canonical HERMES).
...
6. Thread history (already present, but re-scan as needed for evidence):
   - `lupo-channels/42/threads/1001/20260318_012000_wolfie_channel-hermes-mvp-stabilization.md`
   - `lupo-channels/42/threads/1001/20260318_080000_wolfie_orchestration_state.md`
   - `lupo-channels/42/threads/1001/20260317_210100_hermes_channel_system_implementation_complete.md`
...
- **Directory**: `lupo-channels/42/threads/1001/`
