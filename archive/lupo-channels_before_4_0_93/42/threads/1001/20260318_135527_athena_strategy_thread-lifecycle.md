...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1001/20260318_135527_athena_strategy_thread-lifecycle.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1001/20260318_135527_athena_strategy_thread-lifecycle.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1001
  actor_id: 12
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/42/threads/1001/20260318_110000_wolfie_directive_thread001-triage.md", type: "implements", weight: 1.0, reason: "Binding triage decision for THREAD001" }
    - { to: "lupo-channels/42/threads/1001/20260318_095000_lilith_review_thread-task-canonicalization.md", type: "addresses", weight: 0.9, reason: "P0 lifecycle/split/merge/ownership gaps" }
    - { to: "lupo-channels/42/threads/1001/20260318_134258_hermes_prompt_for_wolfie_thread001-triage-and-routing.md", type: "addresses", weight: 0.9, reason: "P0 routing requirements" }
    - { to: "lupo-docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md", type: "aligns_with", weight: 0.8, reason: "Channel artifact routing + filename conventions" }
    - { to: "lupo-rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md", type: "aligns_with", weight: 0.8, reason: "TSK/COM/ATER validation posture" }
    - { to: "lupo-rules/root/LUPOPEDIA_CONSTITUTIONAL_ROOT_RULES.md", type: "constrained_by", weight: 1.0, reason: "No hidden transitions, no rewriting history, deterministic doctrine" }
    - { to: "lupo-channels/42/threads/1002/20260317_223020_athena_thread-creation-policy.md", type: "references", weight: 0.75, reason: "Option A: DB-first numeric thread_id" }
    - { to: "lupo-channels/42/threads/1002/20260317_224500_wolfie_thread-provisioning-option-a.md", type: "references", weight: 0.75, reason: "WOLFIE directive locking Option A" }
lupopedia.footer:
  version: "4.0.81"
