...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-channels/42/threads/1043/20260321_210000_wolfie_canonical_upgrade_validation_loop_crafty_3_7_5_to_lupopedia_4_0_85.md"
  web_path: "http://www.lupopedia.com/lupo-channels/42/threads/1043/canonical_upgrade_validation_loop"
...
lupopedia.edges:
  outbound_edges:
    - { to: "lupo-channels/42/threads/1042/", type: "child_of", weight: 1.0, reason: "Child of Thread 1042 reality reconciliation" }
    - { to: "lupo-channels/42/threads/1032/", type: "routes_to", weight: 0.9, reason: "Schema issues routed to Thread 1032" }
    - { to: "lupo-channels/42/threads/1030/", type: "routes_to", weight: 0.8, reason: "Visibility/UI issues routed to Thread 1030" }
    - { to: "lupo-channels/42/threads/1031/", type: "routes_to", weight: 0.8, reason: "Database visibility issues routed to Thread 1031" }
    - { to: "lupo-channels/42/threads/1036/", type: "routes_to", weight: 0.85, reason: "Actor issues routed to Thread 1036" }
    - { to: "lupo-channels/42/threads/1041/", type: "routes_to", weight: 0.8, reason: "Timestamp issues routed to Thread 1041" }
    - { to: "lupo-database/lupopedia/mysql/import/old_crafty_syntax_3_7_5_start.sql", type: "uses", weight: 0.95, reason: "Crafty 3.7.5 baseline data" }
    - { to: "lupo-database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "uses", weight: 0.95, reason: "Lupopedia 4.0.85 schema" }
...
2. **Install Crafty Syntax 3.7.5 baseline**
   - Load `lupo-database/lupopedia/mysql/import/old_crafty_syntax_3_7_5_start.sql`
