...
Evaluate whether **`channels-controller.php`** / **`channels-api.php`** should list or serve `lupo-channels/{id}/prompts/*.md` similarly to other subtrees. If yes, implement read-only listing + membership gate; if no, document “filesystem-only until 4.0.81” in **README**.
