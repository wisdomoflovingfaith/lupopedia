...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.94/decisions/20260403_222041_DECISION_APPROVED_department_first_actor_model_prd_alignment.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.94/decisions/20260403_222041_DECISION_APPROVED_department_first_actor_model_prd_alignment.md"
  questions_toon: null
...
---
# file: DECISION — APPROVED department-first actor model + PRD alignment — web_path: /docs/versions/4.0.94/decisions/20260403_222041_DECISION_APPROVED_department_first_actor_model_prd_alignment.md
...
| **WHAT** | New **`docs/doctrine/ACTOR_DEPARTMENT_AUTH_USER_DOCTRINE.md`** (join tables, eligibility, visitor chat vs Crafty, illustrative SQL with PHP disclaimer). **`IDENTITY_LAYERS_DOCTRINE.md`** outbound edge to that file. PRD prose/edges updated: **02**, **05**, **07**, **13**, **15**, **18**, **25**, **32** — department intersection, **`from_actor_id`** / **`actor_id`** attribution, governance vs operational scope, Crafty migration narrative; **`docs/implementations/13_crafty_integration/questions/`** Q3 marked answered. |
| **WHERE** | `docs/doctrine/`, `docs/prd/`, `docs/implementations/13_crafty_integration/` |
| **WHEN** | Documentation batch UTC **`20260403222041`** (`python bin/tick.py`) |
