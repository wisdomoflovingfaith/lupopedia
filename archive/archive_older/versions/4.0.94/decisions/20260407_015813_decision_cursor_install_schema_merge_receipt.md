...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.94/decisions/20260407_015813_DECISION_cursor_install_schema_merge_receipt.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.94/decisions/20260407_015813_DECISION_cursor_install_schema_merge_receipt.md"
  questions_toon: null
...
---
# file: docs/versions/4.0.94/decisions/20260407_015813_DECISION_cursor_install_schema_merge_receipt.md — delegation: cursor:root
...
| **WHAT** | `database/lupopedia/mysql/install/install_new_lupopedia.sql` was updated from **`schema_corrected_core.sql`** and **`schema_corrected_missing.sql`** (DDL applied as authored there). A table-name set diff was run against **`install_new_lupopedia_backup_20260406.sql`**. Thread Q&A: redundant **`questions` / `answers` / `question_map`** removed in favor of existing **`truth_*`** tables. |
| **WHERE** | `database/lupopedia/mysql/install/install_new_lupopedia.sql` (canonical); sources under `database/lupopedia/mysql/schema_review/`; optional local backup `install_new_lupopedia_backup_20260406.sql`. |
| **WHEN** | Epoch **2026-04-07 ~02:00 UTC** (temporal anchor **`20260407015813`** from `python bin/tick.py` for this documentation batch). |
...
- **Sources:** `database/lupopedia/mysql/schema_review/schema_corrected_core.sql`, `schema_corrected_missing.sql`
