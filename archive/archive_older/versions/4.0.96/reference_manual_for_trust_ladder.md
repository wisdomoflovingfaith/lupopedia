...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.96/reference_manual_for_trust_ladder.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.96/reference_manual_for_trust_ladder.md"
  questions_toon: null
...
- `docs/doctrine/TRUST_LADDER_REGISTRY.md`
- `docs/prd/38_memory_unification.md`
- `docs/prd/79_install_seed_doctrine.md`
- `docs/prd/19_garbage_collection_system.md`
