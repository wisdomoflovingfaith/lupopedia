...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.96/status/DATABASE_FACTORY_LOCKING_RESEARCH.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.96/status/DATABASE_FACTORY_LOCKING_RESEARCH.md"
  questions_toon: null
...
`PDO_DB` (`includes/classes/pdo_db.php`) exposes three transaction methods,
