...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.96/status/SESSIONS_RESEARCH.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.96/status/SESSIONS_RESEARCH.md"
  questions_toon: null
...
| `includes/classes/AuthSessionManager.php` | Actor mapping + legacy helpers |
| `includes/classes/SessionManager.php` | Idle timeout management |
| `includes/classes/CloudflareRequestHandler.php` | Proxy IP extraction |
| `database/lupopedia/mysql/install/install_new_lupopedia.sql` | Schema (lupo_sessions table) |
| `craftysyntax-reference/functions.php` | Legacy Class C + UA identity (reference only) |
| `database/lupopedia/content/app/Services/CraftySyntax/LegacySessionIdentity.php` | Legacy session bridge |
