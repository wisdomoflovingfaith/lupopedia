...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.96/status/STATUS_SEED_RUNTIME_PK_DOCTRINE_20260407235921.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.96/status/STATUS_SEED_RUNTIME_PK_DOCTRINE_20260407235921.md"
  questions_toon: null
...
| Artifact | Change |
|----------|--------|
| **PRD 00** | **§3.2** qualified for runtime vs seed; new **§3.2.1** with dual-strategy table, illustrative per-table column, six rules, memory mirror note (**`memory/1970/01/`**). |
...
- **Path:** **`memory/1970/01/`** (not `export/…`) — matches **`MemoryExportService`**.
