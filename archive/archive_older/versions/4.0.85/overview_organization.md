...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.85/OVERVIEW_ORGANIZATION.md"
  web_path: null
  questions_toon: null
...
- Authority: TASK_REGISTRY.md at `docs/versions/4.0.85/TASK_REGISTRY.md`
...
| **2015** | resolved the mood_vector model into authoritative canonical tokens plus vector-only routing influence |
...
| 2015 | `doctrine_changes/mood_vector_hybrid_model.md` |
...
| `docs/versions/4.0.85/README.md` | What is special about 4.0.85 and why does the version directory exist? |
| `docs/versions/4.0.85/OVERVIEW.md` | What became true in the system during 4.0.85? |
| `docs/versions/4.0.85/OVERVIEW_ORGANIZATION.md` | How is 4.0.85 work and documentation authority organized? |
