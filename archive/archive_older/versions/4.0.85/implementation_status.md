...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.85/IMPLEMENTATION_STATUS.md"
  web_path: null
  questions_toon: null
...
| mood_vector hybrid authority model | Canonical tokens authoritative; continuous values routing-only | 2015 |
