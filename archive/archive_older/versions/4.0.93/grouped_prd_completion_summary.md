...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.93/GROUPED_PRD_COMPLETION_SUMMARY.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.93/GROUPED_PRD_COMPLETION_SUMMARY.md"
  questions_toon: null
...
All 14 grouped PRD files created in `docs/prd/` with complete coverage:
