...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.93/decisions/20260402_180000_DIALOG_prd_guide_structure_correction.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.93/decisions/20260402_180000_DIALOG_prd_guide_structure_correction.md"
  questions_toon: null
...
2. **Filesystem Thread Instructions**
   - PRD contained detailed instructions for `channels/42/threads/` structure
...
**Before:**
- Detailed `channels/42/threads/` directory structure
