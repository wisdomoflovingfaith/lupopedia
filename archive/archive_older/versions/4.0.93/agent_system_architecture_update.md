...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.93/AGENT_SYSTEM_ARCHITECTURE_UPDATE.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.93/AGENT_SYSTEM_ARCHITECTURE_UPDATE.md"
  questions_toon: null
...
- **Must map to `/includes/` directories**
