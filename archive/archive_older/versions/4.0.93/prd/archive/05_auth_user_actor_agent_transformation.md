...
lupopedia.headers:
  ...
  file_path_from_root: /docs/versions/4.0.93/prd/05_auth_user_actor_agent_transformation.md
  web_path: http://www.lupopedia.com/lupopedia/docs/versions/4.0.93/prd/05_auth_user_actor_agent_transformation.md
...
lupopedia.edges:
  outbound_edges:
    - to: "database/lupopedia/json/lupo_auth_users.json"
      type: references
      weight: 1.0
      reason: Table definition for authentication users
    - to: "database/lupopedia/json/lupo_actors.json"
      type: references
      weight: 1.0
      reason: Table definition for actors
    - to: "database/lupopedia/json/lupo_actor_instances.json"
      type: references
      weight: 1.0
      reason: Table definition for actor instances
    - to: "database/lupopedia/json/lupo_actor_templates.json"
      type: references
      weight: 1.0
      reason: Table definition for actor templates
    - to: "database/lupopedia/json/lupo_actor_lease_sessions.json"
      type: references
      weight: 1.0
