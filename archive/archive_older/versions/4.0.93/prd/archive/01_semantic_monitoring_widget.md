...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.93/prd/archive/01_semantic_monitoring_widget.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.93/prd/archive/01_semantic_monitoring_widget.md"
...
lupopedia.edges:
  outbound_edges:
    - to: "database/lupopedia/json/lupo_context_edges.json"
      type: references
      weight: 1.0
      reason: Table definition for semantic edges
    - to: "database/lupopedia/json/lupo_context_cards.json"
      type: references
      weight: 1.0
      reason: Table definition for context cards
    - to: "database/lupopedia/json/lupo_contexts_map.json"
      type: references
      weight: 1.0
...
**Toon Files (Read-Only Senses)**: The `.json` files in `database/lupopedia/json/` are **READ-ONLY** artifacts. The Monitoring Widget must reference actual `lupo_edges` schema, not assumed structures.
...
- `docs/versions/4.0.93/PLAN.md` 
- `docs/versions/4.0.93/prd/semantic_monitoring_widget.md` 
- `docs/installer/INSTALL.md` 
- Installer wizard text (`install.php`)
- `rules/root/LUPOPEDIA_HEADERS_DOCTRINE.md` 
...
```php
docs/ide/IDE_BEHAVIOR_RULES.md
```
