...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.87/TODO.md"
  web_path: "http://www.lupopedia.com/docs/versions/4.0.87/TODO.md"
  questions_toon: null
...
---
# file: 4.0.87 TODO â€” delegation: cursor:root â€” web_path: http://www.lupopedia.com/docs/versions/4.0.87/TODO.md
...
- [x] Populated complete documentation for 22+ agents in `agents/`.
...
- [x] **P2** â€” Track 4: `EdgeQueryService` PHP class â€” **`includes/classes/EdgeQueryService.php` created with 11 read-only methods**.
...
- [x] Reconcile channel documentation to match live routing/security behavior. — Completed via V487-002 alignment pass; evidence: `channels/42/threads/1054/20260325_231500_cursor_v487_002_channel_docs_alignment_completion.md`.
...
- [x] Run Channel 62 stream for `*` folder inventory, deprecation cleanup, and docs reconciliation â€” **closure published 20260324**.
...
- [x] Track 4: `EdgeQueryService` PHP class created at `includes/classes/EdgeQueryService.php`.
...
- [ ] Expand script metadata comments beyond key validators/importers to full `scripts` coverage.

## Thread Update (2026-03-24: Root organization + channel 66)
- [x] Archived high-confidence stale root files to `docs/archived/root_stale_20260324/`.
...
- [x] Added major-agent manifest `database/lupopedia/actors/major_agents_manifest.json`.
...
- [x] Added `scripts/run_edge_migration_track3a.php` runner and executed Track 3a pass.

### Still Pending (Blocking)
- [x] Resolve channel 66 thread 1047 remaining unanswered Q1-Q7. â€” ANSWERED 20260324_220000 by WOLFIE (actor_id 1, per thread 1054 takeover directive). See `channels/66/threads/1047/20260324_220000_cursor_answers_q1_q7_thread_1047.md`.
- [x] Publish channel 62 organization completion artifact â€” `channels/62/threads/6201/20260324_230000_cursor_organization_pass_closure.md`.
- [x] Publish channel 63 DB docs reconciliation closure artifact â€” `channels/63/threads/6301/20260324_230000_cursor_db_docs_reconciliation_closure.md`.
- [x] Publish channel 64 edge queue closure artifact â€” `channels/edge_generation_governance/threads/6401/20260324_230000_cursor_edge_governance_closure.md`.
...
- [x] Added thread artifact: `channels/table-structure-optimization/threads/20260325_163000_cursor_admin_ui_identity_alignment_4_0_87.md`.
- [x] Added thread artifact: `channels/table-structure-optimization/threads/20260325_170000_athena_semantic_table_architecture_review_4_0_87.md`.
- [x] Added completion artifact: `channels/table-structure-optimization/threads/20260325_123500_cursor_cip_system_removal_4_0_87.md`.
- [x] Removed CIP table blocks from `install_new_lupopedia.sql` and `install_new_lupopedia_backup.sql`.
- [x] Removed `select_one_from_lupo_calibration_impacts` from `scripts/wolfie_orms.py`.
- [x] Removed active CIP docs under `docs/database/lupopedia/tables/active/` and CIP architecture docs.
- [x] Updated `docs/database/lupopedia/tables/TABLE_INDEX.md` to remove `lupo_calibration_impacts` planning entry.
- [ ] Regenerate `tools/flare_validate_issues.json` to clear stale references to removed docs.
...
- [x] Q5 â€” Timestamp validation additions to `generate_headers_from_db.py`: Tier 2 (semantic range) and Tier 3 (role-integrity) checks; unit tests `tests/unit/test_header_validators.py` 9/9 pass.
...
- [x] Updated `includes/classes/EmergentRoleDiscovery.php` — 3 queries migrated to `lupo_edges` with polymorphic column mapping.
- [x] Updated `database/lupopedia/content/app/Services/ActorService.php` — `getActorsUserCanActAs()` JOIN migrated to `lupo_edges`.
- [x] Updated `scripts/audit_schema_doctrine.php` — `lupo_actor_edges` removed from `$tablesRequiringSoftDelete`.
- [x] Deleted `database/lupopedia/toon/lupo_actor_edges.toon` and `lupo_reference_cited_by.toon`.
- [x] Moved `docs/database/lupopedia/tables/active/lupo_actor_edges.md` → `tables/deprecated/` with 4.0.87 deprecation headers.
- [x] Created `database/lupopedia/mysql/migrations/dev_20260325_remove_redundant_edge_tables.sql`.
- [x] Published HEPHAESTUS completion status in `channels/42/threads/1005/20260325_200000_hephaestus_status_edge_consolidation_execution_complete.md`.
...
- [x] WOLFIE directive Phase A — Task C: `docs/doctrine/EDGE_MODEL_DOCTRINE.md` created — 9-section single-table edge model doctrine.
...
- [ ] Regenerate `tools/flare_validate_issues.json` after CIP + edge table deletions.
...
- [x] Published completion artifact: `channels/42/threads/1054/20260325_231500_cursor_v487_002_channel_docs_alignment_completion.md`.
