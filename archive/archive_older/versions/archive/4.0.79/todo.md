...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.79/TODO.md"
...
**Doctrine / Planning:**
- `docs/doctrine/BAYESIAN_DECISION_DOCTRINE.md` – defines what "Bayesian decision" means in Lupopedia
- `docs/planning/bayesian_decision_tracking_PLAN.md + ..._TASKS.md`
- `docs/status/Bayesian_Decision_Tracking_wolfie.md (+ lilith_review_bayesian.md if present)`
...
37. **Minimal API surface** — [x] Add `includes/modules/api/decisions-api.php`:
...
38. **Tests** — [x] Add `tests/unit/bayesian_decision_service_test.php`:
...
39. **Architecture documentation** — [x] Create `docs/architecture/BAYESIAN_DECISION_TRACKING_ARCHITECTURE.md`:
...
41. **Status artifact** — [x] Create `docs/status/bayesian_decision_tracking_implementation_4_0_79.md`:
