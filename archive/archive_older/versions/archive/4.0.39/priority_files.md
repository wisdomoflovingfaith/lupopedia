...
flip.footer: {
  inbound_edges: [
    ...
    { from: "includes/classes/AnubisHeaderFallback.php", type: "processes", weight: 0.9, hashtag: "#automation" }
  ],
  outbound_edges: [
...
|-----------|---------------|------------|-------|
| `includes/modules/crafty_syntax/crafty_syntax-controller.php` | ⚠️ Needs header | 0.90 | Migration controller |
| `includes/modules/crafty_syntax/visitor-session-helper.php` | ⚠️ Needs header | 0.85 | Session migration |
...
| `includes/bootstrap.php` | ⚠️ Needs header | 0.92 | System entry |
| `includes/lupopedia-setup.php` | ⚠️ Needs header | 0.90 | Post-install setup |
...
| `includes/modules/crafty_syntax/CRAFTY_SYNTAX_SQL_TOON_REPORT.md` | ⚠️ Needs header | 0.75 | Conversion data |
...
| `includes/classes/AnubisHeaderFallback.php` | ✅ Complete | 0.85 | ANUBIS engine |
| `includes/classes/pdo_db.php` | ⚠️ Needs header | 0.95 | DB wrapper |
| `includes/classes/DatabaseFactory.php` | ⚠️ Needs header | 0.92 | DB factory |
| `includes/classes/ColorProtocol.php` | ⚠️ Needs header | 0.65 | Color handling |
| `includes/classes/UrlResolver.php` | ⚠️ Needs header | 0.70 | URL resolution |
| `includes/classes/TOONParser.php` | ⚠️ Needs header | 0.88 | TOON parsing |
| `includes/classes/DialogHistoryManager.php` | ⚠️ Needs header | 0.80 | Dialog history |
| `includes/bootstrap.php` | ⚠️ Needs header | 0.90 | System bootstrap |
| `includes/lupopedia-loader.php` | ⚠️ Needs header | 0.88 | Module loader |
| `includes/modules/module-loader.php` | ⚠️ Needs header | 0.85 | Module system |
| `includes/version.php` | ⚠️ Needs header | 0.92 | Version management |
