...
lupopedia.headers:
  ...
  file_hash: "305c782a9db9fdc27470d97a34d2f55a5324871779882afe252c7e654676d7dc"
...
flip.footer: {
  ...
  outbound_edges: [
    ...
    { to: "includes/bootstrap.php", type: "targets", weight: 1.0, hashtag: "#bootstrap" },
    { to: "includes/modules/crafty_syntax/", type: "targets", weight: 1.0, hashtag: "#integration" },
...
| File Path | Status | Priority | Notes |
|-----------|--------|----------|-------|
| `includes/bootstrap.php` | ⚠️ NEEDS HEADER | P0 | System bootstrap |
| `includes/bootstrap-cli.php` | ⚠️ NEEDS HEADER | P1 | CLI bootstrap |
| `includes/lupopedia-loader.php` | ⚠️ NEEDS HEADER | P0 | Module orchestrator |
| `includes/modules/module-loader.php` | ⚠️ NEEDS HEADER | P0 | Module system |
| `includes/version.php` | ⚠️ NEEDS HEADER | P0 | Version management |
| `includes/functions/load_atoms.php` | ⚠️ NEEDS HEADER | P1 | Atom loading |
...
9. `includes/lupopedia-loader.php`
10. `includes/modules/module-loader.php`
