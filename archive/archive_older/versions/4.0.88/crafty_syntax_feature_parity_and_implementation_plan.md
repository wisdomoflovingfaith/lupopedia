...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.88/CRAFTY_SYNTAX_FEATURE_PARITY_AND_IMPLEMENTATION_PLAN.md"
  web_path: null
  questions_toon: null
...
This document is the **implementation plan** for the feature parity required by the **4.1.0 PRD System** (docs/versions/4.1.0/). It operates as follows:
...
**What to Build:**
- `includes/modules/livehelp/livehelp-handler.php` (new)
...
**What to Build:**
- New template: `includes/livehelp-operator-ui.php` (rendered in `live.php`)
- **Operator Dashboard:**
...
if ($admin_section === 'master-settings') {
    require_once LUPOPEDIA_PATH . '/includes/modules/admin/sections/master-settings.php';
    render_master_settings_form($db, $user);
} elseif ($admin_section === 'operator-status') {
    require_once LUPOPEDIA_PATH . '/includes/modules/admin/sections/actor-status.php';
    render_operator_status_board($db, $user);
} elseif ($admin_section === 'quick-replies') {
    require_once LUPOPEDIA_PATH . '/includes/modules/admin/sections/quick-replies.php';
...
```
includes/modules/admin/sections/
...
| **Admin UI complexity grows** | Medium | Medium | Use templated patterns (already established in includes/modules/admin/); reuse form builders |
...
1. **This Document Status Change**
   ...
   - Add to `docs/versions/4.1.0/APPROVED_ARTIFACTS_INDEX.md`
...
- **Crafty Syntax Live Help Admin:** `archive/legacy/craftysyntax-3.7.5/admin.php`
- **Crafty Syntax Live Handler:** `archive/legacy/craftysyntax-3.7.5/livehelp.php`
- **Crafty Syntax Operator UI:** `archive/legacy/craftysyntax-3.7.5/live.php`
- **Crafty Syntax Quick Replies:** `archive/legacy/craftysyntax-3.7.5/quick.php`
- **Migration Mappings:** `docs/doctrine/migrations/*.md`
