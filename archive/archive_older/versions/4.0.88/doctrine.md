...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.88/DOCTRINE.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.88/DOCTRINE.md"
  questions_toon: null
...
---
# file: 4.0.88 DOCTRINE - delegation: cursor:root - web_path: [http://www.lupopedia.com/lupopedia/docs/versions/4.0.88/DOCTRINE.md](http://www.lupopedia.com/lupopedia/docs/versions/4.0.88/DOCTRINE.md)
...
- TOON files under `database/lupopedia/toon/` are the primary schema inspection surface for agents; JSON under `database/lupopedia/json/` is secondary.
...
- Table docs under `docs/database/lupopedia/tables/` must include table purpose, column definitions, relationships, usage examples, and edge interaction explanation
...
- For unclear requests, create questions artifacts first under `channels/{channel_id}/threads/{thread_id}/questions/`.
...
- The 4.0.88 target profile is `channels/{federation_node_id}_{channel_key}/threads/{project_slug}/questions|prompts/`.
...
- Channel refactor governance for 4.0.88 is centralized in `channels/1_channel_refactor_governance/`
...
- Channel artifact validation via `scripts/validate_channel_artifacts.py`
...
- If `context/` does not exist, document intended structure and rollout direction; do not create empty directories blindly.
...
- [Multi-Agent Coordination Doctrine](docs/doctrine/MULTI_AGENT_COORDINATION_DOCTRINE.md)
- [Identity Layers Doctrine](docs/doctrine/IDENTITY_LAYERS_DOCTRINE.md)
- [Edge Model Doctrine](docs/doctrine/EDGE_MODEL_DOCTRINE.md)
- [Decision Model Doctrine](docs/doctrine/DECISION_MODEL.md)

### 9.2 Version Documentation

- [4.0.87 Doctrine](docs/versions/4.0.87/DOCTRINE.md)
- [4.0.88 Plan](PLAN.md)
- [4.0.88 TODO](TODO.md)
