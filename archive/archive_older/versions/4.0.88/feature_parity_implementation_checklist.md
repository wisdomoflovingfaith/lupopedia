...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.88/FEATURE_PARITY_IMPLEMENTATION_CHECKLIST.md"
  web_path: null
  questions_toon: null
...
- [ ] Write DDL in `database/lupopedia/mysql/install/install_new_lupopedia.sql`
- [ ] Write TOON reference: `database/lupopedia/toon/lupo_actor_availability_status.toon.json`
- [ ] Write table doc: `docs/database/lupopedia/tables/active/lupo_actor_availability_status.md`
- [ ] Verify with: `python scripts/verify_db_against_toons.py`
- **Owner:** [assign]  |  **ETA:** Day 1
- **Status:** ⬜ Not Started

**Task 1.1.2: Implement ActorAvailabilityService**
- [ ] Create `includes/classes/ActorAvailabilityService.php`
...
- [ ] Unit tests in `tests/unit/actor_availability_service.php`
- **Owner:** [assign]  |  **ETA:** Day 1-2
- **Status:** ⬜ Not Started

**Task 1.1.3: Implement ChatRoutingService**
- [ ] Create `includes/classes/ChatRoutingService.php`
...
- [ ] Unit tests in `tests/unit/chat_routing_service.php`
...
- [ ] Create `includes/classes/ChatService.php`
...
- [ ] Unit tests in `tests/unit/chat_service.php`
- **Owner:** [assign]  |  **ETA:** Day 3-4
- **Status:** ⬜ Not Started

**Task 1.1.5: Create livehelp-handler.php**
- [ ] Create `includes/modules/livehelp/livehelp-handler.php`
...
- [ ] Create `includes/templates/livehelp-operator-dashboard.php`
...
- [ ] CSS styling in `includes/css/livehelp-operator.css`
- [ ] JavaScript AJAX for message polling in `includes/js/livehelp-operator.js`
...
- [ ] Create `includes/modules/admin/sections/actor-status.php`
...
- [ ] Visitor simulator in `tests/integration/test_live_chat_flow.sh`
...
- [ ] Create `includes/classes/QuickReplyService.php`
...
- [ ] Create `includes/modules/admin/sections/quick-replies.php`
...
- [ ] Create `includes/modules/admin/sections/offline-messages.php`
...
- [ ] Create `includes/classes/AutoInviteService.php`
...
- [ ] Create `includes/classes/OperatorActivityService.php`
...
- [ ] Create `includes/modules/admin/sections/master-settings.php`
- [ ] Form with fields:
...
- [ ] Create `includes/modules/admin/sections/operator-reports.php`
...
- [ ] Create `includes/modules/admin/sections/channel-settings.php`
...
- [ ] Create `includes/modules/admin/sections/qa-management.php`
...
- [ ] Create `includes/templates/operator-personal-dashboard.php`
...
- [ ] Create `includes/classes/EmailQueueService.php`
...
- [ ] Cron hook: `/bin/cron-email-queue.php` to be called by system cron

**Task 4.1.3: Add "Email Message Database" Admin Section**
- [ ] Create `includes/modules/admin/sections/email-messages.php`
...
- [ ] Create `includes/classes/LeadService.php`
...
- [ ] Create `includes/modules/admin/sections/leads-database.php`
...
- [ ] Create `includes/modules/admin/sections/import-leads.php`
...
- [ ] Create `tests/integration/test_complete_live_help_flow.sh`
...
- [ ] Create admin guide: `docs/versions/4.0.88/LIVE_HELP_ADMIN_GUIDE.md`
- [ ] Create operator guide: `docs/versions/4.0.88/LIVE_HELP_OPERATOR_GUIDE.md`
- [ ] Create visitor guide: `docs/versions/4.0.88/LIVE_HELP_VISITOR_GUIDE.md`
