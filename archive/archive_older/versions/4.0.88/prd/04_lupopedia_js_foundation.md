...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.88/prd/04_lupopedia_js_foundation.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.88/prd/04_lupopedia_js_foundation.md"
  questions_toon: null
...
1. `archive/legacy/craftysyntax-3.7.5/livehelp_js.php`
...
2. TOON files under `database/lupopedia/toon/` are structural authority surfaces.
3. Table docs under `docs/database/lupopedia/tables/` explain behavior and constraints.
