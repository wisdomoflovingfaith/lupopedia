...
- [ ] Hydration 2.0: Promote more "Unfinished Business" from legacy files using optimized bin/hydrator.php.

---

- [ ] Review and document all new search and navigation features.
- [ ] Validate all new features with enforce_doctrine.py for compliance.
