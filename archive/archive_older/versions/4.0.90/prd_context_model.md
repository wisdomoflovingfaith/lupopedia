...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.90/PRD_CONTEXT_MODEL.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.90/PRD_CONTEXT_MODEL.md"
  questions_toon: null
...
- **Discussion**: A thread in Channel 42 (markdown in `channels/42/threads/`)
...
2. **Finalize JSON**: Lock the TOON schemas in `database/lupopedia/json/`.
