...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.90/PLAN.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.90/PLAN.md"
  questions_toon: null
...
**Completion criteria:**
- `rules/enforce_doctrine.py` created and integrated into all build/sync/test workflows.
...
| Binding headers doctrine | `rules/root/LUPOPEDIA_HEADERS_DOCTRINE.md` |
