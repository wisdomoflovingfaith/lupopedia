...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.89/WINDSURF_ROLLOVER_AUDIT_AND_COMPLETION_REPORT.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.89/WINDSURF_ROLLOVER_AUDIT_AND_COMPLETION_REPORT.md"
  questions_toon: null
...
**Evidence**:
- `config/global_atoms.yaml`: version: "4.0.88"
- `docs/version.md`: Current version: **4.0.88**
...
**Evidence**:
- References to `docs/doctrine/migrations/`
- References to `archive/legacy/craftysyntax-3.7.5/`
- References to `docs/database/lupopedia/tables/`
