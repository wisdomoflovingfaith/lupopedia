...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.89/LUPOPEDIA_DOCUMENTATION_CLARITY_REVIEW.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.89/LUPOPEDIA_DOCUMENTATION_CLARITY_REVIEW.md"
  questions_toon: null
...
- docs/version.md - 192 lines

**LUPOPEDIA HEADERS / Doctrine**:
- docs/doctrine/LUPOPEDIA_HEADERS/README.md - 158 lines
- docs/doctrine/CONTEXT_MODEL_DOCTRINE.md - 584 lines

**Database / Authority Docs**:
- docs/database/README.md - 226 lines
- docs/database/lupopedia/README.md - 123 lines
- docs/database/lupopedia/tables/active/lupo_actors.md - 98 lines

**Version Documentation**:
- docs/versions/4.0.88/README.md - 178 lines
- docs/versions/4.0.89/README.md - 193 lines
...
3. **Multiple overlapping organization docs**:
   - ORGANIZATION.md (root) and docs/ORGANIZATION.md
...
- **Named scripts and flow:** `import_content.py`, `generate_headers_from_db.py`, `ensure_imported.py`, `lib/header_db_sync.py`; binding narrative in **`rules/root/LUPOPEDIA_HEADERS_DOCTRINE.md`** (*Database-first mapping and `lupo_contents`*).
- **Single binding doctrine file** vs **`docs/doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_DOCTRINE.md`** alias + **`outbound_edges`** to validators — see **`docs/versions/4.0.89/HEADER_DB_FIRST_AND_DOCTRINE_CONSOLIDATION_4.0.89.md`**.
...
- **Scope split (2026-03-28):** Version **4.0.89** is **refocused** to **LUPOPEDIA HEADERS release** (validation, import, `*` / IDE rules, header DB, release tests). Tasks **5.1–5.4** (and broader context/Crafty work) move to **`docs/versions/4.0.90/`** — see **`CHANGELOG.md`** §8 and **`4.0.89/README.md`**.
...
**Path**: c:\ServBay\www\servbay\lupopedia\docs\database\README.md
...
#### docs/database/lupopedia/README.md
**Issue**: Duplicate content with database/README.md
**Path**: c:\ServBay\www\servbay\lupopedia\docs\database\lupopedia\README.md
...
**Issue**: ORGANIZATION.md and docs/ORGANIZATION.md
...
**Files**: README.md, docs/version.md
...
**Files**: ORGANIZATION.md and docs/ORGANIZATION.md
...
**Edges to add**:
- docs/database/README.md (database authority)
- docs/doctrine/LUPOPEDIA_HEADERS/README.md (metadata system)
- docs/versions/4.0.89/README.md (current version)
- channels/channel_index.md (coordination system)
...
**New file needed**: docs/IMPLEMENTATION_GETTING_STARTED.md
...
2. docs/doctrine/LUPOPEDIA_HEADERS/README.md (metadata system)
3. docs/versions/4.0.89/README.md (current work)
4. docs/versions/4.0.89/PLAN.md (implementation)
