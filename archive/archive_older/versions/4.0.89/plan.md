...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.89/PLAN.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.89/PLAN.md"
  questions_toon: null
...
**Scope:** Same as [`README.md`](README.md) — **headers, validation, import** (Python + PHP toolchains; [`TODO.md`](TODO.md) **H8**), **PHP agent filesystem policy** (**H9**, **`AgentFileWriter`**, optional [`PHP_AGENT_FILESYSTEM_DEPLOYMENT.md`](PHP_AGENT_FILESYSTEM_DEPLOYMENT.md)), **`*`** organization, IDE rules, header-related DB, release testing.
...
**Completion criteria:** `TODO.md` H4.* — rule files and IDE packs aligned; propagation documented; **H4.4** repository literacy (root + `docs/ORGANIZATION.md` §2.2) verified for release participants.
