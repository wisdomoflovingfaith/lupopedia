...
lupopedia.headers:
  ...
  when_updated: null
  file_path_from_root: "docs/versions/4.0.89/legacy_research/livehelp_js_deep_analysis.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.89/legacy_research/livehelp_js_deep_analysis.md"
  questions_toon: null
...
**File**: `archive/legacy/craftysyntax-3.7.5/livehelp_js.php`  
**Size**: 964 lines  
...
**Integration Points**:
- **Real-time chat** → `channels/` for live coordination
...
- **API integration**: Use `api/` endpoints instead of direct PHP
