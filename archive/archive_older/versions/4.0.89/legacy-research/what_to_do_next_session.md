...
lupopedia.headers:
  ...
  file_path_from_root: "docs/versions/4.0.89/legacy_research/WHAT_TO_DO_NEXT_SESSION.md"
  web_path: "http://www.lupopedia.com/lupopedia/docs/versions/4.0.89/legacy_research/WHAT_TO_DO_NEXT_SESSION.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "docs/versions/4.0.89/legacy_research/", type: "builds_on", weight: 1.0, reason: "Planning based on completed research documents" }
    - { to: "docs/versions/4.0.89/", type: "informs", weight: 1.0, reason: "Next session planning for version documentation" }
...
- **api/operator/login.php** - Modern authentication endpoint using lupo_actors table
- **views/operator/dashboard.php** - Frame-free responsive dashboard with real-time updates
...
- **api/operator/queue.php** - Visitor queue endpoint
- **api/operator/claim.php** - Chat claiming endpoint
- **api/operator/messages.php** - Message retrieval endpoint
- **api/operator/send.php** - Message sending endpoint
- **api/operator/logout.php** - Logout endpoint
...
- Test integration with views/operator/dashboard.php
...
## Dependencies
- **Migration Documentation**: docs/doctrine/migrations/livehelp_/ for database mapping
- **Legacy Code**: archive/legacy/craftysyntax-3.7.5/ for endpoint analysis
- **Existing Lupopedia Systems**: api/, views/, includes/ for integration

## Required Reading for Next Session
- **Migration Scripts**: database/lupopedia/mysql/import/ directory
- **API Documentation**: api/ existing endpoints for reference
- **Database Schema**: database/lupopedia/tables/ for table structures
- **Integration Examples**: includes/classes/ for existing patterns
