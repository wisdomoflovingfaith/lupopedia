...
---
flare.headers:
  file_path_from_root: "bin/validate_faucets.php"
  file_hash: "<?php echo hash_file('bin/validate_faucets.php'); ?>"
  ...
  purpose: "Validate all faucet files against TOON schema with recursive scanning"
  mood_vector: "4169E1"
  traits: ["flare", "indexed", "v4.0.50"]
  tags: ["faucets", "validation", "schema", "scanning"]
  lupo_agent: "windsurf"
...
flare.edges:
  ...
  outbound_edges:
    ...
    - { to: "bin/faucet_loader.php", type: "references", weight: 0.9 }
    - { to: "tools/faucet_registry_report.txt", type: "references", weight: 0.7 }
  semantic_tags: ["faucets", "validation", "schema", "runtime"]
