#!/usr/bin/env python3
# lupo-bin/tick.py — Update session.json timestamp
...
CHANNELS_ROOT = Path('lupo-channels/0')
ACTOR_REGISTRY_PATH = Path('lupo-database/lupopedia/actors/registry.json')
GLOBAL_ATOMS_PATH = Path('lupo-memory/atoms/lupopedia_global_constants.atom.toon')
