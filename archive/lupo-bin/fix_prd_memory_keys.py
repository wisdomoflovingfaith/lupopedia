...
Rule: memory_key = lupo-memory/development/staging/2026/04/{NN}_{snake_case}.toon
"""
import os
import re

BASE = "C:/ServBay/www/servbay/lupopedia"
PRD_DIR = os.path.join(BASE, "lupo-docs/prd")
STAGING_DIR = os.path.join(BASE, "lupo-memory/development/staging/2026/04")
...
def toon_exists_anywhere(nn, snake):
    canonical_2026 = os.path.join(BASE, f"lupo-memory/development/canonical/2026/04/{nn}_{snake}.toon")
    canonical_1026 = os.path.join(BASE, f"lupo-memory/development/canonical/1026/04/{nn}_{snake}.toon")
    staging = os.path.join(STAGING_DIR, f"{nn}_{snake}.toon")
    # Also check alternate names in canonical dirs
    canon_2026_dir = os.path.join(BASE, "lupo-memory/development/canonical/2026/04")
...
def main():
    ...
    for fname in prd_files:
        ...
        new_mk = f"lupo-memory/development/staging/2026/04/{toon_fname}"
