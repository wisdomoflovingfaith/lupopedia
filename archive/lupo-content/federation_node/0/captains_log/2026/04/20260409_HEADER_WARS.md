...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-content/federation_node/0/captains_log/20260409_HEADER_WARS.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-content/federation_node/0/captains_log/20260409_HEADER_WARS.md"
  questions_toon: null
  federation_node_id: 0
  channel_key: "captains_log"
  trust_tier: "canonical"
  memory_toon: "lupo-memory/captains_log/canonical/1026/04/header-wars.toon"
  artifact_type: documentation
  artifact_kind: blog_entry
  thread_id: "header-wars"
  content_id: null
  pk_id: null
  pk_slug: "header-wars"
...
```json
{
  ...
  "edges": {
    "outbound": [
      {"to": "lupo-docs/prd/00_root_constitutional_system_requirements.md", "type": "references"},
      {"to": "lupo-content/federation_node/0/captains_log/20260407_hello_world.md", "type": "references"}
    ]
  },
...
- **[LUPOPEDIA HEADERS v3 (normative doctrine)](../../../../lupo-docs/doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_FORMAT.md)** — fixed position, 20 fields, memory sidecars
- **[Transcript System](../../../../lupo-docs/prd/44_session_config_and_transcript.md)** — how transcripts work, agent coordination
- **[Memory File Schema](../../../../lupo-docs/doctrine/LUPOPEDIA_HEADERS/MEMORY_FILE_SCHEMA.md)** — the `.toon` format
