...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-content/federation_node/0/captains_log/20260409_DEPARTMENT_DOCTRINE.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-content/federation_node/0/captains_log/20260409_DEPARTMENT_DOCTRINE.md"
  questions_toon: null
  federation_node_id: 0
  channel_key: "captains_log"
  trust_tier: "canonical"
  memory_toon: "lupo-memory/captains_log/canonical/1026/04/department-doctrine.toon"
  artifact_type: documentation
  artifact_kind: blog_entry
  thread_id: "department-doctrine"
  content_id: null
  pk_id: null
  pk_slug: "department-doctrine"
...
```markdown
# file: Captain's Log — The Department Doctrine — delegation: wolfie:root — web_path: http://www.lupopedia.com/lupopedia/lupo-content/federation_node/0/captains_log/20260409_DEPARTMENT_DOCTRINE.md
...
| **Agent** | Immutable AI blueprint | `lupo-agents/{agent_key}/` (filesystem) | ❌ No (template only) | `lupo-agents/wolfie/` |
...
- **[Entry 005: The Unified Theory](../../../../lupo-content/federation_node/0/captains_log/20260409_UNIFIED_THEORY.md)** — how it all fits together

**And the constitutional rules:**
- `lupo-docs/prd/00_root_constitutional_system_requirements.md` — Department 0 rule
- `lupo-docs/prd/15_actors.md` — Actor system
- `lupo-docs/prd/25_departments_system.md` — Department creation rules
- `lupo-docs/doctrine/IDENTITY_LAYERS_DOCTRINE.md` — Full five-layer identity model
