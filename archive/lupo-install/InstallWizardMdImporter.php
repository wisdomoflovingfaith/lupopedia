...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-install/InstallWizardMdImporter.php"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-install/InstallWizardMdImporter.php"
  status: "active"
  when_updated: "20260422100000"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/install-wizard-md-importer-php.toon"
  atoms_toon: null
  transcript_jsonl: "0/development/install-wizard-md-importer-php"
  ...
  title: "InstallWizardMdImporter.php -- Markdown import wrapper for install wizard"
  summary: "Markdown import wrapper for install wizard, supporting structured content import during installation process."
  artifact_type: "implementation"
  artifact_kind: "tool"
*/
