...
lupopedia.headers:
  ...
  file_path_from_root: "channels/60/README.md"
  web_path: "http://www.lupopedia.com/channels/60/README.md"
  questions_toon: null
  channel_id: 60
...
4. **File Structure**: Contracts for `agents/` and `actors/` alignment
