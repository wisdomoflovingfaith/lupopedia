...
lupopedia.headers:
  ...
  file_path_from_root: "channels/60/threads/agent-system-design/20260323_112000_wolfie_agent_system_design_kickoff.md"
  web_path: "http://www.lupopedia.com/channels/60/threads/agent-system-design/20260323_112000_wolfie_agent_system_design_kickoff.md"
  questions_toon: null
  channel_id: 60
  ...
  references:
    - "docs/versions/4.0.86/SCOPE_LOCK_SUMMARY.md"
...
4. **File/DB Alignment**: Risk of drift between `agents/`, `actors/`, and database tables
...
- What is the contract between `agents/` and `actors/`?
