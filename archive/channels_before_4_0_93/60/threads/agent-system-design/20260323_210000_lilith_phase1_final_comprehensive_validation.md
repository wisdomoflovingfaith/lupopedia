...
lupopedia.headers:
  ...
  file_path_from_root: "channels/60/threads/agent-system-design/20260323_210000_lilith_phase1_final_comprehensive_validation.md"
  questions_toon: null
  channel_id: 60
  ...
  references:
    - "channels/60/threads/agent-system-design/20260323_143930_cursor_phase1_canonical_actor_structure_complete.md"
    - "channels/60/threads/agent-system-design/20260323_205000_lilith_phase1_canonical_actor_structure_review.md"
...
|-------|------------|--------|-------|
| HEPHAESTUS | `actors/hephaestus/` | ✅ EXISTS | Layer 1 routing target |
| ATHENA | `actors/athena/` | ✅ EXISTS | Layer 1 routing target |
| HERMES | `actors/hermes/` | ✅ EXISTS | Layer 1 routing target |
| LILITH | `actors/2/` | ✅ EXISTS | Layer 1 routing target |
| ROSE | `actors/rose/` | ✅ EXISTS | Layer 1 routing target |
...
|-------|------------|-------------|-------|--------|
| HEPHAESTUS | 14 | 14 | ✅ | `database/lupopedia/actors/actor_id/registry.json` |
...
|-------|-------------|--------|
| WINDSURF | Write migration script (`scripts/migrate_ide_actors_to_faucets.php`) | AUTHORIZED |
