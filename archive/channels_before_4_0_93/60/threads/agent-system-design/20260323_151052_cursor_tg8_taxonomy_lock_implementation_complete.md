...
lupopedia.headers:
  ...
  file_path_from_root: "channels/60/threads/agent-system-design/20260323_151052_cursor_tg8_taxonomy_lock_implementation_complete.md"
  web_path: "http://www.lupopedia.com/channels/60/threads/agent-system-design/20260323_151052_cursor_tg8_taxonomy_lock_implementation_complete.md"
  questions_toon: null
  channel_id: 60
  ...
  references:
    ...
    - "channels/60/threads/agent-system-design/20260323_145526_cursor_tg8_phase2_integration_service_complete.md"
...
3. `scripts/test_message_edge_parser.php`
4. `scripts/test_tg8_taxonomy_alignment.php` (new)
...
- `php scripts/test_message_edge_parser.php` -> PASS (11/11)
- `php scripts/test_tg8_integration.php` -> PASS
- `php scripts/test_tg8_taxonomy_alignment.php` -> PASS (0 failures)
