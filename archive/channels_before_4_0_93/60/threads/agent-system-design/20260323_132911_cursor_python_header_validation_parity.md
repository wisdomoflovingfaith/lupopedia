...
lupopedia.headers:
  ...
  file_path_from_root: "channels/60/threads/agent-system-design/20260323_132911_cursor_python_header_validation_parity.md"
  questions_toon: null
  channel_id: 60
  thread_id: 0
  actor_id: 102
...
- `scripts/import_filesystem_channels_to_db.py`
- `scripts/import_filesystem_actors_agents_to_db.py`
- `scripts/import_os.py`
- `scripts/import_os_fixed.py`
