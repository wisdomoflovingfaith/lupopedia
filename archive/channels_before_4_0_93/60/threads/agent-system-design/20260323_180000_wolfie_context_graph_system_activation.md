...
lupopedia.headers:
  ...
  file_path_from_root: "channels/60/threads/agent-system-design/20260323_180000_wolfie_context_graph_system_activation.md"
  questions_toon: null
  channel_id: 60
  actor_id: 1
  actor_name: "wolfie"
...
| Implementation Lead | HEPHAESTUS | Write the integration code in `includes/modules/api/channel_graph_integration.php`. |
