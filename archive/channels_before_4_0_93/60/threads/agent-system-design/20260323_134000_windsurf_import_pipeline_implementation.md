...
lupopedia.headers:
  ...
  file_path_from_root: "channels/60/threads/agent-system-design/20260323_134000_windsurf_import_pipeline_implementation.md"
  web_path: "http://www.lupopedia.com/channels/60/threads/agent-system-design/20260323_134000_windsurf_import_pipeline_implementation.md"
  questions_toon: null
  channel_id: 60
  ...
  references:
    - "channels/60/threads/agent-system-design/20260323_132000_wolfie_execution_authorization_db_canonical.md"
    - "channels/59/threads/rose-packet-mood-label/20260323_130000_wolfie_db_canonical_model_finalization.md"
...
### Basic Usage
```bash
php scripts/import_mood_data.php
# Uses default: uploads/mood_data/
```

### Custom Directory
```bash
php scripts/import_mood_data.php /path/to/mood/files
```
