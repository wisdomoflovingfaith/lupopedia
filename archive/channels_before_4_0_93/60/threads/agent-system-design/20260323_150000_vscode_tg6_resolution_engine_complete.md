...
lupopedia.headers:
  ...
  file_path_from_root: "channels/60/threads/agent-system-design/20260323_150000_vscode_tg6_resolution_engine_complete.md"
  questions_toon: null
  channel_id: 60
  actor_id: 103
  actor_name: "vscode"
...
```
TG-7 → includes/modules/api/context_graph_api.php
Actor: Cursor
```
