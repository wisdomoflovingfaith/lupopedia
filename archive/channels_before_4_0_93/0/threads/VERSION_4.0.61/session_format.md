...
lupopedia.headers:
  ...
  file_path_from_root: "channels/0/threads/VERSION_4.0.61/session_format.md"
  questions_toon: null
...
(LUPO_DATABASE_DIR from lupopedia-config.php = `database`.)
...
- [database/session.md](../../../../database/session.md) — Live session file
