...
lupopedia.headers:
  ...
  file_path_from_root: "channels/0/threads/VERSION_4.0.61/README.md"
...
- **LUPO_CHANNELS_DIR** = `channels` (LUPO_PREFIX . 'channels')
- **Full path:** `channels/0/threads/VERSION_4.0.61/`
...
- [database/session.md](../../../../database/session.md) — Session file
