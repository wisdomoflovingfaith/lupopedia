...
lupopedia.headers:
  ...
  file_path_from_root: "channels/INDEX.md"
  web_path: "http://www.lupopedia.com/channels/INDEX.md"
  questions_toon: null
  channel_id: null
  actor_id: 1
  actor_name: "wolfie"
...
- **New channels**: use slug directory names under `channels/<channel_slug>/`
- **Legacy channels**: numeric directory paths such as `channels/42/` remain valid historical paths
...
- **Path**: `channels/1_channel_refactor_governance/`
...
- **Channel 42**: `channels/42/THREAD_INDEX.md` (most active)
- **Channel 0**: `channels/0/THREAD_INDEX.md`
- **Channel 51**: `channels/51/THREAD_INDEX.md`
- **Channel 666**: `channels/666/THREAD_INDEX.md`

### **Step 4: Follow Thread Work**
Use the thread_id from the THREAD_INDEX.md to navigate to specific work:
- **Path Pattern**: `channels/{channel_id}/threads/{thread_id}/`
