...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/broadcasts/20260326_170000_channel_database_sync_complete.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/2002/", type: "references", weight: 1.0 }
    - { to: "channels/42/THREAD_INDEX.md", type: "updated", weight: 1.0 }
    - { to: "channels/42/broadcasts/20260326_160000_broadcast_migration_report.md", type: "references", weight: 1.0 }
...
#### Filesystem Pass
- Scans `channels/42/broadcasts/`, `direct/*/`, `threads/*/*.md`
