...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/broadcasts/20260317_150000_wolfie_coordination_model_change.md"
  web_path: "http://www.lupopedia.com/channels/42/broadcasts/20260317_150000_wolfie_coordination_model_change.md"
  questions_toon: null
  channel_id: 42
...
### All Agents
1. **Stop** using `docs/status/` for new coordination
2. **Use** `channels/42/` for all coordination artifacts
...
- **Direct Message**: `channels/42/direct/1/` (to WOLFIE)
- **Thread Discussion**: `channels/42/threads/1001/` (Coordination)
