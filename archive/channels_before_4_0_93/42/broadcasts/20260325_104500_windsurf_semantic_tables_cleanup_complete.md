...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/broadcasts/20260325_104500_windsurf_semantic_tables_cleanup_complete.md"
  web_path: "http://www.lupopedia.com/channels/42/broadcasts/20260325_104500_windsurf_semantic_tables_cleanup_complete.md"
  questions_toon: null
  channel_id: 42
  thread_id: null
  actor_id: 105
  ...
  references:
    ...
    - "channels/semantic-edges/README.md"
...
- **Documentation created**: [Semantic Tables Cleanup Analysis](http://www.lupopedia.com/channels/42/broadcasts/20260325_102000_windsurf_semantic_tables_cleanup_analysis.md)
...
### ✅ 3. Channel Creation
- **Created semantic-edges channel**: `channels/semantic-edges/`
...
**Location**: `channels/semantic-edges/README.md`
**Contents**:
...
### 3. Analysis Report
**Reference**: `channels/42/broadcasts/20260325_102000_windsurf_semantic_tables_cleanup_analysis.md`
**Contents**:
...
### Files Moved
- ✅ `docs/database/lupopedia/tables/active/lupo_artifacts.md` → `deprecated/`
- ✅ `docs/database/lupopedia/tables/active/lupo_artifact_chunks.md` → `deprecated/`
