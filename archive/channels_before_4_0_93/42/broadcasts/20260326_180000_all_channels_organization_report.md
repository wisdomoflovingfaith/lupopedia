...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/broadcasts/20260326_180000_all_channels_organization_report.md"
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "channels/42/THREAD_INDEX.md", type: "references", weight: 1.0 }
...
1. **Channel 66**: Migrate ERQ-006 completion to thread
   - Create thread 2012 in `channels/66/threads/`
