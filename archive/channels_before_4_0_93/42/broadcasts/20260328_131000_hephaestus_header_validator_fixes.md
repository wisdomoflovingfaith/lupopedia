...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/broadcasts/20260328_131000_hephaestus_header_validator_fixes.md"
  web_path: "http://www.lupopedia.com/lupopedia/channels/42/broadcasts/20260328_131000_hephaestus_header_validator_fixes.md"
...
lupopedia.edges:
  outbound_edges:
    ...
    - to: "scripts/validate_lupopedia_headers_universal.py"
      type: references
      weight: 1.0
...
**File:** `includes/classes/LupopediaHeaderValidator.php`
...
**File:** `scripts/templates/header-template.md`
...
```bash
❌ tmp/test_invalid_headers.md: Deprecated field 'lupopedia.version' found. Remove it.
```

### Test 2: Missing Subdirectory
```bash
❌ tmp/test_webpath_invalid.md: web_path must include '/lupopedia/' subdirectory.
```

### Test 3: Valid Headers
```bash
✅ channels/42/broadcasts/20260328_130000_wolfie_header_enforcement_directive.md: Valid YAML file format
```
...
### Fixed Files:
- ✅ `channels/42/broadcasts/20260328_130000_wolfie_header_enforcement_directive.md`
  - Removed `lupopedia.version`
  - Removed `system_version`
  - Fixed web_path to include `/lupopedia/`
  - Removed `version` from footer

- ✅ `channels/42/direct/105/20260328_130500_wolfie_to_windsurf_header_enforcement.md`
  - Same fixes applied
...
2. **Validate Existing Files**
   ```bash
   python scripts/validate_lupopedia_headers_universal.py channels/42/broadcasts/*.md
   ```
