...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/broadcasts/20260321_180000_wolfie_full_system_synchronization_directive.md"
  web_path: "http://www.lupopedia.com/channels/42/broadcasts/full_system_synchronization_directive"
  questions_toon: null
  channel_id: 42
  thread_id: null
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/", type: "coordinates", weight: 1.0, reason: "Coordinates all actors in Channel 42" }
    ...
    - { to: "docs/versions/4.0.85/", type: "creates", weight: 1.0, reason: "Creates synchronized version directory" }
...
4. **docs/versions/4.0.85/** - Full version directory
...
**CREATE**: `docs/versions/4.0.85/`

**MODELED EXACTLY AFTER**: `docs/versions/4.0.84/`
...
- ✅ **actors Structure**: Database schema + documentation
