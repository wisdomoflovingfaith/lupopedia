...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/THREAD_INDEX.md"
  questions_toon: null
  channel_id: 42
  actor_id: 105
  actor_name: "cascade"
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/", type: "indexes", weight: 1.0 }
    - { to: "channels/42/broadcasts/", type: "indexes", weight: 0.9 }
...
- **thread_paths_root**: `channels/42/threads/`
- **broadcast_paths_root**: `channels/42/broadcasts/`
- **authoritative_registry**: `docs/versions/4.0.88/TASK_REGISTRY.md`
...
5. **Monitor Thread 2019** for context specification progress
