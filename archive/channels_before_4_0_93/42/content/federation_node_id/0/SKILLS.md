...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/content/federation_node_id/0/SKILLS.md"
  web_path: "http://www.lupopedia.com/channels/42/content/federation_node_id/0/SKILLS.md"
  questions_toon: null
...
lupopedia.edges:
  outbound_edges:
    - { to: "skills/uploads/README.md", type: "references", weight: 1.0 }
    - { to: "docs/doctrine/SKILLS_DOCTRINE.md", type: "references", weight: 0.9 }
...
See skills/uploads/README.md for full doctrine.
