...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/content/federation_node_id/0/NO_INFORMATION_SCHEMA_RULE.md"
  web_path: "http://www.lupopedia.com/channels/42/content/federation_node_id/0/NO_INFORMATION_SCHEMA_RULE.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "docs/doctrine/DATABASE_DOCTRINE.md", type: "references", weight: 1.0 }
    - { to: "scripts/generate_toon_files.py", type: "references", weight: 1.0 }
    - { to: "includes/classes/ToonValidator.php", type: "references", weight: 0.9 }
  # See Also paths are from project root; resolve with LUPOPEDIA_PROJECT_ROOT (config/global_atoms.yaml)
  see_also_from_root:
    - "docs/doctrine/DATABASE_DOCTRINE.md"
    - "scripts/generate_toon_files.py"
    - "includes/classes/ToonValidator.php"
...
cat database/lupopedia/toon/lupo_actors.toon.json
```
...
Paths below are from **project root**. Resolve with `LUPOPEDIA_PROJECT_ROOT` in `config/global_atoms.yaml` (e.g. `C:/ServBay/www/servbay/lupopedia`), or use the links (relative from this file).

- [docs/doctrine/DATABASE_DOCTRINE.md](../../../../../docs/doctrine/DATABASE_DOCTRINE.md)
- [scripts/generate_toon_files.py](../../../../../scripts/generate_toon_files.py)
- [includes/classes/ToonValidator.php](../../../../../includes/classes/ToonValidator.php)
