...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/directives/20260326_rose_correction_final_v2.md"
...
```
channels/42/broadcasts/20260326_lilith_corrections.md
```
...
```
channels/42/broadcasts/20260326_thoth_truth.md
```
...
- [ ] Packets go to `channels/42/packets/` 
