...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/tasks/active/20260319_030000_wolfie_task_doctrine_enforcement_validator.md"
  web_path: "http://www.lupopedia.com/channels/42/tasks/active/20260319_030000_wolfie_task_doctrine_enforcement_validator.md"
  questions_toon: null
...
lupopedia.edges:
  outbound_edges:
    - { to: "scripts/DoctrineValidator.php", type: "creates", weight: 1.0, reason: "Creates the doctrine validator" }
    - { to: "rules/root/", type: "validates", weight: 1.0, reason: "Validates against root rules" }
    - { to: "docs/doctrine/", type: "validates", weight: 1.0, reason: "Validates doctrine compliance" }
  semantic_tags: ["doctrine_enforcement", "validation", "semantic_os"]

lupopedia.see:
  mappings:
    - ["DoctrineValidator.php", "http://www.lupopedia.com/scripts/DoctrineValidator.php"]
