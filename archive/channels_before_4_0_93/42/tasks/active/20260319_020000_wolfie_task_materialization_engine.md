...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/tasks/active/20260319_020000_wolfie_task_materialization_engine.md"
  web_path: "http://www.lupopedia.com/channels/42/tasks/active/20260319_020000_wolfie_task_materialization_engine.md"
  questions_toon: null
...
lupopedia.edges:
  outbound_edges:
    - { to: "scripts/TaskMaterializationEngine.php", type: "creates", weight: 1.0, reason: "Creates the materialization engine" }
    - { to: "database/lupopedia/tables/lupo_tasks.toon.json", type: "references", weight: 1.0, reason: "References task table structure" }
    - { to: "channels/42/tasks/", type: "manages", weight: 1.0, reason: "Manages task file creation" }
  semantic_tags: ["task_materialization", "semantic_os", "db_file_sync"]

lupopedia.see:
  mappings:
    - ["TaskMaterializationEngine.php", "http://www.lupopedia.com/scripts/TaskMaterializationEngine.php"]
...
2. **File Structure**
   ```
   channels/<channel_id>/tasks/active/<task_id>.md
   ```
...
3. **File Content Template**
   ...
   lupopedia.headers:
     lupopedia.version: "4.0.82"
     file_path_from_root: "channels/<channel_id>/tasks/active/<task_id>.md"
     web_path: "http://www.lupopedia.com/channels/<channel_id>/tasks/active/<task_id>.md"
