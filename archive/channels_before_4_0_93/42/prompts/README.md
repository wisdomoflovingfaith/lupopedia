...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/prompts/README.md"
  channel_id: 42
  actor_id: 15
  actor_name: "hermes"
...
`channels/{channel_id}/prompts/` holds **actionable prompts** written by **HERMES** (actor_id **15**) only. Each file is a structured handoff to a **target actor** to execute work; it is **not** a substitute for that actor’s own channel artifacts after execution.
...
- No existing prompt files should be moved out of `channels/42/prompts/` without a dedicated migration batch and edge reconciliation audit.
- New governance work for the refactor is piloted under `channels/1_channel_refactor_governance/threads/channel_refactor_4_0_88/prompts/`.
...
python scripts/draft_hermes_prompt_from_artifact.py \
  --artifact channels/42/threads/1001/ARTIFACT.md --target wolfie --purpose short_slug --write
```
...
**Batch routing pattern:** External AI directive `../threads/1002/20260317_235500_externalai_hermes-routing-directive.md` → HERMES report `../threads/1002/20260318_022000_hermes_externalai-routing-batch-1001-1002.md` + grouped `02201x_hermes_prompt_*_externalai-batch.md`. Inventory: `python scripts/hermes_scan_threads.py --channel 42 --threads 1001,1002`.
...
lupopedia.headers:
  ...
  source_artifact: "channels/42/threads/1001/20260317_230500_....md"
