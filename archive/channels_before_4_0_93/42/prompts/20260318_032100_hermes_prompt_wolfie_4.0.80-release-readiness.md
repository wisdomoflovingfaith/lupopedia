...
lupopedia.headers:
  ...
  source_directive: "channels/42/threads/1001/20260318_000500_wisdomoflovingfaith_release-readiness-4.0.80.md"
---
...
- **reason:** Human directive **000500** — reconcile file-based `channels/` work with CHANGELOG/TODO/plan; close 4.0.80; define DB-first path for 4.0.81 so external systems can read state.
- **source artifacts:**
  ...
  - `docs/versions/4.0.80/PLAN.md` (and TODO if any)
  - Inventory: run `python scripts/hermes_scan_threads.py --channel 42 --threads 1001,1002`
- **extracted tasks:**
...
2. **Write** exactly one new file:
   - Path: `channels/42/threads/1001/YYYYMMDD_HHIISS_wolfie_4.0.80_release-readiness.md`
