...
**HEPHAESTUS:** Create or complete verbose table docs under `docs/database/lupopedia/tables/active/` for the four tables above per install SQL / TOON; grounded `lupopedia.edges`; match active table-doc header pattern. Post completion note to thread **1001** with file paths. Use your registered **actor_id** on the artifact (not 15).
