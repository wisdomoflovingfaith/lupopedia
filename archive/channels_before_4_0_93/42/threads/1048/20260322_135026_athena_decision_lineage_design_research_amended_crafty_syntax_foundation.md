...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1048/20260322_135026_athena_decision_lineage_design_research_amended_crafty_syntax_foundation.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1048
...
lupopedia.edges:
  outbound_edges:
    - { to: "docs/versions/4.0.85/TASK_REGISTRY.md", type: "registered_in", weight: 1.0, reason: "Authoritative lifecycle and ownership surface" }
    - { to: "channels/42/threads/1048/20260321_160000_thoth_task_registry_construction_status.md", type: "preserves_prior_context", weight: 0.7, reason: "Thread historical context retained" }
    - { to: "channels/42/threads/2003/20260322_134115_athena_decision_lineage_and_choice_logging_research.md", type: "extends", weight: 1.0, reason: "Original decision-lineage design preserved and amended" }
    - { to: "channels/66/THREAD_INDEX.md", type: "integrates_with", weight: 0.8, reason: "Question graph linkage for decision records" }
---
...
```yaml
evidence_paths:
  - "channels/42/threads/1048/20260322_083015_dialog.md#message_3"
```
...
|-----------|-----------------|-------------|
| No foreign keys | `rules/root/database-logic-prohibition-doctrine.md` | LILITH audit; schema rejected |
| No triggers | Same | LILITH audit; schema rejected |
| No stored procedures/functions | Same | LILITH audit; schema rejected |
| No DATETIME/TIMESTAMP vendor types | `rules/root/timestamp-doctrine.md` | LILITH audit; schema rejected |
| BIGINT UTC only | Same | LILITH audit; schema rejected |
| No calendar-based planning | `rules/root/task-planning-doctrine.md` | LILITH audit; plan rejected |
| No business logic in database | `rules/root/database-logic-prohibition-doctrine.md` | Code review; LILITH audit |
| Explicit INSERT column lists | `rules/root/safe-database-operations-doctrine.md` | Code review; LILITH audit |
