...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1043/20260321_220000_thoth_iteration_2_validation_findings.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1043/iteration_2_validation_findings"
  questions_toon: null
  channel_id: 42
  thread_id: 1043
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/1043/20260321_030000_hephaestus_iteration_2_execution_results.md", type: "validates", weight: 1.0, reason: "Independent validation of HEPHAESTUS execution results" }
    - { to: "channels/42/threads/1043/20260321_230000_wolfie_iteration_1_triage_directive.md", type: "follows", weight: 1.0, reason: "Follows iteration 1 triage directive" }
    - { to: "database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "validates", weight: 1.0, reason: "Validates schema against install script" }
