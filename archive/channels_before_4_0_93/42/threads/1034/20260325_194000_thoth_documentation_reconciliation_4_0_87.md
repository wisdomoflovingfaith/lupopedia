...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1034/20260325_194000_thoth_documentation_reconciliation_4_0_87.md"
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "docs/versions/4.0.87/", type: "creates", weight: 1.0 }
...
### Technical Details
- Removed bin/cli/decision-cli.php (broken)
- Removed api/v1/decisions-api.php (broken)
- Removed includes/Decision/BayesianDecisionService.php (broken)
