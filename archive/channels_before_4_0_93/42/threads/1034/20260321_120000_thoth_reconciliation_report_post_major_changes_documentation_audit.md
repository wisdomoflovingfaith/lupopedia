...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1034/20260321_120000_thoth_reconciliation_report_post_major_changes_documentation_audit.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1034/report"
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "docs/doctrine/LUPOPEDIA_HEADERS/README.md", type: "references", weight: 0.95, reason: "Doctrine describing headers as passive metadata — contradicts new README" }
    - { to: "docs/doctrine/HEADER_DB_REVERSIBILITY_DOCTRINE.md", type: "references", weight: 0.95, reason: "New doctrine describing headers as active execution layer" }
    - { to: "docs/doctrine/CHANNEL_66_QUESTION_GRAPH_DOCTRINE.md", type: "references", weight: 0.9, reason: "Verified Channel 66 references are consistent" }
    ...
    - { to: "channels/42/threads/1030", type: "references", weight: 0.9, reason: "Prior Phase 2 table doc reconciliation" }
    - { to: "channels/42/threads/1032", type: "references", weight: 0.95, reason: "Canonical project model + schema authority" }
    - { to: "channels/42/threads/1033", type: "references", weight: 0.95, reason: "Session continuation + operational reality analysis" }
...
**OLD DOCTRINE** (docs/doctrine/LUPOPEDIA_HEADERS/README.md, line 176):
```
...
### Finding
**`docs/versions/4.0.84/PLAN.md` and root `plan.md` reference each other but may have drifted.**

### Evidence
- `docs/versions/4.0.84/PLAN.md` exists (verified)
...
Add edges between:
- Root `plan.md` → `docs/versions/4.0.84/PLAN.md` (type: `refines` or `details`)
...
1. **Resolve LUPOPEDIA HEADERS paradigm** (recommendation: update old doctrine)
   - **File:** `docs/doctrine/LUPOPEDIA_HEADERS/README.md`
...
5. **Clarify version-specific documentation relationship**
   - **Files:** `plan.md`, `docs/versions/4.0.84/PLAN.md`
