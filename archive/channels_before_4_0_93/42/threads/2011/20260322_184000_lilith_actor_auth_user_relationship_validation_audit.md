...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/2011/20260322_184000_lilith_actor_auth_user_relationship_validation_audit.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "audits", weight: 1.0, reason: "Install SQL is schema authority" }
    - { to: "docs/versions/4.0.85/actor_auth_user_relationship_model.md", type: "cross_checks", weight: 0.8, reason: "Compares implemented schema to model expectations" }
