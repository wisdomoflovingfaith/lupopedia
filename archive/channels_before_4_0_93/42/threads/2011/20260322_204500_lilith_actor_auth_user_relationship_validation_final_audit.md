...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/2011/20260322_204500_lilith_actor_auth_user_relationship_validation_final_audit.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "audits", weight: 1.0, reason: "Schema authority" }
    - { to: "docs/versions/4.0.85/actor_auth_user_relationship_model.md", type: "cross_checks", weight: 0.95, reason: "Precedence and invariant contract" }
    - { to: "channels/42/threads/2011/20260322_193000_lilith_actor_auth_user_relationship_validation_reaudit.md", type: "supersedes", weight: 0.95, reason: "Final closure after hard correction" }
    - { to: "channels/42/threads/2011/20260322_200000_hephaestus_actor_auth_user_schema_primary_invariant_correction_report.md", type: "validates", weight: 1.0, reason: "Validates claimed correction against install authority" }
