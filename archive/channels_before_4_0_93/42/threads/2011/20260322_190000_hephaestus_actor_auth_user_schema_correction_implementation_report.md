...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/2011/20260322_190000_hephaestus_actor_auth_user_schema_correction_implementation_report.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "implements", weight: 1.0, reason: "Install SQL corrections applied" }
    - { to: "docs/versions/4.0.85/actor_auth_user_relationship_model.md", type: "updates", weight: 0.9, reason: "Precedence and enforcement documentation updated" }
    - { to: "channels/42/threads/2011/20260322_184000_lilith_actor_auth_user_relationship_validation_audit.md", type: "addresses", weight: 1.0, reason: "Corrective action response" }
...
Install SQL updated in `database/lupopedia/mysql/install/install_new_lupopedia.sql` with:
...
Documentation updated in `docs/versions/4.0.85/actor_auth_user_relationship_model.md`:
