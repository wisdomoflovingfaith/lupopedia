...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1046/20260321_175500_wolfie_directive_bmad_federation_model.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1046/20260321_175500_wolfie_directive_bmad_federation_model.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1046
...
lupopedia.edges:
  outbound_edges:
    - { to: "docs/doctrine/FEDERATION_NODE_TYPES_DOCTRINE.md", type: "governed_by", weight: 1.0, reason: "Node type selection must follow canonical federation doctrine." }
    - { to: "docs/doctrine/FEDERATION_SCOPING_DOCTRINE.md", type: "governed_by", weight: 1.0, reason: "Federation node scoping rules determine how BMAD content is partitioned from Lupopedia core." }
    - { to: "docs/doctrine/PROJECT_REGISTRY_DOCTRINE.md", type: "constrained_by", weight: 1.0, reason: "Project promotion rules determine whether BMAD receives an internal project_id." }
    - { to: "database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "future_updates", weight: 0.9, reason: "Any future schema or seed work for node 3 must respect this directive." }
...
execution_plan:
  ...
  tasks:
    ...
    - "Create node-3 filesystem mirror root at database/files/3/bmad-method/."
...
2. **Filesystem mirror**  
Establish `database/files/3/bmad-method/` as the provenance-preserving mirror root for BMAD snapshots.
