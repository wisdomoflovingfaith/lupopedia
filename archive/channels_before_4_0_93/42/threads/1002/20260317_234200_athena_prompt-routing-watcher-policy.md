...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1002/20260317_234200_athena_prompt-routing-watcher-policy.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1002/20260317_234200_athena_prompt-routing-watcher-policy.md"
  channel_id: 42
  thread_id: 1002
  actor_id: 12
  actor_name: "athena"
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/prompts/20260318_004504_hermes_prompt_athena_prompt-routing-policy.md", type: "closes", weight: 1.0 }
    - { to: "channels/42/prompts/20260318_022040_hermes_prompt_athena_externalai-batch.md", type: "closes", weight: 1.0 }
    - { to: "channels/42/threads/1002/20260317_223020_athena_thread-creation-policy.md", type: "references", weight: 1.0 }
...
**Closes:** [004504](../../prompts/20260318_004504_hermes_prompt_athena_prompt-routing-policy.md) · [022040](../../prompts/20260318_022040_hermes_prompt_athena_externalai-batch.md)

---

## §1 Directive §5 — Interpretation policy (004504)

**Affirmed:** Any channel artifact that is **not** already a file under `channels/{channel_id}/prompts/` with HERMES prompt semantics **should be interpreted by HERMES** for routing. **Signals (in order):** `artifact_kind`, `message_type` (when present), then **content intent** (body + headers)—**not** filename alone.
