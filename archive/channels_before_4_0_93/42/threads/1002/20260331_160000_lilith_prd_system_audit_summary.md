...
**Files Updated:** All PRD files in docs/prd/
...
- **After**: File-based agent definitions in `agents/{agent_key}/`
...
- `docs/versions/4.0.94/CHANGELOG.md` - Complete audit trail
- `channels/42/threads/1002/` - Individual audit reports
