...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1002/20260318_003000_hermes_actor-identity-violation.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1002/20260318_003000_hermes_actor-identity-violation.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1002
...
# file: HERMES actor-identity violation — thread 1002 — web_path: channels/42/threads/1002/20260318_003000_hermes_actor-identity-violation

## 1. What happened

An IDE agent operating in the **HERMES** routing role edited or authored channel content for  
`channels/42/threads/1001/20260317_184500_wolfie_table-doc-ground-truth-repair.md` while that file’s **LUPOPEDIA HEADERS** carried **`actor_id: 1`** and **`actor_name: wolfie`**. The executing agent was not WOLFIE; attributing the edit to WOLFIE is **misattribution / impersonation**.
...
| For WOLFIE-owned work: emit a **prompt** (below) or place handoff under **`channels/42/direct/1/`** for WOLFIE to execute | Execute orchestrator directives or re-attribute edits to WOLFIE |
