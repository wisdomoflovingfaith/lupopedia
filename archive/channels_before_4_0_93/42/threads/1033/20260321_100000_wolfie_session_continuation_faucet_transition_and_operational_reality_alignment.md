...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1033/20260321_100000_wolfie_session_continuation_faucet_transition_and_operational_reality_alignment.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1033/20260321_100000_wolfie_session_continuation_faucet_transition_and_operational_reality_alignment.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1033
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "channels/42/threads/1030/20260320_175000_thoth_table_reconciliation_report_visibility_critical_db_documentation_authority_check_phase_2_gate.md", type: "extends", weight: 0.9, reason: "Continuation of visibility reconciliation work" }
    - { to: "channels/42/threads/1032/20260321_090000_wolfie_directive_canonical_project_model_schema_authority_and_migration_contract_4_0_84.md", type: "extends", weight: 0.9, reason: "Continuation of schema authority system definition" }
    - { to: "scripts/generate_headers_from_db.py", type: "requires_completion", weight: 0.95, reason: "Script is incomplete; must be finalized for header↔DB reversibility" }
    - { to: "docs/doctrine/CHANNEL_66_QUESTION_GRAPH_DOCTRINE.md", type: "requires_creation", weight: 0.9, reason: "Must formalize Channel 66 as canonical semantic system" }
lupopedia.footer:
...
- **Filesystem-first coordination** — file artifacts in `channels/` are the primary execution surface for multi-agent coordination
...
- Resolution flow: question → investigation → doctrine artifact in `docs/doctrine/`
...
**Discovery:** Version-specific docs should live in `docs/versions/4.0.84/` but **this directory does not yet exist.**

Prior WOLFIE analysis indicated version-scoped docs should include:
- `docs/versions/4.0.84/PLAN.md` — granular 4.0.84-specific execution plan
- `docs/versions/4.0.84/OVERVIEW_ORGANIZATION.md` — schema/classes/level breakdowns
...
**Status:** 🔄 IN PROGRESS  
**Location:** [scripts/generate_headers_from_db.py](../../../../scripts/generate_headers_from_db.py)  
...
**File:** `docs/doctrine/CHANNEL_66_QUESTION_GRAPH_DOCTRINE.md`
...
**File:** `docs/doctrine/HEADER_DB_REVERSIBILITY_DOCTRINE.md`
...
**File:** `docs/doctrine/SEMANTIC_INTEGRITY_DOCTRINE.md`
...
**Action 2.1:** Create [CHANNEL_66_QUESTION_GRAPH_DOCTRINE.md](../../../../docs/doctrine/CHANNEL_66_QUESTION_GRAPH_DOCTRINE.md)

**Action 2.2:** Create [HEADER_DB_REVERSIBILITY_DOCTRINE.md](../../../../docs/doctrine/HEADER_DB_REVERSIBILITY_DOCTRINE.md)

### Priority 3: Implementation Gaps

**Action 3.1:** Complete [generate_headers_from_db.py](../../../../scripts/generate_headers_from_db.py)
...
**Action 4.1:** Create [docs/versions/4.0.84/](../../../../docs/versions/4.0.84) directory
