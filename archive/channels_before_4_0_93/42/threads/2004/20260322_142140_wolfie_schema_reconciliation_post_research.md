...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/2004/20260322_142140_wolfie_schema_reconciliation_post_research.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/2004/20260322_142140_wolfie_schema_reconciliation_post_research.md"
  questions_toon: null
  channel_id: 42
  thread_id: 2004
...
lupopedia.edges:
  outbound_edges:
    - { to: "database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "authoritative_schema_source", weight: 1.0, reason: "Canonical schema authority" }
    - { to: "database/lupopedia/toon/", type: "derived_schema_projection", weight: 1.0, reason: "Derived table projections must match active install tables" }
    - { to: "docs/versions/4.0.85/federation/doom_emacs_research.md", type: "research_input", weight: 0.95, reason: "Canonical Doom federation research publication with deferred candidates" }
    - { to: "channels/42/threads/2004/20260322_140715_thoth_doom_emacs_schema_reconciliation_and_blocker_check.md", type: "prior_reconciliation", weight: 0.95, reason: "Baseline pre-rerun reconciliation and blocker map" }
---
