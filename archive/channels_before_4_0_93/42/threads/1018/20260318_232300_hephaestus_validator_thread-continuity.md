...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1018/20260318_232300_hephaestus_validator_thread-continuity.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1018/20260318_232300_hephaestus_validator_thread-continuity.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1018
  actor_id: 14
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/1017/20260318_230000_wolfie_consistency_thread1006_reconciliation.md", type: references, weight: 1.0, reason: "WOLFIE reconciliation context" }
...
| Component | Location |
|-----------|----------|
| Engine | `scripts/validate_threads.py` |
| CLI | `python scripts/validate_threads.py --repo-root . --channel 42 [--threads 1006,...]` |
| Integration | `python scripts/validate_channel_artifacts.py --repo-root . --channel 42 --thread-validation` (runs channel scan then thread validator) |
