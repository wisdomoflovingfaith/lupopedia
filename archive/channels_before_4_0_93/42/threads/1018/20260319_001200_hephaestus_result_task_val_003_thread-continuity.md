...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1018/20260319_001200_hephaestus_result_task_val_003_thread-continuity.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1018/20260319_001200_hephaestus_result_task_val_003_thread-continuity.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1018
...
| Path | Change |
|------|--------|
| `scripts/validate_threads.py` | LILITH precision: review OR predicate; V-THREAD-005 fixed regex + body-only + edge path rules; V-THREAD-001 endpoint wording; INFO skip line; explicit `--threads` forces full lifecycle check |
| `channels/42/threads/1018/20260319_000500_hephaestus_impl_task_val_003_thread-continuity.md` | Implementation decisions |
