...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/2003/20260322_134115_athena_decision_lineage_and_choice_logging_research.md"
  questions_toon: null
  channel_id: 42
  thread_id: 2003
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "docs/versions/4.0.85/federation/bmad_research.md", type: "informed_by", weight: 0.9, reason: "Workflow and orchestration pattern mapping" }
    - { to: "channels/42/threads/1050/20260322_131757_thoth_bmad_method_workflow_research.md", type: "informed_by", weight: 0.9, reason: "Channel 42 BMAD research context" }
    - { to: "channels/66/THREAD_INDEX.md", type: "integrates_with", weight: 0.8, reason: "Question graph and answer lineage needs" }
    - { to: "channels/42/threads/2003/20260322_134115_athena_task_start_decision_lineage_and_choice_logging_research.md", type: "execution_context", weight: 1.0, reason: "Thread-local execution start state" }
---
...
lupopedia.decision_record:
  ...
  evidence_paths:
    ...
    - "channels/42/threads/1050/20260322_131757_thoth_bmad_method_workflow_research.md"
