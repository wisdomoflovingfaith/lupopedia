---
lupopedia.headers:
  file_path_from_root: "channels/42/threads/1051/STALE_DOCUMENTATION_ANALYSIS_REPORT.md"
  ...
  web_path: "http://www.lupopedia.com/channels/42/threads/1051/STALE_DOCUMENTATION_ANALYSIS_REPORT.md"
...
lupopedia.edges:
  outbound_edges:
    ...
    - to: "scripts/update_stale_headers.py"
      type: "references"
      weight: 0.95
...
lupopedia.footer:
  ...
  next_action: "Execute scripts/update_stale_headers.py to batch update all files"
---
...
**Scope**: 43 files across `docs/doctrine/` tree  
...
- [ ] Run `scripts/update_stale_headers.py`
...
```yaml
lupopedia.headers:
  file_path_from_root: "docs/doctrine/LUPOPEDIA_DOCTRINE.md"
...
1. ✅ **Archive legacy files** → 64 files moved to `archive/`
...
✅ All 43+ files in `docs/doctrine/` have `last_verified` date of 20260325 or later  
