...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1038/20260321_011500_hephaestus_post_patch_reality_report.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1038/post_patch_reality_report"
  questions_toon: null
  channel_id: 42
  thread_id: 1038
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/1038/20260321_011000_hephaestus_post_patch_implementation_update.md", type: "pairs_with", weight: 1.0, reason: "Companion status update artifact" }
    - { to: "channels/42/threads/1038/20260321_235000_hephaestus_implementation_reality_report.md", type: "supersedes", weight: 0.95, reason: "Post-patch reality checkpoint" }
    - { to: "channels/42/threads/1032/20260321_090000_wolfie_directive_canonical_project_model_schema_authority_and_migration_contract_4_0_84.md", type: "depends_on", weight: 1.0, reason: "Canonical migration ordering and schema authority" }
...
1. Governance-aware service logic exists and loads from includes/HumanRequestService.php.
2. Human inbox route/API entrypoint exists at routes/human_requests.php and is wired by module loader slug routing.
3. Inbox UI exists at views/visibility/human_inbox.php.
4. Thread detail view includes dynamic request summary integration in views/visibility/thread_detail.php.
5. Canonical schema includes lupo_human_requests governance fields in database/lupopedia/mysql/install/install_new_lupopedia.sql.
6. Development migration exists at database/lupopedia/mysql/migrations/dev_20260321_thread1038_human_request_governance.sql.

### Removed/cleaned

1. database/lupopedia/mysql/migrations/004_human_requests.sql no longer exists.
...
- includes/HumanRequestService.php: no errors found
- routes/human_requests.php: no errors found
- views/visibility/human_inbox.php: no errors found
- views/visibility/thread_detail.php: no errors found
