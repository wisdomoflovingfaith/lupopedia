...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1038/20260321_220000_hephaestus_human_targeted_thread_requests_implementation.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1038/human_targeted_requests"
  questions_toon: null
  channel_id: 42
  thread_id: 1038
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/1038/20260321_210000_thoth_corrected_human_verification_architecture.md", type: "implements", weight: 1.0, reason: "Builds on THOTH corrected architecture" }
    - { to: "database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "extends", weight: 0.95, reason: "Adds human request tables to core schema" }
    - { to: "views/visibility/", type: "extends", weight: 0.9, reason: "Adds human requests to visibility interface" }
    - { to: "rules/root/CHANNEL_ARTIFACT_ROUTING_DOCTRINE.md", type: "complies_with", weight: 0.9, reason: "Uses deterministic thread routing" }
...
```php
<?php
// views/visibility/thread_detail.php (Extended)
...
include 'views/visibility/header.php';
?>
...
<?php include 'views/visibility/footer.php'; ?>
```
...
-- File: database/lupopedia/mysql/migrations/004_human_requests.sql
