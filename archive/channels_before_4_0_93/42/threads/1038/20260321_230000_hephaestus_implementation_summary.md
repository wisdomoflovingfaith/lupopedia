...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1038/20260321_230000_hephaestus_implementation_summary.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1038/implementation_summary"
  questions_toon: null
  channel_id: 42
  thread_id: 1038
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/1038/20260321_220000_hephaestus_human_targeted_thread_requests_implementation.md", type: "summarizes", weight: 1.0, reason: "Implementation artifact" }
    - { to: "channels/42/threads/1038/20260321_210000_thoth_corrected_human_verification_architecture.md", type: "implements", weight: 0.95, reason: "Based on THOTH architecture" }
    - { to: "database/lupopedia/mysql/migrations/004_human_requests.sql", type: "delivers", weight: 0.9, reason: "Database migration" }
...
**File:** `channels/42/threads/1038/20260321_220000_hephaestus_human_targeted_thread_requests_implementation.md`
...
**File:** `includes/HumanRequestService.php`
...
### 4. API Routes ✅
**File:** `routes/human_requests.php`
...
### 5. Web Interface ✅
**File:** `views/visibility/human_inbox.php`
