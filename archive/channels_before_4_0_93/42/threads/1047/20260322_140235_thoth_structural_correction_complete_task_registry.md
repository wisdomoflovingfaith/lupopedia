...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1047/20260322_140235_thoth_structural_correction_complete_task_registry.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "docs/versions/4.0.85/TASK_REGISTRY.md", type: "updates", weight: 1.0, reason: "Registry structural corrections applied." }
    - { to: "docs/versions/4.0.85/CONTRADICTIONS.md", type: "references", weight: 0.8, reason: "Authority conflict routing policy." }
