...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1025/20260318_175542_cursor_review_task_doc_continuity_update_001_channel-system-continuity-alignment.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1025/20260318_175542_cursor_review_task_doc_continuity_update_001_channel-system-continuity-alignment.md"
  questions_toon: null
...
lupopedia.edges:
  outbound_edges:
    - { to: "docs/doctrine/IDE_AGENT_CONTINUITY_PROTOCOL.md", type: "updates", weight: 1.0, reason: "Continuity checkpoint requirement moved from docs/status to channel checkpoint artifacts" }
    - { to: "ONBOARDING.md", type: "updates", weight: 1.0, reason: "Onboarding guidance now points handoff/continuity at channels threads/tasks" }
    - { to: "docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md", type: "references", weight: 0.8, reason: "Channel-based coordination is authoritative for continuity + routing" }
...
lupopedia.footer:
  ...
  next_action:
    ...
    - "If approved, we can treat remaining docs/status references as archival/legacy only (optional follow-up cleanup)."
---
