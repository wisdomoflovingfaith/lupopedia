...
lupopedia.headers:
	...
	file_path_from_root: "channels/42/threads/2016/20260322_184651_hephaestus_version_4_0_85_final_documentation.md"
...
- updated scope: `docs/versions/4.0.85/*`, root `README.md`, root `CHANGELOG.md`, root `TODO.md`, root `plan.md`
...
- `docs/versions/4.0.85/TASK_BREAKDOWN.md`
...
`See docs/versions/4.0.85/ for structured changes.`
