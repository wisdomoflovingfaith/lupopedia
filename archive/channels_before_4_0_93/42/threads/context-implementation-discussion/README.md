...
lupopedia.headers:
  ...
  file_path_from_root: channels/42/threads/context-implementation-discussion/README.md
  web_path: http://www.lupopedia.com/lupopedia/channels/42/threads/context-implementation-discussion/README.md
  questions_toon: null
...
- **Filesystem:** Markdown files in `context/` folder with LUPOPEDIA HEADERS
...
### Main Context File (`context/[context-name]/README.md`)

```yaml
---
lupopedia.headers:
  lupopedia.schema: context
  file_path_from_root: context/database-doctrine/README.md
  web_path: http://www.lupopedia.com/lupopedia/context/database-doctrine/README.md
...
lupopedia.edges:
  outbound_edges:
    - to: context/database-doctrine/questions/001-what-is-content-id.md
      type: contains_question
      weight: 1.0
      reason: "Question about content_id generation"
    - to: context/database-doctrine/questions/002-how-to-import.md
      type: contains_question
      weight: 1.0
      reason: "Question about import process"
    - to: rules/root/DATABASE_DOCTRINE.md
      type: documents
      weight: 1.0
...
### Question File (`context/[context-name]/questions/001-what-is-content-id.md`)

```yaml
---
lupopedia.headers:
  lupopedia.schema: context_question
  file_path_from_root: context/database-doctrine/questions/001-what-is-content-id.md
  content_id: 202603291200001235
  parent_context: context/database-doctrine/README.md
  question_id: 1
...
lupopedia.edges:
  outbound_edges:
    - to: context/database-doctrine/answers/001-content-id-timestamp.md
      type: has_answer
      weight: 1.0
    ...
    - to: channels/42/threads/headers-doctrine/README.md
      type: derived_from
      weight: 0.8
