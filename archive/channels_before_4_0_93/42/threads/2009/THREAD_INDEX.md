...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/2009/THREAD_INDEX.md"
  questions_toon: null
  channel_id: 42
  thread_id: 2009
  actor_id: 8
...
Implement `scripts/import_filesystem_channels_to_db.py` — a deterministic post-install importer  
...
- `scripts/import_filesystem_channels_to_db.py` — canonical import entrypoint
- `docs/versions/4.0.85/import_filesystem_channels_docs.md` — usage documentation
