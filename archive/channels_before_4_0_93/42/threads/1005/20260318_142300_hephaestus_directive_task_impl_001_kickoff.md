...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1005/20260318_142300_hephaestus_directive_task_impl_001_kickoff.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1005/20260318_142300_hephaestus_directive_task_impl_001_kickoff.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1005
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/1004/20260318_150000_wolfie_directive_task_plan_001_review.md", type: "implements", weight: 1.0, reason: "Acceptance + implementation authorization for task_impl_001" }
    - { to: "channels/42/threads/1004/20260318_141356_athena_spec_todo_registry.md", type: "implements", weight: 1.0, reason: "Binding TODO.md Global Task Registry spec (Option A)" }
    - { to: "channels/42/threads/1004/20260318_141456_athena_spec_plan_roadmap.md", type: "implements", weight: 1.0, reason: "Binding plan.md Strategic Roadmap spec (Option A)" }
    - { to: "channels/42/threads/1004/20260318_141109_athena_strategy_task_plan_001_kickoff.md", type: "references", weight: 0.8 }
    - { to: "channels/42/threads/1001/20260318_110000_wolfie_directive_thread001-triage.md", type: "constrained_by", weight: 1.0, reason: "task_id vs thread_id separation (do not conflate)" }
    - { to: "channels/42/threads/1001/20260318_135527_athena_strategy_thread-lifecycle.md", type: "aligns_with", weight: 0.8, reason: "Lifecycle state set (open/active/blocked/resolved/archived)" }
    ...
    - { to: "docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md", type: "aligns_with", weight: 0.6 }
    - { to: "rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md", type: "aligns_with", weight: 0.8 }
    - { to: "rules/root/LUPOPEDIA_CONSTITUTIONAL_ROOT_RULES.md", type: "aligns_with", weight: 1.0 }
    - { to: "database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "references", weight: 0.7, reason: "Ground DB column names since expected TOON set is absent in workspace" }
lupopedia.footer:
  version: "4.0.81"
...
You asked to verify TOON column names to avoid conflicts. In this workspace, the expected TOON set under `database/lupopedia/toon/` is **not present** (no matches found). I will therefore ground naming against the canonical install SQL instead:
