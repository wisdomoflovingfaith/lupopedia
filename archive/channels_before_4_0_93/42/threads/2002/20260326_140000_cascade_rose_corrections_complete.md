...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/2002/20260326_140000_cascade_rose_corrections_complete.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/2002/20260326_120000_cascade_initial_rose_correction.md", type: "responds_to", weight: 1.0 }
    - { to: "docs/versions/4.0.88/SEMANTIC_ARCHITECTURE.md", type: "updated", weight: 1.0 }
    - { to: "channels/42/directives/20260326_rose_correction_final_v2.md", type: "completed", weight: 1.0 }
...
### Directive Created
- **Location**: `channels/42/directives/20260326_rose_correction_final_v2.md`
