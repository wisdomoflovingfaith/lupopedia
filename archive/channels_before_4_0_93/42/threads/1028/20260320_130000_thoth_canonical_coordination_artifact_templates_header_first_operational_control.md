...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1028/20260320_130000_thoth_canonical_coordination_artifact_templates_header_first_operational_control.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1028/20260320_130000_thoth_canonical_coordination_artifact_templates_header_first_operational_control.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1028
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/1028/20260320_120000_athena_strategy_file_visible_coordination_recovery.md", type: "implements", weight: 1.0, reason: "Template pack operationalizes ATHENA coordination strategy" }
    - { to: "docs/doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_FORMAT.md", type: "constrained_by", weight: 1.0, reason: "Canonical minimum header doctrine and block rules" }
    - { to: "docs/doctrine/LUPOPEDIA_HEADERS/README.md", type: "aligns_with", weight: 1.0, reason: "LUPOPEDIA HEADERS usage and optional block doctrine" }
    - { to: "rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md", type: "constrained_by", weight: 1.0, reason: "Actor-role coordination and channel discipline" }
    - { to: "channels/42/THREAD_INDEX.md", type: "updates", weight: 0.8, reason: "Template set includes canonical thread index entry format" }
...
1. channels/42/threads/1028/20260320_120000_athena_strategy_file_visible_coordination_recovery.md
2. docs/doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_FORMAT.md
3. docs/doctrine/LUPOPEDIA_HEADERS/README.md
4. rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "channels/42/THREAD_INDEX.md", type: "updates", weight: 0.9, reason: "thread status sync" }
lupopedia.footer:
  last_verified: "20260320"
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md", type: "constrained_by", weight: 1.0, reason: "evaluation baseline" }
lupopedia.footer:
  last_verified: "20260320"
...
lupopedia.headers:
  version_when_written: "4.0.84"
  file_path_from_root: "channels/66/threads/..."
  channel_id: 66
  thread_id: 6601
...
- task_id: task_strategy_coordination_repair_001
  thread_id: 1028
  artifact_path: channels/42/threads/1028/20260320_130000_thoth_canonical_coordination_artifact_templates_header_first_operational_control.md
