...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1039/20260321_115034_wolfie_release_execution_and_rollover.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1039/release_execution"
  questions_toon: null
  channel_id: 42
  thread_id: 1039
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "docs/versions/4.0.84/CHANGELOG.md", type: "freezes", weight: 0.95, reason: "Version 4.0.84 release scope frozen." }
    - { to: "docs/versions/4.0.85/PLAN.md", type: "opens", weight: 0.95, reason: "Version 4.0.85 active work surface created." }
    - { to: "channels/42/threads/1038/20260321_011500_hephaestus_post_patch_reality_report.md", type: "references", weight: 0.95, reason: "Thread 1038 repository state assessed before defer decision." }
...
3. `database/lupopedia/mysql/migrations/004_human_requests.sql` was not a valid committed release anchor during audit and must not be treated as shipped 4.0.84 scope.
4. Version sources were inconsistent before rollover: `config/global_atoms.yaml` and `LUPEDIA_VERSION` showed `4.0.84`, while `config/config/global_atoms.yaml` still showed `4.0.83`.
...
1. `LUPEDIA_VERSION`
2. `config/global_atoms.yaml`
3. `config/config/global_atoms.yaml`
