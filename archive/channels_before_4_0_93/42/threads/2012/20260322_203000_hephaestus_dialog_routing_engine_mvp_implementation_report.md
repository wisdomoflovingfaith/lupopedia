...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/2012/20260322_203000_hephaestus_dialog_routing_engine_mvp_implementation_report.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "updates", weight: 1.0, reason: "Adds routing decision storage table" }
    - { to: "includes/HumanRequestService.php", type: "updates", weight: 1.0, reason: "Implements deterministic routing selection and decision persistence" }
    - { to: "routes/human_requests.php", type: "updates", weight: 0.95, reason: "Adds route API action for MVP routing execution" }
    - { to: "docs/versions/4.0.85/dialog_routing_design.md", type: "implements", weight: 0.95, reason: "Implements corrected READY_FOR_IMPLEMENTATION routing design" }
...
Implemented in `includes/HumanRequestService.php` via:
