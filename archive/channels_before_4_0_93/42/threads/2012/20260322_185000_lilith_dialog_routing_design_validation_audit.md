...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/2012/20260322_185000_lilith_dialog_routing_design_validation_audit.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "docs/versions/4.0.85/dialog_routing_design.md", type: "audits", weight: 1.0, reason: "Primary design artifact under audit" }
    - { to: "database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "cross_checks", weight: 0.9, reason: "Verifies implementability against current schema surfaces" }
