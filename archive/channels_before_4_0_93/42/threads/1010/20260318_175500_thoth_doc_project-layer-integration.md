...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1010/20260318_175500_thoth_doc_project-layer-integration.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1010/20260318_175500_thoth_doc_project-layer-integration.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1010
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/1009/20260318_144653_athena_strategy_project-layer-model.md", type: "implements", weight: 1.0, reason: "ATHENA's PROJECT layer architecture" }
    - { to: "README.md", type: "updates", weight: 1.0, reason: "Primary documentation to integrate PROJECT layer" }
    - { to: "channels/42/threads/1001/20260318_110000_wolfie_directive_thread001-triage.md", type: "aligns_with", weight: 0.8, reason: "THREAD001 doctrine consistency" }
lupopedia.footer:
  version: "4.0.81"
...
2. **Channel Inference**: `channels/{channel_id}/` = channel exists
...
Path: `channels/42/threads/1003/20260318_170000_thoth_directive_task_doc_001_kickoff.md`
...
lupopedia.edges:
  outbound_edges:
    - { 
        to: "project-1:channels/42/threads/1003/artifact.md",
        type: "references",
        project_id: 1
      }
```
