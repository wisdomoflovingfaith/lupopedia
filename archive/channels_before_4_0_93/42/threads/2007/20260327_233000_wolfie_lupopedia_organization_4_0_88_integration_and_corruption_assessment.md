...
lupopedia.headers:
  ...
  file_path_from_root: channels/42/threads/2007/20260327_233000_wolfie_lupopedia_organization_4_0_88_integration_and_corruption_assessment.md
  questions_toon: null
  channel_id: 42
  thread_id: 2007
  actor_id: 1
...
- full root and * directory review
...
1. * directory roles are explicitly classified (canonical, operational, generated, coordination, legacy, transitional).
2. MySQL authority is centered on database/lupopedia/mysql/install/install_new_lupopedia.sql.
3. TOON and JSON artifacts are derived snapshots, not primary schema authority.
4. File-based coordination is active and operational (channels, database/sessions, sessions).
...
- stale directory doctrine still describes pre-* path model
...
1. database/lupopedia/mysql/manifest lacks explanatory README.
2. database/lupopedia/postgres is empty and undocumented.
3. context exists but top subdirs are currently empty/incomplete.
...
- docs/database/lupopedia/tables/active/lupo_actor_events.md
- docs/database/lupopedia/tables/active/lupo_actor_handshakes.md
- docs/database/lupopedia/tables/active/lupo_edges.md
- docs/database/lupopedia/tables/active/lupo_decisions.md
- docs/database/lupopedia/tables/active/lupo_decision_evidence.md
- docs/database/lupopedia/tables/active/lupo_departments.md
- docs/database/lupopedia/tables/active/lupo_projects.md
- docs/database/lupopedia/tables/active/lupo_metadata.md
- docs/database/lupopedia/tables/active/lupo_dialog_channels.md
- docs/database/lupopedia/tables/active/lupo_dialog_threads.md
- docs/database/lupopedia/tables/active/lupo_api_tokens.md
...
- context exists as a structural surface but remains incomplete/not implemented as a mature operational subsystem
