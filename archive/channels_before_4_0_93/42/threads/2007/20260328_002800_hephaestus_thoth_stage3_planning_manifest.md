...
lupopedia.headers:
  ...
  file_path_from_root: channels/42/threads/2007/20260328_002800_hephaestus_thoth_stage3_planning_manifest.md
...
lupopedia.edges:
  ...
  - to: channels/42/threads/2007/20260328_002500_thoth_stage2_metadata_restoration_report.md
    type: follows
    weight: 0.9
    reason: Stage 3 planning starts after Stage 2 completion
  - to: channels/42/threads/2007/20260328_001500_hephaestus_thoth_stage1_completion_report.md
    type: references
    weight: 0.9
...
Deliverable:
- `channels/42/threads/2007/20260328_004100_hephaestus_stage3_full_drift_manifest.md`

Method:
1. Enumerate changed/deleted paths in `docs/database/lupopedia/tables/active/`.
...
Deliverable:
- `channels/42/threads/2007/20260328_004000_thoth_stage3_drift_classification.md`
...
Deliverable:
- `docs/reports/STAGE3_NORMALIZATION_PLAN_20260328.md`
