...
lupopedia.headers:
  ...
  file_path_from_root: channels/42/threads/2007/20260328_000500_hephaestus_thoth_stage1_edge_confidence_matrix_report.md
...
lupopedia.edges:
  ...
  - to: docs/database/lupopedia/tables/active/lupo_actor_departments.md
    type: updates
    weight: 1.0
    reason: Placeholder edges replaced with reconstructed confidence-scored set
  - to: docs/database/lupopedia/tables/active/lupo_crafty_user_mapping.md
    type: updates
    weight: 1.0
    reason: Placeholder edges replaced with reconstructed confidence-scored set
...
| lupo_actor_departments | database/lupopedia/mysql/install/install_new_lupopedia.sql | schema_reference | git-restored | 1.0 | canonical install schema anchor |
| lupo_actor_departments | database/lupopedia/content/app/Services/SavedCollectionsService.php | USED_IN_PHP | code-scan | 0.7 | direct table usage pattern |
| lupo_actor_departments | database/lupopedia/content/app/auth/AuthRoleResolver.php | USED_IN_PHP | code-scan | 0.7 | role/department resolver usage |
| lupo_actor_departments | scripts/rebuild_schema_from_toons.py | USED_IN_PYTHON | code-scan | 0.7 | table referenced in rebuild script |
| lupo_actor_departments | scripts/wolfie_orms.py | USED_IN_PYTHON | code-scan | 0.7 | table select helper present |
| lupo_actor_departments | database/lupopedia/json/lupo_actor_departments.json | references | schema-source | 1.0 | TOON JSON source anchor |
| lupo_crafty_user_mapping | database/lupopedia/mysql/install/install_new_lupopedia.sql | schema_reference | schema-source | 1.0 | canonical install schema anchor |
| lupo_crafty_user_mapping | database/lupopedia/content/app/auth/AuthManager.php | USED_IN_PHP | code-scan | 0.7 | auth mapping reference |
| lupo_crafty_user_mapping | database/lupopedia/content/app/Http/Controllers/Admin/AuthenticationController.php | USED_IN_PHP | code-scan | 0.7 | admin auth controller reference |
| lupo_crafty_user_mapping | scripts/generate_install_sql.py | USED_IN_PYTHON | code-scan | 0.7 | table included in SQL generation list |
| lupo_crafty_user_mapping | database/lupopedia/json/lupo_crafty_user_mapping.json | references | schema-source | 1.0 | TOON JSON source anchor |
