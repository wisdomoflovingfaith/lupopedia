...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1029/20260320_161500_wolfie_clarification_directive_phase_1_thread_index_visibility_boundaries_thread_hierarchy.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1029/20260320_161500_wolfie_clarification_directive_phase_1_thread_index_visibility_boundaries_thread_hierarchy.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1029
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/THREAD_INDEX.md", type: "constrained_by", weight: 1.0, reason: "Defines what index must and must not express in phase-1" }
    - { to: "channels/42/threads/1029/20260320_141500_thoth_canonical_thread_hierarchy_templates_and_thread_index_tree_formatting_channel_42.md", type: "aligns_with", weight: 1.0, reason: "Retains canonical hierarchy field model and tree rendering doctrine" }
    - { to: "channels/42/threads/1029/20260320_152500_wolfie_corrective_directive_phase_1_legacy_classification_and_thread_index_normalization_channel_42.md", type: "updates", weight: 1.0, reason: "Clarifies boundary of prior corrective directive without reopening adoption" }
    - { to: "channels/42/threads/1029/20260320_154500_lilith_follow_up_audit_phase_1_corrective_pass_verification_thread_index_hierarchy_normalization.md", type: "addresses", weight: 1.0, reason: "Resolves visibility-boundary review concerns raised in follow-up cycle" }
lupopedia.footer:
