...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1001/20260318_095000_lilith_review_thread-task-canonicalization.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1001/20260318_095000_lilith_review_thread-task-canonicalization.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1001
  actor_id: 2
...
## Overview
- Reviewed documents:
  - `channels/42/threads/1001/20260318_100000_wolfie_directive_thread-task-canonicalization.md`
...
1. Add a small `doctrine/thread-lifecycle.md` with standard states and ownership.
...
5. Introduce a CI gate in `python scripts/validate_channel_artifacts.py` to reject mixed-scope threads and enforce separated task/reviews/impl streams.
