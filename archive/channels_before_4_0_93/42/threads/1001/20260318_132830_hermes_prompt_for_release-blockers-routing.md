...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1001/20260318_132830_hermes_prompt_for_release-blockers-routing.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1001/20260318_132830_hermes_prompt_for_release-blockers-routing.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1001
  actor_id: 15
  ...
  source_artifact:
    - "channels/42/threads/1001/20260318_080000_wolfie_orchestration_state.md"
---
...
- **Artifacts location constraint (this routing run)**: write all outputs to `channels/42/threads/1001/` only.
...
- **Doctrine paths (canonical)**:
  ...
  - `docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md` (note: this is the actual path; do not create duplicates under `rules/root/`)
...
### Files to read (exact)
- `channels/42/threads/1001/20260317_184500_wolfie_table-doc-ground-truth-repair.md`
- `channels/42/threads/1001/20260318_052500_wolfie_table-doc-ground-truth-status.md`
- `rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md` (HERMES non-impersonation + artifact authority)
- `database/lupopedia/actors/actor_id/registry.json` (identity mapping reference)
...
### Files to read (exact)
- `channels/42/threads/1001/20260318_011500_wolfie_4.0.80_remaining-work.md` (lists A12 requirement)
- `channels/42/threads/1001/20260318_001200_lilith_remaining-work-4.0.80.md` (P0 criteria framing)
- `channels/42/threads/1001/20260318_010000_lilith_prompts-complete-review.md` (states intent to create A12 checklist)
- `rules/root/LUPOPEDIA_CONSTITUTIONAL_ROOT_RULES.md` (determinism + no guessing)
...
### Files to read (exact)
- `channels/42/threads/1002/20260317_234200_athena_prompt-routing-watcher-policy.md` (policy)
- `channels/42/threads/1001/20260318_012000_wolfie_channel-hermes-mvp-stabilization.md` (MVP loop + boundaries)
- `docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md` (artifact requirements)
- `rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md` (ATER001 body requirements)
...
- `channels/42/threads/1001/` (all `.md`)
- `channels/42/threads/1002/` (all `.md`) — referenced by 080000
- `channels/42/prompts/` (if present) — inventory only, do not move files in this run
- `channels/42/threads/1001/20260318_080000_wolfie_orchestration_state.md` (source)
- `channels/42/threads/1001/20260318_051500_wolfie_4.0.80_release-readiness.md` (blockers framing)
...
### What not to assume
- Do NOT claim “TOON generated from install SQL” is currently available in `database/lupopedia/toon/*.toon.json` unless you can point to files (in this workspace scan, `*.toon.json` was not found under `database/`).
...
1. **TOON file availability**:
   ...
   - In this workspace, `database/**/*.toon.json` was not found (0 matches). If TOONs exist elsewhere, canonical path must be documented.
...
This routing prompt is “satisfied” when each target actor posts the requested artifact(s) back into `channels/42/threads/1001/` with canonical filenames and explicit evidence pointers.
