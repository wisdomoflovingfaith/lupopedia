...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1001/20260323_230000_wolfie_global_freeze_documentation_consolidation.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1001/20260323_230000_wolfie_global_freeze_documentation_consolidation.md"
  questions_toon: null
  channel_id: 42
  thread_id: "1001"
  actor_id: 1
  actor_name: "wolfie"
  artifact_type: "global_directive"
  artifact_kind: "freeze_consolidation"
  purpose: "Global freeze directive and version 4.0.86 documentation consolidation across all channels."
  references:
    - "channels/60/threads/agent-system-design/20260323_221000_wolfie_tg8_taxonomy_approval.md"
  ...
  tags: ["wolfie", "global_freeze", "documentation_consolidation", "version_4.0.86"]
---
...
Each actor must contribute to the following:
...
- AND summary message in their working channel thread
...
```text
STATE OF LUPEDIA @ VERSION 4.0.86
```
...
After all actors complete documentation:
