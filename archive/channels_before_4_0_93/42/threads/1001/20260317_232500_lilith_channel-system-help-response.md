...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1001/20260317_232500_lilith_channel-system-help-response.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1001/20260317_232500_lilith_channel-system-help-response.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1001
...
- `channels` has empty/metadata-only thread artifacts (example: `20260317_223420_lilith_channel-system-review.md` initially empty), which is invalid.
...
- A cross-check process in `scripts` to detect and flag malformed threads.
...
- Artifact creation: canonical file under `channels/42/threads/{thread_id}/YYYYMMDD_HHIISS_{actor}_{topic}.md`.
