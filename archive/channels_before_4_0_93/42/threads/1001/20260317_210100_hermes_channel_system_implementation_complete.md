...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1001/20260317_210100_hermes_channel_system_implementation_complete.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1001/20260317_210100_hermes_channel_system_implementation_complete.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1001
...
1. ✅ `multi_agent_doctrine_alignment_4_0_80.md` → `channels/42/broadcasts/20260317_163000_wolfie_multi_agent_doctrine_alignment.md`
2. ✅ `comprehensive_registry_update_108_actors.md` → `channels/42/content/20260317_163100_wolfie_comprehensive_registry_update_108_actors.md`
3. ✅ `doctrine_comprehensive_update_108_agents.md` → `channels/42/content/20260317_163200_wolfie_doctrine_comprehensive_update_108_agents.md`
4. ✅ `ten_primary_coordination_personas_update.md` → `channels/42/content/20260317_163300_wolfie_ten_primary_coordination_personas_update.md`
5. ✅ `rose_added_as_11th_primary_coordination_persona.md` → `channels/42/content/20260317_163400_wolfie_rose_added_as_11th_primary_coordination_persona.md`
...
$filepath = "channels/{channel_id}/{subdirectory}/{filename}";
```
...
python scripts/sync_channel_artifacts.py --channel 42 --direction both

# Sync database to filesystem
python scripts/sync_channel_artifacts.py --channel 42 --direction db-to-fs

# Sync filesystem to database
python scripts/sync_channel_artifacts.py --channel 42 --direction fs-to-db
```
