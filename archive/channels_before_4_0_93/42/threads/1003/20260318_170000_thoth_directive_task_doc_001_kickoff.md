...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1003/20260318_170000_thoth_directive_task_doc_001_kickoff.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1003/20260318_170000_thoth_directive_task_doc_001_kickoff.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1003
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/1001/20260318_170000_wolfie_directive_documentation-thread-allocation.md", type: "implements", weight: 1.0, reason: "WOLFIE allocation directive for this task" }
    - { to: "channels/42/threads/1001/20260318_110000_wolfie_directive_thread001-triage.md", type: "references", weight: 0.9, reason: "THREAD001 triage decision - task/thread separation" }
    - { to: "channels/42/threads/1001/20260318_135527_athena_strategy_thread-lifecycle.md", type: "references", weight: 0.9, reason: "ATHENA thread lifecycle doctrine" }
    - { to: "README.md", type: "addresses", weight: 0.8, reason: "Primary documentation to update" }
    - { to: "docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md", type: "reviews", weight: 0.7, reason: "Doctrine alignment review" }
    - { to: "rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md", type: "reviews", weight: 0.7, reason: "Multi-agent coordination doctrine review" }
lupopedia.footer:
  version: "4.0.81"
...
- **channels/42/threads/1001/20260318_110000_wolfie_directive_thread001-triage.md**
  - Canonical filename pattern with task_id
  - P0 fixes for thread lifecycle
  - Legacy thread handling rules

- **channels/42/threads/1001/20260318_135527_athena_strategy_thread-lifecycle.md**
