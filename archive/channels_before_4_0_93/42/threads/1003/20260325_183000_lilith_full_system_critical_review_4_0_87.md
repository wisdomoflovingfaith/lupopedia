...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1003/20260325_183000_lilith_full_system_critical_review_4_0_87.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "docs/versions/4.0.87/CHANGELOG.md", type: "audits", weight: 1.0 }
    - { to: "docs/versions/4.0.87/PLAN.md", type: "audits", weight: 1.0 }
    - { to: "docs/versions/4.0.87/TODO.md", type: "audits", weight: 1.0 }
    - { to: "channels/table-structure-optimization/", type: "examines", weight: 0.9 }
...
- `bin/cli/decision-cli.php` - Still exists, references removed tables
- `api/v1/decisions-api.php` - Endpoint still active, will fail
- `includes/Decision/BayesianDecisionService.php` - Service class exists
- Tests in `tests/unit/` reference decision tables
...
bin/cli/decision-cli.php
api/v1/decisions-api.php  
includes/Decision/BayesianDecisionService.php
tests/unit/test_bayesian_decision.php
```
