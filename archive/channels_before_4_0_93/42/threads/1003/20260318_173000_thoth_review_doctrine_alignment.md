...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1003/20260318_173000_thoth_review_doctrine_alignment.md"
  web_path: "http://www.lupopedia.com/channels/42/threads/1003/20260318_173000_thoth_review_doctrine_alignment.md"
  questions_toon: null
  channel_id: 42
  thread_id: 1003
...
lupopedia.edges:
  outbound_edges:
    - { to: "docs/doctrine/CHANNEL_BASED_COORDINATION_DOCTRINE.md", type: "reviews", weight: 1.0, reason: "Primary doctrine for alignment review" }
    - { to: "rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md", type: "reviews", weight: 1.0, reason: "Multi-agent coordination doctrine review" }
    - { to: "channels/42/threads/1003/20260318_172000_thoth_draft_readme_thread_model_section.md", type: "references", weight: 0.8, reason: "Thread model content implemented in README" }
lupopedia.footer:
  version: "4.0.81"
...
1. **Channel Architecture** (Section 3)
   - Correctly documents `channels/42/threads/{thread_id}/` structure
