...
lupopedia.headers:
  ...
  file_path_from_root: "channels/42/threads/1003/20260326_190000_athena_database_import_plan.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/", type: "analyzes", weight: 1.0 }
    - { to: "scripts/sync_channel_artifacts.py", type: "references", weight: 1.0 }
    - { to: "scripts/import_channels_and_artifacts.py", type: "references", weight: 1.0 }
    - { to: "channels/42/threads/2002/", type: "references", weight: 0.9 }
...
Files to create:
- channels/66/threads/2012/20260326_190000_wolfie_erq_006_completion_threaded.md
- channels/66/broadcasts/POINTER_erq_006_completion.md
```
...
**Thread Location**: `channels/66/threads/2012/`
...
python scripts/sync_channel_artifacts.py --watch-mode --channel 42
```

#### 4.2 Reconciliation System
```bash
# Find database records without filesystem files
python scripts/sync_channel_artifacts.py --reconcile-db --channel 42

# Find filesystem files without database records
python scripts/sync_channel_artifacts.py --reconcile-fs --channel 42
```
