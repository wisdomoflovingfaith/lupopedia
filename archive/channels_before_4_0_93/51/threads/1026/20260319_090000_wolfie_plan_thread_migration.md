...
lupopedia.headers:
  ...
  file_path_from_root: "channels/51/threads/1026/20260319_090000_wolfie_plan_thread_migration.md"
  web_path: "http://www.lupopedia.com/channels/51/threads/1026/20260319_090000_wolfie_plan_thread_migration.md"
  last_path_from_root: "channels/51/threads/1026/20260319_090000_wolfie_plan_thread_migration.md"
  web_path: "http://www.lupopedia.com/channels/51/threads/1026/20260319_090000_wolfie_plan_thread_migration.md"
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/42/threads/", type: "migrates", weight: 1.0, reason: "Migrates threads from Channel 42" }
    - { to: "channels/1/", type: "migrates_to", weight: 1.0, reason: "Migrates release threads to Channel 1" }
    - { to: "channels/7/", type: "migrates_to", weight: 1.0, reason: "Migrates validator threads to Channel 7" }
    - { to: "channels/11/", type: "migrates_to", weight: 1.0, reason: "Migrates documentation threads to Channel 11" }
    - { to: "channels/17/", type: "migrates_to", weight: 1.0, reason: "Migrates architecture threads to Channel 17" }
    - { to: "channels/23/", type: "migrates_to", weight: 1.0, reason: "Migrates migration threads to Channel 23" }
    - { to: "channels/31/", type: "migrates_to", weight: 1.0, reason: "Migrates external AI threads to Channel 31" }
    - { to: "channels/66/", type: "migrates_to", weight: 1.0, reason: "Migrates QA threads to Channel 66" }
    - { to: "channels/88/", type: "migrates_to", weight: 1.0, reason: "Migrates research threads to Channel 88" }
  semantic_tags: ["wolfie_plan", "thread_migration", "channel_architecture"]

lupopedia.see:
  mappings:
    - ["Thread Migration Plan", "http://www.lupopedia.com/channels/51/threads/1026/20260319_090000_wolfie_plan_thread_migration.md"]
    - ["Migration Rules", "http://www.lupopedia.com/channels/channel_creation_doctrine.md#thread-migration-rules"]
...
**Migration Process**:
1. Copy thread to `channels/1/threads/`
...
**Migration Process**:
1. Copy thread to `channels/7/threads/`
...
**Migration Process**:
1. Copy thread to `channels/11/threads/`
