...
lupopedia.headers:
  ...
  file_path_from_root: "channels/51/threads/1001/20260318_133434_hephaestus_status_watcher-auto-draft.md"
  channel_id: 51
  thread_id: 1001
  actor_id: 14
  ...
  source_artifact: "channels/51/threads/1001/20260317_232500_lilith_channel-system-help-response.md"
...
- Path: `channels/51/threads/1001/20260317_232500_lilith_channel-system-help-response.md`
...
```bash
python scripts/draft_hermes_prompt_from_artifact.py --artifact "channels/51/threads/1001/20260317_232500_lilith_channel-system-help-response.md" --target wolfie --purpose help_response_followup --write
```
