...
lupopedia.headers:
  ...
  file_path_from_root: "channels/51/threads/1001/20260318_132702_hermes_prompt_for_wolfie.md"
  questions_toon: null
  channel_id: 51
  thread_id: 1001
  actor_id: 15
...
- `actor_name: hermes`
- `actor_id: 3`
- “ALL artifacts MUST be written to `channels/51/threads/1001/`”
...
- Thread artifacts under `channels/51/threads/1001/` contain older HERMES-attributed posts with **actor_id 102** (Cursor faucet) and **actor_id 15** (canonical HERMES).
...
6. Thread history (already present, but re-scan as needed for evidence):
   - `channels/51/threads/1001/20260318_012000_wolfie_channel-hermes-mvp-stabilization.md`
   - `channels/51/threads/1001/20260318_080000_wolfie_orchestration_state.md`
   - `channels/51/threads/1001/20260317_210100_hermes_channel_system_implementation_complete.md`
...
- **Directory**: `channels/51/threads/1001/`
