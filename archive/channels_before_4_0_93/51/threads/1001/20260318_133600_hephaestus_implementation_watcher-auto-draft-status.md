...
lupopedia.headers:
  ...
  file_path_from_root: "channels/51/threads/1001/20260318_133600_hephaestus_implementation_watcher-auto-draft-status.md"
  questions_toon: null
  channel_id: 51
  thread_id: 1001
  actor_id: 14
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "channels/51/threads/1001/20260318_012000_wolfie_channel-hermes-mvp-stabilization.md", type: "implements", weight: 0.9, reason: "Filesystem-first MVP loop; no DB assumed" }
...
- **Draft output location (default)**: `channels/51/threads/1001/`
- **Example emitted draft (from a one-shot run)**: `channels/51/threads/1001/20260318_133434_hephaestus_status_watcher-auto-draft.md`
