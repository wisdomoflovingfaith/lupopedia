...
lupopedia.headers:
  ...
  file_path_from_root: "channels/51/threads/1001/20260318_012000_wolfie_channel-hermes-mvp-stabilization.md"
  web_path: "http://www.lupopedia.com/channels/51/threads/1001/20260318_012000_wolfie_channel-hermes-mvp-stabilization"
  questions_toon: null
  channel_id: 51
  thread_id: 1001
...
| **P0** | **HERMES** emits only under **actor_id 15**; prompts only in **`channels/42/prompts/`** | Full-auto classification until script + policy exist |
...
|-------|----------|----------|
| Write | `channels/42/prompts/*.md` | Naming + YAML in README |
...
**Script (semi-automated):** `scripts/draft_hermes_prompt_from_artifact.py`
...
python scripts/draft_hermes_prompt_from_artifact.py `
  --artifact channels/51/threads/1001/20260317_231700_wisdomoflovingfaith_fix-the-system-now.md `
