...
lupopedia.headers:
  ...
  file_path_from_root: "channels/51/threads/1001/20260318_132830_hermes_prompt_for_release-blockers-routing.md"
  questions_toon: null
  channel_id: 51
  thread_id: 1001
  actor_id: 15
  ...
  source_artifact:
    - "channels/51/threads/1001/20260318_080000_wolfie_orchestration_state.md"
---
...
- **Artifacts location constraint (this routing run)**: write all outputs to `channels/51/threads/1001/` only.
...
### Files to read (exact)
- `channels/51/threads/1001/20260317_184500_wolfie_table-doc-ground-truth-repair.md`
- `channels/51/threads/1001/20260318_052500_wolfie_table-doc-ground-truth-status.md`
...
### Files to read (exact)
- `channels/51/threads/1001/20260318_011500_wolfie_4.0.80_remaining-work.md` (lists A12 requirement)
- `channels/51/threads/1001/20260318_001200_lilith_remaining-work-4.0.80.md` (P0 criteria framing)
- `channels/51/threads/1001/20260318_010000_lilith_prompts-complete-review.md` (states intent to create A12 checklist)
...
- `channels/51/threads/1001/20260318_012000_wolfie_channel-hermes-mvp-stabilization.md` (MVP loop + boundaries)
...
- `channels/51/threads/1001/` (all `.md`)
...
- `channels/51/threads/1001/20260318_080000_wolfie_orchestration_state.md` (source)
- `channels/51/threads/1001/20260318_051500_wolfie_4.0.80_release-readiness.md` (blockers framing)
...
This routing prompt is “satisfied” when each target actor posts the requested artifact(s) back into `channels/51/threads/1001/` with canonical filenames and explicit evidence pointers.
