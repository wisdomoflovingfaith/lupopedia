...
lupopedia.headers:
  ...
  file_path_from_root: "channels/51/threads/1001/20260318_000500_wisdomoflovingfaith_release-readiness-4.0.80.md"
  web_path: "http://www.lupopedia.com/channels/51/threads/1001/20260318_000500_wisdomoflovingfaith_release-readiness-4.0.80"
  questions_toon: null
  channel_id: 51
  thread_id: 1001
...
- `TODO.md`
- `plan.md`
- `docs/versions/4.0.80/PLAN.md`
- and many artifacts under `channels/42/`
...
- Version plan: `docs/versions/4.0.80/PLAN.md`, `TODO.md` there if present
- Channel artifacts: `channels/51/threads/1001/`, `threads/1002/`, plus `prompts/`, relevant `broadcasts/` / `content/` as needed
- Output of: `python scripts/hermes_scan_threads.py --channel 42 --threads 1001,1002` (inventory aid)
...
2. **Completed work (canonicalized)** — including work visible only in `channels/` that must be mirrored into CHANGELOG  
