...
lupopedia.headers:
  ...
  file_path_from_root: "channels/51/threads/1001/20260318_001200_lilith_remaining-work-4.0.80.md"
  web_path: "http://www.lupopedia.com/channels/51/threads/1001/20260318_001200_lilith_remaining-work-4.0.80"
  questions_toon: null
  channel_id: 51
  thread_id: 1001
...
- **Task:** Create task extraction pipeline from plan/changelog/todo  
  ...
  **Action:** read `CHANGELOG.md`, `TODO.md`, `PLAN.md`; output channel thread tasks in `channels/51/threads/1001/` with canonical filenames; compare with existing channel tasks and report drift  
  **Actor:** LILITH
...
- `channels/51/threads/1001/` includes this structured task artifact.
