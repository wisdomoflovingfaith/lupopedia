...
lupopedia.headers:
  ...
  file_path_from_root: "channels/51/threads/1001/20260318_141500_hephaestus_plan_validator-enforcement.md"
  questions_toon: null
  channel_id: 51
  thread_id: 1001
  actor_id: 14
...
lupopedia.edges:
  outbound_edges:
    - { to: "channels/51/threads/1001/20260318_110000_wolfie_directive_thread001-triage.md", type: "implements", weight: 1.0, reason: "Binding task_id vs thread_id separation + P0 enforcement mechanism" }
    - { to: "channels/51/threads/1001/20260318_135527_athena_strategy_thread-lifecycle.md", type: "implements", weight: 1.0, reason: "Baseline §8 validator-relevant rules" }
    - { to: "channels/51/threads/1001/20260318_095000_lilith_review_thread-task-canonicalization.md", type: "addresses", weight: 0.9, reason: "P0 lifecycle/split/merge/validator hook gaps" }
    - { to: "channels/51/threads/1001/20260318_134258_hermes_prompt_for_wolfie_thread001-triage-and-routing.md", type: "addresses", weight: 0.9, reason: "Validator mapping + legacy constraints" }
...
- **WOLFIE waiver marker** (for legacy / exceptional postings):
  - `wolfie_waiver_artifact: channels/51/threads/1001/YYYYMMDD_HHIISS_wolfie_directive_....md`
