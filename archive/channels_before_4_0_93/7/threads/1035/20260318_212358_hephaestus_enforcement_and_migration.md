...
lupopedia.headers:
  ...
  file_path_from_root: "channels/7/threads/1035/20260318_212358_hephaestus_enforcement_and_migration.md"
  web_path: "http://www.lupopedia.com/channels/7/threads/1035/20260318_212358_hephaestus_enforcement_and_migration.md"
  questions_toon: null
...
lupopedia.footer:
  ...
  orchestrator: "wolfie"
---
# file: HEPHAESTUS enforcement & migration — session: channel 42 -> functional channels + system limits — delegation: hephaestus:enforcement — web_path: http://www.lupopedia.com/channels/7/threads/1035/20260318_212358_hephaestus_enforcement_and_migration.md
...
Implemented in: `includes/modules/channels/operator-accept-visitor-api.php`
...
Implemented in: `database/lupopedia/content/app/Services/ActorService.php`
...
Implemented in: `scripts/safe-migrate.php`
...
Script created: `scripts/check_repo_limits.php`
...
- CI / maintenance gates can use `scripts/check_repo_limits.php` for the repo files metric.
