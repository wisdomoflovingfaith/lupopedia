...
lupopedia.headers:
  ...
  file_path_from_root: "channels/58/threads/actor-pairing-discussion/20260323_113000_wolfie_actor_model_implementation_plan.md"
  web_path: "http://www.lupopedia.com/channels/58/threads/actor-pairing-discussion/20260323_113000_wolfie_actor_model_implementation_plan.md"
  questions_toon: null
  channel_id: 58
  ...
  references:
    ...
    - "channels/58/threads/actor-pairing-discussion/20260323_110000_wolfie_root_approval_actor_model_decision.md"
...
- Update docs/actors.md with new model
- Update actors/README.md with metadata requirements
- Update docs/ACTOR_IDENTITIES.md (remove numeric paths)
...
- **Target Files**: 
  - actors/{slug}/.metadata.yaml for all actors
...
- **Target Files**: 
  - actors/{slug}/prompts/layers/department/
  - actors/{slug}/prompts/layers/human/
...
- **Target Files**: 
  - scripts/validate_actor_filesystem_alignment.py
...
- **Target Files**: 
  - includes/Services/ActorResolutionService.php
  - includes/Services/ActorResolutionInterface.php
...
- **Target Files**: 
  - includes/Services/ActorMergeRules.php
...
- **Target Files**: 
  - includes/Services/ActorFallbackRules.php
...
- **Target Files**: 
  - docs/doctrine/ACTOR_RESOLUTION_CONTRACT.md
...
- **Description**: Update docs/actors.md with new agent-centric model
- **Target Files**: 
  - docs/actors.md
...
- **Description**: Update actors/README.md with metadata requirements
- **Target Files**: 
  - actors/README.md
...
- **Description**: Update docs/ACTOR_IDENTITIES.md (remove numeric paths)
- **Target Files**: 
  - docs/ACTOR_IDENTITIES.md
...
- **Target Files**: 
  - tests/integration/ActorResolutionTest.php
  - tests/integration/ActorModelIntegrationTest.php
...
- **Target Files**: 
  - tests/performance/ActorResolutionPerformanceTest.php
...
- **Target Files**: 
  - tests/integration/ChannelCoordinationIntegrationTest.php
...
- [ ] docs/actors.md updated with new model
- [ ] actors/README.md enforces new standards
- [ ] docs/ACTOR_IDENTITIES.md uses slug-only paths
