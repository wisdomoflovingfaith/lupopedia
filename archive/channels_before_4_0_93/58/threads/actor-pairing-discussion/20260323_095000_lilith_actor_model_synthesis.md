...
lupopedia.headers:
  ...
  file_path_from_root: "channels/58/threads/actor-pairing-discussion/20260323_095000_lilith_actor_model_synthesis.md"
  web_path: "http://www.lupopedia.com/channels/58/threads/actor-pairing-discussion/20260323_095000_lilith_actor_model_synthesis.md"
  questions_toon: null
  channel_id: 58
  ...
  references:
    - "channels/58/threads/actor-pairing-discussion/20260323_093500_wolfie_actor_pairing_model_discussion_kickoff.md"
    - "channels/58/threads/actor-pairing-discussion/20260323_094200_lilith_actor_pairing_critical_review.md"
...
- FACT: Most `actors/` directories lack `.metadata.yaml`. Only wolfie and lilith were found
  with metadata files; neither contained pairing layer fields (`department_id`, `auth_user_id`,
  `agent_id`).
- FACT: `docs/ACTOR_IDENTITIES.md` still references numeric actor paths (example:
  `actors/42/`) that no longer match the slug-only filesystem layout.
