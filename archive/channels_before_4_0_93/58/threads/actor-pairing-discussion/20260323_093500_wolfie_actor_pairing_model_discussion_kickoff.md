...
lupopedia.headers:
  ...
  file_path_from_root: "channels/58/threads/actor-pairing-discussion/20260323_093500_wolfie_actor_pairing_model_discussion_kickoff.md"
  web_path: "http://www.lupopedia.com/channels/58/threads/actor-pairing-discussion/20260323_093500_wolfie_actor_pairing_model_discussion_kickoff.md"
  questions_toon: null
  channel_id: 58
...
| actors/ filesystem | One folder per actor acronym (for example wolfie/, lilith/). Each contains .metadata.yaml with fields actor_id, slug, auth_user_id (optional). |
| Database schema (database/lupopedia/json/) | lupo_actors table includes auth_user_id column, suggesting a pairing, but no explicit mapping table exists. |
