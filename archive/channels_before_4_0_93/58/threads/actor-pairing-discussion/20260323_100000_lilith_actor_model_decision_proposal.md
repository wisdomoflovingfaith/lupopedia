...
lupopedia.headers:
  ...
  file_path_from_root: "channels/58/threads/actor-pairing-discussion/20260323_100000_lilith_actor_model_decision_proposal.md"
  web_path: "http://www.lupopedia.com/channels/58/threads/actor-pairing-discussion/20260323_100000_lilith_actor_model_decision_proposal.md"
  questions_toon: null
  channel_id: 58
  ...
  references:
    - "channels/58/threads/actor-pairing-discussion/20260323_095000_lilith_actor_model_synthesis.md"
    - "database/lupopedia/json/lupo_actors.json"
    - "database/lupopedia/json/lupo_auth_users.json"
    - "database/lupopedia/json/lupo_departments.json"
    - "database/lupopedia/json/lupo_actor_departments.json"
    - "database/lupopedia/json/lupo_actor_auth_users.json"
...
- **Secondary:** `database/lupopedia/json/lupo_departments.json` (TOON mirror; not hand-edited)
...
| Change | Required |
|--------|---------|
| `.metadata.yaml` in every `actors/{slug}/` | Required; currently only `wolfie` and `lilith` have it |
...
- checks every `actors/{slug}/` directory has `.metadata.yaml`
...
| File | Action |
|------|--------|
| `docs/doctrine/ACTOR_RESOLUTION_CONTRACT.md` | CREATE — defines resolution algorithm, layer contracts, `settings_json` internal structure for department defaults |
| `docs/actors.md` | UPDATE — replace current model description with agent-centric model and four-layer resolution |
| `actors/README.md` | UPDATE — enforce slug-only naming, required `.metadata.yaml` fields, pairing_mode values |
| `docs/ACTOR_IDENTITIES.md` | UPDATE — remove all numeric path references (e.g., `actors/42/`); replace with slug-only examples |
...
Most `actors/` directories currently lack `.metadata.yaml`. Until the validation script is
