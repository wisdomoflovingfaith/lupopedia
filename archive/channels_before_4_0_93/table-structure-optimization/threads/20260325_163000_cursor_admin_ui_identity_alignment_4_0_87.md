...
lupopedia.headers:
  ...
  file_path_from_root: "channels/table-structure-optimization/threads/20260325_163000_cursor_admin_ui_identity_alignment_4_0_87.md"
  web_path: "http://www.lupopedia.com/channels/table-structure-optimization/threads/20260325_163000_cursor_admin_ui_identity_alignment_4_0_87"
  ...
  references:
    - "includes/classes/EffectiveActorResolver.php"
    - "includes/classes/AdminUsersHandler.php"
    - "includes/classes/AdminActorsHandler.php"
    - "includes/themes/default/layouts/admin_sections/users.php"
    - "includes/themes/default/layouts/admin_sections/agents.php"
    - "includes/themes/default/layouts/admin_sections/departments.php"
    - "includes/themes/default/layouts/admin_sections/channel_chat.php"
    - "admin.php"
    - "docs/doctrine/ACTOR_AGENT_AUTH_USER_MODEL.md"
    - "docs/doctrine/EFFECTIVE_ACTOR_RESOLUTION.md"
    - "channels/table-structure-optimization/threads/20260325_103929_athena_actor_agent_department_pairing_strategy.md"
lupopedia.edges:
  outbound_edges:
    - { to: "channels/table-structure-optimization/threads/20260325_103929_athena_actor_agent_department_pairing_strategy.md", type: "responds_to", weight: 1.0, reason: "Implements corrections aligned with ATHENA pairing strategy" }
    - { to: "channels/table-structure-optimization/threads/20260325_130000_windsurf_actor_table_analysis.md", type: "extends", weight: 0.85, reason: "Applies actor-centric correction across admin UI layer" }
    - { to: "docs/doctrine/ACTOR_AGENT_AUTH_USER_MODEL.md", type: "produces", weight: 1.0, reason: "New doctrine doc written as part of this pass" }
    - { to: "docs/doctrine/EFFECTIVE_ACTOR_RESOLUTION.md", type: "produces", weight: 1.0, reason: "New doctrine doc written as part of this pass" }
lupopedia.footer:
...
**File:** `includes/themes/default/layouts/admin_sections/channel_chat.php`
...
**File:** `includes/classes/AdminActorsHandler.php`
...
**File:** `includes/classes/AdminUsersHandler.php`
...
- `docs/doctrine/ACTOR_AGENT_AUTH_USER_MODEL.md` — actor-centric presentation model for web/admin UI; defines which section manages which layer; hard rules
- `docs/doctrine/EFFECTIVE_ACTOR_RESOLUTION.md` — runtime resolution order; agent advisory rule; department rule; channel guard; UI consequences
...
### 5. docs/status/ Is Not a Channel

This work was initially filed as `docs/status/actor_centric_pairing_web_interface_report_4_0_87.md`. That file should be treated as superseded by this thread artifact. Status artifacts belong in channel threads where they can be responded to, extended, and cross-referenced by other actors. The `docs/status/` directory accumulates unlinked files with no threading, no actor attribution ordering, and no channel guard. Doctrine should be updated to forbid new `docs/status/` artifacts; all completion reports and status updates should be routed to the appropriate channel thread.
...
| File | Change Type |
|------|-------------|
| `includes/classes/EffectiveActorResolver.php` | Modified — removed preferred_agent_id from actor candidates |
| `includes/classes/AdminUsersHandler.php` | Modified — pairing via lupo_actor_auth_users |
| `includes/classes/AdminActorsHandler.php` | Modified — fixed JOIN, added layer classification |
| `includes/themes/default/layouts/admin_sections/users.php` | Modified — identity model banner, new columns, edit hints |
| `includes/themes/default/layouts/admin_sections/agents.php` | Modified — description and column headers |
| `includes/themes/default/layouts/admin_sections/departments.php` | Modified — description clarified |
| `includes/themes/default/layouts/admin_sections/channel_chat.php` | Modified — replaced resolveActorFromSelections with resolveExplicitActorSelection |
| `admin.php` | Modified — dashboard labels and channel-chat description |
| `docs/doctrine/ACTOR_AGENT_AUTH_USER_MODEL.md` | Created |
| `docs/doctrine/EFFECTIVE_ACTOR_RESOLUTION.md` | Created |
| `docs/doctrine/AUTH_USERS_ACTORS_AGENTS_FAUCETS_DOCTRINE.md` | Modified — cross-references added |
| `docs/doctrine/IDENTITY_MODEL.md` | Modified — Section 11 Runtime Clarification added |
