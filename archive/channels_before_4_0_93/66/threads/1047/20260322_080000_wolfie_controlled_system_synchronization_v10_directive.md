...
lupopedia.headers:
  ...
  file_path_from_root: channels/66/threads/1047/20260322_080000_wolfie_controlled_system_synchronization_v10_directive.md
  web_path: http://www.lupopedia.com/channels/66/threads/1047/20260322_080000_wolfie_controlled_system_synchronization_v10_directive.md
...
lupopedia.edges:
  ...
  - to: docs/versions/4.0.85/TASK_REGISTRY.md
    type: requires_creation
    weight: 1.0
    reason: TASK_REGISTRY is the single source of truth
  - to: docs/versions/4.0.85/CONTRADICTIONS.md
    type: requires_creation
    weight: 1.0
