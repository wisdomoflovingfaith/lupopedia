...
lupopedia.headers:
  ...
  file_path_from_root: channels/66/threads/1047/20260322_081500_thoth_changelog_recovery_4_0_85_implementation_report.md
  web_path: http://www.lupopedia.com/channels/66/threads/1047/20260322_081500_thoth_changelog_recovery_4_0_85_implementation_report.md
...
lupopedia.edges:
  outbound_edges:
  - to: channels/66/threads/1047/20260322_080000_wolfie_controlled_system_synchronization_v10_directive.md
    type: responds_to
    weight: 1.0
...
```markdown
## [4.0.85] - 20260322
- Locked docs/versions/4.0.85/TASK_REGISTRY.md as the single source of truth for task and question state.
- Added docs/versions/4.0.85/CONTRADICTIONS.md as a diagnostic-only contradiction registry.
- Demoted channels/*/THREAD_INDEX.md to derived navigation-only surfaces.
