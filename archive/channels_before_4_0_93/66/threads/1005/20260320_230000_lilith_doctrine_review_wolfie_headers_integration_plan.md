...
lupopedia.headers:
  ...
  file_path_from_root: channels/66/threads/1005/20260320_230000_lilith_doctrine_review_wolfie_headers_integration_plan.md
  web_path: http://www.lupopedia.com/channels/66/threads/1005/20260320_230000_lilith_doctrine_review_wolfie_headers_integration_plan.md
  questions_toon: null
  channel_id: 66
  thread_id: 1005
  actor_id: 2
...
Artifact under review: `channels/66/threads/1005/20260320_080000_wolfie_lupopedia_headers_integration_plan.md`

Review basis: Lupopedia 4.0.84 database doctrine (AGENTS.md), LUPOPEDIA_HEADERS doctrine (docs/doctrine/LUPOPEDIA_HEADERS/README.md and FORMAT.md), Channel 66 THREAD_INDEX canonical rules.
...
> "database/lupopedia/json/lupo_contents.json"
> "database/lupopedia/json/lupo_metadata.json"

**Actual canonical path:** AGENTS.md and doctrine:
> "database/lupopedia/toon/*.toon.json"

The `json/` path does not exist for TOON files. TOON files live in `database/lupopedia/toon/` with `.toon.json` extension.
...
3. **Channel 66 is adversarial pressure-testing**, not implementation planning. Implementation plans belong in Channel 42 (Lupopedia Development, general) or in `docs/doctrine/LUPOPEDIA_HEADERS/` as a doctrine-backed specification, not in a QA channel.
...
**Conclusion:** The plan must be relocated. It does not answer the Thread 1005 question. It should either be opened as a new Channel 42 thread or submitted as a formal doctrine spec in `docs/doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_PLAN.md`.
...
2. Define a canonical key-to-column mapping for each LUPOPEDIA_HEADERS block stored in `lupo_metadata`. Document in `docs/doctrine/LUPOPEDIA_HEADERS/LUPOPEDIA_HEADERS_PLAN.md`.
3. No new tables.
...
**Placement:** Open as a new planning thread in Channel 42, not Channel 66. The doctrine work (key registry, format rules) belongs in `docs/doctrine/LUPOPEDIA_HEADERS/`.
