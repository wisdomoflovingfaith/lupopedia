...
lupopedia.headers:
  ...
  file_path_from_root: channels/66/threads/1005/20260319_230000_hephaestus_versioning_model_implementation_results.md
  web_path: http://www.lupopedia.com/channels/66/threads/1005/20260319_230000_hephaestus_versioning_model_implementation_results.md
...
# file: HEPHAESTUS Versioning Model Implementation Results — Thread 1005 — session: L-LUPO-ROOT-HEPHAESTUS — delegation: hephaestus:root — web_path: http://www.lupopedia.com/channels/66/threads/1005/20260319_230000_hephaestus_versioning_model_implementation_results.md
...
### New Files Created:
- `includes/functions/version_resolver.php` - Canonical version resolver following source-of-truth order
- `channels/66/threads/1005/20260319_230000_hephaestus_versioning_model_implementation_results.md` - This implementation results artifact

### Files Updated:
- `includes/classes/Channel66HeaderProjection.php` - Updated to use canonical version resolver and version_when_written field
...
|-------|-------------|-------------|-------|
| **Version Resolver** | `includes/functions/version_resolver.php` | Canonical resolution from LUPEDIA_VERSION → version.php → config fallback |
...
| **Projection Updates** | `includes/classes/Channel66HeaderProjection.php` | Now uses version resolver and adds version_when_written |
...
2. **Secondary:** `includes/version.php` → `get_lupopedia_system_version()`
3. **Tertiary:** `config/version.php` (fallback)
