...
lupopedia.headers:
  ...
  file_path_from_root: channels/66/threads/1002/20260319_233000_wolfie_lupopedia_headers_canonical_source_of_truth.md
  web_path: http://www.lupopedia.com/channels/66/threads/1002/20260319_233000_wolfie_lupopedia_headers_canonical_source_of_truth.md
...
lupopedia.see:
  mappings:
  - - channels/66/threads/1002
    - http://www.lupopedia.com/channels/66/threads/1002
lupopedia.footer:
  version: 4.0.80
...
- **docs/doctrine/LUPOPEDIA_HEADERS/README.md** - Primary header specification
- **docs/doctrine/LUPOPEDIA_HEADERS/VALIDATORS_AND_TOOLING.md** - Validation and tooling

### 4.2 Root Rules
- **rules/root/LUPOPEDIA_CONSTITUTIONAL_ROOT_RULES.md** - Constitutional rules for header system
- **rules/root/FILE_BOUNDARY_VALIDATION_RULE.md** - File boundary validation
- **rules/root/CHANNEL_ARTIFACT_ROUTING_DOCTRINE.md** - Channel routing in headers
...
- Survey existing header usage across docs/, rules/, channels/
