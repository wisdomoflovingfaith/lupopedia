...
lupopedia.headers:
  ...
  file_path_from_root: channels/66/threads/1050/20260324_220500_ch66_thread_1050_root_archive_scope_decision.md
  ...
  web_path: http://www.lupopedia.com/channels/66/threads/1050/20260324_220500_ch66_thread_1050_root_archive_scope_decision.md
lupopedia.footer:
...
> Root archive scope: Which root-level files should be moved to `docs/archived/root_stale_20260324/`?  
...
- Manifest location: `docs/archived/root_stale_20260324/ARCHIVE_MANIFEST.md`

### Implementation Status

**Status**: ✅ ALREADY EXECUTED (2026-03-24)

**Artifact**: `docs/archived/root_stale_20260324/ARCHIVE_MANIFEST.md` exists with:
...
- Archive manifest: `docs/archived/root_stale_20260324/ARCHIVE_MANIFEST.md`
