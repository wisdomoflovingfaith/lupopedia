...
lupopedia.headers:
  ...
  file_path_from_root: channels/66/threads/1001/20260319_220000_hephaestus_production_migration_remediation_plan_p0_bounded_authority_ingestion.md
  web_path: http://www.lupopedia.com/channels/66/threads/1001/20260319_220000_hephaestus_production_migration_remediation_plan_p0_bounded_authority_ingestion.md
...
# file: HEPHAESTUS Production Migration Remediation Plan — Thread 1001 — session: L-LUPO-ROOT-HEPHAESTUS — delegation: hephaestus:root — web_path: http://www.lupopedia.com/channels/66/threads/1001/20260319_460000_hephaestus_production_migration_remediation_plan_p0_bounded_authority_ingestion
...
**Files to change:** `includes/classes/Channel66ProductionIngester.php`
...
**Files to change:** `includes/classes/Channel66BatchProcessor.php`
...
**Files to change:** `scripts/deploy_channel66_production_extended.sh`
...
**Files to change:** `includes/classes/Channel66ProductionConfig.php`
...
**Files to change:** `includes/classes/Channel66HeaderProjection.php`
...
**Files to change:** `tests/integration/channel66_production_extended_test.php`
...
**Files to change:** `tests/integration/channel66_production_test.php`
...
**Files to change:** `includes/classes/Channel66PerformanceMonitor.php`
...
**Files to change:** `includes/classes/Channel66ProductionErrorHandler.php`
