...
lupopedia.headers:
  ...
  file_path_from_root: channels/66/threads/1003/20260319_233500_wolfie_collections_and_namespaces_system_structure.md
  web_path: http://www.lupopedia.com/channels/66/threads/1003/20260319_233500_wolfie_collections_and_namespaces_system_structure.md
...
- **Documentation**: How collections and namespaces organize docs/
- **Code Organization**: How they structure includes/, routes/, etc.
...
- **docs/doctrine/LUPOPEDIA_HEADERS/README.md** - Namespace usage in headers

### 4.2 Root Rules
- **rules/root/FILE_BOUNDARY_VALIDATION_RULE.md** - File structure and organization
- **rules/root/DIRECTORY_STRUCTURE_DOCTRINE.md** - Directory organization principles
- **rules/root/CHANNEL_ARTIFACT_ROUTING_DOCTRINE.md** - Channel organization
...
### 6.2 System Survey
- Inventory existing collections across actors/, channels/, docs/
