...
lupopedia.headers:
  ...
  file_path_from_root: channels/66/threads/1051/20260324_220600_ch66_thread_1051_edge_review_ownership.md
  ...
  web_path: http://www.lupopedia.com/channels/66/threads/1051/20260324_220600_ch66_thread_1051_edge_review_ownership.md
lupopedia.footer:
...
**Artifact**: `docs/versions/4.0.87/EDGE_REVIEW_QUEUE.md`
...
**Documentation**:
- SLA policy documented in: `docs/versions/4.0.87/EDGE_REVIEW_QUEUE.md`
...
- Queue manifest: `docs/versions/4.0.87/EDGE_REVIEW_QUEUE.md`
- Actor registry: `database/lupopedia/actors/actor_id/registry.json`
- Doctrine: `rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md`
