...
lupopedia.headers:
  ...
  file_path_from_root: channels/66/README.md
  ...
  web_path: http://www.lupopedia.com/channels/66/
lupopedia.footer:
...
- [docs/versions/4.0.87/CHANNEL_66_ANSWERED_QUESTIONS_20260324.md](../../docs/versions/4.0.87/CHANNEL_66_ANSWERED_QUESTIONS_20260324.md) — Consolidated summary of answered questions
- [MULTI_AGENT_COORDINATION_DOCTRINE](../rules/root/MULTI_AGENT_COORDINATION_DOCTRINE.md) — Governance framework
