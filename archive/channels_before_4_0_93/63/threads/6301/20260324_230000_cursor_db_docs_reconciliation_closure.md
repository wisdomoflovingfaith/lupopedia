...
lupopedia.headers:
  ...
  file_path_from_root: channels/63/threads/6301/20260324_230000_cursor_db_docs_reconciliation_closure.md
...
- Full table-by-table `docs/database/` doc backfill for non-surface tables
