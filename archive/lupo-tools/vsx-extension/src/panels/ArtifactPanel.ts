...
export class ArtifactPanel {
    ...
    private _getHtmlForWebview(artifact: { filePath: string, header: LupopediaHeaderV2 | LupopediaHeaderV3, footer?: LupopediaFooterV2 | LupopediaFooterV3 }) {
        ...
        if ('identity' in artifact.header) {
            ...
            moodVector = h.lupopedia.headers.mood_vector || '666666';
...
<head>
    ...
    <style>
        ...
        .header-bar { border-left: 5px solid #${moodVector}; padding-left: 15px; margin-bottom: 25px; }
        h1 { margin: 0; color: #ffffff; font-size: 1.5rem; }
        .type-tag { display: inline-block; padding: 2px 8px; border-radius: 4px; background: #333; font-size: 0.8rem; margin-top: 5px; color: #${moodVector}; border: 1px solid #${moodVector}44; }
