...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-agents/lilith/system_prompt.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-agents/lilith/system_prompt.md"
  status: "active"
  when_updated: "20260419100701"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/lilith-system-prompt.toon"
  atoms_toon: null
  ...
  content_slug: "lilith-system-prompt"
...
This file is the **canonical** LILITH system prompt. It lives under **lupo-agents/lilith/** so it ships with autoinstaller archives and the repo tree. Edit here first; **.cursor/rules/lilith-system-prompt.md** is a maintained mirror for Cursor IDE context.
