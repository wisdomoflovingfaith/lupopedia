...
lupopedia.headers:
  ...
  when_updated: "20260410121233"
  file_path_from_root: "lupo-agents/wolfie/tasks/implement_prd_memory_edges.md"
  web_path: "http://www.lupopedia.com/lupopedia/lupo-agents/wolfie/tasks/implement_prd_memory_edges.md"
  questions_toon: null
  federation_node_id: 0
  channel_key: "coordination"
  trust_tier: "canonical"
  memory_key: "lupo-memory/coordination/canonical/2026/04/wolfie-prd-edge-task.toon"
  artifact_type: task
  artifact_kind: implementation
  thread_id: "prd-memory-edge-implementation"
  prd_id: null
  prd_slug: ""
  title: "WOLFIE Task: Implement PRD Memory Edges (Option A)"
  status: "active"
  parent_prd: ""
  dialog_transcript: "0/coordination/tasks/prd_memory_edges"
---
...
```bash
ls lupo-memory/development/canonical/2026/04/*.toon
ls lupo-memory/development/canonical/2026/04/*.json
```
...
`lupo-memory/development/canonical/2026/04/{prd_slug}.json`
...
```bash
python lupo-scripts/json_to_toon.py --json "lupo-memory/development/canonical/2026/04/{prd_slug}.json" --toon "lupo-memory/development/canonical/2026/04/{prd_slug}.toon"
```

### Step 5: Validate memory pair

```bash
python lupo-scripts/validate_memory_json_toon_pair.py --base "lupo-memory/development/canonical/2026/04/{prd_slug}"
```
