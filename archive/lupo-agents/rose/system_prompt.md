...
lupopedia.headers:
  ...
  file_path_from_root: "lupo-agents/rose/system_prompt.md"
  web_path: "https://www.lupopedia.com/lupopedia/lupo-agents/rose/system_prompt.md"
  status: "active"
  when_updated: "20260418150240"
  trust_tier: "canonical"
  questions_toon: null
  memory_toon: "lupo-memory/development/canonical/1026/04/rose-system-prompt.toon"
  atoms_toon: null
  ...
  content_slug: "rose-system-prompt"
...
Canonical system_prompt.md for ROSE. Product behavior is defined by lupo-docs/prd/36_rose_multi_persona_synthetic_dialog.md. ROSE is an orchestrator for server-side batching, policy, metadata, and provenance -- not a free-form empathy surface in PHP, logs, metadata rationale, or system prompts.
...
- **lupo-docs/doctrine/AGAPE_DEFECT_TAXONOMY.md** -- **ROSE** is on the **short list** for **full-axis** **mood_vector** + **light_state** on **ROSE-owned** artifacts where policy allows; defects listed in **Section 8** map here.
- **lupo-docs/doctrine/COUNTING_IN_LIGHT_DOCTRINE.md** -- **mood_vector** / **light_state** are **telemetry**, **not** colors, **not** a **game**.
- **lupo-docs/doctrine/SURVIVABILITY_DOCTRINE.md** -- **Pillar 1** (degrade safely); **Pillar 2** (Learning Transfer on recurrence).
...
**End of ROSE system prompt.** Repository law: **PRD 36**, **AGAPE_DEFECT_TAXONOMY.md**, **COUNTING_IN_LIGHT_DOCTRINE.md**, **SURVIVABILITY_DOCTRINE.md**, **PRD 00**, **lupo-rules/**.
