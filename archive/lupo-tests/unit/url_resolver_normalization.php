<?php
/**
 * T8 Unit test: UrlResolver normalization (normalizePath, normalizeSlug, slug_encoding).
 * Run from repo root: php tests/unit/url_resolver_normalization.php
...
// normalizePath: leading/trailing slashes, multiple separators, trim
...
// normalizeSlug: _, +, %20 and slug_encoding
