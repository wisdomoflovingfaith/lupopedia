...
if($UNTRUSTED['proccess'] == "yes"){   
  ...
  if(!($serversession))
     ...
     $message = "<br><font color=007700>Sent   to ".htmlspecialchars($UNTRUSTED['email'], ENT_QUOTES, 'UTF-8')." with log in information.</font>  <br><a href=login.php>LOG IN</a><br>";
...
<input type=hidden name=proccess value=yes>
 <?php echo $lang['txt167']; ?><br>
 <b>e-mail:</b><br>
 <input type=text name=email class=large_form_field><br>
