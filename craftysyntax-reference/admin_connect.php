...
function security(){
    ...
    url = 'https://lupopedia.com/salessyntax_docs/updates.php'
    window.open(url,'rdfdsf','toolbar=yes,location=yes,directories=yes,status=yes,menubar=yes,scrollbars=yes,resizable=yes');
}  
 var sleeping=true; 
 </SCRIPT>
<?php } 
 print "<SCRIPT type=\"text/javascript\"> var sleeping=true; </SCRIPT><body bgcolor=$color_background background=\"images/leftbk2.png\"><br><br><br><br><br><center>" . $lang['noone_online2'] . "</center>";
...
if(empty($_REQUEST['see'])){  
 $see = "";
  ...
  $see = preg_replace('/[^a-zA-Z0-9_\-]/','', $_REQUEST['see']);
}
...
?>
    <SCRIPT type="text/javascript">
      window.location.replace("<?php echo $page; ?>?try=0&scriptname=admin_chat&see=<?php echo cslh_escape($see); ?>");
    </SCRIPT>
</body>
</html>
<?php
