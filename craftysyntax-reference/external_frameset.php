...
<frameset rows="30,*,120" border="0" frameborder="0" framespacing="0" spacing="0" NORESIZE=NORESIZE>
 <frame src="external_top.php" name="topof" scrolling="0" border="0" marginheight="0" marginwidth="0" NORESIZE=NORESIZE>
 ...
 <frame src="external_bot.php?channelsplit=<?php echo $channelsplit;?>&auto_focus=FIRST" name="bottomof" scrolling="AUTO" border="0" marginheight="0" marginwidth="0" NORESIZE=NORESIZE>
</frameset>
</html>
