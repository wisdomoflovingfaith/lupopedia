...
?>
<body bgcolor=<?php echo $midbackcolor; ?> >
<br>
...
<table>
<?php 
if(empty($UNTRUSTED['current'])){ $current = 0; } else { $current = intval($UNTRUSTED['current']); }
...
CRAFTY SYNTAX Live Help &copy; 2003 - 2023 by Eric Gerdes  
<br>
