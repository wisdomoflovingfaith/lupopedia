...
$query = "SELECT * FROM livehelp_referers_daily where pageurl='".filter_sql($openedacc_tmp['pageurl'])."' AND department=" . $whichdepartment. " ORDER by dateof";
$openedacc = $mydatabase->query($query);
} else {
$query = "SELECT * FROM livehelp_visits_monthly where recno=".intval($UNTRUSTED['item']);
$openedacc_tmp = $mydatabase->query($query);
$openedacc_tmp = $openedacc_tmp->fetchRow(DB_FETCHMODE_ASSOC);
$query = "SELECT * FROM livehelp_visits_daily where pageurl='".filter_sql($openedacc_tmp['pageurl'])."' AND department=" . $whichdepartment. "  ORDER by dateof";
$openedacc = $mydatabase->query($query);
}
...
$openedacc_tmp = $mydatabase->query($query);
$openedacc_tmp = $openedacc_tmp->fetchRow(DB_FETCHMODE_ASSOC);
$query = "SELECT * FROM livehelp_referers_monthly where pageurl='".filter_sql($openedacc_tmp['pageurl'])."' AND department=" . $whichdepartment. "  ORDER by dateof";
$openedacc = $mydatabase->query($query);
} else {
$query = "SELECT * FROM livehelp_visits_monthly where recno=".intval($UNTRUSTED['item']);
$openedacc_tmp = $mydatabase->query($query);
$openedacc_tmp = $openedacc_tmp->fetchRow(DB_FETCHMODE_ASSOC);
$query = "SELECT * FROM livehelp_visits_monthly where pageurl='".filter_sql($openedacc_tmp['pageurl'])."' AND department=" . $whichdepartment. "  ORDER by dateof";
$openedacc = $mydatabase->query($query);
}
