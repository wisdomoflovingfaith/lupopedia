...
<?php
   ...
   print "<br><a href=https://lupopedia.com/updates/?v=" . $CSLH_Config['version'] . "&d=" . $CSLH_Config['directoryid'] . "&h=" . $_SERVER['HTTP_HOST'] . " target=_blank><img src=https://lupopedia.com/security/?randu=".date("YmdHis")."&format=image&v=". $CSLH_Config['version'] . "&d=". $CSLH_Config['directoryid'] . "&h=" . $_SERVER['HTTP_HOST'] . " name=security id=security border=0></a><br>";
?>
<span id=currentreg>
