...
<input type=hidden name=answer value=<?php echo intval($UNTRUSTED['answer']); ?> >
<input type=hidden name=current value=<?php echo intval($UNTRUSTED['current']); ?> >
<?php 
...
?>
<input type=hidden name=recno value=<?php echo intval($question_a['recno']); ?> >
...
<?php
 ...
 print "<br><a href=qa.php?current=".intval($UNTRUSTED['current'])."&answer=".intval($UNTRUSTED['answer'])."&answeredit=1>EDIT THIS</A><br><br><br>";
 print "<br><a href=qa.php?current=".intval($UNTRUSTED['current'])."&answer=".intval($UNTRUSTED['answer'])."&whatdo=REMOVE&recno=" . intval($question_a['recno']) . ">REMOVE THIS</A><br><br><br>"; 
}
...
<?php
 ...
 print "<br><a href=qa.php?current=".intval($UNTRUSTED['current'])."&answer=".intval($UNTRUSTED['answer'])."&whatdo=REMOVE&recno=" . intval($comment['recno']) . ">REMOVE THIS</A><br><br><br>"; 
