...
if($installed==true){
 ...
 // Default: 'craftysyntax' (changed from 'livehelp' in version 3.8.0)
 // This allows customization of table names if needed
 // All table references should use this variable instead of hardcoded 'livehelp' or 'craftysyntax'
