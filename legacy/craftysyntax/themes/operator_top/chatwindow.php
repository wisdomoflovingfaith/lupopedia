...
<DIV style="background: #FFFFFF url('<?php echo $topbackground; ?>'); background-repeat:no-repeat; width:100%; height:<?php echo $topframeheight; ?>px; top:0px; left:0px; position:relative;">
  ...
  <DIV style="width:250px; height:<?php echo $topframeheight; ?>px;  position:relative; float:left;">
  <table width=100><tr><td valign=center height=<?php echo $topframeheight; ?>><img src=<?php echo $urlforoperator; ?> height=<?php echo $topframeheight; ?> border=0>    			   
   </td></tr></table>
  </DIV>
  <?php } ?>  
  ...
  <DIV style="float:right; width:300px; height:<?php echo $topframeheight; ?>px; text-align:right;  "><?php echo $cslhdue; ?></DIV>    
	...
	<?php if(!(empty($td_list))){ ?>
				<DIV style="width:100%; height:28px; background: #FFFFFF url('themes/operator_top/topbar.png'); position:relative;">
...
<?php } ?>
 ...
 <DIV style="width:99%; height:260px;  top:0px; left:0px; position:relative;  float:left; border: 1px solid;">
	    <iframe height="260" width="99%" frameborder=0 src="<?php echo $urlforchat; ?>" name="chatwindow" scrolling="auto" border="1" marginheight="0" marginwidth="0" NORESIZE=NORESIZE></iframe>
    </DIV>
