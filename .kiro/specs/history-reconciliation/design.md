# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/.kiro/specs/history-reconciliation/design
...
flare.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: [".kiro/specs/history-reconciliation/design.md"]
      runtime_scope: "cli"
      channels:
...
flare.headers:
  ...
  file_hash: "f5bff4f0c0dbd8048a40e2aa9604531d5854dfe61fbdcf64bfbcffb1a6d4ce08"
...
flame.see:
  mappings:
    - [".kiro/specs/history-reconciliation/design.md", "http://www.lupopedia.com/.kiro/specs/history-reconciliation/design"]
