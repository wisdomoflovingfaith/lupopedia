# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/.kiro/specs/history-reconciliation/requirements
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: [".kiro/specs/history-reconciliation/requirements.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_hash: "89385cae7288280c7608cd37260055b39e2e868270c56dc0d3358dfbd1aca949"
...
lupopedia.see:
  mappings:
    - [".kiro/specs/history-reconciliation/requirements.md", "http://www.lupopedia.com/.kiro/specs/history-reconciliation/requirements"]
