# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/.kiro/specs/flip-v2-implementation/requirements
...
flare.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: [".kiro/specs/flip-v2-implementation/requirements.md"]
      runtime_scope: "cli"
      channels:
...
flare.headers:
  ...
  file_hash: "6c8f5c808e09b13d310cca91d19dae876e1571466ce37dd03d436f298a43c77c"
...
flame.see:
  mappings:
    - [".kiro/specs/flip-v2-implementation/requirements.md", "http://www.lupopedia.com/.kiro/specs/flip-v2-implementation/requirements"]
