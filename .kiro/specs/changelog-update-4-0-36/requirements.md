# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/.kiro/specs/changelog-update-4-0-36/requirements
...
flare.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: [".kiro/specs/changelog-update-4-0-36/requirements.md"]
      runtime_scope: "cli"
      channels:
...
flare.headers:
  ...
  file_hash: "7faa2085e5f12de12d8a7f256d7ef159851370993183a32bc31ca90fb43491dd"
...
flame.see:
  mappings:
    - [".kiro/specs/changelog-update-4-0-36/requirements.md", "http://www.lupopedia.com/.kiro/specs/changelog-update-4-0-36/requirements"]
