# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/.kiro/specs/dialog-channel-migration/tasks
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: [".kiro/specs/dialog-channel-migration/tasks.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: ".kiro/specs/dialog-channel-migration/tasks.md"
  file_hash: "b66a635db3e0204151c78af60ce955fa7c22f38cfe758e6266a6b9ce0316d1e9"
...
lupopedia.see:
  mappings:
    - [".kiro/specs/dialog-channel-migration/tasks.md", "http://www.lupopedia.com/.kiro/specs/dialog-channel-migration/tasks"]
