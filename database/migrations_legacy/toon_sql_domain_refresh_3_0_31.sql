...
-- Note: This assumes doctrine_sql_tab_mapping_3_0_25.sql was already executed
-- If not executed, run that migration first

-- Check for any SQL doctrine files not mapped to tab 11
-- (This is informational - actual mapping should be done by doctrine_sql_tab_mapping_3_0_25.sql)
