...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/actors/actor_id/1007/20260227_channels_admin_next_steps_report.md"
...
lupopedia.footer:
  outbound_edges:
    - { to: "includes/modules/api/channels-admin-api.php", type: "references", weight: 0.9, reason: "Admin API module" }
