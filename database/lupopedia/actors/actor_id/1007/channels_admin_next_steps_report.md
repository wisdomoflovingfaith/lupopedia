...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/actors/actor_id/1007/channels_admin_next_steps_report.md"
...
1. **Implement admin API module**
   - Add a small admin API controller (e.g., `includes/modules/api/channels-admin-api.php`).
   - Route it in `includes/modules/module-loader.php`.
