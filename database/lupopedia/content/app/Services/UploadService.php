...
class UploadService
{
    ...
    public function getHandler(): \LupoUploadHandler
    {
        if (self::$handler === null) {
            ...
            $file = $path . '/includes/functions/upload-handler.php';
            if (file_exists($file)) {
                require_once $file;
            }
            if (!class_exists('LupoUploadHandler')) {
                throw new \RuntimeException('LupoUploadHandler not found. Ensure includes/functions/upload-handler.php is loadable.');
            }
