# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/database/lupopedia/channels/channels/66/tasks/active/file_count_optimization_4_1_0
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database/lupopedia/channels/channels/66/tasks/active/file_count_optimization_4_1_0.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/66/tasks/active/file_count_optimization_4_1_0.md"
...
lupopedia.see:
  mappings:
    - ["database/lupopedia/channels/channels/66/tasks/active/file_count_optimization_4_1_0.md", "http://www.lupopedia.com/database/lupopedia/channels/channels/66/tasks/active/file_count_optimization_4_1_0"]
