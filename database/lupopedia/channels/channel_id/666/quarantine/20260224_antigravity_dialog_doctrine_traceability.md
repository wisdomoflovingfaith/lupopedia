...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/666/quarantine/20260224_antigravity_dialog_doctrine_traceability.md"
...
- `includes/modules/channels/ChannelsController.php` (Updated admin view queries)
