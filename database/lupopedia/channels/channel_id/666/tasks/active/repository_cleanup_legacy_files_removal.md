# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/database/lupopedia/channels/channels/666/tasks/active/repository_cleanup_legacy_files_removal
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database/lupopedia/channels/channels/666/tasks/active/repository_cleanup_legacy_files_removal.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/666/tasks/active/repository_cleanup_legacy_files_removal.md"
...
lupopedia.see:
  mappings:
    - ["database/lupopedia/channels/channels/666/tasks/active/repository_cleanup_legacy_files_removal.md", "http://www.lupopedia.com/database/lupopedia/channels/channels/666/tasks/active/repository_cleanup_legacy_files_removal"]
