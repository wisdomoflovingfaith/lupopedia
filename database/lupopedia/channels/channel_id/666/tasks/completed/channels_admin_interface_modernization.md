# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/database/lupopedia/channels/channels/666/tasks/completed/channels_admin_interface_modernization
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database/lupopedia/channels/channels/666/tasks/completed/channels_admin_interface_modernization.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/666/tasks/completed/channels_admin_interface_modernization.md"
...
lupopedia.see:
  mappings:
    - ["database/lupopedia/channels/channels/666/tasks/completed/channels_admin_interface_modernization.md", "http://www.lupopedia.com/database/lupopedia/channels/channels/666/tasks/completed/channels_admin_interface_modernization"]
