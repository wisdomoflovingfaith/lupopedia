...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/0/startup_enhancements_corrections.md"
  ...
  mood_vector: "FF00FF"  # Fuchsia for Lilith-inspired review/action
...
- **Add Note**: "AI classes in `includes/classes/ai/`; load via autoloader or require_once"
- **Class Loading**: Ensure proper inclusion in install script
- **Example**: `require_once 'includes/classes/ai/SystemAI.php';` etc.

#### 6. Add Bootstrap File Check
- **Early Validation**: At script start, check `if (!file_exists('includes/bootstrap.php')) die("❌ ERROR: bootstrap.php not found.");`
...
// Load AI classes
require_once 'includes/classes/ai/SystemAI.php';
require_once 'includes/classes/ai/CaptainWolfieAI.php';
require_once 'includes/classes/ai/LilithAI.php';
...
lupopedia.headers:
  ...
  mood_vector: "32CD32"  # LimeGreen for success
