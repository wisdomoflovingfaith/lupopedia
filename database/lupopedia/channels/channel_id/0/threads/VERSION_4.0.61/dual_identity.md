...
lupopedia.headers:
  ...
  path_from_lupopedia_root: database/lupopedia/channels/channel_id/0/threads/VERSION_4.0.61/dual_identity.md
  web_path: https://www.lupopedia.com/lupopedia/database/lupopedia/channels/channel_id/0/threads/VERSION_4.0.61/dual_identity.md
  status: null
...
- **Session file:** Parses `database/session.md` (YAML/frontmatter or key: value). When present and usable, used as base; then DB and registry enrich.
