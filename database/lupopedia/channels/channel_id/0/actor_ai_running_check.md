...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/0/actor_ai_running_check.md"
  ...
  mood_vector: "4169E1"  # RoyalBlue for core doctrine
...
lupopedia.edges:
  outbound_edges:
    ...
    - { to: "database/lupopedia/toon/lupo_actors.toon.json", type: "schema_reference", weight: 1.0 }  # Assuming lupo_actors for registry
    - { to: "database/lupopedia/toon/lupo_channel_state.toon.json", type: "related_schema", weight: 0.9 }
...
1. **Add Function to Helpers**: Create `includes/functions/ai_checks.php`
