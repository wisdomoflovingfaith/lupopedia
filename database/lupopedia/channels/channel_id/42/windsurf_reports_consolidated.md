...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database\lupopedia\channels\channels\42\windsurf_reports_consolidated.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/windsurf_reports_consolidated.md"
  ...
  tags: ["database", "lupopedia", "channels", "channels", "42", "windsurf_reports_consolidatedmd"]
...
lupopedia.see:
  mappings:
    - ["database\lupopedia\channels\channels\42\windsurf_reports_consolidated.md", "http://www.lupopedia.com/WINDSURF_REPORTS_CONSOLIDATED"]
