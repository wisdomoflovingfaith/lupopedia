# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/actor_help_documentation_validation
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/actor_help_documentation_validation.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/actor_help_documentation_validation.md"
...
lupopedia.see:
  mappings:
    - ["database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/actor_help_documentation_validation.md", "http://www.lupopedia.com/database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/actor_help_documentation_validation"]
...
- **Phase 1–2:** Scanned `database/lupopedia/actors/actor_id/` and channel actor dirs. Priority actors (0, 1, 19, 1000, 10000) validated.
