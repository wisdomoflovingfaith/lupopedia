# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/database_documentation_remaining_tables
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/database_documentation_remaining_tables.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/database_documentation_remaining_tables.md"
  file_hash: "7db20cbeaa45129a69bf4bf93b85fddb998e042046e32d198e0dc0b37a0f9b1c"
...
lupopedia.see:
  mappings:
    - ["database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/database_documentation_remaining_tables.md", "http://www.lupopedia.com/database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/database_documentation_remaining_tables"]
...
A full gap check was run: every table with a TOON in `docs/toons/*.toon.json` was compared to `docs/database/lupopedia/tables/*.md`. **Five tables had no documentation**; all five now have table docs:

| Table | Doc path |
|-------|----------|
| lupo_anubis_processing_log | docs/database/lupopedia/tables/lupo_anubis_processing_log.md |
| lupo_anubis_quarantine | docs/database/lupopedia/tables/lupo_anubis_quarantine.md |
| lupo_anubis_queue | docs/database/lupopedia/tables/lupo_anubis_queue.md |
| lupo_anubis_recovery_attempts | docs/database/lupopedia/tables/lupo_anubis_recovery_attempts.md |
| lupo_channel_boot_detail_lifecycle | docs/database/lupopedia/tables/lupo_channel_boot_detail_lifecycle.md |
...
3. **Analyze Usage Patterns**
   ...
   grep -r "lupo_analytics_visits" includes/ --include="*.php"
   ```
