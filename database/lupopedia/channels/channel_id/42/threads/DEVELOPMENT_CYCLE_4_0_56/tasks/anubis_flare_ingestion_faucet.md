# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/anubis_flare_ingestion_faucet
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/anubis_flare_ingestion_faucet.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/anubis_flare_ingestion_faucet.md"
...
lupopedia.see:
  mappings:
    - ["database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/anubis_flare_ingestion_faucet.md", "http://www.lupopedia.com/database/lupopedia/channels/channels/42/threads/DEVELOPMENT_CYCLE_4_0_56/tasks/anubis_flare_ingestion_faucet"]
...
**Canonical path**: `database/lupopedia/channels/channels/42/actors/19/faucets.json` (created 2026-03-03; Cursor 1003)
...
- Faucet definition persisted at `database/lupopedia/channels/channels/42/actors/19/faucets.json` with schema_version 4.0.56.
