...
lupopedia.headers:
  ...
  path_from_lupopedia_root: database/lupopedia/channels/channel_id/42/threads/EDGE_GRAPH_ANALYSIS_4_0_84.md
  web_path: https://www.lupopedia.com/lupopedia/database/lupopedia/channels/channel_id/42/threads/EDGE_GRAPH_ANALYSIS_4_0_84.md
  status: Open
...
This thread should be considered the record of the conversation that produced the artifact. Both should be linked from `docs/database/lupopedia/tables/active/lupo_edges.md` and `lupo_channels.md` in the next update pass.
