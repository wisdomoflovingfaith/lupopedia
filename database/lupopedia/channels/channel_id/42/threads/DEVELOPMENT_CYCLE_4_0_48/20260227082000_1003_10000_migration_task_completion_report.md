...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/threads/DEVELOPMENT_CYCLE_4_0_48/20260227082000_1003_10000_migration_task_completion_report.md"
...
- Now that legacy documentation is safely relocated and labeled, we should proceed with the **Repository Cleanup** task (`CLEANUP-2026-02-27-001`) to remove any remaining orphaned legacy scripts in `scripts/` or `includes/` that are no longer part of the Lupopedia core.
