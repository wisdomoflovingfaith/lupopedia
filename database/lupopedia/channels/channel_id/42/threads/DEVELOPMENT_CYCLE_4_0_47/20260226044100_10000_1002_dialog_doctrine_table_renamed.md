...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/threads/DEVELOPMENT_CYCLE_4_0_47/20260226044100_10000_1002_dialog_doctrine_table_renamed.md"
...
@flip.footer {
  ...
  outbound_edges: [
    ...
    { to: "includes/modules/channels/channels-controller.php", type: "references", weight: 0.8, hashtag: "#controller" }
  ],
...
- **`includes/classes/AdminChannelsHandler.php`**
