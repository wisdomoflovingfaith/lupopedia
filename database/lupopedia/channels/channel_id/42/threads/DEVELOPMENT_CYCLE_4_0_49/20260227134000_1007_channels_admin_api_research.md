...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/threads/DEVELOPMENT_CYCLE_4_0_49/20260227134000_1007_channels_admin_api_research.md"
...
lupopedia.footer:
  outbound_edges:
    - { to: "includes/modules/module-loader.php", type: "references", weight: 0.9, reason: "API routing map" }
    - { to: "includes/modules/api/channels-api.php", type: "references", weight: 0.8, reason: "channels REST endpoint" }
    - { to: "includes/modules/channels/channel-send-api.php", type: "references", weight: 0.7, reason: "legacy channel send endpoint" }
    - { to: "includes/modules/channels/channel-messages-api.php", type: "references", weight: 0.7, reason: "legacy channel messages endpoint" }
    - { to: "includes/modules/channels/operator-pending-visitors-api.php", type: "references", weight: 0.7, reason: "operator pending visitors endpoint" }
    - { to: "includes/modules/channels/operator-accept-visitor-api.php", type: "references", weight: 0.7, reason: "operator accept visitor endpoint" }
...
## Summary of Findings
- **Existing API routes are limited to chat/visitor operations** and VSX messaging, routed via `includes/modules/module-loader.php`.
...
Routing defined in `includes/modules/module-loader.php`:
- `GET/POST api/channels/{id}/messages` -> `includes/modules/api/channels-api.php`
- `GET api/channel/messages` -> `includes/modules/channels/channel-messages-api.php`
- `POST api/channel/send` -> `includes/modules/channels/channel-send-api.php`
- `GET/POST api/channel/typing` -> `includes/modules/channels/channel-typing-api.php`
- `GET api/channel/check` -> `includes/modules/channels/channel-check-api.php`
- `GET api/operator/pending-visitors` -> `includes/modules/channels/operator-pending-visitors-api.php`
- `POST api/operator/accept-visitor` -> `includes/modules/channels/operator-accept-visitor-api.php`
...
## Next Steps
1. Implement a small admin API module under `includes/modules/api/channels-admin-api.php` and route it from `module-loader.php`.
