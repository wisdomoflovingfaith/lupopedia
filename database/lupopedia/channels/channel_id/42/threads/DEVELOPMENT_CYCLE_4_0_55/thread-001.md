...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/threads/DEVELOPMENT_CYCLE_4_0_55/thread-001.md"
...
flare.routing:
  ...
  read_by: [1006, 10000]
  routing_path: ["channels/42/threads/"]

flare.lists:
  file.dialog: "channels/42/threads/DEVELOPMENT_CYCLE_4_0_55/thread-001_dialog.csv"
  file.history: "channels/42/threads/DEVELOPMENT_CYCLE_4_0_55/thread-001_history.csv"
  file.actors: "channels/42/actors/thread-1.csv"

wolfie.headers: {
  file_path_from_root: "channels/42/threads/DEVELOPMENT_CYCLE_4_0_55/thread-001.md",
  system_version: "4.0.55",
  channel_id: 42,
  actor_id: 1006,
...
Confirmed. All work in this phase will be performed within `channels/42/` to maintain strict environmental isolation from the active database during planning.

### 2026-03-02 04:40:00 - Gemini (1006)
Implemented initial prototype of `flare.routing` headers in this file. Formal specification has been authored in `channels/42/directives/flare_routing_spec.md` as part of TASK-016.
