...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database\lupopedia\channels\channels\42\collections\sessions-collection.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/collections/sessions-collection.md"
...
lupopedia.see:
  mappings:
    - ["database\lupopedia\channels\channels\42\collections\sessions-collection.md", "http://www.lupopedia.com/SESSIONS-COLLECTION"]
...
---
wolfie.headers: {
  file_path_from_root: "channels/42/collections/sessions-collection.md",
