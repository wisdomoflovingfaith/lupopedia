...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database\lupopedia\channels\channels\42\collections\meta-collection.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/collections/meta-collection.md"
...
lupopedia.see:
  mappings:
    - ["database\lupopedia\channels\channels\42\collections\meta-collection.md", "http://www.lupopedia.com/META-COLLECTION"]
...
---
wolfie.headers: {
  file_path_from_root: "channels/42/collections/meta-collection.md",
...
- **MD Mapping**: This collection is represented by the very files within `channels/*/collections/`.
