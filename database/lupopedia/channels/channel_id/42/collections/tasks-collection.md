...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database\lupopedia\channels\channels\42\collections\tasks-collection.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/collections/tasks-collection.md"
...
lupopedia.see:
  mappings:
    - ["database\lupopedia\channels\channels\42\collections\tasks-collection.md", "http://www.lupopedia.com/TASKS-COLLECTION"]
...
---
wolfie.headers: {
  file_path_from_root: "channels/42/collections/tasks-collection.md",
...
- **MD Mapping**: Each row in `lupo_tasks` directly corresponds to an MD file in `channels/42/tasks/active/`.
