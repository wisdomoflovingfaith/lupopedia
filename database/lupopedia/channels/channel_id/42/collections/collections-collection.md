...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database\lupopedia\channels\channels\42\collections\collections-collection.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/collections/collections-collection.md"
...
lupopedia.see:
  mappings:
    - ["database\lupopedia\channels\channels\42\collections\collections-collection.md", "http://www.lupopedia.com/COLLECTIONS-COLLECTION"]
...
## Migration Path
New Path: `database/lupopedia/collections/`
