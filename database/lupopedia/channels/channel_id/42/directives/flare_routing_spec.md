...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/directives/flare_routing_spec.md"
...
flare.routing:
  ...
  routing_path: ["channels/42/directives/"]

flare.lists:
  file.dialog: "channels/42/threads/DEVELOPMENT_CYCLE_4_0_55/thread-001.csv"
...
wolfie.headers: {
  file_path_from_root: "channels/42/directives/flare_routing_spec.md",
  system_version: "4.0.55",
  channel_id: 42,
  actor_id: 1006,
...
- **Example**: `routing_path: ["channels/0/", "channels/42/tasks/"]`
...
- **Example**: `file.dialog: "channels/42/threads/thread-001.csv"`
...
- **Example**: `file.history: "channels/42/threads/thread-001_history.csv"`
...
- **Example**: `file.actors: "channels/42/actors/thread-1.csv"`
