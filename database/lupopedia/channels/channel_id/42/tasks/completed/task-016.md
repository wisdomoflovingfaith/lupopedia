...
# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/database/lupopedia/channels/channels/42/tasks/active/task-016
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database/lupopedia/channels/channels/42/tasks/active/task-016.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/tasks/completed/task-016.md"
...
lupopedia.see:
  mappings:
    - ["database/lupopedia/channels/channels/42/tasks/active/task-016.md", "http://www.lupopedia.com/database/lupopedia/channels/channels/42/tasks/active/task-016"]
