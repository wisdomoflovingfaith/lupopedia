...
# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/database/lupopedia/channels/channels/42/tasks/completed/anubis_flare_ingestion_faucet
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database/lupopedia/channels/channels/42/tasks/completed/anubis_flare_ingestion_faucet.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/tasks/completed/anubis_flare_ingestion_faucet.md"
...
lupopedia.see:
  mappings:
    - ["database/lupopedia/channels/channels/42/tasks/completed/anubis_flare_ingestion_faucet.md", "http://www.lupopedia.com/database/lupopedia/channels/channels/42/tasks/completed/anubis_flare_ingestion_faucet"]
