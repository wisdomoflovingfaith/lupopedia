...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/tasks/completed/task-018-version-synchronization.md"
...
## Verification
- `php bin/lupo.php version` confirms 4.0.63.
