...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/tasks/completed/task-016-actor-workspace-namespace.md"
...
## Verification
- Verified via `php bin/lupo.php doctor --check-actors`.
