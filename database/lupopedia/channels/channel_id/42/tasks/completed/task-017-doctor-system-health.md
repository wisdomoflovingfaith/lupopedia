...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/tasks/completed/task-017-doctor-system-health.md"
...
- **CLI Command:** New `php bin/lupo.php doctor` command and `--check-actors` flag.
...
## Verification
- Run `php bin/lupo.php doctor` for baseline health.
- Run `php bin/lupo.php doctor --check-actors` for audit.
