...
# FLARE Header (aliases: Wolfie, FLIP, FLP, FLPH, CROP) — see http://www.lupopedia.com/database/lupopedia/channels/channels/42/tasks/active/task-005
...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database/lupopedia/channels/channels/42/tasks/active/task-005.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/tasks/active/task-005.md"
  file_hash: "a1b54b73d7ad0b68ba9fecabdaadb8229369ee14ef776f58e3b97a05fcdbf0a4"
...
lupopedia.see:
  mappings:
    - ["database/lupopedia/channels/channels/42/tasks/active/task-005.md", "http://www.lupopedia.com/database/lupopedia/channels/channels/42/tasks/active/task-005"]
