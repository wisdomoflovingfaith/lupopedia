...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/actors/2035/help.md"
...
lupopedia.edges:
  ...
  outbound_edges:
    ...
    - { to: "includes/classes/AnubisHeaderFallback.php", type: "references", weight: 0.8, reason: "Header fallback system" }
...
- **Header Fallback**: `includes/classes/AnubisHeaderFallback.php` for header recovery
...
- **Header Fallback**: `includes/classes/AnubisHeaderFallback.php` - Header recovery system
