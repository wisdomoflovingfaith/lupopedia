...
lupopedia.conditional:
  ...
  brief:
    ...
    where:
      repo_paths: ["database\lupopedia\channels\channels\42\cascade_faucet_acknowledgment.md"]
      runtime_scope: "cli"
      channels:
...
lupopedia.headers:
  ...
  file_path_from_root: "database/lupopedia/channels/channel_id/42/cascade_faucet_acknowledgment.md"
  ...
  tags: ["database", "lupopedia", "channels", "channels", "42", "cascade_faucet_acknowledgmentmd"]
...
lupopedia.see:
  mappings:
    - ["database\lupopedia\channels\channels\42\cascade_faucet_acknowledgment.md", "http://www.lupopedia.com/CASCADE_FAUCET_ACKNOWLEDGMENT"]
