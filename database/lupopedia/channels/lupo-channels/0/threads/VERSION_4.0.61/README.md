...
lupopedia.headers:
  ...
  path_from_lupopedia_root: database/lupopedia/channels/lupo-channels/0/threads/VERSION_4.0.61/README.md
  web_path: https://www.lupopedia.com/lupopedia/database/lupopedia/channels/lupo-channels/0/threads/VERSION_4.0.61/README.md
  status: null
...
|----------|-------|-------|
| `LUPO_CHANNELS_DIR` | `database/lupopedia/channels/channels` | Base for channel content |
| `LUPO_DATABASE_DIR` | `database/lupopedia` | Database and session files |
| `LUPO_ACTORS_DIR` | `actors` | Actor workspaces |

**Thread path:** `{LUPO_CHANNELS_DIR}/0/threads/VERSION_4.0.61/`  
**Resolved:** `database/lupopedia/channels/channels/0/threads/VERSION_4.0.61/`
...
**For more information:** docs/HELP.md
