-- ======================================================================
-- Safe Batch Insert: Lupopedia Channels 5100-5115
-- Generated: 2026-01-25
-- Purpose: Initialize core system channels for Lupopedia Semantic OS
-- Handles duplicates by using INSERT IGNORE
-- ======================================================================
...
(
    ...
    NULL, 'FFFFFF', 1, NULL, NULL, 20260125192700, 20260125192700, 0, NULL, NULL, NULL,
    '3.0.72', 5115, NULL, 1, NULL
);

-- ======================================================================
-- Alternative: Update existing channels if needed
-- Uncomment below if you need to update existing records
-- ======================================================================

/*
UPDATE lupo_channels SET 
    channel_name = 'Lupopedia',
    description = 'Primary Lupopedia knowledge and system channel.',
    awareness_version = '3.0.72',
    is_kernel = 0
WHERE channel_key = 'lupopedia' AND federation_node_id = 1;
*/
