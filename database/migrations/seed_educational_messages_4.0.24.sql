...
(118, 1, 42, 2038, 'Lupopedia uses a unified registry (lupo_unified_registry) to track all actors, channels, and agents with explicit, non-guessable IDs.', 'educational', '{"topic":"lupopedia","part":4}', 20260222101300),
