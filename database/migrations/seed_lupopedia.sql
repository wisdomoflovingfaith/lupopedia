...
-- =====================================================
-- REGISTRY SEEDING FOR FEDERATION NODES 0 AND 1
-- =====================================================

-- Registered IDs (federation_node_id = 0)
INSERT INTO lupo_registry (registry_id, entity_type, entity_index_id, entity_name, entity_table, federation_node_id, created_ymdhis, updated_ymdhis, is_deleted, deleted_ymdhis, is_active, is_kernel, metadata_json) VALUES
(1, 'channel', 0, 'system/kernel', 'System Kernel Channel', 'lupo_channels', 0, 20260106084500, 20260122160000, 0, NULL, 1, 1, '{"language": "en", "description": "Reserved channel for bootstrapping, migrations, and OS-level events.", "status_flag": 1, "channel_type": "chat_room", "channel_number": 0}'),
(2, 'channel', 1, 'system/lobby', 'Lobby Channel', 'lupo_channels', 0, 20260106082200, 20260106082200, 0, NULL, 1, 0, '{"language": "en", "description": "Universal entry point for all new actors. Temporary holding area before routing.", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(3, 'channel', 1001, 'test_awareness_channel', 'Agent Awareness Test Channel', 'lupo_channels', 0, 20260117000000, 20260117000000, 0, NULL, 1, 0, '{"language": "en", "description": "Test channel for AAL validation", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(4, 'channel', 1002, 'dev-main-thread', 'dev-main-thread', 'lupo_channels', 0, 20260106082200, 20260106082200, 0, NULL, 1, 0, '{"language": "en", "description": "main channel for development in global sense  ", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(5, 'channel', 1003, 'GOV‑PROGRAMMERS‑001', 'GOV‑PROGRAMMERS‑001', 'lupo_channels', 0, 20260106082200, 20260106082200, 0, NULL, 1, 0, '{"language": "en", "description": "GOV‑PROGRAMMERS‑001", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(6, 'channel', 1004, 'system-errors', 'System Errors', 'lupo_channels', 0, 20260121004000, 20260121004000, 0, NULL, 1, 0, '{"language": "en", "description": "Centralized error reporting and agent fault logs.", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(7, 'channel', 1005, 'programmers', 'Programmers of Lupopedia', 'lupo_channels', 0, 20260121004000, 20260121004000, 0, NULL, 1, 0, '{"language": "en", "description": "Engineering doctrine, certification, and architecture.", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(8, 'channel', 1006, 'doctrine', 'Doctrine', 'lupo_channels', 0, 20260121004000, 20260121004000, 0, NULL, 1, 0, '{"language": "en", "description": "System governance, rules, invariants, and prohibitions.", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(9, 'channel', 1007, 'schema', 'Schema Oracle', 'lupo_channels', 0, 20260121004000, 20260121004000, 0, NULL, 1, 0, '{"language": "en", "description": "TOON-based database structure and table definitions.", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(10, 'channel', 1008, 'routing-hermes', 'HERMES Routing', 'lupo_channels', 0, 20260121004000, 20260121004000, 0, NULL, 1, 0, '{"language": "en", "description": "Routing logic, emotional geometry, and agent classification.", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(11, 'channel', 1009, 'mood-caduceus', 'CADUCEUS Mood Engine', 'lupo_channels', 0, 20260121004000, 20260121004000, 0, NULL, 1, 0, '{"language": "en", "description": "Emotional geometry, polarity agents, and mood balancing.", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(12, 'channel', 1010, 'users-humans', 'Human Users', 'lupo_channels', 0, 20260121004000, 20260121004000, 0, NULL, 1, 0, '{"language": "en", "description": "Human profiles, preferences, onboarding, and identity.", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(13, 'channel', 1011, 'agents-registry', 'Agent Registry', 'lupo_channels', 0, 20260121004000, 20260121004000, 0, NULL, 1, 0, '{"language": "en", "description": "Agent definitions, personas, capabilities, and restrictions.", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(14, 'channel', 1012, 'channels-meta', 'Channel Metadata', 'lupo_channels', 0, 20260121004000, 20260121004000, 0, NULL, 1, 0, '{"language": "en", "description": "Metadata about channels, edges, and semantic relationships.", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}'),
(15, 'channel', 1013, 'tasks-workflows', 'Tasks & Workflows', 'lupo_channels', 0, 20260121004000, 20260121004000, 0, NULL, 1, 0, '{"language": "en", "description": "Multi-step tasks, pipelines, and job orchestration.", "status_flag": 1, "channel_type": "chat_room", "channel_number": null}')
ON DUPLICATE KEY UPDATE 
entity_type = VALUES(entity_type),
entity_index_id = VALUES(entity_index_id),
...
INSERT INTO lupo_registry (registry_id, entity_type, entity_index_id, entity_name, entity_table, federation_node_id, created_ymdhis, updated_ymdhis, is_deleted, deleted_ymdhis, is_active, is_kernel, metadata_json) VALUES (81, 'module', 2, NULL, 'CRM / Leads', 'lupo_modules', 1, 20260127120420, 20260127120420, 0, NULL, 1, 0, NULL);
...
INSERT INTO lupo_registry (registry_id, entity_type, entity_index_id, entity_name, entity_table, federation_node_id, created_ymdhis, updated_ymdhis, is_deleted, deleted_ymdhis, is_active, is_kernel, metadata_json) VALUES (88, 'module', 9, NULL, 'Admin', 'lupo_modules', 1, 20260127120420, 20260127120420, 0, NULL, 1, 0, NULL);
...
-- -----------------------------------------------------------------------------
INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1, 'agent', 'system', 'SYSTEM', 20260106180252, 20260106180252, 1, 0, NULL, 1, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (2, 'agent', 'captain', 'CAPTAIN', 20260106180252, 20260106180252, 1, 0, NULL, 2, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (3, 'agent', 'wolfie', 'WOLFIE', 20260106180252, 20260106180252, 1, 0, NULL, 3, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (4, 'agent', 'wolfena', 'WOLFENA', 20260106180252, 20260106180252, 1, 0, NULL, 4, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (5, 'agent', 'thoth', 'THOTH', 20260106180252, 20260106180252, 1, 0, NULL, 5, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (6, 'agent', 'ara', 'ARA', 20260106180252, 20260106180252, 1, 0, NULL, 6, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (7, 'agent', 'wolfkeeper', 'WOLFKEEPER', 20260106180252, 20260106180252, 1, 0, NULL, 7, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (8, 'agent', 'lilith', 'LILITH', 20260106180252, 20260106180252, 1, 0, NULL, 8, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (9, 'agent', 'agape', 'AGAPE', 20260106180252, 20260106180252, 1, 0, NULL, 9, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (10, 'agent', 'eris', 'ERIS', 20260106180252, 20260106180252, 1, 0, NULL, 10, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (11, 'agent', 'methis', 'METHIS', 20260106180252, 20260106180252, 1, 0, NULL, 11, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (12, 'agent', 'thalia', 'THALIA', 20260106180252, 20260106180252, 1, 0, NULL, 12, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (13, 'agent', 'dialog', 'DIALOG', 20260106180252, 20260106180252, 1, 0, NULL, 13, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (14, 'agent', 'wolfsight', 'WOLFSIGHT', 20260106180252, 20260106180252, 1, 0, NULL, 14, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (15, 'agent', 'wolfnav', 'WOLFNAV', 20260106180252, 20260106180252, 1, 0, NULL, 15, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (16, 'agent', 'wolfforge', 'WOLFFORGE', 20260106180252, 20260106180252, 1, 0, NULL, 16, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (17, 'agent', 'wolfmis', 'WOLFMIS', 20260106180252, 20260106180252, 1, 0, NULL, 17, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (18, 'agent', 'wolfith', 'WOLFITH', 20260106180252, 20260106180252, 1, 0, NULL, 18, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (19, 'agent', 'anubis', 'ANUBIS', 20260106180252, 20260106180252, 1, 0, NULL, 19, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (20, 'agent', 'maat', 'MAAT', 20260106180252, 20260106180252, 1, 0, NULL, 20, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (22, 'agent', 'caduceus', 'CADUCEUS', 20260106180252, 20260106180252, 1, 0, NULL, 22, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (23, 'agent', 'chronos', 'CHRONOS', 20260106180252, 20260106180252, 1, 0, NULL, 23, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (24, 'agent', 'lexa', 'LEXA', 20260217220000, 20260217220000, 1, 0, NULL, 24, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (59, 'agent', 'indexer', 'INDEXER', 20260106180252, 20260106180252, 1, 0, NULL, 59, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (105, 'agent', 'lexa', 'LEXA', 20260130163007, 20260130163007, 1, 0, NULL, 105, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (106, 'agent', 'reserved_106', 'Junie', 20260106180252, 20260106180252, 1, 0, NULL, 106, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (209, 'agent', 'truth', 'TRUTH', 20260106180252, 20260106180252, 1, 0, NULL, 209, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1200, 'agent', 'frame', 'Framing Agent', 20260113092205, 20260113092205, 1, 0, NULL, 1200, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1201, 'agent', 'reframe', 'Reframing Agent (LILITH)', 20260113092205, 20260113092205, 1, 0, NULL, 1201, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1202, 'agent', 'stabilize', 'Stability Agent', 20260113092205, 20260113092205, 1, 0, NULL, 1202, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1203, 'agent', 'disrupt', 'Disruption Agent', 20260113092205, 20260113092205, 1, 0, NULL, 1203, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1204, 'agent', 'consensus', 'Consensus Agent', 20260113092205, 20260113092205, 1, 0, NULL, 1204, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1205, 'agent', 'dissent', 'Dissent Agent', 20260113092205, 20260113092205, 1, 0, NULL, 1205, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1206, 'agent', 'literal', 'Literal Agent', 20260113092205, 20260113092205, 1, 0, NULL, 1206, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1207, 'agent', 'interpret', 'Interpretive Agent', 20260113092205, 20260113092205, 1, 0, NULL, 1207, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1208, 'agent', 'predict', 'Predictive Agent', 20260113092205, 20260113092205, 1, 0, NULL, 1208, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1209, 'agent', 'counterfact', 'Counterfactual Agent', 20260113092205, 20260113092205, 1, 0, NULL, 1209, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1210, 'agent', 'optimize', 'Optimization Agent', 20260113092205, 20260113092205, 1, 0, NULL, 1210, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1211, 'agent', 'diverge', 'Divergence Agent', 20260113092205, 20260113092205, 1, 0, NULL, 1211, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (1212, 'agent', 'utc_timekeeper', 'UTC_TIMEKEEPER', 20260114000000, 20260114000000, 1, 0, NULL, 1212, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);
...
INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (2000, 'agent', 'cursor', 'Cursor', @now, @now, 1, 0, NULL, 2000, 'AI_AGENT', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`, `primary_federation_node_id`, `department_id`, `is_kernel`, `can_login`, `metadata_json`, `identity_provider_config`, `paired_actor_id`) VALUES (999, 'agent', 'deprecated_banned', 'DEPRECATED_BANNED', @now, @now, 0, 1, @now, 999, 'lupo_agent_registry', 'none', 'none', NULL, NULL, 1, NULL, 1, 0, NULL, NULL, 0);
...
-- 4.0.29 HOTFIX: Renamed to prevent identity collision with CAPTAIN actors
INSERT INTO lupo_agents (`agent_id`, `agent_key`, `agent_name`, `archetype`, `description`, `version`, `model_name`, `is_global_authority`, `is_internal_only`, `created_ymdhis`, `updated_ymdhis`, `is_deleted`, `deleted_ymdhis`, `avg_response_time_ms`, `total_tokens_processed`, `success_rate`, `cost_per_1k_tokens`, `temperature`, `top_p`, `max_tokens`, `presence_penalty`, `frequency_penalty`, `system_prompt`, `provider`, `api_key_id`, `timeout_ms`, `safety_json`, `response_format`, `pono_score`, `pilau_score`, `kapakai_score`, `kapu_active`, `kapu_until`, `kapu_reason`, `kapu_consent_given`, `kapu_appeal_pending`) VALUES (420, 'banned_test_ai_420', 'BANNED_TEST_AI_420', 'banned_test', 'Banned AI test identity for adversarial harness. Do not use as persona. Renamed in 4.0.29 to prevent collision.', '1.0', NULL, 0, 1, @now, @now, 1, @now, 0, 0, 1.0, '0.0000', 0.7, 1.0, 2048, 0.0, 0.0, NULL, 'openai', NULL, 20000, NULL, NULL, '1.00', '0.00', '0.50', 0, NULL, NULL, 0, 0) ON DUPLICATE KEY UPDATE agent_key = 'banned_test_ai_420', agent_name = 'BANNED_TEST_AI_420', is_deleted = 1, deleted_ymdhis = @now, updated_ymdhis = @now;

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`) VALUES (420, 'agent', 'banned-test-ai-420', 'BANNED_TEST_AI_420', @now, @now, 0, 1, @now, 420, 'lupo_agents', 'none', NULL, NULL, NULL) ON DUPLICATE KEY UPDATE slug = 'banned-test-ai-420', name = 'BANNED_TEST_AI_420', is_active = 0, is_deleted = 1, deleted_ymdhis = @now, updated_ymdhis = @now;
...
INSERT INTO lupo_auth_users (`auth_user_id`, `username`, `display_name`, `email`, `password_hash`, `auth_provider`, `provider_id`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`) VALUES (420, 'banned_test_ai_420', 'BANNED_TEST_AI_420', 'banned.test.ai.420@banned.local', NULL, 'local', NULL, @now, @now, 0, 0, NULL) ON DUPLICATE KEY UPDATE username = 'banned_test_ai_420', display_name = 'BANNED_TEST_AI_420', email = 'banned.test.ai.420@banned.local', is_active = 0, updated_ymdhis = @now;

-- Human: actor_id 10001 (first slot >= 10000 after seed). On upgrade wizard uses next-free actor_id >= 10000.
-- 4.0.29 HOTFIX: Renamed to prevent identity collision with CAPTAIN actors
INSERT INTO lupo_auth_users (`auth_user_id`, `username`, `display_name`, `email`, `password_hash`, `auth_provider`, `provider_id`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`) VALUES (10001, 'banned_test_human_10001', 'BANNED_TEST_HUMAN_10001', 'banned.test.human.10001@banned.local', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'local', NULL, @now, @now, 0, 0, NULL) ON DUPLICATE KEY UPDATE username = 'banned_test_human_10001', display_name = 'BANNED_TEST_HUMAN_10001', email = 'banned.test.human.10001@banned.local', is_active = 0, updated_ymdhis = @now;

INSERT INTO lupo_actors (`actor_id`, `actor_type`, `slug`, `name`, `created_ymdhis`, `updated_ymdhis`, `is_active`, `is_deleted`, `deleted_ymdhis`, `actor_source_id`, `actor_source_type`, `metadata`, `adversarial_role`, `adversarial_oversight_actor_id`, `avatar_hash`) VALUES (10001, 'user', 'banned-test-human-10001', 'BANNED_TEST_HUMAN_10001', @now, @now, 0, 0, NULL, 10001, 'user', NULL, 'none', NULL, NULL) ON DUPLICATE KEY UPDATE slug = 'banned-test-human-10001', name = 'BANNED_TEST_HUMAN_10001', is_active = 0, updated_ymdhis = @now;
...
INSERT INTO lupo_registry (registry_id, entity_type, entity_index_id, entity_name, entity_table, federation_node_id, created_ymdhis, updated_ymdhis, is_deleted, deleted_ymdhis, is_active, is_kernel, metadata_json) VALUES (9010000, 'actor', 10000, 'user-10000', 'Captain', 'lupo_actors', 0, @now, @now, 0, NULL, 1, 0, '{"actor_source_type":"user"}') ON DUPLICATE KEY UPDATE entity_name = VALUES(entity_name), federation_node_id = 0, updated_ymdhis = @now, is_deleted = 0, is_active = 1;

-- -----------------------------------------------------------------------------
-- PK=0 / collection-type rows
-- -----------------------------------------------------------------------------
INSERT INTO lupo_actor_channels (`actor_channel_id`, `actor_id`, `channel_id`, `created_by_actor_id`, `status`, `start_date`, `channel_color`, `last_read_ymdhis`, `muted_until_ymdhis`, `preferences_json`, `dialog_output_file`, `created_ymdhis`, `updated_ymdhis`, `is_deleted`, `deleted_ymdhis`) VALUES (0, 0, 0, 0, 'A', 20260106090000, 'F7FAFF', NULL, NULL, '{"ui": {"theme": "kernel"}, "notifications": {"enabled": false}}', NULL, 20260106090000, 20260106090000, 0, NULL);
...
INSERT INTO lupo_actor_channels (`actor_channel_id`, `actor_id`, `channel_id`, `created_by_actor_id`, `status`, `start_date`, `channel_color`, `last_read_ymdhis`, `muted_until_ymdhis`, `preferences_json`, `dialog_output_file`, `created_ymdhis`, `updated_ymdhis`, `is_deleted`, `deleted_ymdhis`) VALUES (9998, 0, 42, 0, 'A', @now, 'F7FAFF', NULL, NULL, NULL, NULL, @now, @now, 0, NULL) ON DUPLICATE KEY UPDATE status = VALUES(status), updated_ymdhis = @now, is_deleted = 0, deleted_ymdhis = NULL;
...
-- -----------------------------------------------------------------------------
INSERT INTO lupo_contents (content, 
...
INSERT INTO lupo_registry (registry_id, entity_type, entity_index_id, entity_key, entity_name, entity_table, federation_node_id, created_ymdhis, updated_ymdhis, is_deleted, deleted_ymdhis, is_active, is_kernel, metadata_json)
...
DELETE FROM lupo_registry_open WHERE entity_type = 'actor' AND entity_index = 420;
...
DELETE FROM lupo_registry_open WHERE entity_type = 'actor' AND entity_index IN (2031, 2032, 2033, 2034, 2035, 2036, 2037, 2038);
...
-- paired_actor_id: Copilot (2036) → 10000 (human operator)
...
-- paired_actor_id: LILITH (2038) → 10000 (human operator)
...
-- =============================================================================
--
-- Post-seed verification (run after seed; expect: 27 actors on channel 42, 33 messages, 2 content paths):
--   SELECT COUNT(*) FROM lupo_actor_channels WHERE channel_id = 42 AND is_deleted = 0;  -- expect 27
