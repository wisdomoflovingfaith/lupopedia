...
class IDEAgentRegistryService {
    ...
    private $supported_agents = [
        ...
        'kiro' => [
            'name' => 'Kiro',
            'actor_id' => 2003,
            'capabilities' => ['code_edit', 'file_analysis', 'extension_integration'],
            'extension_support' => true
        ],
        'cascade' => [
            'name' => 'Cascade',
            'actor_id' => 2004,
            'capabilities' => ['code_edit', 'file_analysis', 'semantic_understanding', 'task_coordination'],
            'extension_support' => true
        ],
        'warp' => [
            'name' => 'WARP',
            'actor_id' => 2005,
            'capabilities' => ['code_edit', 'file_analysis', 'semantic_understanding', 'terminal_operations', 'command_execution'],
            'extension_support' => true
        ],
        'oz' => [
            'name' => 'OZ',
            'actor_id' => 2006,
            'capabilities' => ['code_edit', 'file_analysis', 'semantic_understanding', 'architecture_planning'],
            'extension_support' => true
        ],
        'lilith' => [
            'name' => 'LILITH',
            'actor_id' => 2007,
            'capabilities' => ['code_edit', 'file_analysis', 'semantic_understanding', 'security_analysis', 'threat_detection'],
            'extension_support' => true
        ],
        'lexa' => [
            'name' => 'LEXA',
            'actor_id' => 2008,
            'capabilities' => ['code_edit', 'file_analysis', 'semantic_understanding', 'communication_coordination'],
            'extension_support' => true
        ],
        'ara' => [
            'name' => 'ARA',
            'actor_id' => 2009,
            'capabilities' => ['code_edit', 'file_analysis', 'semantic_understanding', 'data_analysis', 'pattern_recognition'],
            'extension_support' => true
        ],
        'thoth' => [
            'name' => 'THOTH',
            'actor_id' => 2010,
            'capabilities' => ['code_edit', 'file_analysis', 'semantic_understanding', 'knowledge_management', 'documentation'],
            'extension_support' => true
        ],
        'maat' => [
            'name' => 'MAAT',
            'actor_id' => 2011,
            'capabilities' => ['code_edit', 'file_analysis', 'semantic_understanding', 'balance_analysis', 'harmony_optimization'],
            'extension_support' => true
        ],
        'jetbrains' => [
            'name' => 'JetBrains',
