 ...
 *
 * Canonical JSON API: GET/POST api/channels/{channelId}/messages
 *   (see includes/modules/api/channels-api.php)
 ...
 * ui/images/digit0.gif … digit9.gif
 */
...
function lupoChatMessagesUrl(publicPath, channelId, since, format, threadId) {
    ...
    var u = base + "/api/channels/" + channelId + "/messages?since=" + encodeURIComponent(since || "");
