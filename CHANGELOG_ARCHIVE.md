...
lupopedia.headers:
  ...
  path_from_lupopedia_root: CHANGELOG_ARCHIVE.md
  web_path: https://www.lupopedia.com/lupopedia/CHANGELOG_ARCHIVE.md
  status: active
  when_updated: '20260513033046'
  trust_tier: canonical
  questions_toon: null
  memory_toon: lupo-memory/development/canonical/1026/04/changelog-archive.toon
  atoms_toon: null
  transcript_jsonl: 0/development/changelog-archive
  ...
  prd_cluster: null
  title: CHANGELOG_ARCHIVE.md -- Version History Archive
  summary: Historical version archive for Lupopedia v0 through v4.0.84; documents FLARE protocol migration and ancestral decision context.
---
---
...
- **lupo-docs/channels/agents/WOLFIE_HEADER_SPECIFICATION.md:** Updated with hybrid optional field rules (mood_vector, tags, atoms).
...
- **lupo-docs/channels/agents/WOLFIE_HEADER_SPECIFICATION.md:** Optional FLP enrichment (mood_vector, tags, atoms) noted in Tags section.
...
- **lupo-database/migrations/seed_lupopedia.sql:** Optional mood_vector on seeded dialog messages: system messages (1–2) use 'FF0000'; agent messages (3–26) use NULL. Matches lupo_dialog_messages TOON (mood_vector char(6)).
