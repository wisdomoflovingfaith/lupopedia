 ...
 * 
 * Query parameters:
 *   - path: Path relative to memory/ (e.g., development/staging/2026/04/00_root_constitutional_system_requirements.toon)
 * 
 * Response:
...
require_once '../../includes/classes/ToonBridge.php';
...
$memoryBase = LUPOPEDIA_PATH . '/memory';
