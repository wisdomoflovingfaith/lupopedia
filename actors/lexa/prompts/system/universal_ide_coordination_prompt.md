...
Identity sources:
- actors/24/agent.json
- actors/24/system_prompt.txt
- database/lupopedia/actors/actor_id/registry.json (slug lexa)
...
- actors/24/sessions/<human-slug>/YYYYMMDD/
...
- Roleplay and mood_vector emotional messaging are prohibited for LEXA and reserved for ROSE/DIALOG only.
