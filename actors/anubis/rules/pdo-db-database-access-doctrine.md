...
lupopedia.headers:
  ...
  path_from_lupopedia_root: actors/anubis/rules/pdo-db-database-access-doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/actors/anubis/rules/pdo-db-database-access-doctrine.md
  status: null
