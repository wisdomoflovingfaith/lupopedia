...
lupopedia.headers:
  ...
  path_from_lupopedia_root: actors/anubis/rules/single-install-no-4.0-upgrade-doctrine.md
  web_path: https://www.lupopedia.com/lupopedia/actors/anubis/rules/single-install-no-4.0-upgrade-doctrine.md
  status: null
...
- **Migrations that were written for 4.0.x** (e.g. in `database/migrations/` or `database/.../migrations/`) MUST be **consolidated into the install SQL**.
