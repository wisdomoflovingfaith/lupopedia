...
lupopedia.headers:
  ...
  path_from_lupopedia_root: actors/anubis/rules/no-laravel-no-middleware.md
  web_path: https://www.lupopedia.com/lupopedia/actors/anubis/rules/no-laravel-no-middleware.md
  status: null
