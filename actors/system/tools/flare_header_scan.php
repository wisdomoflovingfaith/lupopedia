 ...
 * Logs to actors/0/logs/flare-scan.log.
 *
...
if (!defined('LUPO_CONTENT_DIR'))   { define('LUPO_CONTENT_DIR', 'content'); }
if (!defined('LUPO_ACTORS_DIR'))    { define('LUPO_ACTORS_DIR', 'actors'); }
