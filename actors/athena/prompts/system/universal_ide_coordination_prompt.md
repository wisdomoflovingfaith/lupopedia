...
- database/lupopedia/actors/actor_id/registry.json (slug athena)
...
- actors/athena/sessions/<human-slug>/YYYYMMDD/
...
- Roleplay and mood_vector emotional messaging are prohibited for ATHENA and reserved for ROSE/DIALOG only.
