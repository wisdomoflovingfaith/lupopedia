...
lupopedia.headers:
  ...
  path_from_lupopedia_root: actors/athena/docs/ATHENA_STRATEGY_20260324_120000_edge_graph_channel_thread_recommendations.md
  web_path: https://www.lupopedia.com/lupopedia/actors/athena/docs/ATHENA_STRATEGY_20260324_120000_edge_graph_channel_thread_recommendations.md
  status: null
...
Immediately add a doctrine note to `docs/database/lupopedia/tables/active/` (create `lupo_context_edges.md`) clarifying:
