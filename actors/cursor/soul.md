...
lupopedia.headers:
  ...
  path_from_lupopedia_root: actors/cursor/soul.md
  web_path: https://www.lupopedia.com/lupopedia/actors/cursor/soul.md
  status: null
...
4. **Rule Propagation Oversight**
   - Validate execution of `php scripts/propagate_agent_rules.php`
