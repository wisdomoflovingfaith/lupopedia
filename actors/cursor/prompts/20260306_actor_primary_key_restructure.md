...
lupopedia.init:
  ...
  pre_actions:
    - type: dependency_check
      target: "docs/doctrine/FLARE/FLARE_DOCTRINE.md"
    - type: dependency_check
      target: "database/lupopedia/actors/actor_id/registry.json"

lupopedia.edges:
  outbound_edges:
    - { to: "database/lupopedia/mysql/install/install_new_lupopedia.sql", type: "modifies", weight: 1.0 }
    - { to: "database/lupopedia/mysql/seed/seed_actors_agents_4.0.45.sql", type: "modifies", weight: 1.0 }
    - { to: "app/Services/ActorService.php", type: "modifies", weight: 0.9 }
    - { to: "includes/modules/agents.php", type: "modifies", weight: 0.9 }
    - { to: "database/lupopedia/actors/actor_id/registry.json", type: "restructures", weight: 1.0 }
...
Create `database/migrations/20260306_actor_primary_key_migration.sql` (or under `database/lupopedia/mysql/` per project layout):
...
Update `database/lupopedia/actors/actor_id/registry.json` (or `actor_name/registry.json` if path is renamed):
